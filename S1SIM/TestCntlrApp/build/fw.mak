...
SM_DIR=../src/sm
SSI_DIR=../src/ssi
HI_DIR=../../../lte_enb/src/tucl
CM_DIR=../../../lte_enb/src/cm
RLOG_DIR=../../../lte_enb/src/rlog
NB_DIR=../src/enbApp
EG_DIR=../../../lte_enb/src/egtpu
SZ_DIR=../../../lte_enb/src/s1ap
SB_DIR=../../../lte_enb/src/sctp
TIMER_DIR=../src/timer
UE_SEC_DIR=../src/sec
...
CCRLOGOPTS= $(ENV) -DSS_LINUX -UUSE_RLOG_DATA_TYPES \
				-DRLOG_ENABLE_TEXT_LOGGING -DRLOG_ALLOW_CONSOLE_LOGS -DCMFILE_REORG_1
...
CCUEOPTS=$(DEBUGPOPTS) $(ENV) $(CMOPTS) -DLWLCFWLIUET -DLWLCFWLINBT \
         -DUE_LOGS -DRLOG_ENABLE_TEXT_LOGGING -DSQN_ALGO_TS33102 -UUEHASHLIST -DLTE_UE_NAS_SEC
