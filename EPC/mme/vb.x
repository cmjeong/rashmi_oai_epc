...
typedef struct _VbMmeEUTransContItm
{
   U32         len;     /**< Length of the buffer  */
   U8          *pVal;   /**< Buffer pointer        */
}VbMmeEUTransContItm;
/**< E-UTRAN Transparent Containter */
typedef struct _VbMmeEUStaTfrTransCont
{
   U8          noComp;
   VbMmeEUTransContItm itm[CM_ESM_MAX_BEARER_ID];
} VbMmeEUStaTfrTransCont;
...
/* Rab info for handover procedure */
typedef struct vbMmeHoDataRabInfo 
{
   U8      bId;
...
typedef struct vbMmeHoData
{
   ...
   VbMmeEUStaTfrTransCont  staTfrTCont;   /**< eNB Status Transfer Trans      
                                         Container */
   ...
   U8                 numRabs;      /* Tells the number of RABs admitted by target */

   VbMmeHoDataRabInfo rabInfo[CM_ESM_MAX_BEARER_ID]; /* Rab info of rabs admitted by target */
...
EXTERN S16 vbMmeUtlDelHoTrns ARGS((VbMmeUeCb    *ueCb));
