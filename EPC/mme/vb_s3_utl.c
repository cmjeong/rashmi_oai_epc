...
)
{
   ...
   /* Build the Header  with Default values */
   egUtlBuildEgHeader(&pEgMsg->msgHdr, pUeCb->pUeS3TunCb->remoteTeId,\
         EGT_GTPC_MSG_RC_REQ, ++pS3Tun->seqNum);
...
)
{
   ...
   /* Build the Header  with Default values */
   egUtlBuildEgHeader(&pEgMsg->msgHdr, pUeCb->pUeS3TunCb->remoteTeId,\
         EGT_GTPC_MSG_RC_RSP, pUeCb->pUeS3TunCb->seqNum);
