...
# MTSS defines
SS_FLAGS=-DSS -DSS_MT -DSUNOS -DSS_LINUX -DCONRD -UNOFILESYS -USS_DEBG_MEM_CORRUP_LEVEL1 \
...
TENB_FLAGS=-DLTERRC_REL9 -DEGTP_U_REL_9 -UMAC_SCH_STATS -USCH_STATS \
    -DTENB_TTI_PERF -DAES -UIPV6_SUPPORTED -DLTE_RRC_DISSECTOR -DRSYS_WIRESHARK -DUSE_PURE
...
DEL_FLAGS=-DSS_WL_REGION=1 -DVE_PERF_MEAS -UVE_SUPPORT_RLC_UM_MODE -ULTE_LNX_AFFINITY \
     ...
     -USS_MEM_CORRUPTION_DETECTION -DL2_LOGGING_ENABLED -DLTEMAC_DRX -USE_PURE \
...
# compiler options:
C_OPTS+=-g3 -pipe -pedantic -Wall -Wno-comment -Wshadow -Wno-unused-function \
...
xCPP_OPTS+=-g3 -pipe -pedantic -Wall -Wno-comment -Wshadow \
