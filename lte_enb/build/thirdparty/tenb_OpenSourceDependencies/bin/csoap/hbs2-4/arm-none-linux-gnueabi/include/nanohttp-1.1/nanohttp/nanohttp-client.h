 ...
 */
int
httpc_set_digest_authorization(httpc_conn_t *conn, const char *user, const char *realm, const char *qop,
				const char *nonce, const char *uri, const char *nc, const char *cnonce, const char *response, const char * opaque);
