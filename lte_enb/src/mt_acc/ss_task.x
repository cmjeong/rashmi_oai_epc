...
/* ss002.301: Modifications */
   ...
   PFS16       intrptActvFn;   /* call back function for Interrput */
   Bool        isIntrptReg;  /* check whether Interrupt call already registered or not */
...
/main/3+  LPR         sasahni    1. Logging Phase 2
*********************************************************************91*/
