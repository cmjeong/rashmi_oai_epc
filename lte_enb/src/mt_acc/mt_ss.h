...
#ifndef SS_FAP
#define MT_BKT_0_NUMBLKS        30500 /* Modified from 10500 to 30500*/
#else
...
/*ccpu00129785*/
#ifndef SS_FAP
#define MT_BKT_1_DSIZE          256  /* Modified from 256 to 4096 */
#define MT_BKT_1_NUMBLKS        70500
#else
/*mt010.301*/
...
#else
#define MT_BKT_2_DSIZE 4096 
#define MT_BKT_2_NUMBLKS 10500
#endif
...
#else
/* Changed heap size to 5MB instead of 4MB. This was done for adding support 
 * for circular buffer logging.
 */
#define MT_HEAP_SIZE            5242880U 
#endif
...
/*ccpu00129785*/
#define MT_MAX_MEM_THRESHOLD 2 /*Value of 2 means 80% buckets consumed, 4 = 60%*/ 
