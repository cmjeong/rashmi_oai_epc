...
#
#       Sid:      kw.mak@@/main/TeNB_Main_BR/5 - Mon Aug 11 16:43:12 2014
#
#       Pkw:   gk
#
#********************************************************************21*/
...
PRDOPTS=-DKW -DCMFILE_REORG_1 -DCMFILE_REORG_2 -DDEBUGP -DKW_DEBUG -DTENB_ACC\
		  -DCCPU_OPT -UKW_BG_UL_PROC -DSS_FLOAT -DTENB_SPLIT_ARCH -DTENB_T2K3K_SPECIFIC_CHANGES -ULTE_L2_MEAS -DSS_LOCKLESS_MEMORY -DRLOG_ENABLE_TEXT_LOGGING -DTENB_MULT_CELL_SUPPRT\
		  $(PRDLCLKWOPTS) $(PRDLCCKWOPTS) $(PRDLCKWUOPTS) $(PRDLCRGUOPTS)

#-------------------System Service options----------------------
GENOSOPTS=-DCMFILE_REORG_1 -DCMFILE_REORG_2 -DTENB_ACC

# For No error class
#PRDOPTS=-DKW -DCMFILE_REORG_1 -UNO_ERRCLS

# Product options for portable build
PRDPTOPTS=$(PRDOPTS) -DKW $(GENOSOPTS) -UxNO_ERRCLS 
...
PRDACCOPTS=$(PRDOPTS) -DKW -DNH -DPJ -DRG -DSM $(CMD_LINE)\
			  -DCMXTA_MASTER -UNO_ERRCLS $(CM_INETOPTS)
...
-DDEBUGNOEXIT -DSS_DRVR_SUPPORT -DSS_MT_TMR -DSS_TSKLOG_ENABLE
...
PT_INC_PATH="-I$(CM_DIR) -I$(KW_DIR) -I../../cm -I../../mt"
# for m68k 
...
ACC_INC_PATH="-I$(KW_DIR) -I$(KWACC_DIR) -I$(SM_DIR) -I$(CM_DIR)\
...
#INSCC="insure"
#INSLD="insure"
INSCC="/usr/local/insure71/bin/insure"
INSLD="/usr/local/insure71/bin/insure"
INSLOPTS="-o $(OUTNAME)"
...
#LNXCC="quantify gcc -m32"
#LNXLD="quantify gcc -m32"
#LNXLIBLD="quantify ld"
LNXCC="gcc -m32"
LNXLD="gcc -m32"
LNXLIBLD="ld"
...
#PURIFY 
PURCC="purify --cache-dir=/tmp gcc -m32 -DUSE_PURE -DPURE"
...
# For non-ANSI Compilation
#MRIENV="-DELVIS_68040 -UNOERRCHK -UNO_ERRCLS -DNOCONAVL"
...
SMOPTS=-DCMFILE_REORG_1 -DCMFILE_REORG_2 -DDEBUGP -DKW_DEBUG -DKW
...
KW_INC=$(KW_DIR)/kw.h $(KW_DIR)/kw.x $(KW_DIR)/kw_err.h	\
        $(KW_DIR)/kw_dl.h   $(KW_DIR)/kw_dl.x $(KW_DIR)/kw_ul.h \
        $(KW_DIR)/kw_env.h 

# RLC acceptance test includes LKWAC_INC= $(KWACC_DIR)/kw_acc.x $(KWACC_DIR)/kw_acc.h
...
KWAC_SRCS = \
	...
	$(SY_DIR)/cm_xta_txn.c         \
	$(SY_DIR)/cm_xta_res.c         \
	$(SY_DIR)/cm_xta_queue.c       \
	$(SY_DIR)/cm_xta_master.c      \
	$(SY_DIR)/cm_xta_reg.c         \
	$(SY_DIR)/cm_xta_tst.c         \
	$(SY_DIR)/cm_xta_log.c         \
	$(SY_DIR)/cm_xta_ipc.c         \
	$(SY_DIR)/cm_xta_flag.c        \
	$(SY_DIR)/cm_xta_intreg.c      \
	$(SY_DIR)/cm_xta_inthdl.c      \
	$(SY_DIR)/cm_xta_intutl.c      \
	$(SY_DIR)/cm_xta_py.c          \
	$(SY_DIR)/cm_xta_tcfsm.c       \
	$(SY_DIR)/cm_xta_ldfsm.c       \
	$(SY_DIR)/cm_xta_xml.c         \
	$(SY_DIR)/cm_xta_ex_ms.c       \
	$(SY_DIR)/cm_xta_tgfsm.c       \
	$(SY_DIR)/cm_xta_tafsm.c       \
	$(SY_DIR)/cm_xta_slave.c       \
...
KWACCM_OBJS=\
   $(KWACC_DIR)/cm_xta_slave.$(OBJ) \
	$(KWACC_DIR)/cm_xta_reg.$(OBJ) 	\
	$(KWACC_DIR)/cm_xta_ipc.$(OBJ) 	\
	$(KWACC_DIR)/kwac_prof.$(OBJ) 	\
	$(KWACC_DIR)/kwac_tst.$(OBJ)
...
KW_SRCS= \
   ...
   $(KW_DIR)/kw_ptmi.c     \
   $(KW_DIR)/kw_ptui.c     \
   $(KW_DIR)/kw_dl_ex_ms.c    \
   $(KW_DIR)/kw_ul_ex_ms.c    \
   $(KW_DIR)/kw_tmr.c      \
   $(KW_DIR)/kw_amm_ul.c  \
   $(KW_DIR)/kw_amm_dl.c  \
   $(KW_DIR)/kw_udx.c    \
   $(KW_DIR)/kw_udx_ul.c    \
   $(KW_DIR)/kw_udx_dl.c    \
   $(KW_DIR)/kw_udx_ptul.c \
   $(KW_DIR)/kw_udx_ptdl.c
#	$(KW_DIR)/kw_id.c
...
KW_OBJS= \
	$(KW_ID_OBJS)                \
	$(SY_DIR)/kw_lmm.$(OBJ)      \
	$(SY_DIR)/kw_cfg_dl.$(OBJ)      \
	$(SY_DIR)/kw_cfg_ul.$(OBJ)      \
	$(SY_DIR)/kw_dbm_dl.$(OBJ)      \
	$(SY_DIR)/kw_dbm_ul.$(OBJ)      \
	$(SY_DIR)/kw_lim.$(OBJ)      \
	$(SY_DIR)/kw_tmm_dl.$(OBJ)      \
	$(SY_DIR)/kw_tmm_ul.$(OBJ)      \
	$(SY_DIR)/kw_utl_dl.$(OBJ)      \
	$(SY_DIR)/kw_utl_ul.$(OBJ)      \
	$(SY_DIR)/kw_umm_dl.$(OBJ)      \
	$(SY_DIR)/kw_umm_ul.$(OBJ)      \
	$(SY_DIR)/kw_uim.$(OBJ)      \
	$(SY_DIR)/kw_ptmi.$(OBJ)     \
	$(SY_DIR)/kw_ptui.$(OBJ)     \
	$(SY_DIR)/kw_dl_ex_ms.$(OBJ)    \
	$(SY_DIR)/kw_ul_ex_ms.$(OBJ)    \
	$(SY_DIR)/kw_tmr.$(OBJ)      \
	$(SY_DIR)/kw_amm_ul.$(OBJ)  \
	$(SY_DIR)/kw_amm_dl.$(OBJ)  \
	$(SY_DIR)/kw_udx.$(OBJ)    \
	$(SY_DIR)/kw_udx_ul.$(OBJ)    \
	$(SY_DIR)/kw_udx_dl.$(OBJ)    \
	$(SY_DIR)/kw_udx_ptul.$(OBJ) \
	$(SY_DIR)/kw_udx_ptdl.$(OBJ) 
...
#	$(KW_DIR)/kw_id.$(OBJ)    \
#	$(KW_DIR)/kw_amm.$(OBJ)    \
#	$(KW_DIR)/kw_amm_dl.$(OBJ) \
#	$(KW_DIR)/kw_amm_ul.$(OBJ) \
#	$(KW_DIR)/kw_cfg.$(OBJ) \
#	$(KW_DIR)/kw_cfg_dl.$(OBJ) \
#	$(KW_DIR)/kw_cfg_ul.$(OBJ) \
#	$(KW_DIR)/kw_dbm.$(OBJ) \
#	$(KW_DIR)/kw_dbm_dl.$(OBJ) \
#	$(KW_DIR)/kw_dbm_ul.$(OBJ) \
#	$(KW_DIR)/kw_dl_ex_ms.$(OBJ) \
#	$(KW_DIR)/kw_ex_ms.$(OBJ) \
#	$(KW_DIR)/kw_lim.$(OBJ) \
#	$(KW_DIR)/kw_lmm.$(OBJ) \
#	$(KW_DIR)/kw_ptli.$(OBJ) \
...
#	$(KW_DIR)/kw_ptui.$(OBJ) \
#	$(KW_DIR)/kw_tmm.$(OBJ) \
#	$(KW_DIR)/kw_tmm_dl.$(OBJ) \
#	$(KW_DIR)/kw_tmm_ul.$(OBJ) \
#	$(KW_DIR)/kw_tmr.$(OBJ) \
#	$(KW_DIR)/kw_tst.$(OBJ) \
#	$(KW_DIR)/kw_udx.$(OBJ) \
#	$(KW_DIR)/kw_udx_dl.$(OBJ) \
#	$(KW_DIR)/kw_udx_pt.$(OBJ) \
#	$(KW_DIR)/kw_udx_ptdl.$(OBJ) \
#	$(KW_DIR)/kw_udx_ptul.$(OBJ) \
#	$(KW_DIR)/kw_udx_ul.$(OBJ) \
#	$(KW_DIR)/kw_uim.$(OBJ) \
#	$(KW_DIR)/kw_uim_dl.$(OBJ) \
#	$(KW_DIR)/kw_uim_ul.$(OBJ) \
#	$(KW_DIR)/kw_ul_ex_ms.$(OBJ) \
#	$(KW_DIR)/kw_umm.$(OBJ) \
#	$(KW_DIR)/kw_umm_dl.$(OBJ) \
#	$(KW_DIR)/kw_umm_ul.$(OBJ) \
#	$(KW_DIR)/kw_utl.$(OBJ) \
#	$(KW_DIR)/kw_utl_dl.$(OBJ) \
#	$(KW_DIR)/kw_utl_ul.$(OBJ)
#Pradeep - New end
...
$(SY_DIR)/kw_cfg_dl.$(OBJ): $(KW_DIR)/kw_cfg_dl.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_cfg_dl.c -o $(SY_DIR)/kw_cfg_dl.$(OBJ)

$(SY_DIR)/kw_cfg_ul.$(OBJ): $(KW_DIR)/kw_cfg_ul.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_cfg_ul.c -o $(SY_DIR)/kw_cfg_ul.$(OBJ)

$(SY_DIR)/kw_dbm_dl.$(OBJ): $(KW_DIR)/kw_dbm_dl.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_dbm_dl.c -o $(SY_DIR)/kw_dbm_dl.$(OBJ)

$(SY_DIR)/kw_dbm_ul.$(OBJ): $(KW_DIR)/kw_dbm_ul.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_dbm_ul.c -o $(SY_DIR)/kw_dbm_ul.$(OBJ)

$(SY_DIR)/kw_lim.$(OBJ): $(KW_DIR)/kw_lim.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_lim.c -o $(SY_DIR)/kw_lim.$(OBJ)

$(SY_DIR)/kw_tmm_dl.$(OBJ): $(KW_DIR)/kw_tmm_dl.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_tmm_dl.c -o $(SY_DIR)/kw_tmm_dl.$(OBJ)

$(SY_DIR)/kw_tmm_ul.$(OBJ): $(KW_DIR)/kw_tmm_ul.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_tmm_ul.c -o $(SY_DIR)/kw_tmm_ul.$(OBJ)

$(SY_DIR)/kw_utl_dl.$(OBJ): $(KW_DIR)/kw_utl_dl.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_utl_dl.c -o $(SY_DIR)/kw_utl_dl.$(OBJ)

$(SY_DIR)/kw_utl_ul.$(OBJ): $(KW_DIR)/kw_utl_ul.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_utl_ul.c -o $(SY_DIR)/kw_utl_ul.$(OBJ)

$(SY_DIR)/kw_umm_dl.$(OBJ): $(KW_DIR)/kw_umm_dl.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_umm_dl.c -o $(SY_DIR)/kw_umm_dl.$(OBJ)

$(SY_DIR)/kw_umm_ul.$(OBJ): $(KW_DIR)/kw_umm_ul.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_umm_ul.c -o $(SY_DIR)/kw_umm_ul.$(OBJ)
...
$(SY_DIR)/kw_dl_ex_ms.$(OBJ): $(KW_DIR)/kw_dl_ex_ms.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_dl_ex_ms.c -o $(SY_DIR)/kw_dl_ex_ms.$(OBJ)

$(SY_DIR)/kw_ul_ex_ms.$(OBJ): $(KW_DIR)/kw_ul_ex_ms.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_ul_ex_ms.c -o $(SY_DIR)/kw_ul_ex_ms.$(OBJ)

$(SY_DIR)/kw_tmr.$(OBJ): $(KW_DIR)/kw_tmr.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_tmr.c -o $(SY_DIR)/kw_tmr.$(OBJ)

$(SY_DIR)/kw_amm_ul.$(OBJ): $(KW_DIR)/kw_amm_ul.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_amm_ul.c -o $(SY_DIR)/kw_amm_ul.$(OBJ)

$(SY_DIR)/kw_amm_dl.$(OBJ): $(KW_DIR)/kw_amm_dl.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_amm_dl.c -o $(SY_DIR)/kw_amm_dl.$(OBJ)

$(SY_DIR)/kw_udx.$(OBJ): $(KW_DIR)/kw_udx.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_udx.c -o $(SY_DIR)/kw_udx.$(OBJ)

$(SY_DIR)/kw_udx_ul.$(OBJ): $(KW_DIR)/kw_udx_ul.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_udx_ul.c -o $(SY_DIR)/kw_udx_ul.$(OBJ)

$(SY_DIR)/kw_udx_dl.$(OBJ): $(KW_DIR)/kw_udx_dl.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_udx_dl.c -o $(SY_DIR)/kw_udx_dl.$(OBJ)

$(SY_DIR)/kw_udx_ptul.$(OBJ): $(KW_DIR)/kw_udx_ptul.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_udx_ptul.c -o $(SY_DIR)/kw_udx_ptul.$(OBJ)

$(SY_DIR)/kw_udx_ptdl.$(OBJ): $(KW_DIR)/kw_udx_ptdl.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_udx_ptdl.c -o $(SY_DIR)/kw_udx_ptdl.$(OBJ)
...
#$(SY_DIR)/kw_lmm.$(OBJ): $(KW_DIR)/kw_lmm.c $(SYS_INC) $(CM_INC) 
#	$(CC) -c $(CPRDOPTS)  $(KW_DIR)/kw_lmm.c -o $(SY_DIR)/kw_id.$(OBJ)
...
#$(SY_DIR)/kw_ptli.$(OBJ): $(KW_DIR)/kw_ptli.c $(SYS_INC) $(CM_INC) 
#	$(CC) -c $(CPRDOPTS)  $(SY_DIR)/kw_ptli.c -o $(SY_DIR)/kw_ptli.$(OBJ)
...
$(SY_DIR)/cm_xta_ex_ms.$(OBJ): $(SY_DIR)/cm_xta_ex_ms.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_ex_ms.c -o $(SY_DIR)/cm_xta_ex_ms.$(OBJ)

$(SY_DIR)/cm_xta_xml.$(OBJ): $(SY_DIR)/cm_xta_xml.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_xml.c -o $(SY_DIR)/cm_xta_xml.$(OBJ)

$(SY_DIR)/cm_xta_ldfsm.$(OBJ): $(SY_DIR)/cm_xta_ldfsm.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_ldfsm.c -o $(SY_DIR)/cm_xta_ldfsm.$(OBJ)

$(SY_DIR)/cm_xta_tcfsm.$(OBJ): $(SY_DIR)/cm_xta_tcfsm.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_tcfsm.c -o $(SY_DIR)/cm_xta_tcfsm.$(OBJ)

$(SY_DIR)/cm_xta_tgfsm.$(OBJ): $(SY_DIR)/cm_xta_tgfsm.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_tgfsm.c -o $(SY_DIR)/cm_xta_tgfsm.$(OBJ)

$(SY_DIR)/cm_xta_tafsm.$(OBJ): $(SY_DIR)/cm_xta_tafsm.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_tafsm.c -o $(SY_DIR)/cm_xta_tafsm.$(OBJ)

$(SY_DIR)/cm_xta_py.$(OBJ): $(SY_DIR)/cm_xta_py.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_py.c -o $(SY_DIR)/cm_xta_py.$(OBJ)

$(SY_DIR)/cm_xta_inthdl.$(OBJ): $(SY_DIR)/cm_xta_inthdl.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_inthdl.c -o $(SY_DIR)/cm_xta_inthdl.$(OBJ)

$(SY_DIR)/cm_xta_intreg.$(OBJ): $(SY_DIR)/cm_xta_intreg.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_intreg.c -o $(SY_DIR)/cm_xta_intreg.$(OBJ)

$(SY_DIR)/cm_xta_res.$(OBJ): $(SY_DIR)/cm_xta_res.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_res.c -o $(SY_DIR)/cm_xta_res.$(OBJ)

$(SY_DIR)/cm_xta_queue.$(OBJ): $(SY_DIR)/cm_xta_queue.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_queue.c -o $(SY_DIR)/cm_xta_queue.$(OBJ)

$(SY_DIR)/cm_xta_flag.$(OBJ): $(SY_DIR)/cm_xta_flag.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_flag.c -o $(SY_DIR)/cm_xta_flag.$(OBJ)

$(SY_DIR)/cm_xta_log.$(OBJ): $(SY_DIR)/cm_xta_log.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_log.c -o $(SY_DIR)/cm_xta_log.$(OBJ)

$(SY_DIR)/cm_xta_slave.$(OBJ): $(SY_DIR)/cm_xta_slave.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_slave.c -o $(SY_DIR)/cm_xta_slave.$(OBJ)

$(SY_DIR)/cm_xta_master.$(OBJ): $(SY_DIR)/cm_xta_master.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_master.c -o $(SY_DIR)/cm_xta_master.$(OBJ)

$(SY_DIR)/cm_xta_reg.$(OBJ): $(SY_DIR)/cm_xta_reg.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_reg.c -o $(SY_DIR)/cm_xta_reg.$(OBJ)

$(SY_DIR)/cm_xta_tst.$(OBJ): $(SY_DIR)/cm_xta_tst.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_tst.c -o $(SY_DIR)/cm_xta_tst.$(OBJ)

$(SY_DIR)/cm_xta_ipc.$(OBJ): $(SY_DIR)/cm_xta_ipc.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_ipc.c -o $(SY_DIR)/cm_xta_ipc.$(OBJ)

$(SY_DIR)/cm_xta_txn.$(OBJ): $(SY_DIR)/cm_xta_txn.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_txn.c -o $(SY_DIR)/cm_xta_txn.$(OBJ)

$(SY_DIR)/cm_xta_intutl.$(OBJ): $(SY_DIR)/cm_xta_intutl.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_intutl.c -o $(SY_DIR)/cm_xta_intutl.$(OBJ)

$(SY_DIR)/cm_xta_tmr.$(OBJ): $(SY_DIR)/cm_xta_tmr.c $(SYS_INC) $(KWACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SY_DIR)/cm_xta_tmr.c -o $(SY_DIR)/cm_xta_tmr.$(OBJ)
...
#********************************************************************30**
#  
#        End of file:     kw.mak@@/main/TeNB_Main_BR/5 - Mon Aug 11 16:43:12 2014
#    
#********************************************************************31*/
#
#********************************************************************40**
...
#/main/1      ---     gk   1. LTE RLC 2.1 release
#********************************************************************91*/
