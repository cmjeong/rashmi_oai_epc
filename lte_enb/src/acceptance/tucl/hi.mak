...
#
#       Sid:      hi.mak@@/main/tenb_5.0_SIB_KNOWNSENSE/4 - Wed Oct 28 11:30:44 2015
#
#       Prg:    asa
#
#********************************************************************21*/
...
#HIT (TUCL - user)
#HITLCFLG=-DLCSBLIHIT -DHI_REL_1_4 -DLCEGLIHIT -DLCHCLIHIT -DLCHIUIHIT
HITLCFLG=-DLCHIUIHIT -DLCHCLIHIT -DLCSOLIHIT

# Enable this flag if compiling with multi-threaded TUCL
#LHI (TUCL - LM)
#LHILCFLG=-DLCHIMILHI -USM -DLCLHI
...
#HIOPTS= -DHI -DLCHIMILHI -DSM -DLCSMHIMILHI -UEG -DHI_NO_CHK_RES -DCM_INET2
HIOPTS=-DHI $(HITLCFLG) $(LHILCFLG) $(HIDBGFLG) -DCM_INET2 \
       -DHI_MULTI_THREADED -DLOCAL_INTF -DIPV4_OPTS_SUPPORTED\
		 -DUSE_PURE
       #-DHI_TLS \
...
#
# For ANSI Compilation
LNXENV="-DSUNOS -DSS_LINUX -DANSI -DNOCONAVL -DUSE_PURE"
LNXCOPTS="-g3 -ansi -pipe -pedantic -Wall -Wno-comment -Wshadow \
	  -Wcast-align -Wcast-qual -Wstrict-prototypes \
          -Wmissing-prototypes -fno-strict-aliasing --std=c99"
...
$(BINLNXPACC):
	...
	LD=$(PLNXLD) COPTS=$(LNXCOPTS) LOPTS=$(LNXLOPTS) \
	LIBS="$(LNXLIBS) $(SSLLIBS)" INC_PATH=$(ACC_INC_PATH) \
	OSOPTS="$(LNXOSOPTS)" OS_SRCS="$(MT_SRCS) $(SS_SRCS)" \
	OBJ=$(UNIX_OBJ_SUFFIX) OS_OBJS="$(MT_OBJS) $(SS_OBJS)" OS_DIR=$(MT_DIR)
...
$(BINPURACC):
	...
	LD=$(PURLD) COPTS=$(LNXCOPTS) LOPTS=$(LNXLOPTS) \
	LIBS="$(LNXLIBS) $(SSLLIBS)" INC_PATH=$(ACC_INC_PATH) \
	OSOPTS="$(LNXOSOPTS)" OS_SRCS="$(MT_SRCS) $(SS_SRCS)" \
	OBJ=$(UNIX_OBJ_SUFFIX) OS_OBJS="$(MT_OBJS) $(SS_OBJS)" OS_DIR=$(MT_DIR)
...
$(SY_DIR)/cm_mem.$(OBJ): $(CM_DIR)/cm_mem.c $(SYS_INC) $(SS_INC)
	$(CC) -c $(COSOPTS) $(CM_DIR)/cm_mem.c
...
#********************************************************************30**
#  
#        End of file:     hi.mak@@/main/tenb_5.0_SIB_KNOWNSENSE/4 - Wed Oct 28 11:30:44 2015
#    
#********************************************************************31*/
#
#********************************************************************40**
