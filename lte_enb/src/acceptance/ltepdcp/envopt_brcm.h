...
/********************************************************************20**
     ...
     Sid:      envopt_brcm.h@@/main/TeNB_Main_BR/5 - Mon Aug 11 16:46:55 2014
...
#endif /* ELVIS_PPC860 */
#endif /* ELVIS_68302 */
/* Broadom SSI Instrumentation compilation dependency */
#ifdef BRDCM_SSI_MEM_LEAK_DEBUG_LEVEL2
#ifndef BRDCM_SSI_MEM_LEAK_DEBUG_LEVEL1
#define BRDCM_SSI_MEM_LEAK_DEBUG_LEVEL1
#endif
#endif
#ifdef QUICCADS
#define PROC_68360
...
#if(defined(LTE_TDD) && !defined(BRDCM))
...
/********************************************************************30**
         ...
         End of file:     envopt_brcm.h@@/main/TeNB_Main_BR/5 - Mon Aug 11 16:46:55 2014
