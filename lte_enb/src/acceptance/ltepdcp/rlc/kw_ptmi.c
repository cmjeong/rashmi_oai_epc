...
/********************************************************************20**
        ...
        Sid:      kw_ptmi.c@@/main/TeNB_Main_BR/4 - Thu Apr 24 17:07:48 2014
...
#else
PUBLIC S16 KwMiLkwL2MeasCfm(pst, trc, mBuf)
Pst * pst;
KwL2MeasCfmEvt *measEvt;
#endif
{
...
/********************************************************************30**
         ...
         End of file:     kw_ptmi.c@@/main/TeNB_Main_BR/4 - Thu Apr 24 17:07:48 2014
