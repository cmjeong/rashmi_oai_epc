...
/************************************************************************
     ...
     Sid:      kw_udx_ptdl.c@@/main/TeNB_Main_BR/4 - Thu Apr 24 17:07:51 2014
...
PRIVATE S16 PtDlUdxCfgCfm ARGS((Pst *pst, SuId suId, UdxCfgCfmInfo *cfmInfo));
...
PRIVATE CONSTANT UdxStaUpdCfm KwDlUdxStaUpdCfmMt[UDX_MAX_SEL] =
{
#ifdef LCKWULUDX
   cmPkUdxStaUpdCfm,
#else
...
#endif
#ifdef LWLCKWULUDX
   cmPkUdxStaUpdCfm,            /* 1 - loosely coupled */
#else
   PtDlUdxStaUpdCfm,            /* 1 - loosely coupled, portable  */
#endif /* LCKWUIKWU */
#ifdef KW
   KwUlUdxStaUpdCfm,            /* 2 - tightly coupled, RRC  */
#else
   PtDlUdxStaUpdCfm,            /* 2 - tightly coupled, portable */
#endif /* KW */
};
...
#endif
{
   ...
   /* jump to specific primitive depending on configured selector */
   (*kwDlUdxUeIdChgCfmMt[pst->selector])(pst, suId,transId,ueInfo,status);
...
{
   TRC3(KwDlUdxStaUpdCfm);

   RETVALUE((*KwDlUdxStaUpdCfmMt[pst->selector])(pst,suId, rlcId, pBufLst));
}

/**********************************************************************
 
         End of file:     kw_udx_ptdl.c@@/main/TeNB_Main_BR/4 - Thu Apr 24 17:07:51 2014
