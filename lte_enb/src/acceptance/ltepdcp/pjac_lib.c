...
/********************************************************************20**
     ...
     Sid:      pjac_lib.c@@/main/TeNB_Main_BR/tenb_main_ccb/tenb_5.0_RIB/tenb_5.0_RIB_GA/5 - Mon Feb 15 12:53:07 2016
...
#endif
{
   ...
   pjAcLibObdCmpInitReq(NULLP, cmpCxt, rohc, cmpCxtId);
...
#endif
{
   ...
   pjAcLibObdCmpReq(NULLP, cmpCxtId, NULLP, mBuf, opSdu);
...
#endif
{
   ...
   pjAcLibObdDecmpReq(NULLP, cmpCxtId, NULLP, mBuf, opSdu, feedback);
...
#endif
{
   ...
   pjAcLibObdCmpCloseReq(NULLP, cmpCxtId);
...
#endif
{
   ...
   pjAcLibObdCmpResetReq(NULLP, cmpCxtId);
...
#endif
{
   ...
   pjAcLibObdCmpFbReq(NULLP, cmpCxtId, NULLP, feedback);
...
#endif
{
   ...
   ret = pjAcLibObdIntInitReq(NULLP, secCxt, intInfo, cxtId);
...
#endif
{
   ...
   ret = pjAcLibObdCpInitReq(NULLP, secCxt, algoType, cpKey, cxtId);
...
#endif
{
   ...
   pjAcLibObdUpInitReq(NULLP, secCxt, algoType, upKey, cxtId);
...
#endif
{
   ...
   pjAcLibObdIntProtReq(NULLP, intCxtId, secInp, NULLP, mBuf, macI);
...
#endif
{
   ...
   pjAcLibObdCipherReq(NULLP, secCxtId, NULLP, secInp, mBuf, opSdu);
...
#endif
{
   ...
   pjAcLibObdIntVerReq(NULLP, intCxtId, secInp, NULLP, mBuf, macI, status);
...
#endif
{
   ...
   pjAcLibObdDecipherReq(NULLP, intCxtId, NULLP, secInp, mBuf, opSdu);
...
#endif
{
   ...
   pjAcLibObdIntCloseReq(NULLP, intCxtId);
...
#endif
{
   ...
   pjAcLibObdCipherCloseReq(NULLP, cxtId);
...
#endif
{
   ...
   pjAcLibObdCipherCloseReq(NULLP, upCxtId);
...
#endif
{
   ...
   PjDlRbCb *rbCb = NULLP;
   SCpyMsgMsg(mBuf,0,0,opSdu);

#ifdef TENB_T2K_ACC   
   /* The below code is added in acceptance for simulating the case when:
    * SRB : Integrity protection & Ciphering both applicable 
    * DRB : Compression & Ciphering both applicable */
   ...
   {
      rbCb = (((PjDlUeCb*)(libTrans->ueCb))->drbCb[(libTrans->rbId + 1)]);
      if((rbCb != NULLP) && (rbCb->rohc.hdrCmpUsed))
      {
         PJ_FREE_BUF(mBuf);
      }
   }
...
#if 0
#ifdef ANSI
PUBLIC U32 pjMsCheckSpaccQueue
(
)
#else
PUBLIC U32 pjMsCheckSpaccQueue ()
...
/********************************************************************30**
         ...
         End of file:     pjac_lib.c@@/main/TeNB_Main_BR/tenb_main_ccb/tenb_5.0_RIB/tenb_5.0_RIB_GA/5 - Mon Feb 15 12:53:07 2016
