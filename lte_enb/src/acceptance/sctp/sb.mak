...
#
#       Sid:      sb.mak@@/main/tenb_5.0_SIB_KNOWNSENSE/2 - Fri Sep  4 18:02:03 2015
#
#       Prg:    wvdl
#
#********************************************************************21*/
...
FLAGS_ADDED=-DxCMFILE_REORG_2 -DxLSB2 -DxLSB3 -DxLSB4 -DxLSB5 -DxLSB6 -DxLSB7  -DxLSB8 -DxSCT2 -DxSCT3 -DxSCT4 -DSCT_ENDP_MULTI_IPADDR

PRDOPTS=$(FLAGS_ADDED) -DSB  -DLCSBUISCT -DLCSZLISCT -DLCCZLISCT -DLCLSB -DSM -DLSB4  -DLSB8 -DHI_REL_1_4 -DLCSBLIHIT -DLCHIUIHIT -DHI_REL_1_4 -DLCEGLIHIT\
		  -DLCSBMILSB -DLCSMSBMILSB -DSB_CHECKSUM -DSB_CHECKSUM_CRC -DCMFILE_REORG_1 -DDEBUGP -DSB_DEBUGP -DUSE_PURE
...
# MTSS Options
SS_INC=$(CM_DIR)/cm_mem.h $(CM_DIR)/cm_mem.x $(SS_DIR)/ss_dep.h \
...
$(SY_DIR)/lsb.$(OBJ): $(CM_DIR)/lsb.c $(SYS_INC) $(SBALL_INC)
	$(CC) -c $(CPRDOPTS) $(CM_DIR)/lsb.c -o $(SY_DIR)/lsb.$(OBJ)
...
$(SY_DIR)/cm_mem.$(OBJ): $(CM_DIR)/cm_mem.c $(SYS_INC)
	$(CC) -c $(CSSOPTS) $(CM_DIR)/cm_mem.c -o $(SY_DIR)/cm_mem.$(OBJ)
...
#********************************************************************30**
#
#        End of file:     sb.mak@@/main/tenb_5.0_SIB_KNOWNSENSE/2 - Fri Sep  4 18:02:03 2015
#
#********************************************************************31*/
#
#********************************************************************40**
