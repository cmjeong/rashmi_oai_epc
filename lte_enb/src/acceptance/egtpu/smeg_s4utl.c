...
/********************************************************************20**
     ...
     Sid:      smeg_s4utl.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 18:19:18 2015
...
#ifdef ANSI
PUBLIC Void  egEgtBuildS4CrtIindDatFwdTunRspMsg
(
CmXtaTCCb         *tcCb,
CmXtaSpCb         *spCb,
EgMsg             **egMsg,
...
#else
PUBLIC Void egEgtBuildS4CrtIindDatFwdTunRspMsg(tcCb, spCb, egMsg, intfType, memInfo)
CmXtaTCCb         *tcCb;
CmXtaSpCb         *spCb;
EgMsg             **egMsg;
U8                intfType;
...
#ifdef ANSI
PUBLIC Void  egEgtBuildS4DwLnkDatnNotAckMsg
(
CmXtaTCCb         *tcCb,
CmXtaSpCb         *spCb,
EgMsg             **egMsg,
...
#else
PUBLIC Void egEgtBuildS4DwLnkDatnNotAckMsg(tcCb, spCb, egMsg, intfType, memInfo)
CmXtaTCCb         *tcCb;
CmXtaSpCb         *spCb;
EgMsg             **egMsg;
U8                intfType;
...
#endif /* ANSI */
{
   ...
   TRC2(egEgtBuildS4DwLnkDatnNotAckMsg)
...
/**********************************************************************
         ...
         End of file:     smeg_s4utl.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 18:19:18 2015
