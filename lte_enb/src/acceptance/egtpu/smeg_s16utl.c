...
/********************************************************************20**
     ...
     Sid:      smeg_s16utl.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 18:19:13 2015
...
#ifdef ANSI
PUBLIC Void  egEgtBuildS16CctxRspMsg
(
CmXtaTCCb         *tcCb,
CmXtaSpCb         *spCb,
EgMsg             **egMsg,
...
#else
PUBLIC Void egEgtBuildS16CctxRspMsg(tcCb, spCb, egMsg, intfType, memInfo)
CmXtaTCCb         *tcCb;
CmXtaSpCb         *spCb;
EgMsg             **egMsg;
U8                intfType;
...
/**********************************************************************
         ...
         End of file:     smeg_s16utl.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 18:19:13 2015
