...
#                         All rights reserved.
#
#     This egftware is confidential and proprietary to Continuous Computing 
#     Corporation (CCPU).  No part of this egftware may be reproduced,
...
#     egftware will perform substantially to CCPU specifications as
#     published at the time of shipment, exclusive of any updates or 
#     upgrades, and the media used for delivery of this egftware will be 
#     free from defects in materials and workmanship.  CCPU aleg warrants 
#     that has the corporate authority to enter into and perform under the   
#     Software License Agreement and it is the copyright owner of the egftware 
#     as originally delivered to its licensee.
#
#     CCPU MAKES NO OTHER WARRANTIES, EXPRESS OR IMPLIED, INCLUDING
#     WITHOUT LIMITATION WARRANTIES OF MERCHANTABILITY OR FITNESS FOR
#     A PARTICULAR PURPOSE WITH REGARD TO THIS EGFTWARE, SERVICE OR ANY RELATED
#     MATERIALS.
#
#     IN NO EVENT SHALL CCPU BE LIABLE FOR ANY INDIRECT, SPECIAL,
#     CONSEQUENTIAL DAMAGES, OR PUNITIVE DAMAGES IN CONNECTION WITH OR ARISING
#     OUT OF THE USE OF, OR INABILITY TO USE, THIS EGFTWARE, WHETHER BASED
...
#
#     This egftware and all related materials licensed hereby are
#     classified as "restricted computer egftware" as defined in clause
...
#     States.  The government's rights to the egftware and related
#     materials are limited and restricted as provided in clause
#     52.227-19 of the FAR.
#
#                    IMPORTANT LIMITATION(S) ON USE
#
#     The use of this egftware is limited to the use set
#     forth in the written Software License Agreement between CCPU and
#     its Licensee. Among other things, the use of this egftware
#     may be limited to a particular type of Designated Equipment, as 
#     defined in such Software License Agreement.
#     Before any installation, use or transfer of this egftware, please
#     consult the written Software License Agreement or contact CCPU at
#     the location set forth below in order to confirm that you are
#     engaging in a permissible use of the egftware.
#
#                    Continuous Computing Corporation
...
#
#       Sid:      eg.mak@@/main/TeNB_Main_BR/tenb_main_ccb/tenb_5.0_RIB/tenb_5.0_RIB_GA/11 - Mon Feb 15 12:53:12 2016
#
#       Prg:    kc
#
#********************************************************************21*/
...
FLAT_BUFFER_OPT= -UFLAT_BUFFER_OPT
...
EGOPTS=-DEG -DLCEGT -DLCEGUIEGT -DCCPU_OPT -DLCEULIEGT -DEGTPU_HDR_ALWAYS_PRSNT -DLCSMMILEG -DLCLEG -DSM -DEG -DLCEGMILEG -DLCSMEGMILEG\
		 -UEG_DEBUG -DLCEGLIHIT -DEGTP_U 
...
GENACCOSOPTS=-DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 -USS_SINGLE_THREADED -DSS_TICKS_SEC=SS_1MS  -DSS_DRVR_SUPPORT -DSM -DSS_MULTIPLE_PROCS -DIPV6_SUPPORTED -DxSS_MT_TMR -DEG_IPV6_SUPPORTED 
...
LNXENV="-DSUNOS -DSS_LINUX -DANSI -DxUSE_PURE -D_GNU_SOURCE -DNOCONAVL -D_USE_PURE -DREVIEW    -DDHI -DLEGV2 -DSS_USE_ZBC_MEMORY  -DEGTP_U_REL_9 -D_EG_PRINT_BUF_ $(FLAT_BUFFER_OPT)"
...
#
# For ANSI Compilation
PURENV="-DSUNOS -DSS_LINUX -DANSI -DPURE -DUSE_PURE -UNOCONAVL -DLEGV2 -D_USE_PURE -DREVIEW -DDTL -DSS_USE_ZBC_MEMORY  -DEGTP_U_REL_9 -D_EG_PRINT_BUF_ $(FLAT_BUFFER_OPT)"
...
COSOPTS=$(CENVOPTS) $(GENACCOSOPTS) $(OSOPTS) -UCONAVL
...
# Product source------------------------------------------------
ifeq ($(FLAT_BUFFER_OPT),-DFLAT_BUFFER_OPT)
EG_SRCS = \
      $(EG_DIR)/eg_li.c \
      $(EG_DIR)/eg_ptli.c\
      $(EG_DIR)/eg_tpt.c\
...
EG_OBJS = \
      ...
      $(SY_DIR)/eg_edm.$(OBJ)  \
      $(SY_DIR)/eg_tmr.$(OBJ) \
      $(SY_DIR)/eg_socklayer.$(OBJ)\
      $(SY_DIR)/eg_fbgpdu.$(OBJ)
else
EG_OBJS = \
      $(SY_DIR)/eg_li.$(OBJ) \
      $(SY_DIR)/eg_ptli.$(OBJ)  \
...
$(SY_DIR)/eg_fbgpdu.$(OBJ): $(EG_DIR)/eg_fbgpdu.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(EG_DIR)/eg_fbgpdu.c -o $(SY_DIR)/eg_fbgpdu.$(OBJ)


$(SY_DIR)/eg_socklayer.$(OBJ): $(EG_DIR)/eg_socklayer.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(EG_DIR)/eg_socklayer.c -o $(SY_DIR)/eg_socklayer.$(OBJ)
...
#********************************************************************30**
#
#        End of file:     eg.mak@@/main/TeNB_Main_BR/tenb_main_ccb/tenb_5.0_RIB/tenb_5.0_RIB_GA/11 - Mon Feb 15 12:53:12 2016
#
#********************************************************************31*/
#
#********************************************************************40**
