...
#               
#
#       Sid:      sz.mak.02@@/main/Tenb_Intg_Branch_CC/Br_Tenb_RTLinux_Intg/Br_Tenb_Mspd_T2K_Intg/Br_Tenb_Mspd_T2K_Intg_MS8.0_RC/1 - Fri Jul 19 15:25:12 2013
#
#       Prg:    sn
#
#********************************************************************21*/
...
# for loose coupling
PRDOPTS=-DSZ -DSZ_MME -DSZ_ENB -DLSZV1 -DCM_PASN_CRIT_HANDL -DSZTV1 -DSZTV2 -DSZTV3 \
	-DCM_PASN_ESC_SUPPORT -DCM_PASN_CLASS_IDTYPE -DCM_PASN_DBG    \
        -DLCSZT -DLCLSZ -DLCSCT -DLCSMSZMILSZ -DLCSZMILSZ -DLCUZLISZT \
	-DLWLCSZT -DLCHIUIHIT -DLCSBLIHIT -DLCHIMILHI -DLCSMHIMILHI -DLCLHI -DLCSBUISCT -DLCDMUISCT -US1AP_REL8A0 -DS1AP_REL9A6 \
		  -DSZ_DYNAMIC_PEER -USZ_USTA -DLCSZMILSZ -UUSE_PURE \
		  -DS1AP_REL9A6 -DTENB_ACC -DS1AP_REL11IE -DCM_PASN_ESC_SUPPORT -DCM_PASN_CLASS_IDTYPE -DCM_PASN_DBG -DLWLCSZT -DLCDMUISCT -DLCSBUISCT 
# for ksctp 
...
GENOSOPTS= -DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 \
           -DxSS_SINGLE_THREADED -DLONG_MSG -DSS_MULTIPLE_PROCS -DTENB_ACC 
...
# ---------------- For non-ANSI Compilation
#GNUENV="-DSUNOS -DSOLARIS -DSPARC -DPROC_SPARC -DUNIX -D__EXTENSIONS__"
...
GNULOPTS="-o $(OUTNAME) -lpthread -lposix4 -lnsl -lsocket -lpython2.4 -lm -ldl -lg++"
...
# For ANSI Compilation
#LNXENV="-DSUNOS -DANSI"
LNXENV="-DSUNOS   -DSS_LINUX -DANSI -DNOCONAVL  -D_GNU_SOURCE"
#LNXENV="-DSUNOS   -DSS_LINUX "
LNXCOPTS="-g3 -ansi -Wall -Wno-comment -pipe -Wshadow -Wno-cast-qual \
   -pedantic -Wimplicit -Wunused "
...
#PURIFY 
PURCC="purify --cache-dir=/tmp g++ -m32 -DUSE_PURE -DPURE"
PURLD="purify --cache-dir=/tmp g++ -m32"
...
SZT_INC=$(CM_SZT_DIR)/szt.h $(CM_SZT_DIR)/szt.x $(CM_SZT_DIR)/szt_asn.h $(CM_SZT_DIR)/szt_asn.x \
         $(CM_SZT_DIR)/szt_3gasn.h $(CM_SZT_DIR)/szt_3gasn.x
...
SZALL_INC=$(LSZ_INC) $(SZT_INC) $(SZ_INC) 
...
SZ_ACC_SRCS= \
	...
	$(SZACC_DIR)/szac_sztutl_r9.c \
	$(SZACC_DIR)/szac_sztutl_r11.c \
	...
	$(SZACC_DIR)/szac_sctutl_r9.c \
	$(SZACC_DIR)/szac_sctutl_r11.c \
	...
	$(SZACC_DIR)/szac_db.c   \
	$(SZACC_DIR)/szac_asn_db.c   \
	$(SZACC_DIR)/szac_asn_pk.c   \
	$(SZACC_DIR)/szac_asn_unpk.c   \
...
SZ_ACC_OBJS= \
	...
	$(SY_DIR)/szac_sztutl_r9.$(OBJ)    \
	$(SY_DIR)/szac_sztutl_r11.$(OBJ)    \
	...
	$(SY_DIR)/szac_sctutl_r9.$(OBJ)    \
	$(SY_DIR)/szac_sctutl_r11.$(OBJ)    \
	...
	$(SY_DIR)/szac_db.$(OBJ)   \
	$(SY_DIR)/szac_asn_db.$(OBJ)   \
	$(SY_DIR)/szac_asn_pk.$(OBJ)   \
	$(SY_DIR)/szac_asn_unpk.$(OBJ)   \
...
SZCM_SRCS= \
	...
	$(CM_SZT_DIR)/szt.c        \
	$(CM_SZT_DIR)/szt_pk.c        \
	$(CM_SZT_DIR)/szt_3gpk.c        \
	$(CM_SZT_DIR)/szt_unpk.c        \
	$(CM_SZT_DIR)/szt_3gunpk.c        \
...
SM_SRCS= \
	...
	$CM_SMHI_DIR/smhiexms.c \
	$CM_SMHI_DIR/smhiptmi.c \
	$CM_SMSB_DIR/smsbexms.c \
	$CM_SMSB_DIR/smsbptmi.c \
...
$(BINLNXLIB):
    ...
    LD=$(LNXLIBLD) COPTS=$(LNXCOPTS) LOPTS=$(LNXLIBOPTS) LIBS=$(LNXLIBLIBS) \
    OBJ=$(SOL_OBJ_SUFFIX)
...
$(SY_DIR)/szac_sztutl_r9.$(OBJ): $(SZACC_DIR)/szac_sztutl_r9.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_sztutl_r9.c -o $(SY_DIR)/szac_sztutl_r9.$(OBJ)
$(SY_DIR)/szac_sztutl_r11.$(OBJ): $(SZACC_DIR)/szac_sztutl_r11.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_sztutl_r11.c -o $(SY_DIR)/szac_sztutl_r11.$(OBJ)
...
$(SY_DIR)/szac_sctutl_r9.$(OBJ): $(SZACC_DIR)/szac_sctutl_r9.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_sctutl_r9.c -o $(SY_DIR)/szac_sctutl_r9.$(OBJ)

$(SY_DIR)/szac_sctutl_r11.$(OBJ): $(SZACC_DIR)/szac_sctutl_r11.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_sctutl_r11.c -o $(SY_DIR)/szac_sctutl_r11.$(OBJ)
...
$(SY_DIR)/szac_asn_db.$(OBJ): $(SZACC_DIR)/szac_asn_db.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_asn_db.c -o $(SY_DIR)/szac_asn_db.$(OBJ)

$(SY_DIR)/szac_asn_pk.$(OBJ): $(SZACC_DIR)/szac_asn_pk.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_asn_pk.c -o $(SY_DIR)/szac_asn_pk.$(OBJ)

$(SY_DIR)/szac_asn_unpk.$(OBJ): $(SZACC_DIR)/szac_asn_unpk.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_asn_unpk.c -o $(SY_DIR)/szac_asn_unpk.$(OBJ)
...
$(SY_DIR)/smhiexms.$(OBJ): $(CM_SMHI_DIR)/smhiexms.c $(SYS_INC) $(LSZ_INC)
	$(CC) -c $(CPRDOPTS) $(CHIOPTS) $(CSMOPTS) $(CM_SMHI_DIR)/smhiexms.c -o $(SY_DIR)/smhiexms.$(OBJ)

$(SY_DIR)/smhiptmi.$(OBJ): $(CM_SMHI_DIR)/smhiptmi.c $(SYS_INC) $(LSZ_INC)
	$(CC) -c $(CPRDOPTS) $(CHIOPTS) $(CSMOPTS) $(CM_SMHI_DIR)/smhiptmi.c -o $(SY_DIR)/smhiptmi.$(OBJ)

$(SY_DIR)/smsbexms.$(OBJ): $(CM_SMSB_DIR)/smsbexms.c $(SYS_INC) $(LSZ_INC)
	$(CC) -c $(CPRDOPTS) $(CSBOPTS) $(CSMOPTS) $(CM_SMSB_DIR)/smsbexms.c -o $(SY_DIR)/smsbexms.$(OBJ)

$(SY_DIR)/smsbptmi.$(OBJ): $(CM_SMSB_DIR)/smsbptmi.c $(SYS_INC) $(LSZ_INC)
	$(CC) -c $(CPRDOPTS) $(CSBOPTS) $(CSMOPTS) $(CM_SMSB_DIR)/smsbptmi.c -o $(SY_DIR)/smsbptmi.$(OBJ)
...
$(SY_DIR)/sz_3gdb.$(OBJ): $(SZ_DIR)/sz_3gdb.c $(SYS_INC) $(CM_INC) $(SZALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZ_DIR)/sz_3gdb.c -o $(SY_DIR)/sz_3gdb.$(OBJ)
...
$(SY_DIR)/szt_3gpk.$(OBJ): $(CM_SHT_DIR)/szt_3gpk.c $(SYS_INC) $(CM_INC) $(SZALL_INC)
	$(CC) -c $(CPRDOPTS) $(CM_SHT_DIR)/szt_3gpk.c -o $(SY_DIR)/szt_3gpk.$(OBJ)
...
$(SY_DIR)/szt_3gunpk.$(OBJ): $(CM_SHT_DIR)/szt_3gunpk.c $(SYS_INC) $(CM_INC) $(SZALL_INC)
	$(CC) -c $(CPRDOPTS) $(CM_SHT_DIR)/szt_3gunpk.c -o $(SY_DIR)/szt_3gunpk.$(OBJ)
...
#********************************************************************30**
#  
#        End of file:     sz.mak.02@@/main/Tenb_Intg_Branch_CC/Br_Tenb_RTLinux_Intg/Br_Tenb_Mspd_T2K_Intg/Br_Tenb_Mspd_T2K_Intg_MS8.0_RC/1 - Fri Jul 19 15:25:12 2013
#    
#********************************************************************31*/
#
#********************************************************************40**
