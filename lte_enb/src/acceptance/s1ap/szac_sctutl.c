...
/********************************************************************20**
     ...
     Sid:      szac_sctutl.c@@/main/3 - Mon Jan 10 22:15:59 2011
 ...
 */
#ifdef ANSI
PUBLIC S16  szAcUtlBuildS1APPdu
(
...
#else
PUBLIC S16  szAcUtlBuildS1APPdu (tcCb, spCb, pdu)
CmXtaTCCb    *tcCb;    /* tcCb data structure  */
CmXtaSpCb    *spCb;    /* spCb data structure  */
S1apPdu      **pdu;    /* S1AP PDU structure */
#endif
{
   ...
   switch(eventType)
   {
      case SZT_MSG_ID_CXT_SETUP_REQ:
         ret = szAcUtlSztFillInitCxtSetupReq(tcCb, spCb, pdu);
         break;

      case SZT_MSG_ID_INIT_UE_MSG:
         ret = szAcUtlSztFillInitUeMsg(tcCb, spCb, pdu);
         break;
      ...
      case SZT_MSG_ID_E_RAB_BRR_SETUP_REQ:
         ret = szAcUtlSztFillE_RABSetupRqst(tcCb, spCb, pdu);
         break;
      ...
      case SZT_MSG_ID_UE_CXT_REL_REQ:
         ret = szAcUtlSztFillUeCxtRlsReq(tcCb, spCb, pdu);
         break;

      case SZT_MSG_ID_PAGING:
         ret = szAcUtlSztFillPaging(tcCb, spCb, pdu);
         break;

      case SZT_MSG_ID_DL_NAS_TPT:
         ret = szAcUtlSztFillDwnlnkNasTpt(tcCb, spCb, pdu);
         break;

      case SZT_MSG_ID_UL_NAS_TPT:
         ret = szAcUtlSztFillUplnkNasTpt(tcCb, spCb, pdu);
         break;
      ...
      case SZT_MSG_ID_SETUP_RSP:
         ret = szAcUtlSztFillS1SetupRsp(tcCb, spCb, pdu);
         break;
      ...
      case SZT_MSG_ID_HO_REQ:
         ret = szAcUtlSztFillHovrRqst(tcCb, spCb, pdu);
         break;
      ...
      case SZT_MSG_ID_PATH_SWTCH_REQ:
         ret = szAcUtlSztFillPathSwRqst(tcCb, spCb, pdu);
         break;
      ...
      case SZT_MSG_ID_TRACE_START:
         ret = szAcUtlSztFillTraceStart(tcCb, spCb, pdu);
         break;
      ...
      case SZT_MSG_ID_OVLD_START:
         ret = szAcUtlSztFillOverloadStart(tcCb, spCb, pdu);
         break;

      case SZT_MSG_ID_OVLD_STOP:
         ret = szAcUtlSztFillOverloadStop(tcCb, spCb, pdu);
         break;
      ...
      case SZT_MSG_ID_CELL_TRAFFIC_TRACE:
         ret = szAcUtlSztFillCellTrafficTrace(tcCb, spCb, pdu);
         break;
...
#else
PUBLIC S16 szAcEncode (mem, s1apPdu, mBuf)
Mem     *mem;        /* Memory region and pool information */
S1apPdu **s1apPdu;   /* PDU to be encoded */
Buffer  **mBuf;      /* Buffer */
#endif
{
   ...
   {
      CMXTA_DBG_PARAM((_cmxtap, "szAcEncode(): Message Buffer Not allocated"));
...
#endif
{
   ...
   ret = (cmPAsnDecMsg((Void *)&((*s1apPdu)->pdu), CM_PASN_USE_MBUF, 
                  ...
                  (CmPAsnElmDef **)szAcMsgDb, CM_PASN_DROP_ELMNTS, 
...
/**********************************************************************
         ...
         End of file:     szac_sctutl.c@@/main/3 - Mon Jan 10 22:15:59 2011
