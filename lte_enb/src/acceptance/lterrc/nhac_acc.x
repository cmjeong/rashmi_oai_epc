...
/**********************************************************************
    ...
    Sid:      nhac_acc.x@@/main/3 - Fri Jul  1 01:12:55 2011
...
EXTERN S16  nhAcBuildRRCConReCfgComplete_r11
ARGS((
 Buffer **mBuf
));

#ifdef RRC_REL11
EXTERN S16  nhAcBuildRNReCfgComplete
ARGS((
 Buffer **mBuf
));
EXTERN S16  nhAcBuildMBMSCountingRsp
ARGS((
 Buffer **mBuf
));
EXTERN S16  nhAcBuildInterFreqRSTDMeasurementInd
ARGS((
 Buffer **mBuf
));
...
EXTERN S16  nhAcBuildRRCConSetupComplete_r11
ARGS((
 Buffer **mBuf,
 CmXtaSpCb    *spCb
));
EXTERN S16  nhAcBuildRRCConReEstReq_r9
ARGS((
Buffer **mBuf,
U8 cause
));
EXTERN S16  nhAcBuildRRCConReEstReq_r11
ARGS((
Buffer **mBuf,
U8 cause
));

EXTERN S16 nhAcBuildRRCConReq_r9 
ARGS((
Buffer **mBuf
));
EXTERN S16 nhAcBuildRRCConReq_r11
ARGS((
Buffer **mBuf
));

EXTERN S16  nhAcBuildRRCSecModeComplete_r11
ARGS((
 Buffer **mBuf
));
EXTERN S16  nhAcBuildRRCSecModeFail_r11
ARGS((
 Buffer **mBuf
));
EXTERN S16  nhAcBuildUpLinkTrfr_r11
ARGS((
 Buffer **mBuf
));
EXTERN S16  nhAcBuildRrcStatus_r11
ARGS((
 Buffer **mBuf
));

EXTERN S16  nhAcBuildHndovrPrepTfr_r11 ARGS(( Buffer **mBuf));
EXTERN S16  nhAcBuildCSFBParamCDMA2000Req_r11 ARGS(( Buffer **mBuf));
EXTERN S16  nhAcBuildUeCapInfo_r11 ARGS(( Buffer **mBuf));
EXTERN S16  nhAcBuildCountChkResp_r11 ARGS(( Buffer **mBuf, CmXtaTCCb *tcCb, CmXtaSpCb  *spC));
EXTERN S16  nhAcBuildMeasRpt_r11 ARGS(( Buffer **mBuf));
EXTERN S16  nhAcBuildRRCReEstCmp_r11 ARGS(( Buffer **mBuf));
...
#ifdef RRC_REL11
EXTERN S16 nhAcUtlFillNhuRNRecfgn_r10
ARGS((
CmXtaTCCb     *tcCb,
CmXtaSpCb     *spCb,
Ptr            evnt,
...
EXTERN S16 nhAcUtlFillNhuLoggedMeasurementCfg_r10
ARGS((
CmXtaTCCb     *tcCb,
CmXtaSpCb     *spCb,
Ptr            evnt,
...
#if 0 /* TODO - Need to add XTA TCs for IRAT HO */
...
/*ashenoy*/
EXTERN S16 nhAcHdlCpjDataFwdReq
ARGS((
CmXtaTCCb    *tcCb,    /* tcCb data structcre  */
CmXtaSpCb    *spCb     /* spCb data structcre  */
));
...
#ifdef LTERRC_REL9
EXTERN S16  nhAcBuildUeInfoResp_r11 ARGS((Buffer **mBuf,CmXtaTCCb    *tcCb,CmXtaSpCb    *spCb));
EXTERN S16  nhAcBuildProximityInd_r11 ARGS((Buffer **mBuf,CmXtaTCCb    *tcCb,CmXtaSpCb    *spCb));
#endif
...

/**********************************************************************
         End of file:     nhac_acc.x@@/main/3 - Fri Jul  1 01:12:55 2011
**********************************************************************/
/**********************************************************************
