...
/********************************************************************20**
     ...
     Sid:      czac_cztutl.c@@/main/2 - Tue Aug 30 18:35:46 2011
...
#include "czt_asn.h"            /* defines and macros for CZ */
...
#include "czt_asn.x"
#include "czt.x"           /* typedefs for CZCP */
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillGpReqPdu
(
CmXtaTCCb    *tcCb,
CmXtaSpCb    *spCb,
CztEvnt      **cztEvent
...
#else
PUBLIC S16 czAcUtlCztFillGpReqPdu(tcCb, spCb, cztEvent)
CmXtaTCCb    *tcCb;
CmXtaSpCb    *spCb;
CztEvnt      **cztEvent;
#endif
{
   ...
   switch(evntType)
   {
      case CZT_MSG_LOAD_IND:
         {
            if(czAcUtlCztFillLoadInd(tcCb, spCb, cztEvent)!=ROK)
            RETVALUE(RFAILED);
      ...
      case CZT_MSG_X2_SETUP:
         {
            if(czAcUtlCztFillX2SetupReq(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
      case CZT_MSG_RESET:
      ...
      case CZT_MSG_RSRC_ST_REQ:
         {
            if(czAcUtlCztFillResStatusRqst(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
      case CZT_MSG_RSRC_ST_UPD:
         {
            if(czAcUtlCztFillResStatusUpd(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
      case CZT_MSG_MOB_CHANGE_REQ:
       ...
       case CZT_MSG_RLF_INDICATION:
         {
            if(czAcUtlCztFillRlfInd(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillGpRspPdu
(
CmXtaTCCb    *tcCb,
CmXtaSpCb    *spCb,
CztEvnt      **cztEvent
...
#else
PUBLIC S16 czAcUtlCztFillGpRspPdu(tcCb, spCb, cztEvent)
CmXtaTCCb    *tcCb;
CmXtaSpCb    *spCb;
CztEvnt    **cztEvent;
#endif
{
   ...
   switch(eventType)
   {
      ...
      {
        if(czAcUtlCztResStatusResp(tcCb, spCb, (cztEvent)) != ROK)
               RETVALUE(RFAILED);
        break;
      }     
      case CZT_MSG_RSRC_ST_FAIL:
      {
         if(czAcUtlCztFillResStatusFail(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
         break;
      }
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillBmpReqPdu
(
CmXtaTCCb    *tcCb,
CmXtaSpCb    *spCb,
CztEvnt    **evnt
...
#else
PUBLIC S16 czAcUtlCztFillBmpReqPdu(tcCb, spCb, evnt)
CmXtaTCCb    *tcCb;
CmXtaSpCb    *spCb;
CztEvnt    **evnt;
#endif
{
   ...
   switch(eventType)
   {
      case CZT_MSG_HO_REQ:
         {
            if(czAcUtlCztFillHovrRqst(tcCb, spCb, (evnt)) != ROK)
               RETVALUE(RFAILED);
         }
         break;
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillBmpRspPdu
(
CmXtaTCCb    *tcCb,
CmXtaSpCb    *spCb,
CztEvnt     **evnt
...
#else
PUBLIC S16 czAcUtlCztFillBmpRspPdu(tcCb, spCb, evnt)
CmXtaTCCb    *tcCb;
CmXtaSpCb    *spCb;
CztEvnt     **evnt;
#endif
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillX2SetupReq
(
CmXtaTCCb    *tcCb,
CmXtaSpCb    *spCb,
CztEvnt      **pdu
...
#else
PUBLIC S16 czAcUtlCztFillX2SetupReq(tcCb, spCb, pdu)
CmXtaTCCb    *tcCb;
CmXtaSpCb    *spCb;
CztEvnt      **pdu;
#endif
{  
   ...
   czAcUtlFillTknU32(&(ie1->servedCellInfo.subframeAssignment),
      ...
      cmMemset(pLMNId, 0, sizeof(pLMNId));
      cmMemcpy((char *)pLMNId, "111",sizeof(pLMNId));
      len = 3;
      ...
      cmMemset(tAC, 0, sizeof(tAC));
      cmMemcpy((char *)tAC, "11",sizeof(tAC));
      len = 2;
      czFillTknStr4(&(ie4->extensionValue.u.cztTAC), (U8)len, tAC);
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillHovrRqst
(
CmXtaTCCb  *tcCb,
CmXtaSpCb  *spCb,
CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillHovrRqst(tcCb, spCb, pdu)
CmXtaTCCb  *tcCb;
CmXtaSpCb  *spCb;
CztEvnt    **pdu;
#endif
...
*/
   ...
   /*Fill the MDT Config */
   {
      ...
      czAcUtlFillTknU8(&(ie->value.u.cztTraceActvn.eUTRANTraceID),PRSNT_NODEF);
      cmMemset(eTrcid, 0, sizeof(eTrcid));
      cmMemcpy((char *)eTrcid, "11111111",sizeof(eTrcid));
      len = 8;
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillLoadInd
(
CmXtaTCCb  *tcCb,
CmXtaSpCb  *spCb,
CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillLoadInd(tcCb, spCb, pdu)
CmXtaTCCb  *tcCb;
CmXtaSpCb  *spCb;
CztEvnt    **pdu;
#endif
{
   ...
   /*Fill the ABS Information */
   {
      ...
      cmMemcpy((char *)abs_pattern_info, "111", sizeof(abs_pattern_info));
      len = 40;
      ...
      cmMemcpy((char *)measurement_subset, "111", sizeof(measurement_subset));
      len = 40;
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillResStatusRqst
(
CmXtaTCCb  *tcCb,
CmXtaSpCb  *spCb,
CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillResStatusRqst(tcCb, spCb, pdu)
CmXtaTCCb  *tcCb;
CmXtaSpCb  *spCb;
CztEvnt    **pdu;
#endif
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztResStatusResp
(
CmXtaTCCb  *tcCb,
CmXtaSpCb  *spCb,
CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztResStatusResp(tcCb, spCb, pdu)
CmXtaTCCb  *tcCb;
CmXtaSpCb  *spCb;
CztEvnt    **pdu;
#endif
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillResStatusFail
(
CmXtaTCCb  *tcCb,
CmXtaSpCb  *spCb,
CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillResStatusFail(tcCb, spCb, pdu)
CmXtaTCCb  *tcCb;
CmXtaSpCb  *spCb;
CztEvnt    **pdu;
#endif
{
   ...
   TRC2(czAcUtlCztFillResStatusFail);
   /* Initialize memory control point */
...
*/
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillResStatusUpd
(
CmXtaTCCb  *tcCb,
CmXtaSpCb  *spCb,
CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillResStatusUpd(tcCb, spCb, pdu)
CmXtaTCCb  *tcCb;
CmXtaSpCb  *spCb;
CztEvnt    **pdu;
#endif
{
   ...
   TRC2(czAcUtlCztFillResStatusUpd);
   ...
   */
   ...
   cmMemcpy((char *)usable_abs_pattern_info, "111", sizeof(usable_abs_pattern_info));
   len = 40; 
...
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillRlfInd
(
CmXtaTCCb  *tcCb,
CmXtaSpCb  *spCb,
CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillRlfInd(tcCb, spCb, pdu)
CmXtaTCCb  *tcCb;
CmXtaSpCb  *spCb;
CztEvnt    **pdu;
#endif
...
/********************************************************************30**
         ...
         End of file:     czac_cztutl.c@@/main/2 - Tue Aug 30 18:35:46 2011
