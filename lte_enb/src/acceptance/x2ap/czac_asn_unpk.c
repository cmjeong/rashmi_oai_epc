/**********************************************************************
     ...
     Sid:      czac_asn_unpk.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:08 2015

     Prg:     ad

**********************************************************************/
/* czt_unpk_c_001.main_1 : This file is newly generated for X2AP 3.1 release. */
...
#include <czac_asn.h>
#include <czac_asn.x>
#include <czac_asn_unpk.x>


/*#define cmUnpkCztPresence cmUnpkTknU32 */
namespace CZ_LTEX2AP_REL9_UNPK_C
{
   using namespace CZ_LTEX2AP_REL9_UNPK_X;
   using namespace CZ_LTEX2AP_REL9; 
   using namespace CZ_ASN_H_R9;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztPrivIE_ID(param, pntr, mBuf)
CztPrivIE_ID *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
        ...
        if(param->choice.pres) 
        {
                switch( param->choice.val ) 
                {
                        case PRIVIE_ID_LOCAL :
                                /*Unpacking CztPrivIE_IDlocal*/
                                CMCHKUNPK(cmUnpkTknU32, &param->val.local,
                                           mBuf); 
                                break;
...
#endif
{
        ...
        if( param->pres.pres != NOTPRSNT )
        {
                ...
                CMCHKUNPK(cmUnpkTknU32, &param->criticality, mBuf);
                {
                        S16 ret;
...
#endif
{
        ...
        if( param->pres.pres != NOTPRSNT )
        {
                CMCHKUNPKPTR(cmUnpkTknStrBSXL, &param->abs_pattern_info, ptr, mBuf);
                CMCHKUNPK(cmUnpkTknU32, &param->numberOfCellSpecificAntennaPorts, mBuf);
                CMCHKUNPKPTR(cmUnpkTknStrBSXL, &param->measurement_subset, ptr, mBuf);
...
#endif
{
        ...
        if( param->pres.pres != NOTPRSNT )
        {
                CMCHKUNPKPTR(cmUnpkTknStrBSXL, &param->usable_abs_pattern_info, ptr, mBuf);
...
#endif
{
        ...
        if( param->pres.pres != NOTPRSNT )
        {
                CMCHKUNPK(cmUnpkTknU32, &param->dL_ABS_status, mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnAS_SecurInform_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnAS_SecurInform_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_AS_SecurInform_ExtIEs(param, pntr, mBuf)
CztProtExtnField_AS_SecurInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CztProtIE_ID */
                CMCHKUNPK(cmUnpkTknU32, &param->id, mBuf);
                CMCHKUNPK(cmUnpkTknU32, &param->criticality, mBuf); 
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnAS_SecurInform_ExtIEsCls(
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_AS_SecurInform_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_AS_SecurInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr,
                         ...
                         param->noComp.val), (Ptr*)&(param->member));
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_AS_SecurInform_ExtIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztAS_SecurInform(param, pntr, mBuf)
CztAS_SecurInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CztKey_eNodeB_Star*/
                CMCHKUNPKPTR(cmUnpkTknStrBSXL, &param->key_eNodeB_star,
                             pntr, mBuf);
                /*Unpacking CztNextHopChainingCount*/  
                CMCHKUNPK(cmUnpkTknU32, &param->nextHopChainingCount, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_AS_SecurInform_ExtIEs, 
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnAllocnAndRetentionPriority_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnAllocnAndRetentionPriority_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_AllocnAndRetentionPriority_ExtIEs(param, pntr, mBuf)
CztProtExtnField_AllocnAndRetentionPriority_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;/*shishir*/
                        ret = cmUnpkCzt_ExtnAllocnAndRetentionPriority_ExtIEsCls(&param->extensionValue, param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_AllocnAndRetentionPriority_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_AllocnAndRetentionPriority_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {/*shishir*/
                ...
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_AllocnAndRetentionPriority_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztAllocnAndRetentionPriority(param, pntr, mBuf)
CztAllocnAndRetentionPriority *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CztPriorityLvl*/
                CMCHKUNPK(cmUnpkTknU32, &param->priorityLvl, mBuf);
                /*Unpacking CztPre_emptionCapblty*/ 
                CMCHKUNPK(cmUnpkTknU32, &param->pre_emptionCapblty, mBuf);
                /*Unpacking CztPre_emptionVulnerability */ 
                CMCHKUNPK(cmUnpkTknU32, &param->pre_emptionVulnerability, mBuf); /*shishir*/
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_AllocnAndRetentionPriority_ExtIEs, &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztBroadcastPLMNs_Item(param, pntr, mBuf)
CztBroadcastPLMNs_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztPLMN_Identity)*(param->noComp.val),
                                (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        /*Unpacking CztPLMN_Identity*/
                        CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &(param->member[i]),
                                      pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCause(param, pntr, mBuf)
CztCause *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if(param->choice.pres) 
        {
                ...
                {
                        case CAUSE_RADIONW :
                                /*Unpacking CztCauseRadionw*/
                                CMCHKUNPK(cmUnpkTknU32, &param->val.radioNw,
                                          mBuf); 
                                break;
                        case CAUSE_TRANSPORT :
                                /*Unpacking CztCauseTport*/
                                CMCHKUNPK(cmUnpkTknU32, &param->val.transport,
                                          mBuf); 
                                break;
/* czt_unpk_c_001.main_2 :  Fix for the build warnings */
#ifdef CZTV1
                        case CZT_CAUSE_PROTOCOL :
                                /*Unpacking CztCauseProt*/
                                CMCHKUNPK(cmUnpkTknU32, &param->val.protocol,
                                          mBuf); 
                                break;
                        case CZT_CAUSE_MISC :
                                /*Unpacking CztCauseMisc*/
                                CMCHKUNPK(cmUnpkTknU32, &param->val.misc,
                                          mBuf); 
                                break;
#else
                        case CAUSE_PROTOCOL :
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCellTyp_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCellTyp_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_CellTyp_ExtIEs(param, pntr, mBuf)
CztProtExtnField_CellTyp_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnCellTyp_ExtIEsCls(
                                 &param->extensionValue, param->id.val,
                                 pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_CellTyp_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_CellTyp_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, 
                  sizeof(CztProtExtnField_CellTyp_ExtIEs)*(param->noComp.val),
                  (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_CellTyp_ExtIEs,
                                      &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellTyp(param, pntr, mBuf)
CztCellTyp *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CatCell_Size*/
                CMCHKUNPK(cmUnpkTknU32, &param->cell_Size, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_CellTyp_ExtIEs,
                              &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCompositeAvailableCapacity_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCompositeAvailableCapacity_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_CompositeAvailableCapacity_ExtIEs(param, pntr, mBuf)
CztProtExtnField_CompositeAvailableCapacity_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;/*shishir*/
                        ret = cmUnpkCzt_ExtnCompositeAvailableCapacity_ExtIEsCls(&param->extensionValue, param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_CompositeAvailableCapacity_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_CompositeAvailableCapacity_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_CompositeAvailableCapacity_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCompositeAvailableCapacity(param, pntr, mBuf)
CztCompositeAvailableCapacity *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
               /*Unpacking CztCellCapacityClassValue*/
                CMCHKUNPK(cmUnpkTknU32, &param->cellCapacityClassValue, mBuf);
                /*Unpacking CztCapacityValue*/ 
                CMCHKUNPK(cmUnpkTknU32, &param->capacityValue, mBuf);/*shishir*/ 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_CompositeAvailableCapacity_ExtIEs, &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCompositeAvailableCapacityGroup_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCompositeAvailableCapacityGroup_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_CompositeAvailableCapacityGroup_ExtIEs(param, pntr, mBuf)
CztProtExtnField_CompositeAvailableCapacityGroup_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;/*shishir*/
                        ret = cmUnpkCzt_ExtnCompositeAvailableCapacityGroup_ExtIEsCls(&param->extensionValue, param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_CompositeAvailableCapacityGroup_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_CompositeAvailableCapacityGroup_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {/*shishir*/
                CMGETMBLK(pntr, sizeof(CztProtExtnField_CompositeAvailableCapacityGroup_ExtIEs)*(param->noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_CompositeAvailableCapacityGroup_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCompositeAvailableCapacityGroup(param, pntr, mBuf)
CztCompositeAvailableCapacityGroup *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztCompositeAvailableCapacity,
                             &param->dL_CompositeAvailableCapacity,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztCompositeAvailableCapacity,
                             &param->uL_CompositeAvailableCapacity,
                             pntr, mBuf); /*shishir*/
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_CompositeAvailableCapacityGroup_ExtIEs, &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCOUNTvalue_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCOUNTvalue_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_COUNTvalue_ExtIEs(param, pntr, mBuf)
CztProtExtnField_COUNTvalue_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnCOUNTvalue_ExtIEsCls(
                                       &param->extensionValue, 
                                       param->id.val, pntr,
                                       mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_COUNTvalue_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_COUNTvalue_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr,sizeof(
                     CztProtExtnField_COUNTvalue_ExtIEs)*(param->noComp.val),
                     (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_COUNTvalue_ExtIEs,
                                      &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCOUNTvalue(param, pntr, mBuf)
CztCOUNTvalue *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CztPDCP_SN*/
                CMCHKUNPK(cmUnpkTknU32, &param->pDCP_SN, mBuf);
                /*Unpacking CztHFN*/
                CMCHKUNPK(cmUnpkTknU32, &param->hFN, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_COUNTvalue_ExtIEs,
                              &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCriticalityDiag_IE_Lst_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCriticalityDiag_IE_Lst_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_CriticalityDiag_IE_Lst_ExtIEs(param, pntr, mBuf)
CztProtExtnField_CriticalityDiag_IE_Lst_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnCriticalityDiag_IE_Lst_ExtIEsCls(
                                   &param->extensionValue, param->id.val,
                                   pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_CriticalityDiag_IE_Lst_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_CriticalityDiag_IE_Lst_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(
                    CztProtExtnField_CriticalityDiag_IE_Lst_ExtIEs)*(param->
                    noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_CriticalityDiag_IE_Lst_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCriticalityDiag_IE_LstMember(param, pntr, mBuf)
CztCriticalityDiag_IE_LstMember *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->iECriticality, mBuf); 
                /*Unpacking CztProtIE_ID*/
                CMCHKUNPK(cmUnpkTknU32, &param->iE_ID, mBuf);
                /*Unpacking CztTypOfErr*/
                CMCHKUNPK(cmUnpkTknU32, &param->typeOfErr, mBuf);/*shishir*/ 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_CriticalityDiag_IE_Lst_ExtIEs, &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCriticalityDiag_IE_Lst(param, pntr, mBuf)
CztCriticalityDiag_IE_Lst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztCriticalityDiag_IE_LstMember,
                                      &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCriticalityDiag_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCriticalityDiag_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_CriticalityDiag_ExtIEs(param, pntr, mBuf)
CztProtExtnField_CriticalityDiag_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnCriticalityDiag_ExtIEsCls(
                                                  &param->extensionValue,
                                                  param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_CriticalityDiag_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_CriticalityDiag_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                           cmUnpkCztProtExtnField_CriticalityDiag_ExtIEs,
                           &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCriticalityDiag(param, pntr, mBuf)
CztCriticalityDiag *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CztProcedureCode*/
                CMCHKUNPK(cmUnpkTknU32, &param->procedureCode, mBuf);
                /*Unpacking CztTrgMsg */ 
                CMCHKUNPK(cmUnpkTknU32, &param->triggeringMsg, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->procedureCriticality, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztCriticalityDiag_IE_Lst, 
                             &param->iEsCriticalityDiag, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_CriticalityDiag_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnFDD_Info_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnFDD_Info_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_FDD_Info_ExtIEs(param, pntr, mBuf)
CztProtExtnField_FDD_Info_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnFDD_Info_ExtIEsCls(
                                                &param->extensionValue,
                                                param->id.val, pntr,
                                                mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_FDD_Info_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_FDD_Info_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_FDD_Info_ExtIEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztFDD_Info(param, pntr, mBuf)
CztFDD_Info *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                /*Unpacking CztEARRCN*/
                CMCHKUNPK(cmUnpkTknU32, &param->uL_EARFCN, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->dL_EARFCN, mBuf);
                /*Unpacking CztTransmission_Bandwidth*/
                CMCHKUNPK(cmUnpkTknU32, &param->uL_Transmission_Bandwidth,
                          mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->dL_Transmission_Bandwidth,
                          mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_FDD_Info_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnSpecialSubframe_Info_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnSpecialSubframe_Info_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_SpecialSubframe_Info_ExtIEs(param, pntr, mBuf)
CztProtExtnField_SpecialSubframe_Info_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnSpecialSubframe_Info_ExtIEsCls(
                                              &param->extensionValue, 
                                              param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_SpecialSubframe_Info_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_SpecialSubframe_Info_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_SpecialSubframe_Info_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSpecialSubframe_Info(param, pntr, mBuf)
CztSpecialSubframe_Info *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CztSpecialSubframePatterns*/
                CMCHKUNPK(cmUnpkTknU32, &param->specialSubframePatterns, mBuf);
                /*Unpacking CztCyclicPrefixDL*/
                CMCHKUNPK(cmUnpkTknU32, &param->cyclicPrefixDL, mBuf);
                /*Unpacking CztCyclicPrefixUL*/
                CMCHKUNPK(cmUnpkTknU32, &param->cyclicPrefixUL, mBuf);/*shishir*/ 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_SpecialSubframe_Info_ExtIEs, &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnTDD_Info_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnTDD_Info_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_TDD_Info_ExtIEs(param, pntr, mBuf)
CztProtExtnField_TDD_Info_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnTDD_Info_ExtIEsCls(
                                            &param->extensionValue,
                                            param->id.val, pntr,
                                            mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_TDD_Info_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_TDD_Info_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztProtExtnField_TDD_Info_ExtIEs)*(
                                param->noComp.val),
                                (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_TDD_Info_ExtIEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztTDD_Info(param, pntr, mBuf)
CztTDD_Info *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                /*Unpacking CztEARFCN*/
                CMCHKUNPK(cmUnpkTknU32, &param->eARFCN, mBuf);
                /*Unpacking CztTransmission_Bandwidth*/
                CMCHKUNPK(cmUnpkTknU32, &param->transmission_Bandwidth, mBuf);
                /*Unpacking CztSubframeAssignment*/
                CMCHKUNPK(cmUnpkTknU32, &param->subframeAssignment, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztSpecialSubframe_Info,
                             &param->specialSubframe_Info,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_TDD_Info_ExtIEs, 
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztEUTRA_Mode_Info(param, pntr, mBuf)
CztEUTRA_Mode_Info *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
        ...
        if(param->choice.pres) 
        {
                switch( param->choice.val ) 
                {
                        case EUTRA_MODE_INFO_FDD :
                                CMCHKUNPKPTR(cmUnpkCztFDD_Info, &param->val.fDD,
                                             pntr,
                                             mBuf); 
                                break;
                        case EUTRA_MODE_INFO_TDD :
                                CMCHKUNPKPTR(cmUnpkCztTDD_Info, &param->val.tDD,
                                             pntr,
                                             mBuf); 
                                break;
                        default:
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnECGI_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnECGI_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_ECGI_ExtIEs(param, pntr, mBuf)
CztProtExtnField_ECGI_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnECGI_ExtIEsCls(
                                                       &param->extensionValue,
                                                       param->id.val,
                                                       pntr,
                                                       mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_ECGI_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_ECGI_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                       CztProtExtnField_ECGI_ExtIEs)*(param->noComp.val),
                       (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_ECGI_ExtIEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztECGI(param, pntr, mBuf)
CztECGI *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                /*Unpacking CztPLMN_Identity*/
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->pLMN_Identity, pntr,
                              mBuf);
                /*Unpacking CxtEUTRANCellIdentifier*/
                CMCHKUNPK(cmUnpkTknBStr32, &param->eUTRANcellIdentifier,
                          mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_ECGI_ExtIEs,
                             &param->iE_Extns,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztENB_ID(param, pntr, mBuf)
CztENB_ID *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
        ...
        if(param->choice.pres) 
        {
                switch( param->choice.val ) 
                {
                        case ENB_ID_MACRO_ENB_ID :
                                /*CztENB_IDmacro_eNB_ID*/
                                CMCHKUNPK(cmUnpkTknBStr32, 
                                          &param->val.macro_eNB_ID,
                                          mBuf); 
                                break;
                        case ENB_ID_HOME_ENB_ID :
                                /*CztENB_IDhome_eNB_ID*/
                                CMCHKUNPK(cmUnpkTknBStr32,
                                          &param->val.home_eNB_ID,
                                          mBuf); 
                                break;
                        default:
                                RETVALUE(RFAILED); 
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztEPLMNs(param, pntr, mBuf)
CztEPLMNs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnGBR_QosInform_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnGBR_QosInform_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_GBR_QosInform_ExtIEs(param, pntr, mBuf)
CztProtExtnField_GBR_QosInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnGBR_QosInform_ExtIEsCls(
                                                     &param->extensionValue,
                                                     param->id.val,
                                                     pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_GBR_QosInform_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_GBR_QosInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr,
                      sizeof(CztProtExtnField_GBR_QosInform_ExtIEs)*(param->
                      noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(
                           cmUnpkCztProtExtnField_GBR_QosInform_ExtIEs,
                           &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztGBR_QosInform(param, pntr, mBuf)
CztGBR_QosInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CztBitRate*/
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->e_RAB_MaxBitrateDL,
                              pntr, mBuf); 
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->e_RAB_MaxBitrateUL,
                              pntr, mBuf); 
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL,
                              &param->e_RAB_GuaranteedBitrateDL, pntr,
                              mBuf); 
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, 
                              &param->e_RAB_GuaranteedBitrateUL, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_GBR_QosInform_ExtIEs, 
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnE_RAB_Lvl_QoS_Params_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnE_RAB_Lvl_QoS_Params_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_E_RAB_Lvl_QoS_Params_ExtIEs(param, pntr, mBuf)
CztProtExtnField_E_RAB_Lvl_QoS_Params_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnE_RAB_Lvl_QoS_Params_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val, pntr,
                                                      mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_E_RAB_Lvl_QoS_Params_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_E_RAB_Lvl_QoS_Params_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                           cmUnpkCztProtExtnField_E_RAB_Lvl_QoS_Params_ExtIEs,
                           &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RAB_Lvl_QoS_Params(param, pntr, mBuf)
CztE_RAB_Lvl_QoS_Params *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->qCI, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztAllocnAndRetentionPriority,
                             &param->allocationAndRetentionPriority,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztGBR_QosInform, &param->gbrQosInform,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_E_RAB_Lvl_QoS_Params_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnE_RAB_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnE_RAB_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_E_RAB_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_E_RAB_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnE_RAB_Item_ExtIEsCls(
                                                     &param->extensionValue,
                                                     param->id.val, pntr,
                                                     mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_E_RAB_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_E_RAB_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_E_RAB_Item_ExtIEs,
                                      &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RAB_Item(param, pntr, mBuf)
CztE_RAB_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->e_RAB_ID, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztCause, &param->cause, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_E_RAB_Item_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueE_RAB_ItemIEsCls(param, value, pntr, mBuf)
Czt_ValueE_RAB_ItemIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_E_RAB_Item:
                        CMCHKUNPKPTR(cmUnpkCztE_RAB_Item, 
                                     &param->u.cztE_RAB_Item, 
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_E_RAB_ItemIEs(param, pntr, mBuf)
CztProtIE_Field_E_RAB_ItemIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueE_RAB_ItemIEsCls(
                                                               &param->value,
                                                               param->id.val,
                                                               pntr, 
                                                               mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RAB_Lst(param, pntr, mBuf)
CztE_RAB_Lst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Single_Cont_E_RAB_ItemIEs)*(param->
                          noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                
                         /* Element ------------- ProtocolIE-Single-Container ------------ */
                        /*Unpacking CztProtIE_Single_Cont_E_RAB_ItemIEs*/
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_E_RAB_ItemIEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztForbiddenTACs(param, pntr, mBuf)
CztForbiddenTACs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztTAC)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        /*Unpacking CztTAC*/
                        CMCHKUNPK(cmUnpkTknStr4, &(param->member[i]), mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnForbiddenTAs_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnForbiddenTAs_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_ForbiddenTAs_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_ForbiddenTAs_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnForbiddenTAs_Item_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val, pntr,
                                                      mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_ForbiddenTAs_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_ForbiddenTAs_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                              cmUnpkCztProtExtnField_ForbiddenTAs_Item_ExtIEs,
                              &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztForbiddenTAs_Item(param, pntr, mBuf)
CztForbiddenTAs_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
               /*Unpacking CztPLMN_Identity*/
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->pLMN_Identity,
                              pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztForbiddenTACs, &param->forbiddenTACs,
                              pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_ForbiddenTAs_Item_ExtIEs,
                              &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztForbiddenTAs(param, pntr, mBuf)
CztForbiddenTAs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztForbiddenTAs_Item)*(param->
                          noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztForbiddenTAs_Item, 
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztForbiddenLACs(param, pntr, mBuf)
CztForbiddenLACs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztLAC)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        /*Unpacking CztLAC*/
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnForbiddenLAs_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnForbiddenLAs_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_ForbiddenLAs_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_ForbiddenLAs_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnForbiddenLAs_Item_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val, pntr,
                                                      mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_ForbiddenLAs_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_ForbiddenLAs_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_ForbiddenLAs_Item_ExtIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztForbiddenLAs_Item(param, pntr, mBuf)
CztForbiddenLAs_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->pLMN_Identity,
                              pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztForbiddenLACs, &param->forbiddenLACs,
                              pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_ForbiddenLAs_Item_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztForbiddenLAs(param, pntr, mBuf)
CztForbiddenLAs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztForbiddenLAs_Item)*(param->
                          noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztForbiddenLAs_Item, 
                                     &(param->member[i]), pntr,
                                      mBuf); 
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnGlobalENB_ID_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnGlobalENB_ID_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_GlobalENB_ID_ExtIEs(param, pntr, mBuf)
CztProtExtnField_GlobalENB_ID_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnGlobalENB_ID_ExtIEsCls(             
                                                 &param->extensionValue,
                                                 param->id.val,
                                                 pntr,
                                                 mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_GlobalENB_ID_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_GlobalENB_ID_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                              cmUnpkCztProtExtnField_GlobalENB_ID_ExtIEs,
                              &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztGlobalENB_ID(param, pntr, mBuf)
CztGlobalENB_ID *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
               /*UnPacking CztPMLN_Identity*/
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->pLMN_Identity,
                              pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztENB_ID, &param->eNB_ID, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_GlobalENB_ID_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnGTPtunnelEndpoint_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnGTPtunnelEndpoint_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_GTPtunnelEndpoint_ExtIEs(param, pntr, mBuf)
CztProtExtnField_GTPtunnelEndpoint_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnGTPtunnelEndpoint_ExtIEsCls(
                                                         &param->extensionValue,
                                                         param->id.val,
                                                         pntr,
                                                         mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_GTPtunnelEndpoint_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_GTPtunnelEndpoint_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                             cmUnpkCztProtExtnField_GTPtunnelEndpoint_ExtIEs,
                             &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztGTPtunnelEndpoint(param, pntr, mBuf)
CztGTPtunnelEndpoint *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkTknStrBSXL, &param->transportLyrAddr,
                             pntr, mBuf); 
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->gTP_TEID, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_GTPtunnelEndpoint_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnGU_Group_ID_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnGU_Group_ID_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_GU_Group_ID_ExtIEs(param, pntr, mBuf)
CztProtExtnField_GU_Group_ID_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnGU_Group_ID_ExtIEsCls(
                                                    &param->extensionValue,
                                                    param->id.val,
                                                    pntr,
                                                    mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_GU_Group_ID_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_GU_Group_ID_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                                cmUnpkCztProtExtnField_GU_Group_ID_ExtIEs,
                                &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztGU_Group_ID(param, pntr, mBuf)
CztGU_Group_ID *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
       ...
       /*Unpacking CztPLMN_Identity*/
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->pLMN_Identity,
                              pntr, mBuf); 
                CMCHKUNPK(cmUnpkTknStr4, &param->mME_Group_ID, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_GU_Group_ID_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztGUGroupIDLst(param, pntr, mBuf)
CztGUGroupIDLst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztGU_Group_ID)*(param->noComp.val),
                         (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztGU_Group_ID,&(param->member[i]),
                                     pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnGUMMEI_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnGUMMEI_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_GUMMEI_ExtIEs(param, pntr, mBuf)
CztProtExtnField_GUMMEI_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnGUMMEI_ExtIEsCls(
                                                    &param->extensionValue,
                                                    param->id.val,
                                                    pntr,mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_GUMMEI_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_GUMMEI_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                                cmUnpkCztProtExtnField_GUMMEI_ExtIEs,
                                &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztGUMMEI(param, pntr, mBuf)
CztGUMMEI *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztGU_Group_ID, &param->gU_Group_ID,
                             pntr, mBuf); 
                CMCHKUNPK(cmUnpkTknStr4, &param->mMME_Code, mBuf);  
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_GUMMEI_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnHovrRestrnLst_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnHovrRestrnLst_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_HovrRestrnLst_ExtIEs(param, pntr, mBuf)
CztProtExtnField_HovrRestrnLst_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnHovrRestrnLst_ExtIEsCls(
                                                        &param->extensionValue,
                                                        param->id.val, pntr,
                                                        mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_HovrRestrnLst_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_HovrRestrnLst_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                              cmUnpkCztProtExtnField_HovrRestrnLst_ExtIEs,
                              &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztHovrRestrnLst(param, pntr, mBuf)
CztHovrRestrnLst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
              /*Unpacking CztPLMN_Identity*/
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->servingPLMN,
                              pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztEPLMNs, &param->equivalentPLMNs,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztForbiddenTAs, &param->forbiddenTAs,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztForbiddenLAs, &param->forbiddenLAs,
                             pntr, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->forbiddenInterRATs, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_HovrRestrnLst_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnHWLoadIndicator_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnHWLoadIndicator_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_HWLoadIndicator_ExtIEs(param, pntr, mBuf)
CztProtExtnField_HWLoadIndicator_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnHWLoadIndicator_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val, pntr,
                                                      mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_HWLoadIndicator_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_HWLoadIndicator_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_HWLoadIndicator_ExtIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztHWLoadIndicator(param, pntr, mBuf)
CztHWLoadIndicator *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->dLHWLoadIndicator, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->uLHWLoadIndicator, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_HWLoadIndicator_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnLastVisitedEUTRANCellInform_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnLastVisitedEUTRANCellInform_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_LastVisitedEUTRANCellInform_ExtIEs(param, pntr, mBuf)
CztProtExtnField_LastVisitedEUTRANCellInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;/*shishir*/
                        ret = cmUnpkCzt_ExtnLastVisitedEUTRANCellInform_ExtIEsCls(&param->extensionValue, param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_LastVisitedEUTRANCellInform_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_LastVisitedEUTRANCellInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {       /*shishir*/
                CMGETMBLK(pntr, sizeof(CztProtExtnField_LastVisitedEUTRANCellInform_ExtIEs)*(param->noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                { /*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_LastVisitedEUTRANCellInform_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztLastVisitedEUTRANCellInform(param, pntr, mBuf)
CztLastVisitedEUTRANCellInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->global_Cell_ID, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztCellTyp, &param->cellTyp, pntr, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->time_UE_StayedInCell, mBuf); 
                CMCHKUNPKPTR(
                    cmUnpkCztProtExtnCont_LastVisitedEUTRANCellInform_ExtIEs,
                    &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztLastVisitedGERANCellInform(param, pntr, mBuf)
CztLastVisitedGERANCellInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztLastVisitedCell_Item(param, pntr, mBuf)
CztLastVisitedCell_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
        ...
        if(param->choice.pres) 
        {
                switch( param->choice.val ) 
                {
                        case LASTVISITEDCELL_ITEM_E_UTRAN_CELL :
                                CMCHKUNPKPTR(
                                    cmUnpkCztLastVisitedEUTRANCellInform,
                                    &param->val.e_UTRAN_Cell, pntr,
                                    mBuf); 
                                break;
                        case LASTVISITEDCELL_ITEM_UTRAN_CELL :
                               /*Unpacking CztLastVisitedUTRANCellInform*/
                                CZUCHKUNPKPTR(cmUnpkTknStrOSXL,
                                              &param->val.uTRAN_Cell,
                                              pntr,
                                              mBuf); 
                                break;
                        case LASTVISITEDCELL_ITEM_GERAN_CELL :
                                CMCHKUNPKPTR(
                                  cmUnpkCztLastVisitedGERANCellInform,
                                  &param->val.gERAN_Cell, pntr, mBuf); 
                                break;
                        default:
                                RETVALUE(RFAILED); 
                } 
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnLocRprtngInform_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnLocRprtngInform_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_LocRprtngInform_ExtIEs(param, pntr, mBuf)
CztProtExtnField_LocRprtngInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnLocRprtngInform_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val, pntr,
                                                      mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_LocRprtngInform_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_LocRprtngInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                             cmUnpkCztProtExtnField_LocRprtngInform_ExtIEs,
                             &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztLocRprtngInform(param, pntr, mBuf)
CztLocRprtngInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->eventTyp, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->reportArea, mBuf); 
                CMCHKUNPKPTR(
                   cmUnpkCztProtExtnCont_LocRprtngInform_ExtIEs,
                   &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSubframeAllocn(param, pntr, mBuf)
CztSubframeAllocn *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnMBSFN_Subframe_Info_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnMBSFN_Subframe_Info_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_MBSFN_Subframe_Info_ExtIEs(param, pntr, mBuf)
CztProtExtnField_MBSFN_Subframe_Info_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnMBSFN_Subframe_Info_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val, pntr,
                                                      mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_MBSFN_Subframe_Info_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_MBSFN_Subframe_Info_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                           cmUnpkCztProtExtnField_MBSFN_Subframe_Info_ExtIEs,
                           &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztMBSFN_Subframe_Info(param, pntr, mBuf)
CztMBSFN_Subframe_Info *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->radioframeAllocnPeriod, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->radioframeAllocnOffset, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztSubframeAllocn, &param->subframeAllocn,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_MBSFN_Subframe_Info_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztMBSFN_Subframe_Infolist(param, pntr, mBuf)
CztMBSFN_Subframe_Infolist *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztMBSFN_Subframe_Info)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztMBSFN_Subframe_Info,
                                     &(param->member[i]), pntr,
                                     mBuf); 
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztMobilityParamsModificationRange(param, pntr, mBuf)
CztMobilityParamsModificationRange *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknS32,
                          &param->handoverTriggerChangeLowerLimit,
                          mBuf); 
                CMCHKUNPK(cmUnpkTknS32, 
                          &param->handoverTriggerChangeUpperLimit, 
                          mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztMobilityParamsInform(param, pntr, mBuf)
CztMobilityParamsInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
               /*Unpacking CztMobilityParamsInformhandoverTriggerChange */
                CMCHKUNPK(cmUnpkTknU32, &param->handoverTriggerChange, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnNeighbour_Inform_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnNeighbour_Inform_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_Neighbour_Inform_ExtIEs(param, pntr, mBuf)
CztProtExtnField_Neighbour_Inform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnNeighbour_Inform_ExtIEsCls(
                                                     &param->extensionValue,
                                                     param->id.val, pntr,
                                                     mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_Neighbour_Inform_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_Neighbour_Inform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                           cmUnpkCztProtExtnField_Neighbour_Inform_ExtIEs,
                           &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztNeighbour_InformMember(param, pntr, mBuf)
CztNeighbour_InformMember *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->eCGI, pntr, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->pCI, mBuf);
                /*Unpacking CztEARFCN*/
                CMCHKUNPK(cmUnpkTknU32, &param->eARFCN, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_Neighbour_Inform_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztNeighbour_Inform(param, pntr, mBuf)
CztNeighbour_Inform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztNeighbour_InformMember)*(param->noComp.val),
                         (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztNeighbour_InformMember,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnPRACH_Config_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnPRACH_Config_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_PRACH_Config_ExtIEs(param, pntr, mBuf)
CztProtExtnField_PRACH_Config_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnPRACH_Config_ExtIEsCls(
                                                     &param->extensionValue,
                                                     param->id.val,
                                                     pntr,
                                                     mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_PRACH_Config_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_PRACH_Config_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_PRACH_Config_ExtIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztPRACH_Config(param, pntr, mBuf)
CztPRACH_Config *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->rootSequenceIdx, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->zeroCorrelationIdx, mBuf); 
                CMCHKUNPK(cmUnpkTknU8, &param->highSpeedFlag, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->prach_FreqOffset, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->prach_ConfigIdx, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_PRACH_Config_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnRelativeNarrowbandTxPower_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnRelativeNarrowbandTxPower_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_RelativeNarrowbandTxPower_ExtIEs(param, pntr, mBuf)
CztProtExtnField_RelativeNarrowbandTxPower_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;/*shishir*/
                        ret = cmUnpkCzt_ExtnRelativeNarrowbandTxPower_ExtIEsCls(&param->extensionValue, param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_RelativeNarrowbandTxPower_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_RelativeNarrowbandTxPower_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {       /*shishir*/
                CMGETMBLK(pntr, sizeof(CztProtExtnField_RelativeNarrowbandTxPower_ExtIEs)*(param->noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {       /*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_RelativeNarrowbandTxPower_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztRelativeNarrowbandTxPower(param, pntr, mBuf)
CztRelativeNarrowbandTxPower *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkTknStrBSXL, &param->rNTP_PerPRB, pntr,
                             mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->rNTP_Threshold, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->
                          numberOfCellSpecificAntennaPorts, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->p_B, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->pDCCH_InterferenceImpact,
                          mBuf); 
                CMCHKUNPKPTR(
                    cmUnpkCztProtExtnCont_RelativeNarrowbandTxPower_ExtIEs,
                    &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnRadioResStatus_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnRadioResStatus_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_RadioResStatus_ExtIEs(param, pntr, mBuf)
CztProtExtnField_RadioResStatus_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnRadioResStatus_ExtIEsCls(
                                                       &param->extensionValue,
                                                       param->id.val,
                                                       pntr,
                                                       mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_RadioResStatus_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_RadioResStatus_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                          cmUnpkCztProtExtnField_RadioResStatus_ExtIEs,
                          &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztRadioResStatus(param, pntr, mBuf)
CztRadioResStatus *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->dL_GBR_PRB_usage, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->uL_GBR_PRB_usage, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->dL_non_GBR_PRB_usage, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->uL_non_GBR_PRB_usage, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->dL_Total_PRB_usage, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->uL_Total_PRB_usage, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_RadioResStatus_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnS1TNLLoadIndicator_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnS1TNLLoadIndicator_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_S1TNLLoadIndicator_ExtIEs(param, pntr, mBuf)
CztProtExtnField_S1TNLLoadIndicator_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnS1TNLLoadIndicator_ExtIEsCls(
                                                         &param->extensionValue,
                                                         param->id.val, pntr,
                                                         mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_S1TNLLoadIndicator_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_S1TNLLoadIndicator_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_S1TNLLoadIndicator_ExtIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztS1TNLLoadIndicator(param, pntr, mBuf)
CztS1TNLLoadIndicator *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->dLS1TNLLoadIndicator, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->uLS1TNLLoadIndicator, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_S1TNLLoadIndicator_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnSrvdCell_Inform_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnSrvdCell_Inform_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_Number_of_Antennaports:
                        CMCHKUNPK(cmUnpkTknU32, 
                                  &param->u.cztNumber_of_Antennaports,
                                  mBuf); 
                        break;
                case Cztid_PRACH_Config:
                        CMCHKUNPKPTR(cmUnpkCztPRACH_Config,
                                     &param->u.cztPRACH_Config, 
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_MBSFN_Subframe_Info:
                        CMCHKUNPKPTR(cmUnpkCztMBSFN_Subframe_Infolist,
                                     &param->u.cztMBSFN_Subframe_Infolist,
                                     pntr,
                                     mBuf);
                        break;
                default:
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_SrvdCell_Inform_ExtIEs(param, pntr, mBuf)
CztProtExtnField_SrvdCell_Inform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnSrvdCell_Inform_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val,
                                                      pntr,
                                                      mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_SrvdCell_Inform_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_SrvdCell_Inform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                         cmUnpkCztProtExtnField_SrvdCell_Inform_ExtIEs,
                         &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSrvdCell_Inform(param, pntr, mBuf)
CztSrvdCell_Inform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMCHKUNPK(cmUnpkTknU32, &param->pCI, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->cellId, pntr, mBuf);
                /*Unpacking CztTAC*/
                CMCHKUNPK(cmUnpkTknStr4, &param->tAC, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztBroadcastPLMNs_Item, 
                             &param->broadcastPLMNs,
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztEUTRA_Mode_Info, 
                             &param->eUTRA_Mode_Info,
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_SrvdCell_Inform_ExtIEs,
                             &param->iE_Extns,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnSrvdCell_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnSrvdCell_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_SrvdCell_ExtIEs(param, pntr, mBuf)
CztProtExtnField_SrvdCell_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnSrvdCell_ExtIEsCls(
                                                &param->extensionValue,
                                                param->id.val,
                                                pntr,
                                                mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_SrvdCell_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_SrvdCell_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        (Ptr*)&(param->member) );
                ...
                {
                        CMCHKUNPKPTR(
                                cmUnpkCztProtExtnField_SrvdCell_ExtIEs,
                                &(param->member[i]),
                                pntr,
                                mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSrvdCellsMember(param, pntr, mBuf)
CztSrvdCellsMember *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztSrvdCell_Inform,
                             &param->servedCellInfo,
                             pntr, 
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztNeighbour_Inform, 
                             &param->neighbour_Info,
                             pntr, 
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_SrvdCell_ExtIEs,
                             &param->iE_Extns,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSrvdCells(param, pntr, mBuf)
CztSrvdCells *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztSrvdCellsMember)*(param->noComp.val),
                         (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztSrvdCellsMember,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnTraceActvn_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnTraceActvn_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_TraceActvn_ExtIEs(param, pntr, mBuf)
CztProtExtnField_TraceActvn_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnTraceActvn_ExtIEsCls(
                                                    &param->extensionValue,
                                                    param->id.val,
                                                    pntr,
                                                    mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_TraceActvn_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_TraceActvn_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_TraceActvn_ExtIEs,
                            &(param->member[i]),
                            pntr,
                            mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztTraceActvn(param, pntr, mBuf)
CztTraceActvn *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->eUTRANTraceID,
                              pntr, mBuf); 
                CMCHKUNPK(cmUnpkTknBStr32, &param->interfacesToTrace, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->traceDepth, mBuf); 
                CMCHKUNPKPTR(cmUnpkTknStrBSXL, 
                             &param->traceCollectionEntityIPAddr,
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_TraceActvn_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUE_HistoryInform(param, pntr, mBuf)
CztUE_HistoryInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztLastVisitedCell_Item)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztLastVisitedCell_Item,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnUEAgg_MaxBitrate_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnUEAgg_MaxBitrate_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_UEAgg_MaxBitrate_ExtIEs(param, pntr, mBuf)
CztProtExtnField_UEAgg_MaxBitrate_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnUEAgg_MaxBitrate_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val,
                                                      pntr,
                                                      mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_UEAgg_MaxBitrate_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_UEAgg_MaxBitrate_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                           cmUnpkCztProtExtnField_UEAgg_MaxBitrate_ExtIEs,
                           &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUEAggMaxBitRate(param, pntr, mBuf)
CztUEAggMaxBitRate *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                /*Unpacking CztBitRate */
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, 
                              &param->uEaggregateMaxBitRateDlnk, pntr, mBuf);
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, 
                              &param->uEaggregateMaxBitRateUlnk, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_UEAgg_MaxBitrate_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnUESecurCapabilities_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnUESecurCapabilities_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_UESecurCapabilities_ExtIEs(param, pntr, mBuf)
CztProtExtnField_UESecurCapabilities_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnUESecurCapabilities_ExtIEsCls(
                                                        &param->extensionValue,
                                                        param->id.val,
                                                        pntr,
                                                        mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_UESecurCapabilities_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_UESecurCapabilities_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_UESecurCapabilities_ExtIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUESecurCapabilities(param, pntr, mBuf)
CztUESecurCapabilities *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknBStr32, &param->encryptionAlgorithms, mBuf); 
                CMCHKUNPK(cmUnpkTknBStr32, 
                          &param->integrityProtectionAlgorithms, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_UESecurCapabilities_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUL_InterferenceOverloadInd(param, pntr, mBuf)
CztUL_InterferenceOverloadInd *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztUL_InterferenceOverloadInd_Item)*(param->
                          noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
         /*Unpacking CztUL_InterferenceOverloadInd_Item*/
                        CMCHKUNPK(cmUnpkTknU32, &(param->member[i]), mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnUL_HighInterferenceIndInfo_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnUL_HighInterferenceIndInfo_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_UL_HighInterferenceIndInfo_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_UL_HighInterferenceIndInfo_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;/*shishir*/
                        ret = cmUnpkCzt_ExtnUL_HighInterferenceIndInfo_Item_ExtIEsCls(&param->extensionValue, param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_UL_HighInterferenceIndInfo_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_UL_HighInterferenceIndInfo_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {/*shishir*/
                CMGETMBLK(pntr, sizeof(CztProtExtnField_UL_HighInterferenceIndInfo_Item_ExtIEs)*(param->noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_UL_HighInterferenceIndInfo_Item_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUL_HighInterferenceIndInfo_Item(param, pntr, mBuf)
CztUL_HighInterferenceIndInfo_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->target_Cell_ID, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkTknStrBSXL, 
                             &param->ul_interferenceindication, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_UL_HighInterferenceIndInfo_Item_ExtIEs, &param->iE_Extns, pntr, mBuf);/*shishir*/ 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUL_HighInterferenceIndInfo(param, pntr, mBuf)
CztUL_HighInterferenceIndInfo *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztUL_HighInterferenceIndInfo_Item,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnE_RABs_ToBeSetup_ItemExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnE_RABs_ToBeSetup_ItemExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_E_RABs_ToBeSetup_ItemExtIEs(param, pntr, mBuf)
CztProtExtnField_E_RABs_ToBeSetup_ItemExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnE_RABs_ToBeSetup_ItemExtIEsCls(
                                                        &param->extensionValue,
                                                        param->id.val,
                                                        pntr,
                                                        mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_E_RABs_ToBeSetup_ItemExtIEs(param, pntr, mBuf)
CztProtExtnCont_E_RABs_ToBeSetup_ItemExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {         
                        CMCHKUNPKPTR(
                           cmUnpkCztProtExtnField_E_RABs_ToBeSetup_ItemExtIEs,
                           &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RABs_ToBeSetup_Item(param, pntr, mBuf)
CztE_RABs_ToBeSetup_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMCHKUNPK(cmUnpkTknU32, &param->e_RAB_ID, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztE_RAB_Lvl_QoS_Params,
                             &param->e_RAB_Lvl_QoS_Params,
                             pntr,
                             mBuf);
    /*Unpacking CztDL_Fwding*/
                CMCHKUNPK(cmUnpkTknU32, &param->dL_Fwding, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztGTPtunnelEndpoint, 
                             &param->uL_GTPtunnelEndpoint,
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_E_RABs_ToBeSetup_ItemExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueE_RABs_ToBeSetup_ItemIEsCls(param, value, pntr, mBuf)
Czt_ValueE_RABs_ToBeSetup_ItemIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_E_RABs_ToBeSetup_Item:
                        CMCHKUNPKPTR(cmUnpkCztE_RABs_ToBeSetup_Item,
                                     &param->u.cztE_RABs_ToBeSetup_Item,
                                     pntr,
                                     mBuf);
                        break;
                default:
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_E_RABs_ToBeSetup_ItemIEs(param, pntr, mBuf)
CztProtIE_Field_E_RABs_ToBeSetup_ItemIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueE_RABs_ToBeSetup_ItemIEsCls(
                                                                &param->value,
                                                                param->id.val,
                                                                pntr,
                                                                mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RABs_ToBeSetup_Lst(param, pntr, mBuf)
CztE_RABs_ToBeSetup_Lst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Single_Cont_E_RABs_ToBeSetup_ItemIEs)*(param
                          ->noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(
                           cmUnpkCztProtIE_Field_E_RABs_ToBeSetup_ItemIEs,
                           &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnUE_CntxtInform_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnUE_CntxtInform_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_UE_CntxtInform_ExtIEs(param, pntr, mBuf)
CztProtExtnField_UE_CntxtInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnUE_CntxtInform_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val, 
                                                      pntr, 
                                                      mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_UE_CntxtInform_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_UE_CntxtInform_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                               cmUnpkCztProtExtnField_UE_CntxtInform_ExtIEs,
                               &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUE_CntxtInform(param, pntr, mBuf)
CztUE_CntxtInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->mME_UE_S1AP_ID, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztUESecurCapabilities,
                             &param->uESecurCapabilities, 
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztAS_SecurInform,
                             &param->aS_SecurInform,
                             pntr, 
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztUEAggMaxBitRate, 
                             &param->uEaggregateMaxBitRate,
                             pntr, 
                             mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->subscriberProfileIDforRFP,
                          mBuf); 
                CMCHKUNPKPTR(cmUnpkCztE_RABs_ToBeSetup_Lst, 
                             &param->e_RABs_ToBeSetup_Lst, 
                             pntr,
                             mBuf); 
                CZUCHKUNPKPTR(cmUnpkTknStrOSXL, &param->rRC_Cntxt, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztHovrRestrnLst,
                             &param->handoverRestrnLst,
                             pntr, 
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztLocRprtngInform, 
                             &param->locationRprtngInform,
                             pntr, 
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_UE_CntxtInform_ExtIEs,
                             &param->iE_Extns,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueHovrRqst_IEsCls(param, value, pntr, mBuf)
Czt_ValueHovrRqst_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_Old_eNB_UE_X2AP_ID:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztUE_X2AP_ID, mBuf); 
                        break;
                case Cztid_Cause:
                        CMCHKUNPKPTR(cmUnpkCztCause, &param->u.cztCause, pntr,
                                     mBuf);
                        break;
                case Cztid_TgetCell_ID:
                        CMCHKUNPKPTR(cmUnpkCztECGI, &param->u.cztECGI, pntr, 
                                     mBuf);
                        break;
                case Cztid_GUMMEI_ID:
                        CMCHKUNPKPTR(cmUnpkCztGUMMEI, &param->u.cztGUMMEI,
                                     pntr, mBuf);
                        break;
                case Cztid_UE_CntxtInform:
                        CMCHKUNPKPTR(cmUnpkCztUE_CntxtInform,
                                     &param->u.cztUE_CntxtInform,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_UE_HistoryInform:
                        CMCHKUNPKPTR(cmUnpkCztUE_HistoryInform,
                                     &param->u.cztUE_HistoryInform,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_TraceActvn:
                        CMCHKUNPKPTR(cmUnpkCztTraceActvn,
                                     &param->u.cztTraceActvn,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_SRVCCOperationPossible:
                        CMCHKUNPK(cmUnpkTknU32, 
                                  &param->u.cztSRVCCOperationPossible,
                                  mBuf); 
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_HovrRqst_IEs(param, pntr, mBuf)
CztProtIE_Field_HovrRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueHovrRqst_IEsCls(&param->value,
                                                             param->id.val,
                                                             pntr,
                                                             mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_HovrRqst_IEs(param, pntr, mBuf)
CztProtIE_Cont_HovrRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_HovrRqst_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_HovrRqst_IEs,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztHovrRqst(param, pntr, mBuf)
CztHovrRqst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_HovrRqst_IEs,
                             &param->protocolIEs,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnE_RABs_Admtd_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnE_RABs_Admtd_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_E_RABs_Admtd_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_E_RABs_Admtd_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnE_RABs_Admtd_Item_ExtIEsCls(
                                                       &param->extensionValue,
                                                       param->id.val,
                                                       pntr,
                                                       mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_E_RABs_Admtd_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_E_RABs_Admtd_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_E_RABs_Admtd_Item_ExtIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RABs_Admtd_Item(param, pntr, mBuf)
CztE_RABs_Admtd_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->e_RAB_ID, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztGTPtunnelEndpoint, 
                             &param->uL_GTP_TunnelEndpoint,
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztGTPtunnelEndpoint, 
                             &param->dL_GTP_TunnelEndpoint, 
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_E_RABs_Admtd_Item_ExtIEs,
                             &param->iE_Extns,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueE_RABs_Admtd_ItemIEsCls(param, value, pntr, mBuf)
Czt_ValueE_RABs_Admtd_ItemIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_E_RABs_Admtd_Item:
                        CMCHKUNPKPTR(cmUnpkCztE_RABs_Admtd_Item,
                                     &param->u.cztE_RABs_Admtd_Item,
                                     pntr,
                                     mBuf);
                        break;
                default:
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_E_RABs_Admtd_ItemIEs(param, pntr, mBuf)
CztProtIE_Field_E_RABs_Admtd_ItemIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueE_RABs_Admtd_ItemIEsCls(
                                                             &param->value,
                                                             param->id.val,
                                                             pntr,
                                                             mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RABs_Admtd_Lst(param, pntr, mBuf)
CztE_RABs_Admtd_Lst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Single_Cont_E_RABs_Admtd_ItemIEs)*(param->
                          noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(
                               cmUnpkCztProtIE_Field_E_RABs_Admtd_ItemIEs,
                               &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueHovrRqstAckg_IEsCls(param, value, pntr, mBuf)
Czt_ValueHovrRqstAckg_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_Old_eNB_UE_X2AP_ID:
                        CMCHKUNPK(cmUnpkTknU32, 
                                  &param->u.cztUE_X2AP_ID_Old,
                                  mBuf); /*czt_unpk_c_001.main_1:  X2AP 3.1 : ccpu00117267*/
                        break;
                case Cztid_New_eNB_UE_X2AP_ID:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztUE_X2AP_ID_New,
                                  mBuf); /*czt_unpk_c_001.main_1:  X2AP 3.1 : ccpu00117267*/
                        break;
                case Cztid_E_RABs_Admtd_Lst:
                        CMCHKUNPKPTR(cmUnpkCztE_RABs_Admtd_Lst,
                                     &param->u.cztE_RABs_Admtd_Lst,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_E_RABs_NotAdmtd_Lst:
                        CMCHKUNPKPTR(cmUnpkCztE_RAB_Lst,
                                     &param->u.cztE_RAB_Lst,
                                     pntr, mBuf);
                        break;
                case Cztid_TgeteNBtoSrc_eNBTprntCont:
                        CZUCHKUNPKPTR(cmUnpkTknStrOSXL, 
                                      &param->u.cztTgeteNBtoSrc_eNBTprntCont,
                                      pntr, mBuf); 
                        break;
                case Cztid_CriticalityDiag:
                        CMCHKUNPKPTR(cmUnpkCztCriticalityDiag, 
                                     &param->u.cztCriticalityDiag,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_HovrRqstAckg_IEs(param, pntr, mBuf)
CztProtIE_Field_HovrRqstAckg_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueHovrRqstAckg_IEsCls(
                                                          &param->value,
                                                          param->id.val,
                                                          pntr,
                                                          mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_HovrRqstAckg_IEs(param, pntr, mBuf)
CztProtIE_Cont_HovrRqstAckg_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_HovrRqstAckg_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztHovrRqstAckg(param, pntr, mBuf)
CztHovrRqstAckg *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_HovrRqstAckg_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueHovrPrepFail_IEsCls(param, value, pntr, mBuf)
Czt_ValueHovrPrepFail_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_HovrPrepFail_IEs(param, pntr, mBuf)
CztProtIE_Field_HovrPrepFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueHovrPrepFail_IEsCls(
                                                       &param->value,
                                                       param->id.val,
                                                       pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_HovrPrepFail_IEs(param, pntr, mBuf)
CztProtIE_Cont_HovrPrepFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_HovrPrepFail_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztHovrPrepFail(param, pntr, mBuf)
CztHovrPrepFail *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_HovrPrepFail_IEs, 
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueHovrReport_IEsCls(param, value, pntr, mBuf)
Czt_ValueHovrReport_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_HovrReportTyp:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztHovrReportTyp,
                                  mBuf); 
                        break;
                case Cztid_Cause:
                        CMCHKUNPKPTR(cmUnpkCztCause, &param->u.cztCause, pntr,
                ...
                case Cztid_SrcCellECGI:
                        CMCHKUNPKPTR(cmUnpkCztECGI, &param->u.cztSrcCellECGI, 
                                     pntr, mBuf); 
                        break;
                case Cztid_FailCellECGI:
                        CMCHKUNPKPTR(cmUnpkCztECGI, &param->u.cztFailCellECGI,
                                     pntr, mBuf);
                        break;
                case Cztid_Re_establishmentCellECGI:
                        CMCHKUNPKPTR(cmUnpkCztECGI, &param->u.cztreEstCellECGI,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_HovrReport_IEs(param, pntr, mBuf)
CztProtIE_Field_HovrReport_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueHovrReport_IEsCls(&param->value,
                                                               param->id.val,
                                                               pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_HovrReport_IEs(param, pntr, mBuf)
CztProtIE_Cont_HovrReport_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_HovrReport_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_HovrReport_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztHovrReport(param, pntr, mBuf)
CztHovrReport *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_HovrReport_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnE_RABs_SubjToStatusTfr_ItemExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnE_RABs_SubjToStatusTfr_ItemExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_E_RABs_SubjToStatusTfr_ItemExtIEs(param, pntr, mBuf)
CztProtExtnField_E_RABs_SubjToStatusTfr_ItemExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;/*shishir*/
                        ret = cmUnpkCzt_ExtnE_RABs_SubjToStatusTfr_ItemExtIEsCls(&param->extensionValue, param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_E_RABs_SubjToStatusTfr_ItemExtIEs(param, pntr, mBuf)
CztProtExtnCont_E_RABs_SubjToStatusTfr_ItemExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_E_RABs_SubjToStatusTfr_ItemExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RABs_SubjToStatusTfr_Item(param, pntr, mBuf)
CztE_RABs_SubjToStatusTfr_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPK(cmUnpkTknU32, &param->e_RAB_ID, mBuf); 
                CMCHKUNPKPTR(cmUnpkTknStrBSXL,
                             &param->receiveStatusofULPDCPSDUs,
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztCOUNTvalue, &param->uL_COUNTvalue,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztCOUNTvalue, &param->dL_COUNTvalue,
                             pntr, mBuf); 
                CMCHKUNPKPTR(
                      cmUnpkCztProtExtnCont_E_RABs_SubjToStatusTfr_ItemExtIEs,
                      &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueE_RABs_SubjToStatusTfr_ItemIEsCls(param, value, pntr, mBuf)
Czt_ValueE_RABs_SubjToStatusTfr_ItemIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_E_RABs_SubjToStatusTfr_Item:
                        CMCHKUNPKPTR(cmUnpkCztE_RABs_SubjToStatusTfr_Item,
                                     &param->u.cztE_RABs_SubjToStatusTfr_Item,
                                     pntr,
                                     mBuf);
                        break;
                default:
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_E_RABs_SubjToStatusTfr_ItemIEs(param, pntr, mBuf)
CztProtIE_Field_E_RABs_SubjToStatusTfr_ItemIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueE_RABs_SubjToStatusTfr_ItemIEsCls(
                                                                 &param->value,
                                                                 param->id.val,
                                                                 pntr,
                                                                 mBuf
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztE_RABs_SubjToStatusTfr_Lst(param, pntr, mBuf)
CztE_RABs_SubjToStatusTfr_Lst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Single_Cont_E_RABs_SubjToStatusTfr_ItemIEs
                          )*(param->noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_E_RABs_SubjToStatusTfr_ItemIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueSNStatusTfr_IEsCls(param, value, pntr, mBuf)
Czt_ValueSNStatusTfr_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                case Cztid_Old_eNB_UE_X2AP_ID:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztUE_X2AP_ID_Old,
                                  mBuf); /*czt_unpk_c_001.main_1 : X2AP 3.1 : ccpu00117267*/ 
                        break;
                case Cztid_New_eNB_UE_X2AP_ID:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztUE_X2AP_ID_New,
                ...
                case Cztid_E_RABs_SubjToStatusTfr_Lst:
                        CMCHKUNPKPTR(cmUnpkCztE_RABs_SubjToStatusTfr_Lst, 
                                     &param->u.cztE_RABs_SubjToStatusTfr_Lst,
                                     pntr,
                                     mBuf);
                        break;
                default:
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_SNStatusTfr_IEs(param, pntr, mBuf)
CztProtIE_Field_SNStatusTfr_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueSNStatusTfr_IEsCls(
                                                          &param->value,
                                                          param->id.val,
                                                          pntr,
                                                          mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_SNStatusTfr_IEs(param, pntr, mBuf)
CztProtIE_Cont_SNStatusTfr_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_SNStatusTfr_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_SNStatusTfr_IEs,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSNStatusTfr(param, pntr, mBuf)
CztSNStatusTfr *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_SNStatusTfr_IEs,
                             &param->protocolIEs,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueUECntxtRls_IEsCls(param, value, pntr, mBuf)
Czt_ValueUECntxtRls_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_UECntxtRls_IEs(param, pntr, mBuf)
CztProtIE_Field_UECntxtRls_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueUECntxtRls_IEsCls(&param->value, 
                                                               param->id.val, 
                                                               pntr,
                                                               mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_UECntxtRls_IEs(param, pntr, mBuf)
CztProtIE_Cont_UECntxtRls_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_UECntxtRls_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_UECntxtRls_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUECntxtRls(param, pntr, mBuf)
CztUECntxtRls *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_UECntxtRls_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueHovrCancel_IEsCls(param, value, pntr, mBuf)
Czt_ValueHovrCancel_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_HovrCancel_IEs(param, pntr, mBuf)
CztProtIE_Field_HovrCancel_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueHovrCancel_IEsCls(&param->value,
                                                               param->id.val,
                                                               pntr,
                                                               mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_HovrCancel_IEs(param, pntr, mBuf)
CztProtIE_Cont_HovrCancel_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
        CztProtIE_Field_HovrCancel_IEs)*(param->noComp.val),
        (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_HovrCancel_IEs,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztHovrCancel(param, pntr, mBuf)
CztHovrCancel *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_HovrCancel_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueErrInd_IEsCls(param, value, pntr, mBuf)
Czt_ValueErrInd_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                ...
                case Cztid_New_eNB_UE_X2AP_ID:
                        ...
                        break;
                case Cztid_Cause:
                        CMCHKUNPKPTR(cmUnpkCztCause, &param->u.cztCause,
                                     pntr, mBuf);
                        break;
                case Cztid_CriticalityDiag:
                        CMCHKUNPKPTR(cmUnpkCztCriticalityDiag,
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ErrInd_IEs(param, pntr, mBuf)
CztProtIE_Field_ErrInd_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueErrInd_IEsCls(&param->value,
                                                           param->id.val,
                                                           pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ErrInd_IEs(param, pntr, mBuf)
CztProtIE_Cont_ErrInd_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_ErrInd_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_ErrInd_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztErrInd(param, pntr, mBuf)
CztErrInd *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ErrInd_IEs,
                             &param->protocolIEs,
                             pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueResetRqst_IEsCls(param, value, pntr, mBuf)
Czt_ValueResetRqst_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ResetRqst_IEs(param, pntr, mBuf)
CztProtIE_Field_ResetRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueResetRqst_IEsCls(&param->value,
                                                              param->id.val,
                                                              pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ResetRqst_IEs(param, pntr, mBuf)
CztProtIE_Cont_ResetRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztProtIE_Field_ResetRqst_IEs)*(param->
                          noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_ResetRqst_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztResetRqst(param, pntr, mBuf)
CztResetRqst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ResetRqst_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueResetResp_IEsCls(param, value, pntr, mBuf)
Czt_ValueResetResp_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ResetResp_IEs(param, pntr, mBuf)
CztProtIE_Field_ResetResp_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueResetResp_IEsCls(&param->value,
                                                              param->id.val,
                                                              pntr,
                                                              mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ResetResp_IEs(param, pntr, mBuf)
CztProtIE_Cont_ResetResp_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztProtIE_Field_ResetResp_IEs)*(param->
        noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_ResetResp_IEs,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztResetResp(param, pntr, mBuf)
CztResetResp *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ResetResp_IEs,
                             &param->protocolIEs,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueX2SetupRqst_IEsCls(param, value, pntr, mBuf)
Czt_ValueX2SetupRqst_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_GlobalENB_ID:
                        CMCHKUNPKPTR(cmUnpkCztGlobalENB_ID, 
                                     &param->u.cztGlobalENB_ID,
                                     pntr, mBuf);
                        break;
                case Cztid_SrvdCells:
                        CMCHKUNPKPTR(cmUnpkCztSrvdCells, 
                                     &param->u.cztSrvdCells,
                                     pntr, mBuf);
                        break;
                case Cztid_GUGroupIDLst:
                        CMCHKUNPKPTR(cmUnpkCztGUGroupIDLst,
                                     &param->u.cztGUGroupIDLst, 
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_X2SetupRqst_IEs(param, pntr, mBuf)
CztProtIE_Field_X2SetupRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueX2SetupRqst_IEsCls(&param->value,
                                                                param->id.val,
                                                                  pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_X2SetupRqst_IEs(param, pntr, mBuf)
CztProtIE_Cont_X2SetupRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_X2SetupRqst_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_X2SetupRqst_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztX2SetupRqst(param, pntr, mBuf)
CztX2SetupRqst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_X2SetupRqst_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueX2SetupResp_IEsCls(param, value, pntr, mBuf)
Czt_ValueX2SetupResp_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_X2SetupResp_IEs(param, pntr, mBuf)
CztProtIE_Field_X2SetupResp_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueX2SetupResp_IEsCls(&param->value,
                                                                param->id.val,
                                                                  pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_X2SetupResp_IEs(param, pntr, mBuf)
CztProtIE_Cont_X2SetupResp_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_X2SetupResp_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_X2SetupResp_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztX2SetupResp(param, pntr, mBuf)
CztX2SetupResp *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_X2SetupResp_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueX2SetupFail_IEsCls(param, value, pntr, mBuf)
Czt_ValueX2SetupFail_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                ...
                case Cztid_TimeToWait:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztTimeToWait, mBuf); 
                        break;
                case Cztid_CriticalityDiag:
                        CMCHKUNPKPTR(cmUnpkCztCriticalityDiag,
                                     &param->u.cztCriticalityDiag,
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_X2SetupFail_IEs(param, pntr, mBuf)
CztProtIE_Field_X2SetupFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueX2SetupFail_IEsCls(&param->value,
                                                                param->id.val,
                                                                pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_X2SetupFail_IEs(param, pntr, mBuf)
CztProtIE_Cont_X2SetupFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_X2SetupFail_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_X2SetupFail_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztX2SetupFail(param, pntr, mBuf)
CztX2SetupFail *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_X2SetupFail_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCellInform_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCellInform_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_ABSInform:
                        CMCHKUNPKPTR(cmUnpkCztABSInform, &param->u.cztABSInform, pntr, mBuf);
                        break;
                case Cztid_InvokeInd:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztInvokeInd, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_CellInform_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_CellInform_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnCellInform_Item_ExtIEsCls(
                                                      &param->extensionValue,
                                                      param->id.val,
                                                      pntr,
                                                      mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_CellInform_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_CellInform_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtExtnField_CellInform_Item_ExtIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellInform_Item(param, pntr, mBuf)
CztCellInform_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->cell_ID, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztUL_InterferenceOverloadInd,
                             &param->ul_InterferenceOverloadInd,
                             pntr,
                             mBuf); 
                CMCHKUNPKPTR(cmUnpkCztUL_HighInterferenceIndInfo,
                             &param->ul_HighInterferenceIndInfo,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztRelativeNarrowbandTxPower,
                             &param->relativeNarrowbandTxPower,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_CellInform_Item_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueCellInform_ItemIEsCls(param, value, pntr, mBuf)
Czt_ValueCellInform_ItemIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_CellInform_Item:
                        CMCHKUNPKPTR(cmUnpkCztCellInform_Item,
                                     &param->u.cztCellInform_Item,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_CellInform_ItemIEs(param, pntr, mBuf)
CztProtIE_Field_CellInform_ItemIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueCellInform_ItemIEsCls(
                                                          &param->value,
                                                          param->id.val,
                                                          pntr,
                                                          mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellInform_Lst(param, pntr, mBuf)
CztCellInform_Lst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Single_Cont_CellInform_ItemIEs)*(param->
                          noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_CellInform_ItemIEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueLoadInform_IEsCls(param, value, pntr, mBuf)
Czt_ValueLoadInform_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_CellInform:
                        CMCHKUNPKPTR(cmUnpkCztCellInform_Lst,
                                     &param->u.cztCellInform_Lst,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_LoadInform_IEs(param, pntr, mBuf)
CztProtIE_Field_LoadInform_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueLoadInform_IEsCls(&param->value,
                                                               param->id.val,
                                                                 pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_LoadInform_IEs(param, pntr, mBuf)
CztProtIE_Cont_LoadInform_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_LoadInform_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_LoadInform_IEs,
                                     &(param->member[i]),
                                     pntr, mBuf); 
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztLoadInform(param, pntr, mBuf)
CztLoadInform *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_LoadInform_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnSrvdCellsToMdfy_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnSrvdCellsToMdfy_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
         ...
         /*Unpacking CztDeactivationInd*/
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztDeactivationInd,
                                  mBuf); 
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_SrvdCellsToMdfy_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_SrvdCellsToMdfy_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnSrvdCellsToMdfy_Item_ExtIEsCls(
                                                          &param->extensionValue,
                                                          param->id.val,
                                                          pntr,
                                                          mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_SrvdCellsToMdfy_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_SrvdCellsToMdfy_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                             cmUnpkCztProtExtnField_SrvdCellsToMdfy_Item_ExtIEs,
                             &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSrvdCellsToMdfy_Item(param, pntr, mBuf)
CztSrvdCellsToMdfy_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->old_ecgi, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztSrvdCell_Inform, &param->servedCellInfo,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztNeighbour_Inform, &param->neighbour_Info,
                             pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_SrvdCellsToMdfy_Item_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSrvdCellsToMdfy(param, pntr, mBuf)
CztSrvdCellsToMdfy *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztSrvdCellsToMdfy_Item)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztSrvdCellsToMdfy_Item,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztOld_ECGIs(param, pntr, mBuf)
CztOld_ECGIs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztECGI)*(param->noComp.val),
        (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztECGI, &(param->member[i]),
                                     pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueENBConfigUpd_IEsCls(param, value, pntr, mBuf)
Czt_ValueENBConfigUpd_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                ...
                case Cztid_SrvdCellsToMdfy:
                        CMCHKUNPKPTR(cmUnpkCztSrvdCellsToMdfy,
                                     &param->u.cztSrvdCellsToMdfy,
                                     pntr, mBuf);
                        break;
                case Cztid_SrvdCellsToDelete:
                        CMCHKUNPKPTR(cmUnpkCztOld_ECGIs,
                                     &param->u.cztOld_ECGIs, 
                                     pntr, mBuf);
                        break;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ENBConfigUpd_IEs(param, pntr, mBuf)
CztProtIE_Field_ENBConfigUpd_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueENBConfigUpd_IEsCls(&param->value,
                                                                 param->id.val,
                                                                   pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ENBConfigUpd_IEs(param, pntr, mBuf)
CztProtIE_Cont_ENBConfigUpd_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_ENBConfigUpd_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_ENBConfigUpd_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztENBConfigUpd(param, pntr, mBuf)
CztENBConfigUpd *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ENBConfigUpd_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueENBConfigUpdAckg_IEsCls(param, value, pntr, mBuf)
Czt_ValueENBConfigUpdAckg_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ENBConfigUpdAckg_IEs(param, pntr, mBuf)
CztProtIE_Field_ENBConfigUpdAckg_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueENBConfigUpdAckg_IEsCls(
                                                                 &param->value,
                                                                 param->id.val,
                                                                 pntr,
                                                                 mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ENBConfigUpdAckg_IEs(param, pntr, mBuf)
CztProtIE_Cont_ENBConfigUpdAckg_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtIE_Field_ENBConfigUpdAckg_IEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztENBConfigUpdAckg(param, pntr, mBuf)
CztENBConfigUpdAckg *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ENBConfigUpdAckg_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueENBConfigUpdFail_IEsCls(param, value, pntr, mBuf)
Czt_ValueENBConfigUpdFail_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ENBConfigUpdFail_IEs(param, pntr, mBuf)
CztProtIE_Field_ENBConfigUpdFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueENBConfigUpdFail_IEsCls(
                                                              &param->value,
                                                              param->id.val,
                                                              pntr,
                                                              mBuf);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ENBConfigUpdFail_IEs(param, pntr, mBuf)
CztProtIE_Cont_ENBConfigUpdFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtIE_Field_ENBConfigUpdFail_IEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztENBConfigUpdFail(param, pntr, mBuf)
CztENBConfigUpdFail *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ENBConfigUpdFail_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCellToReport_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCellToReport_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_CellToReport_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_CellToReport_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnCellToReport_Item_ExtIEsCls(
                                                        &param->extensionValue,
                                                        param->id.val, pntr,
                                                         mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_CellToReport_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_CellToReport_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                             cmUnpkCztProtExtnField_CellToReport_Item_ExtIEs,
                             &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellToReport_Item(param, pntr, mBuf)
CztCellToReport_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->cell_ID, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_CellToReport_Item_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueCellToReport_ItemIEsCls(param, value, pntr, mBuf)
Czt_ValueCellToReport_ItemIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_CellToReport_Item:
                        CMCHKUNPKPTR(cmUnpkCztCellToReport_Item,
                                     &param->u.cztCellToReport_Item,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_CellToReport_ItemIEs(param, pntr, mBuf)
CztProtIE_Field_CellToReport_ItemIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueCellToReport_ItemIEsCls(
                                                             &param->value,
                                                             param->id.val,
                                                             pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellToReport_Lst(param, pntr, mBuf)
CztCellToReport_Lst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Single_Cont_CellToReport_ItemIEs)*(param->
                          noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(
                            cmUnpkCztProtIE_Field_CellToReport_ItemIEs,
                            &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueResStatusRqst_IEsCls(param, value, pntr, mBuf)
Czt_ValueResStatusRqst_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_ENB1_Measurement_ID:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztMeasurement_ID,
                                  mBuf); 
                        break;
                ...
                case Cztid_Registration_Rqst:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztRegistration_Rqst,
                                  mBuf); 
                        break;
                case Cztid_ReportCharacteristics:
                        CMCHKUNPK(cmUnpkTknBStr32, 
                                  &param->u.cztReportCharacteristics,
                                  mBuf); 
                        break;
                case Cztid_CellToReport:
                        CMCHKUNPKPTR(cmUnpkCztCellToReport_Lst,
                                     &param->u.cztCellToReport_Lst,
                                     pntr, mBuf);
                        break;
                case Cztid_RprtngPeriodicity:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztRprtngPeriodicity,
                                  mBuf); 
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ResStatusRqst_IEs(param, pntr, mBuf)
CztProtIE_Field_ResStatusRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueResStatusRqst_IEsCls(&param->value,
                                                                  param->id.val,
                                                                    pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ResStatusRqst_IEs(param, pntr, mBuf)
CztProtIE_Cont_ResStatusRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_ResStatusRqst_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztResStatusRqst(param, pntr, mBuf)
CztResStatusRqst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ResStatusRqst_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueResStatusResp_IEsCls(param, value, pntr, mBuf)
Czt_ValueResStatusResp_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ResStatusResp_IEs(param, pntr, mBuf)
CztProtIE_Field_ResStatusResp_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueResStatusResp_IEsCls(&param->value,
                                                                  param->id.val,
                                                                    pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ResStatusResp_IEs(param, pntr, mBuf)
CztProtIE_Cont_ResStatusResp_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_ResStatusResp_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztResStatusResp(param, pntr, mBuf)
CztResStatusResp *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ResStatusResp_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueResStatusFail_IEsCls(param, value, pntr, mBuf)
Czt_ValueResStatusFail_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
        ...
        switch (value)
        {
                ...
                case Cztid_Cause:
                        CMCHKUNPKPTR(cmUnpkCztCause, &param->u.cztCause, pntr,
                                     mBuf);
                        break;
                case Cztid_CriticalityDiag:/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztCriticalityDiag,
                                     &param->u.cztCriticalityDiag,
                                     pntr, mBuf);
                        break;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ResStatusFail_IEs(param, pntr, mBuf)
CztProtIE_Field_ResStatusFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueResStatusFail_IEsCls(&param->value,
                                                                  param->id.val,
                                                                  pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ResStatusFail_IEs(param, pntr, mBuf)
CztProtIE_Cont_ResStatusFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_ResStatusFail_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztResStatusFail(param, pntr, mBuf)
CztResStatusFail *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ResStatusFail_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnCellMeasurementResult_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnCellMeasurementResult_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_CompositeAvailableCapacityGroup:
                        CMCHKUNPKPTR(
                                 cmUnpkCztCompositeAvailableCapacityGroup,
                                 &param->u.cztCompositeAvailableCapacityGroup,
                                 pntr, mBuf);
                        break;
                case Cztid_ABS_Status:
                        CMCHKUNPKPTR(cmUnpkCztABS_Status, &param->u.cztABS_Status, pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_CellMeasurementResult_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_CellMeasurementResult_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;/*shishir*/
                        ret = cmUnpkCzt_ExtnCellMeasurementResult_Item_ExtIEsCls(&param->extensionValue, param->id.val, pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
                }
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_CellMeasurementResult_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_CellMeasurementResult_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_CellMeasurementResult_Item_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellMeasurementResult_Item(param, pntr, mBuf)
CztCellMeasurementResult_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->cell_ID, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztHWLoadIndicator,
                             &param->hWOverLoadIndicator, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztS1TNLLoadIndicator,
                             &param->s1TNLOverLoadIndicator, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztRadioResStatus, &param->radioResStatus,
                             pntr, mBuf); 
                CMCHKUNPKPTR(
                   cmUnpkCztProtExtnCont_CellMeasurementResult_Item_ExtIEs,
                   &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueCellMeasurementResult_ItemIEsCls(param, value, pntr, mBuf)
Czt_ValueCellMeasurementResult_ItemIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_CellMeasurementResult_Item:
                        CMCHKUNPKPTR(cmUnpkCztCellMeasurementResult_Item,
                                     &param->u.cztCellMeasurementResult_Item,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_CellMeasurementResult_ItemIEs(param, pntr, mBuf)
CztProtIE_Field_CellMeasurementResult_ItemIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueCellMeasurementResult_ItemIEsCls(
                                                                  &param->value,
                                                                  param->id.val,
                                                                  pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellMeasurementResult_Lst(param, pntr, mBuf)
CztCellMeasurementResult_Lst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
        CztProtIE_Single_Cont_CellMeasurementResult_ItemIEs)*(
        param->noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(
                          cmUnpkCztProtIE_Field_CellMeasurementResult_ItemIEs,
                          &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueResStatusUpd_IEsCls(param, value, pntr, mBuf)
Czt_ValueResStatusUpd_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                ...
                case Cztid_CellMeasurementResult:
                        CMCHKUNPKPTR(cmUnpkCztCellMeasurementResult_Lst,
                                     &param->u.cztCellMeasurementResult_Lst,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_ResStatusUpd_IEs(param, pntr, mBuf)
CztProtIE_Field_ResStatusUpd_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueResStatusUpd_IEsCls(&param->value,
                                                                 param->id.val,
                                                                 pntr, mBuf); 
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_ResStatusUpd_IEs(param, pntr, mBuf)
CztProtIE_Cont_ResStatusUpd_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
        CztProtIE_Field_ResStatusUpd_IEs)*(param->noComp.val),
        (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_ResStatusUpd_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztResStatusUpd(param, pntr, mBuf)
CztResStatusUpd *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_ResStatusUpd_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValuePrivMsg_IEsCls(param, value, pntr, mBuf)
Czt_ValuePrivMsg_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztPrivIE_Field_PrivMsg_IEs(param, pntr, mBuf)
CztPrivIE_Field_PrivMsg_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztPrivIE_ID, &param->id, pntr, mBuf); 
                CMCHKUNPK(cmUnpkTknU32, &param->criticality, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztPrivIE_Cont_PrivMsg_IEs(param, pntr, mBuf)
CztPrivIE_Cont_PrivMsg_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztPrivIE_Field_PrivMsg_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztPrivIE_Field_PrivMsg_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztPrivMsg(param, pntr, mBuf)
CztPrivMsg *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztPrivIE_Cont_PrivMsg_IEs,
                             &param->privateIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueMobilityChangeRqst_IEsCls(param, value, pntr, mBuf)
Czt_ValueMobilityChangeRqst_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_ENB1_Cell_ID:
                        CMCHKUNPKPTR(cmUnpkCztECGI, &param->u.czteNB1ECGI,
                                     pntr, mBuf);
                        break;
                case Cztid_ENB2_Cell_ID:
                        CMCHKUNPKPTR(cmUnpkCztECGI, &param->u.czteNB2ECGI,
                                     pntr, mBuf);
                        break;
                case Cztid_ENB1_Mobility_Params:
                        CMCHKUNPKPTR(cmUnpkCztMobilityParamsInform,
                                     &param->u.czteNB1MobilityParamsInform,
                                     pntr, mBuf);
                        break;
                case Cztid_ENB2_Proposed_Mobility_Params:
                        CMCHKUNPKPTR(cmUnpkCztMobilityParamsInform,
                                     &param->u.czteNB2MobilityParamsInform,
                                     pntr, mBuf);
                        break;
                case Cztid_Cause:
                        CMCHKUNPKPTR(cmUnpkCztCause, &param->u.cztCause,
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_MobilityChangeRqst_IEs(param, pntr, mBuf)
CztProtIE_Field_MobilityChangeRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueMobilityChangeRqst_IEsCls(
                                                              &param->value,
                                                              param->id.val,
                                                              pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_MobilityChangeRqst_IEs(param, pntr, mBuf)
CztProtIE_Cont_MobilityChangeRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                              cmUnpkCztProtIE_Field_MobilityChangeRqst_IEs,
                              &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztMobilityChangeRqst(param, pntr, mBuf)
CztMobilityChangeRqst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_MobilityChangeRqst_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueMobilityChangeAckg_IEsCls(param, value, pntr, mBuf)
Czt_ValueMobilityChangeAckg_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_MobilityChangeAckg_IEs(param, pntr, mBuf)
CztProtIE_Field_MobilityChangeAckg_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueMobilityChangeAckg_IEsCls(
                                                               &param->value,
                                                               param->id.val,
                                                               pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_MobilityChangeAckg_IEs(param, pntr, mBuf)
CztProtIE_Cont_MobilityChangeAckg_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                             cmUnpkCztProtIE_Field_MobilityChangeAckg_IEs,
                             &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztMobilityChangeAckg(param, pntr, mBuf)
CztMobilityChangeAckg *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_MobilityChangeAckg_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueMobilityChangeFail_IEsCls(param, value, pntr, mBuf)
Czt_ValueMobilityChangeFail_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
        ...
        switch (value)
        {
             ...
             pntr, mBuf);
                ...
                case Cztid_ENB2_Mobility_Params_Modification_Range:
                        CMCHKUNPKPTR(cmUnpkCztMobilityParamsModificationRange,
                                     &param->u.
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_MobilityChangeFail_IEs(param, pntr, mBuf)
CztProtIE_Field_MobilityChangeFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueMobilityChangeFail_IEsCls(
                                                                &param->value,
                                                                param->id.val,
                                                                pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_MobilityChangeFail_IEs(param, pntr, mBuf)
CztProtIE_Cont_MobilityChangeFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                              cmUnpkCztProtIE_Field_MobilityChangeFail_IEs,
                              &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztMobilityChangeFail(param, pntr, mBuf)
CztMobilityChangeFail *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_MobilityChangeFail_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueRLFInd_IEsCls(param, value, pntr, mBuf)
Czt_ValueRLFInd_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_FailCellPCI:
                        CMCHKUNPK(cmUnpkTknU32, &param->u.cztPCI, mBuf); 
                        break;
                case Cztid_Re_establishmentCellECGI:
                        CMCHKUNPKPTR(cmUnpkCztECGI, &param->u.cztECGI, pntr,
                                     mBuf);
      ...
      /*Unpacking CztCRNTI*/
                        CMCHKUNPK(cmUnpkTknBStr32, &param->u.cztCRNTI, mBuf); 
                        break;
                case Cztid_ShortMAC_I:
                        CMCHKUNPK(cmUnpkTknBStr32, &param->u.cztShortMAC_I,
                                  mBuf); 
                        break;
                case Cztid_UE_RLF_Report_Cont:
                        CZUCHKUNPKPTR(cmUnpkTknStrOSXL, 
                                      &param->u.cztUE_RLF_Report_Cont,
                                      pntr, mBuf); 
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_RLFInd_IEs(param, pntr, mBuf)
CztProtIE_Field_RLFInd_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueRLFInd_IEsCls(&param->value,
                                                           param->id.val,
                                                           pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_RLFInd_IEs(param, pntr, mBuf)
CztProtIE_Cont_RLFInd_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, sizeof(
                          CztProtIE_Field_RLFInd_IEs)*(param->noComp.val),
                          (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_RLFInd_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztRLFInd(param, pntr, mBuf)
CztRLFInd *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_RLFInd_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnSrvdCellsToActivate_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnSrvdCellsToActivate_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_SrvdCellsToActivate_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_SrvdCellsToActivate_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnSrvdCellsToActivate_Item_ExtIEsCls(
                                                        &param->extensionValue,
                                                        param->id.val, pntr,
                                                        mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_SrvdCellsToActivate_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_SrvdCellsToActivate_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {/*shishir*/
                        CMCHKUNPKPTR(cmUnpkCztProtExtnField_SrvdCellsToActivate_Item_ExtIEs, &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSrvdCellsToActivate_Item(param, pntr, mBuf)
CztSrvdCellsToActivate_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->ecgi, pntr, mBuf); 
                CMCHKUNPKPTR(
                   cmUnpkCztProtExtnCont_SrvdCellsToActivate_Item_ExtIEs,
                   &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSrvdCellsToActivate(param, pntr, mBuf)
CztSrvdCellsToActivate *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                CMGETMBLK(pntr, sizeof(CztSrvdCellsToActivate_Item)*(
                          param->noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztSrvdCellsToActivate_Item, 
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueCellActvnRqst_IEsCls(param, value, pntr, mBuf)
Czt_ValueCellActvnRqst_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_SrvdCellsToActivate:
                        CMCHKUNPKPTR(cmUnpkCztSrvdCellsToActivate,
                                     &param->u.cztSrvdCellsToActivate,
          pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_CellActvnRqst_IEs(param, pntr, mBuf)
CztProtIE_Field_CellActvnRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueCellActvnRqst_IEsCls(&param->value,
                                                                  param->id.val,
                                                                    pntr, mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_CellActvnRqst_IEs(param, pntr, mBuf)
CztProtIE_Cont_CellActvnRqst_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_CellActvnRqst_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellActvnRqst(param, pntr, mBuf)
CztCellActvnRqst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_CellActvnRqst_IEs,
           &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ExtnActivatedCellLst_Item_ExtIEsCls(param, value, pntr, mBuf)
Czt_ExtnActivatedCellLst_Item_ExtIEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnField_ActivatedCellLst_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnField_ActivatedCellLst_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ExtnActivatedCellLst_Item_ExtIEsCls(
                                                         &param->extensionValue,
                                                         param->id.val, pntr,
                                                         mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtExtnCont_ActivatedCellLst_Item_ExtIEs(param, pntr, mBuf)
CztProtExtnCont_ActivatedCellLst_Item_ExtIEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                {
                        CMCHKUNPKPTR(
                         cmUnpkCztProtExtnField_ActivatedCellLst_Item_ExtIEs,
                         &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztActivatedCellLst_Item(param, pntr, mBuf)
CztActivatedCellLst_Item *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMCHKUNPKPTR(cmUnpkCztECGI, &param->ecgi, pntr, mBuf); 
                CMCHKUNPKPTR(cmUnpkCztProtExtnCont_ActivatedCellLst_Item_ExtIEs,
                             &param->iE_Extns, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztActivatedCellLst(param, pntr, mBuf)
CztActivatedCellLst *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                CMGETMBLK(pntr, 
            sizeof(CztActivatedCellLst_Item)*(param->noComp.val),
         (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztActivatedCellLst_Item,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueCellActvnResp_IEsCls(param, value, pntr, mBuf)
Czt_ValueCellActvnResp_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_ActivatedCellLst:
                        CMCHKUNPKPTR(cmUnpkCztActivatedCellLst,
                                     &param->u.cztActivatedCellLst,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_CriticalityDiag:
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_CellActvnResp_IEs(param, pntr, mBuf)
CztProtIE_Field_CellActvnResp_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueCellActvnResp_IEsCls(&param->value,
                                                                  param->id.val,
                                                                  pntr,
                                                                  mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_CellActvnResp_IEs(param, pntr, mBuf)
CztProtIE_Cont_CellActvnResp_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->noComp.pres != NOTPRSNT ) 
        {
                ...
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_CellActvnResp_IEs,
                                     &(param->member[i]), pntr, mBuf); 
                }
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellActvnResp(param, pntr, mBuf)
CztCellActvnResp *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_CellActvnResp_IEs,
                             &param->protocolIEs, pntr, mBuf); 
        }
        RETVALUE(ROK);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_ValueCellActvnFail_IEsCls(param, value, pntr, mBuf)
Czt_ValueCellActvnFail_IEsCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Field_CellActvnFail_IEs(param, pntr, mBuf)
CztProtIE_Field_CellActvnFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_ValueCellActvnFail_IEsCls(
                                                           &param->value,
                                                           param->id.val,
                                                           pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztProtIE_Cont_CellActvnFail_IEs(param, pntr, mBuf)
CztProtIE_Cont_CellActvnFail_IEs *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        noComp.val), (Ptr*)&(param->member) );
                for(i = 0; i < param->noComp.val; i++)
                {
                        CMCHKUNPKPTR(cmUnpkCztProtIE_Field_CellActvnFail_IEs,
                                     &(param->member[i]),
                                     pntr,
                                     mBuf); 
                }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztCellActvnFail(param, pntr, mBuf)
CztCellActvnFail *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                CMCHKUNPKPTR(cmUnpkCztProtIE_Cont_CellActvnFail_IEs,
                             &param->protocolIEs,
                             pntr,
                             mBuf); 
        }
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_InitiatingMsgCls(param, value, pntr, mBuf)
Czt_InitiatingMsgCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        switch (value)
        {
                case Cztid_handoverPrep:
                        CMCHKUNPKPTR(cmUnpkCztHovrRqst, &param->u.cztHovrRqst,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_reset:
                        CMCHKUNPKPTR(cmUnpkCztResetRqst, &param->u.cztResetRqst,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_x2Setup:
                        CMCHKUNPKPTR(cmUnpkCztX2SetupRqst, 
                                     &param->u.cztX2SetupRqst,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_resourceStatusRprtngInitiation:
                        CMCHKUNPKPTR(cmUnpkCztResStatusRqst,
                                     &param->u.cztResStatusRqst,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_eNBConfigUpd:
                        CMCHKUNPKPTR(cmUnpkCztENBConfigUpd,
                                     &param->u.cztENBConfigUpd,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_mobilitySettingsChange:
                        CMCHKUNPKPTR(cmUnpkCztMobilityChangeRqst,
                                     &param->u.cztMobilityChangeRqst,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_cellActvn:
                        CMCHKUNPKPTR(cmUnpkCztCellActvnRqst,
                                     &param->u.cztCellActvnRqst,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_snStatusTfr:
                        CMCHKUNPKPTR(cmUnpkCztSNStatusTfr, 
                                     &param->u.cztSNStatusTfr,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_uECntxtRls:
                        CMCHKUNPKPTR(cmUnpkCztUECntxtRls, 
                                     &param->u.cztUECntxtRls,
                                     pntr, 
                                     mBuf);
                        break;
                case Cztid_handoverCancel:
                        CMCHKUNPKPTR(cmUnpkCztHovrCancel,
                                     &param->u.cztHovrCancel,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_errorInd:
                        CMCHKUNPKPTR(cmUnpkCztErrInd, &param->u.cztErrInd,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_resourceStatusRprtng:
                        CMCHKUNPKPTR(cmUnpkCztResStatusUpd,
                                     &param->u.cztResStatusUpd,
                                     pntr, mBuf);
                        break;
                case Cztid_loadInd:
                        CMCHKUNPKPTR(cmUnpkCztLoadInform, 
                                     &param->u.cztLoadInform,
                                     pntr, mBuf);
                        break;
                case Cztid_privateMsg:
                        CMCHKUNPKPTR(cmUnpkCztPrivMsg, &param->u.cztPrivMsg,
                                     pntr, mBuf);
                        break;
                case Cztid_rLFInd:
                        CMCHKUNPKPTR(cmUnpkCztRLFInd, &param->u.cztRLFInd,
                                     pntr, mBuf);
                        break;
                case Cztid_handoverReport:
                        CMCHKUNPKPTR(cmUnpkCztHovrReport,
                                     &param->u.cztHovrReport,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztInitiatingMsg(param, pntr, mBuf)
CztInitiatingMsg *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_InitiatingMsgCls(
                                                      &param->value,
                                                     param->procedureCode.val,
                                                     pntr,
                                                     mBuf);
                        if (ret != ROK)
                                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_SuccessfulOutcomeCls(param, value, pntr, mBuf)
Czt_SuccessfulOutcomeCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                case Cztid_handoverPrep:
                        CMCHKUNPKPTR(cmUnpkCztHovrRqstAckg,
                                     &param->u.cztHovrRqstAckg,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_reset:
                        CMCHKUNPKPTR(cmUnpkCztResetResp,
                                     &param->u.cztResetResp,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_x2Setup:
                        CMCHKUNPKPTR(cmUnpkCztX2SetupResp,
                                     &param->u.cztX2SetupResp,
                                     pntr,
                                     mBuf);
                        break;
                case Cztid_resourceStatusRprtngInitiation:
                        CMCHKUNPKPTR(cmUnpkCztResStatusResp, 
                                     &param->u.cztResStatusResp,
                                     pntr, mBuf);
                        break;
                case Cztid_eNBConfigUpd:
                        CMCHKUNPKPTR(cmUnpkCztENBConfigUpdAckg,
                                     &param->u.cztENBConfigUpdAckg,
                                     pntr, mBuf);
                        break;
                case Cztid_mobilitySettingsChange:
                        CMCHKUNPKPTR(cmUnpkCztMobilityChangeAckg,
                                     &param->u.cztMobilityChangeAckg,
                                     pntr, mBuf);
                        break;
                case Cztid_cellActvn:
                        CMCHKUNPKPTR(cmUnpkCztCellActvnResp,
                                     &param->u.cztCellActvnResp,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztSuccessfulOutcome(param, pntr, mBuf)
CztSuccessfulOutcome *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_SuccessfulOutcomeCls(
                                                     &param->value,
                                                     param->procedureCode.val,
                                                     pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCzt_UnsuccessfulOutcomeCls(param, value, pntr, mBuf)
Czt_UnsuccessfulOutcomeCls *param;
U32 value;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        {
                case Cztid_handoverPrep:
                        CMCHKUNPKPTR(cmUnpkCztHovrPrepFail,
                                     &param->u.cztHovrPrepFail,
                                     pntr, mBuf);
                        break;
                case Cztid_x2Setup:
                        CMCHKUNPKPTR(cmUnpkCztX2SetupFail,
                                     &param->u.cztX2SetupFail,
                                     pntr, mBuf);
                        break;
                case Cztid_resourceStatusRprtngInitiation:
                        CMCHKUNPKPTR(cmUnpkCztResStatusFail,
                                     &param->u.cztResStatusFail,
                                     pntr, mBuf);
                        break;
                case Cztid_eNBConfigUpd:
                        CMCHKUNPKPTR(cmUnpkCztENBConfigUpdFail,
                                     &param->u.cztENBConfigUpdFail,
                                     pntr, mBuf);
                        break;
                case Cztid_mobilitySettingsChange:
                        CMCHKUNPKPTR(cmUnpkCztMobilityChangeFail, 
                                     &param->u.cztMobilityChangeFail,
                                     pntr, mBuf);
                        break;
                case Cztid_cellActvn:
                        CMCHKUNPKPTR(cmUnpkCztCellActvnFail,
                                     &param->u.cztCellActvnFail,
                                     pntr, mBuf);
                        break;
                default:
                RETVALUE(RFAILED);
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztUnsuccessfulOutcome(param, pntr, mBuf)
CztUnsuccessfulOutcome *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
{
        ...
        if( param->pres.pres != NOTPRSNT ) 
        {
                ...
                {
                        S16 ret;
                        ret = cmUnpkCzt_UnsuccessfulOutcomeCls(
                                                      &param->value,
                                                      param->procedureCode.val,
                                                      pntr, mBuf);
                        if (ret != ROK)
...
#else /*ANSI*/ 
PUBLIC S16 cmUnpkCztX2AP_PDU(param, pntr, mBuf)
CztX2AP_PDU *param;
Ptr pntr; 
Buffer *mBuf;
#endif /*ANSI*/
        ...
        if(param->choice.pres) 
        {
                switch( param->choice.val ) 
                {
                        case X2AP_PDU_INITIATINGMSG :
                                CMCHKUNPKPTR(cmUnpkCztInitiatingMsg,
                                             &param->val.initiatingMsg,
                                             pntr, mBuf); 
                                break;
                        case X2AP_PDU_SUCCESSFULOUTCOME :
                                CMCHKUNPKPTR(cmUnpkCztSuccessfulOutcome,
                                             &param->val.successfulOutcome,
                                             pntr, mBuf); 
                                break;
                        case X2AP_PDU_UNSUCCESSFULOUTCOME :
                                CMCHKUNPKPTR(cmUnpkCztUnsuccessfulOutcome,
                                             &param->val.unsuccessfulOutcome,
                                             pntr, mBuf); 
                                break;
                        default:
                                RETVALUE(RFAILED); 
...
namespace CZ_LTEX2AP_REL11_UNPK_C
{
   using namespace CZ_LTEX2AP_REL11_UNPK_X;
   using namespace CZ_LTEX2AP_REL11; 
   using namespace CZ_ASN_H_R11;
...
#endif
{
	...
	if( param->pres.pres != NOTPRSNT ) 
	{
		...
		CMCHKUNPK(cmUnpkCztMME_Code, &param->mMME_Code, mBuf); 
...
#define cmUnpkCztRprtngTriggerMDT cmUnpkTknU32
...
/*
* FUN : cmUnpkCzt_ExtnThresholdEventA2_ExtIEsCls
*  DESC: Function to Unpack Czt_ExtnThresholdEventA2_ExtIEsCls structure 
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmUnpkCzt_ExtnThresholdEventA2_ExtIEsCls
(
Czt_ExtnThresholdEventA2_ExtIEsCls *param,
U32 val,
Ptr ptr,
Buffer *mBuf
)
#else 
PUBLIC S16 cmUnpkCzt_ExtnThresholdEventA2_ExtIEsCls(param, val, ptr, mBuf)
Czt_ExtnThresholdEventA2_ExtIEsCls *param;
U32 val;
Ptr ptr; 
Buffer *mBuf;
#endif
{
	...
	TRC3(cmUnpkCzt_ExtnThresholdEventA2_ExtIEsCls) 
	
	RETVALUE(RFAILED);
}	 /* End of function cmUnpkCzt_ExtnThresholdEventA2_ExtIEsCls */



/*
* FUN : cmUnpkCztProtExtnField_ThresholdEventA2_ExtIEs
*  DESC: Function to Unpack CztProtExtnField_ThresholdEventA2_ExtIEs structure 
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmUnpkCztProtExtnField_ThresholdEventA2_ExtIEs
(
CztProtExtnField_ThresholdEventA2_ExtIEs *param,
Ptr ptr,
Buffer *mBuf
)
#else 
PUBLIC S16 cmUnpkCztProtExtnField_ThresholdEventA2_ExtIEs(param, ptr, mBuf)
CztProtExtnField_ThresholdEventA2_ExtIEs *param;
Ptr ptr; 
Buffer *mBuf;
#endif
{
	...
	TRC3(cmUnpkCztProtExtnField_ThresholdEventA2_ExtIEs) 
	...
	if( param->pres.pres != NOTPRSNT ) 
	{
		...
		{
			S16 ret;
			ret = cmUnpkCzt_ExtnThresholdEventA2_ExtIEsCls(&param->extensionValue, param->id.val, ptr, mBuf);
			if (ret != ROK)
				RETVALUE(RFAILED);
		}
	}
	RETVALUE(ROK);
}	 /* End of function cmUnpkCztProtExtnField_ThresholdEventA2_ExtIEs */



/*
* FUN : cmUnpkCztProtExtnCont_ThresholdEventA2_ExtIEs
*  DESC: Function to Unpack CztProtExtnCont_ThresholdEventA2_ExtIEs structure 
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmUnpkCztProtExtnCont_ThresholdEventA2_ExtIEs
(
CztProtExtnCont_ThresholdEventA2_ExtIEs *param,
Ptr ptr,
Buffer *mBuf
)
#else 
PUBLIC S16 cmUnpkCztProtExtnCont_ThresholdEventA2_ExtIEs(param, ptr, mBuf)
CztProtExtnCont_ThresholdEventA2_ExtIEs *param;
Ptr ptr; 
Buffer *mBuf;
#endif
{
	Cntr i;
	TRC3(cmUnpkCztProtExtnCont_ThresholdEventA2_ExtIEs) 
	
	CMCHKUNPK(cmUnpkTknU16, &param->noComp, mBuf); 
	if( param->noComp.pres != NOTPRSNT ) 
	{
		CMGETMBLK(ptr, sizeof(CztProtExtnField_ThresholdEventA2_ExtIEs)*(param->noComp.val), (Ptr*)&(param->member) );
		for(i = 0; i < param->noComp.val; i++)
		{
			CMCHKUNPKPTR(cmUnpkCztProtExtnField_ThresholdEventA2_ExtIEs, &(param->member[i]), ptr, mBuf); 
		}
	}
	return(ROK);
}	 /* End of function cmUnpkCztProtExtnCont_ThresholdEventA2_ExtIEs */



/*
* FUN : cmUnpkCztThresholdEventA2
*  DESC: Function to Unpack CztThresholdEventA2 structure 
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmUnpkCztThresholdEventA2
(
CztThresholdEventA2 *param,
Ptr ptr,
Buffer *mBuf
)
#else 
PUBLIC S16 cmUnpkCztThresholdEventA2(param, ptr, mBuf)
CztThresholdEventA2 *param;
Ptr ptr; 
Buffer *mBuf;
#endif
{
	...
	TRC3(cmUnpkCztThresholdEventA2) 
	
	CMCHKUNPK( cmUnpkTknPres, &param->pres, mBuf); 
	if( param->pres.pres != NOTPRSNT ) 
	{
		CMCHKUNPKPTR(cmUnpkCztMeasurementThresholdA2, &param->measurementThreshold, ptr, mBuf); 
		CMCHKUNPKPTR(cmUnpkCztProtExtnCont_ThresholdEventA2_ExtIEs, &param->iE_Extns, ptr, mBuf); 
	}
	RETVALUE(ROK);
}	 /* End of function cmUnpkCztThresholdEventA2 */
...
/*
* FUN : cmUnpkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls
*  DESC: Function to Unpack Czt_ExtnPeriodicRprtngMDT_ExtIEsCls structure 
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmUnpkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls
(
Czt_ExtnPeriodicRprtngMDT_ExtIEsCls *param,
U32 val,
Ptr ptr,
Buffer *mBuf
)
#else 
PUBLIC S16 cmUnpkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls(param, val, ptr, mBuf)
Czt_ExtnPeriodicRprtngMDT_ExtIEsCls *param;
U32 val;
Ptr ptr; 
Buffer *mBuf;
#endif
{
	...
	TRC3(cmUnpkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls) 
	
	RETVALUE(RFAILED);
}	 /* End of function cmUnpkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls */



/*
* FUN : cmUnpkCztProtExtnField_PeriodicRprtngMDT_ExtIEs
*  DESC: Function to Unpack CztProtExtnField_PeriodicRprtngMDT_ExtIEs structure 
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmUnpkCztProtExtnField_PeriodicRprtngMDT_ExtIEs
(
CztProtExtnField_PeriodicRprtngMDT_ExtIEs *param,
Ptr ptr,
Buffer *mBuf
)
#else 
PUBLIC S16 cmUnpkCztProtExtnField_PeriodicRprtngMDT_ExtIEs(param, ptr, mBuf)
CztProtExtnField_PeriodicRprtngMDT_ExtIEs *param;
Ptr ptr; 
Buffer *mBuf;
#endif
{
	...
	TRC3(cmUnpkCztProtExtnField_PeriodicRprtngMDT_ExtIEs) 
	...
	if( param->pres.pres != NOTPRSNT ) 
	{
		...
		{
			S16 ret;
			ret = cmUnpkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls(&param->extensionValue, param->id.val, ptr, mBuf);
			if (ret != ROK)
				RETVALUE(RFAILED);
		}
	}
	RETVALUE(ROK);
}	 /* End of function cmUnpkCztProtExtnField_PeriodicRprtngMDT_ExtIEs */



/*
* FUN : cmUnpkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs
*  DESC: Function to Unpack CztProtExtnCont_PeriodicRprtngMDT_ExtIEs structure 
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmUnpkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs
(
CztProtExtnCont_PeriodicRprtngMDT_ExtIEs *param,
Ptr ptr,
Buffer *mBuf
)
#else 
PUBLIC S16 cmUnpkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs(param, ptr, mBuf)
CztProtExtnCont_PeriodicRprtngMDT_ExtIEs *param;
Ptr ptr; 
Buffer *mBuf;
#endif
{
	Cntr i;
	TRC3(cmUnpkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs) 
	
	CMCHKUNPK(cmUnpkTknU16, &param->noComp, mBuf); 
	if( param->noComp.pres != NOTPRSNT ) 
	{
		CMGETMBLK(ptr, sizeof(CztProtExtnField_PeriodicRprtngMDT_ExtIEs)*(param->noComp.val), (Ptr*)&(param->member) );
		for(i = 0; i < param->noComp.val; i++)
		{
			CMCHKUNPKPTR(cmUnpkCztProtExtnField_PeriodicRprtngMDT_ExtIEs, &(param->member[i]), ptr, mBuf); 
		}
	}
	return(ROK);
}	 /* End of function cmUnpkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs */



/*
* FUN : cmUnpkCztPeriodicRprtngMDT
*  DESC: Function to Unpack CztPeriodicRprtngMDT structure 
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmUnpkCztPeriodicRprtngMDT
(
CztPeriodicRprtngMDT *param,
Ptr ptr,
Buffer *mBuf
)
#else 
PUBLIC S16 cmUnpkCztPeriodicRprtngMDT(param, ptr, mBuf)
CztPeriodicRprtngMDT *param;
Ptr ptr; 
Buffer *mBuf;
#endif
{
	...
	TRC3(cmUnpkCztPeriodicRprtngMDT) 
	...
	if( param->pres.pres != NOTPRSNT ) 
	{
		...
		CMCHKUNPKPTR(cmUnpkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs, &param->iE_Extns, ptr, mBuf); 
	}
	RETVALUE(ROK);
}	 /* End of function cmUnpkCztPeriodicRprtngMDT */
...
#endif
{
	...
	if( param->pres.pres != NOTPRSNT ) 
	{
		...
		CMCHKUNPK(cmUnpkCztRprtngTriggerMDT, &param->reportingTriggerMDT, mBuf); 
		CMCHKUNPKPTR(cmUnpkCztThresholdEventA2, &param->thresholdeventA2, ptr, mBuf); 
		CMCHKUNPKPTR(cmUnpkCztPeriodicRprtngMDT, &param->periodicRprtngMDT, ptr, mBuf); 
...
#endif
{
	...
	{
		case Cztid_ENB1_Measurement_ID:
			CMCHKUNPK(cmUnpkCztMeasurement_ID, &param->u.cztMeasurement_ID, mBuf); 
			break;
		case Cztid_ENB2_Measurement_ID:
			CMCHKUNPK(cmUnpkCztMeasurement_ID, &param->u.cztMeasurement_ID, mBuf); 
			break;
...
/**********************************************************************
        End of file:     czac_asn_unpk.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:08 2015
**********************************************************************/
...
/main/2      ---      czt_unpk_c_001.main_1  pt  1. Updated for release of X2AP 3.1.
*********************************************************************91*/
