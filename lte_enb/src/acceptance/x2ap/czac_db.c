/**********************************************************************
     ...
     Desc:     This file conatins the DB for X2AP.

     File:     cz_db.c

     Sid:      czac_db.c@@/main/TeNB_Main_BR/tenb_main_ccb/2 - Thu Jul 23 15:15:49 2015
...
CmPAsnTknEnum czCauseRadioNwExtLst[7] =
{
   6,
...
#endif /* CM_PASN_DEBUG */
   0,
   /*cz001.301 : reducing the range of the value */
   65535
};
...
PUBLIC CmPAsnElmDef *czMsgDb_r9[] =
{
   &CZ_LTEX2AP_REL9_DB::czX2AP_PDU,
   NULLP
};

namespace CZ_LTEX2AP_REL11_DB
{
...
CmPAsnTknEnum czRprtngTriggerMDTLst[3] =
{
	2,
	CztRprtngTriggerMDTperiodicEnum,
	CztRprtngTriggerMDTa2eventtriggeredEnum
};
CmPAsnEnumDef czRprtngTriggerMDTspec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_ENUM,
#endif /* CM_PASN_DEBUG */
	czRprtngTriggerMDTLst,
	NULLP
};
CmPAsnElmDef czRprtngTriggerMDT =
{
#ifdef CM_PASN_DBG
	" czRprtngTriggerMDT ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_ENUM,
	CM_PASN_EXT_MKR_PRES,
	sizeof(CztRprtngTriggerMDT),
	&flagCz3M,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *)(&czRprtngTriggerMDTspec),
	NULLP
};
...
PUBLIC CmPAsnElmDef *cz_ExtnThresholdEventA2_ExtIEsClsInst[] =
{
	NULLP
};
PUBLIC U32 cz_ExtnThresholdEventA2_ExtIEsClsInstId[] =
{
	Cztid_Invalid
};
PUBLIC CmPAsnClassInfo cz_ExtnThresholdEventA2_ExtIEsClsInfo =
{
	0,
	&cz_ExtnThresholdEventA2_ExtIEsClsInstId[0]
};
CmPAsnClassIEDef cz_ExtnThresholdEventA2_ExtIEsClsSpec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_CLASSIE,
#endif /* CM_PASN_DEBUG */
	&cz_ExtnThresholdEventA2_ExtIEsClsInfo,
	(sizeof(CztProtIE_ID) + sizeof(CztCriticality)),
	&cz_ExtnThresholdEventA2_ExtIEsClsInst[0],
#ifdef CM_PASN_CLASS_IDTYPE
	CM_PASN_TET_UINT32
#endif
};
PUBLIC CmPAsnElmDef cz_ExtnThresholdEventA2_ExtIEsCls =
{
#ifdef CM_PASN_DBG
	" cz_ExtnThresholdEventA2_ExtIEsCls ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_CLASSIE,
	CM_PASN_EXT_MKR_ABS,
	sizeof(Czt_ExtnThresholdEventA2_ExtIEsCls),
	&flagCz3M,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *)(&cz_ExtnThresholdEventA2_ExtIEsClsSpec)
};
PUBLIC CmPAsnElmDef *czProtExtnField_ThresholdEventA2_ExtIEsTkn[] =
{
	&czProtIE_ID,
	&czCriticality,
	&cz_ExtnThresholdEventA2_ExtIEsCls,
...
CmPAsnSetSeqDef czProtExtnField_ThresholdEventA2_ExtIEsspec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_SEQ,
#endif /* CM_PASN_DEBUG */
	...
	NULLP, /* not supported yet */
	NULLP, /* not supported yet */
	&czProtExtnField_ThresholdEventA2_ExtIEsTkn[0], /* ptr to first token*/
	FALSE      /* Event Memory Allocated */
};
PUBLIC CmPAsnElmDef czProtExtnField_ThresholdEventA2_ExtIEs =
{
#ifdef CM_PASN_DBG
	" czProtExtnField_ThresholdEventA2_ExtIEs ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_SEQ,
	CM_PASN_EXT_MKR_ABS,
	sizeof(CztProtExtnField_ThresholdEventA2_ExtIEs),
	&flagCz3M,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *)(&czProtExtnField_ThresholdEventA2_ExtIEsspec),
	NULLP
};
CmPAsnSetSeqOfDef czProtExtnCont_ThresholdEventA2_ExtIEsspec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_SEQOF,
#endif /* CM_PASN_DEBUG */
...
PUBLIC CmPAsnElmDef czOptProtExtnCont_ThresholdEventA2_ExtIEs =
{
#ifdef CM_PASN_DBG
	" czProtExtnCont_ThresholdEventA2_ExtIEs ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_SEQOF,
	CM_PASN_EXT_MKR_ABS,
	sizeof(CztProtExtnCont_ThresholdEventA2_ExtIEs),
	&flagCz3O,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *) (&czProtExtnCont_ThresholdEventA2_ExtIEsspec),
	NULLP
};
PUBLIC CmPAsnElmDef czProtExtnCont_ThresholdEventA2_ExtIEs =
{
#ifdef CM_PASN_DBG
	" czProtExtnCont_ThresholdEventA2_ExtIEs ",
#endif /* CM_PASN_DEBUG */
...
PUBLIC CmPAsnElmDef *czThresholdEventA2Tkn[] =
{
	&czMeasurementThresholdA2,
	&czOptProtExtnCont_ThresholdEventA2_ExtIEs,
		&czProtExtnField_ThresholdEventA2_ExtIEs,
		&czConstTerm,
	&czExtMkr,
	&czConstTerm
};
CmPAsnSetSeqDef czThresholdEventA2spec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_SEQ,
#endif /* CM_PASN_DEBUG */
	...
	NULLP, /* not supported yet */
	NULLP, /* not supported yet */
	&czThresholdEventA2Tkn[0], /* ptr to first token*/
	FALSE      /* Event Memory Allocated */
};
PUBLIC CmPAsnElmDef czThresholdEventA2 =
{
#ifdef CM_PASN_DBG
	" czThresholdEventA2 ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_SEQ,
	CM_PASN_EXT_MKR_PRES,
	sizeof(CztThresholdEventA2),
	&flagCz3M,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *)(&czThresholdEventA2spec),
	NULLP
};
PUBLIC CmPAsnElmDef czOptThresholdEventA2 =
{
#ifdef CM_PASN_DBG
	" czThresholdEventA2 ",
#endif /* CM_PASN_DEBUG */
...
PUBLIC CmPAsnElmDef *cz_ExtnPeriodicRprtngMDT_ExtIEsClsInst[] =
{
	NULLP
};
PUBLIC U32 cz_ExtnPeriodicRprtngMDT_ExtIEsClsInstId[] =
{
	Cztid_Invalid
};
PUBLIC CmPAsnClassInfo cz_ExtnPeriodicRprtngMDT_ExtIEsClsInfo =
{
	0,
	&cz_ExtnPeriodicRprtngMDT_ExtIEsClsInstId[0]
};
CmPAsnClassIEDef cz_ExtnPeriodicRprtngMDT_ExtIEsClsSpec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_CLASSIE,
#endif /* CM_PASN_DEBUG */
	&cz_ExtnPeriodicRprtngMDT_ExtIEsClsInfo,
	(sizeof(CztProtIE_ID) + sizeof(CztCriticality)),
	&cz_ExtnPeriodicRprtngMDT_ExtIEsClsInst[0],
#ifdef CM_PASN_CLASS_IDTYPE
	CM_PASN_TET_UINT32
#endif
};
PUBLIC CmPAsnElmDef cz_ExtnPeriodicRprtngMDT_ExtIEsCls =
{
#ifdef CM_PASN_DBG
	" cz_ExtnPeriodicRprtngMDT_ExtIEsCls ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_CLASSIE,
	CM_PASN_EXT_MKR_ABS,
	sizeof(Czt_ExtnPeriodicRprtngMDT_ExtIEsCls),
	&flagCz3M,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *)(&cz_ExtnPeriodicRprtngMDT_ExtIEsClsSpec)
};
PUBLIC CmPAsnElmDef *czProtExtnField_PeriodicRprtngMDT_ExtIEsTkn[] =
{
	&czProtIE_ID,
	&czCriticality,
	&cz_ExtnPeriodicRprtngMDT_ExtIEsCls,
...
CmPAsnSetSeqDef czProtExtnField_PeriodicRprtngMDT_ExtIEsspec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_SEQ,
#endif /* CM_PASN_DEBUG */
	...
	NULLP, /* not supported yet */
	NULLP, /* not supported yet */
	&czProtExtnField_PeriodicRprtngMDT_ExtIEsTkn[0], /* ptr to first token*/
	FALSE      /* Event Memory Allocated */
};
PUBLIC CmPAsnElmDef czProtExtnField_PeriodicRprtngMDT_ExtIEs =
{
#ifdef CM_PASN_DBG
	" czProtExtnField_PeriodicRprtngMDT_ExtIEs ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_SEQ,
	CM_PASN_EXT_MKR_ABS,
	sizeof(CztProtExtnField_PeriodicRprtngMDT_ExtIEs),
	&flagCz3M,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *)(&czProtExtnField_PeriodicRprtngMDT_ExtIEsspec),
	NULLP
};
CmPAsnSetSeqOfDef czProtExtnCont_PeriodicRprtngMDT_ExtIEsspec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_SEQOF,
#endif /* CM_PASN_DEBUG */
...
PUBLIC CmPAsnElmDef czOptProtExtnCont_PeriodicRprtngMDT_ExtIEs =
{
#ifdef CM_PASN_DBG
	" czProtExtnCont_PeriodicRprtngMDT_ExtIEs ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_SEQOF,
	CM_PASN_EXT_MKR_ABS,
	sizeof(CztProtExtnCont_PeriodicRprtngMDT_ExtIEs),
	&flagCz3O,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *) (&czProtExtnCont_PeriodicRprtngMDT_ExtIEsspec),
	NULLP
};
PUBLIC CmPAsnElmDef czProtExtnCont_PeriodicRprtngMDT_ExtIEs =
{
#ifdef CM_PASN_DBG
	" czProtExtnCont_PeriodicRprtngMDT_ExtIEs ",
#endif /* CM_PASN_DEBUG */
...
PUBLIC CmPAsnElmDef *czPeriodicRprtngMDTTkn[] =
{
	&czReportIntervalMDT,
	&czReportAmountMDT,
	&czOptProtExtnCont_PeriodicRprtngMDT_ExtIEs,
		&czProtExtnField_PeriodicRprtngMDT_ExtIEs,
		&czConstTerm,
	&czExtMkr,
	&czConstTerm
};
CmPAsnSetSeqDef czPeriodicRprtngMDTspec =
{
#ifdef CM_PASN_DBG
	CM_PASN_TET_SEQ,
#endif /* CM_PASN_DEBUG */
	...
	NULLP, /* not supported yet */
	NULLP, /* not supported yet */
	&czPeriodicRprtngMDTTkn[0], /* ptr to first token*/
	FALSE      /* Event Memory Allocated */
};
PUBLIC CmPAsnElmDef czPeriodicRprtngMDT =
{
#ifdef CM_PASN_DBG
	" czPeriodicRprtngMDT ",
#endif /* CM_PASN_DEBUG */
	CM_PASN_TET_SEQ,
	CM_PASN_EXT_MKR_PRES,
	sizeof(CztPeriodicRprtngMDT),
	&flagCz3M,
	CM_PASN_ESC_FUNC_NULLP,
	(U8 *)(&czPeriodicRprtngMDTspec),
	NULLP
};
PUBLIC CmPAsnElmDef czOptPeriodicRprtngMDT =
{
#ifdef CM_PASN_DBG
	" czPeriodicRprtngMDT ",
#endif /* CM_PASN_DEBUG */
...
PUBLIC CmPAsnElmDef *czMDT_ConfigTkn[] =
{
	...
	&czMeasurementsToActivate,
	&czRprtngTriggerMDT,
	&czOptThresholdEventA2,
	&czOptPeriodicRprtngMDT,
...
PUBLIC CmPAsnElmDef *czMsgDb_r11[] =
{
   &CZ_LTEX2AP_REL11_DB::czX2AP_PDU,
   NULLP
};
/**********************************************************************

         End of file:     czac_db.c@@/main/TeNB_Main_BR/tenb_main_ccb/2 - Thu Jul 23 15:15:49 2015
...
/main/3     cz001.301   akaranth        1. reducing the range of the value. 
*********************************************************************91*/
