/**********************************************************************
     ...
     Sid:      czac_asn_pk.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:06 2015
...
#include <czac_asn.h>
#include <czac_asn.x>
#include <czac_asn_pk.x>

namespace CZ_LTEX2AP_REL9_PK_C
{
   using namespace CZ_LTEX2AP_REL9_PK_X;
...
#endif
{
        ...
        if( param->pres.pres != NOTPRSNT )
        {
                ...
                CMCHKPK(cmPkTknStrBSXL, &param->measurement_subset, mBuf);
                CMCHKPK(cmPkTknU32, &param->numberOfCellSpecificAntennaPorts, mBuf);
                CMCHKPK(cmPkTknStrBSXL, &param->abs_pattern_info, mBuf);
        }
        CMCHKPK(cmPkTknPres, &param->pres, mBuf);
        RETVALUE(ROK);
...
#endif
{
        ...
        if( param->pres.pres != NOTPRSNT )
        {
                ...
                CMCHKPK(cmPkTknStrBSXL, &param->usable_abs_pattern_info, mBuf);
        }
        CMCHKPK(cmPkTknPres, &param->pres, mBuf);
        RETVALUE(ROK);
...
#endif
{
        ...
        if( param->pres.pres != NOTPRSNT )
        {
                ...
                CMCHKPK(cmPkTknU32, &param->dL_ABS_status, mBuf);
        }
        CMCHKPK(cmPkTknPres, &param->pres, mBuf);
        RETVALUE(ROK);
...
#endif /* ANSI */
{
   ...
   if(param->choice.pres) 
   {
      switch( param->choice.val ) 
      {
/* czt_pk_c_001.main_2 :  Fix for the build warnings */
#ifdef CZTV1
         case CZT_CAUSE_MISC :
...
#endif /* ANSI */
{
   ...
   switch (value)
   {
	   ...
	   case Cztid_InvokeInd:
		   CMCHKPK(cmPkTknU32, &param->u.cztInvokeInd, mBuf);
		   break;
	   default:
		   RETVALUE(RFAILED);
   }
...
namespace CZ_LTEX2AP_REL11_PK_C
{
   using namespace CZ_LTEX2AP_REL11_PK_X;
...
#define cmPkCztRprtngTriggerMDT cmPkTknU32
...
/* 
* FUN : cmPkCzt_ExtnThresholdEventA2_ExtIEsCls
*  DESC: Function to Pack Czt_ExtnThresholdEventA2_ExtIEsCls structure
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmPkCzt_ExtnThresholdEventA2_ExtIEsCls
(
...
#else 
PUBLIC S16 cmPkCzt_ExtnThresholdEventA2_ExtIEsCls(param, val, mBuf)
Czt_ExtnThresholdEventA2_ExtIEsCls *param;
U32 val;
Buffer *mBuf;
#endif
{
	...
	TRC3(cmPkCzt_ExtnThresholdEventA2_ExtIEsCls) 
	
	RETVALUE(RFAILED);
}	 /* End of function cmPkCzt_ExtnThresholdEventA2_ExtIEsCls */



/* 
* FUN : cmPkCztProtExtnField_ThresholdEventA2_ExtIEs
*  DESC: Function to Pack CztProtExtnField_ThresholdEventA2_ExtIEs structure
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmPkCztProtExtnField_ThresholdEventA2_ExtIEs
(
CztProtExtnField_ThresholdEventA2_ExtIEs *param,
Buffer *mBuf
)
#else 
PUBLIC S16 cmPkCztProtExtnField_ThresholdEventA2_ExtIEs(param, mBuf)
CztProtExtnField_ThresholdEventA2_ExtIEs *param;
Buffer *mBuf;
#endif
{
	
	TRC3(cmPkCztProtExtnField_ThresholdEventA2_ExtIEs) 
	
	if( param->pres.pres != NOTPRSNT ) 
	{
		{
			S16 ret;
			ret = cmPkCzt_ExtnThresholdEventA2_ExtIEsCls(&param->extensionValue, param->id.val, mBuf);
			if (ret != ROK)
				RETVALUE(RFAILED);
		}
		CMCHKPK(cmPkCztCriticality, &param->criticality, mBuf); 
	...
	CMCHKPK(cmPkTknPres, &param->pres, mBuf); 
	RETVALUE(ROK);
}	 /* End of function cmPkCztProtExtnField_ThresholdEventA2_ExtIEs */



/* 
* FUN : cmPkCztProtExtnCont_ThresholdEventA2_ExtIEs
*  DESC: Function to Pack CztProtExtnCont_ThresholdEventA2_ExtIEs structure
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmPkCztProtExtnCont_ThresholdEventA2_ExtIEs
(
CztProtExtnCont_ThresholdEventA2_ExtIEs *param,
Buffer *mBuf
)
#else 
PUBLIC S16 cmPkCztProtExtnCont_ThresholdEventA2_ExtIEs(param, mBuf)
CztProtExtnCont_ThresholdEventA2_ExtIEs *param;
Buffer *mBuf;
#endif
{ 
	Cntr i;
	TRC3(cmPkCztProtExtnCont_ThresholdEventA2_ExtIEs) 
	
	if( param->noComp.pres != NOTPRSNT ) 
	{ 
		for(i = param->noComp.val-1; i >= 0; i--) 
		{ 
			CMCHKPK(cmPkCztProtExtnField_ThresholdEventA2_ExtIEs, (&param->member[i]), mBuf);
		} 
	} 
	CMCHKPK(cmPkTknU16, &param->noComp, mBuf); 
	RETVALUE(ROK);
}	 /* End of function cmPkCztProtExtnCont_ThresholdEventA2_ExtIEs */



/* 
* FUN : cmPkCztThresholdEventA2
*  DESC: Function to Pack CztThresholdEventA2 structure
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmPkCztThresholdEventA2
(
CztThresholdEventA2 *param,
Buffer *mBuf
)
#else 
PUBLIC S16 cmPkCztThresholdEventA2(param, mBuf)
CztThresholdEventA2 *param;
Buffer *mBuf;
#endif
{
	
	TRC3(cmPkCztThresholdEventA2) 
	
	if( param->pres.pres != NOTPRSNT ) 
	{
		CMCHKPK(cmPkCztProtExtnCont_ThresholdEventA2_ExtIEs, &param->iE_Extns, mBuf); 
		CMCHKPK(cmPkCztMeasurementThresholdA2, &param->measurementThreshold, mBuf); 
	}
	CMCHKPK(cmPkTknPres, &param->pres, mBuf); 
	RETVALUE(ROK);
}	 /* End of function cmPkCztThresholdEventA2 */
...
/* 
* FUN : cmPkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls
*  DESC: Function to Pack Czt_ExtnPeriodicRprtngMDT_ExtIEsCls structure
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmPkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls
(
...
#else 
PUBLIC S16 cmPkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls(param, val, mBuf)
Czt_ExtnPeriodicRprtngMDT_ExtIEsCls *param;
U32 val;
Buffer *mBuf;
#endif
{
	...
	TRC3(cmPkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls) 
	
	RETVALUE(RFAILED);
}	 /* End of function cmPkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls */



/* 
* FUN : cmPkCztProtExtnField_PeriodicRprtngMDT_ExtIEs
*  DESC: Function to Pack CztProtExtnField_PeriodicRprtngMDT_ExtIEs structure
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmPkCztProtExtnField_PeriodicRprtngMDT_ExtIEs
(
CztProtExtnField_PeriodicRprtngMDT_ExtIEs *param,
Buffer *mBuf
)
#else 
PUBLIC S16 cmPkCztProtExtnField_PeriodicRprtngMDT_ExtIEs(param, mBuf)
CztProtExtnField_PeriodicRprtngMDT_ExtIEs *param;
Buffer *mBuf;
#endif
{
	
	TRC3(cmPkCztProtExtnField_PeriodicRprtngMDT_ExtIEs) 
	
	if( param->pres.pres != NOTPRSNT ) 
	{
		{
			S16 ret;
			ret = cmPkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls(&param->extensionValue, param->id.val, mBuf);
			if (ret != ROK)
				RETVALUE(RFAILED);
		}
		CMCHKPK(cmPkCztCriticality, &param->criticality, mBuf); 
	...
	CMCHKPK(cmPkTknPres, &param->pres, mBuf); 
	RETVALUE(ROK);
}	 /* End of function cmPkCztProtExtnField_PeriodicRprtngMDT_ExtIEs */



/* 
* FUN : cmPkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs
*  DESC: Function to Pack CztProtExtnCont_PeriodicRprtngMDT_ExtIEs structure
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmPkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs
(
CztProtExtnCont_PeriodicRprtngMDT_ExtIEs *param,
Buffer *mBuf
)
#else 
PUBLIC S16 cmPkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs(param, mBuf)
CztProtExtnCont_PeriodicRprtngMDT_ExtIEs *param;
Buffer *mBuf;
#endif
{ 
	Cntr i;
	TRC3(cmPkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs) 
	
	if( param->noComp.pres != NOTPRSNT ) 
	{ 
		for(i = param->noComp.val-1; i >= 0; i--) 
		{ 
			CMCHKPK(cmPkCztProtExtnField_PeriodicRprtngMDT_ExtIEs, (&param->member[i]), mBuf);
		} 
	} 
	CMCHKPK(cmPkTknU16, &param->noComp, mBuf); 
	RETVALUE(ROK);
}	 /* End of function cmPkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs */



/* 
* FUN : cmPkCztPeriodicRprtngMDT
*  DESC: Function to Pack CztPeriodicRprtngMDT structure
* RETURN: ROK - OK
*/ 
#ifdef ANSI 
PUBLIC S16 cmPkCztPeriodicRprtngMDT
(
CztPeriodicRprtngMDT *param,
Buffer *mBuf
)
#else 
PUBLIC S16 cmPkCztPeriodicRprtngMDT(param, mBuf)
CztPeriodicRprtngMDT *param;
Buffer *mBuf;
#endif
{
	
	TRC3(cmPkCztPeriodicRprtngMDT) 
	
	if( param->pres.pres != NOTPRSNT ) 
	{
		CMCHKPK(cmPkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs, &param->iE_Extns, mBuf); 
		CMCHKPK(cmPkCztReportAmountMDT, &param->reportAmount, mBuf); 
		CMCHKPK(cmPkCztReportIntervalMDT, &param->reportInterval, mBuf); 
	}
	CMCHKPK(cmPkTknPres, &param->pres, mBuf); 
	RETVALUE(ROK);
}	 /* End of function cmPkCztPeriodicRprtngMDT */
...
#endif
{
	...
	if( param->pres.pres != NOTPRSNT ) 
	{
		...
		CMCHKPK(cmPkCztPeriodicRprtngMDT, &param->periodicRprtngMDT, mBuf); 
		CMCHKPK(cmPkCztThresholdEventA2, &param->thresholdeventA2, mBuf); 
		CMCHKPK(cmPkCztRprtngTriggerMDT, &param->reportingTriggerMDT, mBuf); 
...
#endif
{
	...
	{
		case Cztid_ENB1_Measurement_ID:
			CMCHKPK(cmPkCztMeasurement_ID, &param->u.cztMeasurement_ID, mBuf);
			break;
		case Cztid_ENB2_Measurement_ID:
			CMCHKPK(cmPkCztMeasurement_ID, &param->u.cztMeasurement_ID, mBuf);
			break;
...
/**********************************************************************
        End of file:     czac_asn_pk.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:06 2015
**********************************************************************/
