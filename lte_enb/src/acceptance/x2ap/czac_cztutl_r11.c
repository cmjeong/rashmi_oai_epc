...
/********************************************************************20**
  ...
  Sid:      czac_cztutl_r11.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:16 2015
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillGpReqPdu_R11
(
 CmXtaTCCb    *tcCb,
 CmXtaSpCb    *spCb,
 CztEvnt      **cztEvent
...
#else
PUBLIC S16 czAcUtlCztFillGpReqPdu_R11(tcCb, spCb, cztEvent)
   CmXtaTCCb    *tcCb;
   CmXtaSpCb    *spCb;
   CztEvnt      **cztEvent;
#endif
{
   ...
   switch(evntType)
   {
      case CZT_MSG_LOAD_IND:
         {
            if(czAcUtlCztFillLoadInd_R11(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
      ...
      case CZT_MSG_X2_SETUP:
         {
            if(czAcUtlCztFillX2SetupReq_R11(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
      case CZT_MSG_RESET:
      ...
      case CZT_MSG_RSRC_ST_REQ:
         {
            if(czAcUtlCztFillResStatusRqst_R11(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
      case CZT_MSG_RSRC_ST_UPD:
         {
            if(czAcUtlCztFillResStatusUpd_R11(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
      ...
      case CZT_MSG_RLF_INDICATION:
         {
            if(czAcUtlCztFillRlfInd_R11(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillGpRspPdu_R11
(
 CmXtaTCCb    *tcCb,
 CmXtaSpCb    *spCb,
 CztEvnt      **cztEvent
...
#else
PUBLIC S16 czAcUtlCztFillGpRspPdu_R11(tcCb, spCb, cztEvent)
   CmXtaTCCb    *tcCb;
   CmXtaSpCb    *spCb;
   CztEvnt    **cztEvent;
#endif
{
   ...
   switch(eventType)
   {
      ...
      case CZT_MSG_RSRC_ST_RSP:
         {
            if(czAcUtlCztResStatusResp_R11(tcCb, spCb, (cztEvent)) != ROK)
               RETVALUE(RFAILED);
            break;
         }     
      case CZT_MSG_RSRC_ST_FAIL:
         {
            if(czAcUtlCztFillResStatusFail_R11(tcCb, spCb, cztEvent)!=ROK)
               RETVALUE(RFAILED);
            break;
         }
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillBmpReqPdu_R11
(
 CmXtaTCCb    *tcCb,
 CmXtaSpCb    *spCb,
 CztEvnt    **evnt
...
#else
PUBLIC S16 czAcUtlCztFillBmpReqPdu_R11(tcCb, spCb, evnt)
   CmXtaTCCb    *tcCb;
   CmXtaSpCb    *spCb;
   CztEvnt    **evnt;
#endif
{
   ...
   switch(eventType)
   {
      case CZT_MSG_HO_REQ:
         {
            if(czAcUtlCztFillHovrRqst_R11(tcCb, spCb, (evnt)) != ROK)
               RETVALUE(RFAILED);
         }
         break;
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillBmpRspPdu_R11
(
 CmXtaTCCb    *tcCb,
 CmXtaSpCb    *spCb,
 CztEvnt     **evnt
...
#else
PUBLIC S16 czAcUtlCztFillBmpRspPdu_R11(tcCb, spCb, evnt)
   CmXtaTCCb    *tcCb;
   CmXtaSpCb    *spCb;
   CztEvnt     **evnt;
#endif
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillX2SetupReq_R11
(
 CmXtaTCCb    *tcCb,
 CmXtaSpCb    *spCb,
 CztEvnt      **pdu
...
#else
PUBLIC S16 czAcUtlCztFillX2SetupReq_R11(tcCb, spCb, pdu)
   CmXtaTCCb    *tcCb;
   CmXtaSpCb    *spCb;
   CztEvnt      **pdu;
#endif
{  
   ...
   U32        earfcn = 0;
   U8         TAC;
   CztProtExtnField_SrvdCell_Inform_ExtIEs *ie2;
   CztNeighbour_InformMember *ie3;
   CztProtExtnField_Neighbour_Inform_ExtIEs *ie4;
#endif
   Bool encodeFail = FALSE;

   mem.region = 0;
   mem.pool   = 0;
   TRC2(czAcUtlCztFillX2SetupReq_R11); 
...
#else
      /*Fill the CSG Id */
      czAcUtlFillTknU16(&(ie1->servedCellInfo.iE_Extns.noComp),1);
      noComp = 1;
      if ((cmGetMem(x2SetupRqstPdu,(noComp * sizeof(CztProtExtnField_SrvdCell_Inform_ExtIEs)),
                  (Ptr *)&ie1->servedCellInfo.iE_Extns.member)) !=ROK)
      {
         printf("encdecHovrRqst:: cmGetMem failed, line %d\n",__LINE__);
         RETVALUE(RFAILED);
      }
      ie2 = &ie1->servedCellInfo.iE_Extns.member[0];
      czAcUtlFillTknU8(&(ie2->pres),PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie2->id),Cztid_CSG_Id);
      czAcUtlFillTknU32(&(ie2->criticality),CztCriticalityignoreEnum);
      len = 27;
      czFillTknBStr32(&(ie2->extensionValue.u.cztCSG_Id),len,250);
      /*Fill the neighbour info */
      czAcUtlFillTknU16(&(ie1->neighbour_Info.noComp), 1);
      if ((cmGetMem(x2SetupRqstPdu,(noComp * sizeof(CztNeighbour_InformMember)),
                  (Ptr *)&ie1->neighbour_Info.member)) !=ROK)
      {
         printf("encdecHovrRqst:: cmGetMem failed, line %d\n",__LINE__);
         RETVALUE(RFAILED);
      }
      ie3 = &ie1->neighbour_Info.member[0];
      czAcUtlFillTknU8(&(ie3->pres), PRSNT_NODEF);
      czAcUtlFillTknU8(&(ie3->eCGI.pres), PRSNT_NODEF);
      cmMemset(pLMNId, 0, sizeof(pLMNId));
      strcpy((char *)pLMNId, "111"); /* klockwork fix */
      len = 3;

      /* Fill the PLMN ID */
      czFillTknStrOSXL(&(ie3->eCGI.pLMN_Identity),
            len, pLMNId, &x2SetupRqstPdu);

      len = 28;
      czFillTknBStr32(&(ie3->eCGI.eUTRANcellIdentifier), len, val);
      ie3->eCGI.iE_Extns.noComp.pres = NOTPRSNT;

      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "pci", &pci);
      czAcUtlFillTknU32(&(ie3->pCI), pci);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "earfcn", &earfcn);

      czAcUtlFillTknU32(&(ie3->eARFCN), earfcn);
      czAcUtlFillTknU16(&(ie3->iE_Extns.noComp), 1);
      if ((cmGetMem(x2SetupRqstPdu,(noComp * sizeof(CztProtExtnField_Neighbour_Inform_ExtIEs)),
                  (Ptr *)&ie3->iE_Extns.member)) !=ROK)
      {
         printf("encdecHovrRqst:: cmGetMem failed, line %d\n",__LINE__);
         RETVALUE(RFAILED);
      }
      ie4 = &ie3->iE_Extns.member[0];
      czAcUtlFillTknU8(&(ie4->pres),PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie4->id),Cztid_NeighbourTAC);
      czAcUtlFillTknU32(&(ie4->criticality),CztCriticalityignoreEnum);
      /*cmMemset(tAC, 0, sizeof(tAC));
      cmMemcpy((U8 *)tAC,(const U8 *)"11",sizeof(tAC));*/
      len = 2;
      TAC = 111;
      czFillTknStr4((TknStr4 *)(&(ie4->extensionValue.u.cztTAC)), (U8)len, (U8)TAC);
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillHovrRqst_R11
(
 CmXtaTCCb  *tcCb,
 CmXtaSpCb  *spCb,
 CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillHovrRqst_R11(tcCb, spCb, pdu)
   CmXtaTCCb  *tcCb;
   CmXtaSpCb  *spCb;
   CztEvnt    **pdu;
#endif
{
   ...
   U8         thrshldChoice = 0;
   U8         noComp;
   CztProtExtnField_UE_CntxtInform_ExtIEs *ie3;
   CztProtExtnField_TraceActvn_ExtIEs *ie4;
#endif
...
#else
         /*Fill the management based MDT */

         czAcUtlFillTknU16(&(ie->value.u.cztUE_CntxtInform.iE_Extns.noComp),1); 
         noComp = 1;
         ret = 1;
         ret = cmGetMem(hovrRqstPdu,(noComp * sizeof(CztProtExtnField_UE_CntxtInform_ExtIEs)),
               (Ptr *)&ie->value.u.cztUE_CntxtInform.iE_Extns.member);
         if (ret != ROK)
         {
            printf("encdecHovrRqst:: cmGetMem failed, line %d\n",__LINE__);
            RETVALUE(RFAILED);
         }
         /*  if ((cmGetMem(hovrRqstPdu,(noComp * sizeof(CztProtExtnField_UE_CntxtInform_ExtIEs)), 
             (Ptr *)&ie->value.u.cztUE_CntxtInform.iE_Extns.member)) !=ROK)
             {
             printf("encdecHovrRqst:: cmGetMem failed, line %d\n",__LINE__);
             RETVALUE(RFAILED);
             }*/
         ie3=&ie->value.u.cztUE_CntxtInform.iE_Extns.member[0];
         czAcUtlFillTknU8(&(ie3->pres),PRSNT_NODEF);
         czAcUtlFillTknU32(&(ie3->id),Cztid_ManagementBasedMDTallowed);
         czAcUtlFillTknU32(&(ie3->criticality),CztCriticalityignoreEnum);
         cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "MDTallowed", &MDTallowed);
         czAcUtlFillTknU32(&(ie3->extensionValue.u.cztManagementBasedMDTallowed),
...
#ifdef X2AP_REL11
   /*Fill the CSG membership status */
   {
      ie = &hovrRqstPdu->pdu.val.initiatingMsg.value.u.cztHovrRqst.protocolIEs.member[6];

      czAcUtlFillTknU8(&(ie->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie->id), Cztid_CSGMembershipStatus);
      czAcUtlFillTknU32(&(ie->criticality), CztCriticalityrejectEnum);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "CSGmembership", &CSGmembership);
      if (CSGmembership == 0)
      {
         czAcUtlFillTknU32(&(ie->value.u.cztCSGMembershipStatus),CztCSGMembershipStatusmemberEnum);
      }
      else
      {
         czAcUtlFillTknU32(&(ie->value.u.cztCSGMembershipStatus),CztCSGMembershipStatusnot_memberEnum);
      }
   }
   /*Fill the MDT Config */
   {
      ie = &hovrRqstPdu->pdu.val.initiatingMsg.value.u.cztHovrRqst.protocolIEs.member[7];

      czAcUtlFillTknU8(&(ie->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie->id), Cztid_TraceActvn);
      czAcUtlFillTknU32(&(ie->criticality), CztCriticalityignoreEnum);
      czAcUtlFillTknU8(&(ie->value.u.cztTraceActvn.pres),PRSNT_NODEF);
      cmMemset(eTrcid, 0, sizeof(eTrcid));
      strcpy((char *)eTrcid, "11111111"); /* klockwork fix */
      len = 8;

      /* Fill the Trace Id */
      czFillTknStrOSXL(&(ie->value.u.cztTraceActvn.eUTRANTraceID),
            len, eTrcid, &hovrRqstPdu);
      len = 8;
      czFillTknBStr32(&(ie->value.u.cztTraceActvn.interfacesToTrace),len,250);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "traceDepth", &traceDepth);
      if (traceDepth == 0)
      {
         czAcUtlFillTknU32(&(ie->value.u.cztTraceActvn.traceDepth),CztTraceDepthminimumEnum);
      }
      else
      {
         czAcUtlFillTknU32(&(ie->value.u.cztTraceActvn.traceDepth),
               CztTraceDepthmaximumWithoutVendorSpecificExtnEnum);
      }
      cmMemset(TrcIpAdd, 0, sizeof(TrcIpAdd));
      cmMemcpy((U8 *)TrcIpAdd, (const U8 *)"111",4);
      len = 4;

      /* Fill the Trace Collection IP Add. */
      czFillTknStrOSXL(&(ie->value.u.cztTraceActvn.traceCollectionEntityIPAddr),
            len, TrcIpAdd,&hovrRqstPdu);
      czAcUtlFillTknU16(&(ie->value.u.cztTraceActvn.iE_Extns.noComp),1);
      noComp = 1;
      if ((cmGetMem(hovrRqstPdu,(noComp * sizeof(CztProtExtnField_TraceActvn_ExtIEs)),
                  (Ptr *)&ie->value.u.cztTraceActvn.iE_Extns.member)) !=ROK)
      {
         printf("encdecHovrRqst:: cmGetMem failed, line %d\n",__LINE__);
         RETVALUE(RFAILED);
      }
      ie4 = &ie->value.u.cztTraceActvn.iE_Extns.member[0];
      czAcUtlFillTknU8(&(ie4->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie4->id), Cztid_MDTConfig);
      czAcUtlFillTknU32(&(ie4->criticality), CztCriticalityignoreEnum);
      czAcUtlFillTknU8(&(ie4->extensionValue.u.cztMDT_Config.pres),PRSNT_NODEF);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "MDTActvn", &MDTActvn);
      if (MDTActvn == 0)
      {
         czAcUtlFillTknU32(&(ie4->extensionValue.u.cztMDT_Config.mdt_Actvn),CztMDT_Actvnimmediate_MDT_onlyEnum);
      }
      else
      {
         czAcUtlFillTknU32(&(ie4->extensionValue.u.cztMDT_Config.mdt_Actvn),CztMDT_Actvnimmediate_MDT_and_TraceEnum);
      }
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U8, "MDTchoice", &MDTchoice);
      czAcUtlFillTknU8(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.choice),MDTchoice);
      switch (MDTchoice)
      {
         case AREASCOPEOFMDT_CELLBASED:
            czAcUtlFillTknU8(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.cellBased.pres),PRSNT_NODEF);
            czAcUtlFillTknU16(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.cellBased.cellIdLstforMDT.noComp),1);
            if ((cmGetMem(hovrRqstPdu,(noComp * sizeof(CztECGI)),
                        (Ptr *)&ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.cellBased.cellIdLstforMDT.member)) !=ROK)
            {
               printf("encdecHovrRqst:: cmGetMem failed, line %d\n",__LINE__);
               RETVALUE(RFAILED);
            }
            czAcUtlFillTknU8(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.cellBased.
                     cellIdLstforMDT.member[0].pres),PRSNT_NODEF);
            cmMemset(pLMNId, 0, sizeof(pLMNId));
            strcpy((char *)pLMNId, "111"); /* klockwork fix */
            len = 3;

            czFillTknStrOSXL(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.cellBased.cellIdLstforMDT.
                     member[0].pLMN_Identity),len, pLMNId, &hovrRqstPdu);
            len = 28;
            czFillTknBStr32(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.cellBased.cellIdLstforMDT.
                     member[0].eUTRANcellIdentifier), len, val);
            ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.cellBased.cellIdLstforMDT.member[0].
               iE_Extns.noComp.pres=NOTPRSNT;
            ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.cellBased.iE_Extns.noComp.pres=NOTPRSNT;
            break;
         case AREASCOPEOFMDT_TABASED:
            czAcUtlFillTknU8(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.tABased.pres),PRSNT_NODEF);
            czAcUtlFillTknU16(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.tABased.tALstforMDT.noComp),1);
            if ((cmGetMem(hovrRqstPdu,(noComp * sizeof(CztTAC)),
                        (Ptr *)&ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.tABased.tALstforMDT.member)) !=ROK)
            {
               printf("encdecHovrRqst:: cmGetMem failed, line %d\n",__LINE__);
               RETVALUE(RFAILED);
            }
            ...
            len = 2;
            TAC = 111;
            czFillTknStr4(&(ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.tABased.tALstforMDT.member[0]), 
                  (U8)len,TAC);
            ie4->extensionValue.u.cztMDT_Config.areaScopeOfMDT.val.tABased.iE_Extns.noComp.pres=NOTPRSNT;
            break;
         default:
            break;
      }
      len = 8;
      czFillTknBStr32(&(ie4->extensionValue.u.cztMDT_Config.measurementsToActivate),len,250);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "rptTrigrMDT", &rptTrigrMDT);
      if (rptTrigrMDT == 0)
      {
         czAcUtlFillTknU32(&(ie4->extensionValue.u.cztMDT_Config.reportingTriggerMDT),CztRprtngTriggerMDTperiodicEnum);
      }
      else
      {
         czAcUtlFillTknU32(&(ie4->extensionValue.u.cztMDT_Config.reportingTriggerMDT),
               CztRprtngTriggerMDTa2eventtriggeredEnum);
      }
      czAcUtlFillTknU8(&(ie4->extensionValue.u.cztMDT_Config.thresholdeventA2.pres),PRSNT_NODEF);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U8, "thrshldChoice", &thrshldChoice);
      czAcUtlFillTknU8(&(ie4->extensionValue.u.cztMDT_Config.thresholdeventA2.measurementThreshold.choice),thrshldChoice);
      switch (thrshldChoice)
      {
         case MEASUREMENTTHRESHOLDA2_THRESHOLD_RSRP:
            cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "thrshldRsrp", &thrshldRsrp);
            czAcUtlFillTknU32(&(ie4->extensionValue.u.cztMDT_Config.thresholdeventA2.measurementThreshold.val.threshold_RSRP),
                  thrshldRsrp);
            break;
         case MEASUREMENTTHRESHOLDA2_THRESHOLD_RSRQ:
            cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "thrshldRsrq", &thrshldRsrq);
            czAcUtlFillTknU32(&(ie4->extensionValue.u.cztMDT_Config.thresholdeventA2.measurementThreshold.val.threshold_RSRQ),
                  thrshldRsrq);
         default:
            break;
      }

      ie4->extensionValue.u.cztMDT_Config.thresholdeventA2.iE_Extns.noComp.pres=NOTPRSNT;
      czAcUtlFillTknU8(&(ie4->extensionValue.u.cztMDT_Config.periodicRprtngMDT.pres),PRSNT_NODEF);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "rptInterval", &rptInterval);
      if (rptInterval == 0)
      {
         czAcUtlFillTknU32(&(ie4->extensionValue.u.cztMDT_Config.periodicRprtngMDT.reportInterval),
      ...
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "rptAmount", &rptAmount);
      if (rptAmount == 0)
      {
         czAcUtlFillTknU32(&(ie4->extensionValue.u.cztMDT_Config.periodicRprtngMDT.reportAmount),
      ...
      ie4->extensionValue.u.cztMDT_Config.periodicRprtngMDT.iE_Extns.noComp.pres=NOTPRSNT;
      ie4->extensionValue.u.cztMDT_Config.iE_Extns.noComp.pres=NOTPRSNT;
   }
#endif
   *pdu = hovrRqstPdu;
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillLoadInd_R11
(
 CmXtaTCCb  *tcCb,
 CmXtaSpCb  *spCb,
 CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillLoadInd_R11(tcCb, spCb, pdu)
   CmXtaTCCb  *tcCb;
   CmXtaSpCb  *spCb;
   CztEvnt    **pdu;
#endif
{
   ...
   Mem  mem; 
#ifdef X2AP_REL11
   U8		     abs_pattern_info[40];
   U8         measurement_subset[40];
   U8         noComp;
   U8         ABSInformchoice = 0;
   U32        noOfAntennaPorts = 1;
   U32        InvokeInd = 0;
   CztProtExtnField_CellInform_Item_ExtIEs *ie2;
#endif
...
#ifdef X2AP_REL11
   /*Fill the ABS Information */
   {
      ie = &loadInformPdu->pdu.val.initiatingMsg.value.u.cztLoadInform.protocolIEs.member[1];
      czAcUtlFillTknU8(&(ie->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie->id), Cztid_CellInform);
      czAcUtlFillTknU32(&(ie->criticality), CztCriticalityignoreEnum);
      czAcUtlFillTknU16(&(ie->value.u.cztCellInform_Lst.noComp), 1);
      noComp = 1;
      if ((cmGetMem(loadInformPdu,(noComp * sizeof(CztProtIE_Single_Cont_CellInform_ItemIEs)), 
                  (Ptr *)&ie->value.u.cztCellInform_Lst.member)) !=ROK)
      {
         printf("encdecLoadInform:: cmGetMem failed, line %d\n",__LINE__);
         RETVALUE(RFAILED);
      ...
      czFillTknBStr32(&(ie1->value.u.cztCellInform_Item.cell_ID.eUTRANcellIdentifier), len, 100);
      ie1->value.u.cztCellInform_Item.cell_ID.iE_Extns.noComp.pres = NOTPRSNT;
      czAcUtlFillTknU16(&(ie1->value.u.cztCellInform_Item.iE_Extns.noComp),1);
      if ((cmGetMem(loadInformPdu,(noComp * sizeof(CztProtExtnField_CellInform_Item_ExtIEs)), 
                  (Ptr *)&ie1->value.u.cztCellInform_Item.iE_Extns.member)) !=ROK)
      {
         printf("encdecLoadInform:: cmGetMem failed, line %d\n",__LINE__);
         RETVALUE(RFAILED);
      }

      ie2 = &ie1->value.u.cztCellInform_Item.iE_Extns.member[0];
      czAcUtlFillTknU8(&(ie2->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie2->id), Cztid_ABSInform);
      czAcUtlFillTknU32(&(ie2->criticality), CztCriticalityignoreEnum);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U8, "ABSInformchoice", &ABSInformchoice);
      czAcUtlFillTknU8(&(ie2->extensionValue.u.cztABSInform.choice),ABSINFORM_FDD);
      czAcUtlFillTknU8(&(ie2->extensionValue.u.cztABSInform.val.fdd.pres),PRSNT_NODEF);
      cmMemset(abs_pattern_info, 0, sizeof(abs_pattern_info));
      strcpy((char *)abs_pattern_info, "111"); /* klockwork fix */
      len = 40;
      czFillTknStrOSXL(&(ie2->extensionValue.u.cztABSInform.val.fdd.abs_pattern_info),
            len, abs_pattern_info, &loadInformPdu);

      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "noOfAntennaPorts", &noOfAntennaPorts);
      if (noOfAntennaPorts == 0)
      {
         czAcUtlFillTknU32(&(ie2->extensionValue.u.cztABSInform.val.fdd.numberOfCellSpecificAntennaPorts),
      ...
      cmMemset(measurement_subset, 0, sizeof(measurement_subset));
      strcpy((char *)measurement_subset, "111"); /* klockwork fix */
      len = 40;
      czFillTknStrOSXL(&(ie2->extensionValue.u.cztABSInform.val.fdd.measurement_subset),
            len, measurement_subset, &loadInformPdu);
      ie2->extensionValue.u.cztABSInform.val.fdd.iE_Extns.noComp.pres = NOTPRSNT;
   }
   /*Fill the InvokeInd */
   {
      ie = &loadInformPdu->pdu.val.initiatingMsg.value.u.cztLoadInform.protocolIEs.member[2];
      czAcUtlFillTknU8(&(ie->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie->id), Cztid_CellInform);
      czAcUtlFillTknU32(&(ie->criticality), CztCriticalityignoreEnum);
      czAcUtlFillTknU16(&(ie->value.u.cztCellInform_Lst.noComp), 1);
      ...
      ie2 = &ie1->value.u.cztCellInform_Item.iE_Extns.member[0];
      czAcUtlFillTknU8(&(ie2->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie2->id), Cztid_InvokeInd);
      czAcUtlFillTknU32(&(ie2->criticality), CztCriticalityignoreEnum);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "InvokeInd", &InvokeInd);
      czAcUtlFillTknU32(&(ie2->extensionValue.u.cztInvokeInd),CztInvokeIndabs_informationEnum);
   }
#endif
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillResStatusRqst_R11
(
 CmXtaTCCb  *tcCb,
 CmXtaSpCb  *spCb,
 CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillResStatusRqst_R11(tcCb, spCb, pdu)
   CmXtaTCCb  *tcCb;
   CmXtaSpCb  *spCb;
   CztEvnt    **pdu;
#endif
...
#ifdef X2AP_REL11
   /* Fill the partial success indicator */
   {
      ie=&cztResStatusRqstPdu->pdu.val.initiatingMsg.value.u.cztResStatusRqst.protocolIEs.member[idx];
      czAcUtlFillTknU8(&(ie->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie->id), Cztid_PartialSuccessIndicator);
      czAcUtlFillTknU32(&(ie->criticality),CztCriticalityignoreEnum);
      cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "PartialSuccessIndicator", &PartialSuccessIndicator);
      czAcUtlFillTknU32(&(ie->value.u.cztPartialSuccessIndicator),
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztResStatusResp_R11
(
 CmXtaTCCb  *tcCb,
 CmXtaSpCb  *spCb,
 CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztResStatusResp_R11(tcCb, spCb, pdu)
   CmXtaTCCb  *tcCb;
   CmXtaSpCb  *spCb;
   CztEvnt    **pdu;
#endif
{
   ...
   U8      len;
   U8      noComp;
   CztProtIE_Single_Cont_MeasurementInitiationResult_ItemIEs *ie1=NULLP;
#endif
...
#ifdef X2AP_REL11
   /*Fill the measurement initiation result */   
   {
      ie=&cztResStatusRespPdu->pdu.val.successfulOutcome.value.u.cztResStatusResp.protocolIEs.member[idx];
      czAcUtlFillTknU8(&(ie->pres), PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie->id),Cztid_MeasurementInitiationResult_Lst);
      czAcUtlFillTknU32(&(ie->criticality), CztCriticalityignoreEnum);
      czAcUtlFillTknU16(&(ie->value.u.cztMeasurementInitiationResult_Lst.noComp),1);
      noComp = 1;
      if ((cmGetMem(cztResStatusRespPdu, noComp*sizeof(CztProtIE_Single_Cont_MeasurementInitiationResult_ItemIEs),
                  (Ptr*)&ie->value.u.cztMeasurementInitiationResult_Lst.member)) !=ROK)
      {
         printf("cmGetMem failed, line %d\n", __LINE__); 
         RETVALUE(RFAILED);
      }
      ie1= &ie->value.u.cztMeasurementInitiationResult_Lst.member[0];
      czAcUtlFillTknU8(&(ie1->pres),PRSNT_NODEF);
      czAcUtlFillTknU32(&(ie1->id),Cztid_MeasurementInitiationResult_Item);
      czAcUtlFillTknU32(&(ie1->criticality),CztCriticalityignoreEnum);
      czAcUtlFillTknU8(&(ie1->value.u.cztMeasurementInitiationResult_Item.pres),PRSNT_NODEF);  
      czAcUtlFillTknU8(&(ie1->value.u.cztMeasurementInitiationResult_Item.cell_ID.pres),PRSNT_NODEF);
      cmMemset(pLMNId, 0, sizeof(pLMNId));
      strcpy((char *)pLMNId, "111"); /* klockwork fix */
      len = 3;

      czFillTknStrOSXL(&(ie1->value.u.cztMeasurementInitiationResult_Item.cell_ID.pLMN_Identity),
            len, pLMNId, &cztResStatusRespPdu);
      len = 28;

      czFillTknBStr32(&(ie1->value.u.cztMeasurementInitiationResult_Item.cell_ID.eUTRANcellIdentifier), len, 100);
      ie1->value.u.cztMeasurementInitiationResult_Item.cell_ID.iE_Extns.noComp.pres=NOTPRSNT;
      ie1->value.u.cztMeasurementInitiationResult_Item.iE_Extns.noComp.pres=NOTPRSNT;
   }
#endif       
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillResStatusFail_R11
(
 CmXtaTCCb  *tcCb,
 CmXtaSpCb  *spCb,
 CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillResStatusFail_R11(tcCb, spCb, pdu)
   CmXtaTCCb  *tcCb;
   CmXtaSpCb  *spCb;
   CztEvnt    **pdu;
#endif
{
   ...
   U32     causePrt = 3;
   U32     causeMisc = 2;
   U8      MeasFailCausechoice = 1;
   CztProtIE_Single_Cont_CompleteFailCauseInform_ItemIEs *ie1;
   CztProtIE_Single_Cont_MeasurementFailCause_ItemIEs *ie2;
#endif

   mem.region = 0;
   mem.pool   = 0;

   TRC2(czAcUtlCztFillResStatusFail_R11);
   /* Initialize memory control point */
...
#ifdef X2AP_REL11
   /* Fill the complete fail cause information list */
   ie= &cztResStatusFailPdu->pdu.val.unsuccessfulOutcome.value.u.cztResStatusFail.protocolIEs.member[compIdx];
   czAcUtlFillTknU8(&(ie->pres), PRSNT_NODEF);
   czAcUtlFillTknU32(&(ie->id),Cztid_CompleteFailCauseInform_Lst);
   czAcUtlFillTknU32(&(ie->criticality), CztCriticalityignoreEnum);
   czAcUtlFillTknU16(&(ie->value.u.cztCompleteFailCauseInform_Lst.noComp),1);
   noComp = 1;
   if ((cmGetMem(cztResStatusFailPdu, noComp*sizeof(CztProtIE_Single_Cont_CompleteFailCauseInform_ItemIEs),
               (Ptr*)&ie->value.u.cztCompleteFailCauseInform_Lst.member)) !=ROK)
   {
      printf("cmGetMem failed, line %d\n", __LINE__); 
      RETVALUE(RFAILED);
   }
   ie1= &ie->value.u.cztCompleteFailCauseInform_Lst.member[0];
   czAcUtlFillTknU8(&(ie1->pres),PRSNT_NODEF);
   czAcUtlFillTknU32(&(ie1->id),Cztid_CompleteFailCauseInform_Item);
   czAcUtlFillTknU32(&(ie1->criticality),CztCriticalityignoreEnum);
   czAcUtlFillTknU8(&(ie1->value.u.cztCompleteFailCauseInform_Item.pres),PRSNT_NODEF);
   czAcUtlFillTknU8(&(ie1->value.u.cztCompleteFailCauseInform_Item.cell_ID.pres),PRSNT_NODEF);
   cmMemset(pLMNId, 0, sizeof(pLMNId));
   strcpy((char *)pLMNId, "111"); /* klockwork fix */
   len = 3;

   czFillTknStrOSXL(&(ie1->value.u.cztCompleteFailCauseInform_Item.cell_ID.pLMN_Identity),
         len, pLMNId, &cztResStatusFailPdu);
   len = 28;

   czFillTknBStr32(&(ie1->value.u.cztCompleteFailCauseInform_Item.cell_ID.eUTRANcellIdentifier), len, 100);
   ie1->value.u.cztCompleteFailCauseInform_Item.cell_ID.iE_Extns.noComp.pres=NOTPRSNT;
   czAcUtlFillTknU16(&(ie1->value.u.cztCompleteFailCauseInform_Item.measurementFailCause_Lst.noComp),1);
   if ((cmGetMem(cztResStatusFailPdu, noComp*sizeof(CztProtIE_Single_Cont_MeasurementFailCause_ItemIEs),
               (Ptr*)&ie1->value.u.cztCompleteFailCauseInform_Item.measurementFailCause_Lst.member)) !=ROK)
   {
      printf("cmGetMem failed, line %d\n", __LINE__); 
      RETVALUE(RFAILED);
   }
   ie2= &ie1->value.u.cztCompleteFailCauseInform_Item.measurementFailCause_Lst.member[0];
   czAcUtlFillTknU8(&(ie2->pres),PRSNT_NODEF);
   czAcUtlFillTknU32(&(ie2->id),Cztid_MeasurementFailCause_Item);
   czAcUtlFillTknU32(&(ie2->criticality),CztCriticalityignoreEnum);
   czAcUtlFillTknU8(&(ie2->value.u.cztMeasurementFailCause_Item.pres),PRSNT_NODEF);
   /*cmMemset(measFailRpt ,0, sizeof(measFailRpt));
   for (idx = 0; idx < 28; idx++)
      measFailRpt[idx] = 0xFF;*/
   len = 32;
   measFailRpt = 255;
   czFillTknBStr32(&(ie2->value.u.cztMeasurementFailCause_Item.measurementFailedReportCharacteristics), len, measFailRpt);
   cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U8, "MeasFailCausechoice",
         &(MeasFailCausechoice));
   czAcUtlFillTknU8(&(ie2->value.u.cztMeasurementFailCause_Item.cause.choice),MeasFailCausechoice);
   switch (MeasFailCausechoice)
   {
      case CAUSE_RADIONW:
         cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "causeRadioNw",
               &(causeRadioNw));
         if (causeRadioNw == 0)
         {
            czAcUtlFillTknU32(&(ie2->value.u.cztMeasurementFailCause_Item.cause.val.radioNw),
                  CztCauseRadioNwhandover_desirable_for_radio_reasonsEnum);
         }
         else
         {
         ...
         break;
      case CAUSE_TRANSPORT:
         cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "causeTrpt",
               &(causeTrpt));
         if (causeTrpt == 0)
         {
            czAcUtlFillTknU32(&(ie2->value.u.cztMeasurementFailCause_Item.cause.val.radioNw),
         ...
         break;
      case CAUSE_PROTOCOL:
         cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "causePrt",
               &(causePrt));
         if (causePrt == 0)
         {
            czAcUtlFillTknU32(&(ie2->value.u.cztMeasurementFailCause_Item.cause.val.radioNw),
         ...
         break;
      case CAUSE_MISC:
         cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "causeMisc",
               &(causeMisc));
         if (causeMisc == 0)
         {
            czAcUtlFillTknU32(&(ie2->value.u.cztMeasurementFailCause_Item.cause.val.radioNw),
   ...
   ie2->value.u.cztMeasurementFailCause_Item.iE_Extns.noComp.pres=NOTPRSNT;
   ie1->value.u.cztCompleteFailCauseInform_Item.iE_Extns.noComp.pres=NOTPRSNT;
#endif       
 ...
 */
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillResStatusUpd_R11
(
 CmXtaTCCb  *tcCb,
 CmXtaSpCb  *spCb,
 CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillResStatusUpd_R11(tcCb, spCb, pdu)
   CmXtaTCCb  *tcCb;
   CmXtaSpCb  *spCb;
   CztEvnt    **pdu;
#endif
{
...
#ifdef X2AP_REL11
   U16        nComp=1;
   U8         usable_abs_pattern_info[40];
   U8         noComp;
   U8         ABS_statuschoice = 0;
   U32        dL_ABS_status = 50;
   CztProtExtnField_CellMeasurementResult_Item_ExtIEs *ie2=NULLP;
#endif
   CzAcCztRsrcInfo rsrcInfo = {0};

   TRC2(czAcUtlCztFillResStatusUpd_R11);
   ...
   if ((cmGetMem(cztResStatusUpdPdu,(nComp * sizeof(CztProtIE_Single_Cont_CellMeasurementResult_ItemIEs)),
...
#ifdef X2AP_REL11
   /* Fill the ABS status */
   ie1= &ie->value.u.cztCellMeasurementResult_Lst.member[1];
   czAcUtlFillTknU8(&(ie1->pres), PRSNT_NODEF);
   czAcUtlFillTknU32(&(ie1->id),Cztid_CellMeasurementResult_Item);
   czAcUtlFillTknU32(&(ie1->criticality), CztCriticalityignoreEnum);
   czAcUtlFillTknU8(&(ie1->value.u.cztCellMeasurementResult_Item.pres),PRSNT_NODEF);
   ...
   ie1->value.u.cztCellMeasurementResult_Item.cell_ID.iE_Extns.noComp.pres=NOTPRSNT;   
   czAcUtlFillTknU16(&(ie1->value.u.cztCellMeasurementResult_Item.iE_Extns.noComp),1);
   noComp = 1;
   if ((cmGetMem(cztResStatusUpdPdu,(noComp * sizeof(CztProtExtnField_CellMeasurementResult_Item_ExtIEs)),
               (Ptr *)&ie1->value.u.cztCellMeasurementResult_Item.iE_Extns.member)) !=ROK)
   {
      printf("cmGetMem failed, line %d\n",__LINE__);
      RETVALUE(RFAILED);
   }

   ie2= &ie1->value.u.cztCellMeasurementResult_Item.iE_Extns.member[0];

   czAcUtlFillTknU8(&(ie2->pres),PRSNT_NODEF);
   czAcUtlFillTknU32(&(ie2->id),Cztid_ABS_Status);
   czAcUtlFillTknU32(&(ie2->criticality),CztCriticalityignoreEnum);
   czAcUtlFillTknU8(&(ie2->extensionValue.u.cztABS_Status.pres),PRSNT_NODEF);
   cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "dL_ABS_status",
         &(dL_ABS_status));
   czAcUtlFillTknU32(&(ie2->extensionValue.u.cztABS_Status.dL_ABS_status),dL_ABS_status);
   cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U8, "ABS_statuschoice",
         &(ABS_statuschoice));
   czAcUtlFillTknU8(&(ie2->extensionValue.u.cztABS_Status.usableABSInform.choice),USABLEABSINFORM_FDD);
   czAcUtlFillTknU8(&(ie2->extensionValue.u.cztABS_Status.usableABSInform.val.fdd.pres),PRSNT_NODEF);
   cmMemset(usable_abs_pattern_info, 0, sizeof(usable_abs_pattern_info));
   strcpy((char *)usable_abs_pattern_info, "111"); /* klockwork fix */
   len = 40; 
   czFillTknStrOSXL(&(ie2->extensionValue.u.cztABS_Status.usableABSInform.val.fdd.usable_abs_pattern_info), 
         len, usable_abs_pattern_info, &cztResStatusUpdPdu);
   ie2->extensionValue.u.cztABS_Status.usableABSInform.val.fdd.iE_Extns.noComp.pres=NOTPRSNT;   
   ie2->extensionValue.u.cztABS_Status.iE_Extns.noComp.pres=NOTPRSNT;   
...
#endif
{
   ...
   if(encodeFail == FALSE)
   {
      ...
      czAcUtlFillTknU32((TknU32 *)&(ie->value.u.czteNB1MobilityParamsInform.handoverTriggerChange), (U32)2);
      ...
      czAcUtlFillTknU32((TknU32 *)&(ie->value.u.czteNB2MobilityParamsInform.handoverTriggerChange), (U32)5);
...
#ifdef ANSI
PUBLIC S16 czAcUtlCztFillRlfInd_R11
(
 CmXtaTCCb  *tcCb,
 CmXtaSpCb  *spCb,
 CztEvnt    **pdu
...
#else
PUBLIC S16 czAcUtlCztFillRlfInd_R11(tcCb, spCb, pdu)
   CmXtaTCCb  *tcCb;
   CmXtaSpCb  *spCb;
   CztEvnt    **pdu;
#endif
{
   ...
   U32 eUTRANcellId = 200;
#ifdef X2AP_REL11
   U32 setupIndicator = 0;
#endif

   mem.region = 0;
   mem.pool   = 0;

   TRC2(czAcUtlCztFillRlfInd_R11);
   cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_BOOL, "encodeFail",
         &(encodeFail));
...
#ifdef X2AP_REL11
      /*Fill the RRCConnSetupIndicator */

      {
         ie = &rlfIndPdu->pdu.val.initiatingMsg.value.u.cztRLFInd.protocolIEs.member[3];
         czAcUtlFillTknU8(&(ie->pres), PRSNT_NODEF);
         czAcUtlFillTknU32(&(ie->id), Cztid_RRCConnSetupIndicator);
         czAcUtlFillTknU32(&(ie->criticality), CztCriticalityrejectEnum);
         cmXtaXmlGetVal(tcCb, spCb->childStep, CMXTA_ATTRIB_U32, "setupIndicator",
               &(setupIndicator));
         czAcUtlFillTknU32(&(ie->value.u.cztRRCConnSetupIndicator), 
...
/********************************************************************30**
  ...
  End of file:     czac_cztutl_r11.c@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:16 2015
