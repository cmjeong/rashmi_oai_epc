/**********************************************************************
     ...
     Sid:      czac_asn_pk.x@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:07 2015
...
#ifndef __CZACASNPKX__
#define __CZACASNPKX__ 
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
namespace CZ_LTEX2AP_REL9_PK_X
{
...
EXTERN S16 cmPkCzt_ExtnABSInformFDD_ExtIEsCls ARGS ((
       Czt_ExtnABSInformFDD_ExtIEsCls *param, 
       U32 val, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnField_ABSInformFDD_ExtIEs ARGS ((
       CztProtExtnField_ABSInformFDD_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnCont_ABSInformFDD_ExtIEs ARGS ((
       CztProtExtnCont_ABSInformFDD_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztABSInformFDD ARGS ((
       CztABSInformFDD *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCzt_ExtnABSInformTDD_ExtIEsCls ARGS ((
       Czt_ExtnABSInformTDD_ExtIEsCls *param,
       U32 val, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnField_ABSInformTDD_ExtIEs ARGS ((
       CztProtExtnField_ABSInformTDD_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnCont_ABSInformTDD_ExtIEs ARGS ((
       CztProtExtnCont_ABSInformTDD_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztABSInformTDD ARGS ((
       CztABSInformTDD *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztABSInform ARGS ((
       CztABSInform *param,
       Buffer *mBuf
));
EXTERN S16 cmPkCzt_ExtnUsableABSInformFDD_ExtIEsCls ARGS ((
       Czt_ExtnUsableABSInformFDD_ExtIEsCls *param, 
       U32 val, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnField_UsableABSInformFDD_ExtIEs ARGS ((
       CztProtExtnField_UsableABSInformFDD_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnCont_UsableABSInformFDD_ExtIEs ARGS ((
       CztProtExtnCont_UsableABSInformFDD_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztUsableABSInformFDD ARGS ((
       CztUsableABSInformFDD *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCzt_ExtnUsableABSInformTDD_ExtIEsCls ARGS ((
       Czt_ExtnUsableABSInformTDD_ExtIEsCls *param,
       U32 val, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnField_UsableABSInformTDD_ExtIEs ARGS ((
       CztProtExtnField_UsableABSInformTDD_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnCont_UsableABSInformTDD_ExtIEs ARGS ((
       CztProtExtnCont_UsableABSInformTDD_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztUsableABSInformTDD ARGS ((
       CztUsableABSInformTDD *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztUsableABSInform ARGS ((
       CztUsableABSInform *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCzt_ExtnABS_Status_ExtIEsCls ARGS ((
       Czt_ExtnABS_Status_ExtIEsCls *param, 
       U32 val, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnField_ABS_Status_ExtIEs ARGS ((
       CztProtExtnField_ABS_Status_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztProtExtnCont_ABS_Status_ExtIEs ARGS ((
       CztProtExtnCont_ABS_Status_ExtIEs *param, 
       Buffer *mBuf
));
EXTERN S16 cmPkCztABS_Status ARGS ((
       CztABS_Status *param,
       Buffer *mBuf
));
...
namespace CZ_LTEX2AP_REL11_PK_X
{
...
EXTERN S16 cmPkCzt_ExtnThresholdEventA2_ExtIEsCls ARGS ((Czt_ExtnThresholdEventA2_ExtIEsCls *param, U32 val, Buffer *mBuf));
EXTERN S16 cmPkCztProtExtnField_ThresholdEventA2_ExtIEs ARGS ((CztProtExtnField_ThresholdEventA2_ExtIEs *param, Buffer *mBuf));
EXTERN S16 cmPkCztProtExtnCont_ThresholdEventA2_ExtIEs ARGS ((CztProtExtnCont_ThresholdEventA2_ExtIEs *param, Buffer *mBuf));
EXTERN S16 cmPkCztThresholdEventA2 ARGS ((CztThresholdEventA2 *param, Buffer *mBuf));
EXTERN S16 cmPkCzt_ExtnPeriodicRprtngMDT_ExtIEsCls ARGS ((Czt_ExtnPeriodicRprtngMDT_ExtIEsCls *param, U32 val, Buffer *mBuf));
EXTERN S16 cmPkCztProtExtnField_PeriodicRprtngMDT_ExtIEs ARGS ((CztProtExtnField_PeriodicRprtngMDT_ExtIEs *param, Buffer *mBuf));
EXTERN S16 cmPkCztProtExtnCont_PeriodicRprtngMDT_ExtIEs ARGS ((CztProtExtnCont_PeriodicRprtngMDT_ExtIEs *param, Buffer *mBuf));
EXTERN S16 cmPkCztPeriodicRprtngMDT ARGS ((CztPeriodicRprtngMDT *param, Buffer *mBuf));
...
/**********************************************************************
        End of file:     czac_asn_pk.x@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:07 2015
**********************************************************************/
