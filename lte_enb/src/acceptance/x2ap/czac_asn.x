/**********************************************************************
     ...
     Sid:      czac_asn.x@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:09 2015
...
typedef TknStrBSXL CztUsableABSInformTDDusable_abs_pattern_info;
...
{
        TknPres pres;
        CztUsableABSInformTDDusable_abs_pattern_info usable_abs_pattern_info;
...
typedef enum enumCztRprtngTriggerMDT
{
	CztRprtngTriggerMDTperiodicEnum,
	CztRprtngTriggerMDTa2eventtriggeredEnum
} EnumCztRprtngTriggerMDT;
typedef TknU32 CztRprtngTriggerMDT;
...
typedef struct x2ap_ExtnThresholdEventA2_ExtIEsCls{
	union {
		TknU8 unused;
	} u;
} Czt_ExtnThresholdEventA2_ExtIEsCls;
typedef struct x2apProtExtnField_ThresholdEventA2_ExtIEs
{
	TknPres pres;
	CztProtIE_ID id;
	CztCriticality criticality;
	Czt_ExtnThresholdEventA2_ExtIEsCls extensionValue;
} CztProtExtnField_ThresholdEventA2_ExtIEs;

typedef struct x2apProtExtnCont_ThresholdEventA2_ExtIEs
{
	TknU16 noComp;
	CztProtExtnField_ThresholdEventA2_ExtIEs *member;
}CztProtExtnCont_ThresholdEventA2_ExtIEs;

typedef struct x2apThresholdEventA2
{
	TknPres pres;
	CztMeasurementThresholdA2 measurementThreshold;
	CztProtExtnCont_ThresholdEventA2_ExtIEs iE_Extns;
} CztThresholdEventA2;
...
typedef struct x2ap_ExtnPeriodicRprtngMDT_ExtIEsCls{
	union {
		TknU8 unused;
	} u;
} Czt_ExtnPeriodicRprtngMDT_ExtIEsCls;
typedef struct x2apProtExtnField_PeriodicRprtngMDT_ExtIEs
{
	TknPres pres;
	CztProtIE_ID id;
	CztCriticality criticality;
	Czt_ExtnPeriodicRprtngMDT_ExtIEsCls extensionValue;
} CztProtExtnField_PeriodicRprtngMDT_ExtIEs;

typedef struct x2apProtExtnCont_PeriodicRprtngMDT_ExtIEs
{
	TknU16 noComp;
	CztProtExtnField_PeriodicRprtngMDT_ExtIEs *member;
}CztProtExtnCont_PeriodicRprtngMDT_ExtIEs;

typedef struct x2apPeriodicRprtngMDT
{
	TknPres pres;
	CztReportIntervalMDT reportInterval;
	CztReportAmountMDT reportAmount;
	CztProtExtnCont_PeriodicRprtngMDT_ExtIEs iE_Extns;
} CztPeriodicRprtngMDT;
...
typedef struct x2apMDT_Config
{
	...
	CztRprtngTriggerMDT reportingTriggerMDT;
	CztThresholdEventA2 thresholdeventA2;
	CztPeriodicRprtngMDT periodicRprtngMDT;
...
/**********************************************************************
        End of file:     czac_asn.x@@/main/TeNB_Main_BR/tenb_main_ccb/1 - Wed Jul 22 20:08:09 2015
**********************************************************************/
