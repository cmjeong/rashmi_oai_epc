...
)
{
    ...
    */
   if(SS_INVALID_THREAD_REG_MAP ==
            osCp.threadMemoryRegionMap[((threadId >> 16) % SS_MAX_THREAD_REGION_MAP)])
   {
    ...
    * for all the thread Ids which are created before this 
    */
   osCp.threadMemoryRegionMap[((threadId >> 16) % SS_MAX_THREAD_REGION_MAP)] = SS_INVALID_THREAD_REG_MAP;
...
/********************************************************************30**
         ...
         End of file:     pt_ss.c@@/main/TeNB_Main_BR/11 - Mon Aug 11 16:44:04 2014
