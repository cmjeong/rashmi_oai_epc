...
/********************************************************************20**
     ...
     Sid:      ss_tskent.c@@/main/TeNB_Main_BR/5 - Mon Aug 11 16:44:17 2014
...
#else
PUBLIC S16 FbtstEntActvInit(ent, inst, region, reason)
Ent    ent;                   /* entity */
Inst   inst;                  /* instance */
Region region;                /* region */
Reason reason;                /* reason */
...
#else
PUBLIC S16 FbtstEnt1ActvInit(ent, inst, region, reason)
Ent    ent;                   /* entity */
Inst   inst;                  /* instance */
Region region;                /* region */
Reason reason;                /* reason */
...
#else
PUBLIC S16 FbtstEnt2ActvInit(ent, inst, region, reason)
Ent    ent;                   /* entity */
Inst   inst;                  /* instance */
Region region;                /* region */
Reason reason;                /* reason */
...
#else
PUBLIC S16 FbPerm2ActvInit(ent, inst, region, reason)
Ent    ent;                   /* entity */
Inst   inst;                  /* instance */
Region region;                /* region */
Reason reason;                /* reason */
...
#endif
{
   ...
   sprintf(buf,"\n FbpermTsk8:Received an event:%d from the Entity %d Inst:%d\n",pst->event,pst->srcEnt,pst->srcInst);
  SPrint(buf);
   if (mBuf)
      SPutMsg(mBuf);
...
{
{"ENTTST", ENTTSTX, (void *)FbtstEntActvInit,(void *) FbtstEntActvTsk},
{"ENTTST1", ENTTSTX+1, (void *)FbtstEnt1ActvInit, (void *)FbtstEnt1ActvTsk},
{"ENTTST2", ENTTSTX+2, (void *)FbtstEnt2ActvInit, (void *)FbtstEnt2ActvTsk},
{"PERMENT1", PERMENT2, (void *)FbPerm2ActvInit, (void *)FbpermTsk1},
{"PERMENT2", PERMENT2, (void *)FbPerm2ActvInit, (void *)FbpermTsk2},
{"PERMENT3", PERMENT2, (void *)FbPerm2ActvInit, (void *)FbpermTsk3},
{"PERMENT4", PERMENT2, (void *)FbPerm2ActvInit, (void *)FbpermTsk4},
{"PERMENT5", PERMENT2, (void *)FbPerm2ActvInit, (void *)FbpermTsk5},
{"PERMENT6", PERMENT2, (void *)FbPerm2ActvInit, (void *)FbpermTsk6},
{"PERMENT7", PERMENT2, (void *)FbPerm2ActvInit, (void *)FbpermTsk7}
};


/********************************************************************30**
 
         End of file:     ss_tskent.c@@/main/TeNB_Main_BR/5 - Mon Aug 11 16:44:17 2014
