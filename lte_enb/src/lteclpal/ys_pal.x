...
struct ysCellCb
{
   ...
   YsCqiCb         cqiCb;
#elif YS_LTE_PAL   
   YsTxMsgArr      txMsgArr[YS_NUM_SUB_FRAMES];/* Used for storing MAC 
                                                   CntrlReq/DatReq pointer */
   Pst             peerPst;
#endif
...
#endif /* YS_LTE_PAL */
#endif
   YsTfuSapCb      *tfuSapLst[YS_PAL_MAX_CELLS];                 /* TFU SAP Control Block */
   YsTfuSapCb      *schTfuSapLst[YS_PAL_MAX_CELLS];                    /* TFU SAP Control Block */
   YsCellCb        *cellCb[YS_PAL_MAX_CELLS];  /* Cell configuration list */
...
EXTERN S16  ysPalSend2Peer ARGS(( Buffer *mBuf, U8 cellId));
#endif /* SS_CAVIUM */
