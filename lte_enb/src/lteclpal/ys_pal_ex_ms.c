...
#include "tip_cmn.h"
#endif
extern U32 numEnCodeL1DataReqRecv;
      ...
      case ENTTF:
         ...
         switch(pst->event)
         {
            ...
            case EVTTFURECPREQ:
               ...
               break;
#endif /* LTE_PAL_ENB */
            case EVTTFUREADL1DATA:
		printf("unPack and Receive\n");
		SPrntMsg(mBuf, 0 , 0);
                SPutMsg(mBuf);
                //ret = cmUnpkTful1DataReq(YsUiTful1ReadReq, pst, mBuf);
               break;
            case EVTTFUENCODEL1DATA:
               numEnCodeL1DataReqRecv++;
               SPutMsg(mBuf);
	       ret = encodeDl();
               break;
