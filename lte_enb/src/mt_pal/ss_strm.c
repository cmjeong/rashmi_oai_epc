...
/********************************************************************20**
     ...
     Sid:      ss_strm.c@@/main/2 - Mon Apr  5 18:01:19 2010
...
#endif
{
   ...
   if (mp == NULLP)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS760, ERRZERO, "Null pointer");
      RETVALUE(0);
   }
#endif
...
#endif
{
   ...
   if (r != ROK)
   {
      ...
      SSLOGERROR(ERRCLS_ADD_RES, ESS761, (ErrVal) r, "SAlloc() failed");
#endif
   ...
   if (size > 0)
   {
      ...
      {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SSLOGERROR(ERRCLS_ADD_RES, ESS762, (ErrVal) r, "SAlloc() failed");
#endif
...
#endif
{
   ...
   if (mp == NULLP)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS763, ERRZERO, "Null pointer");
      RETVALUE(NULLP);
   }
#endif
   ...
   {
#if (ERRCLASS & ERRCLS_ADD_RES)
      SSLOGERROR(ERRCLS_ADD_RES, ESS764, ERRZERO, "ssAllocB() failed");
#endif
...
#endif
{
   ...
   if (mp == NULLP)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS765, ERRZERO, "Null pointer");
      RETVALUE(NULLP);
   }
#endif
   ...
   {
#if (ERRCLASS & ERRCLS_ADD_RES)
      SSLOGERROR(ERRCLS_ADD_RES, ESS766, ERRZERO, "ssCopyB() failed");
#endif
   ...
   while (mp->b_cont)
   {
      ...
      {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SSLOGERROR(ERRCLS_ADD_RES, ESS767, ERRZERO, "ssCopyB() failed");
#endif
...
#endif
{
   ...
   if (mp == NULLP)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS768, ERRZERO, "Null pointer");
      RETVALUE(NULLP);
   }
#endif
   ...
   {
#if (ERRCLASS & ERRCLS_ADD_RES)
      SSLOGERROR(ERRCLS_ADD_RES, ESS769, ERRZERO, "ssAllocB() failed");
#endif
   ...
   if (ret != ROK)
   {
      SSLOGERROR(ERRCLS_DEBUG, ESS770, ERRZERO,
   ...
   if ( SUnlock(&osCp.mBufRefLock) != ROK)
   {
      ...
      SSLOGERROR(ERRCLS_DEBUG, ESS771, ERRZERO,
...
#endif
{
   ...
   {
#if (ERRCLASS & ERRCLS_ADD_RES)
      SSLOGERROR(ERRCLS_ADD_RES, ESS772, ERRZERO, "ssDupB() failed");
#endif
   ...
   while (mp->b_cont)
   {
      ...
      {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SSLOGERROR(ERRCLS_ADD_RES, ESS773, ERRZERO, "ssDupB() failed");
#endif
...
#endif
{
   ...
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS774, ERRZERO, "Null pointer");
      RETVALUE(NULLP);
   }
#endif
   ...
   {
#if (ERRCLASS & ERRCLS_ADD_RES)
      SSLOGERROR(ERRCLS_ADD_RES, ESS775, (ErrVal) r, "SAlloc() failed");
#endif
...
#endif
{
   ...
   if (mp == NULLP)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS776, ERRZERO, "Null pointer");
      RETVOID;
   }
#endif
   ...
   {
#if (ERRCLASS & ERRCLS_DEBUG)
      SSLOGERROR(ERRCLS_DEBUG, ESS777, ERRZERO,
   ...
   if (ret != ROK)
   {
      SSLOGERROR(ERRCLS_DEBUG, ESS778, ERRZERO,
                     "Could not lock the mBuf Ref Lock");
      RETVOID;
   }
   ...
   {
#if (ERRCLASS & ERRCLS_DEBUG)
      SSLOGERROR(ERRCLS_DEBUG, ESS779, ERRZERO,
                      "Could not give the Semaphore");
      RETVOID;
#endif
   }
...
#endif
{
   ...
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS780, ERRZERO, "Null pointer");
      RETVOID;
   }
#endif
...
#endif
{
   ...
   if (mp == NULLP)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS781, ERRZERO, "Null pointer");
      RETVALUE(0);
   }
   
   if (len < -1)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS782, len, "Invalid length");
      RETVALUE(0);
   }
#endif
...
#endif
{
   ...
   if (mp == NULLP  ||  bp == NULLP)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS783, ERRZERO, "Null pointer");
      RETVALUE(NULLP);
   }
#endif
...
#endif
{
   ...
   if (mp == NULLP)
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS784, ERRZERO, "Null pointer");
      RETVALUE(NULLP);
   }
#endif
...
/********************************************************************30**
         ...
         End of file:     ss_strm.c@@/main/2 - Mon Apr  5 18:01:19 2010
