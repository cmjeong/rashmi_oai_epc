...
/********************************************************************20**
     ...
     Sid:      ss_gen.c@@/main/2 - Mon Apr  5 18:01:15 2010
...
/* ss029.103: modification: multiple procId related changes */ 
   ...
   if (ret != ROK)
   {
      ...
      if ( (ssDestroySema(&osCp.regionTblSem)) != ROK)
      {
         ...
         SSLOGERROR(ERRCLS_DEBUG, ESS648, ERRZERO,
...
/* ss029.103: addition: TAPA task control block added */
  ...
  if(SS_MAX_STSKS > SS_MAX_REGS)
   ...
   for (i = 0;  i < SS_MAX_STSKS;  i++)
   {
      ...
      regCb = (CmMmRegCb*)(osCp.regionTbl[sTsk->region].regCb);
      regCb->sTsk = sTsk;
#endif
   }
   ...
   if (ret != ROK)
   {
      ...
      {
#if (ERRCLASS & ERRCLS_DEBUG)
         SSLOGERROR(ERRCLS_DEBUG, ESS649, ERRZERO,
                         "Could not destroy the Semaphore");
         RETVALUE(RFAILED);
   ...
   if (ret != ROK)
   {
      ...
      {
#if (ERRCLASS & ERRCLS_DEBUG)
         SSLOGERROR(ERRCLS_DEBUG, ESS650, ERRZERO,
                         "Could not destroy the Semaphore");
         RETVALUE(RFAILED);
...
cleanup3:
   ...
   SDestroyLock(&osCp.sTskTblLock);
      ...
      {
#if (ERRCLASS & ERRCLS_DEBUG)
         SSLOGERROR(ERRCLS_DEBUG, ESS651, ERRZERO,
                         "Could not destroy the Semaphore");
         RETVALUE(RFAILED);
...
cleanup2:
   ssdDeinitMem();
      ...
      {
#if (ERRCLASS & ERRCLS_DEBUG)
         SSLOGERROR(ERRCLS_DEBUG, ESS652, ERRZERO,
                         "Could not destroy the Semaphore");
         RETVALUE(RFAILED);
...
#endif
{
   ...
   if (ret != ROK)
   {
      SSLOGERROR(ERRCLS_DEBUG, ESS653, ERRZERO,
   ...
   if (ret != ROK)
   {
...
#if (ERRCLASS & ERRCLS_DEBUG)
      SSLOGERROR(ERRCLS_DEBUG, ESS654, ERRZERO,
      ...
      {
#if (ERRCLASS & ERRCLS_DEBUG)
         SSLOGERROR(ERRCLS_DEBUG, ESS655, ERRZERO,
...
#endif
{
   ...
   {
#if (ERRCLASS & ERRCLS_DEBUG)
      SSLOGERROR(ERRCLS_DEBUG, ESS656, ERRZERO,
                      "Could not give the Semaphore");
      RETVALUE(RFAILED);
#endif
   }
...
#endif
{
   ...
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS657, ERRZERO, "number of proc Ids exceeds\
 limit");
      RETVALUE(RFAILED);
   }
   ...
   for (i = 0; i < numPIds; i++)
   {
      ...
      {
         SSLOGERROR(ERRCLS_INT_PAR, ESS658, ERRZERO, "Invalid proc Ids");
         RETVALUE(RFAILED);
      }
   }
   ...
   for (i = 0; i < numPIds; i++)
      ...
      {
         SSLOGERROR(ERRCLS_INT_PAR, ESS659, ERRZERO, "Duplicate proc id");
         (Void) SULockOsCp();
         RETVALUE(RFAILED);
      }
   ...
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS660, ERRZERO, "Total number of proc id \
exceeds");
      (Void) SULockOsCp();
      RETVALUE(RFAILED);
   }
   ...
   for (i = 0; i < numPIds; i++)
   {
      ...
      {
#if (ERRCLASS & ERRCLS_DEBUG)
         SSLOGERROR(ERRCLS_DEBUG, ESS661, ERRZERO,
...
#endif
{
   ...
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS662, ERRZERO, "Invalid numPIds/pIdLst");
      RETVALUE(RFAILED);
   }
#endif 
...
#endif
{
   ...
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS663, ERRZERO, "Invalid proc/entity/instance");
      RETVALUE(RFAILED);
   }
#endif 
   ...
   {
#if (ERRCLASS & ERRCLS_INT_PAR)
      SSLOGERROR(ERRCLS_INT_PAR, ESS664, ERRZERO, "Could not get proc table idx");
#endif
      RETVALUE(RFAILED);
   }
...
/********************************************************************30**
         ...
         End of file:     ss_gen.c@@/main/2 - Mon Apr  5 18:01:15 2010
