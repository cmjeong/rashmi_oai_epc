...
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)cfgReq, sizeof(UdxCfgReqInfo), 0);
      RETVALUE(RFAILED);
   }
...
#endif
      PJ_FREE_BUF(mBuf);
      SPutStaticBuffer(pst->region, pst->pool, (Data *)staRep, sizeof(UdxUlStaRepInfo), 0);
...
#endif
{
   ...
   if (SGetMsg(pst->region, pst->pool, &mBuf) != ROK) 
   {
      ...
      SPutStaticBuffer(pst->region, pst->pool, (Data *)staRep, sizeof(UdxDlStaRepInfo), 0);
...
#endif
                        SPutStaticBuffer(pst->region, pst->pool, (Data *)cfgCfm, sizeof(UdxCfgCfmInfo), 0);
                        RETVALUE(RFAILED);
                }
        switch(pst->selector)
        {
...
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)reEstReq, sizeof(UdxReEstReqInfo), 0);
      RETVALUE(RFAILED);
   }
   switch(pst->selector)
   {
...
#endif
                        SPutStaticBuffer(pst->region, pst->pool, (Data *)reEstCfm, sizeof(UdxReEstCfmInfo), 0);
                        RETVALUE(RFAILED);
                }
        switch(pst->selector)
        {
...
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)secCfgReq, sizeof(UdxSecCfgReqInfo), 0);
      RETVALUE(RFAILED);
   }
...
#endif
                        SPutStaticBuffer(pst->region, pst->pool, (Data *)secCfgCfm, sizeof(UdxSecCfgCfmInfo), 0);
                        RETVALUE(RFAILED);
                }
        switch(pst->selector)
        {
...
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)oldUeInfo, sizeof(UdxUeInfo), 0);
      SPutStaticBuffer(pst->region, pst->pool, (Data *)newUeInfo, sizeof(UdxUeInfo), 0);
      RETVALUE(RFAILED);
   }
...
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)ueInfo, sizeof(UdxUeInfo), 0);
      RETVALUE(RFAILED);
   }
...
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)countReq, sizeof(UdxCountReqInfo), 0);
      RETVALUE(RFAILED);
   }
...
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)countCfm, sizeof(UdxCountCfmInfo), 0);
      RETVALUE(RFAILED);
   }
   switch(pst->selector)
   {
...
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)staReq, sizeof(UdxSduStaReqInfo), 0);
      RETVALUE(RFAILED);
   }
...
#endif
                        SPutStaticBuffer(pst->region, pst->pool, (Data *)staCfm, sizeof(UdxSduStaCfmInfo), 0);
                        RETVALUE(RFAILED);
                }
        switch(pst->selector)
        {
...
#endif
{
   ...
   if (SGetMsg(pst->region, pst->pool, &mBuf) != ROK) {
      ...
      SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            ...
            (ErrVal)ECPJ115, (ErrVal)0, "Packing failed");
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)datResumeCfm, sizeof(UdxDatResumeCfmInfo), 0);
      RETVALUE(RFAILED);
   }
   switch(pst->selector)
   {
...
#endif
{
   ...
   if (SGetMsg(pst->region, pst->pool, &mBuf) != ROK) {
      ...
      SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            ...
            (ErrVal)ECPJ115, (ErrVal)0, "Packing failed");
#endif
      SPutStaticBuffer(pst->region, pst->pool, (Data *)datFwdCfm, sizeof(UdxDatFwdCfmInfo), 0);
      RETVALUE(RFAILED);
   }
...
#endif
{
   ...
   if (cnt)
      SPutStaticBuffer(pst->region, pst->pool, (Data *)param->ulBitMap, cnt * sizeof(U8), 0);
...
#endif
      PJ_FREE_BUF(mBuf);
      SPutStaticBuffer(pst->region, pst->pool, (Data *)fdbkPktInfo, sizeof(UdxUlFdbkPktInfo), 0);
      ...
      case UDX_SEL_LC:
         {
            ...
            if(ret != ROK)
            {
               PJ_FREE_BUF(mBuf);
               PJ_FREE_BUF(fdbkPktInfo->fbPkt);
               SPutStaticBuffer(pst->region, pst->pool, (Data *)fdbkPktInfo, sizeof(UdxDlFdbkPktInfo), 0);
...
#endif
{
   ...
   switch(pst->selector)
   {
       ...
       {        
          ...
          {
             SPutStaticBuffer(pst->region, pst->pool, (Data *)fdbkPkt, sizeof(UdxDlFdbkPktInfo), 0);
             PJ_FREE_BUF(mBuf);
#if (ERRCLASS & ERRCLS_ADD_RES)
             SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
                __FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif
{
   ...
   switch(pst->selector)
   {
       ...
       {        
          ...
          {
             SPutStaticBuffer(pst->region, pst->pool, (Data *)fdbkPkt, sizeof(UdxUlFdbkPktInfo), 0);
             PJ_FREE_BUF(mBuf);
#if (ERRCLASS & ERRCLS_ADD_RES)
             SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
                __FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
