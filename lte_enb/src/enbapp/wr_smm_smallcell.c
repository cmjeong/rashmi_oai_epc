...
/* Ends - Fix for CR ccpu00123185 */
   ...
   U16 wrSmDfltZeroCorrelZoneCfg = 0x05;         /* 0x05 */
   U16 wrSmDfltPrachFreqOffset   = 43;          /* (assuming 10MHz Channel bandwidth) changed from 4 in mspd  */
   CtfPucchDeltaShift wrSmDfltPUCCHDeltaShift = 0x00;       /* DS1 */
#endif
...
#else
   U16 wrSmDfltULPwrCtrlAlpha      = 0x05;
...
/* UE Timers and   s */
   ...
   U16 wrSmDfltTmrsAndConstsT310 = 0x02;     
   U16 wrSmDfltTmrsAndConstsN310 = 0x02;    
   U16 wrSmDfltTmrsAndConstsT311 = 0x00;   
   U16 wrSmDfltTmrsAndConstsN311 = 0x00;  
#endif
...
#ifndef LTE_TDD
   U16 wrSmDfltBetaOffACKIdx             = 10;
   U16 wrSmDfltBetaOffRIIdx              = 12;
