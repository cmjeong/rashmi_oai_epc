...
#endif
{
   ...
   CMCHKPK(SPkU16, param->cellCfg.maxUeSupp, mBuf); /* 256 UE Support */
...
*/
#ifdef ANSI
PUBLIC S16 cmPkLwrCellCfgReq
(
Pst *pst,
LwrMngmt *cfg
)
#else
PUBLIC S16 cmPkLwrCellCfgReq(pst, cfg)
Pst *pst;
LwrMngmt *cfg;
#endif
{
...
#ifdef LCLWR 
       case LWR_SEL_LC:
    ret1 = cmPkWrMngmt(cfg, EVTLWRCELLCFGREQ ,mBuf);
#if(ERRCLASS & ERRCLS_ADD_RES)
    if(ret1 != ROK)
    {
       SPutMsg(mBuf);
    ...
    pst->event = (Event) EVTLWRCELLCFGREQ;
    RETVALUE(SPstTsk(pst,mBuf));
} /*end of function cmPkLwrCellCfgReq*/
...
*/
#ifdef ANSI
PUBLIC S16 cmPkLwrCellCntrlReq
(
Pst *pst,
LwrMngmt *cntrl
)
#else
PUBLIC S16 cmPkLwrCellCntrlReq(pst, cntrl)
Pst *pst;
LwrMngmt *cntrl;
#endif
{
   ...
   switch(pst->selector)
   {
...
#ifdef LCLWR 
      case LWR_SEL_LC:
    ret1 = cmPkWrMngmt(cntrl, EVTLWRCELLCNTRLREQ ,mBuf);
#if(ERRCLASS & ERRCLS_ADD_RES)
    if(ret1 != ROK)
    {
       SPutMsg(mBuf);
    ...
    pst->event = (Event) EVTLWRCELLCNTRLREQ;
    RETVALUE(SPstTsk(pst,mBuf));
} /*end of function cmPkLwrCellCntrlReq*/
...
*/
#ifdef ANSI
PUBLIC S16 cmPkLwrCellCfgCfm
(
Pst *pst,
LwrMngmt *cfm
)
#else
PUBLIC S16 cmPkLwrCellCfgCfm(pst, cfm)
Pst *pst;
LwrMngmt *cfm;
#endif
{
    ...
    switch(pst->selector)
    {
       case LWR_SEL_LC:
#ifdef LCLWR 
    ret1 = cmPkWrMngmt(cfm, EVTLWRCELLCFGCFM ,mBuf);
#if(ERRCLASS & ERRCLS_ADD_RES)
    if(ret1 != ROK)
    {
       SPutMsg(mBuf);
    ...
    pst->event = (Event) EVTLWRCELLCFGCFM;
    RETVALUE(SPstTsk(pst,mBuf));
} /*end of function cmPkLwrCfgCfm*/
...
*/
#ifdef ANSI
PUBLIC S16 cmPkLwrCellCntrlCfm
(
Pst *pst,
LwrMngmt *cfm
)
#else
PUBLIC S16 cmPkLwrCellCntrlCfm(pst, cfm)
Pst *pst;
LwrMngmt *cfm;
#endif
{
   ...
   switch(pst->selector)
   {
#ifdef LCLWR 
      case LWR_SEL_LC:
    ret1 = cmPkWrMngmt(cfm, EVTLWRCELLCNTRLCFM ,mBuf);
#if(ERRCLASS & ERRCLS_ADD_RES)
    if(ret1 != ROK)
    {
       SPutMsg(mBuf);
    ...
    pst->event = (Event) EVTLWRCELLCNTRLCFM;
    RETVALUE(SPstTsk(pst,mBuf));
} /*end of function cmPkLwrCellCntrlCfm*/
...
#endif
{
    ...
    CMCHKUNPK(SUnpkU16, &param->cellCfg.maxUeSupp, mBuf); /* 256 UE Support */
    for (idx = 0; idx < 3; idx++)
    {
...
*/
#ifdef ANSI
PUBLIC S16 cmUnpkLwrCellCfgReq
(
LwrCfgReq func,
Pst *pst,
Buffer *mBuf
...
#else
PUBLIC S16 cmUnpkLwrCellCfgReq(func, pst, mBuf)
LwrCfgReq func;
Pst *pst;
Buffer *mBuf;
#endif
{
   ...
   LwrMngmt cfg;
    ...
    TRC3(cmUnpkLwrCellCfgReq)

      switch(pst->selector)
      {
#ifdef LCLWR 
         case LWR_SEL_LC:
    ret1 = cmUnpkWrMngmt((LwrMngmt *)&cfg, EVTLWRCELLCFGREQ , NULLP ,mBuf, pst);
#if(ERRCLASS & ERRCLS_DEBUG)
    if(ret1 != ROK)
    {
       SPutMsg(mBuf);
   ...
   RETVALUE(ret1);
    ...
    RETVALUE((*func)(pst, &cfg));
#endif
} /*end of function cmUnpkLwrCellCfgReq*/
...
PUBLIC S16 cmUnPackSendDynCfg(LwrDynCfgReqSend func, Pst *pst, Buffer *mBuf)
{
   ...
   cfg = &pkArray[0];
   SRemPreMsgMult((Data *)&cellIdx, (MsgLen) sizeof(U16), mBuf);
   SPutMsg(mBuf);
   ret = (*func)(cfg, cfgType, cellIdx);
...
*/
#ifdef ANSI
PUBLIC S16 cmUnpkLwrCellCntrlReq
(
LwrCntrlReq func,
Pst *pst,
Buffer *mBuf
...
#else
PUBLIC S16 cmUnpkLwrCellCntrlReq(func, pst, mBuf)
LwrCntrlReq func;
Pst *pst;
Buffer *mBuf;
#endif
{
   ...
   LwrMngmt cntrl;
    ...
    TRC3(cmUnpkLwrCellCntrlReq)
      switch(pst->selector)
      {
#ifdef LCLWR 
         case LWR_SEL_LC:
    ret1 = cmUnpkWrMngmt((LwrMngmt *)&cntrl, EVTLWRCELLCNTRLREQ , NULLP ,mBuf, pst);
#if(ERRCLASS & ERRCLS_DEBUG)
    if(ret1 != ROK)
    {
       SPutMsg(mBuf);
...
#endif 
} /*end of function cmUnpkLwrCellCntrlReq*/
...
*/
#ifdef ANSI
PUBLIC S16 cmUnpkCellLwrCfgCfm
(
LwrCfgCfm func,
Pst *pst,
Buffer *mBuf
...
#else
PUBLIC S16 cmUnpkCellLwrCfgCfm(func, pst, mBuf)
LwrCfgCfm func;
Pst *pst;
Buffer *mBuf;
#endif
{
   ...
   LwrMngmt cfm;
    ...
    ret1 = cmUnpkWrMngmt((LwrMngmt *)&cfm, EVTLWRCELLCFGCFM , NULLP ,mBuf, pst);
#if(ERRCLASS & ERRCLS_DEBUG)
    if(ret1 != ROK)
    {
       SPutMsg(mBuf);
...
*/
#ifdef ANSI
PUBLIC S16 cmUnpkLwrCellCntrlCfm
(
LwrCntrlCfm func,
Pst *pst,
Buffer *mBuf
...
#else
PUBLIC S16 cmUnpkLwrCellCntrlCfm(func, pst, mBuf)
LwrCntrlCfm func;
Pst *pst;
Buffer *mBuf;
#endif
{
   ...
   LwrMngmt cfm;
    ...
    TRC3(cmUnpkLwrCellCntrlCfm)
      switch(pst->selector)

      {
#ifdef LCLWR 
    ret1 = cmUnpkWrMngmt((LwrMngmt *)&cfm, EVTLWRCELLCNTRLCFM , NULLP ,mBuf, pst);
#if(ERRCLASS & ERRCLS_DEBUG)
    if(ret1 != ROK)
    {
       SPutMsg(mBuf);
   ...
   RETVALUE(ret1);
    ...
    RETVALUE((*func)(pst, &cfm));
#endif
} /*end of function cmUnpkLwrCellCntrlCfm*/
