...
/********************************************************************20**
     ...
     Sid:      wr_smm_init_intel.h@@/main/tenb_main_ccb/tenb_5.0_RIB/tenb_5.0_RIB_GA/13 - Mon Feb 15 12:51:39 2016
...
#define SM_SM_PROC  10
#define SM_NH_PROC  10
#define SM_NX_PROC  10
#define SM_RX_PROC  10
#define SM_SZ_PROC  10
#define SM_CZ_PROC  10
#define SM_SB_PROC  10
#define SM_HI_PROC  10
#define SM_WR_PROC  10
#ifdef RM_INTF
#define SM_RM_PROC  10
#endif /*RM_INTF*/
#define SM_NL_PROC  10
#ifndef TIP_L3_UL2_LL2_SPLIT
#define SM_EG_PROC  10
#define SM_EU_PROC  10
#define SM_PJ_PROC  10
#define SM_UL2_SM_PROC  10
#else
#define SM_EG_PROC  20
#define SM_EU_PROC  20
#define SM_PJ_PROC  20
#define SM_UL2_SM_PROC  20
#endif

#define SM_LL2_SM_PROC  30
#define SM_TF_PROC  30
#define SM_KW_PROC  30
#define SM_KW_UL_PROC  30 /* ULRLC->NET_CLUSTER*/
#define SM_RG_PROC  30
#define SM_YS_PROC  30
#if 0
#define SM_SM_PROC  proc_Id 
#define SM_NH_PROC  proc_Id
#define SM_NX_PROC  proc_Id
#define SM_RX_PROC  proc_Id
#define SM_SZ_PROC  proc_Id
#define SM_CZ_PROC  proc_Id
#define SM_SB_PROC  proc_Id
#define SM_HI_PROC  proc_Id
#define SM_WR_PROC  proc_Id
#ifdef RM_INTF
#define SM_RM_PROC  proc_Id
#endif /*RM_INTF*/
#define SM_NL_PROC  proc_Id
#ifndef TIP_L3_UL2_LL2_SPLIT
#define SM_EG_PROC  proc_Id
#define SM_EU_PROC  proc_Id
#define SM_PJ_PROC  proc_Id
#else
#define SM_EG_PROC  proc_Id
#define SM_EU_PROC  proc_Id
#define SM_PJ_PROC  proc_Id
#define SM_UL2_SM_PROC  proc_Id
#endif

#define SM_LL2_SM_PROC  proc_Id
#define SM_TF_PROC  proc_Id
#define SM_KW_PROC  proc_Id
#define SM_KW_UL_PROC  proc_Id /* ULRLC->NET_CLUSTER*/
#define SM_RG_PROC  proc_Id
#define SM_YS_PROC  proc_Id
#else
...
#define SM_EU_PROC  100
#define SM_WR_PROC  100
#ifdef RM_INTF
#define SM_RM_PROC  100
#endif /*RM_INTF*/
#define SM_NL_PROC  100
...
#define WR_DAM_SUID                     0
#define WR_DAM_SPID                     0
#endif
/*RRM->FSM */
#ifdef RM_INTF
#define WR_RM_SUID                      0
...
#define WR_WR_DAMCFG_CFG               16777216
#ifdef RM_INTF
...
#else
#ifndef TIP_L3
#define WR_SM_WR_CONFIGURED  (WR_WR_GEN_CFG | WR_WR_CTF_CFG | WR_WR_NHU_CFG | WR_WR_SZT_CFG| \
                              WR_WR_CZT_CFG | WR_WR_RGR_CFG | WR_WR_ENBCFG_CFG | \
                          WR_WR_CELLCFG_CFG | WR_WR_MME_CFG | WR_WR_NHCFG_CFG | \
                         WR_WR_NREUTRAN_CFG | WR_WR_NRUTRAN_CFG | WR_WR_NHCELL_CFG | \
                     WR_WR_NHUTRAN_CELL_CFG | WR_WR_INTER_NHCELL_CFG | WR_WR_CDMA1XRTT_BAND_CFG | \
                   WR_WR_CDMA1XRTT_FREQ_CFG | WR_WR_CDMA1XRTT_CELL_CFG | \
                          WR_WR_RMU_SAP_CFG | WR_WR_GERAN_FREQ_CFG |WR_WR_GERAN_CELL_CFG | WR_WR_NLU_SAP_CFG) 
#else
#define WR_SM_WR_CONFIGURED  (WR_WR_GEN_CFG | WR_WR_CTF_CFG | WR_WR_SZT_CFG | WR_WR_CZT_CFG | WR_WR_ENBCFG_CFG | \
                              WR_WR_MME_CFG | WR_WR_NHU_CFG | WR_WR_RMU_SAP_CFG | WR_WR_NLU_SAP_CFG) 
...
#endif
#endif
#define WR_SM_WR_CELL_CONFIGURED  (WR_WR_GEN_CFG | WR_WR_RGR_CFG | WR_WR_CELLCFG_CFG | WR_WR_NHCFG_CFG | \
                                  WR_WR_NREUTRAN_CFG | WR_WR_NRUTRAN_CFG | WR_WR_NHCELL_CFG | \
                                  WR_WR_NHUTRAN_CELL_CFG | WR_WR_INTER_NHCELL_CFG | WR_WR_CDMA1XRTT_BAND_CFG | \
                                  WR_WR_CDMA1XRTT_FREQ_CFG | WR_WR_CDMA1XRTT_CELL_CFG | \
                                  WR_WR_GERAN_FREQ_CFG |WR_WR_GERAN_CELL_CFG | WR_WR_DAMCFG_CFG) 
...
#define WR_SM_RG_CONFIGURED  (WR_RG_GEN_CFG |  WR_RG_RGU_SAP_CFG |\
                              WR_RG_CRG_SAP_CFG | WR_RG_TFU_SAP_CFG)

#define WR_SM_SCH_CONFIGURED  (WR_SM_RG_CONFIGURED | WR_RG_SCH_INS_CFG)
...
#define WRSM_LYS_MAX_TFU_SAPS         (2 * WR_MAX_CELLS)
#define WRSM_LYS_NMB_UES              2
#define WR_SM_DFLT_CELL_INDX          0
...
#define WR_FILL_PST(_pst,_dstProc,_srcProc,_dstEnt,_srcEnt, _dstInst,_srcInst,_event,_pool,_selector) \
{                                                                \
   cmMemset((U8 *)&(_pst), 0, sizeof(Pst));                       \
   _pst.dstProcId = _dstProc;                                    \
...
#define WR_GET_ENBIP_FROM_CELLID(enbIp, type) do{\
   ...
   {                                             \
      enbIp->u.ipv4TptAddr.address = fapParameters.lteEnodebIpAddr.enbIpAddr;  \
   }                                             \
   else if(type == CM_TPTADDR_IPV6)              \
   {                                             \
      cmMemcpy((U8*)&enbIp->u.ipv6TptAddr.ipv6NetAddr, (U8*)&fapParameters.lteEnodebIpAddr.enbIpv6Addr, sizeof(CmInetIpAddr6)); \
   }                                             \
}while(0)
...
/* WR ----> PJ selector */
#define WRSM_WRPJSEL           1
/* PJ ----> WR selector */
#define WRSM_PJWRSEL           2
...
#define     EVTOAMCMDRECV       59
#define     EVTWRMACSCHDCFG     60
...
typedef struct _smCfgCb
{
   ...
   LwrNghUtraFddCfg   *nghUtraFddInfo[WR_MAX_CELLS][MAX_NBR_UTRA_CELL];/* UTRA FDD neighbor cell info */
   LwrNghUtraTddCfg   *nghUtraTddInfo[WR_MAX_CELLS][MAX_NBR_UTRA_CELL];/* UTRA TDD neighbor cell info */
   U16             noOfEutraFreq[WR_MAX_CELLS];                /* number of neighbor info */
   LwrNghFreqCfg   *nghEutraFreq[WR_MAX_CELLS][MAX_NBR_EUTRA_FREQ];
   U16             noOfUtraFddFreq[WR_MAX_CELLS];              /* number of UTRA FDD neighbor info */
   LwrNeighUtraFreq   *nghUtraFddFreq[WR_MAX_CELLS][MAX_NBR_UTRA_FREQ];/* UTRA FDD neighbor freq info */
   U16             noOfUtraTddFreq[WR_MAX_CELLS];                   /* number of UTRA TDD neighbor info */
   LwrNeighUtraFreq  *nghUtraTddFreq[WR_MAX_CELLS][MAX_NBR_UTRA_FREQ];/* UTRA TDD neighbor freq info */
   U16                   noOfGeranFreq[WR_MAX_CELLS]; /* number of Geran Freqs */
   U16                   noOfGeranCell[WR_MAX_CELLS]; /* number of Geran Cells */
   LwrGERANNeighCell     *geranCell[WR_MAX_CELLS][LWR_MAX_NUM_NEIGH_GERAN_CELLS];
   LwrNeighGERANFreq     *geranFreq[WR_MAX_CELLS][LWR_MAX_NUM_NEIGH_GERAN_FREQS];
   ...
   U32             ueHoAttachTimerVal;         /* Time within which UE \
                                                  ...
                                                  target cell during \
                                                  Handover. */
   U8              noOfNghCfg[WR_MAX_CELLS];                 /* number of neighbor cells configured */
   LwrNghCellCfg   *wrNghCellCfg[WR_MAX_CELLS][WR_SMM_MAX_NBR_ENB];             /* neighbor cell config info */
   /*Chinna:X2ap */
...
#endif 
  U8                       noOfCdma1xBndCls[WR_MAX_CELLS];
  LwrCdma1xrttBndClsCfg    *cdma1xBndClsCfg[WR_MAX_CELLS][WR_SMM_MAX_CDMA_1X_BAND_CLASS];
  U8                       noOfNeighCdma1xFreq[WR_MAX_CELLS];
  LwrCdma1xrttNeighFreqCfg *neighCdma1xFreq[WR_MAX_CELLS][WR_SMM_MAX_CDMA_1X_NEIGH_FREQ];
  U8                       noOfNeighCdma1xCells[WR_MAX_CELLS];
  LwrCdma1xrttNeighCellCfg *neighCdma1xCell[WR_MAX_CELLS][WR_SMM_MAX_CDMA_1X_NEIGH_CELL];
...
typedef struct _smCb
{
   ...
   U8              smCellState;    /* state for Cell state in progress or not */
   U8              numOfCells;
   U16             cellIdLst[WR_MAX_CELLS];
...
#if 0 /* MultiCell Implementation - Commenting this API as it is not being called. */
...
EXTERN Void wrSmmEnbInitFreePeerIdList(Void);
EXTERN U8 wrSmmEnbGetIsX2Enabl(U32 enbId, U8 cellCfgIdx);
EXTERN U8 wrSmmEnbGetPeerId(U32 enbId);
EXTERN U8 smGetIsX2Enabl(LwrEnbType enbType);
EXTERN Void smReturnPeerIdToFreeList(U8 peerId);
EXTERN Void wrSmmEnbFillNghUtraFreqParam(LwrNeighUtraFreq *lwrNghEutraCell,\
                         MsmLteNeighUtraFreq *msmNghEutraCell, U32 reCfgType);
EXTERN Void wrSmmEnbFillNghEutraFreqParamToMsm(MsmLteNeighEutraFreq *msmNghEutraFreq,\
                                   MsmLteNeighEutraFreq *msmNghEutraFreqDyn,\
                                   U32 reCfgType);
EXTERN Void wrSmmEnbFillNghEutraFreqParam(LwrNeighEutraFreq *lwrNghEutraFreq,\
                                   MsmLteNeighEutraFreq *msmNghEutraFreq,\
                                   U32 reCfgType);
EXTERN Void wrSmmEnbFillNghGeranFreqParam(LwrNeighGERANFreq *lwrNghGeranFreq,\
                                   MsmLteNeighGERANFreq *msmNghGeranFreq,\
                                   U32 reCfgType, U32 idx);
EXTERN Void wrSmmEnbFillNghUtraCellParam(LwrUtraNeighCell *lwrNghUtraCell,\
                                   MsmUtraNeighCell *msmNghUtraCell,\
                                   U32 reCfgType);
EXTERN Void wrSmmEnbFillNghEutraCellParam(LwrEUTRANeighCell *lwrNghEutraCell,\
                                   MsmEUTRANeighCell *msmNghEutraCell,\
                                   U32 reCfgType);
EXTERN Void wrSmmEnbFillNghGeranCellParam(LwrGERANNeighCell *lwrNghGeranCell,\
                                   MsmLteGERANNeighCell *msmNghGeranCell,\
                                   U32 reCfgType, U32 idx);
EXTERN Void wrSmmEnbFillNghEnbParam(SmNeigEnbList *nghEnbCfg,\
                              MsmEUTRANeighCell *msmNghEutraCell, U8 cellCfgIdx);
EXTERN S16 wrSmmEnbValidateFillMmeIp(LwrSmMmeCfg *mmeCfg, U8 *idx, Mmeiptype ip);
EXTERN Void smFillNghHashKeyInit(smNghCellHasKey *hashKey, LwrPlmnId *plmnId, U16 cId);
EXTERN S16 wrSmmEnbFillNghCdma1xBandParam(LwrNeighCdmaBandClassCfg *bandClassCfg, MsmCdmaBandClassCfg *bandClass, U32 reCfgType, U8 idx);

EXTERN S16 wrSmmEnbFillNghCdma1xCellParam(LwrCDMA1xNeighCell *lwrNghCdma1xCell, MsmCDMA1xNeighCell *msmNghCdma1xCell, LwrNeighCdma1xFreq *lwrNghCdma1xFreq, U32 reCfgType, U16 cnt,U8 cellCfgIdx);

EXTERN Void wrSmmEnbFillNghCdma1xFreqParam(LwrNeighCdma1xFreq *lwrNghCdma1xFreq, LwrCDMA1xNeighCell *nghCdma1xCell, U32 reCfgType, U8 idx, U8 cellCfgIdx);
EXTERN S16 smBuildWrNr1xCdmaFreqCfg(LwrMngmt *lwrMng, U8   cellCfgIdx);
EXTERN S16 smBuildWrNr1xCdmaCellCfg(LwrMngmt *lwrMng, U8   cellCfgIdx);
...
EXTERN S16 MsmSmmDynCfgReq(Void *cfg, U32 cfgType, U16 cellIdx);
EXTERN S16 wrSmmEnbInitMmeCfg(Void);
...
EXTERN S16 wrSmmEnbStaticCfgReq(Void);
...
typedef enum {
...
#if 0
   /*WR_TAG_ENB_NAME removed*/
#endif
   WR_TAG_NO_OF_BRDCST_PLMN,
   WR_TAG_PLMN_ID_LST,
   WR_TAG_NO_OF_NGH_INFO,
#if 0
   /*WR_TAG_NGH_INFO_CFG, removed*/
#endif
   WR_TAG_NO_OF_GU_GRP,
#if 0
  /* WR_TAG_GU_GRP_ID_CFG removed*/
#endif
   WR_TAG_S1_PREP_TMR,
  ...
  /* WR_TAG_NO_OF_NGH_ENB_CFG,
   ...
   WR_TAG_PRIMETWS_NO_BROADCAST,
   WR_TAG_PRIMETWS_REPETITION_PERIOD removed*/
#endif
...
#if 0
   /* ccpu00138740 */
   /*WR_TAG_PRACH_CONFIG_IDX removed*/
#endif
...
#ifdef LTE_ADV
EXTERN S16 wrSmmEnbBuildWrScellCntrl(S32 action);
#endif
...
/********************************************************************30**
           ...
           End of file:     wr_smm_init_intel.h@@/main/tenb_main_ccb/tenb_5.0_RIB/tenb_5.0_RIB_GA/13 - Mon Feb 15 12:51:39 2016
