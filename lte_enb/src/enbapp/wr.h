...
#define WR_NUM_RGR_SAPS  2
#define WR_NUM_NHU_SAPS  1
#ifdef TIP_L3
#define WR_NUM_DAM_SAPS  12
#else
#define WR_NUM_DAM_SAPS  1
#endif
#define WR_DFLT_CELL_INDX 1
...
#ifndef LTE_ADV/* CRC err observeed on LP board when UE goes to high power (23)*/
/* This needs to be checked on Intel board */
...
#define WR_KWUL_INST     1
#define WR_KWDL_INST     0
#define WR_PJUL_INST     1
#define WR_PJDL_INST     0
...
#ifdef TENB_MULT_CELL_SUPPRT
   NhuLLyrSapIdInfo         sapIds[WR_MAX_CELLS];
#endif /* TENB_MULT_CELL_SUPPRT */
} WrCb;
