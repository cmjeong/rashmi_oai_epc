...
EXTERN U16 wrSmDfltServingCellDLCarrierFreq[WR_MAX_CELLS];


EXTERN CtfBandwidth wrSmDfltCellDlBW[WR_MAX_CELLS];                   
/* ACC-TDD */
...
#ifdef LTE_ADV
EXTERN U32   wrSmDfltSCellDeActTmrVal;
EXTERN Bool   wrSmDfltForceCntrlSrbBoOnPCel;
EXTERN Bool   wrSmDfltIsSCellActDeactAlgoEnable;
/*sprint4 UECap start*/
#ifdef LTE_ADV_UECAP
#endif /* LTE_ADV_UECAP*/
/*sprint4 UECap end*/
...
EXTERN U16 wrSmDfltPUCCHnRBCQI[WR_MAX_CELLS];          /* Should have been 1 as per doc */
EXTERN U16 wrSmDfltPUCCHnCSAN[WR_MAX_CELLS];           /* zero */
EXTERN    U8 wrSmDfltPUCCHFixBw;             
EXTERN    U8 wrSmDfltPUCCHCyclShift;        
EXTERN    U8 wrSmDfltMaxPucchRbs[WR_MAX_CELLS];
/* PUSCH cfg */
EXTERN U16 wrSmDfltNSB[WR_MAX_CELLS];                    /* 2 */
EXTERN CtfPuschHoppingMode wrSmDfltHoppingMode[WR_MAX_CELLS]; /* interSubFrame */
EXTERN U16 wrSmDfltPuschHoppingOff[WR_MAX_CELLS];       /* Assuming 10Mhz channel bandwidth*/
EXTERN U16 wrSmDfltEnable64QAM[WR_MAX_CELLS];           /* false */
EXTERN U16 wrSmDfltGroupHoppingEnabled[WR_MAX_CELLS];   /* false */
EXTERN U16 wrSmDfltSeqHoppingEnabled[WR_MAX_CELLS];     /* since group hopping disabled */
EXTERN U16 wrSmDfltGroupAssignPUSCH[WR_MAX_CELLS];       /* since group hopping disabled */
EXTERN U16 wrSmDfltCyclicShift[WR_MAX_CELLS];            /* since group hopping disabled */
...
EXTERN    S8 wrSmDfltCqiOffst[WR_MAX_CELLS];
EXTERN    S8 wrSmDfltCqiCfgk[WR_MAX_CELLS];
EXTERN    U16 wrSmDfltCqiPmiCfgIdx[WR_MAX_CELLS];
...
EXTERN    U8 wrSmDfltUeUlPwrTrgCqi[WR_MAX_CELLS];
...
EXTERN U8    wrSmDfltPlmn2Mnc1;
EXTERN U8    wrSmDfltPlmn2Mnc2;
EXTERN U16   wrSmDfltTac[WR_MAX_CELLS];
EXTERN U32   wrSmDfltPhysCellId[WR_MAX_CELLS];
/* CSG_DEV - removing unused variable - remove when checking-in */
//EXTERN U32   wrSmDfltCsgId;
EXTERN U8    wrSmDfltnumSi;
EXTERN U8    wrSmDfltNumNrFreq[WR_MAX_CELLS]; /**/
...
EXTERN U16   wrSmDfltUlEarFcn[WR_MAX_CELLS];
...
#define WR_MAX_QCI           9
/* setting same as per Aricent request. SRB QCI value should follow the same QCI
 * range */
#define WR_SRB1_QCI          5 //WR_MAX_QCI + 1
#define WR_SRB2_QCI          5 //WR_MAX_QCI + 2

#define WR_NUM_OF_TFU_SAPS   wrSmDfltNumCells * 2 /* Number of TFU Saps will be twice the nos of Cells. */
...
EXTERN U8    wrSmDfltNumofUtraFddNrCell[WR_MAX_CELLS];
EXTERN U8    wrSmDfltNumofUtraTddNrCell[WR_MAX_CELLS];
EXTERN WrSmDfltExternalUtranCellLogic    wrSmDfltExtUtraCell[WR_MAX_CELLS][MAX_NBR_UTRA_CELL];
EXTERN WrSmDfltExternalUtranCellLogic    wrSmDfltExtUtraTddCell[WR_MAX_CELLS][MAX_NBR_UTRA_CELL];
