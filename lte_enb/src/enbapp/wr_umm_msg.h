...
#ifdef LTE_ADV
#define WR_UMM_INTMSG_SCELL_TRANS      15
#endif
...
/*CA-Dev*/
#ifdef LTE_ADV
/*moved WrUmmScellAction to wr_umm.h*/
typedef struct wrUmmSCellReq
{
   WrUmmScellAction  action;
   WrCellId       sCellId;
   U8             sCellIdx; 
} WrUmmSCellReq;
typedef struct wrUmmIntSCellTransMsg
{
   U8             numSCells;
   WrUmmScellAction  triggerTyp;
   WrUmmSCellReq  sCellUpdtReq[WR_MAX_SCELL_PER_UE];
} WrUmmIntSCellTransMsg;
/*CA-Dev*/
#endif
