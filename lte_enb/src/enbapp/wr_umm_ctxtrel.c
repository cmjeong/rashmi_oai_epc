...
)
{
   ...
   switch(msg->msgTyp)
   {
      ...
      RLOG0(L_WARNING, "UE Release Cause as IRAT Redirection: WR_UMM_UTRA_TDD_REDIR_REL_TRANSID");
#ifdef UE_REL_DBG
       printf("\n Release Cause as IRAT Redirection: WR_UMM_UTRA_TDD_REDIR_REL_TRANSID \n");
#endif
