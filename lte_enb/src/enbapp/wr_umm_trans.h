...
#ifdef LTE_ADV
      WrUmmSCellTransCb         sCellTransCb; /*CA-Dev*/
#endif
   } u;
} WrUmmTransCb;
...
#ifdef LTE_ADV
EXTERN S16 wrUmmSCellProcessor(WrUmmTransCb *transCb);
EXTERN S16 wrUmmSCellTransRel( WrUmmTransCb *transCb);
EXTERN S16 wrUmmSCellNewTransProcessor(WrUmmTransCb *transCb, WrUmmTransCb *incTrans);
EXTERN S16 wrUmmSendSCellSchActReady(WrUmmTransCb  *transCb);
#endif
