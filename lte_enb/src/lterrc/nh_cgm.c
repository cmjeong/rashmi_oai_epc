...
#endif /* ANSI */
{
   ...
   { 
      RLOG0(L_DEBUG, "nhCGMUpdUeCbExpCfg : Updating UE CFG for SCell ");
      transCtrlBlk->ordrdCfg.actionMask |= NH_ORD_CFG_SCELL_MAC_CFG;
      /* Update transCtrlBlk with Sec Info*/
      transCtrlBlk->ueSCellCfgInfo = ueCfg->ueSCellCfgInfo; 
