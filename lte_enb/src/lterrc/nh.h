...
#ifdef LTE_ADV
#define NH_ORD_CFG_SCELL_MAC_CFG    0x0800 /* Ordered Configure SCELL MAC */
#endif /* LTE_ADV */
...
#ifdef LTE_ADV
#define NH_CRG_UE_MAC_SCELL         0x04 /* MAC UE SCell Addition */
#endif /* LTE_ADV */
...
#define NH_GET_UE_SUID_FOR_MULT_CELL_SUPPRT(_suId, _ueCb, _sapType)\
{\
   switch(_sapType)\
   {\
      case STNHKWUSAP:\
         _suId = (_ueCb)->crntCfg.uellyrSapIdInfo.kwuSapId;\
         break;\
      case STNHCKWSAP:\
         _suId = (_ueCb)->crntCfg.uellyrSapIdInfo.ckwSapId;\
         break;\
      case STNHCRGSAP:\
         _suId = (_ueCb)->crntCfg.uellyrSapIdInfo.crgSapId;\
         break;\
      case STNHCPJSAP:\
         _suId = (_ueCb)->crntCfg.uellyrSapIdInfo.cpjSapId;\
         break;\
      case STNHPJUSAP:\
         _suId = (_ueCb)->crntCfg.uellyrSapIdInfo.pjuSapId;\
         break;\
      default :\
         NH_DBG_ERROR((NH_PRNT_BUF, "Failed : Invalid SAP Type received"));\
        break;\
   }\
}
