...
typedef struct rgLaaPrgTbReq
{
   CmMemListCp       *memCp;         /*!< Memory control point */
   CmLListCp         laaTbInfoLst;  /*!< List of type RgLaaPrgTbReqInfo*/
} RgLaaPrgTbReq;

typedef struct rgLaaPrgTbReqInfo
{
   CmLList   lnk;
   U8                sCellHqProcId;
   U8                pCellHqProcId;
...
typedef struct rgLaaPrgTbInd
{
   CmMemListCp       *memCp;         /*!< Memory control point */
   CmLListCp         laaTbLst;  /*!< List of type RgLaaPrgTbIndInfo */
} RgLaaPrgTbInd;

typedef struct rgLaaPrgTbIndInfo
{
   CmLList   lnk;
   CmLteRnti  rnti;
   U8        pCellHqPId;
...
/** @brief Function ptr for Request from PMAC to SMAC for TBs.*/
typedef Void (*RgLaaPrgPmacTbReq) ARGS
         ((Pst                        *pst,
           RgLaaPrgTbReq              *tbReq
         ));
/** @brief Function ptr for indication from SMAC to PMAC for TBs.*/
typedef Void (*RgLaaPrgPmacTbInd) ARGS
         ((Pst                        *pst,
           RgLaaPrgTbInd              *tbInd
         ));
EXTERN Void RgLaaPrgSndPmacTbReq ARGS
((Pst *pst,
RgLaaPrgTbReq  *tbReq ));
...
EXTERN Void RgLaaPrgSndTbInd ARGS
((
Pst            *pst,
RgLaaPrgTbInd  *tbInd
));
