...
EXTERN Void rgSCHCmnLaaTxAllocFnlz ARGS((
RgSchCellCb             *cell,
RgSchCmnDlRbAllocInfo   *allocInfo
));

EXTERN Void rgSCHLaaErrIndDlAllocFnlz ARGS((
RgSchCellCb             *cell,
RgSchCmnDlRbAllocInfo   *allocInfo
));

EXTERN Void rgSCHLaaDlAllocFnlz ARGS((
RgSchCellCb             *cell,
RgSchCmnDlRbAllocInfo   *allocInfo
));

EXTERN S16 rgSCHCmnDlAllocErrIndTxRb ARGS((
RgSchCellCb                *cell,
RgSchDlSf                  *subFrm,
RgSchUeCb                  *ue,
U32                        bo,
