...
#ifdef TIP_LOWER_L2
      rgSCHUtlRgrCfgCfm(instId, spId, transId, cfmStatus,1,1); //TODO- darshan - hardcoded for now
#else
...
#ifdef TIP_LOWER_L2
            rgSCHUtlRgrCfgCfm(instId, spId, transId, cfmStatus,1,1); //TODO - darshan - hardcoding
#else
            rgSCHUtlRgrCfgCfm(instId, spId, transId, cfmStatus);
#endif 
            RETVALUE(RFAILED);
