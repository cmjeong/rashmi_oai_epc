...
#define RM_RCM_CQI_PMI_IDX_FACTOR_PER_CELL 2

#ifdef LTE_ADV
/*TEMP: For now we are supporting only one Scell */
#define RM_MAX_SCELL_SUPPORTED 1
#define RM_MAX_CELL_SUPPORTED (RM_MAX_SCELL_SUPPORTED + 1)
#endif   
