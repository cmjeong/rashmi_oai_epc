##############################################################################
#
# Makefile fragment for building a static library under Linux.
...
# calling makefile.
#
# Built library is 'lib<TARGET_NAME>.a'
#
##############################################################################
...
CFLAGS   += -Wall -Wno-unknown-pragmas -fmessage-length=0
CXXFLAGS += -Wall -Wno-unknown-pragmas -fmessage-length=0 -m32
LDFLAGS  := -Wall -fmessage-length=0 -g -static $(LIBS:%=-l%) $(LIB_BASES:%=-l%) $(LIB_PATHS:%=-L%) $(LDFLAGS)
