/*****************************************************************************
 *
 * $Id: binstamp.c 27745 2010-06-30 12:56:50Z mmcternan $
 *
 * Copyright (C) Radisys Uk Ltd
 *
 *****************************************************************************/
...
{
    TRACE_PRINTF_CONSOLE("Usage: binstamp <binary> [-u <version>]\n");
    TRACE_PRINTF_CONSOLE("\n");
    TRACE_PRINTF_CONSOLE("This will print the stamp information held in <binary>, or update. the stamp\n"
