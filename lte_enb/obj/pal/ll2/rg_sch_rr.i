...
extern Void rgSCHRrCListInit (RgSchRrCListCp *lList);
extern Void rgSCHRrCListAdd2Tail (RgSchRrCListCp *lList, RgSchRrCList *node)
                                                                        ;

extern RgSchRrCList *rgSCHRrCListDelFrm (RgSchRrCListCp *lList, RgSchRrCList *node)
                                                                        ;
extern Void rgSCHRrCListInsrtAtCrnt (RgSchRrCListCp *lList, RgSchRrCList *node)
                                                                        ;

extern Void rgSCHRrCListAdd2Crnt (RgSchRrCListCp *lList, RgSchRrCList *node)
                                                              ;
typedef struct rgSchRrDlProc
{
   RgSchRrCList retxLnk;
...
{
   RgSchRrCList ueTxLnk;
   RgSchRrCList toBeSchdLnk;
   RgSchRrCListCp sigLst;
   RgSchRrCListCp dataLst;
   RgSchRrCListCp schedLcs;
   Bool schdTa;
...
{
   RgSchRrCListCp prioUeTxLst;
   RgSchRrCListCp normUeTxLst;
   RgSchRrCListCp ueRetxLst;
...
( RgSchCellCb *cell, RgSchUeCb *ue, Bool isPucchInfo, Void *dlCqi )
...
( RgSchCellCb *cell, RgrCellCfg *cfg, RgSchErrInfo *err )
...
( RgSchCellCb *cell, RgrCellRecfg *recfg, RgSchErrInfo *err )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgrUeCfg *cfg, RgSchErrInfo *err )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgrUeRecfg *recfg, RgSchErrInfo *err )
...
( RgSchCellCb *cell, RgSchDlHqProcCb *hqP )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgSchDlLcCb *dlLc, RgrLchCfg *cfg, RgSchErrInfo *err )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgSchDlLcCb *dlLc, RgrLchRecfg *recfg, RgSchErrInfo *err )
...
( RgSchCellCb *cell, RgSchUeCb *ueCb )


  ;

extern Void rgSCHRrDlNewSchd
( RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *allocInfo )
...
( RgSchCellCb *cell, CmLListCp *lst )
...
( RgSchCellCb *cell, RgSchUeCb *ue, TfuUlCqiRpt *ulCqiInfo )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgSchLcgCb *ulLcg, RgrLcgCfg *cfg, RgSchErrInfo *err )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgSchLcgCb *ulLcg, RgrLcgRecfg *recfg, RgSchErrInfo *err )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgSchLcgCb *ulLcg )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgSchLcgCb *ulLcg, U8 bs )
...
( RgSchCellCb *cell, RgSchUeCb *ue, U8 bsArr[] )
...
( RgSchCellCb *cell, RgSchCmnUlRbAllocInfo *allocInfo )
...
( RgSchCellCb *cell, RgSchUeCb *ue, RgSchDlHqProcCb *hqP)
...
extern S16 rgSCHRrUlLchCfg ( RgSchCellCb *cell, RgSchUeCb *ue, RgrLchCfg *cfg, RgSchErrInfo *err )
...
extern S16 rgSCHRrUlLchRecfg ( RgSchCellCb *cell, RgSchUeCb *ue, RgrLchRecfg *recfg, RgSchErrInfo *err )
...
extern S16 rgSCHRrUlLchDel ( RgSchCellCb *cell, RgSchUeCb *ue, CmLteLcId lcId, U8 lcgId )
...
static Void rgSCHRrRlsDlHqProc ( RgSchDlHqProcCb *proc );


static Void rgSCHRrDlRetxOfPrioritizedUe ( RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *allocInfo, U8 feautre, Bool vctmPrior)


                                                                                   ;
static Void rgSCHRrDlNewTxOfPrioritizedUe ( RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *allocInfo, U8 feautre, Bool vctmPrior)


                                                                                    ;


static Void rgSCHRrDlScheduleUEs ( RgSchCellCb *cell, RgSchDlSf *sf, RgSchCmnDlRbAllocInfo *allocInfo)


                                                                              ;

static Void rgSCHRrDlAddUeToSchdLst ( RgSchRrCListCp *lcp, RgSchUeCb *ueToBeInsrtd, RgSchCellCb *cell)
                                                                                             ;

 S16 rgSCHRrUlLcgUpd ( RgSchCellCb *cell, RgSchUeCb *ue, RgInfUeDatInd *datInd)

                                                                 ;

 Void rgSCHRrDlScanUpdPdbPrio (RgSchCellCb *cell );
 S16 rgSCHRrDlFillFlowCntrlInfo ( RgSchCellCb *cell, RgInfSfAlloc *sfAlloc)
                                                                      ;
static Void rgSCHRrDlUpdateSchedList ( RgSchCellCb *cell, RgSchRrDlCell *rrDlCell, RgSchDlSf *dlSf, CmLteTimingInfo schdTime, RgSchRrCListCp *txListCp)



                                                                        ;
static Void rgSCHRrDlAddUeTxLst ( RgSchUeCb *ue, RgSchRrDlCell *rrDlCell, RgSchRrDlUe *rrDlUe)

                                                                       ;

static Void rgSCHRrUlAddUeTxLst ( RgSchUeCb *ue, RgSchRrUlCell *rrUlCell, RgSchRrUlUe *rrUlUe)

                                                                       ;

static Void rgSCHRrDlDelUeTxLst ( RgSchUeCb *ue, RgSchRrDlCell *rrDlCell, RgSchRrDlUe *rrDlUe)

                                                                       ;

static Void rgSCHRrUlDelUeTxLst ( RgSchUeCb *ue, RgSchRrUlCell *rrUlCell, RgSchRrUlUe *rrUlUe)
...
U32 cellDlAvgAvlPrbCount = 0 ;
U32 gDbgTxLstCntPerTti[6] = {0};
U32 gDbgUlTxLstCntPerTti[6] = {0};
 Void rgSCHRrDlCqiInd
(
RgSchCellCb *cell,
RgSchUeCb *ue,
Bool isPucchInfo,
...

{
   ...
   if(rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(schCmnCell->dl.schSpfc), (sizeof(RgSchRrDlCell))) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0001,L_ERROR,DBG_CELLID, cell->cellId, 0, 0, 0, 0,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"      ,                                   264      , "Memory allocation FAILED", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                    ;
      return(1);
   }
...

{
   ...
   if(rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(hqEnt->sch),
      (hqEnt->numHqPrcs * sizeof(RgSchRrDlHqProc))) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0002,L_ERROR,DBG_CELLID, cell->cellId,hqEnt->ue->ueId, 0, 0, 0,                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"      ,                                                            389      , "Memory allocation FAILED CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                             ;
      return(1);
   }
   return(0);
...

{
   ...
   if(rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(schCmnUe->dl.schSpfc), (sizeof(RgSchRrDlUe))) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0003,L_ERROR,DBG_CELLID, cell->cellId,ue->ueId, 0, 0, 0,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"      ,                                                     667      , "Memory allocation FAILED CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
      return(1);
   }
...

{
   ...
   if(schRrDlHqProc->retxLnk.node != 0L)
   {
      rgSCHRrCListDelFrm(&(rrDlCell->ueRetxLst),
            &(schRrDlHqProc->retxLnk));
      schRrDlHqProc->retxLnk.node = 0L;
   }

   return;
}
 S16 rgSCHRrDlUeRecfg
(
RgSchCellCb *cell,
RgSchUeCb *ue,
RgrUeRecfg *recfg,
...

{
   ...
   {
      if (rrDlUe->ueTxLnk.node != 0L)
      {
         if (recfg->csgMmbrSta == 0)
         {
         ...
         rrDlUe->ueTxLnk.node = (U32)ue;
      }
   }

   return(0);
}
 Void rgSCHRrDlProcAddToRetx
(
RgSchCellCb *cell,
RgSchDlHqProcCb *hqP
)
...

{
   ...
   rgSCHRrCListAdd2Tail(&(rrDlCell->ueRetxLst),
                     &(schRrDlHqProc->retxLnk));
   schRrDlHqProc->retxLnk.node = (U32)hqP;
 ...
 Void rgSCHRrDlRmvProcFrmRetxLst
(
RgSchCellCb *cell,
RgSchUeCb *ue,
RgSchDlHqProcCb *hqP
...

{
 ...
 S16 rgSCHRrDlFillFlowCntrlInfo
(
RgSchCellCb *cell,
...

{
   ...
   if (hqEnt)
   {
      ...
      {
         RgSchDlHqProcCb *hqP = &(hqEnt->procs[i]);
         rgSCHRrDlProcRmvFrmRetx(cell, hqP);
         if (hqP->subFrm != 0L)
         {
            if (hqP->pdcch )
...
)
{
   ...
   if(rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&((((RgSchCmnDlSvc *)(dlLc->sch))->schSpfc[ ue->cellIdToCellIdxMap[(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]])), (sizeof(RgSchRrDlLc))) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0004,L_ERROR,DBG_CELLID, cell->cellId,ue->ueId, cfg->lcId, 0, 0,                                                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"      ,                                                                       1040      , "Memory allocation FAILED CRNTI:%d LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                        ;
      return(1);
   }
   return(0);
}
 S16 rgSCHRrDlLcRecfg
(
RgSchCellCb *cell,
RgSchUeCb *ue,
RgSchDlLcCb *dlLc,
...

{
   ...
   RgSchRrDlLc *rrDlLc = (((RgSchCmnDlSvc *)(dlLc->sch))->schSpfc[ ue->cellIdToCellIdxMap[(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]]);
   ;;

   if(schCmnDlLc->schSpfc == 0L || rrDlLc == 0L)
   {
      return;
   }
   ...
   if(rrDlLc->lnk.node)
   {
      ...
      if((rrDlUe->sigLst.first == 0L) &&
            (rrDlUe->dataLst.first == 0L))
      {
         if (rrDlUe->ueTxLnk.node != 0L)
         {
            rgSCHRrDlDelUeTxLst(ue,rrDlCell,rrDlUe);
   ...
   rgSCHUtlFreeSBuf(cell->instIdx,
   (Data**)(&((((RgSchCmnDlSvc *)(dlLc->sch))->schSpfc[ ue->cellIdToCellIdxMap[(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]]))), (sizeof(RgSchRrDlLc)));
   return;
}
 Void rgSCHRrDlDedBoUpd
(
RgSchCellCb *cell,
RgSchUeCb *ue,
RgSchDlLcCb *dlLc
...

{
   ...
   while((node=rrDlUe->sigLst.first) != 0L)
   {
      dlLc = (RgSchDlLcCb *)(node->node);
      schCmnDlLc = (RgSchCmnDlSvc *)(dlLc->sch);
      rrDlLc = (((RgSchCmnDlSvc *)(dlLc->sch))->schSpfc[ ue->cellIdToCellIdxMap[(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]]);
      rgSCHRrCListDelFrm(&(rrDlUe->sigLst), &(rrDlLc->lnk));
      rrDlLc->lnk.node = 0L;
      node = node->next;
   }
   ...
   while((node=rrDlUe->dataLst.first) != 0L)
   {
      dlLc = (RgSchDlLcCb *)(node->node);
      schCmnDlLc = (RgSchCmnDlSvc *)(dlLc->sch);
      rrDlLc = (((RgSchCmnDlSvc *)(dlLc->sch))->schSpfc[ ue->cellIdToCellIdxMap[(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]]);
...

{
   ...
   if(rrDlCell->ueRetxLst.crnt == 0L || !remUe)
   {
      return;
   }
   ...
   {
      rgSCHRrDlRetxOfPrioritizedUe(cell, allocInfo, RGR_SFR, 1);
   ...
   {
      rgSCHRrDlRetxOfPrioritizedUe(cell, allocInfo, RGR_ABS, 1);
   ...
   do
   {
      ...
      ue = hqP->hqE->ue;
      schCmnUe = ((RgSchCmnUe *)((ue->cellInfo[(ue->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)])])->sch));
      rrDlUe = (RgSchRrDlUe *)(schCmnUe->dl.schSpfc);
      node = node->next;
      ...
      if(schCmnUe->dl.proc != 0L)
      {

         continue;
      }
      if ((rrDlUe->sigLst.first != 0L) || (rrDlUe->dataLst.first != 0L))
      {
...
static Void rgSCHRrDlRetxOfPrioritizedUe
(
 RgSchCellCb *cell,
 RgSchCmnDlRbAllocInfo *allocInfo,
 U8 feature,
...

{
   ...
   U32 allocBo;
   RgSchRrDlHqProc *schRrDlHqProc;
   RgSchRrCList *crntNode = 0L;
   Bool isNodeSkipped = 0;
   U32 remUe = allocInfo->dedAlloc.dedDlSf->remUeCnt;
   ...
   do
   {
      ...
      if(1 == vctmPrior)
      {
         if(((RGR_SFR == feature) && (0 == ue->lteAdvUeCb.rgrLteAdvUeCfg.isUeCellEdge))
               || ((RGR_ABS == feature) && (0 == ue->lteAdvUeCb.rgrLteAdvUeCfg.isAbsUe))
           )
         {
      ...
      {
         if(((RGR_SFR == feature) && (1 == ue->lteAdvUeCb.rgrLteAdvUeCfg.isUeCellEdge))
               || ((RGR_ABS == feature) && (1 == ue->lteAdvUeCb.rgrLteAdvUeCfg.isAbsUe))
           )
         {
      ...
      if((1 == vctmPrior) && (RGR_SFR == feature))
      {
         allocInfo->dedAlloc.dedDlSf->sfrTotalPoolInfo.isUeCellEdge = 1;
      }
...

{
   ...
   cmnHqDl = ((RgSchCmnDlHqProc *)((schCmnUe->dl.proc)->sch));
      ...
      if((ret != 0) || (allocBo == 0))
      {
         if (cmnHqDl->totBytes == 0)
         {
            ...
            if(schCmnUe->dl.proc != 0L)
            {
               ...
               if(schCmnUe->dl.proc->reqLnk.node != (U32)0L)
               {
                  cmLListDelFrm(&allocInfo->dedAlloc.txHqPLst,
                                &schCmnUe->dl.proc->reqLnk);
                  schCmnUe->dl.proc->reqLnk.node = (U32)0L;
               }
   ...
   if((rrDlUe->schedLcs.count == 0) && (rrDlUe->schdTa == 0))
...
static Void rgSCHRrRlsDlHqProc
(
RgSchDlHqProcCb *proc
)
...

{
   ...
   while(taNode && dlSf->remUeCnt)
   {
      ...
      if(rgSCHDhmGetAvlHqProc(cell, ue,
               schCmnCell->dl.time, &(schCmnUe->dl.proc)) != 0)
      {
         continue;
      }
      ...
      if(rgSCHCmnDlAllocTxRb(cell, dlSf, ue,
               macCeBo, &allocBo, schCmnUe->dl.proc,
               allocInfo) != 0)
      {
         rgSCHRrRlsDlHqProc(schCmnUe->dl.proc);
         schCmnUe->dl.proc = 0L;
      ...
      if(allocBo)
      {
         ...
         rgSCHRrDlAddUeToSchdLst(&(rrDlCell->toBeSchedLst), ue, cell);
...
static Void rgSCHRrDlAddPrioritizedUeToSchLst
(
 RgSchCellCb *cell,
 RgSchCmnDlRbAllocInfo *allocInfo,
 U8 feature,
...
static Void rgSCHRrDlNewTxOfPrioritizedUe
(
 RgSchCellCb *cell,
 RgSchCmnDlRbAllocInfo *allocInfo,
 U8 feature,
...
static Void rgSCHRrDlScheduleUEs
(
RgSchCellCb *cell,
RgSchDlSf *sf,
RgSchCmnDlRbAllocInfo *allocInfo
...

{
   ...
   {
      ue = (RgSchUeCb *)(node->node);
      cmnUe = ((RgSchCmnUe *)((ue->cellInfo[(ue->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)])])->sch));
      ...
      cmnUe->dl.maxRb = ((tmpMaxRb) <= (prbSharePerUe) ? (tmpMaxRb) : (prbSharePerUe));
...
static Void rgSCHRrDlAddUeToSchdLst
(
RgSchRrCListCp *toBeSchedLst,
...
{
   RgSchCmnUe *schCmnUe = ((RgSchCmnUe *)((ueToBeInsrtd->cellInfo[(ueToBeInsrtd->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)])])->sch));
   RgSchRrDlUe *rrDlUe = (RgSchRrDlUe *)(schCmnUe->dl.schSpfc);
   ...
   if(toBeSchedLst->first == 0L)
   {

      rgSCHRrCListAdd2Tail(toBeSchedLst, &(rrDlUe->toBeSchdLnk));
      rrDlUe->toBeSchdLnk.node = (U32)ueToBeInsrtd;
      return;
   }
   ...
   else
   {
      ...
      while(tmpNode != (toBeSchedLst->first))
      {
         ...
         tmpSchCmnUe = ((RgSchCmnUe *)((tmpUe->cellInfo[(tmpUe->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)])])->sch));
...
static Void rgSCHRrDlSelectDlUes
(
RgSchCellCb *cell,
RgSchCmnCell *schCmnCell,
RgSchDlSf *dlSf
...
static Void rgSCHRrDlUpdateSchedList
(
RgSchCellCb *cell,
RgSchRrDlCell *rrDlCell,
RgSchDlSf *dlSf,
...
)
{
   ...
   RgSchRrDlUe *rrDlUe;
   RgSchRrCList *node;
   RgrLteAdvancedUeConfig *rgrLteAdvUeCfg = 0L;
   U32 prbRequrd;
   U32 availBw;
   ...
   if(txListCp->crnt == 0L || !(dlSf->remUeCnt))
   {
      return;
   }
   ...
   do
   {
      ...
      if(rrDlUe->toBeSchdLnk.node != 0L)
      {
         if(rrDlCell->toBeSchedLst.count == 0)
             if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0005,L_ERROR,DBG_CELLID, cell->cellId,ue->ueId, 0, 0, 0,                                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"             ,                                                                           2862             , "UE already present count(ERROR) CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                            ;
         continue;
      }
...

{
   ...
   dlSf->numDlActvUes = rrDlCell->prioUeTxLst.count +
                          rrDlCell->normUeTxLst.count;

   {

      cellDlAvgAvlPrbCount += availableBW;
      if(!(dlSf->numDlActvUes))
      {
         gDbgTxLstCntPerTti[(dlSf->numDlActvUes)]++;
      }
      else if((dlSf->numDlActvUes <= 4))
      {
         gDbgTxLstCntPerTti[(dlSf->numDlActvUes)]++;
      }
      else
      {
         gDbgTxLstCntPerTti[4]++;
      }
   }
   ...
   if(cell->lteAdvCb.sfrCfg.status)
   {
      rgSCHRrDlNewTxOfPrioritizedUe(cell, allocInfo, RGR_SFR, 1);
   }
   ...
   if(RG_SCH_ABS_ENABLED_ABS_SF == cell->lteAdvCb.absDlSfInfo)
   {
      if (dlSf->remUeCnt)
      {
         rgSCHRrDlNewTxOfPrioritizedUe(cell, allocInfo, RGR_ABS, 1);
      }
   }
...
static Void rgSCHRrDlNewTxTbDstn
(
RgSchCellCb *cell,
RgSchUeCb *ue,
...
)
{
   ...
   if(!tbInfo->schdTa.pres)
   {
      if(rrDlUe->schdTa == 1)
      {
         ...
         else if(rrDlUe->schedLcs.first == 0L)
         {
            return;
         }
      }
   ...
   while((*node) && (*effAlloc > 0))
   {
      ...
      *node = (*node)->next;
      ...
      bo = dlLc->bo;
      lcTotalBo = (bo) ? (bo + rrDlLc->rlcHdrEstmt):(0);
      bo = ((((lcTotalBo) >= (rrDlLc->schdBo) ? (lcTotalBo) : (rrDlLc->schdBo))) <= (*effAlloc) ? (((lcTotalBo) >= (rrDlLc->schdBo) ? (lcTotalBo) : (rrDlLc->schdBo))) : (*effAlloc));
      ...
      *effAlloc -= bo;
      ...
      if(rgSCHDhmAddLcData(cell->instIdx, &lchSchdData,
            tbInfo) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0006,L_ERROR,DBG_CELLID, cell->cellId,ue->ueId, dlLc->lcId, 0, 0,                                                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"         ,                                                                       3436         , "Failed to update DHM CRNTI:%d LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                        ;
      }
...
static Void rgSCHRrDlSprTxTbDstn
(
RgSchCellCb *cell,
RgSchUeCb *ue,
RgSchDlHqTbCb *tbInfo,
   ...
   while(lcLst->crnt)
   {
      ...
      *effAlloc -= bo;
      ...
      if(rgSCHDhmAddLcData(cell->instIdx, &lchSchdData,
            tbInfo) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0007,L_ERROR,DBG_CELLID, cell->cellId,ue->ueId, dlLc->lcId, 0, 0,                                                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"         ,                                                                       3591         , "Failed to update DHM CRNTI:%d LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                        ;
      }
...
static S16 rgSCHRrDlUeAllocFnlz
(
RgSchCellCb *cell,
RgSchUeCb *ue
)
...
static Void rgSCHRrDlRetxUesAllocFnlz
(
RgSchCellCb *cell,
RgSchCmnDlRbAllocInfo *allocInfo
)
...

{
   ...
   while(node)
   {
      hqP = (RgSchDlHqProcCb *)(node->node);
      ue = hqP->hqE->ue;
      dlRbAlloc = &(((ue)->cellInfo[(ue)->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]])->dlAllocCb);;
      node = node->next;
      ...
      ue->tenbStats->stats.nonPersistent.sch[(U8)((hqP->hqE->cell->cellId >= rgSchCb[hqP->hqE->cell->instIdx].genCfg.startCellId) ? (hqP->hqE->cell->cellId - rgSchCb[hqP->hqE->cell->instIdx].genCfg.startCellId)&(8 -1): 0)].dlRetxOccns++;
...
static Void rgSCHRrDlUesAllocFnlz
(
RgSchCellCb *cell,
RgSchCmnDlRbAllocInfo *allocInfo
)
...

{
   ...
   while(node)
   {
      ...
      node = node->next;
      if(rgSCHRrDlUeAllocFnlz(cell, ue) == 0)
      {
      ...
      ue->tenbStats->stats.nonPersistent.sch[(U8)((hqP->hqE->cell->cellId >= rgSchCb[hqP->hqE->cell->instIdx].genCfg.startCellId) ? (hqP->hqE->cell->cellId - rgSchCb[hqP->hqE->cell->instIdx].genCfg.startCellId)&(8 -1): 0)].dlTxOccns++;
...
static Void rgSCHRrDlRetxNewTxAllocFnlz
(
RgSchCellCb *cell,
RgSchCmnDlRbAllocInfo *allocInfo
)
...

{
   ...
   while(node)
   {
      ...
      rgSCHCmnRdcImcsTxTb(dlRbAlloc, 1, effAlloc - remTbBytes);
      rgSCHRrDlProcRmvFrmRetx(cell, hqP);
...

{
   ...
   rgSchDlApis->rgSCHDlNewSched = rgSCHRrDlNewSchd;
   rgSchDlApis->rgSCHDlPreSched = rgSCHRrDlPreSchd;
   rgSchDlApis->rgSCHDlPstSched = rgSCHRrDlPstSchd;
   rgSchDlApis->rgSCHDlCeSched = rgSCHRrDlCeSchd;
   rgSchDlApis->rgSCHDlRetxSched = rgSCHRrDlRetxSchd;
...

{
   ...
   if(rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(schCmnCell->ul.schSpfc), (sizeof(RgSchRrUlCell))) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0008,L_ERROR,DBG_CELLID, cell->cellId, 0, 0, 0, 0,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"      ,                                   4309      , "Memory allocation FAILED", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                    ;
      return(1);
   }
...

{
   ...
   if(rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(schCmnUe->ul.schSpfc), (sizeof(RgSchRrUlUe))) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac0009,L_ERROR,DBG_CELLID, cell->cellId, 0, 0, 0, 0,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"      ,                                   4436      , "Memory allocation FAILED", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                    ;
      return(1);
   }
...
static Void rgSCHRrUlUeChkAndUpdSchd
(
RgSchCellCb *cell,
RgSchUeCb *ue
)
...

{
   ...
   if((ue->ul.effBsr) && (rrUlUe->contResLnk.node == 0L))
   {
      if(rrUlUe->ueTxLnk.node == 0L)
      {
         rgSCHRrUlAddUeTxLst(ue,rrUlCell,rrUlUe);
         schCmnUeUlAlloc->reqLnk.node = 0L;
      }
      else if(
               (((&ue->ul.lcgArr[0])->lcgId != 255) == 0) &&
               (((&ue->ul.lcgArr[1])->lcgId != 255) == 0) &&
               (((&ue->ul.lcgArr[2])->lcgId != 255) == 0) &&
               (((&ue->ul.lcgArr[3])->lcgId != 255) == 0)
             )
      {
         rgSCHRrUlDelUeTxLst(ue,rrUlCell,rrUlUe);
      }
...

{
   ...
   if(rrUlUe->contResLnk.node != 0L)
   {
      rgSCHRrCListDelFrm(&(rrUlCell->contResLst), &(rrUlUe->contResLnk));
      rrUlUe->contResLnk.node = 0L;
      return;
   }
...
static Void rgSCHRrUlSchdContResUes
(
RgSchCellCb *cell,
...

{
   ...
   if(rrUlCell->contResLst.crnt == 0L || !*remUe)
   {
      return;
   }
   ...
   do
   {
      ...
      {
         schCmnUeUlAlloc->reqBytes = ue->ul.effBsr;
      }
      cmLListAdd2Tail(&(allocInfo->contResLst),
                        &(schCmnUeUlAlloc->reqLnk));
      schCmnUeUlAlloc->reqLnk.node = (U32)ue;
      ue->isSrGrant = 0;
      (*remUe)--;
      if(*remUe == 0)
      {
...

{
   ...
   do
   {
      ...
      schCmnUe = ((RgSchCmnUe *)((ue->cellInfo[(ue->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)])])->sch));
      schCmnUeUlAlloc = &(schCmnUe->ul.alloc);
      proc = &(ueUl->hqEnt.hqProcCb[schCmnCell->ul.schdHqProcIdx]);
      ...
      rgSchUtlSortInsUeLst(cell, &(allocInfo->ueLst), &schCmnUeUlAlloc->reqLnk,
            ueUl->subbandRequired);
      totSbReq += ueUl->subbandRequired;
      schCmnUeUlAlloc->reqLnk.node = (U32)ue;
...

{
   ...
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xac000a,L_DEBUG,DBG_CELLID, cell->cellId, schCmnCell->ul.maxAllocPerUlSf, *allocInfo->sf->allocCountRef, 0, 0,                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_rr.c"      ,                                            5393      , "More than expecte UEs per TTI allocated in UL exp(%u)" "allocated(%u)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
static Void rgSCHRrUlContResUesAllocFnlz
(
RgSchCellCb *cell,
RgSchCmnUlRbAllocInfo *allocInfo
)
...
static Void rgSCHRrUlUeAllocFnlz
(
RgSchCellCb *cell,
RgSchUeCb *ue,
...
static Void rgSCHRrUlUesAllocFnlz
(
RgSchCellCb *cell,
RgSchCmnUlRbAllocInfo *allocInfo
)
...
static Void rgSCHRrDlAddUeTxLst
(
RgSchUeCb *ue,
RgSchRrDlCell *rrDlCell,
RgSchRrDlUe *rrDlUe
...
static Void rgSCHRrUlAddUeTxLst
(
RgSchUeCb *ue,
RgSchRrUlCell *rrUlCell,
RgSchRrUlUe *rrUlUe
...
static Void rgSCHRrDlDelUeTxLst
(
RgSchUeCb *ue,
RgSchRrDlCell *rrDlCell,
RgSchRrDlUe *rrDlUe
...

{
   ...
   if (rrDlUe->ueTxLnk.node != 0L)
   {
      ...
      rrDlUe->ueTxLnk.node = 0L;
   }
}
static Void rgSCHRrUlDelUeTxLst
(
RgSchUeCb *ue,
RgSchRrUlCell *rrUlCell,
RgSchRrUlUe *rrUlUe
