...
extern S16 PtLiRguBndReq ( Pst *post, SuId suId, SpId spId )



  ;

extern S16 PtLiRguUbndReq ( Pst *post, SpId spId, Reason reason )



  ;

extern S16 PtLiRguCDatReq ( Pst *post, SpId spId, RguCDatReqInfo *datReq )



  ;

extern S16 PtLiRguDDatReq ( Pst *post, SpId spId, RguDDatReqInfo *datReq )



  ;

extern S16 PtLiRguCStaRsp ( Pst *post, SpId spId, RguCStaRspInfo *staRsp )



  ;

extern S16 PtLiRguDStaRsp ( Pst *post, SpId spId, RguDStaRspInfo *staRsp )
...

{
   ...
   if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xee0001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_ptli.c",705, "Improper selector value", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   (post=post);
   (suId=suId);
   (spId=spId);
