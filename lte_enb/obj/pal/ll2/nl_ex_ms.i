   ...
   switch(pst->srcEnt)
   {
      ...
      case 0x0E:
      {
         switch(pst->event)
         {
            ...
            case 6:
               ...
               break;
            default:
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf80001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ex_ms.c",112, "SON received Invalid Event received from SM \n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               { if(0L != mBuf) { (Void)SPutMsg((mBuf)); (mBuf) = 0L; } };
               break;
         }
         break;
      }
      case 0xe3 :
      {
         switch(pst->event)
         {
            ...
            default :
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf80002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ex_ms.c",148, "SON received Invalid Event received from eNB-APP  \n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               { if(0L != mBuf) { (Void)SPutMsg((mBuf)); (mBuf) = 0L; } };
               break;
         }
         break;
      ...
      case 0xe4 :
      {
         switch(pst->event)
         {
            case 100 :
               ...
               break;
            default :
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf80003, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ex_ms.c",162, "SON received Invalid Event received from DSON  \n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               { if(0L != mBuf) { (Void)SPutMsg((mBuf)); (mBuf) = 0L; } };
               break;
         }
         break;
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf80004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ex_ms.c",170, " SON received invalid event from unexpected source entity \n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { if(0L != mBuf) { (Void)SPutMsg((mBuf)); (mBuf) = 0L; } };
         break;
      }
   }
