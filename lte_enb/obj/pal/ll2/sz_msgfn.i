...

{
   switch(errCode-1)
   {
      case 0 :
      {
         { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { snprintf((&szCb.init)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->procId, (&szCb.init)->ent, (&szCb.init)->inst,
                                                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_msgfn.c"
         ,
                                                                          221
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255, "Transfer Syntax Error: Unexpected value(%d) \n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                           ;
         break;
      }
      case 1 :
      {
         ...
         ,
                                                                          227
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255, "Transfer Syntax Error: Resources error (%d)\n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                           ;
         break;
      }
      case 2 :
      {
         ...
         ,
                                                                   233
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255,"Transfer Syntax" " Error: Out of DB defined range (%d) \n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                    ;
         break;
      }
      case 3 :
      {
         ...
         ,
                                                                             239
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255,"Transfer Syntax" " Error: Extra parameter at the end of msg (%d)\n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                              ;
         break;
      }
      case 4 :
      {
         ...
         ,
                                                                           245
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255,"Transfer Syntax" " Error: Element index is bad for choice (%d)\n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                            ;
         break;
      }
      case 5 :
      {
         ...
         ,
                                                               251
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255,"Transfer Syntax" " Error: Undefined parameter (%d)\n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                ;
         break;
      }
      case 6 :
      {
         ...
         ,
                                                                     257
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255,"Transfer Syntax" " Error: Mandatory element missing (%d)\n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                      ;
         break;
      }
      case 7 :
      {
         ...
         ,
                                                          263
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255,"Transfer Syntax" " Error: Database error (%d)\n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                           ;
         break;
      }
      case 8 :
      {
         ...
         ,
                                                                   269
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255,"Transfer Syntax" " Error: Default element missing (%d)\n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                    ;
         break;
      }
      case 9 :
      {
         ...
         ,
                                                                       275
         ); SPrint((&szCb.init)->prntBuf); snprintf (szCb.init.prntBuf, 255,"Abstract Syntax" " Error: User escape function failed (%d)\n", errCode); SPrint((&szCb.init)->prntBuf); } }
                                                                        ;
         break;
      }
      default:
      {
         ...
         ,
                                                 281
         ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf," Invalid error code" " value (%d) \n",errCode); SPrint((&szCb.init)->prntBuf); } }
                                                  ;
         break;
      }
   }
...

{
   ...
   if (szCb.init.dbgMask & (0x00000100 << 2))
      dbgFlag = 1;
   ...
   if ((SGetMsg(mem->region, mem->pool, mBuf)) != 0)
   {
      ;

      { if (*s1apPdu != 0L) { cmFreeMem ((Ptr)(*s1apPdu)); *s1apPdu = 0L; } };
   ...
   ret = cmPAsnEncMsg((TknU8 *)(&(*s1apPdu)->pdu), 1,
                      (Void *)(*mBuf), 0,
   ...
   if (ret == 1)
   {
      ...
      ,
                                  357
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, " Encoding failed \n"); SPrint((&szCb.init)->prntBuf); } }
                                   ;
...

{
   ...
   ret = cmAllocEvnt(sizeof(S1apPdu), 2048, mem, (Ptr *)s1apPdu);
   if (ret != 0)
   {
      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { snprintf((&szCb.init)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->procId, (&szCb.init)->ent, (&szCb.init)->inst,
                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_msgfn.c"
      ,
                                                    557
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "Memory allocation failed in Decode \n"); SPrint((&szCb.init)->prntBuf); } }
                                                     ;
   ...
   ret = (cmPAsnDecMsg((Void *)&((*s1apPdu)->pdu), 1,
                  (Void **)mBuf, &numDecOct, 0,
                  (CmPAsnElmDef **)szMsgDb, 1,
   ...
   if ((ret == 1) || (err->errCode != 0))
   {
      ...
      ,
                                  581
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, " Decoding failed \n"); SPrint((&szCb.init)->prntBuf); } }
                                   ;
...

{
   ...
   ret = cmAllocEvnt(sizeof(SzIePdu), 2048, mem, (Ptr *) &(sztEncDecEvnt->u.iePdu));
   if (ret != 0)
   {
      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { snprintf((&szCb.init)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->procId, (&szCb.init)->ent, (&szCb.init)->inst,
                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_msgfn.c"
