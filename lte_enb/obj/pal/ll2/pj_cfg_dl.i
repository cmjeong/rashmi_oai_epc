...
static S16 pjCfgFillPjDlRbCb ( PjCb *gCb, PjDlRbCb *rbCb, PjDlUeCb *ueCb, U8 isHo, UdxCfgEnt *cfgEnt, UdxCfmEnt *cfmEnt )
...
static S16 pjCfgUpdDlCompInfo ( PjCb *gCb, PjDlRbCb *rbCb, PjDlUeCb *ueCb, UdxHdrCompCfg *rohcCfg )




  ;
static U16 rohcProfId[9]= { 0x0001, 0x0002, 0x0003, 0x0004,
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd40001, L_DEBUG, cellId, ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 161   , "pjCfgAddRb- Received with -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;

   if( 0L == *ueCb)
   {

      if ( pjDbmCreateDlUeCb(gCb, ueId, cellId, ueCb) != 0)
      {

         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 2; }
                                          ;

         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40002,L_ERROR,DBG_UEID, ueId, cellId, 0, 0, 0,                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"         ,                                  173         , "CellId[%d] Creating DL UeCb Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;
         return(ret);
      }
   }
   ...
   { ret = 0; if (ueId == 0) { if (entCfg->rbId >= 10) { ret = 1; } } else { if ((entCfg->rbType != 0) && (entCfg->rbType != 1)) { ret = 1; } else if (entCfg->rbType == 0 &&entCfg->rbId >= 3) { ret = 1; } else if (entCfg->rbType == 1 &&entCfg->rbId >= 32) { ret = 1; } } };
   if ( 0 != ret)
   {
      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 17; }
                                   ;

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40003,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                                                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                                                       188      , "CellId[%u]:RbId[%d] - " "Invalid RB ID,RbCb Creation Failed ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                        ;
      return(ret);
   }


   { rbCb = (entCfg->rbType==0)?(*ueCb)->srbCb[entCfg->rbId]:(*ueCb)->drbCb[entCfg->rbId];};
   if (0L != rbCb)
   {
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40004,L_WARNING,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                               197      , "CellId [%u]:RbId[%d] already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;

      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 16; }
                                   ;

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40005,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                          203      , "RB Id already present-- cellId(%d), rbId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
      return(1);
   }
   else if (0L == rbCb)
   {
      ...
      rbCb = pjDbmCreateDlRbCb(gCb, entCfg->rbId, entCfg->rbType, *ueCb, 2);
      if(0L == rbCb)
      {

         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 1; }
                                           ;

         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40006,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"         ,                                             217         , "Failed to Create RB CB -- cellId(%d) rbId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;
         return(1);
      }
   }
   ...
   { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 1; entCfm->reason = 0; }
                           ;

   return(ret);
}
static S16 pjCfgFillPjDlRbCb
(
PjCb *gCb,
PjDlRbCb *pjRbCb,
PjDlUeCb *ueCb,
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40007,L_DEBUG,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, cfgEnt->rbId, cfgEnt->cfgType, 0,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   ,                                                    287   , "Received Fill Req cellId(%d), rbId(%d),cfgType(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   switch (cfgEnt->cfgType)
   {
      ...
      case 0x01:
         {
            ...
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40008,L_DEBUG,DBG_UEID, ueCb->key.ueId, pjRbCb->dir, pjRbCb->mode, 0, 0,                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"            ,                                                333            , "Received RB Req with -- Dir(%d), mode(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
            ...
            if (2 & pjRbCb->dir)
            {
               ...
               {
                  cmInitTimers(&pjRbCb->dlCb.discTmr,1);





                  tmrVal = (S16)(pjRbCb->dlCb.discTmrInt % (100
                        * gCb->pjGenCfg.timeRes));
                  pjRbCb->dlCb.discTmrInt = (S16)(pjRbCb->dlCb.discTmrInt /
                                            (100 * gCb->pjGenCfg.timeRes));
                  if(tmrVal)
                     pjRbCb->dlCb.discTmrInt +=1;

               }


               gCb->pjGenCfg.nmbDlBins = 255;
      ...
      case 0x02:
         {
            if(0x02 & cfgEnt->m.modCfg.bitFlag)
               pjRbCb->dlCb.cfmReqd = cfgEnt->m.modCfg.cfmReqd;



            if(1 == cfgEnt->m.modCfg.hdrCompCfg.hdrCompUsed)
            {
            ...
            if(1 & cfgEnt->m.modCfg.hoInfo.isHoPres)
            {


               if(2 & cfgEnt->m.modCfg.hoInfo.isHoPres)
               {
                  ...
                  { pjRbCb->dlCb.nxtTxSn = (U16)(cfgEnt->m.modCfg.hoInfo.dlCount % (1 << pjRbCb->snLen)); pjRbCb->dlCb.txHfn = (cfgEnt->m.modCfg.hoInfo.dlCount >> pjRbCb->snLen); }
                                                                     ;
               }
      ...
      default:
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40009,L_ERROR,DBG_CELLID, ueCb->key.cellId, cfgEnt->cfgType, 0, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"            ,                                    425            , "pjCfgFillRbCb Failed -- for the invalid cfgType(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd4000a, L_DEBUG, ueCb->key.cellId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 479   , "pjCfgReCfgRb - Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                           ;
   ...
   if( 0L == rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4000b,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                         487      , "CellId [%u]:RbId[%d] already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;

      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 6; }
                                      ;

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4000c,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                                        494      , "RB Cb is not present -- cellId(%d), rbId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   ret = pjCfgFillPjDlRbCb(gCb, rbCb, ueCb,0, entCfg , entCfm);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd4000d, L_DEBUG, ueCb->key.cellId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 551   , "pjCfgDelRb- Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                          ;
   ...
   if (0L == rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4000e,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                         560      , "CellId [%u]:RbId[%d] already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;

      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 3; }
                                        ;

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4000f,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                                        567      , "RB Cb is not found, Deletion Failed -- cellId(%d), rbId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if(0 != ret)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40010,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                                        581      , "RB Cb Deletion Failed -- cellId(%d), rbId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd40011, L_DEBUG, ueCb->key.cellId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 639   , "pjCfgReEstRb- Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                          ;
   ...
   if( 0L == rbCb )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40012,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                         647      , "CellId [%u]:RbId[%d] already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;

      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 6; }
                                      ;

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40013,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, 0, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                          654      , "Re-Est Failed : DL RB CB is not present -- cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (ueCb->libInfo.state != 2 )
   {
      ...
      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 23; }
                                       ;

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40014,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, 0, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                          669      , "Re-Est Failed : RB State is Not REEST -- cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40015,L_DEBUG,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, 0, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   ,                                          738   , "pjCfgDelUe- Received for -- cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                           ;


   pjDbmDelDlUeCb(gCb, ueCb, 0);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd40016, L_DEBUG, secCfg->cellId, secCfg->ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 789   , "pjCfgPrcSecCfg- Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40017,L_ERROR,DBG_CELLID, secCfg->cellId, secCfg->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                        798      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;

      { cfgCfm->ueId = secCfg->ueId; cfgCfm->cellId = secCfg->cellId; cfgCfm->transId = secCfg->transId; cfgCfm->status = 2; cfgCfm->reason = 7; }
                                                  ;
      return(ret);
   }
   ...
   cmMemcpy(&ueCb->secInfo.intInfo.intKey[0], &secCfg->secCfg.integInfo.intKey[0], 16);


   ueCb->secInfo.cipherInfo.algoType=secCfg->secCfg.cipherInfo.algoType;

   cmMemcpy(ueCb->secInfo.cipherInfo.cpKey,
         &secCfg->secCfg.cipherInfo.ctrlplnKey[0],16);

   cmMemcpy(ueCb->secInfo.cipherInfo.upKey,
         &secCfg->secCfg.cipherInfo.usrplnKey[0],16);


   ueCb->secInfo.secAct = 1;

   if(1 == secCfg->secCfg.isHo)
   {
      ueCb->secInfo.firstMsg = 0;
   }
   else
   {
      ueCb->secInfo.firstMsg = 1;
   }

   ueCb->secInfo.secCxt.cellId = secCfg->cellId;
   ueCb->secInfo.secCxt.ueId = secCfg->ueId;
   ueCb->secInfo.secCxt.dir = 1;

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40018,L_DEBUG,DBG_UEID, secCfg->ueId, secCfg->cellId, ueCb->secInfo.intInfo.algoType, ueCb->secInfo.cipherInfo.algoType, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   ,                                          840   , "Security Paramters stored in UE CB are -- cellId(%d)" "Integrity Algo(%ld), cipherAlgoType(%ld) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if(ueCb->secInfo.secAct)
   {
      ...
      if(0 != ret)
      {
         { cfgCfm->ueId = secCfg->ueId; cfgCfm->cellId = secCfg->cellId; cfgCfm->transId = secCfg->transId; cfgCfm->status = 2; cfgCfm->reason = 18; }
                                                           ;
      ...
      if(0 != ret)
      {
         { cfgCfm->ueId = secCfg->ueId; cfgCfm->cellId = secCfg->cellId; cfgCfm->transId = secCfg->transId; cfgCfm->status = 2; cfgCfm->reason = 19; }
                                                          ;
      ...
      if(0 != ret)
      {
         { cfgCfm->ueId = secCfg->ueId; cfgCfm->cellId = secCfg->cellId; cfgCfm->transId = secCfg->transId; cfgCfm->status = 2; cfgCfm->reason = 20; }
                                                          ;
   ...
   { cfgCfm->ueId = secCfg->ueId; cfgCfm->cellId = secCfg->cellId; cfgCfm->transId = secCfg->transId; cfgCfm->status = 1; cfgCfm->reason = 0; }
                                          ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd40019, L_DEBUG, ueInfo->cellId, ueInfo->ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 934   , "pjCfgUeIdChng- Recived for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
        ...
        (ueInfo->cellId == newUeInfo->cellId))
   {
      status->reason = 15;
      status->status = 2;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4001a,L_ERROR,DBG_CELLID, ueInfo->cellId, ueInfo->ueId, newUeInfo->ueId, 0, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                        942      , "Old UeId[%d] same as new UeId[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
      return(1);
   }
   ...
   if (ret == 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4001b,L_ERROR,DBG_CELLID, newUeInfo->cellId, newUeInfo->ueId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                           950      , "NewUeId[%d]:ueCb already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
      status->reason = 15;
      status->status = 2;
      return(1);
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4001c,L_ERROR,DBG_CELLID, ueInfo->cellId, ueInfo->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                        960      , "UeId [%d]: UeCb not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
      status->reason = 7;
      status->status = 2;
      return(1);
   ...
   ret = cmHashListDelete(&(gCb->u.dlCb->ueLstCp), (U32) ueCb);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4001d,L_ERROR,DBG_CELLID, ueInfo->cellId, ueInfo->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                        970      , "UeId[%u] HashList Deletion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
      status->reason = 2;
      status->status = 2;
      return(1);
   ...
   ret = cmHashListInsert(&(gCb->u.dlCb->ueLstCp), (U32)ueCb,
                            (U8 *)&(ueCb->key), (U16) sizeof(PjUeKey));

   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd4001e,L_ERROR,DBG_CELLID, newUeInfo->cellId, newUeInfo->ueId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                           986      , "UeId[%u] HashList Insertion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
      status->reason = 2;
      status->status = 2;
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd4001f, L_DEBUG, countReq->cellId, countReq->ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 1039   , "pjCfgPrcCount - Count Request Received for - cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                           ;
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40020,L_ERROR,DBG_CELLID, countCfm->cellId,countCfm->ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c",1050, "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for(numRb=0, idx=0; idx < 32 && numRb < 12; idx++)
   {
      rbCb = ueCb->drbCb[idx];
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd40021, L_DEBUG, staReq->cellId, staReq->ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 1132   , "pjCfgPrcSduSta - Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;


   udxSap = &(gCb->u.dlCb->udxDlSap[0]);
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&cfmInfo, (Size) sizeof (UdxSduStaCfmInfo), 0) != 0) { ret = 1; } }
                                     ;
   if(ret != 0)
   {
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40022,L_ERROR,DBG_CELLID, staReq->cellId,staReq->ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c",1160, "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      cfmInfo->status = 2;
      cfmInfo->reason = 7;
      cfmInfo->numRb = numRb;


      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40023,L_ERROR,DBG_UEID, staReq->ueId, staReq->cellId, 0, 0, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                        1168      , "UE Cb is not found -- cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   for(rbCnt=0, numRb=0; rbCnt < 32 && numRb < 12; rbCnt++)
   {
      ...
      staInfo->dlSduStaInfo.hoPres = 1;
      numRb++;
   }
   cfmInfo->numRb = numRb;
   cfmInfo->status = 0;
   cfmInfo->reason = 0;
   { if (ueCb->hoInfo->hoCfmInfo != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) ueCb->hoInfo->hoCfmInfo, (Size) (32 * sizeof(PjDlHoCfmInfo))); ueCb->hoInfo->hoCfmInfo = 0L; } }
                                                          ;
   { if (ueCb->hoInfo != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) ueCb->hoInfo, (Size) sizeof(PjDlHoInfo)); ueCb->hoInfo = 0L; } };

   PjDlUdxSduStaCfm(&gCb->u.dlCb->udxDlSap[0].pst,
                     gCb->u.dlCb->udxDlSap[0].suId, cfmInfo);
   return(0);
}
static S16 pjCfgUpdDlCompInfo
(
PjCb *gCb,
PjDlRbCb *rbCb,
PjDlUeCb *ueCb,
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd40024, L_DEBUG, rbCb->rbId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 1251   , "pjCfgUpdCompInfo - Received for -- cellId(%d),RbId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                     ;
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd40025, L_DEBUG, rbCb->rohc.profId, rbCb->rohc.maxCid, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 1286   , "pjCfgUpdCompInfo - Selected   -- profId(%d),maxCid(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                               ;
...

{
   ...
   if(0L != rbCb)
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40026,L_DEBUG,DBG_UEID, ueCb->key.ueId,rbCb->rbId, 0, 0, 0,                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                                                1339      , "Delete RB Req Received for -- rbId (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                 ;
      rbCb->ueCb = 0L;
      ...
      {
        { if (rbCb->dlCb.staRep != 0L) { SPutMsg(rbCb->dlCb.staRep); } rbCb->dlCb.staRep = 0L; };
      }
      ...
      pjDbmDelDlRbCb(gCb,rbCb->rbId, rbCb->rbType, &rbCb, 2,ueCb);
   }
   return(ret);
}
 S16 pjCfgDlReEstReq
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd40027, L_DEBUG, reEstReq->pdcpId.cellId, reEstReq->pdcpId.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"   , 1469   , "ReEst Req Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                ;
   ...
   if( 0 != ret || 0L == rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd40028,L_ERROR,DBG_UEID, rlcId.ueId, rlcId.cellId, rlcId.rbId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_dl.c"      ,                                    1477      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;

      { reEstCfm->ueId = reEstReq->pdcpId.ueId; reEstCfm->cellId = reEstReq->pdcpId.cellId; reEstCfm->transId = reEstReq->transId; reEstCfm->status = 2; }
                                               ;
      return(ret);
   }


   cmMemcpy(&rbCb->ueCb->secInfo.intInfo.intKey[0], &reEstReq->intKey[0], 16);
   cmMemcpy(&rbCb->ueCb->secInfo.cipherInfo.cpKey[0], &reEstReq->ctrlplnKey[0], 16);
   cmMemcpy(&rbCb->ueCb->secInfo.cipherInfo.upKey[0], &reEstReq->usrplnKey[0], 16);


   rbCb->ueCb->secInfo.secAct = 1;


   { reEstCfm->ueId = reEstReq->pdcpId.ueId; reEstCfm->cellId = reEstReq->pdcpId.cellId; reEstCfm->transId = reEstReq->transId; reEstCfm->status = 1; }
                                              ;
