...
extern NlCellPciType pciModType[4];

static S16 nlBuildCellReCfgPciList ( NlCellCb *cellCb, LnlCellReCfg *tmpReCfg, LnlCellReCfg *cellReCfg )
...
nlGlbStateMachine nlGlbCellFSM[NL_CELL_STATE_MAX][NL_CELL_EVENT_MAX] =
{
   ...
   {
      nlConflictNghCellCfgEvtHndlr,
      nlConflictCellReCfgEvtHndlr,
      nlProcessInvalidMsg,
      nlProcessInvalidMsg,
      nlProcessInvalidMsg,
      nlProcessInvalidMsg,
   ...
   {
      nlConfigNghCellCfgEvtHndlr,
      nlConfigCellReCfgEvtHndlr,
      nlConfigUeAddEvtHndlr,
      nlConfigUeDeleteEvtHndlr,
      nlConfigUeMeasRptEvtHndlr,
      nlConfigUeCqiRptEvtHndlr,
      nlConfigUeModEvtHndlr,
   },
   {
      nlPciModifyNghCellCfgEvtHndlr,
      nlPciModifyCellReCfgEvtHndlr,
      nlProcessInvalidMsg,
      nlProcessInvalidMsg,
      nlProcessInvalidMsg,
      nlProcessInvalidMsg,
...

{
 ...
 S16 nlPciModifyNghCellCfgEvtHndlr
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...

{
   ...
   NlNghCfgPendMsg *pendNghCfg = 0L;
   ;;

   nghCellCfg = (NlTmpNghCellCfg *)evtMsg->msg;


   { if (0 == SGetSBuf(nlCb.init.region, nlCb.init.pool, (Data **)(&pendNghCfg), (sizeof(NlNghCfgPendMsg))) ) { cmMemset((U8 *)(*(&pendNghCfg)), 0, (sizeof(NlNghCfgPendMsg))); } else { (*(&pendNghCfg)) = 0L; } };
   if(0L == pendNghCfg)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",168, "Failed to allocate memory for neighbor cfg during PCI Mod", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   cmMemcpy((U8 *)&pendNghCfg->nghCellCfg, (U8 *)nghCellCfg,
                sizeof(NlTmpNghCellCfg));
   pendNghCfg->link.node = (U32)pendNghCfg;
   cmLListAdd2Tail(&cellCb->pciModPendMsg.nghCfgMsgList, &pendNghCfg->link);
   return(0);
}
 S16 nlPciModifyCellReCfgEvtHndlr
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...
{
   LnlCellReCfg *cellReCfg = 0L;
   CmLList *link = 0L;
   NlCellReCfgPendMsg *reCfgPendMsg = 0L;
   ;;
   ...
   ((((link) = ((&cellCb->pciModPendMsg.cellReCfgMsgList)->crnt = (&cellCb->pciModPendMsg.cellReCfgMsgList)->first)) != 0L) ? (link)->node : 0L);
   if(0L == link)
   {
      { if (0 == SGetSBuf(nlCb.init.region, nlCb.init.pool, (Data **)(&reCfgPendMsg), (sizeof(NlCellReCfgPendMsg))) ) { cmMemset((U8 *)(*(&reCfgPendMsg)), 0, (sizeof(NlCellReCfgPendMsg))); } else { (*(&reCfgPendMsg)) = 0L; } };
      if(0L == reCfgPendMsg)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",226, "Failed to allocate memory for Cell re cfg during PCI Mod", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      cmMemcpy((U8 *)&reCfgPendMsg->cellReCfg, (U8 *)cellReCfg, sizeof(LnlCellReCfg));
      reCfgPendMsg->link.node = (U32)reCfgPendMsg;
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf70003, L_ERROR, nghCellCfg->nghEnbCellCfg[0].nghCellParam.cfgType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c"      , 286      , "Invalid ngh cell config type %d received", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                               ;
      return(1);
   }
   if(0 != nlCellSelectPrach(cellCb, evtMsg, &alarm))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70004, L_ERROR,                                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c"      ,                                                                  292      , "Failed to select prach configuration for serving cell", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                   ;
      return(1);
   }
   nlCellSelectPci(cellCb, nghCellCfg, evtMsg->msgType, &alarm);

   if(1 == alarm.isAlarmSend)
   {
   ...
   if(1 == cellCb->isSmSonCfgDone)
   {
      nlCellSelectTxPower(cellCb);
   }
   return(0);
}
 S16 nlConflictNghCellCfgEvtHndlr
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...

{
   ...
   if(NL_CELL_STATE_CONFIGURED == cellCb->state)
   {
      ...
      else if(0 == cellCb->isSmSonCfgDone)
      {
         cellCb->isSmSonCfgDone = 1;
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf70005, L_INFO, cellCb->cellInfo.pci, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c"         , 391         , "SON selected Serv cell PCI : %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
 ...
 S16 nlConfigNghCellCfgEvtHndlr
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...

{
   ...
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70006, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",452, "Distributed SON PCI selection is not enable", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(0);
   }
   ...
   if(NL_VENDOR_DSON_STATE_CONFIGURED != cellCb->dSonState)
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70007, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",509, "Sending REM result indication", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      nlBuildRemResultInd(cellCb);
   }

   return(0);
}
static S16 nlBuildCellReCfgPciList
(
NlCellCb *cellCb,
...
)
{
   ...
   if((1 == cellCb->cellInfo.isCsgPciCfg) &&
      (LNL_ENB_CLOSED_ACCESS == cellCb->cellInfo.accessMode))
   {
      ...
      if(numPci < 1)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70008, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",569, "No Valid PCI found for Cell ReCfg CSG PCI Range config", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      tmpReCfg->numPci = numPci;
   }
   else if(1 == cellCb->cellInfo.isSmallCellPciCfg)
   {
      for(count = 0; count < cellReCfg->numPci; count ++)
      {
      ...
      if(numPci < 1)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70009, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",599, "No Valid PCI found for Cell ReCfg  Small Cell PCI Range config", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      tmpReCfg->numPci = numPci;
   }
   else
   {
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf7000a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",627, "No Valid PCI found for Cell ReCfg  Cell PCI Range config", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
   }
   return(0);
}
 S16 nlConflictCellReCfgEvtHndlr
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...

{
   ...
   if(cellReCfg->numPci > 0)
   {
      ...
      if(0 != nlBuildCellReCfgPciList(cellCb, &tmpReCfg, cellReCfg))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf7000b, L_ERROR,                                                                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c"         ,                                                                              683         , "Failed to select PCI as per CSG and small cell range from PCI list", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                               ;
         return(1);
      }
      ...
      for(count = 0; count < 4; count ++)
      {
         ...
         {
            if((tmpReCfg.pciList[pciCount] <= 503)&&
               (tmpReCfg.pciList[pciCount] != cellCb->cellInfo.pci))
            {
               if(1 != nlValidatePciWithNghCellInfo(cellCb,
      ...
      if(0 != pciCollRes)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf7000c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",713, "Failed to Perform PCI mod for cell ReCfg in conflict state", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }

      nlStoreCellReCfgPciInfo(cellCb, &tmpReCfg, pciCount);
      nlSendPciUpdateInd(cellCb);
      if(0 == cellCb->isSmSonCfgDone)
      {
         cellCb->isSmSonCfgDone = 1;
         nlCellSelectTxPower(cellCb);
      }
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf7000d, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",728, "Empty PCI List received in cell reconfiguration", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   }
   return(1);
}
static S16 nlCellReCfgPciListHndlr
(
LnlCellReCfg *cellReCfg,
NlCellCb *cellCb
)
...

{
   ...
   if(cellReCfg->numPci > 504)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf7000e, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",771, "Invalid number of PCI received in Cell ReCfg", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   for(pciCount = 0; pciCount < cellReCfg->numPci; pciCount ++)
   {
      if((cellReCfg->pciList[pciCount] <= 503) &&
   ...
   if(0 != pciCollRes)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf7000f, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",818, "Failed to Perform PCI modification", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if(NL_PCI_SEL_DSON != nlCb.genCfg.pciSelType)
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70010, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",872, "Distributed SON PCI selection is not enable", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(0);
   }
   cellReCfg = (LnlCellReCfg *)evtMsg->msg;
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf70013, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_events.c",904, "Invalid PCI Recfg msg received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   return(0);
}
 S16 nlHandleCellSelectedTxPower
(
NlCellCb *cellCb
)
