...

{
   ...
   cellCb->txPowerSel.refSignalTxPwr = -127;
...

{
   ...
   switch(nlCb.genCfg.txPowerSelType)
   {
      case NL_TXPOWER_SEL_DISABLE :
      {
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0x1000001, L_INFO, cellCb->txPowerSel.refSignalTxPwr, cellCb->txPowerSel.pssPowerOffset, cellCb->txPowerSel.sssPowerOffset, cellCb->txPowerSel.pbchPowerOffset, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_txpower_sel.c"         , 183         , "SON selected RefSigTxPwr: %d pssPowerOffse:t %d sssPowerOffset: %d pbchPowerOffset: %d \n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      {
         { cellCb->state = NL_CELL_STATE_WAIT_TXPOWER_CFG; };
 ...
 S16 nlHdlPeriodicRemCellSrchRsp
(
...

{
   ...
   switch(nlCb.genCfg.txPowerSelType)
   {
      case NL_TXPOWER_SEL_DISABLE :
      {
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x1000002, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_txpower_sel.c",242, "TxPower Selection Disbaled, Drop message", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(0);
      }
      break;
      case NL_TXPOWER_SEL_DSON :
