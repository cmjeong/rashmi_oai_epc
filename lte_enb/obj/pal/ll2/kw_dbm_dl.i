...

{
   ...
   if(0 != cmHashListInit(&(gCb->u.dlCb->ueLstCp),
                            (U16) 128,
                            (U16) 0,
                            (Bool) 0,
                            (U16) 5,
                            ...
                            (gCb->init.pool)))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc10001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c",130, "UeLstCp Initialization Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }


   if(0 != cmHashListInit(&(gCb->u.dlCb->cellLstCp),
                            (U16) 10,
                            (U16) 0,
                            (Bool) 0,
                            (U16) 5,
                            ...
                            (gCb->init.pool)))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc10002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c",144, "CellLstCp Initialization Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   return(0);
}
...

{
   ...
   *rbCb= 0L;
   ...
   if (rlcId->ueId == 0)
   {
      ...
      if(rlcId->rbId >= 10)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc10003,L_ERROR,DBG_RBID, rlcId->rbId,10, rlcId->ueId, rlcId->cellId, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c"         ,                            268         , "Invalid RbId, Max is [%d] UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if(!cellCb)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc10004,L_ERROR,DBG_CELLID, rlcId->cellId, rlcId->ueId, rlcId->rbId, 0, 0,                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c"         ,                          278         , "CellCb not found UEID:%d RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   else
   {
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc10005,L_ERROR,DBG_RBID, rlcId->rbId, rlcId->rbType, rlcId->ueId, rlcId->cellId, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c"         ,                            293         , "Invalid RbId for RbType[%d] RBID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc10006,L_ERROR,DBG_CELLID, rlcId->cellId, rlcId->ueId, rlcId->rbId, 0, 0,                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c"         ,                          302         , "UeId [%d]: UeCb not found RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
 ...
 Void kwDbmFetchDlRbCbFromLchId
(
KwCb *gCb,
CmLteRnti ueId,
CmLteCellId cellId,
...
)
{
   ...
   if (ueId == 0)
   {
      ...
      if(!cellCb)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc10007,L_ERROR,DBG_CELLID, cellId,ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c",360, "CellCb not found UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return;
      }
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc10008,L_ERROR,DBG_CELLID, cellId,ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c",370, "UeId [%d]: UeCb not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return;
   }
   ...
   for (idx = 0; idx < numRbCb; idx++)
   {
      if (rbCbLst[idx] != 0L)
      {
         ...
         if( 2 == rbCbLst[idx]->mode)
         {
            ...
            { if (rbCbLst[idx] != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCbLst[idx], (Size) sizeof (KwDlRbCb)); rbCbLst[idx] = 0L; } };
         }
...

{
   ...
   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&*ueCb, (Size) sizeof(KwDlUeCb)) == 0) { cmMemset((U8 *)(*ueCb), 0, sizeof(KwDlUeCb)); } else { (*ueCb) = 0L; } };
   tUeCb = *ueCb;
   tUeCb->ueId = ueId;
   tUeCb->cellId = cellId;
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc10009,L_ERROR,DBG_CELLID, cellId, ueId, 0, 0, 0,                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c"      ,                505      , "UeId[%u] HashList Insertion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   return(cmHashListFind(&(gCb->u.dlCb->ueLstCp), (U8 *)&(ueId), sizeof(CmLteRnti), 0, (U32 *) ueCb))
...

{
   ...
   cmMemset((U8 *)(ueCb->lCh), 0, sizeof(KwDlLch) * 12);;


   kwDbmDelAllDlRb(gCb,ueCb->srbCb, 3);


   kwDbmDelAllDlRb(gCb,ueCb->drbCb, 32);


   if(0 != cmHashListDelete(&(gCb->u.dlCb->ueLstCp), (U32) ueCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc1000a,L_ERROR,DBG_CELLID, ueCb->cellId, ueCb->ueId, 0, 0, 0,                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c"      ,                      611      , "UeId[%u] HashList Insertion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   { if (ueCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) ueCb, (Size) sizeof(KwDlUeCb)); ueCb = 0L; } };

   return;
}
 Void kwDbmDelAllDlUe
(
KwCb *gCb
)
...

{
   ...
   while (0 == cmHashListGetNext(&(gCb->u.dlCb->ueLstCp),
                                   (U32) ueCb,
                                   (U32 *)&ueCb))
   {

      kwDbmDelDlUeCb(gCb,ueCb, 1);
...

{
   ...
   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&*cellCb, (Size) sizeof(KwDlCellCb)) == 0) { cmMemset((U8 *)(*cellCb), 0, sizeof(KwDlCellCb)); } else { (*cellCb) = 0L; } };
   tCellCb = *cellCb;
   tCellCb->cellId = cellId;

   if(0 != cmHashListInsert(&(gCb->u.dlCb->cellLstCp),
                              (U32) tCellCb,
                              (U8 *)&(tCellCb->cellId),
                              (U16) sizeof(CmLteCellId)))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc1000b,L_ERROR,DBG_CELLID, cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c",742, "HashList Insertion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   return(0);
}
 S16 kwDbmFetchDlCellCb
(
KwCb *gCb,
CmLteCellId cellId,
KwDlCellCb **cellCb
...

{
   ...
   *cellCb = 0L;
   ...
   if(0 != cmHashListFind(&(gCb->u.dlCb->cellLstCp),
                            (U8 *)&(cellId),
                            sizeof(CmLteCellId),
                            0,
                            (U32*) cellCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc1000c,L_ERROR,DBG_CELLID, cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c",791, "CellCb not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   return(0);
}
 Void kwDbmDelDlCellCb
(
KwCb *gCb,
KwDlCellCb *cellCb
)
...

{
   ...
   kwDbmDelAllDlRb(gCb,cellCb->rbCb, 10);


   if(0 != cmHashListDelete(&(gCb->u.dlCb->cellLstCp), (U32) cellCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc1000d,L_ERROR,DBG_CELLID, cellCb->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_dl.c",832, "HashList Deletion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   }


   { if (cellCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) cellCb, (Size) sizeof(KwDlCellCb)); cellCb = 0L; } };

   return;
}
 Void kwDbmDelAllDlCell
(
KwCb *gCb
)
...
{
   KwDlCellCb *cellCb = 0L;

   ;



   while (0 == cmHashListGetNext(&(gCb->u.dlCb->cellLstCp),
                                   (U32) cellCb,
                                   (U32 *)&cellCb))
   {
