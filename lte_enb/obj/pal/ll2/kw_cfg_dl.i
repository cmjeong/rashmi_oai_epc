...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0001,L_DEBUG,DBG_RBID, entCfg->rbId, rbCb->rlcId.ueId, rbCb->rlcId.cellId, entCfg->rbType, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"   ,                              355   , "kwCfgFillRbCb(ueId(%d),cellId(%d) rbType(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   switch (entCfg->entMode)
   {
      ...
      case 3:
      {
         ...
         rbCb->m.amDl.vtMs = 512;

         ueCb->lCh[rbCb->lch.lChId - 1].dlRbCb = rbCb;


         { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&rbCb->m.amDl.txBuf, (Size) ((512 << 1) * sizeof(KwTx*))) == 0) { cmMemset((U8 *)(rbCb->m.amDl.txBuf), 0, ((512 << 1) * sizeof(KwTx*))); } else { (rbCb->m.amDl.txBuf) = 0L; } }
                                                        ;
         break;
      }
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0002,L_ERROR,DBG_RBID, entCfg->rbId, rbCb->rlcId.ueId, rbCb->rlcId.cellId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                                    421         , "Invalid RB Mode ueId(%d),cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0003,L_ERROR,DBG_RBID, rbCb->rlcId.rbId, rbCb->mode, entCfg->entMode, rbCb->rlcId.ueId, rbCb->rlcId.cellId,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                              469      , "RB Mode Mismatch : exp [%d] rcv [%d] UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   switch (rbCb->mode)
   {
      ...
      case 2:
      {
         ...
         if (entCfg->lCh[0].type == 5)
         {
            return(5);
         }
         ueCb->lCh[rbCb->lch.lChId - 1].dlRbCb = 0L;
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0004,L_DEBUG,DBG_RBID, entCfg->rbId, cellId, ueId, entCfg->cfgType, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"   ,                               589   , "kwCfgAddRb(cellId(%d),UEID:%d cfgType(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (cellId == 0)
   {
      ...
      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 8; }
                                                  ;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0005,L_ERROR,DBG_RBID, entCfg->rbId, ueId, 0, 0, 0,                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                   598      , "Add DLRb,CellId is 0 for UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   {
         do { if (!((gCb->init.dbgMask & ((0x00000002 << 2) | ((0x00000002 << 4) << 5))) ^ ((0x00000002 << 2) | ((0x00000002 << 4) << 5)))) { { snprintf((gCb)->init.prntBuf, 255, "[%s]::", __func__); SPrint((gCb)->init.prntBuf); snprintf(gCb->init.prntBuf, 255,"kwCfgAddDlRb(ueId(%u), cellId(%u), Invalid rguSapId (%d)\n", ueId, cellId, entCfg->rguSapId); SPrint(gCb->init.prntBuf); }; } }while(0)
                                              ;
         return(1);
   }
   ...
   if (ueId == 0)
   {
      if(entCfg->rbId >= 10)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }

                                                   ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0006,L_ERROR,DBG_RBID, entCfg->rbId,10, cellId, ueId, 0,                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                      622         , "Invalid RbId ,Max is [%d] CELLID:%d UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
          ...
          (entCfg->entMode == 1))
      {
         ...
         if(cellCb)
         {
            ...
            if (( cellCb->rbCb[entCfg->rbId] != 0L))
            {

               { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 4; }

                                                         ;
               if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0007,L_WARNING,DBG_CELLID, cellId, entCfg->rbId, ueId, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"               ,                            645               , "RbId [%d] already exists UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         else
         {
            ...
            if ( 0 != kwDbmCreateDlCellCb(gCb,cellId, &cellCb))
            {

               { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 3; }

                                                                ;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0008,L_ERROR,DBG_CELLID, cellId, entCfg->rbId, ueId, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"               ,                            661               , "cellCb Creation failed RBID:%d UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0009,L_ERROR,DBG_LCID, entCfg->lCh[0].lChId, cellId, ueId, entCfg->rbId, 0,                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"            ,                                 673            , "Invalid LcId CELLID:%d UEID:%d RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }



                                  ;

            { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 18; }
                                                              ;
            return(1);
         }


         { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&kwRbCb, (Size) sizeof (KwDlRbCb)) == 0) { cmMemset((U8 *)(kwRbCb), 0, sizeof (KwDlRbCb)); } else { (kwRbCb) = 0L; } };
         if (!kwRbCb)
         {
            if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf000a,L_FATAL,DBG_UEID, ueId, entCfg->rbId, ueId, 0, 0,                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"            ,                         687            , "Memory allocation failed for rbId:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                          ;

            { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 1; }
                                                                            ;
            return(1);
         }
      ...
      {
         reason= (entCfg->entMode != 1)? 12:
                                                      5;

         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = reason; }
                                                     ;
         return(1);
      }
   }
   ...
   {
      if (!(((entCfg->rbType == 0 && entCfg->rbId < 3) || (entCfg->rbType == 1 && entCfg->rbId < 32))))
      {

         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                     ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf000b,L_ERROR,DBG_RBID, entCfg->rbId, entCfg->rbType, ueId, 0, 0,                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                      718         , "Invalid RbId for RbType[%d] UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
          ...
          (entCfg->entMode != 1))
      {
         ...
         if ( kwDbmFetchDlUeCb(gCb,ueId, cellId, &ueCb) == 0)
         {

            (kwRbCb) = ((entCfg->rbType) == 0) ? (ueCb)->srbCb[(entCfg->rbId)] : (ueCb)->drbCb[(entCfg->rbId)];;
            ...
            if(( kwRbCb != 0L))
            {
               ...
               { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 4; }
                                           ;
               if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf000c,L_WARNING,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"               ,                                    742               , "CellId[%u]:rbId [%d] already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         else
         {
            ...
            if ( kwDbmCreateDlUeCb(gCb,ueId, cellId, &ueCb) != 0)
            {

               { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 2; }
                                                ;
               if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf000d,L_WARNING,DBG_CELLID, cellId, ueId, entCfg->rbId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"               ,                                    757               , "UeId [%u]:ueCb Creation Failed RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                          ...
                          )
         {
            ...
            { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 1; }
                                                               ;
            if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf000e,L_FATAL,DBG_UEID, ueId, entCfg->rbId, cellId, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"            ,                           783            , "Memory allocation failed RBID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (kwCfgFillDlRbCb(gCb,kwRbCb, ueCb, entCfg) != 0)
   {
      ...
      { if (kwRbCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) kwRbCb, (Size) sizeof(KwDlRbCb)); kwRbCb = 0L; } };
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf000f,L_ERROR,DBG_RBID, entCfg->rbId, ueId, cellId, 0, 0,                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                     836      , "Filling of RbCb failed UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 1; entCfm->status.reason = 0; };
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0010,L_DEBUG,DBG_UEID, ueId, cellId, entCfg->cfgType, entCfg->rbId, 0,                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"   ,                                                915   , "kwCfgReCfgRb(cellId(%d), cfgType(%d)) RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (ueId == 0)
   {
      if(entCfg->rbId >= 10)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                                   ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0011,L_ERROR,DBG_RBID, entCfg->rbId,10, ueId, cellId, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                        930         , "Invalid RbId , Max is [%d] UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if(!cellCb)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 8; }
                                                     ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0012,L_ERROR,DBG_CELLID, cellId, ueId, entCfg->rbId, cellId, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                        944         , "CellCb not found ueId:%d RBID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (!rbCb)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                     ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0013,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              959         , "CELLID:%d RBID:%d not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (ret != 0)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = ret; }



                                 ;

         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0014,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              982         , "CELLID:%u RBID:%d updation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   else
   {
      if (!(((entCfg->rbType == 0 && entCfg->rbId < 3) || (entCfg->rbType == 1 && entCfg->rbId < 32))))
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                     ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0015,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, entCfg->rbType, 0,                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                                999         , "CELLID:%d Invalid RBID:%d for RbType[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (ret != 0)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 7; }
                                                                    ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0016,L_ERROR,DBG_CELLID, cellId, ueId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              1012         , "UEID:%d UeCb not found RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if ( rbCb == 0L)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                     ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0017,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              1027         , "CELLID:%d RBID:%d not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (ret != 0)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = ret; }
                   ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0018,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              1046         , "CELLID:%d RBID:%d updation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0019,L_DEBUG,DBG_UEID, ueId, entCfg->rbId, cellId, entCfg->cfgType, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"   ,                           1119   , "kwCfgDelRb(RBID(%d), cellId(%d), cfgType(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (ueId == 0)
   {
      if(entCfg->rbId >= 10)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                                                    ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf001a,L_ERROR,DBG_RBID, entCfg->rbId,10, ueId, cellId, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                        1135         , "Invalid RbId, Max is [%d] UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (!cellCb)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                                                    ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf001b,L_ERROR,DBG_CELLID, cellId, ueId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              1148         , "CellCb not found UEID:%d RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      (kwRbCb) = (cellCb->rbCb)[(entCfg->rbId)];;
      ...
      if ( kwRbCb == 0L)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                                                    ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf001c,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              1163         , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      cellCb->rbCb[entCfg->rbId] = 0L;



      cellCb->lCh[kwRbCb->lch.lChId - 1].dlRbCb = 0L;
      { if (kwRbCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) kwRbCb, (Size) sizeof(KwDlRbCb)); kwRbCb = 0L; } };
   }
   ...
   else
   {
      if (!(((entCfg->rbType == 0 && entCfg->rbId < 3) || (entCfg->rbType == 1 && entCfg->rbId < 32))))
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                                                    ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf001d,L_ERROR,DBG_RBID, entCfg->rbId, entCfg->rbType, ueId, cellId, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                        1187         , "Invalid RbId for RbType[%d] UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (ret != 0)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 7; }
                                                                    ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf001e,L_ERROR,DBG_CELLID, cellId, ueId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              1201         , "UeId [%d]: UeCb not found RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if ( kwRbCb == 0L)
      {
         ...
         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                     ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf001f,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"         ,                              1216         , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      ueCb->lCh[kwRbCb->lch.lChId - 1].dlRbCb = 0L;
      ...
      if ( entCfg->rbType == 0 )
      {
         ueCb->srbCb[entCfg->rbId] = 0L;
      }
      else
      {
         ueCb->drbCb[entCfg->rbId] = 0L;
      }
   }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0020,L_DEBUG,DBG_RBID, entCfg->rbId, ueId, cellId, entCfg->cfgType, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"   ,                           1315   , "kwCfgReEstDlRb(ueId(%d), cellId(%d), cfgType(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (rbCb == 0L)
   {
      ...
      { entCfm->rbId = entCfg->rbId; entCfm->rbType = rlcId.rbType; entCfm->status.status = 2; entCfm->status.reason = 6; }
                                  ;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0021,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                           1332      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0022,L_DEBUG,DBG_RBID, entCfg->rbId, ueId, cellId, entCfg->cfgType, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"   ,                           1416   , "kwCfgDelUe(ueId(%d), cellId(%d), cfgType(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if ( ueId == 0 )
   {
      ...
      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 7; }
                                                 ;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0023,L_ERROR,DBG_RBID, entCfg->rbId, ueId, cellId, 0, 0,                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                     1429      , "ueId(%d), cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (ret != 0)
   {
      ...
      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 7; }
                                                ;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0024,L_ERROR,DBG_CELLID, cellId, ueId, entCfg->rbId, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                           1443      , "UEID:%d UeCb not found RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0025,L_DEBUG,DBG_RBID, entCfg->rbId, cellId, entCfg->cfgType, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"   ,                        1507   , "kwCfgDelCell( cellId(%d), cfgType(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if ( cellId == 0 )
   {
      ...
      { entCfm->rbId = rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 8; }
                                    ;
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0026,L_DEBUG,DBG_RBID, entCfg->rbId, cellId, 0, 0, 0,                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                     1521      , "cellId is 0 (%d) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (!cellCb)
   {
      ...
      { entCfm->rbId = rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 2; entCfm->status.reason = 8; }
                                    ;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0027,L_ERROR,DBG_CELLID, cellId, entCfg->rbId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                           1534      , "CellCb not found for RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   { entCfm->rbId = rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 1; entCfm->status.reason = 0; }
                                         ;
...

{
        ...
        (ueInfo->cellId == newUeInfo->cellId))
   {
      status->reason = 16;
      status->status = 2;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0028,L_ERROR,DBG_CELLID, ueInfo->cellId, ueInfo->ueId, newUeInfo->ueId, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                           1598      , "Old UeId[%d] same as new UeId[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if(0 == kwDbmFetchDlUeCb(gCb,newUeInfo->ueId, newUeInfo->cellId, &ueCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf0029,L_ERROR,DBG_CELLID, newUeInfo->cellId, newUeInfo->ueId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                           1606      , "NewUeId[%d]:ueCb already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if(0 != kwDbmFetchDlUeCb(gCb,ueInfo->ueId, ueInfo->cellId, &ueCb))
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf002a,L_ERROR,DBG_CELLID, ueInfo->cellId, ueInfo->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                        1617      , "UeId [%d]: UeCb not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if(0 != cmHashListDelete(&(gCb->u.dlCb->ueLstCp), (U32) ueCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf002b,L_ERROR,DBG_CELLID, ueInfo->cellId, ueInfo->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                        1630      , "UeId[%u] HashList Deletion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if(0 != cmHashListInsert(&(gCb->u.dlCb->ueLstCp),
                              (U32)ueCb, (U8 *)&(ueCb->ueId),
                              (U16) sizeof(CmLteRnti)))

   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbf002c,L_ERROR,DBG_CELLID, newUeInfo->cellId, newUeInfo->ueId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_cfg_dl.c"      ,                           1647      , "UeId[%u] HashList Insertion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
