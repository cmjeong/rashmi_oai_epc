...
private:
   ...
   U16 m_MaxNumOfQciBearersAllowed[4];


   U16 m_numOfQciBearersAdmitted[4];
                                       ...
                                       LrmCellConfigData &stCellCfg)
{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d0001, L_ERROR,m_enConfigMode, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",52, "Config mode [%d] is not in range", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return;
   }
   ...
   if(RM_MODE_TDD == m_bDuplexMode)
   {
      ...
      for(U32 idx = 0; idx < 4; idx++)
      {
         ...
         m_MaxNumOfQciBearersAllowed[idx] =
            (((numDlUEsPerTTI * totalNumDlSfs)) <= ((numUlUEsPerTTI * totalNumUlSfs)) ? ((numDlUEsPerTTI * totalNumDlSfs)) : ((numUlUEsPerTTI * totalNumUlSfs)))
                                                    ;


         m_MaxNumOfQciBearersAllowed[idx] = (m_MaxNumOfQciBearersAllowed[idx] -
                                    ((((m_MaxNumOfQciBearersAllowed[idx]*10)) + (100)/2) / (100)));
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d0002, L_INFO,m_MaxNumOfQciBearersAllowed[0], "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",124, "MAX QCI-1 bearers:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
}
                                                ...
                                                RrmRbcRspInfo & erabRbcRspInfo)
{
   ...
   U16 numOfQciBearersAdmitted[4];
   RrmErabAdmitted *pAcceptLst = erabRbcRspInfo.eRabAcceptedLst;
   RrmErabRejected *pRejectLst = erabRbcRspInfo.eRabRejectedLst;

   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x9d0003, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",139, "Checking admission of ERAB during ERAB setup", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   memcpy(numOfQciBearersAdmitted, m_numOfQciBearersAdmitted, 4 *
          sizeof(U16));
   ...
   for (U32 bRabIndex = 0; bRabIndex < stERAB.usNoErabsToAddMod; bRabIndex++)
   {
      ...
      if(!isValidQci(bQci))
      {
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x9d0004, L_INFO, bQci, stERabAddMod.bErabId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"         , 154         , "Invalid QCI [%d] ERAB[%d] for admission", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
      ...
      else
      {
         ...
         pAcceptLst[numErabsAdmitted++].bERabId = stERabAddMod.bErabId;
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d0005, L_INFO,stERabAddMod.bErabId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",223, "Allowing Non-GBR ERAB [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      }
   }


   memcpy(m_numOfQciBearersAdmitted, numOfQciBearersAdmitted, 4 *
          sizeof(U16));
                                              ...
                                              RmuUErabQosInfoIe &stRabQos)
{
   ...
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d0006, L_DEBUG, stRabQos.bErabQCI, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",245, "QCI %d bearer is admitted", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      m_numOfQciBearersAdmitted[RM_QCI_ONE-1]++;
      return(true);
   }
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d0007, L_DEBUG, stRabQos.bErabQCI, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",249, "QCI %d bearer is rejected", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x9d0008, L_DEBUG, m_numOfQciBearersAdmitted[RM_QCI_ONE-1], m_MaxNumOfQciBearersAllowed[RM_QCI_ONE-1], "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"   , 252   , "Since NoOf[%ld], maxNoOf[%ld] QCI-1 bearers", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ...
                                              RmuUErabQosInfoIe &stRabQos)
{
   ...
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d0009, L_DEBUG, stRabQos.bErabQCI, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",263, "QCI %d bearer is admitted", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      m_numOfQciBearersAdmitted[RM_QCI_TWO-1]++;
      return(true);
   }
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d000a, L_DEBUG, stRabQos.bErabQCI, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",267, "QCI %d bearer is rejected", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x9d000b, L_DEBUG, m_numOfQciBearersAdmitted[RM_QCI_TWO-1], m_MaxNumOfQciBearersAllowed[RM_QCI_TWO-1], "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"   , 270   , "Since NoOf[%ld], maxNoOf[%ld] QCI-2 bearers", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ...
                                              RmuUErabQosInfoIe &stRabQos)
{
   ...
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d000c, L_DEBUG, stRabQos.bErabQCI, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",281, "QCI %d bearer is admitted", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      m_numOfQciBearersAdmitted[RM_QCI_THREE-1]++;
      return(true);
   }
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d000d, L_DEBUG, stRabQos.bErabQCI, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",285, "QCI %d bearer is rejected", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x9d000e, L_DEBUG, m_numOfQciBearersAdmitted[RM_QCI_THREE-1], m_MaxNumOfQciBearersAllowed[RM_QCI_THREE-1], "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"   , 288   , "Since NoOf[%ld], maxNoOf[%ld] QCI-3 bearers", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ...
                                              RmuUErabQosInfoIe &stRabQos)
{
   ...
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d000f, L_DEBUG, stRabQos.bErabQCI, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",299, "QCI %d bearer is admitted", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      m_numOfQciBearersAdmitted[RM_QCI_FOUR-1]++;
      return(true);
   }
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9d0010, L_DEBUG, stRabQos.bErabQCI, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",303, "QCI %d bearer is rejected", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x9d0011, L_DEBUG, m_numOfQciBearersAdmitted[RM_QCI_FOUR-1], m_MaxNumOfQciBearersAllowed[RM_QCI_FOUR-1], "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"   , 306   , "Since NoOf[%ld], maxNoOf[%ld] QCI-4 bearers", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                 ...
                                                 RrmRbcRspInfo & erabRbcRspInfo)
{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x9d0012, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp",331, "Checking admission of ERAB during ERAB modification", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for (U32 bRabIndex = 0; bRabIndex < stERAB.usNoErabsToAddMod; bRabIndex++)
   {
      ...
      if(
        __null 
             == pObjOldERab)
      {
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9d0013,L_INFO,DBG_CRNTI, pUE->getCRNTI(), bErabId, 0, 0, 0,                                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"         ,                                                         347         , "Invalid ERAB [%d] for admission", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                          ;
      ...
      if(!isValidQci(bQci))
      {
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9d0014,L_INFO,DBG_CRNTI, pUE->getCRNTI(), bQci, 0, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"         ,                                                  362         , "Invalid QCI for admission [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                   ;
      ...
      {
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0x9d0015, L_DEBUG, bErabId, pObjOldERab->getQci(), bQci, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"         , 388         , "Non-GBR to GBR or vice versa is not allowed for ERAB" "moficiation ERAB ID [%d], oldQci:%d, newQci:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      else
      {
         ...
         pAcceptLst[numErabsAdmitted++].bERabId = stERabAddMod.bErabId;
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9d0016,L_INFO,DBG_CRNTI, pUE->getCRNTI(),stERabAddMod.bErabId, 0, 0, 0,                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_qcibasedadmissioncontroller.cpp"         ,                                                                460         , "Allowing Non-GBR ERAB [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                 ;
      }
   }
