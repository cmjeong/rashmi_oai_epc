...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xcd0001, L_DEBUG, spId, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",148, "spId(%d), suId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   switch(ckwSap->state)
   {
      ...
      case 4:
      {
         ...
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xcd0002, L_DEBUG, ckwSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",166, "KwUiCkwBndReq: state (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
      }
      case 2:
      {
         ...
         if (ckwSap->pst.dstProcId != pst->srcProcId ||
             ...
             ckwSap->suId != suId)
         {
            { kwLmmSendAlarm(tKwCb,2, (256 + 3), 13, spId, 0); }


                                                      ;

            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xcd0003, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",183, "CKW SAP already Bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            KwUiCkwBndCfm(&(ckwSap->pst), ckwSap->suId, 2);
            return(1);
         }
         break;
      }
   ...
   KwUiCkwBndCfm(&(ckwSap->pst), ckwSap->suId, 1);
   return(0);
}
 S16 KwUiCkwUbndReq
(
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xcd0004, L_DEBUG, spId, reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"   , 255   , "spId(%d), reason(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                       ;

   (reason=reason);
   tKwCb->u.ulCb->ckwSap.state = 1;
   return(0);
}
 S16 KwUiCkwCfgReq
(
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xcd0005, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",320, "spId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   { if((&(tKwCb->u.ulCb->ckwSap))->state != 2) { ; { kwLmmSendAlarm(tKwCb,2, 1, 9, 0, 0); }; ret = 1; } };
   if (ret != 0)
   {
      { if (cfg != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) cfg, (Size) sizeof(CkwCfgInfo)); cfg = 0L; } };
      return(1);
   }

   { if (SGetSBuf(tKwCb->init.region, tKwCb->init.pool, (Data **)&cfgTmpData, (Size) sizeof (KwUlCfgTmpData)) == 0) { cmMemset((U8 *)(cfgTmpData), 0, sizeof (KwUlCfgTmpData)); } else { (cfgTmpData) = 0L; } };
   ...
   cfgTmpData->uprLyrTransId = cfg->transId;
   cfgTmpData->transId = ++transCount;
   cfg->transId = cfgTmpData->transId;
   cfgTmpData->cfgInfo = cfg;

   if (kwDbmAddUlTransaction(tKwCb, cfgTmpData) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xcd0006, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",346, "Addition to UL transId Lst Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (cfg != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) cfg, (Size) sizeof(CkwCfgInfo)); cfg = 0L; } };
   ...
   KwUlUdxCfgReq(&((tKwCb->u.ulCb->udxUlSap)->pst),(tKwCb->u.ulCb->udxUlSap)->spId,cfg);

   return(0);
}
 S16 KwUiCkwUeIdChgReq
(
Pst *pst,
SpId spId,
U32 transId,
...
)
{
   ...
   do
   {
      ...
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcd0007,L_DEBUG,DBG_CELLID, newUeInfo->cellId, spId, transId, 0, 0,                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"      ,                          417      , "KwUiCkwUeIdChgReq(pst, spId(%d), transId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xcd0008, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",438, "Addition to UL transId Lst Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
   }while(0);
   ...
   if(ret)
   {
      ...
      { if (newUeInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) newUeInfo, (Size) sizeof(CkwUeInfo)); newUeInfo = 0L; } };
      { if (ueInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) ueInfo, (Size) sizeof(CkwUeInfo)); ueInfo = 0L; } };
   ...
   if(0 != kwCfgValidateUeIdChng(tKwCb,ueInfo,newUeInfo,cfgTmpData))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcd0009,L_ERROR,DBG_CELLID, cfgTmpData->ueInfo->cellId, 0, 0, 0, 0,                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"      ,                                                463      , "Validation Failure for UeId change", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                 ;
   }

   KwUlUdxUeIdChgReq(&((tKwCb->u.ulCb->udxUlSap)->pst),
                     (tKwCb->u.ulCb->udxUlSap)->spId,
                     transId,
                     ueInfo,
                     newUeInfo);
...

{
   ...
   {
      cfgTmpData->cfgEntData[idx].entUlCfgCfm.status.status = 1;
      ...
      switch(cfg->entCfg[idx].cfgType)
      {
         ...
         case 3:
         {
            ...
            if(cfg->entCfg[idx].dir & 1)
            {

               if(0 != kwCfgValidateUlRb(gCb,
                                           &cfg->entCfg[idx],
                                           &cfgTmpData->cfgEntData[idx],
                                           cfgTmpData))
               {
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcd000a,L_ERROR,DBG_UEID, cfgTmpData->ueId, cfg->cellId, cfg->entCfg[idx].rbId, 0, 0,                                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"                  ,                                                          530                  , "CELLID [%u]:Validation Failure for UL RB [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                           ;
                  cfgTmpData->cfgEntData[idx].entUlCfgCfm.status.status = 2;
         ...
         case 4:
         {
            if(cfg->entCfg[idx].dir & 1)
            {
               if(0 != kwCfgValidateReEstRb(gCb,
                                              cfg->ueId,
                                              cfg->cellId,
                                              &cfg->entCfg[idx],
                                              &cfgTmpData->cfgEntData[idx]))
               {
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcd000b,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->entCfg[idx].rbId, 0, 0,                                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"                  ,                                                         562                  , "CellID [%u]:Validation Failure for Reest UL RB [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 5 :
         {
            if(0 != kwCfgValidateDelUlUe(gCb,
                                           &cfg->entCfg[idx],
                                           &cfgTmpData->cfgEntData[idx],
                                           cfgTmpData))
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcd000c,L_ERROR,DBG_CELLID, cfg->cellId, cfgTmpData->ueId, 0, 0, 0,                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"               ,                                     592               , "UL UEID [%d]:Validation Failure", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 6 :
         {
            if(0 != kwCfgValidateDelUlCell(gCb,
                                             cfg->cellId,
                                             &cfg->entCfg[idx],
                                             &cfgTmpData->cfgEntData[idx],
                                             cfgTmpData))
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcd000d,L_ERROR,DBG_CELLID, cfg->cellId, 0, 0, 0, 0,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"               ,                                                     608               , "Del UL Cell Validation Failure", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
               cfgTmpData->cfgEntData[idx].entUlCfgCfm.status.status = 2;
...

{
   ...
   tKwCb = kwCb[pst->dstInst];
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xcd000e, L_DEBUG, spId, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",670, "KwUiKwuBndReq(pst, spId(%d), suId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   kwuSap = (tKwCb->genCfg.rlcMode == 1) ?
   ...
   switch(kwuSap->state)
   {
      ...
      case 4:
      {
         ...
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xcd000f, L_DEBUG, kwuSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",703, "KwUiKwuBndReq: state (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
      }
      case 2:
      {
         ...
         if (kwuSap->pst.dstProcId != pst->srcProcId ||
             ...
             kwuSap->suId != suId)
         {
            { kwLmmSendAlarm(tKwCb,2, (256 + 2), 13, spId, 0); }


                                                      ;
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xcd0010, L_ERROR, tKwCb->genCfg.rlcMode, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"            , 719            , "RLC Mode [%d] : KWU SAP already Bound", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                        ;
            KwUiKwuBndCfm(&(kwuSap->pst), kwuSap->suId, 2);
            return(1);
         }
         break;
      }
   ...
   KwUiKwuBndCfm(&(kwuSap->pst), kwuSap->suId, 1);
   return(0);
}
 S16 KwUiKwuUbndReq
(
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xcd0011, L_DEBUG, spId, reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"   , 795   , "spId(%d), reason(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   { if(kwuSap->state != 2) { ; { kwLmmSendAlarm(tKwCb,2, 1, 9, 0, 0); }; ret = 1; } };
   if (ret != 0)
   {
   ...
   if(!rbCb)
   {
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcd0012,L_WARNING,DBG_UEID, datReq->rlcId.ueId, datReq->rlcId.cellId, datReq->rlcId.rbId, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c"      ,                                                   874      , "CellId[%u]:DL RbId [%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
      { if (mBuf != 0L) { SPutMsg(mBuf); } mBuf = 0L; };
   ...
   switch (rbCb->mode)
   {
      case 1:
      {
         ...
         if (pst->srcEnt != 0xd9)
         {
            ...
            { if (datReq != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) datReq, (Size) sizeof(KwuDatReqInfo), 0); datReq = 0L; } }
                                              ;
            { if (mBuf != 0L) { SPutMsg(mBuf); } mBuf = 0L; };
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xcd0013, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_uim.c",920, "Invalid RB Mode", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
      }
   }
   return(ret);
}
 S16 KwUiKwuDiscSduReq
(
Pst *pst,
SpId spId,
...

{
   ...
   { if (discSdu != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) discSdu, (Size) sizeof(KwuDiscSduInfo), 0); discSdu = 0L; } };
   return(0);
}
