...

{
   ...
   if(0 != cmHashListInit(&(gCb->u.ulCb->ueLstCp),
                            (U16) 128,
                            (U16) 0,
                            (Bool) 0,
                            (U16) 5,
                            ...
                            (gCb->init.pool)))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc20001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",107, "UeLstCp Initialization Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }


   if(0 != cmHashListInit(&(gCb->u.ulCb->cellLstCp),
                            (U16) 10,
                            (U16) 0,
                            (Bool) 0,
                            (U16) 5,
                            ...
                            (gCb->init.pool)))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc20002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",121, "CellLstCp Initialization Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if(0 != cmHashListInit(&(gCb->u.ulCb->transIdLstCp),
                            (U16) 10,
                            (U16) 0,
                            (Bool) 0,
                            (U16) 5,
                            ...
                            (gCb->init.pool)))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc20003, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",135, "transIdLstCp Initialization Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   *rbCb= 0L;
   ...
   if (rlcId->ueId == 0)
   {
      ...
      if(rlcId->rbId >= 10)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc20004,L_ERROR,DBG_RBID, rlcId->rbId, rlcId->cellId, rlcId->ueId, 10, 0,                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c"         ,                                 228         , "Invalid RbId, cellId:%d UEID:%d Max is [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if(!cellCb)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc20005,L_ERROR,DBG_CELLID, rlcId->cellId, rlcId->rbId, rlcId->ueId, 0, 0,                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c"         ,                          238         , "CellCb not found RBID:%d UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   else
   {
      ...
      if (!(((rlcId->rbType == 0 && rlcId->rbId < 3) || (rlcId->rbType == 1 && rlcId->rbId < 32))))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc20006,L_ERROR,DBG_RBID, rlcId->rbId, rlcId->rbType, rlcId->cellId, rlcId->ueId, 0,                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c"         ,                          254         , "Invalid RbId for RbType[%d] CELLID:%d UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (kwDbmFetchUlUeCb(gCb,rlcId->ueId, rlcId->cellId, &ueCb) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc20007,L_ERROR,DBG_CELLID, rlcId->cellId, rlcId->ueId, rlcId->rbId, 0, 0,                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c"         ,                          263         , "UeId [%d]: UeCb not found RBID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      (*rbCb) = ((rlcId->rbType) == 0) ? (ueCb)->srbCb[(rlcId->rbId)] : (ueCb)->drbCb[(rlcId->rbId)];;
   }
   return;
}
 Void kwDbmFetchUlRbCbFromLchId
(
KwCb *gCb,
CmLteRnti ueId,
CmLteCellId cellId,
...
)
{
   ...
   *rbCb = 0L;
   ...
   if (ueId == 0)
   {
      ...
      if(!cellCb)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc20008,L_ERROR,DBG_CELLID, cellId,ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",322, "CellCb not found UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return;
      }
   ...
   if (kwDbmFetchUlUeCb(gCb,ueId, cellId, &ueCb) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc20009,L_ERROR,DBG_CELLID, cellId,ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",332, "UeId [%d]: UeCb not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return;
   }
...

{
   ...
   for (idx = 0; idx < numRbCb; idx++)
   {
      if (rbCbLst[idx] != 0L)
      {
         ...
         if( 2 == rbCbLst[idx]->mode )
         {
            kwUmmFreeUlRbCb(gCb,rbCbLst[idx]);
         }
         else if(3 == rbCbLst[idx]->mode)
         {
            kwAmmFreeUlRbCb(gCb,rbCbLst[idx]);
         }

         { if (rbCbLst[idx] != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCbLst[idx], (Size) sizeof (KwUlRbCb)); rbCbLst[idx] = 0L; } };
      }
   }
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc2000a,L_ERROR,DBG_CELLID, cellId, ueId, 0, 0, 0,                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c"      ,                442      , "UeId[%u] HashList Insertion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xc2000b, L_DEBUG, cfg->transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",482, "(transId(%ld)", RLOG_FILE_ID, RLOG_MODULE_NAME); };




   return(cmHashListInsert(&(gCb->u.ulCb->transIdLstCp), (U32)cfg, (U8 *)&(cfg->transId), (U16) sizeof(cfg->transId)))


                                                         ;
}
 S16 kwDbmFindUlTransaction
(
KwCb *gCb,
U32 transId,
KwUlCfgTmpData **cfg
...

{
   ...
   if(0 != cmHashListFind(&(gCb->u.ulCb->transIdLstCp),
                            (U8 *) &transId,
                            sizeof (transId),
                            0,(U32 *) cfg))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xc2000c, L_ERROR,transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",531, "TransId [%ld] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   return(0);
}
 S16 kwDbmDelUlTransaction
(
KwCb *gCb,
KwUlCfgTmpData *cfg
)
...

{
   ...
   if(cmHashListDelete(&(gCb->u.ulCb->transIdLstCp),(U32) (cfg)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc2000d, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",571, "HashList Deletion failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   return(0);
}
 S16 kwDbmDelAllUlTransactions
(
KwCb *gCb
)
...

{
   ...
   while (0 == cmHashListGetNext(&(gCb->u.ulCb->transIdLstCp),
                                   (U32) cfg,
                                   (U32 *)&cfg))
   {
      if(kwDbmDelUlTransaction(gCb, cfg) != 0)
      {
         return(1);
      }
...

{
   ...
   return(cmHashListFind(&(gCb->u.ulCb->ueLstCp), (U8 *)&(ueId), sizeof(CmLteRnti), 0, (U32 *) ueCb))
...

{
   ...
   cmMemset((U8 *)(ueCb->lCh), 0, sizeof(KwUlLch) * 12);;


   kwDbmDelAllUlRb(gCb,ueCb->srbCb, 3);


   kwDbmDelAllUlRb(gCb,ueCb->drbCb, 32);


   if(0 != cmHashListDelete(&(gCb->u.ulCb->ueLstCp), (U32) ueCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc2000e,L_ERROR,DBG_UEID, ueCb->ueId, ueCb->cellId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c"      ,                        715      , "HashList Deletion Failed cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   { if (ueCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) ueCb, (Size) sizeof(KwUlUeCb)); ueCb = 0L; } };

   return;
}
 Void kwDbmDelAllUlUe
(
KwCb *gCb
)
...

{
   ...
   while (0 == cmHashListGetNext(&(gCb->u.ulCb->ueLstCp),
                                   (U32) ueCb,
                                   (U32 *)&ueCb))
   {
      kwDbmDelUlUeCb(gCb,ueCb, 1);
...

{
   ...
   if(0 != cmHashListInsert(&(gCb->u.ulCb->cellLstCp),
                              (U32) tCellCb,
                              (U8 *)&(tCellCb->cellId),
                              (U16) sizeof(CmLteCellId)))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc2000f,L_ERROR,DBG_CELLID, tCellCb->cellId, 0, 0, 0, 0,                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c"      ,                                       809      , "HashList Insertion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                        ;
      return(1);
   }
...

{
   ...
   *cellCb = 0L;
   if(0 != cmHashListFind(&(gCb->u.ulCb->cellLstCp),
                            (U8 *)&(cellId),sizeof(CmLteCellId),
                            0, (U32*) cellCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc20010,L_ERROR,DBG_CELLID, cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c",855, "CellCb not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   }

   return;
}
 Void kwDbmDelUlCellCb
(
KwCb *gCb,
KwUlCellCb *cellCb
)
...

{
   ...
   kwDbmDelAllUlRb(gCb,cellCb->rbCb, 10);


   if(0 != cmHashListDelete(&(gCb->u.ulCb->cellLstCp), (U32) cellCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc20011,L_ERROR,DBG_CELLID, cellCb->cellId, 0, 0, 0, 0,                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_dbm_ul.c"      ,                                      896      , "HashList Deletion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
   }

   { if (cellCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) cellCb, (Size) sizeof(KwUlCellCb)); cellCb = 0L; } };
...
{
   KwUlCellCb *cellCb = 0L;

   ;



   while (0 == cmHashListGetNext(&(gCb->u.ulCb->cellLstCp),
                                   (U32) cellCb,
                                   (U32 *)&cellCb))
   {
