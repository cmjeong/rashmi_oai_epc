...

{
   ...
   if ( (spId > egCb.genCfg.nmbUSaps || spId < 0) ||
        (!egCb.egtSapLst) ||
        ( (uSapCb = egCb.egtSapLst[spId]) == 0L))
   {

      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c", 191, 0x4, ((0 + 0) + 333), 0, (Txt *)"EgUiEgtBndReq: invalid spId");;
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",201); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if (uSapCb->state == 2)
   {
      ...
      EgUiEgtBndCfm(&uSapCb->pst, suId, 1);





      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",219); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   uSapCb->suId = suId;
   ...
   egSendLmAlarm(2, 11, (256 + 1), &sta.dgn);




   EgUiEgtBndCfm(&uSapCb->pst, suId, 1);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",293); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 EgUiEgtUbndReq
(
Pst *pst,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",336); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   (pst=pst);
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000002)) { snprintf((&(egCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->procId, (&(egCb.init))->ent, (&(egCb.init))->inst,
                                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c"
   ,
                                                                                370
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtUbndReq: Unbind request from suId(%d), reason(%d)", spId, reason); SPrint((&(egCb.init))->prntBuf); } }
                                                                                 ;
   ...
   if ( (spId > egCb.genCfg.nmbUSaps || spId < 0) ||
    ...
    ( (uSapCb = egCb.egtSapLst[spId]) == 0L))
   {
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c", 381, 0x4, ((0 + 0) + 335), 0, (Txt *)"EgUiEgtUbndReq: invalid spId");;
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",391); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if (uSapCb->state == 3 || uSapCb->state == 1)
   {
      ...
      uSapCb->state = 3;
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",405); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   ...
   if(uSapCb->cfg.flag == 1)
   {
      ...
      if ( (retValue = egMiRmvEchoCb(uSapCb, 0L, 0L, 0L, 1)) != 0)
      {
         SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c", 416, 0x4, ((0 + 0) + 336), 0, (Txt *)"EgUiEgtUbndReq: Failed to process the IpCb");;
         sta.dgn.dgnVal[0].type = 1;
         sta.dgn.dgnVal[0].t.sapId = spId;
   ...
   egSendLmAlarm(2, 19, (256 + 2), &sta.dgn);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",475); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 EgUiEgtEguDatReq
(
Pst *pst,
SpId spId,
EgtUEvnt *egtUEvnt
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",515); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",596); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 EgUiEgtEguLclTnlMgmtReq
(
Pst *pst,
SpId spId,
EgtUEvnt *egtUEvnt
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",634); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   if ( (spId > egCb.genCfg.nmbUSaps || spId < 0) ||
        (!egCb.egtSapLst) ||
        ((uSapCb = egCb.egtSapLst[spId]) == 0L) ||
        (uSapCb->state != 2))
   {
      ...
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c", 672, 0x4, ((0 + 0) + 363), 0, (Txt *)"EgUiEgtEguTnlMgmtReq: Invalid spId");;

      sta.dgn.dgnVal[0].type = 1;
      sta.dgn.dgnVal[0].t.sapId = spId;

      { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",677); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};



      egSendLmAlarm(2, 1, 3, &sta.dgn);

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",683); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",697); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 EgUiEgtEguStaReq
(
Pst *pst,
SpId spId,
EgtUEvnt *egtUEvnt
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",733); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   if ( (spId > egCb.genCfg.nmbUSaps || spId < 0) ||
        (!egCb.egtSapLst) ||
        ((uSapCb = egCb.egtSapLst[spId]) == 0L) ||
        (uSapCb->state != 2))
   {
      ...
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c", 771, 0x4, ((0 + 0) + 366), 0, (Txt *)"EgUiEgtEguStaReq: Invalid spId");;

      sta.dgn.dgnVal[0].type = 1;
      sta.dgn.dgnVal[0].t.sapId = spId;

      { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",776); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",783); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ui.c",795); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
