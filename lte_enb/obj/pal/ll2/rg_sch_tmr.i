...

{
   ...
   switch (tmrEvnt)
   {
      case 1:
         ...
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xaf0001,L_ERROR,DBG_INSTID, cell->instIdx, 0, 0, 0, 0,                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_tmr.c"         ,                                  131         , "Hit AckNackRep timer", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;
         break;
      case 2:
      ...
      default:
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xaf0002,L_ERROR,DBG_INSTID, cell->instIdx, 0, 0, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_tmr.c"         ,                                                      185         , "rgSCHTmrStartTmr() Incorrect Timer event", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
         return;
   }
...

{
   ...
   switch (tmrEvnt)
   {
      ...
      default:
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xaf0003,L_ERROR,DBG_INSTID, cell->instIdx, 0, 0, 0, 0,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_tmr.c"         ,                                                     311         , "rgSCHTmrStopTmr() Incorrect Timer event", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
         return;
   }
...

{
   ...
   switch (tmrEvnt)
   {
      ...
      default:
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xaf0004,L_ERROR,DBG_INSTID, ue->cell->instIdx, 0, 0, 0, 0,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_tmr.c"         ,                                                     426         , "rgSCHTmrProcTmr() Incorrect Timer event", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
         return;
   }
   return;
