...
extern S16 pjUtlChekTxEnqReq ( PjCb *gCb, PjDlRbCb *pjRbCb, PjTxEnt *txEnt);

static S16 pjDlmBldPdu(PjCb *gCb,PjDlRbCb *pjRbCb,PjTxEnt *txEnt);
static Void pjDlmDelTxEntUptoFms (PjCb *gCb, PjDlRbCb *pjRbCb, U32 fms, PjuDatCfmInfo *datCfm);
static Void pjDlmDelTxEntUptoFms
(
PjCb *gCb,
PjDlRbCb *pjRbCb,
U32 fms,
...

{
   ...
   { count = pjRbCb->dlCb.txHfn << (pjRbCb->snLen); count |= fms; };

   ((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt = (&pjRbCb->dlCb.txBuf.datCfmQ)->first);
   while (((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt))
   {
     txEnt = (PjTxEnt *) ((((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt))->node);
     if (txEnt != 0L)
     {
        if (txEnt->count < count)
        {
           if (pjRbCb->dlCb.cfmReqd)
           {
              ...
              if(datCfm->numSdus < 1024)
              {
                 datCfm->cfmSta[datCfm->numSdus].sduId = txEnt->sduId;
                 datCfm->cfmSta[datCfm->numSdus].status = 0;
                 datCfm->numSdus++;
              }
           }
     ...
     ((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt = ((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt ? (&pjRbCb->dlCb.txBuf.datCfmQ)->crnt->next : (&pjRbCb->dlCb.txBuf.datCfmQ)->first));
   }
...
)
{
   ...
   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&txEnt, (Size) sizeof(PjTxEnt)) == 0) { cmMemset((U8 *)(txEnt), 0, sizeof(PjTxEnt)); } else { (txEnt) = 0L; } };
   { count = txHfn << (pjRbCb->snLen); count |= sn; };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10001,L_DEBUG,DBG_RBID, pjRbCb->rbId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",319, "pjDlmRbDataResume(pjRbCb ()) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   ((&pjRbCb->dlCb.txBuf.reEstPktQ)->crnt = (&pjRbCb->dlCb.txBuf.reEstPktQ)->first);
   while (((&pjRbCb->dlCb.txBuf.reEstPktQ)->crnt))
   {
      txEnt = (PjTxEnt *) ((((&pjRbCb->dlCb.txBuf.reEstPktQ)->crnt))->node);
         if ( txEnt->pdu != txEnt->sdu )
         {
            { if (txEnt->pdu != 0L) { SPutMsg(txEnt->pdu); } txEnt->pdu = 0L; };
         }
         else
         {
            txEnt->pdu = 0L;
         ...
         if ( ret != 0 )
         {
             if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10002,L_ERROR,DBG_RBID, pjRbCb->rbId, 0, 0, 0, 0,                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c"             ,                                                            370             , "pjDlmRbDataResume: pjDlmProcDrb Failed ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                             ;
         }
      ((&pjRbCb->dlCb.txBuf.reEstPktQ)->crnt = (&pjRbCb->dlCb.txBuf.reEstPktQ)->first);
   }
...

{
   ...
   { Data _liByte; U16 _bytes; _bytes = 0; while (numBytes > _bytes ) { _liByte = (U8) (hdr >> (8*_bytes)); ret = SAddPreMsg((Data )_liByte, txEnt->pdu); if ( ret != 0 ) { break; } _bytes++; } };
   return(ret);
}
 Void pjDlmReEstSrb
(
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10003,L_DEBUG,DBG_RBID, pjRbCb->rbId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",606, "pjDlmResetSrb(pjRbCb ()) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   pjDbmTxDelAll(gCb, &(pjRbCb->dlCb.txBuf));


   { pjRbCb->dlCb.nxtTxSn = 0; pjRbCb->dlCb.txHfn = 0; pjRbCb->dlCb.cfmExp = 0; pjRbCb->dlCb.count = 0; };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10004,L_DEBUG,DBG_RBID, pjRbCb->rbId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",668, "pjDlmReEstDrbUm(pjRbCb ()) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ret = 0;
   newCount = 0;
   txEnt = 0L;
   datQ = 0L;
   ...
   { tmpTxBuf.datQ = pjRbCb->dlCb.txBuf.datQ; tmpTxBuf.numEntries = pjRbCb->dlCb.txBuf.numEntries; tmpTxBuf.numBins = pjRbCb->dlCb.txBuf.numBins; tmpTxBuf.sduSubmitQ = pjRbCb->dlCb.txBuf.sduSubmitQ; pjDbmDlBufInit(gCb,&pjRbCb->dlCb.txBuf,gCb->pjGenCfg.nmbDlBins); if ( pjRbCb->dlCb.txBuf.datQ == 0L ) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf10005, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",690, "PJ_CREATE_NEW_LIST: PJ_ALLOC Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; ret = 1; } };
   datQ = tmpTxBuf.datQ;

   ((&tmpTxBuf.sduSubmitQ)->crnt = (&tmpTxBuf.sduSubmitQ)->first);
   while (((&tmpTxBuf.sduSubmitQ)->crnt))
   {
      U8 hashKey = 0;
      txEnt = (PjTxEnt *) ((((&tmpTxBuf.sduSubmitQ)->crnt))->node);



      if ( txEnt != 0L )
      {
         hashKey = (U8)(txEnt->count % 255);
         { pjRbCb->dlCb.count = pjRbCb->dlCb.txHfn << (pjRbCb->snLen); pjRbCb->dlCb.count |= pjRbCb->dlCb.nxtTxSn; };
         { PjDlCb *_dlCb; _dlCb = &pjRbCb->dlCb; txEnt->sn = _dlCb->nxtTxSn; txEnt->txHfn = _dlCb->txHfn; if ( (++_dlCb->nxtTxSn) == pjRbCb->maxTxSn) { _dlCb->txHfn++; _dlCb->nxtTxSn = 0; } };
         txEnt->state = 0x01;
         txEnt->pdu = 0L;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10006,L_DEBUG,DBG_RBID, pjRbCb->rbId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",785, "pjDlmReEstDrbAm(pjRbCb ()) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   while (((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt))
   {
      ...
      txEnt->datCfmEnt.node = 0L;
      cmLListDelFrm(&pjRbCb->dlCb.txBuf.datCfmQ, &txEnt->datCfmEnt);
      ((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt = (&pjRbCb->dlCb.txBuf.datCfmQ)->first);
   }

   ((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt = (&pjRbCb->dlCb.txBuf.sduSubmitQ)->first);
   while (((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt))
   {
      txEnt = (PjTxEnt *) ((((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt))->node);
      if (txEnt != 0L)
      {
         txEnt->reEstPktEnt.node = (U32)txEnt;
         cmLListAdd2Tail(&pjRbCb->dlCb.txBuf.reEstPktQ, &txEnt->reEstPktEnt);
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10007,L_ERROR,DBG_RBID, pjRbCb->rbId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",830, "This should not be hit ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
      }
   }
...

{
   ...
   if ( (pjRbCb->dlCb.cfmReqd) || (1 == cfmType))
   {
      ...
      if (pjRbCb->rbType == 0)
         pjuSap = &(gCb->u.dlCb->pjuSap[0]);
      else
         pjuSap = &(gCb->u.dlCb->pjuSap[1]);
      ...
      for ( cnt = 0; cnt < pjDatCfm->numSdu; cnt++)
      {
         ...
         if ( txEnt != 0L )
         {
            ...
            if (0 != cfmType)
            {
               datCfm->cfmSta[datCfmCnt].status = 1;
            }
            else
            {
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10008,L_DEBUG,DBG_RBID, pjRbCb->rbId,fms, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",1025, "pjDlmHndlStaRep(pjRbCb (), fms (%u), staPdu) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if (staPdu != 0L) { SPutMsg(staPdu); } staPdu = 0L; };

   return(ret);
}
 S16 pjDlmReEstHoDrbAm
(
PjCb *gCb,
PjDlRbCb *pjRbCb
)
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10009,L_DEBUG,DBG_RBID, pjRbCb->rbId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",1152, "pjDlmReEstHoDrbAm(pjRbCb ()) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   pjRbCb->pktAdmitCnt = 0;
   pjRbCb->ueCb->hoInfo->hoCfmInfo[pjRbCb->rbId].pres = 1;
   pjRbCb->ueCb->hoInfo->hoCfmInfo[pjRbCb->rbId].rbId = pjRbCb->rbId;
   pjRbCb->ueCb->hoInfo->hoCfmInfo[pjRbCb->rbId].dir = 2;
   pjRbCb->ueCb->hoInfo->hoCfmInfo[pjRbCb->rbId].count = pjRbCb->dlCb.count + 1;

   return(0);
}
 S16 pjDlmStartDataFrwdPerRb
(
PjCb *gCb,
PjDlRbCb *pjRbCb
)
...

{
   ...
   PjTxEnt *txEnt = 0L;
   PjuDatFwdIndInfo *datFwdInd = 0L;
   PjPjuSapCb *pjuSap;
   PjDlPkt *pkt = 0L;

   ;

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf1000a,L_DEBUG,DBG_RBID, pjRbCb->rbId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",1209, "pjDlmStartDataFrwdPerRb(pjRbCb ()) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   ((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt = (&pjRbCb->dlCb.txBuf.datCfmQ)->first);
   ((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt = (&pjRbCb->dlCb.txBuf.sduSubmitQ)->first);
   ((&pjRbCb->dlCb.dlPktQ)->crnt = (&pjRbCb->dlCb.dlPktQ)->first);
...
while(numSduCnt >0)
{
            ...
            sizeof (PjuDatFwdIndInfo)) != 0)
   {
      ...
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf1000b, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",1268, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if(SGetSBuf(pjuSap->pst.region,pjuSap->pst.pool,(Data **)&datFwdInd->datFwdInfo,
            (sizeof(PjuDatFwdInfo) * numSduTx)) != 0)
   {

      { if (datFwdInd->datFwdInfo != 0L) { (Void) SPutSBuf(pjuSap->pst.region, pjuSap->pst.pool, (Data *) datFwdInd->datFwdInfo, (Size) numSdu * sizeof(PjuDatFwdIndInfo)); datFwdInd->datFwdInfo = 0L; } }
                                              ;
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf1000c, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",1278, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   while (numSduTx>0)
   {
      ...
      if(0L != ((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt))
      {
         txEnt = (PjTxEnt *) ((((&pjRbCb->dlCb.txBuf.datCfmQ)->crnt))->node);
      ...
      if(0L != ((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt))
      {
         txEnt = (PjTxEnt *) ((((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt))->node);
         datFwdInd->datFwdInfo[count].sduId = txEnt->sduId;
         datFwdInd->datFwdInfo[count].sn = txEnt->sn;
         ...
         ((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt = ((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt ? (&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt->next : (&pjRbCb->dlCb.txBuf.sduSubmitQ)->first));
         numSduTx--;
         count++;
         continue;
      }
      ...
      if(0L != ((&pjRbCb->dlCb.dlPktQ)->crnt))
      {
         pkt = (PjDlPkt *) ((((&pjRbCb->dlCb.dlPktQ)->crnt))->node);
         ...
         ((&pjRbCb->dlCb.dlPktQ)->crnt = ((&pjRbCb->dlCb.dlPktQ)->crnt ? (&pjRbCb->dlCb.dlPktQ)->crnt->next : (&pjRbCb->dlCb.dlPktQ)->first));
         numSduTx--;
         count++;
      }
          ...
          sizeof (PjuDatFwdIndInfo)) != 0)
   {
      ...
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf1000d, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",1374, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   datFwdInd->dir = 2;
   datFwdInd->numSdus = 0;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf1000e,L_DEBUG,DBG_RBID, pjRbCb->rbId, datFwdReq->numSdus, 0, 0, 0,                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c"   ,                                               1435   , "pjDlmHndlDatFwdReq(pjRbCb (),datFwdReq(%d)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                ;
   ...
   for ( numSdus = 0; numSdus < sduCount; numSdus++ )
   {
      ...
      { txEnt->count = txHfn << (pjRbCb->snLen); txEnt->count |= txEnt->sn; };
      pjDbmInsTxEnt(gCb, &(pjRbCb->dlCb.txBuf), txEnt);
...

{
   ...
   if ( ret != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf1000f,L_ERROR,DBG_RBID, pjRbCb->rbId, txEnt->sn, txEnt->txHfn, txEnt->count, 0,                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c"      ,                                               1558      , "PDCP DL Build PDU Failed SN [%u], HFN [%lu] , Count [%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                ;
      { U32 _count = txEnt->count + 1; if ( pjRbCb->dlCb.nxtToSub == txEnt->count ) { pjRbCb->dlCb.nxtToSub = _count; } if ( pjRbCb->dlCb.cfmExp == txEnt->count ) { pjRbCb->dlCb.cfmExp = _count; } };
      if ( pjRbCb->dlCb.cfmReqd)
      {
         { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.dlCb->pjuSap[0]); else _pjuSap = &(gCb->u.dlCb->pjuSap[1]); { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&_datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(_datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (_datCfm) = 0L; } }; { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&_pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(_pdcpId), 0, sizeof(CmLtePdcpId)); } else { (_pdcpId) = 0L; } }; if ( _datCfm != 0L && _pdcpId != 0L ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = 1; _datCfm->numSdus++; _pdcpId->rbId = pjRbCb->rbId; _pdcpId->rbType = pjRbCb->rbType; _pdcpId->ueId = pjRbCb->ueCb->key.ueId; _pdcpId->cellId = pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt(gCb, &(pjRbCb->dlCb.txBuf), txEnt->count); };
      }
      return(1);
   }
   txEnt->state = 0x05;
   ...
   while (((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt))
   {
      txFirstEntity = (PjTxEnt *) ((((&pjRbCb->dlCb.txBuf.sduSubmitQ)->crnt))->node);
      if (txFirstEntity->state == 0x05 )
      {
     ret1 =
         pjDlmSendDatReq(gCb, pjRbCb, txFirstEntity->count,
               txFirstEntity->pdu);
         gCb->pjGenSts.txPdus++;
         txFirstEntity->pdu = 0L;
         txFirstEntity->state = 0x06;

         txFirstEntity->sduSubmitEnt.node = (U32)0L;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10010,L_DEBUG,DBG_RBID, pjRbCb->rbId, txEnt->count, 0, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c"   ,                                          1670   , "pjDlmProcSrb(pjRbCb (), txEnt(%ld)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
   ...
   if ( pjRbCb->ueCb->secInfo.secAct && pjRbCb->ueCb->secInfo.intInfo.algoType != 0)
   {
      ...
      if ( ret != 0 )
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10011,L_ERROR,DBG_RBID, pjRbCb->rbId, txEnt->sn, txEnt->txHfn, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",1689, "Integrity Prot failed SN [%u] HFN [%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      }
   }
   else
   {
      ...
      { U16 _tmp; Data _pkArray[4]; _tmp = (U16) (((U32)(macI) >> 16) & 0xffffL); _pkArray[0] = (Data) (((U16)(_tmp) >> 8) & 0xff); _pkArray[1] = (Data) ((U16)(_tmp) & 0xff); _tmp = (U16) ((U32)(macI) & 0xffffL); _pkArray[2] = (Data) (((U16)(_tmp) >> 8) & 0xff); _pkArray[3] = (Data) ((U16)(_tmp) & 0xff); SAddPstMsgMult(_pkArray, (MsgLen) 4, pdu); };
...

{
   ...
   if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10012,L_UNUSED,DBG_RBID, pjRbCb->rbId, txEnt->count, 0, 0, 0,                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c"   ,                                                             1746   , "pjDlmProcDrb(pjRbCb (), txEnt(%ld)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                              ;
   ...
   return(pjDlmHdlCmp(gCb, pjRbCb, txEnt));
}
 S16 pjDlmHdlIntProt
(
PjCb *gCb,
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10013,L_DEBUG,DBG_RBID, pjRbCb->rbId, txEnt->count, 0, 0, 0,                                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c"   ,                                                                   1802   , "pjDlmHdlIntProt(pjRbCb (), txEnt (%ld)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                    ;
   ...
   if (pjRbCb->ueCb->secInfo.selSecAct == 1 &&
            pjRbCb->ueCb->secInfo.firstMsg == 1 )
   {
      pjRbCb->firstDlMsg = 1;
      pjRbCb->firstSn = txEnt->sn;
      pjRbCb->ueCb->secInfo.firstMsg = 0;
   }
   secInp.dir = 1;
   ...
   if ( ret != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf10014, L_ERROR, txEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",1857, "Integrity Protection Req failed Tx Count[%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { U32 _count = txEnt->count + 1; if ( pjRbCb->dlCb.nxtToSub == txEnt->count ) { pjRbCb->dlCb.nxtToSub = _count; } if ( pjRbCb->dlCb.cfmExp == txEnt->count ) { pjRbCb->dlCb.cfmExp = _count; } };
      if ( pjRbCb->dlCb.cfmReqd)
      {
         { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.dlCb->pjuSap[0]); else _pjuSap = &(gCb->u.dlCb->pjuSap[1]); { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&_datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(_datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (_datCfm) = 0L; } }; { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&_pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(_pdcpId), 0, sizeof(CmLtePdcpId)); } else { (_pdcpId) = 0L; } }; if ( _datCfm != 0L && _pdcpId != 0L ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = 5; _datCfm->numSdus++; _pdcpId->rbId = pjRbCb->rbId; _pdcpId->rbType = pjRbCb->rbType; _pdcpId->ueId = pjRbCb->ueCb->key.ueId; _pdcpId->cellId = pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt(gCb, &(pjRbCb->dlCb.txBuf), txEnt->count); };
      }
   ...
   if ( pjRbCb->firstDlMsg == 1 && pjRbCb->firstSn == txEnt->sn)
   {
      pjRbCb->firstDlMsg = 0;



    { if (txEnt->sdu != 0L) { SPutMsg(txEnt->sdu); } txEnt->sdu = 0L; };
...

{
   ...
   if (txEnt->pdu == 0L )
   {
      ...
      {
         ret =(SAddMsgRef((txEnt->sdu), (gCb->init.region), (gCb->init.pool), (&(txEnt->pdu))));
      }
      else
      {
         txEnt->pdu = txEnt->sdu;
...

{
   ...
   if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10015,L_UNUSED,DBG_RBID, pjRbCb->rbId, txEnt->count, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c"   ,                        2049   , "pjDlmHdlCmp(pjRbCb (), txEnt (%ld)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
   ...
   if ( pjRbCb->rohc.hdrCmpUsed )
   {
      ...
      if ( ret != 0 )
      {
         ...
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf10016, L_ERROR, txEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",2067, "Compression Req Failed Tx Count [%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { U32 _count = txEnt->count + 1; if ( pjRbCb->dlCb.nxtToSub == txEnt->count ) { pjRbCb->dlCb.nxtToSub = _count; } if ( pjRbCb->dlCb.cfmExp == txEnt->count ) { pjRbCb->dlCb.cfmExp = _count; } };
         if ( pjRbCb->dlCb.cfmReqd)
         {
            { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.dlCb->pjuSap[0]); else _pjuSap = &(gCb->u.dlCb->pjuSap[1]); { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&_datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(_datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (_datCfm) = 0L; } }; { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&_pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(_pdcpId), 0, sizeof(CmLtePdcpId)); } else { (_pdcpId) = 0L; } }; if ( _datCfm != 0L && _pdcpId != 0L ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = 4; _datCfm->numSdus++; _pdcpId->rbId = pjRbCb->rbId; _pdcpId->rbType = pjRbCb->rbType; _pdcpId->ueId = pjRbCb->ueCb->key.ueId; _pdcpId->cellId = pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt(gCb, &(pjRbCb->dlCb.txBuf), txEnt->count); };
         }
...

{
   ...
   if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf10017,L_UNUSED,DBG_RBID, pjRbCb->rbId, txEnt->count, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c"   ,                        2169   , "pjDlmHdlCiph(pjRbCb (), txEnt (%ld)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
...
txEnt->state = 0x04;
   ...
   if ( secInfo->secAct && secInfo->cipherInfo.algoType != 0)
   {
      if ( txEnt->pdu == 0L )
      {
         txEnt->pdu = txEnt->sdu;
      ...
      if ( ret != 0 )
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf10018, L_ERROR, txEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",2218, "Ciphering Req failed Tx Count [%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { U32 _count = txEnt->count + 1; if ( pjRbCb->dlCb.nxtToSub == txEnt->count ) { pjRbCb->dlCb.nxtToSub = _count; } if ( pjRbCb->dlCb.cfmExp == txEnt->count ) { pjRbCb->dlCb.cfmExp = _count; } };
         if ( pjRbCb->dlCb.cfmReqd)
         {
            { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.dlCb->pjuSap[0]); else _pjuSap = &(gCb->u.dlCb->pjuSap[1]); { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&_datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(_datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (_datCfm) = 0L; } }; { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&_pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(_pdcpId), 0, sizeof(CmLtePdcpId)); } else { (_pdcpId) = 0L; } }; if ( _datCfm != 0L && _pdcpId != 0L ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = 6; _datCfm->numSdus++; _pdcpId->rbId = pjRbCb->rbId; _pdcpId->rbType = pjRbCb->rbType; _pdcpId->ueId = pjRbCb->ueCb->key.ueId; _pdcpId->cellId = pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt(gCb, &(pjRbCb->dlCb.txBuf), txEnt->count); };
         }
 ...
 Void pjDlmEnqueueDlPkt
(
PjCb *gCb,
PjDlRbCb *pjRbCb,
U8 datType,
PjuDatFwdReqInfo *datFwd,
PjuSduId sduId,
Buffer *pdu
)
{
   ...
   if (datType == 1)
   {
      ...
      {
          { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&pkt, (Size) sizeof(PjDlPkt)) == 0) { cmMemset((U8 *)(pkt), 0, sizeof(PjDlPkt)); } else { (pkt) = 0L; } };
          if (pkt != 0L)
          {
             pkt->type = datType;
   ...
   else
   {
      ...
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf10019, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dlm.c",2408, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L; };
      }
   }

   return;
}
 Void pjDlmProcessDlPktQ
(
PjCb *gCb,
PjDlRbCb *pjRbCb
)
...

{
   ...
   ((((node) = ((&(pjRbCb->dlCb.dlPktQ))->crnt = (&(pjRbCb->dlCb.dlPktQ))->first)) != 0L) ? (node)->node : 0L);
   while (node != 0L)
   {
      ...
      { if (pkt != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) pkt, (Size) sizeof (PjDlPkt)); pkt = 0L; } };
      node = 0L;
      ((((node) = ((&(pjRbCb->dlCb.dlPktQ))->crnt = (&(pjRbCb->dlCb.dlPktQ))->first)) != 0L) ? (node)->node : 0L);
  }
