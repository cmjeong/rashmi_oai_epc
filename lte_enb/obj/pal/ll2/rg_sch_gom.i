...
static S16 rgSCHGomGetCellIdFrmCfgReq (RgrCfgReqInfo *rgrCfgReq, CmLteCellId *cellId)
                              ;
static S16 rgSCHGomCfgReq (Region reg, Pool pool, RgSchCb *instCb, SpId spId, RgrCfgTransId transId, RgrCfgReqInfo *cfgReqInfo)
                                                                      ;
...
)
{
   ...
   U8 action;
   U8 cfgType;
   action = cfgReqInfo->action;
   cfgType = cfgReqInfo->u.recfgInfo.recfgType;

   ;;

   if (cfgReqInfo->action != 2)
   {
   ...
   if((rgSCHGomGetCellIdFrmCfgReq(cfgReqInfo, &cellId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40001,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c",165, "Action.Config Type Error", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
      cfgReqInfo = 0L;

      rgSCHUtlRgrCfgCfm(instCb->rgSchInit.inst, spId, transId, cfmStatus, action, cfgType);
   ...
   if(0L != instCb->rgrSap[spId].cell)
   {
      if(cellId != instCb->rgrSap[spId].cell->cellId)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40002,L_ERROR,DBG_CELLID, cellId, instCb->rgrSap[spId].cell->cellId, spId, 0, 0,                                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"         ,                                                               182         , "Cell with Id %d already exists " "on sap %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                ;
      ...
      if (ret != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40003,L_ERROR,DBG_CELLID, cellId, 0, 0, 0, 0,                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"         ,                       200         , "rgSCHGomHndlCfg: Enqueuing CfgReq " "Failed ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                        ;
      ...
      case 1:
         {
            ...
            cfgType = cfgReqInfo->u.cfgInfo.cfgType;
      ...
      case 3:
         {
            ...
            cfgType = cfgReqInfo->u.delInfo.delType;

            break;
         }
      default:
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40004,L_ERROR,DBG_INSTID, inst, cfgReqInfo->action, 0, 0, 0,                                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                                              333            , "Invalid configuration " "action %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                               ;
            ret = 1;
         }
   }
...
)
{
   ...
   rgrCfgElem->cfgReqLstEnt.prev = 0L;
   rgrCfgElem->cfgReqLstEnt.next = 0L;
   rgrCfgElem->cfgReqLstEnt.node = (U32 )rgrCfgElem;


   if (((rgrCfgReq->action == 2) &&
            (rgrCfgReq->u.recfgInfo.recfgType == 1) &&
            (rgrCfgReq->u.recfgInfo.u.cellRecfg.recfgActvTime.pres == 1)))

   {
      ...
      if (actvTime.sfn >= 1024
            || actvTime.subframe >= 10)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40005,L_ERROR,DBG_CELLID, cell->cellId, actvTime.sfn, actvTime.subframe, cell->crntTime.sfn, cell->crntTime.subframe,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"         ,                                                      443         , "Invalid activation time for RGR " "config request: activation sfn %d activation subframe %d current " "sfn %d current subframe %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      sfDiff = (actvTime.sfn*10+actvTime.subframe) < (cell->crntTime.sfn*10+cell->crntTime.subframe)? ((actvTime.sfn+1024)*10+actvTime.subframe) - (cell->crntTime.sfn*10+cell->crntTime.subframe) : (actvTime.sfn*10+actvTime.subframe) - (cell->crntTime.sfn*10+cell->crntTime.subframe);

      if (sfDiff > (20 * 10))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40006,L_ERROR,DBG_CELLID, cell->cellId, actvTime.sfn, actvTime.subframe, cell->crntTime.sfn, cell->crntTime.subframe,                                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"         ,                                                                            457         , "Invalid activation time for RGR" " config request: activation sfn %d activation subframe %d " "current sfn %d current subframe %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   while ((cfgElem = rgSCHDbmGetNextCrntRgrCfgElem(cell, 0L)) != 0L)
   {
   ...
   while((cfgElem = rgSCHDbmGetPndngRgrCfgElemByKey(cell, cell->crntTime)) != 0L)
   {
   ...
   switch (cfg->cfgType)
   {
      case 1:
      {
         ret = rgSCHCfgVldtRgrCellCfg(inst, &cfg->u.cellCfg, cell, errInfo);
            if (ret != 0)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xa40007, L_ERROR, cfg->u.cellCfg.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"               , 604               , "Rgr Cell configuration " "validation FAILED: Cell %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                      ;
               return(1);
            }
      ...
      case 5:
      {
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xa40008, L_ERROR, cfg->u.ueCfg.crnti, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            , 617            , "Ue configuration validation" " FAILED: CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
            return(1);
         }
      ...
      case 3:
      {
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xa40009, L_ERROR, cfg->u.lchCfg.lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            , 629            , "LC configuration validation " "FAILED: LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
            return(1);
         }
      ...
      case 4:
      {
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xa4000a, L_ERROR, cfg->u.lcgCfg.ulInfo.lcgId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            , 641            , "LCG configuration validation " "FAILED: LCGID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                             ;
            return(1);
         }
      ...
      case 6:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { snprintf((&rgSchCb[inst].rgSchInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->procId, (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst,
                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"
            ,
                            653
            ); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "SCH ENB configuration validation " "FAILED: \n" ); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } }
                             ;
            return(1);
         }
...

{
   ...
   switch (recfg->recfgType)
   {
      case 1:
      {
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4000b,L_ERROR,DBG_CELLID, recfg->u.cellRecfg.cellId, 0, 0, 0, 0,                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                             812            , "Rgr Cell Recfg Validation " "FAILED", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                              ;
            return(1);
         }
      ...
      case 5:
      {
         ...
         if ( ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4000c,L_ERROR,DBG_CELLID, recfg->u.ueRecfg.cellId,recfg->u.ueRecfg.oldCrnti, 0, 0, 0,                                                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                                                              825            , "Ue Recfg Validation FAILED" "OLD CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                               ;
            return(1);
         }
      ...
      case 3:
      {
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4000d,L_ERROR,DBG_CELLID, recfg->u.lchRecfg.cellId,recfg->u.lchRecfg.lcId, 0, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                                                      838            , "Lc Recfg Validation FAILED" "LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
            return(1);
         }
      ...
      case 4:
      {
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4000e,L_ERROR,DBG_CELLID, recfg->u.lcgRecfg.cellId,recfg->u.lcgRecfg.ulRecfg.lcgId, 0, 0, 0,                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                                                                851            , "Lcg Recfg Validation FAILED" "LCGID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                 ;
            return(1);
         }
...

{
   ...
   errInfo->errType = ((((((0 + 1) + 4) + 1) + 7) + 1) + 3);


   ret = rgSCHCfgVldtRgrUeReset(inst, reset, cell, &ue, errInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4000f,L_ERROR,DBG_CELLID, reset->cellId,reset->crnti, 0, 0, 0,                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"      ,                                      921      , "Rgr UE Reset Validation FAILED" "CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40010,L_ERROR,DBG_CELLID, reset->cellId,reset->crnti, 0, 0, 0,                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"      ,                                      929      , "Rgr UE Reset FAILED" "CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
      return(1);
   }
...

{
   ...
   errInfo->errType = ((((((0 + 1) + 4) + 1) + 7) + 1) + 2);

   if(instCb->rgrSap[spId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40011,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c",988, "Cell doesnt exist", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   switch (del->delType)
   {
      case 1:
      {
         ...
         if(ret == 0)
         {
            ...
            U8 idx = (U8)((instCb->rgrSap[spId].cell->cellId - instCb->genCfg.startCellId)&(8 -1));
            instCb->cells[idx] = 0L;

            instCb->rgrSap[spId].cell = 0L;
            instCb->tfuSap[spId].cell = 0L;
         }
         break;
      }
      case 2:
...

{
   ...
   switch (rgrCfgReq->action)
   {
      case 2:
         {
            if (rgrCfgReq->u.recfgInfo.recfgType ==1)
            {
               *cellId = rgrCfgReq->u.recfgInfo.u.cellRecfg.cellId;
            }
            else if ((rgrCfgReq->u.recfgInfo.recfgType == 5) ||
                  (rgrCfgReq->u.recfgInfo.recfgType == 2))
            {
               *cellId = rgrCfgReq->u.recfgInfo.u.ueRecfg.cellId;
            }
            else if (rgrCfgReq->u.recfgInfo.recfgType == 3)
            {
               *cellId = rgrCfgReq->u.recfgInfo.u.lchRecfg.cellId;
            }
            else if (rgrCfgReq->u.recfgInfo.recfgType == 4)
            {
...
)
{
   ...
   if (((U8 *)cell == 0L) || (cell->cellId != cfgReqInfo->cellId))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40012,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"      ,               1185      , "Cell Control block does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                ;
      { if (0L != (cfgReqInfo->pdu)) { SPutMsg((cfgReqInfo->pdu)); cfgReqInfo->pdu = 0L; } };
      SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
      cfgReqInfo = 0L;
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40013,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"      ,                                  1198      , "Rgr SI configuration " "validation FAILED", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;
      { if (0L != (cfgReqInfo->pdu)) { SPutMsg((cfgReqInfo->pdu)); cfgReqInfo->pdu = 0L; } };
      SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
      cfgReqInfo = 0L;
   ...
   {
      if((cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si != 0L)&&
                      (cell->siCb.siArray[cfgReqInfo->siId-1].si != 0L))
      {
         cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si = 0L;
         { if (0L != (cell->siCb.siArray[cfgReqInfo->siId-1].si)) { SPutMsg((cell->siCb.siArray[cfgReqInfo->siId-1].si)); cell->siCb.siArray[cfgReqInfo->siId-1].si = 0L; } };
         cell->siCb.siArray[cfgReqInfo->siId-1].si = 0L;
         if(cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si != 0L)
         {
            { if (0L != (cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si)) { SPutMsg((cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si)); cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si = 0L; } };
            cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si = 0L;
         }
         SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
         cfgReqInfo = 0L;
         cfmStatus = 0x00;
   ...
   if ( RGR_SI_CFG_TYPE_MIB != cfgReqInfo->cfgType)
   {
      ...
      if ( tbSz != (msgLen*8) )
      {
         ...
         if ( SGetSBuf(reg,pool,&padding,nmPadBytes) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40014,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,                                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                                                         1259            , "Rgr SI configuration " "SGetSBuf failed for padding failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                          ;
            SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
            cfgReqInfo = 0L;
         ...
         if ( SAddPstMsgMult((Data*)padding,nmPadBytes,cfgReqInfo->pdu) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40015,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                                                  1275            , "Rgr SI configuration " "Failed to add padding bytes", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                   ;
            SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
            cfgReqInfo = 0L;
   ...
   switch(cfgReqInfo->cfgType)
   {
      case RGR_SI_CFG_TYPE_MIB:
         do{ if(0L == cell->siCb.crntSiInfo.mib) { cell->siCb.crntSiInfo.mib = cfgReqInfo->pdu; } else { if(0L != cell->siCb.newSiInfo.mib) { { if (0L != (cell->siCb.newSiInfo.mib)) { SPutMsg((cell->siCb.newSiInfo.mib)); cell->siCb.newSiInfo.mib = 0L; } }; cell->siCb.newSiInfo.mib = 0L; } cell->siCb.newSiInfo.mib = cfgReqInfo->pdu; cell->siCb.siBitMask |= (1<<1); }}while(0)
      ...
      case RGR_SI_CFG_TYPE_SIB1_PWS:
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40016,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                            1305            , "Failed to get MCS and NPRB" "value", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
            { if (0L != (cfgReqInfo->pdu)) { SPutMsg((cfgReqInfo->pdu)); cfgReqInfo->pdu = 0L; } };
            SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
            cfgReqInfo = 0L;
         ...
         do{ if(0L == cell->siCb.crntSiInfo.sib1Info.sib1) { cell->siCb.crntSiInfo.sib1Info.sib1 = cfgReqInfo->pdu; } else { if(0L != cell->siCb.newSiInfo.sib1Info.sib1) { { if (0L != (cell->siCb.newSiInfo.sib1Info.sib1)) { SPutMsg((cell->siCb.newSiInfo.sib1Info.sib1)); cell->siCb.newSiInfo.sib1Info.sib1 = 0L; } }; cell->siCb.newSiInfo.sib1Info.sib1 = 0L; } cell->siCb.newSiInfo.sib1Info.sib1 = cfgReqInfo->pdu; cell->siCb.siBitMask |= (1<<4); }}while(0)
      ...
      case RGR_SI_CFG_TYPE_SIB1:
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40017,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                            1326            , "Failed to get MCS and NPRB" "value", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
            { if (0L != (cfgReqInfo->pdu)) { SPutMsg((cfgReqInfo->pdu)); cfgReqInfo->pdu = 0L; } };
            SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
            cfgReqInfo = 0L;
         ...
         do{ if(0L == cell->siCb.crntSiInfo.sib1Info.sib1) { cell->siCb.crntSiInfo.sib1Info.sib1 = cfgReqInfo->pdu; } else { if(0L != cell->siCb.newSiInfo.sib1Info.sib1) { { if (0L != (cell->siCb.newSiInfo.sib1Info.sib1)) { SPutMsg((cell->siCb.newSiInfo.sib1Info.sib1)); cell->siCb.newSiInfo.sib1Info.sib1 = 0L; } }; cell->siCb.newSiInfo.sib1Info.sib1 = 0L; } cell->siCb.newSiInfo.sib1Info.sib1 = cfgReqInfo->pdu; cell->siCb.siBitMask |= (1<<2); }}while(0)
      ...
      case RGR_SI_CFG_TYPE_SI:
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40018,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                            1347            , "Failed to get MCS and NPRB" "value", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
            { if (0L != (cfgReqInfo->pdu)) { SPutMsg((cfgReqInfo->pdu)); cfgReqInfo->pdu = 0L; } };
            SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
            cfgReqInfo = 0L;
         ...
         if (cell->siCb.siBitMask & (1<<0))
         {
            ...
            if(*newSiPdu != 0L)
            {
               { if (0L != (*newSiPdu)) { SPutMsg((*newSiPdu)); *newSiPdu = 0L; } };
            }
         ...
         else
         {
            ...
            if (cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si == 0L)
            {
               ...
               cell->siCb.siArray[cfgReqInfo->siId-1].isWarningSi = 0;
               bitMask = 0;
            }
            else
            {
            ...
            do{ if(0L == cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si) { cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si = cfgReqInfo->pdu; } else { if(0L != cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si) { { if (0L != (cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si)) { SPutMsg((cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si)); cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si = 0L; } }; cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si = 0L; } cell->siCb.newSiInfo.siInfo[cfgReqInfo->siId-1].si = cfgReqInfo->pdu; cell->siCb.siBitMask |= bitMask; }}while(0)
      ...
      case RGR_SI_CFG_TYPE_SIB8_CDMA:
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40019,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"            ,                            1395            , "Failed to get MCS and NPRB" "value", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
            { if (0L != (cfgReqInfo->pdu)) { SPutMsg((cfgReqInfo->pdu)); cfgReqInfo->pdu = 0L; } };
            SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
            cfgReqInfo = 0L;
         ...
         cell->siCb.siArray[cfgReqInfo->siId-1].si = cfgReqInfo->pdu;
         do{ if(0L != cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si) { if (0L != (cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si)) { SPutMsg((cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si)); cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si = 0L; } }; cell->siCb.crntSiInfo.siInfo[cfgReqInfo->siId-1].si = cfgReqInfo->pdu; cfgReqInfo->pdu = 0L;}while(0)
                               ;
         cell->siCb.siArray[cfgReqInfo->siId-1].isWarningSi = 0;
         break;

      default:
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4001a,L_ERROR,DBG_CELLID, cfgReqInfo->cellId, 0, 0, 0, 0,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"         ,                                   1412         , "Invalid cfgType " "parameter value", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                    ;
         { if (0L != (cfgReqInfo->pdu)) { SPutMsg((cfgReqInfo->pdu)); cfgReqInfo->pdu = 0L; } };
...
)
{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4001b,L_ERROR,DBG_CELLID, warningSiCfgReqInfo->cellId,warningSiCfgReqInfo->siId, warningSiCfgReqInfo->cellId, 0, 0,                                                                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"      ,                                                                                         1494      , "Warning SI Cfg Failed for siId = %d" "warning cellID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                                          ;
   ...
   for(idx = 0; idx < 3; idx++)
   {
               ...
               cell->siCb.warningSi[idx].siId == warningSiCfgReqInfo->siId))
      {
         ...
         if (warningSiMsg->segLstCp.first == 0L)
         {
            warningSiMsg->transId = transId;
            pduNode = (RgSchWarningSiPdu *)&cell->siCb.warningSi[idx].
               warningSiMsg.pduNode;
            ((((node) = ((&warningSiCfgReqInfo->siPduLst)->crnt = (&warningSiCfgReqInfo->siPduLst)->first)) != 0L) ? (node)->node : 0L);
            j = 0;
...

            {
               ...
               if(pduNode[j].pdu != 0L)
               {
                        ...
                        (msgLen*8))
                  {
                     ...
                     , (S32)
                                              ...
                                              1541
                     , (ErrCls) (0x2), (ErrCode) (((0 + 0) + 11)), (ErrVal) ((ErrVal)msgLen), (Txt *) "rgSCHGomHndlWarningSiCfg():msgLen does not match                           any valid TB Size.")


                                               ;
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4001c,L_ERROR,DBG_CELLID, cell->cellId, warningSiCfgReqInfo->siId, 0, 0, 0,                                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"                     ,                                                                     1543                     , "Warning SI Cfg Failed" "for siId = %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                      ;
               ...
               pduNode[j].lnk.node = (U32)&pduNode[j];
               j++;
               node = node->next;
            }
            ...
            while(warningSiCfgReqInfo->siPduLst.first != 0L)
            {
   ...
   if (freeNodeFound == 0)
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4001d,L_DEBUG,DBG_CELLID, cell->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c",1589, "No SI Index is free", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      rgSCHUtlFreeWarningSiSeg(reg, pool, &warningSiCfgReqInfo->siPduLst);
      SPutSBuf(reg, pool, (Data *)warningSiCfgReqInfo,
            sizeof(RgrWarningSiCfgReqInfo));
      warningSiCfgReqInfo = 0L;
   ...
   for(idx = 0; idx < 3; idx++)
   {
      if(cell->siCb.warningSi[idx].siId == siId)
      {
                     ...
                     (U8 *)&transId, sizeof(RgrCfgTransId))) == 0)
         {
            ...
            ((((node) = ((&cell->siCb.warningSi[idx].warningSiMsg.segLstCp)->crnt = (&cell->siCb.warningSi[idx].warningSiMsg.segLstCp)->first)) != 0L) ? (node)->node : 0L);
            while(node != 0L)
            {
 ...
 )
{
   ...
   if (((U8 *)cell == 0L) || (cell->cellId != loadInfReq->cellId))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4001e,L_ERROR,DBG_CELLID, loadInfReq->cellId,loadInfReq->cellId, 0, 0, 0,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"      ,                                                    1795      , "Cell Control block does not exist" "for load cellId:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                     ;
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa4001f,L_ERROR,DBG_CELLID, cell->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c",1802, "rgSCHGomHndlLoadInf(): DSFR Feature not enabled", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      SPutSBuf(reg, pool, (Data *)loadInfReq, (Size)sizeof(*loadInfReq));
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa40020,L_ERROR,DBG_CELLID, cell->cellId, 0, 0, 0, 0,                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_gom.c"      ,                                  1811      , "Rgr LOAD INF Configuration " "validation FAILED", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;
      SPutSBuf(reg, pool, (Data *)loadInfReq, (Size)sizeof(*loadInfReq));
      return(1);
   }
   ...
   for(i = 0; i < 20; i++)
   {
      if((rgSchUpdtRNTPInfo(cell, cell->subFrms[i], loadInfReq) != 0))
      {
         return(1);
      }
   }
