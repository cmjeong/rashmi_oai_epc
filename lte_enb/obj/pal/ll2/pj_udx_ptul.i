...
static S16 PtUlUdxBndReq (Pst *post, SuId suId, SpId spId);
static S16 PtUlUdxUbndReq (Pst *post, SpId spId, Reason reason);
static S16 PtUlUdxCfgReq (Pst *post, SpId spId, UdxCfgReqInfo *pdCfgReq);
static S16 PtUlUdxUeIdChgReq (Pst *post, SpId spId,U32 transId, UdxUeInfo *oldUeInfo, UdxUeInfo *newUeInfo)

                                                          ;

static S16 PtUlUdxSecCfgReq (Pst *post, SpId spId, UdxSecCfgReqInfo *pdcpSecCfgReq)
                                                                    ;
static S16 PtUlUdxCountReq (Pst *post, SpId spId, UdxCountReqInfo *pdcpCountReq)
                                                                  ;
static S16 PtUlUdxReEstReq ( Pst *post, SpId spId, UdxReEstReqInfo *restbInfo)
                                                               ;
static S16 PtUlUdxSduStaReq ( Pst *post, SpId spId, UdxSduStaReqInfo *statReqInfo)
                                                                  ;

static S16 PtUlUdxUlStaRep ( Pst *post, SpId spId, UdxUlStaRepInfo *pdStaRep )



           ;
static S16 PtUlUdxDlStaRep ( Pst *post, SpId spId, UdxDlStaRepInfo *pdStaRep )



           ;

static S16 PtUlUdxUlFdbkPktInfo ( Pst *post, SpId spId, UdxUlFdbkPktInfo *fdbkPktInfo )



              ;

static S16 PtUlUdxDlFdbkPktInfo ( Pst *post, SpId spId, UdxDlFdbkPktInfo *fdbkPktInfo )



              ;
static S16 PtUlUdxDatResumeReq ( Pst *pst, UdxDatResumeInfo *udxDatResumeInfo )


           ;
static S16 PtUlUdxDatForwardReq ( Pst *pst, UdxDatForwardInfo *udxDatForwardInfo )


           ;
static const UdxBndReq PjUlUdxBndReqMt [3] =
{
...
static const UdxUbndReq PjUlUdxUbndReqMt [3] =
{
...
static const UdxCfgReq PjUlUdxCfgReqMt [3] =
{
...
static const UdxUlStaRep PjUlUdxUlStaRepMt [3] =
{
...
static const UdxDlStaRep PjUlUdxDlStaRepMt [3] =
{
...
static const UdxDlFdbkPkt PjUlUdxDlFdbkPktInfoMt [3] =
{



 PtUlUdxDlFdbkPktInfo,
...
static const UdxUlFdbkPkt PjUlUdxUlFdbkPktInfoMt [3] =
{



    PtUlUdxUlFdbkPktInfo,
...
static const UdxUeIdChgReq PjUlUdxUeIdChgReqMt [3] =
{
...
static const UdxSecCfgReq PjUlUdxSecCfgReqMt [3] =
{
...
static const UdxCountReq PjUlUdxCountReqMt [3] =
{
...
static const UdxSduStaReq PjUlUdxSduStaReqMt [3] =
{
...
static const UdxReEstReq PjUlUdxReEstReqMt [3] =
{
...
static const UdxDatResumeReq pjUlUdxDatResumeReqMt [3] =
{
...
static const UdxDatForwardReq pjUlUdxDatForwardReqMt [3] =
{



   PtUlUdxDatForwardReq,
...

{
   ...
   return((*PjUlUdxBndReqMt[post->selector])(post, suId, spId));
...

{
   ...
   return((*PjUlUdxUbndReqMt[post->selector])(post, spId, reason));
...

{
  ...
  return((*PjUlUdxCfgReqMt[post->selector])(post, spId, pdCfgReq));
...

{
  ...
  return((*PjUlUdxUlStaRepMt[pst->selector])(pst, spId, staRep));
...

{
  ...
  return((*PjUlUdxDlStaRepMt[pst->selector])(pst, spId, staRep));

}
 S16 PjUlUdxDlFdbkPktInfo
(
Pst *pst,
SpId spId,
UdxDlFdbkPktInfo *fdbk
)
...

{
  ...
  return((*PjUlUdxDlFdbkPktInfoMt[pst->selector])(pst, spId, fdbk));

}
 S16 PjUlUdxUlFdbkPktInfo
(
Pst *pst,
SpId spId,
...

{
    ...
    return((*PjUlUdxUlFdbkPktInfoMt[pst->selector])(pst, spId, fdbkPktInfo));

}
 S16 PjUlUdxUeIdChgReq
(
Pst *post,
SpId spId,
U32 transId,
...
)
{
  ...
  return((*PjUlUdxUeIdChgReqMt[post->selector])(post, spId, transId, (UdxUeInfo *)oldUeInfo, (UdxUeInfo *)newUeInfo ))
                                                             ;

}
 S16 PjUlUdxSecCfgReq
(
Pst *post,
SpId spId,
UdxSecCfgReqInfo *cpjSecConfigReqInfo
)
...

{
  ...
  return((*PjUlUdxSecCfgReqMt[post->selector])(post, spId, cpjSecConfigReqInfo))
                                                 ;
...

{
  ...
  return((*PjUlUdxCountReqMt[post->selector])(post, spId, pdcpCountReq));

}
 S16 PjUlUdxSduStaReq
(
Pst *post,
SpId spId,
UdxSduStaReqInfo *pdcpSduStaReq
)
...

{
  ...
  return((*PjUlUdxSduStaReqMt[post->selector])(post, spId, pdcpSduStaReq));
...

{
  ...
  return((*PjUlUdxReEstReqMt[post->selector])(post, spId, restbInfo));

}
 S16 PjUlUdxDatResumeReq
(
Pst* pst,
...

{
   ...
   return((*pjUlUdxDatResumeReqMt[pst->selector])(pst, udxDatResumeInfo));
}
 S16 PjUlUdxDatForwardReq
(
Pst* pst,
...

{
   ...
   return((*pjUlUdxDatForwardReqMt[pst->selector])(pst, udxDatForwardInfo));
}
...
static S16 PtUlUdxUlStaRep
(
Pst *post,
SpId spId,
UdxUlStaRepInfo *pdStaRep
)
...
static S16 PtUlUdxDlStaRep
(
Pst *post,
SpId spId,
UdxDlStaRepInfo *pdStaRep
)
...
static S16 PtUlUdxSduStaReq
(
Pst *post,
SpId spId,
UdxSduStaReqInfo *sduStaReq
)
...
static S16 PtUlUdxUlFdbkPktInfo
(
Pst *post,
SpId spId,
UdxUlFdbkPktInfo *fdbkPktInfo
...

{
    ...
    (post=post);
    (spId=spId);
    (fdbkPktInfo=fdbkPktInfo);


    return(0);

}
static S16 PtUlUdxDlFdbkPktInfo
(
Pst *post,
SpId spId,
...
static S16 PtUlUdxDatResumeReq
(
Pst* pst,
UdxDatResumeInfo *udxDatResumeInfo
)
...
static S16 PtUlUdxDatForwardReq
(
Pst* pst,
UdxDatForwardInfo *udxDatForwardInfo
)
