...

{
   ...
   if(pst->dstInst < 2)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90001,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",115, "Invalid inst ID", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(0);
   }
   ...
   switch(cfg->hdr.elmId.elmnt)
   {
      ...
      default:
         ret = 1;
         reason = 5;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90002,L_ERROR,DBG_INSTID, inst, cfg->hdr.elmId.elmnt, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",145, "Invalid Elmnt=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
   }
...

{
   ...
   if(rgSchCb[inst].rgSchInit.cfgDone != 1)
   {
      cfm.cfm.status = 1;
      cfm.cfm.reason = 8;
      cfm.hdr.elmId.elmnt = cntrl->hdr.elmId.elmnt;
      RgMiLrgSchCntrlCfm(&cfmPst, &cfm);
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90003,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",232, "Gen Cfg not done.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   switch(cntrl->hdr.elmId.elmnt)
   {
      ...
      default:
         ...
         cfm.cfm.reason = 13;
         RgMiLrgSchCntrlCfm(&cfmPst, &cfm);
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90004,L_ERROR,DBG_INSTID, inst, cntrl->hdr.elmId.elmnt, 0, 0, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"         ,                                        252         , "invalid elmnt=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
         break;
   }
...

{
   ...
   tmpPst.srcInst = rgSchCb[instId].rgSchInit.inst + 2;
   tmpPst.event = 0x00;
   ...
   if(spId < rgSchCb[instId].numSaps)
   {
      ...
      switch (rgSchCb[instId].rgrSap[spId].sapSta.sapState)
      {
         ...
         case 1:
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb90005, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",601, "SAP Not yet bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            rgSchCb[instId].rgrSap[spId].sapSta.sapState = 2;
            rgSchCb[instId].rgrSap[spId].sapCfg.suId = suId;

            ret = rgSCHUtlRgrBndCfm(instId, suId, 1);

            rgSCHUtlFillDgnParams(instId, &dgn, 1);
            ret = rgSCHLmmStaInd(instId, 2,
                  (256 + 2), 0, &dgn);
            break;
         case 2:
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb90006, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",612, "SAP is already bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            ret = rgSCHUtlRgrBndCfm(instId, suId, 1);
            break;
         default:
            ...
            ret = rgSCHUtlRgrBndCfm(instId, suId, 2);
            break;
      }
   }
   else
   {
      ...
      ret = RgUiRgrBndCfm(&tmpPst, suId, 2);
   }
   return(ret);
}
 S16 RgUiRgrUbndReq
...

{
   ...
   if (spId < rgSchCb[instId].numSaps)
   {
      ...
      {
         case 2:
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb90007, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",681, "SAP is already bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };

            rgSchCb[instId].rgrSap[spId].sapSta.sapState = 1;
            break;
         default:
...

{
   ...
   if (cfgReqInfo == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90008,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",756, "Input Message Buffer is NULL", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      rgSCHUtlRgrCfgCfm(instId, spId, transId, cfmStatus,1,1);
   ...
   if (spId < rgSchCb[instId].numSaps)
   {
      ...
      {
         case 2:
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb90009, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",770, "SAP is already bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            break;
         default:
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9000a,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",811, "Configuration Request Handling Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if (cfgReqInfo == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9000b,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                            870      , "Input Message Buffer " "is NULL", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
   ...
   if (spId < rgSchCb[instId].numSaps)
   {
      if(2 != rgSchCb[instId].rgrSap[spId].sapSta.sapState)
      {
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9000c,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0,                                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                                          910      , "RgUiRgrSiCfgReq:" "Configuration Request Handling Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                           ;
      return(1);
   }
...

{
   ...
   if (warningSiCfgReqInfo == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9000d,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                        970      , "Input Message Buffer " "is NULL", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
   ...
   if(ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9000e,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                                      1015      , "Configuration Request Handling Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
      return(1);
   }
...

{
   ...
   if (loadInfReq == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9000f,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                        1146      , "Input Message Buffer " "is NULL", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
      return(1);
   }
   ...
   ret = rgSCHGomHndlLoadInf(pst->region, pst->pool,
         &rgSchCb[(pst->dstInst - 2)], spId, transId,
         loadInfReq);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90010,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                                      1183      , "Configuration Request Handling Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
      return(1);
   }
...

{
   ...
   if ((ue = rgSCHDbmGetUeCb(cell, boRpt->rnti)) != 0L)
   {
      RgSchDlLcCb *dlLc;
      ...
      if ((dlLc = rgSCHDbmGetDlDedLcCb(ue, boRpt->lcId)) != 0L)
      {
         ...
         if (boRpt->bo > dlLc->bo)
         {
            ue->tenbStats->stats.nonPersistent.sch[(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)].dlBo += ((boRpt->bo - dlLc->bo)<<3);
         }
...

{
   ...
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90011,L_DEBUG,DBG_CELLID, cell->cellId,boRpt->cellId, 0, 0, 0,                                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                                       1371      , "RgMacSchCmnBoUpdtReq():" "Invalid boRpt cell Id:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                        ;
      return(1);
   }
   ...
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90012,L_DEBUG,DBG_CELLID, cell->cellId, 0, 0, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                    1379      , "RgMacSchCmnBoUpdtReq():" " BO update for CCCH", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
...

{
   ...
   if (rgSchCb[inst].rgrSap == 0L || rgSchCb[inst].rgrSap[cellSapId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90013,L_ERROR,DBG_CELLID, ueDelInd->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",1427, "rgrSap or cell is not configured", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(0);
   }
   cell = rgSchCb[inst].rgrSap[cellSapId].cell;
   ((((tmp) = ((&cell->rntiDb.rntiGuardPool)->crnt = (&cell->rntiDb.rntiGuardPool)->first)) != 0L) ? (tmp)->node : 0L);
   ...
   while(tmp)
   {
      ...
      if(rntiLnk->rnti == ueDelInd->rnti)
      {
        ...
        if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90014,L_DEBUG,DBG_CELLID, cell->cellId, ueDelInd->rnti, cell->rntiDb.rntiGuardPool.count, 0, 0,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"        ,                                                    1454        , "RNTI:%d Released from the Guard pool(%ld)", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                     ;

         break;
      }
      ((((tmp) = ((&cell->rntiDb.rntiGuardPool)->crnt = ((&cell->rntiDb.rntiGuardPool)->crnt ? (&cell->rntiDb.rntiGuardPool)->crnt->next : (&cell->rntiDb.rntiGuardPool)->first)))!= 0L) ? (tmp)->node : 0L);
   }

   if(tmp == 0L)
   {

      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90015,L_INFO,DBG_CELLID, ueDelInd->cellId, ueDelInd->rnti, cell->rntiDb.rntiGuardPool.count, 0, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                                                             1465      , "HO CRNTI:%d not present in the" "Guard Pool:%ld", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                              ;
   }
...

{
   ...
   while((0L != tmp) && ((RgInfUeDatInd *)tmp->node != 0L))
   {
      ue = 0L;
      ...
      rnti = datInd->rnti;
      if (datInd->ceInfo.bitMask & (1<<1))
      {

         rgNumMsg3CrntiCE++;

         if (datInd->ceInfo.bitMask & (1<<0))
         {
            { if (0L != (subfrmInfo)) { cmFreeMem((Ptr)(subfrmInfo)); subfrmInfo = 0L; } };
            err.errType = ((((0 + 1) + 4) + 1) + 4);
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90016,L_ERROR,DBG_CELLID, cell->cellId, datInd->ceInfo.ces.cRnti, 0, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"            ,                                             1571            , "Received MSG3 with CRNTI:%d and also CCCH ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         if (ue == 0L)
         {
            ...
            { if (0L != (subfrmInfo)) { cmFreeMem((Ptr)(subfrmInfo)); subfrmInfo = 0L; } };
            err.errType = ((((0 + 1) + 4) + 1) + 4);
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90017,L_ERROR,DBG_CELLID, cell->cellId, datInd->ceInfo.ces.cRnti, 0, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"            ,                                             1584            , "Received MSG3 " "with CRNTI:%d unable to find ueCb", RLOG_FILE_ID, RLOG_MODULE_NAME); }
               ...
               rnti, datInd, &err)) != 0)
         {
            { if (0L != (subfrmInfo)) { cmFreeMem((Ptr)(subfrmInfo)); subfrmInfo = 0L; } };
            err.errType = ((((0 + 1) + 4) + 1) + 4);
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90018,L_ERROR,DBG_CELLID, cell->cellId, datInd->rnti, 0, 0, 0,                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"            ,                                 1594            , "Processing for MSG3 failed for CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                  ;
            return(1);
         }
         ...
         if(ret == 0)
         {
            ueStaInd->status = 0x01;
            ret = rgSCHUtlFillSndUeStaInd(cell, ue, ueStaInd);
            if(ret != 0)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90019,L_ERROR,DBG_CELLID, cell->cellId,ue->ueId, 0, 0, 0,                                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"               ,                                                               1619               , "Could not Send Ue Sta Ind UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                ;
            }
         }
      ...
      else if (datInd->ceInfo.bitMask & (1<<0))
      {

         rgNumMsg3CCCHSdu++;

         if (0L == rgSCHDbmGetRaCb (cell, rnti))
         {
               ...
               rnti, datInd, &err)) != 0)
         {
            { if (0L != (subfrmInfo)) { cmFreeMem((Ptr)(subfrmInfo)); subfrmInfo = 0L; } };
            err.errType = ((((0 + 1) + 4) + 1) + 4);
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9001a,L_ERROR,DBG_CELLID, cell->cellId, datInd->rnti, 0, 0, 0,                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"            ,                                 1641            , "Processing for MSG3 failed for CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                  ;
            return(1);
         }
      ...
      if (ue == 0L)
      {
         ...
         if((ue = rgSCHDbmGetSpsUeCb (cell, datInd->rnti)) == 0L)

            {
               { if (0L != (subfrmInfo)) { cmFreeMem((Ptr)(subfrmInfo)); subfrmInfo = 0L; } };
               err.errType = ((((0 + 1) + 4) + 1) + 4);
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9001b,L_ERROR,DBG_CELLID, cell->cellId, datInd->rnti, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"               ,                           1661               , "Unable to get the UE CB for CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
               return(1);
            }
         }
      }
      if ((ret = rgSCHUtlUpdSch (subfrmInfo, cell, ue, datInd, &err)) != 0)
      {
         { if (0L != (subfrmInfo)) { cmFreeMem((Ptr)(subfrmInfo)); subfrmInfo = 0L; } };
         err.errType = ((((0 + 1) + 4) + 1) + 4);
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9001c,L_ERROR,DBG_CELLID, cell->cellId,ue->ueId, 0, 0, 0,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"         ,                                                     1725         , "Unable to handle Data" " Indication for UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
         return(1);
      }
...

{
   ...
   if ((ue = rgSCHDbmGetUeCb(cell, relInfo->cRnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9001d,L_ERROR,DBG_CELLID, cell->cellId,relInfo->cRnti, 0, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                                      1790      , "No Ue exists with CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
      return(1);
   }

   if ((rgSCHUtlSpsRelInd(cell, ue, relInfo->isExplRel)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9001e,L_ERROR,DBG_CELLID, cell->cellId,relInfo->cRnti, 0, 0, 0,                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                                                 1797      , "RelInd processing for CRNTI:%d failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                  ;
      return(1);
   }
   return(0);
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9001f,L_ERROR,DBG_INSTID, instId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2023, "Incorrect SuId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90020,L_ERROR,DBG_INSTID, instId, tfuSap->sapCfg.suId, suId, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"      ,                                                      2032      , "Incorrect SuId. Configured (%d)" "Recieved (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90021,L_ERROR,DBG_INSTID, inst, suId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2078, "SAP Validation failed SuId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (0L != (raReqInd)) { cmFreeMem((Ptr)(raReqInd)); raReqInd = 0L; } };
      return(ret);
   }

   if(raReqInd == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90022,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2086, "Invalid input pointer for raReqInd Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90023,L_ERROR,DBG_CELLID, raReqInd->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2092, "No cell exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90024,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2142, "SAP Validation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (0L != (ulCqiInd)) { cmFreeMem((Ptr)(ulCqiInd)); ulCqiInd = 0L; } };
      return(ret);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90025,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2150, "No cell exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90026,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2199, "SAP Validation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (0L != (pucchDeltaPwr)) { cmFreeMem((Ptr)(pucchDeltaPwr)); pucchDeltaPwr = 0L; } };
      return(ret);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90027,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2207, "No cell exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   { if (0L != (harqAckInd)) { cmFreeMem((Ptr)(harqAckInd)); harqAckInd = 0L; } };
   return(ret);
}
 S16 RgLiTfuSrInd
(
...

{
   ...
   { if (0L != (srInd)) { cmFreeMem((Ptr)(srInd)); srInd = 0L; } };
   return(ret);
}
 S16 RgLiTfuDlCqiInd
(
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90028,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2376, " SAP Validation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (0L != (dlCqiInd)) { cmFreeMem((Ptr)(dlCqiInd)); dlCqiInd = 0L; } };
      return(ret);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90029,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2384, "No cell exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9002a,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2433, "SAP Validation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (0L != (rawCqiInd)) { cmFreeMem((Ptr)(rawCqiInd)); rawCqiInd = 0L; } };
      return(ret);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9002b,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2441, " No cell exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9002c,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2489, " SAP Validation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (0L != (srsInd)) { cmFreeMem((Ptr)(srsInd)); srsInd = 0L; } };
      return(ret);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9002d,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2497, "No cell exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9002e,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2547, "SAP Validation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (0L != (doaInd)) { cmFreeMem((Ptr)(doaInd)); doaInd = 0L; } };
      return(ret);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb9002f,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2555, "No cell exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   { if (0L != (crcInd)) { cmFreeMem((Ptr)(crcInd)); crcInd = 0L; } };
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90030,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2660, "SAP Validation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (0L != (timingAdvInd)) { cmFreeMem((Ptr)(timingAdvInd)); timingAdvInd = 0L; } };
      return(ret);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90031,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2668, "No cell exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   rgSchCb[instId].rgmSap[spId].sapSta.sapState = 1;
   ...
   if(spId < rgSchCb[instId].numSaps)
   {
      ...
      switch (rgSchCb[instId].rgmSap[spId].sapSta.sapState)
      {
         ...
         case 1:
          if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb90032, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2800, "SAP is not yet bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            rgSchCb[instId].rgmSap[spId].sapSta.sapState = 2;
            rgSchCb[instId].rgmSap[spId].sapCfg.suId = suId;

            ret = rgSCHUtlRgmBndCfm(instId, suId, 1);

            break;
         case 2:
          if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb90033, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2808, "SAP is already bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            ret = rgSCHUtlRgmBndCfm(instId, suId, 1);
            break;
         default:
            ...
            ret = rgSCHUtlRgmBndCfm(instId, suId, 2);
            break;
      }
   }
   else
   {
      ...
      ret = RgUiRgmBndCfm(&tmpPst, suId, 2);
   }
   return(ret);
}
 S16 RgUiRgmUbndReq
   ...
   if (spId < rgSchCb[instId].numSaps)
   {
      switch(rgSchCb[instId].rgmSap[spId].sapSta.sapState)
      {
         case 2:
          ...
          if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb90034, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c",2878, "SAP is already bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            rgSchCb[instId].rgmSap[spId].sapSta.sapState = 1;
            break;
         default:
...

{
   ...
   if ((cell->crntTime.subframe + (1)) >= 10) prbUsage->startTime.sfn = (cell->crntTime.sfn + (cell->crntTime.subframe + (1))/10) % 1024; else prbUsage->startTime.sfn = cell->crntTime.sfn; prbUsage->startTime.subframe = (cell->crntTime.subframe + (1)) % 10;;


   cmMemset((U8*)&prbUsage->qciPrbRpts[0], 0,
             (4 * sizeof(RgSchQciPrbUsage)));

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb90035,L_DEBUG,DBG_CELLID, cell->cellId, prbUsage->prbRprtEnabld, prbUsage->rprtPeriod, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch.c"   ,                                                  2954   , "RgUiRgmCfgPrbRprt config type %d with the report period %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
