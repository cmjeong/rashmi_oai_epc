...
extern Void rgSCHLaaSCellCbDeInit ( RgSchCellCb *cell )
 ...
 Void rgSCHCmnInit (Void);




static U16 rgSCHLmmSapCfg ( Inst inst, RgCfg *cfg, U8 sapIdx, Elmnt sapType )
 ...
 void printSchCellInfo(void)
{
   ...
   for (idx = 0; idx < rgSchCb[inst].numSaps; idx++)
   {
      ...
      if (rgSchCb[inst].tfuSap[idx].cell != 0L)
      {
         printf("CELL %d\n", idx);
...

{
   ...
   rgSchCb[inst].rgSchInit.cfgDone = 0;
   rgSchCb[inst].rgSchInit.acnt = 0;
   rgSchCb[inst].rgSchInit.usta = 0;
   rgSchCb[inst].rgSchInit.trc = 0;
   ...
   rgSchCb[inst].rgrSap = 0L;
   rgSchCb[inst].tfuSap = 0L;
   rgSchCb[inst].rgmSap = 0L;
   rgSCHCmnInit();
...
{
   U16 ret = 0;
   RgSchLowSapCfgInfo *lowSapCfg = 0L;
   RgSchUpSapCfgInfo *upSapCfg = 0L;
   Inst inst = (dInst - 2);
   ...
   switch(sapType)
   {
      case 1 + 2:
         ...
         if ((cfg->s.schInstCfg.rgrSap[sapIdx].selector != 1) &&
             (cfg->s.schInstCfg.rgrSap[sapIdx].selector != 0))
         {
            ret = 13;
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70001,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0,                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"            ,                                         234            , "rgSCHLmmSapCfg(): unsupported" " Selector value for RGR.", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;
            break;
         }

         if(rgSchCb[inst].rgrSap[sapIdx].sapSta.sapState == 0)
         {
            rgSchCb[inst].rgrSap[sapIdx].sapSta.sapState = 1;
         }
      ...
      case 1 + 4:
         ...
         if ((cfg->s.schInstCfg.tfuSap[sapIdx].selector != 1) &&
             (cfg->s.schInstCfg.tfuSap[sapIdx].selector != 0))
         {
            ret = 13;
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70002,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0,                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"            ,                                               268            , "rgSCHLmmSapCfg(): unsupported" " Selector value for TFU.", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                ;
            break;
         }

         if (rgSchCb[inst].tfuSap[sapIdx].sapSta.sapState == 0)
         {
            rgSchCb[inst].tfuSap[sapIdx].sapSta.sapState = 1;
         }
         ...
         break;
      case 190:
         if (rgSchCb[inst].rgmSap[sapIdx].sapSta.sapState == 0)
         {
            rgSchCb[inst].rgmSap[sapIdx].sapSta.sapState = 1;
         }
...

{
   ...
   if ((cfg->s.schInstCfg.genCfg.lmPst.selector != 1) &&
       (cfg->s.schInstCfg.genCfg.lmPst.selector != 0))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70003,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0,                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"      ,                                            388      , "rgSCHLmmInstCfg(): unsupported " "Selector value for lmPst.", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                             ;
      return(13);
   }
   ...
   2;
   rgSchCb[inst].rgSchInit.lmPst.event = 0x00;
   ...
   if (SGetSBuf(rgSchCb[inst].rgSchInit.region,
                ...
                (sizeof(RgSchUpSapCb) * cfg->s.schInstCfg.numSaps)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70004,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"      ,                                    419      , "rgSCHLmmInstCfg: SGetSBuf for " "RGR saps failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
      return(1);
   }
   ...
   if (SGetSBuf(rgSchCb[inst].rgSchInit.region,
                ...
                (sizeof(RgSchUpSapCb) * cfg->s.schInstCfg.numSaps)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70005,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"      ,                                    429      , "rgSCHLmmInstCfg: SGetSBuf for " "RGM saps failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
      return(1);
   }
   ...
   if (SGetSBuf(rgSchCb[inst].rgSchInit.region,
                ...
                (sizeof(RgSchLowSapCb) * cfg->s.schInstCfg.numSaps)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70006,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"      ,                              441      , "rgSCHLmmInstCfg: SGetSBuf for TFU " "saps failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                               ;
      return(1);
   }
   ...
   if (SGetSBuf(rgSchCb[inst].rgSchInit.region,
                ...
                (sizeof(RgSchLmResponse) * cfg->s.schInstCfg.numSaps)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70007,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0,                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"      ,                                      452      , "rgSCHLmmInstCfg: SGetSBuf for bind" " confirm responses failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
      return(1);
   }


   cmLListInit(&rgSchCb[inst].laaMovedTBNodeLst);

   rgSchCb[inst].numSaps = cfg->s.schInstCfg.numSaps;
   for (idx = 0; idx < cfg->s.schInstCfg.numSaps; idx++)
   {

      rgSchCb[inst].rgrSap[idx].sapSta.sapState = 0;
      rgSchCb[inst].rgrSap[idx].cell = 0L;
      rgSCHLmmSapCfg(dInst, cfg, idx, 1 + 2);

      rgSchCb[inst].rgmSap[idx].sapSta.sapState = 0;
      rgSchCb[inst].rgmSap[idx].cell = 0L;
      rgSCHLmmSapCfg(dInst, cfg, idx, 190);

      rgSchCb[inst].tfuSap[idx].sapSta.sapState = 0;
      rgSchCb[inst].tfuSap[idx].cell = 0L;
      rgSCHLmmSapCfg(dInst, cfg, idx, 1 + 4);
      rgSchCb[inst].tfuSap[idx].numBndRetries = 0;
   }

   cmMemset((U8 *)&rgSchCb[inst].tmrTq, 0, sizeof(CmTqType)*100);

   cmMemset((U8 *)&rgSchCb[inst].tmrTqCp, 0, sizeof(CmTqCp));
   rgSchCb[inst].tmrTqCp.tmrLen = 100;



   if (SRegCfgTmrMt(rgSchCb[inst].rgSchInit.ent,dInst,(S16)rgSchCb[inst].genCfg.tmrRes,100,schActvTmr)
                                                    != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70008,L_ERROR,DBG_INSTID, inst, 0, 0, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"      ,                              488      , "rgSCHLmmInstCfg(): Failed to " "register timer.", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                               ;
      return(4);
   }


   rgSchCb[inst].rgSchInit.cfgDone = 1;
...

{
   ...
   for (idx = 0; idx < rgSchCb[inst].numSaps; idx++)
   {
      ...
      if(rgSchCb[inst].tfuSap[idx].sapSta.sapState == 3)
      {
         rgSCHUtlTfuUBndReq(inst, rgSchCb[inst].tfuSap[idx].sapCfg, 1);
         if (rgSchCb[inst].tfuSap[idx].sapCfg.bndTmr.enb == 1)
         {
            rgSCHLmmStopTmr(inst, 1, (U32)&rgSchCb[inst].tfuSap[idx]);
         }
         rgSchCb[inst].tfuSap[idx].sapSta.sapState = 1;
      }
      if(rgSchCb[inst].tfuSap[idx].sapSta.sapState == 2)
      {
         rgSCHUtlTfuUBndReq(inst, rgSchCb[inst].tfuSap[idx].sapCfg, 1);
         rgSchCb[inst].tfuSap[idx].sapSta.sapState = 1;
      }
   ...
   rgSchCb[inst].genCfg.bndCfmResp = 0L;

   lst = &rgSchCb[inst].laaMovedTBNodeLst;
   while (lst->first != 0L)
   {
      laaTbInfo = (RgSchLaaTBInfo*)lst->first->node;
      cmLListDelFrm(lst, &(laaTbInfo->laaTbsLnk));
      rgSCHUtlFreeSBuf(inst,(Data **)&laaTbInfo, sizeof(RgSchLaaTBInfo));
   }

   (Void) SDeregCfgTmrMt(rgSchCb[inst].rgSchInit.ent,dInst,(S16)rgSchCb[inst].genCfg.tmrRes,100,schActvTmr)
                                                                  ;
...

{
   ...
   switch(cntrl->t.cntrl.action)
   {
      case 1:
         ...
         switch(cntrl->t.cntrl.subAction)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa70009,L_ERROR,DBG_INSTID, inst, cntrl->t.cntrl.subAction, 0, 0, 0,                                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"               ,                                                                  753               , "rgSCHLmmGenCntrl(): " "invalid subaction=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                   ;
               break;
         }
         break;
      case 2:
         ...
         switch(cntrl->t.cntrl.subAction)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa7000a,L_ERROR,DBG_INSTID, inst, cntrl->t.cntrl.subAction, 0, 0, 0,                                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"               ,                                                                  777               , "rgSCHLmmGenCntrl():" " invalid subaction=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                   ;
               break;
         }
         break;
      ...
      default:
         cfm->cfm.status = 1;
         cfm->cfm.reason = 13;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa7000b,L_ERROR,DBG_INSTID, inst, cntrl->t.cntrl.action, 0, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"         ,                                             789         , "rgSCHLmmGenCntrl(): invalid" " action=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;
         break;
   }
      ...
      case 1 + 4:
         ...
         switch(cntrl->t.cntrl.action)
         {
            case 30:
               ...
               if ((rgSchCb[inst].tfuSap[idx].sapSta.sapState == 0) ||
                   (rgSchCb[inst].tfuSap[idx].sapSta.sapState == 2))
               {
                  cfm->cfm.status = 1;
                  cfm->cfm.reason = 12;
               }
               else
               {
                  if (rgSchCb[inst].tfuSap[idx].sapCfg.bndTmr.enb == 1)
                  {
                     rgSCHLmmStartTmr(inst, 1,
                                  rgSchCb[inst].tfuSap[idx].sapCfg.bndTmr.val,
                                  (U32)&rgSchCb[inst].tfuSap[idx]);
                  }

                  rgSchCb[inst].tfuSap[idx].sapSta.sapState = 3;
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa7000c,L_ERROR,DBG_INSTID, inst, cntrl->t.cntrl.action, 0, 0, 0,                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"               ,                                                            929               , "rgSCHLmmSapCntrl(): " "invalid action=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                             ;
               break;
         }
         break;
      case 1 + 2:
         ...
         switch(cntrl->t.cntrl.action)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa7000d,L_ERROR,DBG_INSTID, inst, cntrl->t.cntrl.action, 0, 0, 0,                                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"               ,                                                               952               , "rgSCHLmmSapCntrl(): " "invalid action=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                ;
               break;
         }
         break;
      case 190:
         ...
         switch(cntrl->t.cntrl.action)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa7000e,L_ERROR,DBG_INSTID, inst, cntrl->t.cntrl.action, 0, 0, 0,                                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"               ,                                                               975               , "rgSCHLmmSapCntrl(): " "invalid action=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                ;
               break;
         }
         break;
...

{
   ...
   inst = (reqPst->dstInst - 2);

   cfmPst->srcEnt = rgSchCb[inst].rgSchInit.ent;
   cfmPst->srcInst = rgSchCb[inst].rgSchInit.inst + 2;
...

{
   ...
   switch(tmrEvnt)
   {
      case 1:
         ...
         {
            rgSCHLmmStaInd((U8)(tfuSap->sapCfg.sapPst.srcInst - 2),
                           (U16)2, (U16)8,
                           (U16)10, (RgUstaDgn *)0L);
         }
         else
         {
            ...
            {
               ret = rgSCHLmmStartTmr((U8)(tfuSap->sapCfg.sapPst.srcInst - 2),
                                  1,
                                 (U32)tfuSap->sapCfg.bndTmr.val, cb);
            }


            rgSCHUtlTfuBndReq((U8)(tfuSap->sapCfg.sapPst.srcInst - 2),
            tfuSap->sapCfg.suId, tfuSap->sapCfg.spId);
         }
         break;
      default:
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xa7000f,L_ERROR,DBG_INSTID, inst, tmrEvnt, 0, 0, 0,                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_lmm.c"         ,                                       1232         , "rgSCHLmmTmrExpiry(): Invalid" " tmrEvnt=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                        ;
         ret = 1;
         break;
   }
...

{
   ...
   switch(status)
   {
      case 1:
         ...
         rgSchCb[inst].tfuSap[suId].sapSta.sapState = 2;
         if (rgSchCb[inst].tfuSap[suId].sapCfg.bndTmr.enb == 1)
         {
            ret = rgSCHLmmStopTmr(inst, 1, (U32)&rgSchCb[inst].tfuSap[suId]);
         }

         cntrlCfm.cfm.status = 0;
         cntrlCfm.cfm.reason = 0;

         rgSCHLmmStaInd((U8)(rgSchCb[inst].tfuSap->sapCfg.sapPst.srcInst - 2),
               2, 11,
               256, (RgUstaDgn *)0L);
         break;
      ...
      default:
         ...
         rgSchCb[inst].tfuSap[suId].sapSta.sapState = 1;
         if (rgSchCb[inst].tfuSap[suId].sapCfg.bndTmr.enb == 1)
         {
            ret = rgSCHLmmStopTmr(inst, 1, (U32)&rgSchCb[inst].tfuSap[suId]);
         }
...
)
{
   ...
   if(rgSchCb[inst].rgSchInit.usta == 0)
   {
      return(0);
   }
