...
U32 CPRBCongestionController::convertBwToPrb(LrmCellBandwidth cellBw)
{
   ...
   switch(cellBw)
   {
      ...
      case LRM_BANDWIDTH_100:
         ...
         break;
      default:
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9a0001, L_ERROR,cellBw, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbcongestioncontroller.cpp",55, "Invalid BW config [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
   }
   return prb;
}
                                 ...
                                 U8 bMaxPrbGbrUsage, LrmCellBandwidth cellBw)
{
   ...
   if(m_uiMaxPrbThreshold > 100)
   {
      m_uiMaxPrbThreshold = 100;
   }
   ...
   if(m_uiMinPrbThreshold > 100)
   {
      m_uiMinPrbThreshold = 0;
   }

   m_uiTimeSamples = 40;
   m_uiPreemptWaitInterval = 3;
   m_uiPrevDlPrb = 0;
   m_uiPrevUlPrb = 0;
   m_objRBearerCtrlr = pstRbBrCntrlr;
   m_bIsCongested = false;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9a0002,L_DEBUG,DBG_CELLID, m_objRBearerCtrlr->getCellId(), m_uiMaxPrbThreshold, m_uiMinPrbThreshold, m_uiTimeSamples, m_uiPreemptWaitInterval,                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbcongestioncontroller.cpp"   ,                                                 101   , "PRB Congestion Configuration:: Threshold max/min: [%d, %d] " "timeSample During Congestion: %d waitTime: %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
bool CPRBCongestionController::verifyCongestion()
{
         ...
         uiCurDlPrbUsage >= m_uiMaxPrbThreshold)
   {
      ...
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9a0003,L_INFO,DBG_CELLID, m_objRBearerCtrlr->getCellId(), uiCurDlPrbUsage, uiCurUlPrbUsage, m_uiPrevDlPrb, m_uiPrevUlPrb,                                                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbcongestioncontroller.cpp"      ,                                                                          130      , "Cell is Congested. Curr DL/UL PRB Usage: [%ld, %ld] [%ld, %ld]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
void CPRBCongestionController::verifyUncongestion()
{
         ...
         uiCurDlPrbUsage <= m_uiMinPrbThreshold)
   {
      ...
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9a0004,L_INFO,DBG_CELLID, m_objRBearerCtrlr->getCellId(), uiCurDlPrbUsage, uiCurUlPrbUsage, m_uiMaxPrbThreshold, m_uiMinPrbThreshold,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbcongestioncontroller.cpp"      ,                               153      , "Cell is Un-Congested. Curr DL/UL PRB Usage: [%ld, %ld] [%ld, %ld]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
bool CPRBCongestionController::verifyChangeInPrbUsage()
{
   ...
   if(m_bIsCongested)
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9a0005,L_INFO,DBG_CELLID, m_objRBearerCtrlr->getCellId(), uiCurDlPrbUsage, uiCurUlPrbUsage, m_uiPrevDlPrb, m_uiPrevUlPrb,                                                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbcongestioncontroller.cpp"      ,                                                                          204      , "Cell is Congested. Curr DL/UL PRB Usage: [%ld, %ld] [%ld, %ld]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
