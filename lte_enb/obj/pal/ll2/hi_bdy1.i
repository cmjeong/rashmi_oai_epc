...
)
{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000001)) { snprintf((&(hiCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->procId, (&(hiCb.init))->ent, (&(hiCb.init))->inst,
                                        ...
                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/tucl/hi_bdy1.c"
   ,

                                        273
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiActvInit(Ent(%d), Inst(%d), Region(%d), Reason(%d))\n", entity, inst, region, reason); SPrint((&(hiCb.init))->prntBuf); } }
...

{
   ...
   ;;
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { snprintf((&(hiCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->procId, (&(hiCb.init))->ent, (&(hiCb.init))->inst,

                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/tucl/hi_bdy1.c"
   ,

                                365
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCfgReq(pst, elmnt(%d))\n", cfg->hdr.elmId.elmnt); SPrint((&(hiCb.init))->prntBuf); } }

                                 ;

   cmMemset((U8 *)&cfmMsg, 0, sizeof (HiMngmt));;
   ...
   hiSendLmCfm(pst, 1, &cfg->hdr, (U16)(ret == 0 ?
               0 : 1), (U16)ret, &cfmMsg);
...

{
   ...
   ,
                                        ...
                                        460
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStsReq(pst, action(%d), elmnt(%d))\n", action, sts->hdr.elmId.elmnt); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   ,
                                                                462
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SGetDateTime(DateTime(%p))\n", (Ptr)&cfmMsg.t.sts.dt); SPrint((&(hiCb.init))->prntBuf); } }
                                                                 ;
   ...
   if(!hiCb.init.cfgDone)
   {
      ...
      ,
                                                             474
      ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStsReq(): general configuration not done\n"); SPrint((&(hiCb.init))->prntBuf); } }
                                                              ;

      hiSendLmCfm(pst, 3, &sts->hdr, 1, 8,
               &cfmMsg);
...

{
   ...
   ,
                                                                    579
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCntrlReq(pst, elmnt(%d))\n", ctl->hdr.elmId.elmnt); SPrint((&(hiCb.init))->prntBuf); } }
                                                                     ;
   { if ((&(hiCb.init))->dbgMask & (0x00000001)) { snprintf((&(hiCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->procId, (&(hiCb.init))->ent, (&(hiCb.init))->inst,
                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/tucl/hi_bdy1.c"
   ,
                                                                581
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SGetDateTime(DateTime(%p))\n", (Ptr)&ctl->t.cntrl.dt); SPrint((&(hiCb.init))->prntBuf); } }
                                                                 ;
   ...
   if((!hiCb.init.cfgDone) && (hdr->elmId.elmnt != 1))
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { snprintf((&(hiCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->procId, (&(hiCb.init))->ent, (&(hiCb.init))->inst,
                                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/tucl/hi_bdy1.c"
      ,
                                                               591
      ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCntrlReq(): general configuration not done\n"); SPrint((&(hiCb.init))->prntBuf); } }
                                                                ;


      hiSendLmCfm(pst, 2, hdr, 1, 8,
               &cfmMsg);
   ...
   hiSendLmCfm(pst, 2, hdr, (U16)(ret == 0 ?
               0 : 1), (U16)ret, &cfmMsg);
...

{
   ...
   ,
                                686
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStaReq(pst, elmnt(%d))\n", sta->hdr.elmId.elmnt); SPrint((&(hiCb.init))->prntBuf); } }
                                 ;
   ...
   if(!hiCb.init.cfgDone && hdr->elmId.elmnt == 2)
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { snprintf((&(hiCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->procId, (&(hiCb.init))->ent, (&(hiCb.init))->inst,
                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/tucl/hi_bdy1.c"
      ,
                                                             699
      ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStaReq(): general configuration not done\n"); SPrint((&(hiCb.init))->prntBuf); } }
                                                              ;
      hiSendLmCfm(pst, 4, hdr, 1,
                  8, &cfmMsg);
...

{
   ...
   ;;
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { snprintf((&(hiCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->procId, (&(hiCb.init))->ent, (&(hiCb.init))->inst,

                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/tucl/hi_bdy1.c"
   ,

                     1038
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitBndReq(pst, suId(%d), spId(%d))\n", suId, spId); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   if (sap->state == 0x2)
   {
      HiUiHitBndCfm(&sap->uiPst, suId, 1);
      return(0);
   }
...

{
   ...
   ,
                       ...
                       1191
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitUbndReq(pst, spId(%d), reason(%d))\n", spId, reason); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   for (i = 0; i < hiCb.numFdGrps; i++)
   {
      ...
      if (ret != 0)
      {
         ...
         ,
                                                                      1221
         ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitUbndReq(): send message to group thread failed\n"); SPrint((&(hiCb.init))->prntBuf); } }
                                                                       ;
         return(1);
      }
   }
...
)
{
   ...
   ,
                                                               ...
                                                               1312
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitServOpenReq(pst, spId(%d), servConId(%ld), " "servTAddr(%p), tPar(%p), srvcType(%d))\n", spId, servConId, (Ptr)servTAddr, (Ptr)tPar, srvcType); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   { if (sap->pendOp.flag || hiCb.pendOp.flag) { alInfo.type = 0; hiSendAlarm(2, (256 + 4), 9, &alInfo); return(1); } };
   ...
   if (sap->resCongStrt)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)15); } };
      return(0);
   }
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)9); } };
      return(1);
   }
   ...
   {
      ret = hiCreateSock(1, type, servTAddr, tPar, conCb);

      if (ret != 0)
      {
         { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)conCb->suConId, (Reason)ret); } };
                               ...
                               )
      {
         ...
         ret = cmInetListen(&conCb->conFd, backLog);;
         if (ret != 0)
         {
            { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)4); } };
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)16); } };
      alInfo.type = 0;
      hiSendAlarm(3, (256 + 4),
                  (256 + 7), &alInfo);
      if (conCb->protocol != 
   ...
   if ((icmpFilter->type == 4 && icmpFilter->u.icmpv4Filter.icmpMsgFlag))
   {
      ...
      if (ret != 0)
      {
         { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)14); } };
         { cmHashListDelete(&conCb->sap->conCbHlCp, (U32)conCb); if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
         return(1);
      }
   }
   ...
   for (i = 0; ((tPar != 0L) && (i < tPar->u.sockParam.numOpts && tPar->type != 0)); i++)
   {
...
)
{
   ...
   ,
                                                                           ...
                                                                           1598
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitConReq(pst, spId(%d), suConId(%ld), remAddr(%p), " "localAddr(%p), tPar(%p), srvcType(%d))\n", spId, suConId, (Ptr)remAddr, (Ptr)localAddr, (Ptr)tPar, srvcType); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   { if (sap->pendOp.flag || hiCb.pendOp.flag) { alInfo.type = 0; hiSendAlarm(2, (256 + 5), 9, &alInfo); return(1); } };
   hiChkRes(sap);
   if (sap->resCongStrt)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)15); } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)9); } };
      return(1);
   }
   ret = hiCreateSock(0, type, localAddr, tPar, conCb);
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)conCb->suConId, (Reason)ret); } };
      { cmHashListDelete(&conCb->sap->conCbHlCp, (U32)conCb); if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
   ...
   conCb->state = 0x3;
   if ((remAddr && remAddr->type == 4))
   {
      ret = cmInetConnect(&conCb->conFd, &(remAddr)->u.ipv4TptAddr);;
      if (ret == 1 || ret == 20)
      {
         { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)conCb->suConId, (Reason)(ret == 1 ? 5 : 17)); } }
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)16); } };
      hiSendAlarm(3, (256 + 5),
                  (256 + 7), &alInfo);
      cmInetClose(&conCb->conFd);;
      { cmHashListDelete(&conCb->sap->conCbHlCp, (U32)conCb); if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)14); } };
      hiSendAlarm(3, (256 + 5),
                  (256 + 11), &alInfo);
      cmInetClose(&conCb->conFd);;
      { cmHashListDelete(&conCb->sap->conCbHlCp, (U32)conCb); if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
...

{
   ...
   ,
                                 ...
                                 1848
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitConRsp(pst, spId(%d), suConId(%ld), spConId(%ld))\n", spId, suConId, spConId); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   { if (sap->pendOp.flag || hiCb.pendOp.flag) { alInfo.type = 0; hiSendAlarm(2, (256 + 6), 9, &alInfo); return(1); } };
   ...
   if (ret != 0)
   {
      ...
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)12); } };
      return(1);
   }
...

{
   ...
   ,
                                   ...
                                   1999
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDatReq(pst, spId(%d), spConId(%ld), mBuf(%p)))\n", spId, spConId, (Ptr)mBuf); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   { if (sap->pendOp.flag || hiCb.pendOp.flag) { alInfo.type = 0; hiSendAlarm(2, (256 + 7), 9, &alInfo); return(1); } };
   ...
   {
      { SPutMsg(mBuf); };
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPst, sap->suId, (U8)2, (UConnId)spConId, (Reason)18); } };
      return(1);
   }
...
)
{
   ...
   ,
                                        ...
                                        2275
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitUDatReq(pst, spId(%d), remAddr(%p), mBuf(%p))\n", spId, (Ptr)remAddr, (Ptr)mBuf); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   { if (sap->pendOp.flag || hiCb.pendOp.flag) { alInfo.type = 0; hiSendAlarm(2, (256 + 8), 9, &alInfo); return(1); } };
   ...
   if (tPar->type == 1
       ...
       && (tPar->u.sockParam.sockOpts[0].option == 14))
   {
      if (conCb)
      {
   ...
   { CmInetMemInfo memInfo; memInfo.region = hiCb.init.region; memInfo.pool = hiCb.init.pool; ret = cmInetSendMsg(sendFd, (udpClt ? 0L : remAddr) ? &((udpClt ? 0L : remAddr))->u.ipv4TptAddr : 0L, &memInfo, mBuf, &txLen, 0);; }
                                                      ;
   if (ret != 0)
   {
      { SPutMsg(mBuf); };
...
)
{
   ...
   ,
                                                      ...
                                                      2762
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDiscReq(pst, spId(%d), choice(%d), conId(%ld),           action(%d))\n", spId, choice, conId, action); SPrint((&(hiCb.init))->prntBuf); } }
   ...
   { if (sap->pendOp.flag || hiCb.pendOp.flag) { alInfo.type = 0; hiSendAlarm(2, (256 + 10), 9, &alInfo); return(1); } };
   if (choice == 2)
   ...
   if ((ret != 0)||(conCb == 0L))
   {
      { HiUiHitDiscCfm(&sap->uiPst, sap->suId, (U8)choice, (UConnId)conId, (Action)action); };
      return(0);
   }
