...
extern S16 kwDlmHndlStaRsp ( KwCb *gCb,KwDlRbCb *rbCb, KwUdxStaPdu *pStaPdu, KwUdxBufLst *rlsPduLst)
                                                               ;
 S16 KwDlUdxBndReq
(
Pst *pst,
...

{
   ...
   do { if (!((tKwCb->init.dbgMask & ((0x00000002 << 1) | ((0x00000002 << 4) << 11))) ^ ((0x00000002 << 1) | ((0x00000002 << 4) << 11)))) { { snprintf((tKwCb)->init.prntBuf, 255, "[%s]::", __func__); SPrint((tKwCb)->init.prntBuf); snprintf(tKwCb->init.prntBuf, 255,"KwDlUdxBndReq(spId(%d), suId(%d))\n", spId, suId); SPrint(tKwCb->init.prntBuf); }; } }while(0)
                           ;
   ...
   switch(udxSap->state)
   {
      ...
      case 4:
      {
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xcb0001, L_INFO, udxSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c",154, "UDX SAP state [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
      }
      ...
      case 2:
      {
               ...
               || udxSap->suId != suId)
         {
            ...
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xcb0002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c",172, "UDX SAP already Bound", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            KwDlUdxBndCfm(&(udxSap->pst), udxSap->suId, 2);
         }
         break;
      }
     ...
     default:
      {
         ...
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xcb0003, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c",184, "Invalid UDX SAP State in Bind Req", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         KwDlUdxBndCfm(&(udxSap->pst), udxSap->suId, 2);
         break;
      }
   }
   KwDlUdxBndCfm(&(udxSap->pst), udxSap->suId, 1);
   return(0);
}
 S16 KwDlUdxUbndReq
(
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xcb0004, L_DEBUG, spId, reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"   , 234   , "Unbind Req for spId[%d], reason[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
   (reason=reason);
...

{
   ...
   do { if (!((tKwCb->init.dbgMask & ((0x00000002 << 1) | ((0x00000002 << 4) << 11))) ^ ((0x00000002 << 1) | ((0x00000002 << 4) << 11)))) { { snprintf((tKwCb)->init.prntBuf, 255, "[%s]::", __func__); SPrint((tKwCb)->init.prntBuf); snprintf(tKwCb->init.prntBuf, 255,"spId(%d)\n", spId); SPrint(tKwCb->init.prntBuf); }; } }while(0);


   { if((&tKwCb->u.dlCb->udxDlSap[spId])->state != 2) { ; { kwLmmSendAlarm(tKwCb,2, 1, 9, 0, 0); }; ret = 1; } }
   ...
   { SGetStaticBuffer(pstUdxCfm->region, pstUdxCfm->pool, (Data **)&cfgCfm, (Size) sizeof(CkwCfgCfmInfo), 0); }
         ...
         case 1:
            {
               if (entCfg->dir & 2)
               {
                  ...
                  if (kwCfgAddDlRb(tKwCb,cfg->ueId, cfg->cellId,
                              entCfg, entCfgCfm) != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb0005,L_ERROR,DBG_RBID, cfg->entCfg[idx].rbId, entCfgCfm->status.reason, 0, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"                     ,                                                   349                     , "Addition Failed due to[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
                  }
               }
               break;
         ...
         case 2:
            {
               if (entCfg->dir & 2)
               {
                  ...
                  if (kwCfgReCfgDlRb(tKwCb,cfg->ueId, cfg->cellId,
                           entCfg, entCfgCfm) != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb0006,L_ERROR,DBG_RBID, cfg->entCfg[idx].rbId, entCfgCfm->status.reason, 0, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"                     ,                                                   363                     , "ReCfg Failed due to[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
                  }
               }
               break;
         ...
         case 3:
            {
               if (entCfg->dir & 2)
               {
                  ...
                  if (kwCfgDelDlRb(tKwCb,cfg->ueId, cfg->cellId,
                        entCfg, entCfgCfm) != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb0007,L_ERROR,DBG_RBID, cfg->entCfg[idx].rbId, entCfgCfm->status.reason, 0, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"                     ,                                                   378                     , "Deletion Failed due to[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
                  }
               }
               break;
         ...
         case 4:
            {
               if (entCfg->dir & 2)
               {
                  ...
                  if (kwCfgReEstDlRb(tKwCb,cfg->ueId, cfg->cellId,
                                     sndReEst,entCfg, entCfgCfm) != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb0008,L_ERROR,DBG_RBID, cfg->entCfg[idx].rbId, entCfgCfm->status.reason, 0, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"                     ,                                                   401                     , "Reest Failed due to[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
                  }
               }
               break;
         ...
         case 5:
            {
               ...
               if (kwCfgDelDlUe(tKwCb,cfg->ueId, cfg->cellId,
                                entCfg, entCfgCfm) != 0)
               {
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb0009,L_ERROR,DBG_UEID, cfg->ueId, entCfgCfm->status.reason, 0, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"                  ,                                                   414                  , "deletion Failed due to[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
               }
               break;
            }
         case 6:
            {
               if (kwCfgDelDlCell(tKwCb,cfg->cellId,entCfg,entCfgCfm)
                                                                != 0 )
               {
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb000a,L_ERROR,DBG_CELLID, cfg->cellId, entCfgCfm->status.reason, 0, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"                  ,                                                   424                  , "deletion Failed due to[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
               }
               break;
            }
         ...
         default:
            {
               { entCfgCfm->rbId = entCfg->rbId; entCfgCfm->rbType = entCfg->rbType; entCfgCfm->status.status = 2; entCfgCfm->status.reason = 15; }
                                                                             ;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xcb000b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c",433, "Invalid CfgType", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            }
      }
...
)
{
   ...
   do { if (!((tKwCb->init.dbgMask & ((0x00000002 << 1) | ((0x00000002 << 4) << 11))) ^ ((0x00000002 << 1) | ((0x00000002 << 4) << 11)))) { { snprintf((tKwCb)->init.prntBuf, 255, "[%s]::", __func__); SPrint((tKwCb)->init.prntBuf); snprintf(tKwCb->init.prntBuf, 255,"(spId(%d), transId(%ld))\n", spId, transId); SPrint(tKwCb->init.prntBuf); }; } }while(0)
                              ;
   ...
   if (kwCfgDlUeIdChng(tKwCb, ueInfo, newUeInfo, &status) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb000c,L_ERROR,DBG_CELLID, newUeInfo->cellId, status.reason, 0, 0, 0,                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"      ,                          519      , "Failure due to[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                           ;
   }
...

{
   ...
   if (!rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb000d,L_ERROR,DBG_UEID, rlcId->ueId, rlcId->cellId, rlcId->rbId, 0, 0,                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"      ,                                     567      , "CellId [%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                      ;
      { if (pStaPdu != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) pStaPdu, (Size) sizeof(KwUdxDlStaPdu), 0); pStaPdu = 0L; } }
   ...
   rbCb->m.amDl.cntrlBo = pStaPdu->controlBo;


   if(rbCb->m.amDl.pStaPdu)
   {
      { if (rbCb->m.amDl.pStaPdu != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) rbCb->m.amDl.pStaPdu, (Size) sizeof(KwUdxDlStaPdu), 0); rbCb->m.amDl.pStaPdu = 0L; } }


                          ;
   }

   rbCb->m.amDl.pStaPdu = pStaPdu;



   kwAmmSendDStaRsp(tKwCb, rbCb, &rbCb->m.amDl);

   return(0);
}
 S16 KwDlUdxStaUpdReq
(
Pst* pst,
SpId spId,
CmLteRlcId *rlcId,
...

{
   ...
   if (!rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xcb000e,L_ERROR,DBG_UEID, rlcId->ueId, rlcId->cellId, rlcId->rbId, 0, 0,                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_udx_dl.c"      ,                                     633      , "CellId [%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                      ;
      return(1);
   }
   ...
   { if (pStaPdu != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) pStaPdu, (Size) sizeof(KwUdxStaPdu), 0); pStaPdu = 0L; } }
