...
CRmRcmSpsMgr::CRmRcmSpsMgr(LrmCellConfigData &stCellCfg)
{
   ...
   m_usExplctRelAftrDl = 4;
   m_usNumOfConfSpsProcDl = 2;
...
void CRmRcmSpsMgr::calcMaxNumSpsUe()
{
   ...
   m_usMaxNumSpsUe = (U16) (m_usMaxSpsUePerTti * 20);
...
{
   U16 usMaxSpsUeSchd = 0;


   U8 usMaxN1PucchResAllocPerUe;

   U32 cnt = 0;



   usMaxN1PucchResAllocPerUe = 4;
   if(m_stRmCellSpsCfg.bIsSpsEnabled)
   {
      if(m_usMaxSpsUePerTti < 4)
      {
