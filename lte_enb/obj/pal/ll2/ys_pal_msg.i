...
static Buffer *ysPalPkTfuCntrlReq ( Pst *pst, SpId spId, TfuCntrlReqInfo *cntrlReq);
static Buffer *ysPalPkTfuDatReq ( Pst *pst, SpId spId, TfuDatReqInfo *datReq);
static Buffer *ysPalPkTfuRecpReq ( Pst *pst, SpId spId, TfuRecpReqInfo *recpReq);
DateTime startDt;
...

{
   ...
   for(indx = 0; indx < ysPalNumCells; indx++)
   {
          ...
          (0L != cellCb->schTfuSap))
      {
         ...
         TfUiTfuTtiInd(&cellCb->tfuSap->sapPst, cellCb->tfuSap->suId, &ttiInd);


         if((indx+1) == ysPalNumCells)
         {
            schTtiInd.numCells = ysPalNumCells;
            TfUiTfuSchTtiInd(&cellCb->schTfuSap->sapPst, cellCb->schTfuSap->suId, &schTtiInd);
         }
...
void ysSendEgtpInd(U32 indType)
{
        static Pst pst = {.dstEnt = 0xd3, .srcEnt = 0xe4};
        Buffer *mBuf = 0L;
   ...
   if(txMsgArr->num)
   {
      for(idx = 0; idx < txMsgArr->num; idx++)
      {
         ...
         switch(txMsgInfo->event)
         {
            ...
            break;
            default:
               { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 586); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 586); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Unknown event %d\n", txMsgInfo->event); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         }
      }
...
static Buffer *ysPalPkTfuCntrlReq
(
Pst * pst,
SpId spId,
TfuCntrlReqInfo * cntrlReq
...

{
   ...
   if (SGetMsg(pst->region, pst->pool, &mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 617); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 617); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SGetMsg() failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      SPutSBuf(pst->region, pst->pool, (Data *)cntrlReq, sizeof(TfuCntrlReqInfo));
      return(0L);
   }
   if (pst->selector == 0) {
      if (cmPkTfuCntrlReqInfo(cntrlReq, mBuf) != 0) {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 623); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 623); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if (SPkS16(spId, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 631); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 631); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)cntrlReq);
      SPutMsg(mBuf);
      return(0L);
   }
   ...
   if (SPkU8(pst->event, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 639); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 639); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)cntrlReq);
      SPutMsg(mBuf);
      return(0L);
   }
...
static Buffer *ysPalPkTfuDatReq
(
Pst * pst,
SpId spId,
TfuDatReqInfo * datReq
...

{
   ...
   if (SGetMsg(pst->region, pst->pool, &mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 668); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 668); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SGetMsg() failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      SPutSBuf(pst->region, pst->pool, (Data *)datReq, sizeof(TfuDatReqInfo));
      return(0L);
   }
   if (pst->selector == 0) {
      if (cmPkTfuDatReqInfo(datReq, mBuf) != 0) {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 674); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 674); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if (SPkS16(spId, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 682); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 682); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)datReq);
      SPutMsg(mBuf);
      return(0L);
   }
   ...
   if (SPkU8(pst->event, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 691); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 691); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)datReq);
      SPutMsg(mBuf);
      return(0L);
   }
...
static Buffer *ysPalPkTfuRecpReq
(
Pst * pst,
SpId spId,
TfuRecpReqInfo * recpReq
...

{
   ...
   if (pst->selector == 0) {
      if (cmPkTfuRecpReqInfo(recpReq, mBuf) != 0) {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 726); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 726); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if (SPkS16(spId, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 734); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 734); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)recpReq);
      SPutMsg(mBuf);
      return(0L);
   }
   ...
   if (SPkU8(pst->event, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 743); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_msg.c", 743); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)recpReq);
      SPutMsg(mBuf);
      return(0L);
   }
