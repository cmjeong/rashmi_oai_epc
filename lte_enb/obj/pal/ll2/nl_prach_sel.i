...
static S16 nlCheckIfRootSeqIndexIsUnique ( NlTmpNghCellCfg *nghCellCfg, U32 rootSeqIdx )


  ;

static U16 nlCalcTotalResElemGrps ( U8 bw, U8 cfi, U8 numAntna, Bool isEcp )
...
static U16 nlCalcPhichResElemGrps ( U8 bw, U8 ng6 )


  ;

static S16 nlPrachSelPrachFreqOffsetByDSon ( NlCellCb *cellCb )

  ;

static U8 nlCalcNumCce ( U8 bw, NlPhichNg ng, U8 cfi, U8 mi, U8 numAntna, Bool isEcp )
...
static S16 nlPrachSelPrachCfgIndxByDSon ( NlEventMsg *evtMsg, NlCellCb *cellCb )


  ;

static S16 nlPrachSelZeroCorrZoneCfgByDSon ( NlEventMsg *evtMsg, NlCellCb *cellCb )


  ;

static S16 nlSelPrachInfoByDSon ( NlCellCb *cellCb, NlEventMsg *evtMsg, NlAlarm *alarm )
...
static S16 nlPrachSelRootSeqIdxByDSon ( NlEventMsg *evtMsg, NlCellCb *cellCb, NlAlarm *alarm )



  ;

static S16 nlBldNghRootSeqIndexs ( NlCellCb *cellCb, NlTmpNghCellAdd *nghCellAdd, NlAlarm *alarm )



  ;
 S16 nlValidateCellPrachCfg
(
...

{
   ...
   do
   {
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb0001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",176, "Empty PRACH root sequence List received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
      if(0 == prachCfg->numPrachCfgIdx)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb0002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",182, "Empty PRACH config index List received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
      if(0 == prachCfg->numZeroCorrCfgZone)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb0003, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",188, "Empty PRACH Zero correlation config zone List received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
      if(0 == prachCfg->numFreqOffset)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb0004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",194, "Empty PRACH Frequency Offset List received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
   }while(0);
...

{
   ...
   switch(dlbW)
   {
      ...
      case 5:
         ...
         break;
      default:
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb0005, L_ERROR, dlbW, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",251, "Unknown bwIn [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         bwOut = 6;
         break;
   }
   return(bwOut);
}
static S16 nlDlNpValueInit
(
NlCellCb *cellCb
)
...

{
   ...
   for(idx=1; idx < 5; idx++)
   {
      npVal = cellCb->bandWidth * (idx * 12 - 4);
      cellCb->pucchResCfg.mappingNpwithP[idx] = (U8) (npVal/36);
   }

   return(0);
}
 S16 nlCellStorePrachCfg
(
NlCellCb *cellCb,
LnlCellCfg *cellCfg
)
...
)
{
   ...
   switch(nlCb.genCfg.prachSelType)
   {
      case NL_PRACH_SEL_DISABLE :
      {
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0xfb0006, L_INFO, cellCb->prachCfg.servRootSeqIdx, cellCb->prachCfg.servPrachCfgIdx, cellCb->prachCfg.servZeroCorrelationZoneCfg, cellCb->prachCfg.servPrachFreqOffset, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c"         , 406         , "SON selected PRACH Cfg [RootSeqIdx: %d] [PrachCfgIdx: %d] " "[ZeroZoneCfg: %d] [FreqOffset: %d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                                                                                                 ;

         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb0007, L_INFO,cellCb->prachCfg.highSpeedFlag, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",408, "SON Selected PRACH Cfg [HighSpeedFlag: %d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      {
         if(0 == nlSelPrachInfoByDSon(cellCb, evtMsg, alarm))
         {

            if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0xfb0008, L_INFO, cellCb->prachCfg.servRootSeqIdx, cellCb->prachCfg.servPrachCfgIdx, cellCb->prachCfg.servZeroCorrelationZoneCfg, cellCb->prachCfg.servPrachFreqOffset, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c"            , 421            , "SON selected PRACH Cfg [RootSeqIdx: %d] [PrachCfgIdx: %d] " "[ZeroZoneCfg: %d] [FreqOffset: %d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                                                                                                 ;

            if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb0009, L_INFO,cellCb->prachCfg.highSpeedFlag, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",423, "SON Selected PRACH Cfg [HighSpeedFlag: %d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            nlSendPrachParamUpdateInd(cellCb);
            return(0);
         }
      }
...
static U16 nlCalcTotalResElemGrps
(
U8 bw,
U8 cfi,
U8 numAntna,
...
static U16 nlCalcPhichResElemGrps
(
U8 bw,
U8 ng6
)
...
)
{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xfb000a, L_INFO, totalRegs, phichRegs, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c"   , 605   , "TotalRegs is %d and total PhichRegs is %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                   ;

   if(mPhich != 0xff)
   {
      cceRegs = totalRegs - mPhich*phichRegs - 4;
   }
   else
   {
...
static S16 nlPrachSortZeroCorrZoneCfg
(
U8 *zeroCorrZoneCfgArr,
...
static S16 nlPrachSortFreqOffsetCfgVal
(
U8 *prachFreqCfgArr,
...
static S16 nlPrachSelPrachFreqOffsetByDSon
(
NlCellCb *cellCb
)
...

{
   ...
   mixedRb = (((n1Cs) + (8)-1) / (8));
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0xfb000b, L_INFO, n1RbPart, n1Rb, mixedRb, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c"   , 869   , "n1RbPart is %d, n1Rb %d, mixedRb %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                 ;
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb000c, L_INFO, exclRb, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",882, "exclRb is %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   prachRbStart = exclRb/2 + 1;
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb000d, L_INFO,prachRbStart, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",884, "prachRbStart is %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for(cntFreqOff=0; cntFreqOff<numFreqOffset; cntFreqOff++)
   {
         ...
         (cellCb->prachCfg.freqOffset[cntFreqOff] < cellCb->bandWidth))
      {
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb000e, L_INFO, cellCb->prachCfg.servPrachFreqOffset, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c"         , 897         , "Selected PRACH Freq Offset value is %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
         return(0);
      }
      else
   ...
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb000f, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",908, "All PRACH Freq Offsets have startRB > Total DL BW", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb0010, L_INFO, cellCb->prachCfg.servPrachFreqOffset, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c"   , 924   , "Selected PRACH Freq Offset value is %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;

   return(0);
}
static S16 nlPrachExcludePrachCfgIndxByDSon
(
NlCellCb *cellCb,
U8 prachCfgIdx
...
static S16 nlPrachSelPrachCfgIndxByDSon
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...

{
   ...
   Bool prachCfgIndexSelectable = 0;
       ...
       tmpIdxPrachCfgIdxLst ++)
   {
      ...
      {
         if(nlPrachExcludePrachCfgIndxByDSon(cellCb, prachCfgIdx[tmpIdxPrachCfgIdxLst]) == 0)
         {
            prachCfgIndexSelectable = 1;
   ...
   if(nlPrachExcludePrachCfgIndxByDSon(cellCb, minPrachCfgIdx) == 0)
   {
      prachCfgIndexSelectable = 1;
   }
   ...
   if(prachCfgIndexSelectable)
   {
      ...
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb0011, L_INFO, cellCb->prachCfg.servPrachCfgIdx, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",1044, "Selected PRACH Config Index is %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   }
   else
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb0012, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",1048, "PRACH Cfg Index NOT Selectable\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   return(0);
}
static U8 nlFillPreambleFormat
(
NlCellCb *cellCb
)
...

{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xfb0013, L_INFO, preambleFormat, cellCb->prachCfg.servPrachCfgIdx, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",1127, "Preamble format chosen is %d for PrachCfgIdx %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   return(preambleFormat);
}
static S16 nlPrachSelZeroCorrZoneCfgByDSon
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...

{
   ...
   if(64 < numZeroCorrZoneCfg)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb0014, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",1173, "Invalid number of ZeroCorelationZone has congiured", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb0015, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",1232, "All configured values for ZeroCorrelationZoneCfg are not selectable", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   return(0);
}
static S16 nlCheckIfRootSeqIndexIsUnique
(
NlTmpNghCellCfg *nghCellCfg,
U32 rootSeqIdx
)
      ...
      for(numCells = 0; numCells < nghCellAdd->numNgh; numCells++)
      {
         ...
         if(nghCellInfo->isPrachCfg)
         {
                ...
                tmpCounter ++)
            {
               ...
               {
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xfb0016, L_ERROR, selectedRootSeqIndex, nghCellInfo->pci, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c"                  , 1302                  , "Selected RootSeqIdx %d is not unique. Conflict with" "Neighbor with PCI %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
static S16 nlBldNghRootSeqIndexs
(
NlCellCb *cellCb,
NlTmpNghCellAdd *nghCellAdd,
NlAlarm *alarm
...
static S16 nlPrachSelRootSeqIdxByDSon
(
NlEventMsg *evtMsg,
NlCellCb *cellCb,
NlAlarm *alarm
)
{
   ...
   NlTmpNghCellCfg *nghCellCfg = 0L;
   U32 selectedRootSeqIndex = 0xffffffff;
   U32 rootSeqIdxCounter, numNghEnb;
   Bool rootSeqIdxSelectable = 0;
   Bool rootSeqIndxNotInRange = 0;
   ...
   for(numNghEnb = 0; numNghEnb < nghCellCfg->numNghEnb; numNghEnb++)
   {
      switch(nghCellCfg->nghEnbCellCfg[numNghEnb].nghCellParam.cfgType)
      {
         ...
         default :
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb0017, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",1467, "Inavlid neighbor cfg type received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return(1);
         }
      }
   }
       ...
       rootSeqIdxCounter ++)
   {
      ...
      {
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfb0018, L_INFO, selectedRootSeqIndex, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",1486, "Not considering Root sequence Index %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         rootSeqIndxNotInRange = 1;
         continue;
      }

      rootSeqIndxNotInRange = 0;


      if(1 == nlCheckIfRootSeqIndexIsUnique(nghCellCfg,
                                               selectedRootSeqIndex))
      {
         rootSeqIdxSelectable = 1;
         break;
      }
   }

   if(1 == rootSeqIdxSelectable)
   {


      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xfb0019, L_DEBUG, selectedRootSeqIndex, (rootSeqIdxCounter -1), "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c"      , 1507      , "RootSeqIdx (%d) present in the List location (%d) is" "selected", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                     ;
      cellCb->prachCfg.servRootSeqIdx = selectedRootSeqIndex;
   }
   else if(rootSeqIndxNotInRange != 1)
   {
   ...
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfb001a, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_prach_sel.c",1519, "Root-Seq Index NOT selectable !!!!!\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   return(0);
}
 S16 nlSelPrachInfoByDSon
(
NlCellCb *cellCb,
NlEventMsg *evtMsg,
NlAlarm *alarm
)
{
   ...
   if(nlPrachSelPrachCfgIndxByDSon(evtMsg, cellCb) != 0)
   {
      return(1);
   }


   if(nlPrachSelZeroCorrZoneCfgByDSon(evtMsg, cellCb) != 0)
   {
      return(1);
   }


   if(nlPrachSelPrachFreqOffsetByDSon(cellCb) != 0)
   {
      return(1);
   }


   cellCb->prachCfg.highSpeedFlag = 0;


   if(nlPrachSelRootSeqIdxByDSon(evtMsg, cellCb, alarm) != 0)
   {
      return(1);
   }
