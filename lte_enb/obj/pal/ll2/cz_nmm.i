...
static Bool czNmmCmpIpAddr ( CmNetAddr *peerAddr, CmNetAddr *dstAddr );


static S16 czNmmHdlProcErrInd (CzPeerCb *peerCb, CztEvnt *evnt, U8 msgDirectn)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmFndPeer"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",108, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };



   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",112, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Finding peer with peerId (%ld)", peerId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   *peer = 0L;

   found = cmHashListFind(&czCb.nodeCb.peerCbLst, (U8 *)&peerId,
         sizeof (U32), 0, (U32 *)peer);
   if (found == 0)
   {
      peerCb = *peer;
      do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",132, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Peer Cb Found.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",133, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "For peer with peerId (%ld)", peerCb->peerId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",134, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",137, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
}
 S16 czNmmInitPeerLst
(
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmInitPeerLst"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",161, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",162, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Initializing Peerid list.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);

   ret = cmHashListInit(&czCb.nodeCb.peerCbLst,
            1024,
            0,
            0,
            4,
   ...
   if (ret == 0)
   {
      ret = cmHashListInit(&czCb.nodeCb.dynamPeerAssocLst,
            1024,
            0,
            0,
            4,
      ...
      if(ret != 0)
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",185, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "dynamPeerAssocLst Hash List failed                  to initialize. "); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                    ;
   ...
   {
         do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",192, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "peerCbLst Hash List failed                  to initialize. "); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                    ;
   }


   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",196, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(ret); }while(0);
}
 S16 czNmmAllocPeerCb
(
U32 peerId,
CzPeerCb **peer
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmAllocPeerCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",231, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",233, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Allocating PeerCb.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   ...
   { if (SGetSBuf(czCb.init.region, czCb.init.pool, (Data**)&peerCb, sizeof(CzPeerCb)) == 0) { cmMemset((U8*)peerCb, 0, sizeof(CzPeerCb)); czCb.genSta.memAlloc += (sizeof(CzPeerCb)); } else { CzUstaDgn _dgn; peerCb = 0L; _dgn.alarmType = 2; _dgn.u.mem.region = czCb.init.region; _dgn.u.mem.pool = czCb.init.pool; czLmmSendLmAlarm (4, 12, 15, &_dgn); } };
   ...
   if(peerCb == 0L)
   {
      ...
      SLogError(0, 0, 0,
            "/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c", 248, (ErrCls)0x1,
            (ErrVal)(0 + 15), (ErrVal)0, "Memory allocaiton failed");

      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",252, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAllocPeerCb: Couldn't allocate memory for peerCB\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                      ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",253, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(4); }while(0);
   }


   { if (SGetSBuf(czCb.init.region, czCb.init.pool, (Data**)&peerCb->assocCb, sizeof(CzAssocCb)) == 0) { cmMemset((U8*)peerCb->assocCb, 0, sizeof(CzAssocCb)); czCb.genSta.memAlloc += (sizeof(CzAssocCb)); } else { CzUstaDgn _dgn; peerCb->assocCb = 0L; _dgn.alarmType = 2; _dgn.u.mem.region = czCb.init.region; _dgn.u.mem.pool = czCb.init.pool; czLmmSendLmAlarm (4, 12, 15, &_dgn); } };
   if(peerCb->assocCb == 0L)
   {
      SLogError(0, 0, 0,
            "/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c", 261, (ErrCls)0x1,
            (ErrVal)(0 + 15), (ErrVal)0, "Memory allocaiton failed");
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",264, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAllocPeerCb: Couldn't allocate memory for assocCB\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                       ;
      { if (peerCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb, sizeof(CzPeerCb)); czCb.genSta.memAlloc -= (sizeof(CzPeerCb)); peerCb = 0L; } };
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",266, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }


   { if (SGetSBuf(czCb.init.region, czCb.init.pool, (Data**)&peerCb->assocCb->assocCfg, sizeof(CzAssocCfg)) == 0) { cmMemset((U8*)peerCb->assocCb->assocCfg, 0, sizeof(CzAssocCfg)); czCb.genSta.memAlloc += (sizeof(CzAssocCfg)); } else { CzUstaDgn _dgn; peerCb->assocCb->assocCfg = 0L; _dgn.alarmType = 2; _dgn.u.mem.region = czCb.init.region; _dgn.u.mem.pool = czCb.init.pool; czLmmSendLmAlarm (4, 12, 15, &_dgn); } };

   if(peerCb->assocCb->assocCfg == 0L)
   {
      SLogError(0, 0, 0,
            "/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c", 275, (ErrCls)0x1,
            (ErrVal)(0 + 15), (ErrVal)0, "Memory allocaiton failed");
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",278, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAllocPeerCb: Couldn't allocate memory for assocCfg\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                        ;
      { if (peerCb->assocCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb->assocCb, sizeof(CzAssocCb)); czCb.genSta.memAlloc -= (sizeof(CzAssocCb)); peerCb->assocCb = 0L; } };
      { if (peerCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb, sizeof(CzPeerCb)); czCb.genSta.memAlloc -= (sizeof(CzPeerCb)); peerCb = 0L; } };
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",281, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }

   ret = cmHashListInit(&peerCb->ueCbHlCp,
            1024,
            0,
            0,
            4,
   ...
   if(ret == 0)
   {
      ret = cmHashListInit(&peerCb->resrcCbHlCp,
            1024,
            0,
            0,
            4,
      ...
      if (ret == 0)
      {
         ...
         do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",305, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "For peer with peerId (%ld)", peerCb->peerId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);;
      ...
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",328, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "resrcCbHlCp Hash List failed                  to initialize. "); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                    ;
         cmHashListDeinit(&peerCb->ueCbHlCp);
      }
   }
   ...
   {
         do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",335, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "ueCbHlCp Hash List failed                  to initialize. "); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                    ;
   }

   if (ret != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",341, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAllocPeerCb: Failure in the Hash List Operation\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                     ;


      { if (peerCb->assocCb->assocCfg != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb->assocCb->assocCfg, sizeof(CzAssocCfg)); czCb.genSta.memAlloc -= (sizeof(CzAssocCfg)); peerCb->assocCb->assocCfg = 0L; } };
      { if (peerCb->assocCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb->assocCb, sizeof(CzAssocCb)); czCb.genSta.memAlloc -= (sizeof(CzAssocCb)); peerCb->assocCb = 0L; } };
      { if (peerCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb, sizeof(CzPeerCb)); czCb.genSta.memAlloc -= (sizeof(CzPeerCb)); peerCb = 0L; } };
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",347, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",350, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Initializing Timers.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);

   cmInitTimers(&peerCb->gpmCb.gpTimer, 1);
   *peer = peerCb;

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",355, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmDeallocPeerCb
(
CzPeerCb *peerCb
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmDeallocPeerCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",387, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",398, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "For peer with peerId (%ld)", peerCb->peerId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);;
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",399, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Deallocating PeerCb.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   found = cmHashListFind(&czCb.nodeCb.peerCbLst, (U8 *)&peerCb->peerId,
                    sizeof (U32), 0, (U32 *)&locPeerCb);

   if(found != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",406, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmDeallocPeerCb: peer not found in Hash list\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",407, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }


   ret = cmHashListDelete (&czCb.nodeCb.peerCbLst,(U32)locPeerCb);
   if(ret != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",415, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmDeallocPeerCb:Peer Could not be deleted from czCb HashList\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                               ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",416, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",429, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmDisablePeer
(
CzPeerCb *peerCb,
Bool assocTerm
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmDisablePeer"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",462, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",472, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "For peer with peerId (%ld)", peerCb->peerId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);;
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",473, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Disabling peerCb.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   ...
   if(assocTerm)
   {
      ...
      ret = czTpmTermAssoc(peerCb->assocCb, 0);
      if (ret == 0)
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",487, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
      }

      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",491, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmDisablePeer: Call to czLiTermAssoc Failed Assoc is down\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                              ;
   }

   czNmmResetPeer(peerCb);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",496, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmAddUeCb
(
CzPeerCb *peerCb,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmAddUeCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",543, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",545, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Adding UeCb oldUEX2APId = %d.\n",oldUEX2APId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);

   if(peerCb == 0L)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",550, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Null Peer Pointer as the Argument\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                  ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",551, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",553, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "For peer with peerId (%ld)", peerCb->peerId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);;

   if(ueCb == 0L)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",558, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Null ueCb Pointer as the Argument\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                  ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",559, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }

   *ueCb = 0L;

   { if (SGetSBuf(czCb.init.region, czCb.init.pool, (Data**)&tmpUeCb, sizeof(CzUeCb)) == 0) { cmMemset((U8*)tmpUeCb, 0, sizeof(CzUeCb)); czCb.genSta.memAlloc += (sizeof(CzUeCb)); } else { CzUstaDgn _dgn; tmpUeCb = 0L; _dgn.alarmType = 2; _dgn.u.mem.region = czCb.init.region; _dgn.u.mem.pool = czCb.init.pool; czLmmSendLmAlarm (4, 12, 15, &_dgn); } };

   if(tmpUeCb == 0L)
   {
      SLogError(0, 0, 0,
            "/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c", 569, (ErrCls)0x1,
            (ErrVal)(0 + 15), (ErrVal)0, "Memory allocaiton failed");
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",572, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Couldn't allocate memory for ueCb\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                  ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",573, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(4); }while(0);
   }


   cmInitTimers(tmpUeCb->bmpTimers, 2);


   tmpUeCb->peerCb = peerCb;
   tmpUeCb->oldUEX2APId = oldUEX2APId;
   tmpUeCb->newUEX2APId = 0xFFFF;
   tmpUeCb->ueCbKey = ueCbKey;
   keyPrefix = (((U32)(ueCbKey) >> 16) & 0xffffL); keyPrefix = ((U16)(keyPrefix) & 0xff);;

   tmpUeCb->eNbType = (U8) keyPrefix;


   ret = cmHashListInsert (&peerCb->ueCbHlCp, (U32)tmpUeCb,
         (U8 *)&tmpUeCb->ueCbKey, sizeof (U32));

   if(ret != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",595, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Couldn't Insert ueCb in the peerCb->ueCbHlCp\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                             ;
      { if (tmpUeCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)tmpUeCb, sizeof(CzUeCb)); czCb.genSta.memAlloc -= (sizeof(CzUeCb)); tmpUeCb = 0L; } };
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",597, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   ...
   *ueCb = tmpUeCb;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",605, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmFindUeCb
(
CzPeerCb *peerCb,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmFindUeCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",642, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };



   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",646, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Finding UeCb. Key = %ld\n", ueCbKey); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   *ueCb = 0L;

   found = cmHashListFind(&peerCb->ueCbHlCp, (U8 *)&ueCbKey,
         sizeof(U32), 0, (U32 *)ueCb);

   if (found == 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",665, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "UE found.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",666, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",669, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
}
 S16 czNmmDelUeCb
(
CzUeCb *ueCb
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmDelUeCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",700, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",715, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Deleting UE. UE Key = %ld\n", ueCb->ueCbKey); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);

   found = cmHashListFind(&ueCb->peerCb->ueCbHlCp, (U8 *)&ueCb->ueCbKey,
         sizeof (U32), 0, (U32 *)&locUeCb);
   if (found != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",722, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmDelUeCb: UeCb not found in HAsh list\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                           ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",723, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
    ret = cmHashListDelete (&ueCb->peerCb->ueCbHlCp,(U32)locUeCb);

   if(ret != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",730, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmDelUeCb: HAsh list Delete Failed\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                       ;
   }
   ...
   { if (locUeCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)locUeCb, sizeof(CzUeCb)); czCb.genSta.memAlloc -= (sizeof(CzUeCb)); locUeCb = 0L; } };

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",740, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmAddRsrcCb
(
CzPeerCb *peerCb,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmAddRsrcCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",781, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",801, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Adding RsrcCb. eNb1MeasId = %d\n", eNb1MeasId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   *rsrcCb = 0L;


   { if (SGetSBuf(czCb.init.region, czCb.init.pool, (Data**)&rsCb, sizeof(CzRsrcCb)) == 0) { cmMemset((U8*)rsCb, 0, sizeof(CzRsrcCb)); czCb.genSta.memAlloc += (sizeof(CzRsrcCb)); } else { CzUstaDgn _dgn; rsCb = 0L; _dgn.alarmType = 2; _dgn.u.mem.region = czCb.init.region; _dgn.u.mem.pool = czCb.init.pool; czLmmSendLmAlarm (4, 12, 15, &_dgn); } };
   if(rsCb == 0L)
   {
      SLogError(0, 0, 0,
            "/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c", 809, (ErrCls)0x1,
            (ErrVal)(0 + 15), (ErrVal)0, "Memory allocaiton failed");
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",812, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAddRsrcCb: Couldn't allocate memory for ueCb\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                  ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",813, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(4); }while(0);
   }


   rsCb->peerCb = peerCb;
   rsCb->eNb1MeasId = eNb1MeasId;
   rsCb->eNb2MeasId = 0xFFFF;
   rsCb->rsrcCbKey = rsrcCbKey;
   rsCb->state = CZ_RSRC_IDLE;
   rsCb->retxBuf = 0L;


   ret = cmHashListInsert (&peerCb->resrcCbHlCp, (U32)rsCb,
         (U8 *)&rsCb->rsrcCbKey, sizeof (U32));
   if(ret != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",830, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAddRsrcCb: Couldn't Insert the rsCb into the Hash List\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                            ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",831, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }

   *rsrcCb = rsCb;

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",836, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmFindRsrcCb
(
CzPeerCb *peerCb,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmFindRsrcCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",870, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };



   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",874, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Finding RsrcCb. Key = %ld\n", rsCbKey); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   *rsCb = 0L;
   found = cmHashListFind(&peerCb->resrcCbHlCp, (U8 *)&rsCbKey,
         sizeof (U32), 0, (U32 *)rsCb);

   if (found == 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",902, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Rsrc Cb Found.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",903, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",906, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
}
 S16 czNmmDelRsrcCb
(
CzRsrcCb *rsCb
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmDelRsrcCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",936, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",937, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Deleting RsrcCb.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",951, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "rsrcCbKey = %ld.\n", rsCb->rsrcCbKey); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);

   found = cmHashListFind(&rsCb->peerCb->resrcCbHlCp, (U8 *)&rsCb->rsrcCbKey,
         sizeof (U32), 0, (U32 *)&locrsCb);
   if (found != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",958, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmDelRsrcCb: rsCb not found in Hash list\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                             ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",959, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   ret = cmHashListDelete (&rsCb->peerCb->resrcCbHlCp,(U32)locrsCb);
   if (ret != 0 )
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",965, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmDelRsrcCb: Deletion from the peerCb->resrcCbHlCp failed\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                             ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",966, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }


   do { if(0L != rsCb->retxBuf) { (Void)SPutMsg(rsCb->retxBuf); rsCb->retxBuf = 0L; } } while(0);

   { if (rsCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)rsCb, sizeof(CzRsrcCb)); czCb.genSta.memAlloc -= (sizeof(CzRsrcCb)); rsCb = 0L; } };

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",974, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 CzPeerCb* czNmmMatchPeer
(
...

{
   ...
   CzPeerCb *nextCb = 0L;
   CzPeerCb *peerCb = 0L;
   CmNetAddr *peerLstAddr = 0L;
   CmNetAddr *dstPeerAddr = 0L;

   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmMatchPeer"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1010, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
      ...
      if(peerCb != 0L)
      {
                       ...
                       dstAddrLst.nmb; idx++)
         {
            ...
            for(nmbPeer = 0; nmbPeer < dstNAddrLst->nmb; nmbPeer++)
            {
               ...
               if(czNmmCmpIpAddr(peerLstAddr, dstPeerAddr) == 1)
               {
                  if(peerCb->assocCb->assocCfg->dstPort == port)
                  {
                     do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1040, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Peer Matched.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
                     do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1041, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(peerCb); }while(0);
                  }
               }
            }
         }
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1051, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Peer Failed to Matched.\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1052, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
}
static Bool czNmmCmpIpAddr
(
CmNetAddr *peerAddr,
CmNetAddr *dstAddr
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmCmpIpAddr"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1086, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   ...
   if((peerAddr->type == dstAddr->type))
   {
      switch (peerAddr->type)
      {
         ...
         default:
            matchFlag = 0;
            do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1120, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmCmpIpAddr: IP Address is other than the IPV4/IPV6\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                            ;
            break;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1130, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(matchFlag); }while(0);
}
 S16 czNmmHdlErrInd
(
CzPeerCb *peerCb,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmHdlErrInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1178, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   ...
   if(16 == ret)
   {
      ...
      if(CZ_DIR_IN == msgDirectn)
      {
         ...
         do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1194, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Delivering Error Indication from peer(%ld)" "to user through NMM \n",(peerCb->peerId)); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                           ;
         ...
         if(0 != ret)
         {
            ...
            do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1212, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Sending Error Indication " "to user(%ld) failed: cause(%d)", peerCb->peerId, ret); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
      ...
      else
      {
         ...
         do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1231, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Sending Error Indication through NMM" "to peer(%ld) on stream(%d)", (peerCb->peerId), peerCb->peerCfg.globalStreamId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
         ...
         if(0 != ret)
         {
            ...
            do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1249, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Sending Error Indication " "to peer(%ld) failed: cause(%d)", peerCb->peerId, ret); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
            ...
            { S16 _ret = 0; CztLclErrInd _errInd; _errInd.peerId = peerCb->peerId; _errInd.causeType = 0x50; _errInd.causeValue = (U8)ret; _errInd.msgType = 7; _ret = czUimSndErrInd (peerCb->cztSapCb, &_errInd, evnt, 0L); if(_ret != 0) { if(evnt != 0L) { do { cmFreeMem((evnt)); (evnt) = 0L; } while(0); } } }
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1275, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(ret); }while(0);
}
static S16 czNmmHdlProcErrInd
(
CzPeerCb *peerCb,
CztEvnt *evnt,
U8 msgDirectn
...
{
   CztCriticalityDiag *criticalityDiag = 0L;
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmHdlProcErrInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1338, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1347, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Handling Error Indication message from (%s)" "through NMM for peer(%ld)\n", ((msgDirectn == CZ_DIR_OUT) ? ("User"):("Peer")), (peerCb->peerId)); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
   ...
   if(CZ_DIR_OUT == msgDirectn || CZ_DIR_IN == msgDirectn)
   {
      ...
      czUtlGetIE(&evnt->pdu, 17, (TknU8 **)&criticalityDiag);
      if(0L != criticalityDiag)
      {
         if(1 == criticalityDiag->procedureCode.pres)
         {

            procCode = (U8)criticalityDiag->procedureCode.val;
            if(1 == criticalityDiag->triggeringMsg.pres)
            {
               ...
               switch(procType)
               {
                  ...
                  case CZ_BMP:
                  {
                     ...
                     do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1379, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(ret); }while(0);
                  }
                  case CZ_GP:
                  {
                     ...
                     do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1386, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(ret); }while(0);
                  }
                  case CZ_ERR:
                  case CZ_PRIV:
                  {
                     ...
                     do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1398, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Error Indication on" "Error Indication / Private Message for peer(%ld)", (peerCb->peerId)); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                  ...
                  default:
                  {
                     if(CZ_DIR_OUT == msgDirectn)
                     {
                        ...
                        do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1415, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Error Indication received " "from user on unknown procedure for peer(%ld)\n", (peerCb->peerId)); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                        ...
                        { S16 _ret = 0; CztLclErrInd _errInd; _errInd.peerId = peerCb->peerId; _errInd.causeType = 0x60; _errInd.causeValue = (U8)(0x60 + 0x02); _errInd.msgType = 255; _ret = czUimSndErrInd (peerCb->cztSapCb, &_errInd, evnt, 0L); if(_ret != 0) { if(evnt != 0L) { do { cmFreeMem((evnt)); (evnt) = 0L; } while(0); } } }



                                                  ;
                        do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1427, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
                     }
                     break;
                  }
               }
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1436, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(ret); }while(0);
}
 S16 czNmmDeallocAllPeerCb
(
SpId sapId,
U8 opn
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmDeallocAllPeerCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1482, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
            ...
            (U32 *)&next) == 0)
   {
      ...
      next->delPcb = (opn == 3) ? 1 : 0;

      czTpmTermAssoc(next->assocCb,1);
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1519, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmAllocDynamPeerCb
(
SuId suId,
CzPeerCb **peer
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmAllocDynamPeerCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1555, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   ...
   *peer = 0L;
   ...
   {
      SLogError(0, 0, 0,
            "/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c", 1568, (ErrCls)0x1,
            (ErrVal)(0 + 15), (ErrVal)0, "Memory allocaiton failed");
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1571, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAllocDynamPeerCb: Couldn't allocate memory for peerCB\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                           ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1572, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(4); }while(0);
   }
   ...
   {
      SLogError(0, 0, 0,
            "/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c", 1580, (ErrCls)0x1,
            (ErrVal)(0 + 15), (ErrVal)0, "Memory allocaiton failed");
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1583, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAllocDynamPeerCb: Couldn't allocate memory for assocCB\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                            ;
      { if (peerCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb, sizeof(CzPeerCb)); czCb.genSta.memAlloc -= (sizeof(CzPeerCb)); peerCb = 0L; } };
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1585, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   ...
   {
      SLogError(0, 0, 0,
            "/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c", 1593, (ErrCls)0x1,
            (ErrVal)(0 + 15), (ErrVal)0, "Memory allocaiton failed");
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1596, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmAllocDynamPeerCb: Couldn't allocate memory for assocCfg\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                             ;
      { if (peerCb->assocCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb->assocCb, sizeof(CzAssocCb)); czCb.genSta.memAlloc -= (sizeof(CzAssocCb)); peerCb->assocCb = 0L; } };
      { if (peerCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb, sizeof(CzPeerCb)); czCb.genSta.memAlloc -= (sizeof(CzPeerCb)); peerCb = 0L; } };
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1599, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }

   peerCb->assocCb->peer = peerCb;

   peerCb->peerCfg.isDynamCfgd = 1;
   ...
   if (ret != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1654, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmDynamAllocPeerCb: Failure in the Hash List Operation\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                          ;
      { if (peerCb->assocCb->assocCfg != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb->assocCb->assocCfg, sizeof(CzAssocCfg)); czCb.genSta.memAlloc -= (sizeof(CzAssocCfg)); peerCb->assocCb->assocCfg = 0L; } };
      { if (peerCb->assocCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb->assocCb, sizeof(CzAssocCb)); czCb.genSta.memAlloc -= (sizeof(CzAssocCb)); peerCb->assocCb = 0L; } };
      { if (peerCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerCb, sizeof(CzPeerCb)); czCb.genSta.memAlloc -= (sizeof(CzPeerCb)); peerCb = 0L; } };

      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1659, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   ...
   *peer = peerCb;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1667, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmDeallocDynamPeerCb
(
CzPeerCb *peer
)
...
{
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmDeallocDynamPeerCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1694, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   cmHashListDeinit(&peer->ueCbHlCp);
   cmHashListDeinit(&peer->resrcCbHlCp);

   { if (peer->assocCb->assocCfg != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peer->assocCb->assocCfg, sizeof(CzAssocCfg)); czCb.genSta.memAlloc -= (sizeof(CzAssocCfg)); peer->assocCb->assocCfg = 0L; } };
   { if (peer->assocCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peer->assocCb, sizeof(CzAssocCb)); czCb.genSta.memAlloc -= (sizeof(CzAssocCb)); peer->assocCb = 0L; } };
   { if (peer != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peer, sizeof(CzPeerCb)); czCb.genSta.memAlloc -= (sizeof(CzPeerCb)); peer = 0L; } };

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1703, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmFindDynamPeerAssocCb
(
CztNetAddrLst *dstAddrLst,
CztPort dstPort,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmFindDynamPeerAssocCb"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1739, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };


   if(peerAssoc == 0L)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1745, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmFindDynamPeerAssocCb: Null peerAssoc as the Argument\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                       ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1746, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   ...
   *peerAssoc = 0L;
   ...
   {
      do { (Void)cmMemset((U8*)(&peerAssocEntry), 0, (Size)sizeof(CzDynamPeerAssocEntry)); } while(0);

      peerAssocEntry.peerAddr.type = dstAddrLst->nAddr[idx].type;

      if (peerAssocEntry.peerAddr.type == 4)
      {
      ...
      ret = cmHashListFind(&(czCb.nodeCb.dynamPeerAssocLst),
            (U8 *) &(peerAssocEntry),
            sizeof(CzDynamPeerAssocEntry), 0, (U32 *) &peerAssocCb);
      if (ret == 0)
      {
         break;
      }
   ...
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1781, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }

   *peerAssoc = peerAssocCb;

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1786, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czNmmRemDynamPeerAssoc
(
CzPeerCb *peer
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmRemDynamPeerAssoc"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1819, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };


   if(peer == 0L)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1825, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmRemDynamPeerAssoc: Null  peer as the Argument\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                   ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1826, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   ...
   for (idx = 0; idx < dstAddrLst->nmb; idx++)
   {
      ...
      cmHashListDelete(&(czCb.nodeCb.dynamPeerAssocLst), (U32)(peerAssocCb));
      { if (peerAssocCb != 0L) { (Void)SPutSBuf(czCb.init.region, czCb.init.pool, (Data*)peerAssocCb, sizeof(CzDynamPeerAssocCb)); czCb.genSta.memAlloc -= (sizeof(CzDynamPeerAssocCb)); peerAssocCb = 0L; } };
   }

   if (allFound == 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1869, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmRemDynamPeerAssoc: No  peer found  \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                         ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1870, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1873, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 Void czNmmResetPeer
(
CzPeerCb *peer
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czNmmResetPeer"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1904, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   while (cmHashListGetNext(&peer->ueCbHlCp, (U32) 0L,
               (U32 *) &ueCb) == 0)
   {
      ret = czNmmDelUeCb(ueCb);
      if(ret != 0)
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1923, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmResetPeer: UE Could not be deleted form ueCbHlCp\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                          ;
      }
      else
      {
   ...
   while (cmHashListGetNext(&peer->resrcCbHlCp, (U32) 0L,
               (U32 *) &rsCb) == 0)
   {
      ret = czNmmDelRsrcCb(rsCb);
       if(ret != 0)
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_nmm.c",1939, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czNmmResetPeer: ResourCb Could not be deleted form rsrcbLst\n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                                               ;
      }
       else
       {
   ...
   do { (Void)cmMemset((U8*)(&peer->peerCfg.peerSts), 0, (Size)sizeof(CzPeerNodeSts)); } while(0);


   do { if(0L != peer->gpmCb.retxBuf) { (Void)SPutMsg(peer->gpmCb.retxBuf); peer->gpmCb.retxBuf = 0L; } } while(0);
