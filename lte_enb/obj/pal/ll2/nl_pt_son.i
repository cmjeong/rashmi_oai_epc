...
static S8 nlCellSelectTxPowerRsysTpm ( NlCellCb *cellCb )

  ;
 S16 nlBuildRemResultInd
(
NlCellCb *cellCb
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc0001, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",96, "In SON PT nlBuildRemResultInd", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 S16 nlBuildPeriodicRemResultInd
(
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc0002, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",127, "In SON PT nlBuildPeriodicRemResultInd", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 S16 nlCellSelectTxPowerByDSon
(
NlCellCb *cellCb
)
...

{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc0003, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",161, "In SON PT nlCellSelectTxPowerByDSon", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0xfc0004, L_INFO, cellCb->txPowerSel.refSignalTxPwr, cellCb->txPowerSel.pssPowerOffset, cellCb->txPowerSel.sssPowerOffset, cellCb->txPowerSel.pbchPowerOffset, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c"   , 190   , "RSYS SON selected RefSigTxPwr: %d pssPowerOffset %d" " sssPowerOffset: %d pbchPowerOffset: %d \n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
 ...
 S16 NlVendorDSonDatInd
(
Pst *pst,
NlVendorDSonEventMsg *evtMsg
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc0005, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",226, "In SON PT NlVendorDSonDatInd", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 S16 nlUnpkVendorDSonDatInd
(
NlVendorDSonDatIndFp func,
Pst *pst,
Buffer *mBuf
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc0006, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",258, "In SON PT nlUnpkVendorDSonDatInd", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 S16 nlVendorDSonConnEstReq
(
Void
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc0007, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",286, "In SON PT nlVendorDSonConnEstReq", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 Void nlInitSonDB
(
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc0008, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",314, "In SON PT nlInitSonDB", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return;
}
 S16 nlReportNumNghToSon
(
U16 numNgh
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc0009, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",344, "In SON PT nlReportNumNghToSon", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 S16 nlConfigUeAddEvtHndlr
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc000a, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",375, "In SON PT nlConfigUeAddEvtHndlr", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 S16 nlConfigUeDeleteEvtHndlr
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc000b, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",406, "In SON PT nlConfigUeDeleteEvtHndlr", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 S16 nlConfigUeMeasRptEvtHndlr
(
NlEventMsg *evtMsg,
NlCellCb *cellCb
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc000c, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",503, "In SON PT nlConfigUeModEvtHndlr", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
 S16 nlShutDownVendorDSon
(
Void
)
...
{
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfc000d, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c",533, "In SON PT nlShutDownVendorDSon", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
static S8 nlCellSelectTxPowerRsysTpm
(
NlCellCb *cellCb
)
...
{
   NlNghServCellCb *strngstNghCell = 0L;
   S8 rsrpDiff;
   S8 rsrpPwr;
   S16 remRsrp;
   ...
   if (strngstNghCell == 0L)
   {
      rsrpPwr = cellCb->txPowerCfg.referenceSignalPwr[0];
      return(rsrpPwr);
   }
   remRsrp = strngstNghCell->servCellInfo.rsrp-144;

   if (remRsrp >= cellCb->tgtRsrp)
   {
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xfc000e, L_INFO, remRsrp, cellCb->tgtRsrp, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c"      , 583      , "RSYS SON TPM Rem Rsrp(%d) of Neigh > Tgt Rsrp %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                      ;
   ...
   else
   {
      ...
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0xfc000f, L_INFO, rsrpDiff, cellCb->tgtRsrp, remRsrp, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_pt_son.c"      , 593      , "RSYS SON TPM rsrpDiff %d, Target Rsrp %d" " Rem Rsrp %d \n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (rsrpDiff <= 20)
      {
         rsrpPwr = rsysTpmTable[cellCb->attnConstIdx][rsrpDiff-1] +
            strngstNghCell->servCellInfo.RSTxPower - -5;

         { if (rsrpPwr > cellCb->rsysTpmRsrpMax) { rsrpPwr = cellCb->rsysTpmRsrpMax; } else if (rsrpPwr < cellCb->rsysTpmRsrpMin) { rsrpPwr = cellCb->rsysTpmRsrpMin; }};
      }
      else
      {
 ...
 Void nlUtlFindStrongestNghCell
(
NlCellCb *cellCb,
