...
inline void rrmFree(U8* pbMsg, U16 usMsgLen)
{
 ...
 S16 PtMiLrmCfgCfm (Pst *pst, RmMngmt *cfg);
 S16 PtMiLrmCntrlCfm (Pst *pst, RmMngmt *cfm );



static LrmCfgCfm rmMiLrmCfgCfmMt[3] =
{
...
static const LrmCntrlCfm RmMiLrmCntrlCfmMt[3] =
{
