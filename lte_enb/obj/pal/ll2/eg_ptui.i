...
extern S16 egUtlDelTknStrOSXL ( TknStrOSXL *delTknStrOSXL )
                                                            ;
static S16 PtUiEgtBndCfm ( Pst *pst, SuId suId, U8 status);


 S16 PtUiEgtEguLclTnlMgmtCfm (Pst *pst, SuId suId, EgtUEvnt *egtUEvnt);
 S16 PtUiEgtEguStaCfm (Pst *pst, SuId suId, EgtUEvnt *egtUEvnt);
 S16 PtUiEgtEguUStaInd (Pst *pst, SuId suId, EgtUEvnt *egtUEvnt);
 S16 PtUiEgtEguErrInd (Pst *pst, SuId suId, EgtUEvnt *egtUEvnt);
 S16 PtUiEgtEguDatInd (Pst *pst, SuId suId, EgtUEvnt *egtUEvnt);
static const EgtBndCfm EgUiEgtBndCfmMt [3] =
{
...
static const EgtEguLclTnlMgmtCfm EgUiEgtEguLclTnlMgmtCfmMt[3] =
{

   cmPkEgtEguLclTnlMgmtCfm,
...
static const EgtEguStaCfm EgUiEgtEguStaCfmMt[3] =
{
...
static const EgtEguUStaInd EgUiEgtEguUStaIndMt[3] =
{
...
static const EgtEguErrInd EgUiEgtEguErrIndMt[3] =
{
...
static const EgtEguDatInd EgUiEgtEguDatIndMt[3] =
{
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { snprintf((&(egCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->procId, (&(egCb.init))->ent, (&(egCb.init))->inst,
                                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ptui.c"
   ,
                                                                     313
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtBndCfm(pst, suId(%d), status(%d))\n", suId, status); SPrint((&(egCb.init))->prntBuf); } }
                                                                      ;
...

{
   ...
   ,
                                                     353
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtStaCfm(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } }
                                                      ;
...

{
   ...
   ,
                                                         427
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtEguUStaInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } }
                                                          ;
...

{
   ...
   ,
                                                        464
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtEguErrInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } }
                                                         ;
...

{
   ...
   ,
                                                        516
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtEguDatInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } }
                                                         ;
...

{
   ...
   SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_ptui.c", 557, 0x4, ((0 + 0) + 15), 0, (Txt *)"PtUiEgtBndCfm: Invalid selector");;
...

{
   ...
   ,
                                                         667
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "PtUiEgtEguUStaInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } }
                                                          ;


   return(0);
}
 S16 PtUiEgtEguErrInd
(
Pst *pst,
SuId suId,
EgtUEvnt *egtUEvnt
...

{
   ...
   ,
                                                        703
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "PtUiEgtEguErrInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } }
                                                         ;

   return(0);
}
 S16 PtUiEgtEguDatInd
(
Pst *pst,
SuId suId,
EgtUEvnt *egtUEvnt
...

{
   ...
   ,
                                                        739
   ); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "PtUiEgtEguDatInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } }
                                                         ;
