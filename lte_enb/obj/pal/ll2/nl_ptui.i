...
extern S16 nlSendSonMeasRptIntervalInd ( U32 ueMeasInterval, NlCellCb *cellCb )
  ...
  ;
static S16 nlCopyNluNghCellInfo ( NlCellCb *cellCb, NluNeighborReport *srcCellCfg, NlTmpNghCellCfg *tgtCellCfg )



  ;

static S16 nlCopyNluNghCellModInfo ( NluNghCellMod *srcCellMod, NlTmpNghCellMod *tgtCellMod )


  ;

static S16 nlCopyNluNghCellAddInfo ( NlCellCb *cellCb, NluNghCellAdd *srcCellAdd, NlTmpNghCellAdd *tgtCellAdd )



  ;

static S16 nlCopyNluNghCellDelInfo ( NluNghCellDel *srcCellDel, NlTmpNghCellDel *tgtCellDel )


  ;

 NluBndCfm nlLiNluBndCfmMt[3] =
{
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfe0001, L_ERROR,spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ptui.c",193, "Invalid SAP ID %d: NluUiNluBndReq Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      status = 2;
   }
...
static S16 nlCopyNluNghCellModInfo
(
...

{
   ...
   NluNghCellModInfo *nluCellMod = 0L;
   ;;
...
static S16 nlCopyNluNghCellDelInfo
(
...
static S16 nlCopyNluNghCellAddInfo
(
NlCellCb *cellCb,
...

{
   U32 nghCount;
   U32 nghNghCount;
   NluNghCellAddInfo *nluCellAdd = 0L;
   NlTmpNghCellAddInfo *nlCellAdd = 0L;
   ;;
   for(nghCount = 0; nghCount < srcCellAdd->numNgh; nghCount ++)
   {
      ...
      if(!((nluCellAdd->nghCellInfo.pci == cellCb->cellInfo.pci) &&
         ...
         (0 == cmMemcmp((U8 *)&(cellCb->cellInfo.ecgi),
...
static S16 nlCopyNluNghCellInfo
(
NlCellCb *cellCb,
...

{
 ...
 S16 NlUiNluNeighborReq
(
Pst *pst,
SuId suId,
NluNeighborReport *nhbr
)
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfe0002, L_ERROR, nhbr->servCellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ptui.c"      , 548      , "Failed to cell Cb with cell Id %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
      { (Void)SPutSBuf((pst->region), (pst->pool), (Data *)(nhbr), (Size)(sizeof(NluNeighborReport))); (nhbr) = 0L; };
      return(1);
   }
   ...
   switch(nhbr->msgType)
   {
      ...
      default :
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfe0003, L_ERROR, nhbr->msgType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ptui.c"         , 584         , "Invalid message type: %d  received from eNB-APP", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                          ;
         { (Void)SPutSBuf((pst->region), (pst->pool), (Data *)(nhbr), (Size)(sizeof(NluNeighborReport))); (nhbr) = 0L; };
         return(1);
      }
...

{
   ...
   if(0 != cmHashListFind(&(nlCb.cellCbList), (U8 *)&hashKey,
     sizeof(hashKey), 0, (U32 *)&cellCb))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfe0004, L_ERROR, pciMod->ecgi.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ptui.c"      , 645      , "Failed to cell Cb with cell Id %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                  ;
      { (Void)SPutSBuf((pst->region), (pst->pool), (Data *)(pciMod), (Size)(sizeof(NluPciModIndCfm))); (pciMod) = 0L; };
      return(1);
   }
   ...
   if(cellCb->pciModAlarmInfo.isAlarmSend)
   {
      ...
      cellCb->pciModAlarmInfo.isAlarmSend = 0;
   }

   { cellCb->state = NL_CELL_STATE_CONFIGURED; };


   ((((link) = ((&cellCb->pciModPendMsg.nghCfgMsgList)->crnt = (&cellCb->pciModPendMsg.nghCfgMsgList)->first)) != 0L) ? (link)->node : 0L);
   while(0L != link)
   {
      ...
      { (Void)SPutSBuf((nlCb.init.region), (nlCb.init.pool), (Data *)(nghPendMsg), (Size)(sizeof(NlNghCfgPendMsg))); (nghPendMsg) = 0L; };
      link = 0L;
      ((((link) = ((&cellCb->pciModPendMsg.nghCfgMsgList)->crnt = (&cellCb->pciModPendMsg.nghCfgMsgList)->first)) != 0L) ? (link)->node : 0L);
   }
   ...
   while(0L != link)
   {
      ...
      { (Void)SPutSBuf((nlCb.init.region), (nlCb.init.pool), (Data *)(reCfgPendMsg), (Size)(sizeof(NlCellReCfgPendMsg))); (reCfgPendMsg) = 0L; };
      link = 0L;
      ((((link) = ((&cellCb->pciModPendMsg.cellReCfgMsgList)->crnt = (&cellCb->pciModPendMsg.cellReCfgMsgList)->first)) != 0L) ? (link)->node : 0L);
   }
...

{
   ...
   if(0 != cmHashListFind(&(nlCb.cellCbList), (U8 *)&hashKey,
      sizeof(hashKey), 0, (U32 *)&cellCb))
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfe0005, L_ERROR, ueInfo->ecgi.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ptui.c"       , 743       , "Failed to cell Cb with cell Id for UeInd%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                 ;
       { (Void)SPutSBuf((pst->region), (pst->pool), (Data *)(ueInfo), (Size)(sizeof(NluUeInfo))); (ueInfo) = 0L; };
       return(1);
   }
...

{
   ...
   if(0 != cmHashListFind(&(nlCb.cellCbList), (U8 *)&hashKey,
      sizeof(hashKey), 0, (U32 *)&cellCb))
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfe0006, L_ERROR, measRpt->ecgi.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ptui.c"       , 810       , "Failed to cell Cb with cell Id for MeasRpt%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                  ;
       { (Void)SPutSBuf((pst->region), (pst->pool), (Data *)(measRpt), (Size)(sizeof(NluUeMeasRpt))); (measRpt) = 0L; };
       return(1);
   }
...

{
   ;;
      ...
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xfe0007, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ptui.c",860, "Periodic Cell search Rsp for REM received at SON", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      nlHdlPeriodicRemCellSrchRsp(cellSrchRsp);

   { (Void)SPutSBuf((pst->region), (pst->pool), (Data *)(cellSrchRsp), (Size)(sizeof(NluPeriodicRemCellSearchRsp))); (cellSrchRsp) = 0L; }
                                             ;

   return(0);
}
 S16 NlUiNluUeCqiReportInd
(
Pst *pst,
SuId suId,
NluUeCqiRpt *cqiRpt
...

{
   ...
   if(0 != cmHashListFind(&(nlCb.cellCbList), (U8 *)&hashKey,
      sizeof(hashKey), 0, (U32 *)&cellCb))
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xfe0008, L_ERROR, cqiRpt->cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_ptui.c"       , 910       , "Failed to cell Cb with cell Id for CqiRpt%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
       { (Void)SPutSBuf((pst->region), (pst->pool), (Data *)(cqiRpt), (Size)(sizeof(NluUeCqiRpt))); (cqiRpt) = 0L; };
       return(1);
   }
