...
extern Void TSL2SendStatsToApp ( Pst *pst, SuId suId )
 ...
 TSL2CellStatsCb* l2CellStats[12];
 TSL2UeStatsCb* l2UeStats[120];
 CmLListCp freeL2UeStatsLst;
 CmLListCp inUseL2UeStatsLst;
