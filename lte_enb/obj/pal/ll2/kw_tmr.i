...
static Void kwBndTmrExpiry(U32 cb);
 Void kwStartTmr
(
KwCb *gCb,
U32 cb,
...

{
   ...
   switch (tmrEvnt)
   {
      case 1:
      {
         ...
         { (arg.wait) = ((umUl->reOrdTmrInt) * 100)/((gCb->genCfg.timeRes) * 1000); if((0 != (umUl->reOrdTmrInt)) && (0 == (arg.wait))) { (arg.wait) = 1; } };
      ...
      case 2:
      {
         ...
         { (arg.wait) = ((amUl->reOrdTmrInt) * 100)/((gCb->genCfg.timeRes) * 1000); if((0 != (amUl->reOrdTmrInt)) && (0 == (arg.wait))) { (arg.wait) = 1; } };
      ...
      case 3:
      {
         ...
         { (arg.wait) = ((amUl->staProhTmrInt) * 100)/((gCb->genCfg.timeRes) * 1000); if((0 != (amUl->staProhTmrInt)) && (0 == (arg.wait))) { (arg.wait) = 1; } }
      ...
      case 4:
      {
         ...
         { (arg.wait) = ((amDl->pollRetxTmrInt) * 100)/((gCb->genCfg.timeRes) * 1000); if((0 != (amDl->pollRetxTmrInt)) && (0 == (arg.wait))) { (arg.wait) = 1; } }
      ...
      case 5:
      {
         ...
         { (arg.wait) = ((rguSap->bndTmrInt) * 100)/((gCb->genCfg.timeRes) * 1000); if((0 != (rguSap->bndTmrInt)) && (0 == (arg.wait))) { (arg.wait) = 1; } };
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xca0001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_tmr.c",212, "Invalid tmr Evnt", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      }
   }
...

{
   ...
   switch (tmrType)
   {
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xca0002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_tmr.c",307, "Invalid tmr Evnt", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      }
   }
   if (tmrType != 0)
   {
...

{
   ...
   switch (tmrEvnt)
   {
      case 1:
      {
         ...
         kwUmmReOrdTmrExp(kwCb[ulRbCb->inst], ulRbCb);
      ...
      {
         KwUlRbCb *ulRbCb = (KwUlRbCb *)cb;
         kwAmmReOrdTmrExp(kwCb[ulRbCb->inst], ulRbCb);
         break;
      }
      case 3:
      {
         KwUlRbCb *ulRbCb = (KwUlRbCb *)cb;
         kwAmmStaProTmrExp(kwCb[ulRbCb->inst], ulRbCb);
...

{
   ...
   switch (tmrEvnt)
   {
      ...
      case 5:
      {
         return (((KwRguSapCb *)cb)->bndTmr.tmrEvnt == 5);
      }
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xca0003, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_tmr.c",455, "Invalid tmr Evnt", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      }
   }

   return(0);
}
static Void kwBndTmrExpiry
(
U32 cb
)
...

{
   ...
   if (rguSapCb->state == 3)
   {
      if (rguSapCb->retryCnt < 3)
      {

         kwStartTmr(kwCb[rguSapCb->pst.srcInst],
                    (U32)rguSapCb,
                    5);
      ...
      else
      {
         rguSapCb->retryCnt = 0;
         rguSapCb->state = 1;
         kwLmmSendAlarm(kwCb[rguSapCb->pst.srcInst],
                        2,
                        8,
                        10,
                        0,
