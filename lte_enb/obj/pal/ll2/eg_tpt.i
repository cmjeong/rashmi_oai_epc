...
extern S16 egUtlDelTknStrOSXL ( TknStrOSXL *delTknStrOSXL )
                                                            ;
static S16 egUTptPartialReadGTPuMsg
(
Buffer *mBuf,
...

{
   ...
   SFndLenMsg(mBuf, &bufLen);
    ...
    { U16 nwWord[0x02]; U32 tmpU32 = 0; U16 tmpCnt = count; nwWord[0] = 0; nwWord[1] = 0; { U8 nwByte[0x02]; U16 tmpU16 = 0; U16 tmpCnt1 = tmpCnt; nwByte[0] = 0; nwByte[1] = 0; SExamMsg(&nwByte[0], mBuf, tmpCnt1); tmpCnt1 = tmpCnt1 + 1; SExamMsg(&nwByte[1], mBuf, tmpCnt1); tmpU16 = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(tmpU16) & 0x00ff)); tmpU16 = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(tmpU16) & 0xff00)); nwWord[0] = tmpU16; }; tmpCnt = tmpCnt + 2; { U8 nwByte[0x02]; U16 tmpU16 = 0; U16 tmpCnt1 = tmpCnt; nwByte[0] = 0; nwByte[1] = 0; SExamMsg(&nwByte[0], mBuf, tmpCnt1); tmpCnt1 = tmpCnt1 + 1; SExamMsg(&nwByte[1], mBuf, tmpCnt1); tmpU16 = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(tmpU16) & 0x00ff)); tmpU16 = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(tmpU16) & 0xff00)); nwWord[1] = tmpU16; }; tmpU32 = (U32) (((U32)(nwWord[0]) << 16) | ((U32)(tmpU32) & (U32)0x0000ffff)); tmpU32 = (U32) (((U32)(nwWord[1]) & 0xffff) | ((U32)(tmpU32) & (U32)0xffff0000)); teid = tmpU32; };



    { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",188); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n  TEID(%ld) of Message", teid); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
    ...
    { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",197); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
...

{
   S16 ret;
   EgUEvnt evntMsg;
   EgPartialMsg readMsgVals;

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",232); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",234); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Process the Message from Peer "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",251); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Reading Failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };



      { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",255); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };


      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",258); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(ret); };
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",268); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Received Message: MessageType (%d) Local Teid(%ld)", readMsgVals.msgType, readMsgVals.teid); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",280); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Message type %d is not allowed on non-default server", readMsgVals.msgType); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }

                                  ;



      { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",284); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",285); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
 ...
 cmMemset( (U8* )&evntMsg, 0, sizeof(EgUEvnt));
         ...
         (evntMsg.msgType == EGT_GTPU_MSG_ECHO_RSP ))
   {
      ...
      for (spId=0;spId < egCb.genCfg.nmbUSaps ; spId++)
      {
         ...
         if(uSapCb != 0L && (uSapCb->cfg.flag == 1))
         {

            cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
            { keyAddr.type = evntMsg.localAddr.type; if(evntMsg.localAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = evntMsg.localAddr.u.ipv4TptAddr.address; } };
            ...
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",357); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n NULL ipCb received for address %lx", keyAddr.u.ipv4TptAddr.address); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }

                                                     ;
               { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",358); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
               { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",359); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
            }

            cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
            { keyAddr.type = evntMsg.remAddr.type; if(evntMsg.remAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = evntMsg.remAddr.u.ipv4TptAddr.address; } };
            ...
            if((dstCb == 0L)&& (0 != ret))
            {
               ...
               { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",404); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
               { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",405); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
         ...
         else
         {
            if( ++uSapCnt == egCb.genCfg.nmbUSaps)
            {
               ...
               { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",414); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n uSapCb not configured"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
               { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",415); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
               { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",416); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
            }
            continue ;
         }
      }
         ...
         (evntMsg.msgType == EGT_GTPU_MSG_END_MARKER))
   {
      ...
      if(ret != 0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",455); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Cannot proceed with Teid processing "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                             ;
         { if (evntMsg.mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",456); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)evntMsg.mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(evntMsg.mBuf); evntMsg.mBuf = 0L; } };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",457); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",465); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egTptSendMsg
(
EgTptSrvCb *serverCb,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",499); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
    ...
    if (ret != 0)
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",520); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"FATAL\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"SendMsg AddMsgRef Failed "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
       { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",521); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
    }




    ret = egTptUdpServerDatReq (serverCb, destAddr, sendBuf, pst,0);
    ...
    if (ret != 0)
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",535); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"DatReq Failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
       { if (sendBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",536); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)sendBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(sendBuf); sendBuf = 0L; } };
    }
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",538); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(ret); };
}
 S16 egTptUdpServerDatReq
(
EgTptSrvCb *serverCb,
CmTptAddr *destAddr,
Buffer *mBuf,
...
)
{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",582); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   tSapCb = egCb.tSapCb;
   ...
   if ((tSapCb == 0L) || (tSapCb->state != 2))
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",601); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n TSap State not bind"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",602); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if (serverCb->state != 1)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",610); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Server State not Enabled"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",611); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   {
   ipHdrParm.type = 4;
   ipHdrParm.u.hdrParmIpv4.tos.pres = 1;
   ...
   if ( tSapCb->trcMask & 0x01)
   {



      egGenTrcInd(tSapCb,2, &serverCb->cfg.tptAddr, destAddr, 0x01, mBuf);
   }
  ...
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",663); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egTptProcessTsapServers
(
EgTSapCb *tsapCb,
...

{
   ...
   EgTptSrvCb *tempSrvCb;
   S16 retVal;


   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",698); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",707); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb->tptSrvCbLst, (S8 *)"tsapCb->tptSrvCbLst"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n tptSrvCbLst is NULLP"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                            ;
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",708); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
    ...
    {
       if ((serverCb = tsapCb->tptSrvCbLst[numSrv]) == 0L)
          continue;
          ...
          case EG_TPT_TPTSRV_OPEN:
             {
                 ...
                 if (egTptOpenServer (serverCb, 0L) != 0)
                    { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",750); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
          ...
          case EG_TPT_TPTSRV_FREE:
             {
                   ...
                   if(serverCb->cfg.gtp_C_Or_U == 1)
                 {




                       if((0 != (retVal = cmHashListFind(&(serverCb->ipCbPtr->tptServCbLst), (U8 *)&(serverCb->portNum),
                                                   sizeof(U16),0,(U32 *)&tempSrvCb))) && tempSrvCb != serverCb)
                      {
                           { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",768); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egTServerCntrl(): Failed to find the tpt server from IpCb hashList"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                                                              ;

                      }
                       else
                      {
                        if ( (retVal = cmHashListDelete(&(serverCb->ipCbPtr->tptServCbLst), (U32)tempSrvCb)) != 0)
                        {
                           { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",776); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egTServerCntrl(): Failed to delete tpt server Control block from hash list"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                                                                      ;
                        }
                     }
                  }
                ...
                tsapCb->tptSrvCbLst[numSrv] = 0L;

             }
             break;
          default:
             {
                { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",813); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid action %d", srvAction); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                              ;
                { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",814); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
             }
       }
   }

    { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",820); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Number of Tpt Server Processed(%d)", processed); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                   ;

    { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",822); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egTptOpenServer
(
EgTptSrvCb *serverCb,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",857); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",859); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Open the TPT Server "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

   cmMemset( (U8* )&sta, 0, sizeof(EgUsta));
    if (serverCb->state != 2)
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",875); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n serverCb is already opened / enabled state, state %d ", serverCb->state); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",882); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
    }
    ...
    if (tsapCb->state != 2)
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",894); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n tsapCb not in enabled state"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                  ;

       sta.dgn.dgnVal[0].type = 3;
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",909); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
    }
    ...
    hitTptProt = 0;
   if (serverCb->cfg.opnSrvTmr.enb == 1)
   {
      if (serverCb->opnSrvCurRetryCnt-- >= 0)
      {
          { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",935); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Decrementing opnSrvCurRetryCnt"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                         ;
          ...
          ret = egSchedTmr(serverCb, 2, 1,
                               serverCb->cfg.opnSrvTmr.val);
          if (ret != 0)
          {
             { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",945); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Failed to start the Timer"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
             { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",946); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(ret); };
          }
      }
      else
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",957); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n opnSrvCurRetryCnt exceeded"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                  ;

         egMiTptSrvCloseInd (serverCb, 0);
        ...
        { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",980); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
      }
   }
  ...
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",997); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 Void egTptCloseServer
(
EgTptSrvCb *serverCb
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1027); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1029); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Close the TPT Server "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };




    if ((serverCb == 0L ) || (serverCb->state == 2))
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 2))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1036); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"DEBUG\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n serverCb->state already disabled."); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
       { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1037); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
    }
    ...
    if (tsapCb->state != 2)
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1047); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n tsapCb not enabled"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
       { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1048); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
    }
    ...
    if (serverCb->cfg.opnSrvTmr.enb == 1)
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1056); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Stop the Open Server Timer if running "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
       (Void) egSchedTmr(serverCb, 2, 2, 0);
    }
  ...
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1086); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
}
 Void egTptIssueDiscReq
(
EgTSapCb *tsapCb,
U8 choice,
ConnId connId
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1117); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   if (tsapCb->state == 2)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1128); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Send TPT Server Disc Req "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                ;

      (Void) EgLiHitDiscReq (&tsapCb->pst, tsapCb->cfg.spId,
                             choice, connId, 4, &tptParam);
     { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1132); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
   }




   { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1138); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n TSAP State not enabled"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1140); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
}
 Void egTptFreeServer
(
EgTptSrvCb *serverCb
)
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1165); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };





   { if (serverCb->cfg.hostName.val != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1171); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)serverCb->cfg.hostName.val, (U32)serverCb->cfg.hostName.len ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) serverCb->cfg.hostName.val, (Size) serverCb->cfg.hostName.len); (serverCb->cfg.hostName.val) = 0L; }};

   { if (serverCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1173); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)serverCb, (U32)sizeof (EgTptSrvCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) serverCb, (Size) sizeof (EgTptSrvCb)); (serverCb) = 0L; }};

  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1175); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
}
 Void egTptDeInit
(
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1202); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   if (0L != egCb.tSapCb)
   {
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1225); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
}
 S16 egCmpTptAddr
(
CmTptAddr *one,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1258); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1270); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if (one->type == 4)
   {
      ...
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1283); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }
      ...
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1296); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1299); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tpt.c",1340); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
