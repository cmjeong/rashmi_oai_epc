...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20003, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",293, "PjUlUdxBndCfm(post, suId(%d), )", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb,cfmInfo->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",313, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20005, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",322, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20006, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",391, "PjUlUdxReEstCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb, reEstCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20007, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",409, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      sizeof (CpjReEstCfmInfo)) != 0)
   {
      ...
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20008, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",425, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20009, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",489, "PjUlUdxUeIdChgCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   cpjSap = &(tPjCb->u.ulCb->cpjSap);

   ret = pjDbmFindUlTransIdLst(tPjCb,secCfgCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2000a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",506, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      sizeof (CpjSecCfgCfmInfo)) != 0)
   {
      ...
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2000b, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",521, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ( pjCfgPrcSecUlCfg(tPjCb,secCfg,cfgCfm) != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2000c,L_ERROR,DBG_UEID, secCfg->ueId, secCfg->cellId, cfgCfm->reason, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                                          529      , "PjUiCpjSecCfgReq  cellId(%d) pjCfgSecCfg Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe2000d, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",602, "PjUlUdxUeIdChgCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb, transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2000e, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",619, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                      ...
                      cfgInfo->newUeInfo, &tStatus)) != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2000f,L_ERROR,DBG_UEID, cfgInfo->ueInfo->ueId, cfgInfo->ueInfo->ueId, cfgInfo->newUeInfo->ueId, cfgInfo->newUeInfo->cellId, status.reason,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                                                      635      , "Cpj UeId Chg Req" " old-ueId(%d), new-ueId(%d), cellId(%d))Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20010, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",693, "PjUlUdxUeIdChgCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb, cntCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20011, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",710, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      sizeof (CpjCountCfmInfo)) != 0)
   {
      ...
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20012, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",726, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20013,L_ERROR,DBG_UEID, countReq->ueId, countReq->cellId, countCfm->reason, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                                                  735      , "PjUiCpjCountReq cellId(%d)  pjCfgSecCfg Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20014, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",786, "PjUlUdxSduStaCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;
   cpjSap = &(tPjCb->u.ulCb->cpjSap);
   ret = pjDbmFindUlTransIdLst(tPjCb, staCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20015, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",803, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if (0 == staCfm->status)
   {
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20016,L_ERROR,DBG_UEID, staReq->ueId,staReq->cellId, 0, 0, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"         ,                                                                             815         , "PjUlUdxSduStaReq ,cellId(%d) pjCfgSecCfg Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                              ;
   ...
   else
   {
      ...
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20017, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",827, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { if (staCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staCfm, (Size) sizeof (UdxSduStaCfmInfo), 0); staCfm = 0L; } };
      ...
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20018,L_DEBUG,DBG_UEID, staCfm->ueId,staCfm->cellId, 0, 0, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                                                                             841      , "PjUlUdxSduStaCfm- UdxSduStaCfm fail - cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                              ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20019, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",886, "PjUlUdxDatResumeCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb, udxDatResumeCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2001a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",903, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2001b, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",918, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (udxDatResumeCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) udxDatResumeCfm, (Size) sizeof (UdxDatResumeCfmInfo), 0); udxDatResumeCfm = 0L; } };
...

{
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2001c,L_ERROR,DBG_CELLID, datFwdCfm->cellId, datFwdCfm->ueId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                           979      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
...
)
{
   ...
   for (idx = 0; idx < cfg->numEnt && idx < 10; idx++)
   {
      ...
      {
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2001d,L_INFO,DBG_CELLID, cfg->cellId, cfg->ueId, 0, 0, 0,                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"         ,                     1089         , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                      ;
         ...
         case 0x01:
            {
               if (entCfg->m.addCfg.rlcInfo.dir & 1)
               {
                              ...
                              entCfg, &ueCb, entCfgCfm) != 0)
                  {
                      ...
                      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2001e,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                      ,                                                                                 1114                      , "UL RB Addition for" "cellId(%d),rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x02:
            {
                   ...
                   (entCfg->m.modCfg.hoInfo.isHoPres & 1))
               {
                  ...
                  if (pjCfgReCfgUlRb(gCb,ueCb, entCfg, entCfgCfm) != 0)
                  {
                     ...
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2001f,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                     ,                                                                             1157                     , "RB Config Modify HO" "for cellId(%d), rbId(%d) Failed :reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
               ...
               else if (entCfg->m.modCfg.hdrCompCfg.hdrCompUsed)
               {
                  ...
                  if (pjCfgReCfgUlRb(gCb,ueCb, entCfg, entCfgCfm) != 0)
                  {
                     ...
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20020,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                     ,                                                                             1189                     , "UL RB Modify Normal" " for cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x03:
            {
               ...
               if (pjCfgDelUlRb(gCb,ueCb,entCfg, entCfgCfm) != 0)
               {
                  ...
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20021,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                  ,                                                                           1230                  , "Ul RB Delete for" "cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x04:
            {
               ...
               {
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20022,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                  ,                                                                              1248                  , "UL RB Re-establish " "for cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x05:
            {
               ...
               if (pjCfgDelUlUe(gCb,ueCb,entCfg, entCfgCfm) != 0)
               {
                  ...
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20023,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                  ,                                                                           1267                  , "UL UE Delete for " "cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
