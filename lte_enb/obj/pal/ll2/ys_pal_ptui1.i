...
extern S16 tipSendCtfCfgReq ( Pst* pst, SpId spId, CtfCfgTransId transId, CtfCfgReqInfo * cfgReqInfo )
...
extern S16 tipProcCtfCfgReq ( CtfCfgReq func, Pst* pst, Buffer *mBuf )



  ;

extern S16 tipSendCtfCfgRsp ( Pst* pst, SuId suId, CtfCfgTransId transId, U8 status )
...
extern S16 tipProcCtfCfgCfm ( CtfCfgCfm func, Pst *pst, Buffer *mBuf )
...
extern S16 PtUiTfuBndCfm (Pst* pst, SuId suId, U8 status);


extern S16 PtUiTfuSchBndCfm (Pst* pst, SuId suId, U8 status);



extern S16 PtUiTfuRaReqInd (Pst * pst, SuId suId, TfuRaReqIndInfo * raReqInd);


extern S16 PtUiTfuUlCqiInd (Pst * pst, SuId suId, TfuUlCqiIndInfo * ulCqiInd);


extern S16 PtUiTfuHqInd (Pst * pst, SuId suId, TfuHqIndInfo * hqInd);


extern S16 PtUiTfuSrInd (Pst * pst, SuId suId, TfuSrIndInfo * srInd);



extern S16 PtUiTfuDlCqiInd (Pst * pst, SuId suId, TfuDlCqiIndInfo * dlCqiInd);


extern S16 PtUiTfuDatInd (Pst * pst, SuId suId, TfuDatIndInfo * datInd);


extern S16 PtUiTfuCrcInd (Pst * pst, SuId suId, TfuCrcIndInfo * crcInd);


extern S16 PtUiTfuTimingAdvInd (Pst * pst, SuId suId, TfuTimingAdvIndInfo * timingAdvInd);


extern S16 PtUiTfuTtiInd (Pst * pst, SuId suId, TfuTtiIndInfo * ttiInd);


extern S16 PtUiTfuSchTtiInd (Pst * pst, SuId suId, TfuTtiIndInfo * ttiInd);





extern S16 PtUiCtfBndCfm (Pst* pst, SuId suId, U8 status);


extern S16 PtUiCtfCfgCfm (Pst* pst, SuId suId, CtfCfgTransId transId, U8 status)
                                            ;




static const TfuBndCfm YsUiTfuBndCfmMt[4] =
{
...
static const TfuSchBndCfm YsUiTfuSchBndCfmMt[4] =
{
...
static const TfuRaReqInd YsUiTfuRaReqIndMt[4] =
{
...
static const TfuUlCqiInd YsUiTfuUlCqiIndMt[4] =
{
...
static const TfuHqInd YsUiTfuHqIndMt[4] =
{
...
static const TfuSrInd YsUiTfuSrIndMt[4] =
{
...
static const TfuDlCqiInd YsUiTfuDlCqiIndMt[4] =
{
...
static const TfuDatInd YsUiTfuDatIndMt[4] =
{
...
static const TfuCrcInd YsUiTfuCrcIndMt[4] =
{
...
static const TfuTimingAdvInd YsUiTfuTimingAdvIndMt[4] =
{
...
static const TfuTtiInd YsUiTfuTtiIndMt[4] =
{
...
static const TfuSchTtiInd YsUiTfuSchTtiIndMt[4] =
{
...
static const CtfBndCfm YsUiCtfBndCfmMt[4] =
{
...
static const CtfCfgCfm YsUiCtfCfgCfmMt[4] =
{
...

{
   ...
   if(0L == cellCb)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ptui1.c", 551); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ptui1.c", 551); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", raReqInd->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      return(1);
   }
...

{
   ...
   if(0L == cellCb)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst,
                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ptui1.c"
      ,
                                          604
      ...
      ,
                                          604
      ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", ulCqiInd->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                           ;
      return(1);
   }
...

{
   ...
   if(0L == cellCb)
   {
      ...
      ,
                                      657
      ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", hqInd->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                       ;
      return(1);
   }
...

{
   ...
   if(0L == cellCb)
   {
      ...
      ,
                                       710
      ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", srInd->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                        ;
      return(1);
   }
...

{
   ...
   if(0L == cellCb)
   {
      ...
      ,
                                          765
      ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", dlCqiInd->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                           ;
      return(1);
   }
...

{
   ...
   if(0L == cellCb)
   {
      ...
      ,
                                        827
      ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", datInd->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                         ;
      return(1);
   }
   ...
   if(ret == 1)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ptui1.c", 835); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ptui1.c", 835); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to allocate memory\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      return(1);
   }
   ...
   while (cmLstEnt != 0L)
   {
               ...
               (Ptr *)&crcInfo) != 0)
      {
         ...
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ptui1.c", 853); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ptui1.c", 853); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "cmGetMem() failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         return(1);
      }
...

{
   ...
   if(0L == cellCb)
   {
      ...
      ,
                                              963
      ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", timingAdvInd->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                               ;
      return(1);
   }
...

{
   ...
   if(0L == cellCb)
   {
      ...
      ,
                                                 1016
      ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", ttiInd->cells[0].cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                                  ;
      return(1);
   }
...

{
   ...
   ;;
   for(U32 idx=0; idx<(ttiInd->numCells); idx++)
   {
      ...
      if(0L == cellCb)
      {
         ...
         ,
                                            1066
         ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed Get CellCb for Cell Id = %d\n", ttiInd->cells[idx].cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                             ;
         return(1);
      }
