...
U32 pjTotDlPckCntPerCell;
 S16 pjCiphStateChek (PjCb *gCb, PjTxEnt *txEnt);
 S16 pjDbmDlBufInit
(
PjCb *gCb,
PjBuf *buf,
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd70001, L_DEBUG, numBins, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",127, "pjDbmBufInit(buf, numBins(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&buf->datQ, (Size) (sizeof(CmLListCp) * numBins)) == 0) { cmMemset((U8 *)(buf->datQ), 0, (sizeof(CmLListCp) * numBins)); } else { (buf->datQ) = 0L; } };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd70002, L_DEBUG, sn, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",297, "pjDbmGetTxEnt(buf, sn(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
  ...
  { if (txEnt != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) txEnt, (Size) sizeof(PjTxEnt)); txEnt = 0L; } };
  return(0);
}
 S16 pjDbmDelTxEnt
(
...

{
   ...
   hashKey = (U8)(delEnt->count % 255);
   datQ = &buf->datQ[hashKey];


   cmLListDelFrm(datQ, &delEnt->lstEnt);

   if (delEnt->sduSubmitEnt.node != 0L)
   {
      delEnt->sduSubmitEnt.node = 0L;
      cmLListDelFrm(&buf->sduSubmitQ,&delEnt->sduSubmitEnt);
   }
   if(delEnt->datCfmEnt.node != 0L)
   {
      delEnt->datCfmEnt.node = 0L;
      cmLListDelFrm(&buf->datCfmQ, &delEnt->datCfmEnt);
      pjTotDlPckCntPerCell--;
   }

   if(delEnt->reEstPktEnt.node != 0L)
   {
      delEnt->reEstPktEnt.node = 0L;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd70003, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",476, "pjDbmTxDelAll(buf)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for(i = 0; i< buf->numBins; i++)
   {
      ...
      while(((datQ)->crnt = (datQ)->first))
      {
         ...
         if(lstEnt != 0L)
         {
            txEnt = (PjTxEnt *)((lstEnt)->node);
            if(txEnt->datCfmEnt.node != 0L)
            {
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd70004, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",550, "pjDbmTxDeInit(buf)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd70005, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",593, "pjDbmInit()", RLOG_FILE_ID, RLOG_MODULE_NAME); };



   ret = cmHashListInit(&(gCb->u.dlCb->ueLstCp), (U16) 128,
         (U16) 0, (Bool) 0, (U16) 0,
         gCb->init.region, gCb->init.pool);
   if (ret != 0)
   {

      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd70006, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",603, "pjDbmInit: cmHashListInit Failed for gCb.ueLstCp.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd70007, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",641, "pjDbmDeInit()", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd70008, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",649, "pjDbmDeInit: cmHashListDeinit Failed for gCb.ueLstCp.", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      return(ret);
   }
   return(0);
}
 S16 pjDbmFetchDlRbCb
(
PjCb *gCb,
CmLteRlcId rlcId,
PjDlRbCb **rbCb
...

{
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd70009,L_ERROR,DBG_UEID, rlcId.ueId, rlcId.rbId, rlcId.cellId, 0, 0,                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c"      ,                                       712      , "PJ_VALIDATE_RBID Failed -- rbId(%d), cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (pjDbmFetchDlUeCb(gCb, rlcId.ueId, rlcId.cellId, &ueCb) != 0)
   {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd7000a,L_ERROR,DBG_CELLID, rlcId.cellId, rlcId.ueId, 0, 0, 0,                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c"         ,                      720         , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                       ;
         return(1);
   ...
   if (tRbCb == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd7000b,L_ERROR,DBG_UEID, rlcId.ueId, rlcId.cellId, rlcId.rbId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c"      ,                                    730      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
      return(1);
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd7000c, L_DEBUG, numRbCb, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",777, "pjDbmDelAllRb(rbCbLst, numRbCb(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for (idx = 0; idx < numRbCb; idx++)
   {
      ...
      if (rbCb != 0L)
      {
         { { if (rbCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCb, (Size) sizeof(PjDlRbCb)); rbCb = 0L; } }; { gCb->pjGenSts.numOfRb--; }; };
         rbCbLst[idx] = 0L;
      }
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd7000d, L_DEBUG, ueId, cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",834, "pjDbmCreateUeCb(ueId(%d), cellId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&*ueCb, (Size) sizeof(PjDlUeCb)) == 0) { cmMemset((U8 *)(*ueCb), 0, sizeof(PjDlUeCb)); } else { (*ueCb) = 0L; } };
   tUeCb = *ueCb;
   tUeCb->key.ueId = ueId;
   tUeCb->key.cellId = cellId;

   ret = cmHashListInsert(&(gCb->u.dlCb->ueLstCp), (U32)tUeCb, (U8 *)&(tUeCb->key),
         (U16) sizeof(PjUeKey));
   if (ret != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd7000e,L_ERROR,DBG_UEID, ueId, cellId, 0, 0, 0,                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c"      ,                                                                 858      , "DL UE CB Hash Insert Failed for cellId (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                  ;
...

{
   ...
   if (ret != 0)
   {
      ...
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd7000f,L_WARNING,DBG_UEID, ueId, 0, 0, 0, 0,                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c"      ,                                                             921      , "pjDbmFetchUeCb: cmHashListFind Failed for ueCb.", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                              ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd70010, L_DEBUG, ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c"   , 969   , "pjDbmDelUeCb(ueId(%d), cellId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                             ;
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd70011,L_ERROR,DBG_UEID, ueCb->key.ueId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",1009, "Hash Delete Failed for ueCb", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd70012, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",1051, "pjDbmDelAllUe()", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   while (cmHashListGetNext(&(gCb->u.dlCb->ueLstCp), (U32) ueCb, (U32 *)&ueCb) == 0)
   {

      ret = pjDbmDelDlUeCb(gCb,ueCb, 1);
      if (ret != 0)
      {

         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd70013,L_ERROR,DBG_UEID, ueCb->key.ueId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",1065, "DL Ue Cb Deletion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...
)
{
   ...
   if(rbCb == 0L)
   {
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&rbCb, (Size) sizeof(PjDlRbCb)) == 0) { cmMemset((U8 *)(rbCb), 0, sizeof(PjDlRbCb)); } else { (rbCb) = 0L; } };
      if ( rbCb == 0L )
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd70014, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_dl.c",1158, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(rbCb);
      }
   }
