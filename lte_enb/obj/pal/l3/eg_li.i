...
extern S16 egUtlDelTknStrOSXL ( TknStrOSXL *delTknStrOSXL )
                                                            ;
 U32 egNumPkts = 0, egProcDur = 0;




static S16 egLiValidatePrimitive ( SuId suId, U16 event)

                            ;


extern S16 egLiPrcBndCfm ( SuId suId, EgTSapCb *tsapCb, U16 result)
...

{
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",166); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"General configuration not done"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",176); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }

   if ((suId < 0) || (suId > egCb.genCfg.maxNmbTSaps))
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",181); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Invalid tSapId range"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",191); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   if (egCb.tSapCb == 0L)

   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",204); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Invalid TSap, no TSAP Configured"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",214); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   tsapCb = egCb.tSapCb;


   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",228); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Process HIT Bind Confirm"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                          ;
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",235); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 EgLiHitConCfm
(
Pst *pst,
...
)
{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",282); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; }


   if (!localAddr)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",287); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n localAddr: NULLP "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
  ...
  cmMemset( (U8* )&sta, 0, sizeof(EgUsta));
      ...
      egSendLmAlarm (2, (256 + 10),
               13, &sta.dgn);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",296); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   serverCb = 0L;
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",322); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n tSapId(%d) suConnId(%ld)", suId, suConnId); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",323); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n spConnId(%ld) ", spConnId); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",325); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "EG_DBG_CMTPTADDR" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_CMTPTADDR,(Void*) localAddr, (S8 *)"localAddr"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   ...
   retVal = egLiValidatePrimitive(suId, (256 + 10));
   if(retVal != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",337); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Primitive Validation Failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",339); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   ...
   if (suConnId < egCb.genCfg.nmbSrvs)
   {
      ...
      if(serverCb == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",361); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid suConnId"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   ...
   cmMemset( (U8* )&sta, 0, sizeof(EgUsta));
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",373); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
      }
      ...
      if (serverCb->cfg.opnSrvTmr.enb == 1)
      {
         ...
         retVal = egSchedTmr(serverCb, 2,
                             2, 0);
         if (retVal != 0)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",391); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Timer EG_TMR_TCM_OPEN_SRV stop failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
         }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",398); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invlaid suConnId"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",399); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   ...
   break;
      case 1:
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",428); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n HitConCfm received in LEG_TPTSRV_ENA state"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   ...
   break;
      case 3:
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",437); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Server is Open Successfully "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      default:
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",454); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid tptState (%d)", tptState); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

         }
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",466); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 EgLiHitDiscInd
(
Pst *pst,
...
{
   EgTSapCb *tsapCb;
   EgTptSrvCb *serverCb = 0L;
   S16 retVal;
   State prevState;
   EgUsta sta;

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",509); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   if (egCb.shutdown)
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",534); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n choice (%d) connId(%ld) ", choice, connId); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };


   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",537); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n tSapId(%d) reason(%d)", suId, reason); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   ...
   retVal = egLiValidatePrimitive(suId, (256 + 5));
   if(retVal != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",548); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Primitive Validation Failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",549); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   ...
   if (choice != 1)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",557); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid choice"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

      cmMemset( (U8* )&sta, 0, sizeof(EgUsta));

      sta.dgn.dgnVal[0].type = 7;
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",569); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   tsapCb = egCb.tSapCb;
   ...
   if (serverCb != 0L)
   {
      ...
      if (serverCb->state == 2)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 2))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",600); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"DEBUG\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n serverCb->state already disabled"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",601); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
      }
      ...
      serverCb->state = 2;
       if (serverCb->cfg.opnSrvTmr.enb == 0)
       {
       ...
       else
       {
           ...
           if (prevState != 3)
           {
              ...
              retVal = egTptOpenServer (serverCb,0L);
           }
       }

       { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",661); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
   }
   else
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 2))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",668); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"DEBUG\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n TPT Server is not Present "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",671); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 EgLiHitUDatInd
(
Pst *pst,
...
)
{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",721); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",743); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n tSapId(%d) suConnId(%ld)", suId, suConnId); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };



   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",747); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "EG_DBG_CMTPTADDR" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_CMTPTADDR,(Void*) srcAddr, (S8 *)"srcAddr"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n  "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",748); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "EG_DBG_CMTPTADDR" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_CMTPTADDR,(Void*) remAddr, (S8 *)"remAddr"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n  "); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   ...
   if (suConnId < egCb.genCfg.nmbSrvs)
   {
      ...
      if (serverCb == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",887); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid serverCb:NULL"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
         { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",888); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",890); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Sending Disconnect Indication to LI"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

         egTptIssueDiscReq (tSapCb, 1, suConnId);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",893); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
      }

      if (serverCb->state != 1)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",898); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid serverCb->state %d", serverCb->state); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
         { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",899); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",900); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
      }
   }
   else
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",908); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid suConnId(%ld)", suConnId); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };




      { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",913); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",914); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   ...
   if ( tSapCb->trcMask & 0x02)
   {

      egGenTrcInd(tSapCb, 2, srcAddr, remAddr, 0x02, mBuf);
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",950); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
...
)
{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",994); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   if (egCb.shutdown)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1015); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf," \n Do nothing if layer has been shut down"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      return(0);
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1022); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"choice (%d) connId(%ld) ", choice, connId); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };



   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1026); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"tSapId(%d) action(%d)", suId, action); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
   ...
   retVal = egLiValidatePrimitive(suId, (256 + 6));
   if(retVal != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1037); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Primitive Validation Failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1038); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   ...
   if (choice != 1)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1046); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid choice"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1058); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   tsapCb = egCb.tSapCb;
   ...
   if (serverCb != 0L)
   {
      ...
      if (serverCb->state == 2)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1089); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n serverCb->state already disabled"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1090); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
      }
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1105); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }




   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1111); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };

}
static S16 egLiValidatePrimitive
(
SuId suId,
U16 event
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1236); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; }

   cmMemset( (U8* )&sta, 0, sizeof(EgUsta));

   if (egCb.init.cfgDone != 1)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1242); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n General configuration not done"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1252); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }

   if ((suId < 0) || (suId >= egCb.genCfg.maxNmbTSaps))
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1257); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid TSAP"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1267); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   if (egCb.tSapCb == 0L)

   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1280); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid TSAP :NULL"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1290); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   if(egCb.tSapCb->state != 2)

   {



      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1306); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid tSapCb state %d", egCb.tSapCb->state); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1317); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1320); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1358); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; }
   ...
   switch (tsapCb->state)
   {
      ...
      case 3:
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1369); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid tSapCb state"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

         }
         break;
      case 5:
         {
            if (tsapCb->reCfg.bndTmCfg.enb == 1)
            {
               ...
               if (retVal != 0)
               {
                  { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1383); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n timer EG_TMR_TPT_BND stop failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                    ;
      ...
      default:
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1469); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "EG_DBG_TSAP" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_TSAP,(Void*) tsapCb, (S8 *)"tsapCb"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Invalid tSapCb state"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };

            egSendLmCntrlCfm(&tsapCb->cfmPst,
                  1, 11,
                  &tsapCb->ctrlHdr);

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1475); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
         }
         break;
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_li.c",1480); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
