...
static U32 g_uiiTbsToBitsfor100Prbs[27] = {
...
{
   RgmPrbRprtCfg *prbRprtCfg = 0L;

   { if (SGetSBuf(g_stRmCb.rmInit.region, g_stRmCb.rmInit.pool, (Data **)(&prbRprtCfg), (sizeof(RgmPrbRprtCfg))) == 0) { { cmMemset((U8 *)((*(&prbRprtCfg))), 0, ((sizeof(RgmPrbRprtCfg)))); }; } else { (*(&prbRprtCfg)) = 0L; } };
   if(prbRprtCfg == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x990001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp",50, "PRB Report Configuration Send Failure", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x990002, L_ERROR, sizeof(RgmPrbRprtCfg), "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"      , 52      , "Memory allocation failed [size: %d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                  ;
      return(1);
   }
...
CPRBBasedAdmissionController::CPRBBasedAdmissionController(LrmCellConfigData & stCellCfg)
{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x990003, L_ERROR, m_enConfigMode, LRM_UL_DL_CONFIG_6, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"      , 74      , "Invalid config mode:%d. Taking default value %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                               ;
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x990004,L_INFO,DBG_CELLID, (U32)stCellCfg.bCellId, m_bNumTxAnt, m_usMaxGBRPRBUsageLimit, m_uiPrbReportInterval, stCellCfg.utNumOfPrbRpts,                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"   ,                                                        93   , "PRB CFG: NumAnt:%d  MaxGBRPRB Limit: %d " "ReportInterval: %ld WindowSize: %ld", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                               ...
                                                               U32 biTbs)
{
   ...
   uiRcvdGbrPerMilliSec = (U32)(((uiRcvdGbrBitsPerSec) + (1000)/2) / (1000));
   uiReqrdNumPrbsPerMilliSec =
      (U32)((((uiRcvdGbrPerMilliSec * 100)) + (uiMaxNumOfbitsFor100Rbs)/2) / (uiMaxNumOfbitsFor100Rbs)) ;


   if(bIsDlGbrBitRate)
   {
      return ((U32)(((uiReqrdNumPrbsPerMilliSec) + (m_bNumTxAnt)/2) / (m_bNumTxAnt)));
   }
                                                    ...
                                                    U32 biTbs)
{
   ...
   if(RM_MODE_TDD == m_bDuplexMode)
   {
      if(bIsDlGbrBitRate)
      {
         ...
         bTotalAvailRbs = (bTotalAvailRbs * bNumDlSfs)/10;
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x990005, L_DEBUG, uiReqrdNumPrbsPerMilliSec, bTotalAvailRbs, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"         , 147         , "DL Required PRB/MS: %ld, AvailRBs: %d ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      else
      {
         ...
         bTotalAvailRbs = (bTotalAvailRbs * bNumUlSfs)/10;
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x990006, L_DEBUG, uiReqrdNumPrbsPerMilliSec, bTotalAvailRbs, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"         , 155         , "UL Required PRB/MS: %ld, AvailRBs: %d ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   bRqrdPrbsInPercent = (U8) ((((uiReqrdNumPrbsPerMilliSec * 100)) + (bTotalAvailRbs)/2) / (bTotalAvailRbs)) ;
...
S16 CPRBBasedAdmissionController::triggerPrbReportConfig(U8 bCellId,
                                                         U32 bAction)
{
   return(sendPrbReportCfg(bCellId, bAction));
}
                                          ...
                                          RrmRbcRspInfo & erabRbcRspInfo)
{
   ...
   for(uiRbIdx = 0; uiRbIdx < erabRbcRspInfo.nErabsAccepted; uiRbIdx++)
   {
      ...
      {
         for(uiRbIdx2 = uiRbIdx + 1; uiRbIdx2 < erabRbcRspInfo.nErabsAccepted;
               uiRbIdx2++)
         {
                                                ...
                                                RrmRbcRspInfo & erabRbcRspInfo)
{
   ...
   for(uiRbIdx = 0; uiRbIdx < erabRbcRspInfo.nErabsAccepted; uiRbIdx++)
   {
         ...
         __null 
              == stRbAddMod) || (
                                 __null 
                                      == pObjOldERab))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x990007,L_ERROR,DBG_CRNTI, pUE->getCRNTI(), bErabId, 0, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"         ,                                             244         , "ErabId %d not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;
         continue;
      }
      ...
      if(isGbrBearer(bQci))
      {
         ...
         if((((((accDlPrbCount + bCurrDlPrbUsage + bReqPrbForDl) > uiReservedPrbForDl)?(((accDlPrbCount + bCurrDlPrbUsage + bReqPrbForDl)) - (uiReservedPrbForDl)):((uiReservedPrbForDl) - ((accDlPrbCount + bCurrDlPrbUsage + bReqPrbForDl)))))
                   > m_usMaxGBRPRBUsageLimit) ||
            (((((accUlPrbCount + bCurrUlPrbUsage + bReqPrbForUl) > uiReservedPrbForUl)?(((accUlPrbCount + bCurrUlPrbUsage + bReqPrbForUl)) - (uiReservedPrbForUl)):((uiReservedPrbForUl) - ((accUlPrbCount + bCurrUlPrbUsage + bReqPrbForUl)))))
                  > m_usMaxGBRPRBUsageLimit))
         {
            ...
            bNumErabsRejected++;
            if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x990008,L_INFO,DBG_CRNTI, pUE->getCRNTI(), bCurrDlPrbUsage, bReqPrbForDl, bCurrUlPrbUsage, bReqPrbForUl,                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"            ,                                               312            , "[Rejected-ERAB-PRB] DL Curr: %ld DL Req: %ld " "UL Curr: %ld UL Req: %ld", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x990009,L_INFO,DBG_CRNTI, pUE->getCRNTI(), bCurrDlPrbUsage, bReqPrbForDl, uiReservedPrbForDl, 0,                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"         ,                                                                324         , "[Accepted-ERAB-PRB] DL Curr: %ld DL Req: %ld DL reserved:%ld", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                                 ;
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x99000a,L_INFO,DBG_CRNTI, pUE->getCRNTI(), bCurrUlPrbUsage, bReqPrbForUl, uiReservedPrbForUl, 0,                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"         ,                                                                327         , "[Accepted-ERAB-PRB] UL Curr: %ld UL Req: %ld UL Reserved:%ld", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x99000b,L_INFO,DBG_CRNTI, pUE->getCRNTI(), bNumErabsAdmitted, bNumErabsRejected, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"   ,                                             340   , "Number of Admitted/Rejected ERABS:: [%d, %d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ...
                                           RrmRbcRspInfo & erabRbcRspInfo)
{
   ...
   for(uiRbIdx = 0; uiRbIdx < erabRbcRspInfo.nErabsAccepted; uiRbIdx++)
   {
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x99000c,L_ERROR,DBG_CRNTI, erabRbcRspInfo.usCRNTI, bErabId, 0, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"         ,                                             390         , "ErabId %d not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;
         continue;
      }
      RmuErabGbrInfoIe &stGbrInfo = stRbAddMod->stErabQosInfo.stErabGbrInfo;
      ...
      if(isGbrBearer(bQci))
      {
               ...
               (accUlPrbCount + bCurrUlPrbUsage + uiReqPrbForUl) > m_usMaxGBRPRBUsageLimit)
         {
            ...
            pRejectLst[bNumErabsRejected].bErabPreemptCap =
               stRbAddMod->stErabQosInfo.stErabArpInfo.bErabPreemptCap;
            bNumErabsRejected++;
            if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x99000d,L_INFO,DBG_CRNTI, erabRbcRspInfo.usCRNTI, bCurrDlPrbUsage, uiReqPrbForDl, bCurrUlPrbUsage, uiReqPrbForUl,                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"            ,                                                433            , "[Rejected-ERAB-PRB] DL Curr: %ld DL Req: %ld " "UL Curr: %ld UL Req: %ld", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x99000e,L_INFO,DBG_CRNTI, erabRbcRspInfo.usCRNTI, bCurrDlPrbUsage, uiReqPrbForDl, bCurrUlPrbUsage, uiReqPrbForUl,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"         ,                                                                             446         , "[Accepted-ERAB-PRB] DL Curr: %ld DL Req: %ld " "UL Curr: %ld UL Req: %ld", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x99000f,L_INFO,DBG_CRNTI, erabRbcRspInfo.usCRNTI, bNumErabsAdmitted, bNumErabsRejected, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"   ,                                             452   , "Number of Admitted/Rejected ERABS:: [%d, %d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                               ...
                                               RrmRbcRspInfo & erabRbcRspInfo)
{
   ...
   for(U32 uiRbIdx = 0; uiRbIdx < erabRbcRspInfo.nErabsRejected; uiRbIdx++)
   {
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x990010,L_ERROR,DBG_CRNTI, erabRbcRspInfo.usCRNTI, bErabId, 0, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_prbbasedadmissioncontroller.cpp"         ,                                             491         , "ErabId %d not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;
         continue;
      }
