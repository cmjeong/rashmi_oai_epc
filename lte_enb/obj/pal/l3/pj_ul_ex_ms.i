...

{
   ...
   { cmMemset((U8 *)tPjCb, (U8)0, sizeof(PjCb)); };



   tPjCb->init.ent = ent;
   tPjCb->init.inst = inst;
   tPjCb->init.region = region;
   tPjCb->init.pool = 0;
   tPjCb->init.reason = reason;
   tPjCb->init.cfgDone = 0;
   tPjCb->init.acnt = 1;
   tPjCb->init.usta = 1;
   tPjCb->init.trc = 0;
      ...
      case 0x0E:
         {
            switch(pst->event)
            {
               ...
               default:
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30001, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",263, "Received Invalid Event[%d] from SM", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     ret = 1;
                     break;
                  }
      ...
      case 0xe3:
         {
            ...
            default:
                  SPutMsg(mBuf);
                   if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30002, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",285, "Received Invalid Event[%d] from APP", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
            }
            break;
      ...
      case 0xd8:
         {
            switch(pst->event)
            {
              default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30003, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",351, "Received Invalid Event[%d] from PDCP DL", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
      ...
      case 0xd9:
         {
            ...
            case 0x42:
              ...
              default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30004, L_ERROR,pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",451, "Received Invalid Event[%d] from RRC", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
    ...
    case 0xe2:
         {
            switch(pst->event)
            {
               ...
               default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30005, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",489, "Received Invalid Event[%d] from Relay", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
            }
            break;
      ...
      case 0xe1:
         {
            switch(pst->event)
            {
               default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30006, L_ERROR,pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",512, "Received Invalid Event[%d] from Offboard Compression", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
            }
            break;
      ...
      case 0xe0:
         {
            switch(pst->event)
            {
               default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30007, L_ERROR,pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",548, "Received Invalid Event[%d] from Offboard Security", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
            }
            break;
      ...
      case 0xd7:
         {
            switch(pst->event)
            {
               ...
               default:
                  {
                     SPutMsg(mBuf);
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30008, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",593, "Received Invalid Event[%d] from RLC", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     ret = 1;
                     break;
                   }
      ...
      default:
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf30009, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ul_ex_ms.c",653, "Received Invalid Src Entity[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            SPutMsg(mBuf);
            ret = 1;
            break;
         }
