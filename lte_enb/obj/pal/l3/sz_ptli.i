...
static S16 PtLiSctStaReq (Pst *pst, SpId spId, UConnId spAssocId, CmNetAddr *dstNAddr, U8 staType)
                                                                  ...
                                                                  ;
static SctBndReq SzLiSctBndReqMt[4] =
{
...
static SctEndpOpenReq SzLiSctEndpOpenReqMt[4] =
{
...
static SctEndpCloseReq SzLiSctEndpCloseReqMt[4] =
{
...
static SctStaReq SzLiSctStaReqMt[4] =
{
...
static SctTermReq SzLiSctTermReqMt[4] =
{
...
static SctAssocReq SzLiSctAssocReqMt[4] =
{
...
static SctDatReq SzLiSctDatReqMt[4] =
{
...
static SctAssocRsp SzLiSctAssocRspMt[4] =
{
...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000008)) { snprintf((&szCb.init)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->procId, (&szCb.init)->ent, (&szCb.init)->inst,
                                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_ptli.c"
   ,
                                                                  561
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctBndReq(pst, suId: %d, spId: %d)\n", suId, spId); SPrint((&szCb.init)->prntBuf); } }
                                                                   ;



   return((*SzLiSctBndReqMt[pst->selector])(pst, suId, spId));
}
 S16 SzLiSctEndpOpenReq
(
Pst *pst,
SpId spId,
UConnId suEndpId,
...
)
{
...

   {
      ...
      ,
                                   ...
                                   632
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctEndpOpenReq(pst, spId: %d, suEndpId: %ld, port: %d )\n", spId, suEndpId, port); SPrint((&szCb.init)->prntBuf); } }
   ...
   return((*SzLiSctEndpOpenReqMt[pst->selector])(pst, spId, suEndpId, port, intfNAddr))
                                                              ;

}
 S16 SzLiSctEndpCloseReq
(
Pst *pst,
SpId spId,
UConnId endpId,
...

{
...

   {
      ...
      ,
                                       ...
                                       693
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctEndpCloseReq(pst, spId: %d, endpId: %ld, " "endpIdType: %d)\n", spId, endpId, endpIdType); SPrint((&szCb.init)->prntBuf); } }
   ...
   return((*SzLiSctEndpCloseReqMt[pst->selector])(pst, spId, endpId, endpIdType))
                                                                ;
}
 S16 SzLiSctAssocReq
(
...
)
{
...

   {
      ...
      ,
                                                           ...
                                                           798
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctAssocReq(pst, spId: %d, spEndpId: %ld, " "suAssocId: %ld, dstPort: %d, outStrms: %d)\n", spId, spEndpId, suAssocId, dstPort, outStrms); SPrint((&szCb.init)->prntBuf); } }
   ...
   return((*SzLiSctAssocReqMt[pst->selector])(pst, spId, spEndpId, suAssocId, priDstNAddr, dstPort, outStrms, dstNAddrLst, srcNAddrLst, vsInfo))
...
)
{
   ...
   if (assocIndParams->type == 1)
   {
       ...
       ,
                                                               ...
                                                               903
       ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "\nSzLiSctAssocRsp(pst, spId: %d, spAssocId: %ld, " "result: %d, assocIndParams->type: %d, " "initParams: iTag: %ld, a_rwnd: %ld, " "outStrms: %d, inStrms: %d)\n", spId, spAssocId, result, assocIndParams->type, ip->iTag, ip->a_rwnd, ip->outStrms, ip->inStrms); SPrint((&szCb.init)->prntBuf); } }
      ...
      else if (assocIndParams->type == 2)
      {
         ...
         ,
                                                            ...
                                                            930
         ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "\nSzLiSctAssocRsp(pst, spId: %d, spAssocId: %ld, " "result: %d, assocIndParams->type: %d, " "cookieParams: spAssocId: %ld, suAssocId: %ld, " "peerPort: %d)\n", spId, spAssocId, result, assocIndParams->type, cp->spAssocId, cp->suAssocId, cp->peerPort); SPrint((&szCb.init)->prntBuf); } }
   ...
   return((*SzLiSctAssocRspMt[pst->selector])(pst, spId, spAssocId, assocIndParams, result, vsInfo))
...
)
{
...

   {
      ...
      ,
                                                  ...
                                                  1044
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctTermReq(pst, spId: %d, assocId: %ld, " "assocIdType: %d, abrtFlg: %d)\n", spId, assocId, assocIdType, abrtFlg); SPrint((&szCb.init)->prntBuf); } }
   ...
   return((*SzLiSctTermReqMt[pst->selector])(pst, spId, assocId, assocIdType, abrtFlg))
                                                        ;
}
 S16 SzLiSctDatReq
(
...
)
{
...

   {
      ...
      ,
                               ...
                               1176
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctDatReq(pst, spId: %d, spAssocId: %ld, " "strmId: %d, unorderFlg: %d, nobundleFlg: %d, " "lifetime: %d, protId: %ld)\n", spId, spAssocId, strmId, unorderFlg, nobundleFlg, lifetime, protId); SPrint((&szCb.init)->prntBuf); } }
   ...
   return((*SzLiSctDatReqMt[pst->selector])(pst, spId, spAssocId, dstNAddr, strmId, unorderFlg, nobundleFlg, lifetime, protId, mBuf))
...
)
{
...

   {
      ...
      ,
                                       ...
                                       1242
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctStaReq(pst, spId: %d, spAssocId: %ld, " "staType: %d)\n", spId, spAssocId, staType); SPrint((&szCb.init)->prntBuf); } }
   ...
   return((*SzLiSctStaReqMt[pst->selector])(pst, spId, spAssocId, dstNAddr, staType))
                                                       ;
}
