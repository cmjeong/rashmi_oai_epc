...
static S16 czUtlFillCritDiagIe (CztEvnt *ptr, CztCriticalityDiag *critIe, CztX2AP_PDU *pdu, CzIeInfo *idlst, Bool isErrInd)



                                                             ;

static Void czMapPasnErrToCauseIe (S16 errCode, U8 *causeType, U8 *causeVal)

                                                         ;
static CztEvnt* czUtlX2RsrcStsDecErr (CztX2AP_PDU *pdu, U8 causeType, U8 causeVal)

                                                                   ;
static CztEvnt* czUtlX2SetupReqDecErr (CztX2AP_PDU *pdu, U8 causeType, U8 causeval)

                                                                    ;

static CztEvnt* czUtlMobChgReqDecErr (CztX2AP_PDU *pdu, U8 causeType, U8 causeval)

                                                                    ;

static CztEvnt* czUtlCellActReqDecErr (CztX2AP_PDU *pdu, U8 causeType, U8 causeval)

                                                                    ;

 S16 czUtlFillTknBStr32 ( TknBStr32 *ptr, U16 len, U32 val )
...
static CztEvnt* czUtlHoReqDecErr (CztX2AP_PDU *pdu, U8 causeType, U8 causeVal)

                                                           ;
static S16 czUtlGetRsrcErrIdLst (CztX2AP_PDU *pdu, U8 msgId, CzIeInfo *ieId, CztUeInfo *ueInfo)


                                                              ;
static S16 czUtlGetBmpErrIdLst (CztX2AP_PDU *pdu, U8 msgId, CzIeInfo *ieId, CztUeInfo *ueInfo)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetMsgType"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",551, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   procCode = 0;
   ...
   *procType = CZ_PROC_UNKNOWN;
   ...
   switch(msgChoice)
   {
      case 0:
      {
         if(1 == pdu->val.initiatingMsg.pres.pres)
         {
      ...
      case 1:
      {
         if(1 == pdu->val.successfulOutcome.pres.pres)
         {
      ...
      case 2:
      {
         if(1 == pdu->val.unsuccessfulOutcome.pres.pres)
         {
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",608, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czMsgVal); }while(0);

}
 S16 czUtlGetProcTypeVal
(
S16 procCode
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetProcTypeVal"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",639, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   if(procCode >=0 && procCode < 16)
      czProcType = czX2ProcMap[procCode];

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",644, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czProcType); }while(0);

}
 S16 czUtlUpdOutErrSts
(
CzPeerCb *peer,
U16 msgType
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlUpdOutErrSts"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",673, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",675, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"czUtlUpdOutErrSts: messageType(%u)",msgType); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",920, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czUtlUpdInErrSts
(
CzPeerCb *peer,
U16 msgType
)
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlUpdInErrSts"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",947, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",949, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"czUtlUpdInErrSts: messageType(%u)",msgType); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   switch (msgType)
   {
     case 0:
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1167, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czUtlUpdOutSts
(
CzPeerCb *peer,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlUpdOutSts"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1195, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1197, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"czUtlUpdOutSts: messageType(%u)",msgType); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   switch (msgType)
   {
     case 0:
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1409, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czUtlUpdInSts
(
CzPeerCb *peer,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlUpdInSts"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1436, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1438, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"czUtlUpdOutInSts: messageType(%u)",msgType); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
   switch (msgType)
   {
     case 0:
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1651, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czUtlGetIE
(
CztX2AP_PDU *pdu,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetIE"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1690, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   ...
   *ie = 0L;
   ...
   if(pdu->choice.pres != 1)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1700, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }
   ...
   switch(choiceType)
   {
      case 0:
      {
         if (pdu->val.initiatingMsg.pres.pres != 1)
         {
            do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1711, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
         }
      ...
      case 1:
      {
         if (pdu->val.successfulOutcome.pres.pres != 1)
         {
            do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1721, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
         }
      ...
      default:
      {
         if ((pdu->val.unsuccessfulOutcome.pres.pres != 1) ||
            (choiceType != 2))
         {
            do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1732, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
         }
   ...
   if (((TknU8 *)startStr)->pres == 1)
   {

      currStr = (TknU8 *) ((U32)startStr + sizeof(TknU8));
   }
   else
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1748, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }

   if (((TknU16 *)(currStr))->pres == 1)
   {
   ...
   currStr = (TknU8 *)((U32)currStr + sizeof(TknU16));
   ...
   while (recIdx < numComp)
   {
      ...
      if (((TknPres *)currStr)->pres == 1)
      {

         currStr = (TknU8 *) ((U32)currStr + sizeof(TknPres));
         ...
         if (recId == id)
         {
            startStr = (TknU8 *) ((U32)currStr + sizeof(CztProtIE_ID) +
      ...
      currStr = (TknU8 *) ((U32)startStr + size);
      recIdx++;
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1788, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czUtlGetProcMsgCrit
(
CztX2AP_PDU *pdu,
U8 *procCode,
U8 *msgType,
...
)
{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetProcMsgCrit"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1828, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   if(pdu->choice.pres == 1)
   {
   ...
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1843, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }
   switch(*msgType)
   {
      case 0:
      {
         ...
         {
            do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1858, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
         }
         break;
      }
      case 1:
      {
         ...
         {
            do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1873, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
         }
         break;
      }
      case 2:
      {
         ...
         {
            do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1888, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
         }
         break;
      }
      default:
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1894, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
      }
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1898, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);

}
 Void czUtlFillCauseIe
(
CztCause *causeIe,
U8 causeType,
U8 causeVal
...
{
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlFillCauseIe"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",1931, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   { causeIe->choice.pres = 1; causeIe->choice.val = causeType; };
   switch(causeType)
   {
      case 0:
         { causeIe->val.radioNw.pres = 1; causeIe->val.radioNw.val = causeVal; };
         break;
      case 1:
         { causeIe->val.transport.pres = 1; causeIe->val.transport.val = causeVal; };
         break;


      case 2:
         { causeIe->val.protocol.pres = 1; causeIe->val.protocol.val = causeVal; };
         break;
      ...
      case 3:
         { causeIe->val.misc.pres = 1; causeIe->val.misc.val = causeVal; };
         break;
...
static S16 czUtlGetBmpErrIdLst
(
CztX2AP_PDU *pdu,
U8 msgId,
CzIeInfo *ieId,
...

{
   U8 cnt = 0;
   TknU8 *ieTkn = 0L;
   CztUE_X2AP_ID *x2ApUeId = 0L;

   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetBmpErrIdLst"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2002, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   czUtlGetIE(pdu,10, &ieTkn);
   if(ieTkn == 0L)
   {
      { ieId[cnt].pres = 1; ieId[cnt].ieId = 10; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrmissingEnum; }
                                                              ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2009, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }
   x2ApUeId = (CztUE_X2AP_ID *)ieTkn;
   if((x2ApUeId->pres == 1) && (x2ApUeId->val <(U16) 4096))
   {

   }
   else
   {
      { ieId[cnt].pres = 1; ieId[cnt].ieId = 10; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                     ;
      cnt++;
   }
   ...
   if((msgId != 2) &&
      (msgId != 3))
   {
      czUtlGetIE(pdu,9, &ieTkn);
      if(ieTkn == 0L)
      {
         { ieId[cnt].pres = 1; ieId[cnt].ieId = 9; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrmissingEnum; }
                                                                 ;
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2031, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
      }
      x2ApUeId = (CztUE_X2AP_ID *)ieTkn;

      if((x2ApUeId->pres == 1) &&(x2ApUeId->val < 4096))
      {

      }
      else
      {
         { ieId[cnt].pres = 1; ieId[cnt].ieId = 9; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                        ;
         cnt++;
      }
   }
   ...
   {
      czUtlGetIE(pdu, 5, &ieTkn);
      if(ieTkn == 0L)
      {
         { ieId[cnt].pres = 1; ieId[cnt].ieId = 5; ieId[cnt].crit = CztCriticalityignoreEnum; ieId[cnt].typOfErr = CztTypOfErrmissingEnum; }
                                                              ;
      }
   }
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2055, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);

}
static S16 czUtlGetRsrcErrIdLst
(
CztX2AP_PDU *pdu,
U8 msgId,
CzIeInfo *ieId,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetRsrcErrIdLst"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2095, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   czUtlGetIE(pdu, 39, &ieTkn);
   if(ieTkn == 0L)
   {
      { ieId[cnt].pres = 1; ieId[cnt].ieId = 39; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrmissingEnum; }
                                                              ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2102, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }
   measId = (CztMeasurement_ID *)ieTkn;
   if((measId->pres != 1) ||
      (4095 < measId->val))
   {
      { ieId[cnt].pres = 1; ieId[cnt].ieId = 39; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                     ;
      cnt++;
   }
   czUtlGetIE(pdu, 40, &ieTkn);
   if(ieTkn == 0L)
   {
      { ieId[cnt].pres = 1; ieId[cnt].ieId = 40; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrmissingEnum; }
                                                              ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2117, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }
   measId = (CztMeasurement_ID *)ieTkn;
   if((measId->pres != 1) ||
      (4095 < measId->val))
   {
      { ieId[cnt].pres = 1; ieId[cnt].ieId = 40; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                     ;
      cnt++;
   }
   if(msgId == 18)
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2133, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czUtlGetErrIdLst
(
CztX2AP_PDU *pdu,
U8 msgId,
CzIeInfo *ieId,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetErrIdLst"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2175, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   ...
   switch(msgId)
   {
      ...
      case 9:
      {
         czUtlGetIE(pdu, 21, &ieTkn);
         if(ieTkn == 0L)
         {
            { ieId[cnt].pres = 1; ieId[cnt].ieId = 21; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrmissingEnum; }
                                                                    ;
         }
         break;
      }
      ...
      case 22:
      {
          czUtlGetIE(pdu, 43, &ieTkn);


          eNB1Ecgi = (CztECGI *)ieTkn;
          if((eNB1Ecgi == 0L) || (eNB1Ecgi->pres.val != 1))
          {
           ...
           czUtlGetIE(pdu, 44, &ieTkn);

           eNB2Ecgi = (CztECGI *)ieTkn;
           if((ieTkn == 0L) || (eNB2Ecgi->pres.val != 1))
           {
            ...
            czUtlGetIE(pdu, 45, &ieTkn);
            if(ieTkn == 0L)
            {
                { ieId[cnt].pres = 1; ieId[cnt].ieId = 45; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrmissingEnum; }
                                                                      ;
                cnt++;
            }
            ...
            if(ieTkn == 0L)
            {
               { ieId[cnt].pres = 1; ieId[cnt].ieId = 5; ieId[cnt].crit = CztCriticalityrejectEnum; ieId[cnt].typOfErr = CztTypOfErrmissingEnum; }
                                                                     ;
                cnt++;
            }
            break;
      ...
      case 26:
      {
            czUtlGetIE(pdu, 58, &ieTkn);
            if(ieTkn == 0L)
            {
                { ieId[0].pres = 1; ieId[0].ieId = 58; ieId[0].crit = CztCriticalityrejectEnum; ieId[0].typOfErr = CztTypOfErrmissingEnum; }
                                                                       ;
            }
            break;
      }
      case 27:
      {
            ...
            if(ieTkn == 0L)
            {
                { ieId[0].pres = 1; ieId[0].ieId = 5; ieId[0].crit = CztCriticalityrejectEnum; ieId[0].typOfErr = CztTypOfErrmissingEnum; }
                                                                       ;
            }
            break;
      }
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2293, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);

}
static S16 czUtlFillCritDiagIe
(
CztEvnt *ptr,
...
)
{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlFillCritDiagIe"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2345, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };


   do { (Void)cmMemset((U8*)((U8 *)ieIdlst), 0, (Size)5 * sizeof(CzIeInfo)); } while(0);
   { critIe->pres.pres = 1; critIe->pres.val = 1; };
   if((1 == isErrInd) && (0L != pdu))
   {
      czUtlGetProcMsgCrit(pdu, &procCode, &msgType, &criticality,
                          &msgId);
      { critIe->procedureCode.pres = 1; critIe->procedureCode.val = procCode; };
      { critIe->triggeringMsg.pres = 1; critIe->triggeringMsg.val = msgType; };
      { critIe->procedureCriticality.pres = 1; critIe->procedureCriticality.val = criticality; };
      czUtlGetErrIdLst(pdu, msgId, ieIdlst, 0L);
   }
   else
   {
      ...
      if(idlst)
         do { (Void)cmMemcpy((U8*)(U8 *)ieIdlst,(const U8*)idlst, (Size)5 * sizeof(CzIeInfo)); } while(0);
   }
   for (idx = 0; idx < 5; idx++)
   {
      if(ieIdlst[idx].pres == 1)
      {
         numComp++;
      }
   }
   ...
   if (numComp == 0)
   {
      critIe->iEsCriticalityDiag.noComp.pres = 0;
      critIe->iEsCriticalityDiag.noComp.val = 0;
      critIe->iE_Extns.noComp.pres = 0;
      critIe->iE_Extns.noComp.val = 0;

      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2381, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }
   { critIe->iEsCriticalityDiag.noComp.pres = 1; critIe->iEsCriticalityDiag.noComp.val = numComp; };
   do { (*(Ptr*)&(critIe->iEsCriticalityDiag.member)) = 0L; (Void)cmGetMem(ptr, numComp *sizeof(CztCriticalityDiag_IE_LstMember), (Ptr *)(Ptr*)&(critIe->iEsCriticalityDiag.member)); } while(0)
                                                                         ;
   if(0L == critIe->iEsCriticalityDiag.member)
   {
      critIe->iEsCriticalityDiag.noComp.pres = 0;
      critIe->iEsCriticalityDiag.noComp.val = 0;
      critIe->iE_Extns.noComp.pres = 0;
      critIe->iE_Extns.noComp.val = 0;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2392, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
   }
   for(idx = 0; idx < numComp; idx++)
   {
     { critIe->iEsCriticalityDiag.member[idx].pres.pres = 1; critIe->iEsCriticalityDiag.member[idx].pres.val = 1; };
     { critIe->iEsCriticalityDiag.member[idx].iE_ID.pres = 1; critIe->iEsCriticalityDiag.member[idx].iE_ID.val = ieIdlst[idx].ieId; }
                                                                  ;
     { critIe->iEsCriticalityDiag.member[idx].iECriticality.pres = 1; critIe->iEsCriticalityDiag.member[idx].iECriticality.val = ieIdlst[idx].crit; }
                                                                  ;
     { critIe->iEsCriticalityDiag.member[idx].typeOfErr.pres = 1; critIe->iEsCriticalityDiag.member[idx].typeOfErr.val = ieIdlst[idx].typOfErr; }
                                                                      ;
     critIe->iEsCriticalityDiag.member[idx].iE_Extns.noComp.pres = 0;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2410, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 CztEvnt* czUtlGenHoCancel
(
CztUeInfo *ueInfo,
U8 causeType,
U8 causeVal
...
{
   CztX2AP_PDU *hoCnclPdu = 0L;
   CztProtIE_Cont_HovrCancel_IEs *contHocnl = 0L;
   CztEvnt *uiEvnt = 0L;
   S16 numComp = 1;
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGenHoCancel"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2455, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   sMem.region = czCb.init.region;
   sMem.pool = czCb.init.pool;

   do { (*(Ptr *)&uiEvnt) = 0L; (Void)cmAllocEvnt((Size) sizeof(CztEvnt), 2048, &sMem, (Ptr *)(Ptr *)&uiEvnt); } while(0);
   if(0L == uiEvnt)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2463, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"Allocation of CzEvnt Failed \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2464, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   hoCnclPdu = &(uiEvnt->pdu);

   { hoCnclPdu->choice.pres = 1; hoCnclPdu->choice.val = 0; };
   { hoCnclPdu->val.initiatingMsg.pres.pres = 1; hoCnclPdu->val.initiatingMsg.pres.val = 1; };
   { hoCnclPdu->val.initiatingMsg.procedureCode.pres = 1; hoCnclPdu->val.initiatingMsg.procedureCode.val = 1; }
                                                             ;
   { hoCnclPdu->val.initiatingMsg.criticality.pres = 1; hoCnclPdu->val.initiatingMsg.criticality.val = CztCriticalityignoreEnum; }
                                                             ;
   { hoCnclPdu->val.initiatingMsg.value.u.cztHovrCancel.pres.pres = 1; hoCnclPdu->val.initiatingMsg.value.u.cztHovrCancel.pres.val = 1; }
                                                             ;
   contHocnl =
        &(hoCnclPdu->val.initiatingMsg.value.u.cztHovrCancel.protocolIEs);

   if (0xFFFF != ueInfo->oldUEX2APId)
   {
      numComp++;
   }
   if(0xFFFF != ueInfo->newUEX2APId)
   {
      numComp++;
   }

   { contHocnl->noComp.pres = 1; contHocnl->noComp.val = numComp; };
   do { (*(Ptr *)&(contHocnl->member)) = 0L; (Void)cmGetMem(uiEvnt, numComp *sizeof(CztProtIE_Field_HovrCancel_IEs), (Ptr *)(Ptr *)&(contHocnl->member)); } while(0)
                                                                      ;
   if(0L == contHocnl->member)
   {
      do { cmFreeMem((uiEvnt)); (uiEvnt) = 0L; } while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2494, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   cnt = 0;

   { contHocnl->member[cnt].pres.pres = 1; contHocnl->member[cnt].pres.val = 1; };
   { contHocnl->member[cnt].id.pres = 1; contHocnl->member[cnt].id.val = 10; };
   { contHocnl->member[cnt].criticality.pres = 1; contHocnl->member[cnt].criticality.val = CztCriticalityrejectEnum; };
   { contHocnl->member[cnt].value.u.cztid_Old_eNB_UE_X2AP_ID.pres = 1; contHocnl->member[cnt].value.u.cztid_Old_eNB_UE_X2AP_ID.val = ueInfo->oldUEX2APId; }
                                                                          ;
   ...
   {
      { contHocnl->member[cnt].pres.pres = 1; contHocnl->member[cnt].pres.val = 1; };
      { contHocnl->member[cnt].id.pres = 1; contHocnl->member[cnt].id.val = 9; };
      { contHocnl->member[cnt].criticality.pres = 1; contHocnl->member[cnt].criticality.val = CztCriticalityignoreEnum; };
      { contHocnl->member[cnt].value.u.cztid_New_eNB_UE_X2AP_ID.pres = 1; contHocnl->member[cnt].value.u.cztid_New_eNB_UE_X2AP_ID.val = ueInfo->newUEX2APId; }
                                                                             ;
      cnt++;
   }

   { contHocnl->member[cnt].pres.pres = 1; contHocnl->member[cnt].pres.val = 1; };
   { contHocnl->member[cnt].id.pres = 1; contHocnl->member[cnt].id.val = 5; };
   { contHocnl->member[cnt].criticality.pres = 1; contHocnl->member[cnt].criticality.val = CztCriticalityignoreEnum; };

   czUtlFillCauseIe(&(contHocnl->member[cnt].value.u.cztCause),
                                             causeType, causeVal);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2523, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(uiEvnt); }while(0);
}
 CztEvnt* czUtlGenX2CfgUpdFailure
(
CztX2AP_PDU *pdu,
U8 causeType,
U8 causeVal
...
{
   CztX2AP_PDU *cfgFailPdu = 0L;
   CztENBConfigUpdFail *failIe = 0L;
   CztEvnt *uiEvnt = 0L;
   S16 numComp = 2;
   S16 czCnt;
   Mem czSMem;

   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGenX2CfgUpdFailure"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2568, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }


   czSMem.region = czCb.init.region;
   czSMem.pool = czCb.init.pool;

   do { (*(Ptr *)&uiEvnt) = 0L; (Void)cmAllocEvnt((Size) sizeof(CztEvnt), 2048, &czSMem, (Ptr *)(Ptr *)&uiEvnt); } while(0);
   if(0L == uiEvnt)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2577, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"Allocation of CzEvnt Failed \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2578, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   cfgFailPdu = &(uiEvnt->pdu);

   { cfgFailPdu->choice.pres = 1; cfgFailPdu->choice.val = 2; };
   { cfgFailPdu->val.unsuccessfulOutcome.pres.pres = 1; cfgFailPdu->val.unsuccessfulOutcome.pres.val = 1; };
   { cfgFailPdu->val.unsuccessfulOutcome.procedureCode.pres = 1; cfgFailPdu->val.unsuccessfulOutcome.procedureCode.val = 8; }
                                                                           ;
   { cfgFailPdu->val.unsuccessfulOutcome.criticality.pres = 1; cfgFailPdu->val.unsuccessfulOutcome.criticality.val = CztCriticalityrejectEnum; }
                                                                       ;

   failIe = &(cfgFailPdu->val.unsuccessfulOutcome.value.u.cztENBConfigUpdFail);
   { failIe->pres.pres = 1; failIe->pres.val = 1; };
   { failIe->protocolIEs.noComp.pres = 1; failIe->protocolIEs.noComp.val = numComp; };

   do { (*(Ptr *)&(failIe->protocolIEs.member)) = 0L; (Void)cmGetMem(uiEvnt, numComp *sizeof(CztProtIE_Field_X2SetupFail_IEs), (Ptr *)(Ptr *)&(failIe->protocolIEs.member)); } while(0)
                                              ;
   if(0L == failIe->protocolIEs.member)
   {
      do { cmFreeMem((uiEvnt)); (uiEvnt) = 0L; } while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2598, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   czCnt = 0;

   { failIe->protocolIEs.member[czCnt].pres.pres = 1; failIe->protocolIEs.member[czCnt].pres.val = 1; };
   { failIe->protocolIEs.member[czCnt].id.pres = 1; failIe->protocolIEs.member[czCnt].id.val = 5; };
   { failIe->protocolIEs.member[czCnt].criticality.pres = 1; failIe->protocolIEs.member[czCnt].criticality.val = CztCriticalityignoreEnum; }
                                                                  ;
   ...
   czCnt++;
   { failIe->protocolIEs.member[czCnt].pres.pres = 1; failIe->protocolIEs.member[czCnt].pres.val = 1; };
   { failIe->protocolIEs.member[czCnt].id.pres = 1; failIe->protocolIEs.member[czCnt].id.val = 22; };
   { failIe->protocolIEs.member[czCnt].criticality.pres = 1; failIe->protocolIEs.member[czCnt].criticality.val = CztCriticalityignoreEnum; }
                                                                      ;
   { failIe->protocolIEs.member[czCnt].value.u.cztTimeToWait.pres = 1; failIe->protocolIEs.member[czCnt].value.u.cztTimeToWait.val = czCb.nodeCb.protCfg.timeToWait; }
                                              ;

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2617, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(uiEvnt); }while(0);
}
 CztEvnt* czUtlGenRsrcStsFail
(
CzIeInfo *idLst,
CzRsrcInfo *rsrcInfo,
U8 causeType,
...
{
   CztX2AP_PDU *rsrcFailPdu = 0L;
   CztResStatusFail *failIe = 0L;
   CztEvnt *uiEvnt = 0L;
   S16 numComp = 3;
   S16 czCnt;
   Mem czSMem;

   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGenRsrcStsFail"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2666, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   ...
   if(0L == uiEvnt)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2675, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"Allocation of CzEvnt Failed \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2676, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   ...
   { rsrcFailPdu->choice.pres = 1; rsrcFailPdu->choice.val = 2; };
   { rsrcFailPdu->val.unsuccessfulOutcome.pres.pres = 1; rsrcFailPdu->val.unsuccessfulOutcome.pres.val = 1; };
   { rsrcFailPdu->val.unsuccessfulOutcome.procedureCode.pres = 1; rsrcFailPdu->val.unsuccessfulOutcome.procedureCode.val = 9; }
                                                                             ;
   { rsrcFailPdu->val.unsuccessfulOutcome.criticality.pres = 1; rsrcFailPdu->val.unsuccessfulOutcome.criticality.val = CztCriticalityrejectEnum; }
                                                                       ;
   ...
   do { (*(Ptr *)&(failIe->protocolIEs.member)) = 0L; (Void)cmGetMem(uiEvnt, numComp * sizeof(CztProtIE_Field_ResStatusFail_IEs), (Ptr *)(Ptr *)&(failIe->protocolIEs.member)); } while(0)
                                                                          ;
   if(0L == failIe->protocolIEs.member)
   {
      do { cmFreeMem((uiEvnt)); (uiEvnt) = 0L; } while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2700, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   czCnt = 0;

   { failIe->protocolIEs.member[czCnt].pres.pres = 1; failIe->protocolIEs.member[czCnt].pres.val = 1; };
   { failIe->protocolIEs.member[czCnt].id.pres = 1; failIe->protocolIEs.member[czCnt].id.val = 39; };
   { failIe->protocolIEs.member[czCnt].criticality.pres = 1; failIe->protocolIEs.member[czCnt].criticality.val = CztCriticalityrejectEnum; }
                                                                            ;
   { failIe->protocolIEs.member[czCnt].value.u.cztid_ENB1_Measurement_ID.pres = 1; failIe->protocolIEs.member[czCnt].value.u.cztid_ENB1_Measurement_ID.val = rsrcInfo->eNb1measId; }
                                                                           ;

   czCnt ++;

   { failIe->protocolIEs.member[czCnt].pres.pres = 1; failIe->protocolIEs.member[czCnt].pres.val = 1; };
   { failIe->protocolIEs.member[czCnt].id.pres = 1; failIe->protocolIEs.member[czCnt].id.val = 40; };
   { failIe->protocolIEs.member[czCnt].criticality.pres = 1; failIe->protocolIEs.member[czCnt].criticality.val = CztCriticalityrejectEnum; }
                                                                         ;
   { failIe->protocolIEs.member[czCnt].value.u.cztid_ENB2_Measurement_ID.pres = 1; failIe->protocolIEs.member[czCnt].value.u.cztid_ENB2_Measurement_ID.val = rsrcInfo->eNb2measId; }
                                                                           ;
   ...
   {
      { failIe->protocolIEs.member[czCnt].pres.pres = 1; failIe->protocolIEs.member[czCnt].pres.val = 1; };
      { failIe->protocolIEs.member[czCnt].id.pres = 1; failIe->protocolIEs.member[czCnt].id.val = 17; };
      { failIe->protocolIEs.member[czCnt].criticality.pres = 1; failIe->protocolIEs.member[czCnt].criticality.val = CztCriticalityignoreEnum; }
                                                                              ;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2743, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(uiEvnt); }while(0);
}
 CztEvnt* czUtlGenHoPrepFailure
(
CzIeInfo *idLst,
CztUeInfo *ueInfo,
U8 causeType,
...
{
   CztX2AP_PDU *hoPrepFailPdu = 0L;
   CztHovrPrepFail *failIe = 0L;
   CztEvnt *uiEvnt = 0L;
   S16 numComp = 2;
   S16 czCnt;
   Mem czSMem;

   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGenHoPrepFailure"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2793, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   ...
   if(0L == uiEvnt)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2802, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"Allocation of CzEvnt Failed \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2803, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   ...
   { hoPrepFailPdu->choice.pres = 1; hoPrepFailPdu->choice.val = 2; };
   { hoPrepFailPdu->val.unsuccessfulOutcome.pres.pres = 1; hoPrepFailPdu->val.unsuccessfulOutcome.pres.val = 1; };
   { hoPrepFailPdu->val.unsuccessfulOutcome.procedureCode.pres = 1; hoPrepFailPdu->val.unsuccessfulOutcome.procedureCode.val = 0; }
                                                                       ;
   { hoPrepFailPdu->val.unsuccessfulOutcome.criticality.pres = 1; hoPrepFailPdu->val.unsuccessfulOutcome.criticality.val = CztCriticalityrejectEnum; }
                                                                       ;
   ...
   do { (*(Ptr *)&(failIe->protocolIEs.member)) = 0L; (Void)cmGetMem(uiEvnt, numComp * sizeof(CztProtIE_Field_HovrPrepFail_IEs), (Ptr *)(Ptr *)&(failIe->protocolIEs.member)); } while(0)
                                                                        ;
   if(0L == failIe->protocolIEs.member)
   {
      do { cmFreeMem((uiEvnt)); (uiEvnt) = 0L; } while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2828, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   czCnt = 0;

   { failIe->protocolIEs.member[czCnt].pres.pres = 1; failIe->protocolIEs.member[czCnt].pres.val = 1; };
   { failIe->protocolIEs.member[czCnt].id.pres = 1; failIe->protocolIEs.member[czCnt].id.val = 10; };
   { failIe->protocolIEs.member[czCnt].criticality.pres = 1; failIe->protocolIEs.member[czCnt].criticality.val = CztCriticalityignoreEnum; }
                                                                              ;
   { failIe->protocolIEs.member[czCnt].value.u.cztUE_X2AP_ID.pres = 1; failIe->protocolIEs.member[czCnt].value.u.cztUE_X2AP_ID.val = ueInfo->oldUEX2APId; }
                                                                          ;
   czCnt ++;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2861, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(uiEvnt); }while(0);
}
 CztEvnt* czUtlGenX2SetupFailure
(
CzIeInfo *idLst,
U8 causeType,
U8 causeVal
...
{
   CztX2AP_PDU *setupFailPdu = 0L;
   CztX2SetupFail *failIe = 0L;
   CztEvnt *uiEvnt = 0L;
   S16 numComp = 2;
   S16 czCnt;
   Mem czSMem;

   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGenX2SetupFailure"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2905, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   ...
   if(0L == uiEvnt)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2914, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"Allocation of CzEvnt Failed \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2915, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   ...
   { setupFailPdu->choice.pres = 1; setupFailPdu->choice.val = 2; };
   { setupFailPdu->val.unsuccessfulOutcome.pres.pres = 1; setupFailPdu->val.unsuccessfulOutcome.pres.val = 1; };
   { setupFailPdu->val.unsuccessfulOutcome.procedureCode.pres = 1; setupFailPdu->val.unsuccessfulOutcome.procedureCode.val = 6; }
                                                                      ;
   { setupFailPdu->val.unsuccessfulOutcome.criticality.pres = 1; setupFailPdu->val.unsuccessfulOutcome.criticality.val = CztCriticalityrejectEnum; }
                                                                       ;
   ...
   {
      do { cmFreeMem((uiEvnt)); (uiEvnt) = 0L; } while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2940, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   czCnt = 0;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",2973, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(uiEvnt); }while(0);
}
 CztEvnt* czUtlGenMobChgFailure
(
CzIeInfo *idLst,
...
{
   CztX2AP_PDU *mobChgFailPdu = 0L;
   CztMobilityChangeFail *failIe = 0L;
   CztEvnt *uiEvnt = 0L;
   S16 numComp = 3;
   S16 czCnt;
   Mem czSMem;
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGenMobChgFailure"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3024, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   ...
   if(0L == uiEvnt)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3033, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"Allocation of CzEvnt Failed \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3034, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   ...
   { mobChgFailPdu->choice.pres = 1; mobChgFailPdu->choice.val = 2; };
   { mobChgFailPdu->val.unsuccessfulOutcome.pres.pres = 1; mobChgFailPdu->val.unsuccessfulOutcome.pres.val = 1; };
   { mobChgFailPdu->val.unsuccessfulOutcome.procedureCode.pres = 1; mobChgFailPdu->val.unsuccessfulOutcome.procedureCode.val = 12; }
                                                                       ;
   { mobChgFailPdu->val.unsuccessfulOutcome.criticality.pres = 1; mobChgFailPdu->val.unsuccessfulOutcome.criticality.val = CztCriticalityrejectEnum; }
                                                                       ;
   ...
   do { (*(Ptr *)&(failIe->protocolIEs.member)) = 0L; (Void)cmGetMem(uiEvnt, numComp *sizeof(CztProtIE_Field_MobilityChangeFail_IEs), (Ptr *)(Ptr *)&(failIe->protocolIEs.member)); } while(0)
                                                                       ;
   if(0L == failIe->protocolIEs.member)
   {
      do { cmFreeMem((uiEvnt)); (uiEvnt) = 0L; } while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3060, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }

   czCnt = 0;

   { failIe->protocolIEs.member[czCnt].pres.pres = 1; failIe->protocolIEs.member[czCnt].pres.val = 1; };
   { failIe->protocolIEs.member[czCnt].id.pres = 1; failIe->protocolIEs.member[czCnt].id.val = 43; };
   { failIe->protocolIEs.member[czCnt].criticality.pres = 1; failIe->protocolIEs.member[czCnt].criticality.val = CztCriticalityignoreEnum; }
                                                                        ;

   { failIe->protocolIEs.member[czCnt].value.u.cztid_ENB1_Cell_ID.pres.pres = 1; failIe->protocolIEs.member[czCnt].value.u.cztid_ENB1_Cell_ID.pres.val = 1; }
                                                           ;

   { (failIe->protocolIEs.member[czCnt].value.u.cztid_ENB1_Cell_ID.pLMN_Identity).pres = 1; (failIe->protocolIEs.member[czCnt].value.u.cztid_ENB1_Cell_ID.pLMN_Identity).len = eNB1CellEcgi->pLMN_Identity.len; (failIe->protocolIEs.member[czCnt].value.u.cztid_ENB1_Cell_ID.pLMN_Identity).val = eNB1CellEcgi->pLMN_Identity.val; }
  ...
  &(failIe->protocolIEs.member[czCnt].value.u.cztid_ENB1_Cell_ID.eUTRANcellIdentifier),
   ...
   { failIe->protocolIEs.member[czCnt].pres.pres = 1; failIe->protocolIEs.member[czCnt].pres.val = 1; };
   { failIe->protocolIEs.member[czCnt].id.pres = 1; failIe->protocolIEs.member[czCnt].id.val = 44; };
   { failIe->protocolIEs.member[czCnt].criticality.pres = 1; failIe->protocolIEs.member[czCnt].criticality.val = CztCriticalityignoreEnum; }
                                                                       ;

   { failIe->protocolIEs.member[czCnt].value.u.cztid_ENB2_Cell_ID.pres.pres = 1; failIe->protocolIEs.member[czCnt].value.u.cztid_ENB2_Cell_ID.pres.val = 1; }
                                                                         ;

   { (failIe->protocolIEs.member[czCnt].value.u.cztid_ENB2_Cell_ID.pLMN_Identity).pres = 1; (failIe->protocolIEs.member[czCnt].value.u.cztid_ENB2_Cell_ID.pLMN_Identity).len = eNB2CellEcgi->pLMN_Identity.len; (failIe->protocolIEs.member[czCnt].value.u.cztid_ENB2_Cell_ID.pLMN_Identity).val = eNB2CellEcgi->pLMN_Identity.val; }
  ...
  &(failIe->protocolIEs.member[czCnt].value.u.cztid_ENB2_Cell_ID.eUTRANcellIdentifier),
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3130, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(uiEvnt); }while(0);
}
 CztEvnt* czUtlGenCellActFailure
(
CzIeInfo *idLst,
U8 causeType,
U8 causeVal
...
{
   CztX2AP_PDU *cellActFailPdu = 0L;
   CztCellActvnFail *failIe = 0L;
   CztEvnt *uiEvnt = 0L;
   S16 numComp = 1;
   S16 czCnt;
   Mem czSMem;

   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGenCellActFailure"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3176, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   ...
   if(0L == uiEvnt)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3185, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"Allocation of CzEvnt Failed \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3186, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   ...
   { cellActFailPdu->choice.pres = 1; cellActFailPdu->choice.val = 2; };
   { cellActFailPdu->val.unsuccessfulOutcome.pres.pres = 1; cellActFailPdu->val.unsuccessfulOutcome.pres.val = 1; };
   { cellActFailPdu->val.unsuccessfulOutcome.procedureCode.pres = 1; cellActFailPdu->val.unsuccessfulOutcome.procedureCode.val = 15; }
                                                                    ;
   { cellActFailPdu->val.unsuccessfulOutcome.criticality.pres = 1; cellActFailPdu->val.unsuccessfulOutcome.criticality.val = CztCriticalityrejectEnum; }
                                                                       ;
   ...
   do { (*(Ptr *)&(failIe->protocolIEs.member)) = 0L; (Void)cmGetMem(uiEvnt, numComp *sizeof(CztProtIE_Field_CellActvnFail_IEs), (Ptr *)(Ptr *)&(failIe->protocolIEs.member)); } while(0)
                                                                       ;
   if(0L == failIe->protocolIEs.member)
   {
      do { cmFreeMem((uiEvnt)); (uiEvnt) = 0L; } while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3212, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3238, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(uiEvnt); }while(0);
}
 CztEvnt* czUtlGenPeerErrInd
(
CztX2AP_PDU *pdu,
U8 msgType,
CzMsgInfo *msgInfo,
...
)
{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGenPeerErrInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3316, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   czTmpUeInfo.oldUEX2APId = 0xFFFF;
   czTmpUeInfo.newUEX2APId = 0xFFFF;
   ...
   if(0L == uiEvnt)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3328, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"FATAL\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf,"Allocation of CzEvnt Failed \n"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3329, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   errIndPdu = &(uiEvnt->pdu);

   if(msgInfo != 0L)
   {
      if (0xFFFF != msgInfo->oldUEX2APId)
      {
         czTmpUeInfo.oldUEX2APId = msgInfo->oldUEX2APId;
         numComp++;
      }
      if (0xFFFF != msgInfo->newUEX2APId)
      {
   ...
   { errIndPdu->choice.pres = 1; errIndPdu->choice.val = 0; };
   { errIndPdu->val.initiatingMsg.pres.pres = 1; errIndPdu->val.initiatingMsg.pres.val = 1; };
   { errIndPdu->val.initiatingMsg.procedureCode.pres = 1; errIndPdu->val.initiatingMsg.procedureCode.val = 3; }
                                                                   ;
   { errIndPdu->val.initiatingMsg.criticality.pres = 1; errIndPdu->val.initiatingMsg.criticality.val = CztCriticalityignoreEnum; }
                                                                       ;

   errIe = &(errIndPdu->val.initiatingMsg.value.u.cztErrInd);
   { errIe->pres.pres = 1; errIe->pres.val = 1; };
   { errIe->protocolIEs.noComp.pres = 1; errIe->protocolIEs.noComp.val = numComp; };

   do { (*(Ptr *)&(errIe->protocolIEs.member)) = 0L; (Void)cmGetMem(uiEvnt, numComp *sizeof(CztProtIE_Field_ErrInd_IEs), (Ptr *)(Ptr *)&(errIe->protocolIEs.member)); } while(0)
                                                                  ;
   if(0L == errIe->protocolIEs.member)
   {
      do { cmFreeMem((uiEvnt)); (uiEvnt) = 0L; } while(0);
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3368, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
   cnt = 0;

   if (0xFFFF != czTmpUeInfo.oldUEX2APId)
   {
      { errIe->protocolIEs.member[cnt].pres.pres = 1; errIe->protocolIEs.member[cnt].pres.val = 1; };
      { errIe->protocolIEs.member[cnt].id.pres = 1; errIe->protocolIEs.member[cnt].id.val = 10; };
      { errIe->protocolIEs.member[cnt].criticality.pres = 1; errIe->protocolIEs.member[cnt].criticality.val = CztCriticalityignoreEnum; }
                                                                             ;
      { errIe->protocolIEs.member[cnt].value.u.cztid_Old_eNB_UE_X2AP_ID.pres = 1; errIe->protocolIEs.member[cnt].value.u.cztid_Old_eNB_UE_X2AP_ID.val = czTmpUeInfo.oldUEX2APId; }
                                                                             ;
      cnt ++;
   }
   if (0xFFFF != czTmpUeInfo.newUEX2APId)
   {
      { errIe->protocolIEs.member[cnt].pres.pres = 1; errIe->protocolIEs.member[cnt].pres.val = 1; };
      { errIe->protocolIEs.member[cnt].id.pres = 1; errIe->protocolIEs.member[cnt].id.val = 9; };
      { errIe->protocolIEs.member[cnt].criticality.pres = 1; errIe->protocolIEs.member[cnt].criticality.val = CztCriticalityignoreEnum; }
                                                                          ;
      { errIe->protocolIEs.member[cnt].value.u.cztid_New_eNB_UE_X2AP_ID.pres = 1; errIe->protocolIEs.member[cnt].value.u.cztid_New_eNB_UE_X2AP_ID.val = czTmpUeInfo.newUEX2APId; }
                                                                         ;

      cnt++;
   }
   { errIe->protocolIEs.member[cnt].pres.pres = 1; errIe->protocolIEs.member[cnt].pres.val = 1; };
   { errIe->protocolIEs.member[cnt].id.pres = 1; errIe->protocolIEs.member[cnt].id.val = 5; };
   { errIe->protocolIEs.member[cnt].criticality.pres = 1; errIe->protocolIEs.member[cnt].criticality.val = CztCriticalityignoreEnum; }
                                                                        ;
   ...
   {
      { errIe->protocolIEs.member[cnt].pres.pres = 1; errIe->protocolIEs.member[cnt].pres.val = 1; };
      { errIe->protocolIEs.member[cnt].id.pres = 1; errIe->protocolIEs.member[cnt].id.val = 17; };
      { errIe->protocolIEs.member[cnt].criticality.pres = 1; errIe->protocolIEs.member[cnt].criticality.val = CztCriticalityignoreEnum; }
                                                                          ;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3415, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(uiEvnt); }while(0);
}
static Void czMapPasnErrToCauseIe
(
S16 errCode,
U8 *causeType,
U8 *causeVal
...
static CztEvnt* czUtlX2RsrcStsDecErr
(
CztX2AP_PDU *pdu,
U8 causeType,
U8 causeVal
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlX2RsrcStsDecErr"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3535, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };


   do { (Void)cmMemset((U8*)((U8 *)czIeId), 0, (Size)5 * sizeof(CzIeInfo)); } while(0);
   czUtlGetIE(pdu, 39, &czIeTkn);
   if(czIeTkn == 0L)
   {
      ...
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3550, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, 16, 0L, czTmpCauseType, czTmpCauseVal)); }while(0)
                                                                 ;
   ...
   if((czMeasId->pres != 1) ||
      (4095 < czMeasId->val))
   {
      { czIeId[cnt].pres = 1; czIeId[cnt].ieId = 39; czIeId[cnt].crit = CztCriticalityrejectEnum; czIeId[cnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                     ;
      cnt++;
   }
   czResrcInfo.eNb1measId = ((CztMeasurement_ID *)czIeTkn)->val;
   czUtlGetIE(pdu, 40, &czIeTkn);
   if(czIeTkn == 0L)
   {
      ...
      czTmpCauseVal = CztCauseProtabstract_syntax_error_rejectEnum;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3573, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, 16, 0L, czTmpCauseType, czTmpCauseVal)); }while(0)
                                                                 ;
   }
   czMeasId = (CztMeasurement_ID *)czIeTkn;
   if((czMeasId->pres != 1) ||
      (4095 < czMeasId->val))
   {
      { czIeId[cnt].pres = 1; czIeId[cnt].ieId = 40; czIeId[cnt].crit = CztCriticalityrejectEnum; czIeId[cnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                     ;
   }
   czResrcInfo.eNb2measId = ((CztMeasurement_ID *)czIeTkn)->val;

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3584, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenRsrcStsFail(czIeId, &czResrcInfo, causeType, causeVal)); }while(0);

}
static CztEvnt* czUtlX2SetupReqDecErr
(
CztX2AP_PDU *pdu,
U8 causeType,
U8 causeval
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlX2SetupReqDecErr"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3627, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { (Void)cmMemset((U8*)((U8 *)czIeId), 0, (Size)5 * sizeof(CzIeInfo)); } while(0);
   czUtlGetIE(pdu, 21, &czIeTkn);
   if(czIeTkn == 0L)
   {
      { czIeId[0].pres = 1; czIeId[0].ieId = 21; czIeId[0].crit = CztCriticalityrejectEnum; czIeId[0].typOfErr = CztTypOfErrmissingEnum; }
                                                                    ;
      ...
      czTmpCauseVal = CztCauseProtabstract_syntax_error_rejectEnum;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3643, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenX2SetupFailure(czIeId, czTmpCauseType, czTmpCauseVal)); }while(0)
                                                                     ;
   }
   else
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3647, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenX2SetupFailure(0L, causeType, causeval)); }while(0);
   }

}
static CztEvnt* czUtlMobChgReqDecErr
(
CztX2AP_PDU *pdu,
U8 causeType,
U8 causeval
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlMobChgReqDecErr"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3693, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { (Void)cmMemset((U8*)((U8 *)czIeId), 0, (Size)5 * sizeof(CzIeInfo)); } while(0);
   czUtlGetIE(pdu, 43, &czIeTkn);
    if(czIeTkn == 0L)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 43; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrmissingEnum; }
                                                              ;
      czCnt++;
      ...
      czTmpCauseVal = CztCauseProtabstract_syntax_error_rejectEnum;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3710, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, 20, 0L, czTmpCauseType, czTmpCauseVal)); }while(0)
                                                                    ;
   }
   czENB1Ecgi = (CztECGI *)czIeTkn;
   if(czENB1Ecgi->pres.val != 1)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 43; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                     ;
      czCnt++;
      ...
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3727, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, 255, 0L, czTmpCauseType, czTmpCauseVal)); }while(0)
                                                                    ;

   }

   czUtlGetIE(pdu, 44, &czIeTkn);
    if(czIeTkn == 0L)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 44; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrmissingEnum; }
                                                              ;
      czCnt++;
      ...
      czTmpCauseVal = CztCauseProtabstract_syntax_error_rejectEnum;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3745, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, 20, 0L, czTmpCauseType, czTmpCauseVal)); }while(0)
                                                                    ;
   }
   czENB2Ecgi = (CztECGI *)czIeTkn;
   if(czENB2Ecgi->pres.val != 1)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 44; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                     ;
      czCnt++;
      ...
      czTmpCauseVal = CztCauseProtabstract_syntax_error_rejectEnum;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3761, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, 20, 0L, czTmpCauseType, czTmpCauseVal)); }while(0)
                                                                    ;
   }

   czUtlGetIE(pdu, 45, &czIeTkn);
   if(czIeTkn == 0L)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 45; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrmissingEnum; }
                                                              ;
      czCnt++;
   }

   czUtlGetIE(pdu, 5, &czIeTkn);
   if(czIeTkn == 0L)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 5; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrmissingEnum; }
                                                              ;
      czCnt++;
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3781, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenMobChgFailure(czIeId, czENB1Ecgi, czENB2Ecgi, causeType, causeval)); }while(0)
                                                                       ;
}
static CztEvnt* czUtlCellActReqDecErr
(
CztX2AP_PDU *pdu,
U8 causeType,
U8 causeval
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlCellActReqDecErr"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3821, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { (Void)cmMemset((U8*)((U8 *)czIeId), 0, (Size)5 * sizeof(CzIeInfo)); } while(0);
   czUtlGetIE(pdu, 57, &czIeTkn);
   if(czIeTkn == 0L)
   {
      { czIeId[0].pres = 1; czIeId[0].ieId = 57; czIeId[0].crit = CztCriticalityrejectEnum; czIeId[0].typOfErr = CztTypOfErrmissingEnum; }
                                                                    ;
   }
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3830, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenCellActFailure(czIeId, causeType, causeval)); }while(0);
}
static CztEvnt* czUtlHoReqDecErr
(
CztX2AP_PDU *pdu,
U8 causeType,
U8 causeVal
...

{
   ...
   CztUeInfo czUeInfo;
   U8 czCnt = 0;
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlHoReqDecErr"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3876, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };

   do { (Void)cmMemset((U8*)((U8 *)czIeId), 0, (Size)5 * sizeof(CzIeInfo)); } while(0);
   czUtlGetIE(pdu, 10, &czIeTkn);
   if(czIeTkn == 0L)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 10; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrmissingEnum; }
                                                             ;
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3885, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, 255, 0L, causeType, causeVal)); }while(0)
                                                                           ;
   }
   czOldUEX2APId = (CztUE_X2AP_ID *)czIeTkn;
   if((czOldUEX2APId->pres == 1) &&
   ...
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 10; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                    ;
      czCnt++;
   }
   czUtlGetIE(pdu, 5, &czIeTkn);
   if(czIeTkn == 0L)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 5; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrnot_understoodEnum; }
                                                                    ;
      czCnt++;
   }
   czUtlGetIE(pdu, 11, &czIeTkn);
   if(czIeTkn == 0L)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 11; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrmissingEnum; }
                                                             ;
      czCnt++;
   }
   czUtlGetIE(pdu, 23, &czIeTkn);
   if(czIeTkn == 0L)
   {
      { czIeId[czCnt].pres = 1; czIeId[czCnt].ieId = 11; czIeId[czCnt].crit = CztCriticalityrejectEnum; czIeId[czCnt].typOfErr = CztTypOfErrmissingEnum; }
                                                             ;
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3920, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenHoPrepFailure(czIeId, &czUeInfo, causeType, causeVal)); }while(0);
}
 CztEvnt* czUtlSndRspMsg
(
CztX2AP_PDU *pdu,
CmPAsnErr *pasnErr
)
...

{
   ...
   U8 czCauseVal;
   U8 czRspMsgType;
   CztUE_X2AP_ID *czUeX2APId = 0L;
   CztUeInfo czUeInfo;
   CztUeInfo *czTmpUeInfo = 0L;
   S16 ret = 0;
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlSndRspMsg"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3962, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
   ...
   if(ret != 0)
   {
      do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3970, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, 255, 0L, czCauseType, czCauseVal)); }while(0)
                           ;
   }
   czRspMsgType = responseMsg[czMsgId];

   switch(czRspMsgType)
   {
      case 2:
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3978, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlHoReqDecErr(pdu, czCauseType, czCauseVal)); }while(0);
      }
      case 10:
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3982, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlX2SetupReqDecErr(pdu, czCauseType, czCauseVal)); }while(0);
      }
      case 15:
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3986, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenX2CfgUpdFailure(pdu, czCauseType, czCauseVal)); }while(0);
      }
      case 18:
      {
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3990, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlX2RsrcStsDecErr(pdu, czCauseType, czCauseVal)); }while(0);
      }
      case 22:
      {
          do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3994, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlMobChgReqDecErr(pdu, czCauseType, czCauseVal)); }while(0);
      }
      case 27:
      {
           do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",3998, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlCellActReqDecErr(pdu, czCauseType, czCauseVal)); }while(0);
      }
      case 255:
      {
          czUtlGetIE(pdu, 10, (TknU8 **)&czUeX2APId);
          if(czUeX2APId && ((0 <= czUeX2APId->val) && (czUeX2APId->val < 4096)))
          {
             czUeInfo.oldUEX2APId = (U16) czUeX2APId->val;
             czUtlGetIE(pdu, 9, (TknU8 **)&czUeX2APId);
             ...
             {
                czUeInfo.newUEX2APId = 0xFFFF;
             }
             czTmpUeInfo = &czUeInfo;
          }
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",4020, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czUtlGenPeerErrInd(pdu, czMsgId, ((CzMsgInfo *)czTmpUeInfo), czCauseType, czCauseVal)); }while(0)

                                                              ;
      }
      default:
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",4023, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0L); }while(0);
   }
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetCause"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",4055, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   ...
   switch(causeIE->choice.val)
   {
      ...
      default:
         do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",4104, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(1); }while(0);
   }

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",4107, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(czCauseVal); }while(0);
}
 S16 czUtlGetStream
(
CzPeerCb *peerCb,
...
{
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czUtlGetStream"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",4140, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }
   ...
   *strmId = ((peerCb->nextStreamId) % peerCb->assocCb->assocCfg->locOutStrms);
   ...
   do { if (czCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",4152, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"INFO\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "czUtlGetStream(*strmId = %d)\n", *strmId); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0)
                                                               ;

   peerCb->nextStreamId = ((*strmId + 1) %
                          peerCb->assocCb->assocCfg->locOutStrms);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_utl.c",4157, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
 S16 czUtlFillTknBStr32
(
TknBStr32 *ptr,
U16 len,
U32 val
