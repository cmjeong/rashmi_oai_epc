...
RLCStats gRlcStats;
 ...
 KwCb *kwCb[2];
extern S16 kwActvTmr (Ent ent, Inst inst);

static Void kwLmmSendCfm (KwCb *gCb,Pst *pst,KwMngmt *cfm,U8 type, Header *hdr)
                                              ;
static S16 kwLmmGenCfg (KwCb *gCb, KwGenCfg *cfg);
static S16 kwLmmCfgKwuSap (KwCb *gCb,KwSapCfg *cfg);
static S16 kwLmmCfgUdxSap (KwCb *gCb,KwSapCfg *cfg);
static S16 kwLmmCfgCkwSap (KwCb *gCb,KwSapCfg *cfg);
static S16 kwLmmCfgRguSap (KwCb *gCb,KwSapCfg *cfg);
static S16 kwLmmGenCntrl (KwCb *gCb,KwMngmt *cntrl);
static S16 kwLmmUdxSapCntrl (KwCb *gCb,KwMngmt *cntrl);
static S16 kwLmmLSapCntrl (KwCb *gCb,KwMngmt *cntrl);
static S16 kwLmmGetKwuSapSta (KwCb *gCb,KwKwuSapSta *sta);
static S16 kwLmmGetRguSapSta (KwCb *gCb,KwRguSapSta *sta);
static S16 kwLmmGetCkwCntSapSta (KwCb *gCb,KwCkwCntSapSta *sta);
static S16 kwLmmGetGenSts (KwCb *gCb,KwGenSts *sts,Action action);
static S16 kwLmmGetSapSts (KwCb *gCb,KwMngmt *sts,Elmnt elmnt,Action action)
                                          ;
static S16 kwLmmGenCfg
(
KwCb *gCb,
KwGenCfg *cfg
)
...

{
   ...
   if((cfg->maxRguSaps == 0) || (cfg->maxRguSaps > 2))
   {


      return(13);
   }
   if(gCb->init.cfgDone == 1)
   {
   ...
   if(gCb->genCfg.rlcMode == 1)
   {
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.dlCb, (Size) sizeof (KwDlCb)) == 0) { cmMemset((U8 *)(gCb->u.dlCb), 0, sizeof (KwDlCb)); } else { (gCb->u.dlCb) = 0L; } };
      if (gCb->u.dlCb == 0L)
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc50001, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",209, "Memory Allocation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(4);
      ...
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.dlCb->kwuDlSap, (Size) kwSapSize) == 0) { cmMemset((U8 *)(gCb->u.dlCb->kwuDlSap), 0, kwSapSize); } else { (gCb->u.dlCb->kwuDlSap) = 0L; } };
      gCb->u.dlCb->numKwuSaps = gCb->genCfg.maxKwuSaps;

      kwUdxSapSize = (Size)((Size) gCb->genCfg.maxUdxSaps *
                   (Size)sizeof(KwUdxDlSapCb));

      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.dlCb->udxDlSap, (Size) kwUdxSapSize) == 0) { cmMemset((U8 *)(gCb->u.dlCb->udxDlSap), 0, kwUdxSapSize); } else { (gCb->u.dlCb->udxDlSap) = 0L; } };
      rguSapSize = (Size)((Size) gCb->genCfg.maxRguSaps *
                   (Size)sizeof(KwRguSapCb));
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.dlCb->rguDlSap, (Size) rguSapSize) == 0) { cmMemset((U8 *)(gCb->u.dlCb->rguDlSap), 0, rguSapSize); } else { (gCb->u.dlCb->rguDlSap) = 0L; } };
      ret = kwDbmDlInit(gCb);
      if (ret != 0)
      {
         { if (gCb->u.dlCb->udxDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->udxDlSap, (Size) kwSapSize); gCb->u.dlCb->udxDlSap = 0L; } };
         { if (gCb->u.dlCb->kwuDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->kwuDlSap, (Size) kwSapSize); gCb->u.dlCb->kwuDlSap = 0L; } };
         { if (gCb->u.dlCb->rguDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->rguDlSap, (Size) rguSapSize); gCb->u.dlCb->rguDlSap = 0L; } };
         { if (gCb->u.dlCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb, (Size) sizeof (KwDlCb)); gCb->u.dlCb = 0L; } };
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc50002, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",269, "RLC DL Initialization failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(4);
      }


      if(SRegCfgTmrMt(gCb->init.ent,gCb->init.inst,(U16)cfg->timeRes,100,kwActvTmr)
                         != 0)
      {
         { if (gCb->u.dlCb->udxDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->udxDlSap, (Size) kwUdxSapSize); gCb->u.dlCb->udxDlSap = 0L; } };
         { if (gCb->u.dlCb->kwuDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->kwuDlSap, (Size) kwSapSize); gCb->u.dlCb->kwuDlSap = 0L; } };
         { if (gCb->u.dlCb->rguDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->rguDlSap, (Size) rguSapSize); gCb->u.dlCb->rguDlSap = 0L; } };
         { if (gCb->u.dlCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb, (Size) sizeof (KwDlCb)); gCb->u.dlCb = 0L; } };
   ...
   else if(gCb->genCfg.rlcMode == 2)
   {
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.ulCb, (Size) sizeof (KwUlCb)) == 0) { cmMemset((U8 *)(gCb->u.ulCb), 0, sizeof (KwUlCb)); } else { (gCb->u.ulCb) = 0L; } };
      if (gCb->u.ulCb == 0L)
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc50003, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",310, "Memory Allocation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(4);
      ...
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.ulCb->kwuUlSap, (Size) kwSapSize) == 0) { cmMemset((U8 *)(gCb->u.ulCb->kwuUlSap), 0, kwSapSize); } else { (gCb->u.ulCb->kwuUlSap) = 0L; } };
      ...
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.ulCb->udxUlSap, (Size) kwUdxSapSize) == 0) { cmMemset((U8 *)(gCb->u.ulCb->udxUlSap), 0, kwUdxSapSize); } else { (gCb->u.ulCb->udxUlSap) = 0L; } };
      rguSapSize = (Size)((Size) gCb->genCfg.maxRguSaps *
                   (Size)sizeof(KwRguSapCb));
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.ulCb->rguUlSap, (Size) rguSapSize) == 0) { cmMemset((U8 *)(gCb->u.ulCb->rguUlSap), 0, rguSapSize); } else { (gCb->u.ulCb->rguUlSap) = 0L; } };
      ret = kwDbmUlInit(gCb);
      if (ret != 0)
      {
         { if (gCb->u.ulCb->udxUlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.ulCb->udxUlSap, (Size) kwUdxSapSize); gCb->u.ulCb->udxUlSap = 0L; } };
         { if (gCb->u.ulCb->kwuUlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.ulCb->kwuUlSap, (Size) kwSapSize); gCb->u.ulCb->kwuUlSap = 0L; } };
         { if (gCb->u.ulCb->rguUlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.ulCb->rguUlSap, (Size) kwSapSize); gCb->u.ulCb->rguUlSap = 0L; } };
         { if (gCb->u.ulCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.ulCb, (Size) sizeof (KwUlCb)); gCb->u.ulCb = 0L; } };
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc50004, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",371, "RLC DL Initialization failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      }
   ...
   gCb->kwTqCp.tmrLen = 10;

   cmMemset((U8*)gCb->kwTq, 0L, sizeof(CmTqType) * 10);

   cmMemcpy((U8*)&(gCb->init.lmPst), (U8 *)&cfg->lmPst, sizeof(Pst));;

   gCb->init.lmPst.srcProcId = gCb->init.procId;
   gCb->init.lmPst.srcEnt = gCb->init.ent;
   gCb->init.lmPst.srcInst = gCb->init.inst;
   gCb->init.lmPst.event = 0x00;
...
)
{
   ...
   cmMemset((U8 *)&rPst, (U8)0, sizeof(Pst));;
...

{
   ...
   if (!tKwCb)
   {
      cfg->cfm.status = 1;
      cfg->cfm.reason = 8;
      kwLmmSendCfm(tKwCb,pst, cfg, 1, &cfg->hdr);
      return(1);
   }

   if ((tKwCb->init.cfgDone != 1) &&
       (cfg->hdr.elmId.elmnt != 1))
   {
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xc50005, L_DEBUG, cfg->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",628, "KwMiLkwCfgReq elmId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if(!tKwCb)
   {
      cntrl->cfm.status = 1;
      cntrl->cfm.reason = 8;
      kwLmmSendCfm(tKwCb,pst, cntrl, 2, &cntrl->hdr);
      return(1);
   }
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xc50006, L_DEBUG, cntrl->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",778, "KwMiLkwCntrlReq(elmId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if (!tKwCb)
   {
      ...
      kwLmmSendCfm(tKwCb,pst, sta, 4, &sta->hdr);
      return(1);
   }

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xc50007, L_DEBUG, sta->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",880, "Status request for elmId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   reason = 0;

   cmMemset((U8 *)&rSta, (U8)0, sizeof(KwMngmt));;
   switch (sta->hdr.elmId.elmnt)
   {
      ...
      case 185:
      {
         cmMemcpy((U8*)&rSta.t.ssta.s.kwuSap, (U8 *)&sta->t.ssta.s.kwuSap, sizeof (KwKwuSapSta));
      ...
      case 186:
      {
         cmMemcpy((U8*)&rSta.t.ssta.s.rguSap, (U8 *)&sta->t.ssta.s.rguSap, sizeof (KwRguSapSta));
      ...
      case 184:
      {
         cmMemcpy((U8*)&rSta.t.ssta.s.ckwSap, (U8 *)&sta->t.ssta.s.ckwSap, sizeof (KwCkwCntSapSta));
   ...
   kwLmmSendCfm(tKwCb,pst, &rSta, 4, &sta->hdr);
...

{
   ...
   if (!tKwCb)
   {
      ...
      kwLmmSendCfm(tKwCb,pst, &rSts, 2, &sts->hdr);
      return(1);
   }

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xc50008, L_DEBUG, action, sts->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c"   , 1018   , "KwMiLkwStsReq(elmId(%d),action(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                            ;

   cmMemset((U8 *)&rSts, (U8)0, sizeof(KwMngmt));;
   ...
   kwLmmSendCfm(tKwCb,pst, &rSts, 3, &sts->hdr);

   return(0);
}
static S16 kwLmmCfgKwuSap
(
KwCb *gCb,
KwSapCfg *cfg
)
...

{
   KwKwuSapCb *kwuSapCb;
   ;
   kwuSapCb = (gCb->genCfg.rlcMode == 1) ?
              (KwKwuSapCb*)(gCb->u.dlCb->kwuDlSap + cfg->sapId):
              (KwKwuSapCb*)(gCb->u.ulCb->kwuUlSap + cfg->sapId);
   { kwuSapCb->pst.selector = cfg->selector; kwuSapCb->pst.route = cfg->route; kwuSapCb->pst.prior = cfg->priority; kwuSapCb->pst.region = gCb->init.region; kwuSapCb->pst.pool = gCb->init.pool; kwuSapCb->pst.dstProcId = cfg->procId; kwuSapCb->pst.dstEnt = cfg->ent; kwuSapCb->pst.dstInst = cfg->inst; kwuSapCb->pst.srcProcId = gCb->init.procId; kwuSapCb->pst.srcEnt = gCb->init.ent; kwuSapCb->pst.srcInst = gCb->init.inst; kwuSapCb->pst.event = 0x00; kwuSapCb->spId = cfg->sapId; kwuSapCb->state = 1; };

   return(0);
}
static S16 kwLmmCfgCkwSap
(
KwCb *gCb,
KwSapCfg *cfg
)
...

{
   ...
   { ckwSap->pst.selector = cfg->selector; ckwSap->pst.route = cfg->route; ckwSap->pst.prior = cfg->priority; ckwSap->pst.region = gCb->init.region; ckwSap->pst.pool = gCb->init.pool; ckwSap->pst.dstProcId = cfg->procId; ckwSap->pst.dstEnt = cfg->ent; ckwSap->pst.dstInst = cfg->inst; ckwSap->pst.srcProcId = gCb->init.procId; ckwSap->pst.srcEnt = gCb->init.ent; ckwSap->pst.srcInst = gCb->init.inst; ckwSap->pst.event = 0x00; ckwSap->spId = cfg->sapId; ckwSap->state = 1; };

   return(0);
}
static S16 kwLmmCfgUdxSap
(
KwCb *gCb,
KwSapCfg *cfg
)
...

{
   ...
   if (gCb->genCfg.rlcMode == 1)
   {
      ...
      { udxDlSap->pst.selector = cfg->selector; udxDlSap->pst.route = cfg->route; udxDlSap->pst.prior = cfg->priority; udxDlSap->pst.region = gCb->init.region; udxDlSap->pst.pool = gCb->init.pool; udxDlSap->pst.dstProcId = cfg->procId; udxDlSap->pst.dstEnt = cfg->ent; udxDlSap->pst.dstInst = cfg->inst; udxDlSap->pst.srcProcId = gCb->init.procId; udxDlSap->pst.srcEnt = gCb->init.ent; udxDlSap->pst.srcInst = gCb->init.inst; udxDlSap->pst.event = 0x00; udxDlSap->spId = cfg->sapId; udxDlSap->state = 1; };
   }
   else
   {
      udxUlSap = (gCb->u.ulCb->udxUlSap + cfg->sapId);
      { udxUlSap->pst.selector = cfg->selector; udxUlSap->pst.route = cfg->route; udxUlSap->pst.prior = cfg->priority; udxUlSap->pst.region = gCb->init.region; udxUlSap->pst.pool = gCb->init.pool; udxUlSap->pst.dstProcId = cfg->procId; udxUlSap->pst.dstEnt = cfg->ent; udxUlSap->pst.dstInst = cfg->inst; udxUlSap->pst.srcProcId = gCb->init.procId; udxUlSap->pst.srcEnt = gCb->init.ent; udxUlSap->pst.srcInst = gCb->init.inst; udxUlSap->pst.event = 0x00; udxUlSap->spId = cfg->sapId; udxUlSap->state = 1; };
...

{
   ...
   ;;
   rguSap = (gCb->genCfg.rlcMode == 1) ?
            &(gCb->u.dlCb->rguDlSap[cfg->sapId]): &(gCb->u.ulCb->rguUlSap[cfg->sapId]);
   { rguSap->pst.selector = cfg->selector; rguSap->pst.route = cfg->route; rguSap->pst.prior = cfg->priority; rguSap->pst.region = gCb->init.region; rguSap->pst.pool = gCb->init.pool; rguSap->pst.dstProcId = cfg->procId; rguSap->pst.dstEnt = cfg->ent; rguSap->pst.dstInst = cfg->inst; rguSap->pst.srcProcId = gCb->init.procId; rguSap->pst.srcEnt = gCb->init.ent; rguSap->pst.srcInst = gCb->init.inst; rguSap->pst.event = 0x00; rguSap->spId = cfg->sapId; rguSap->state = 1; };
...
static S16 kwLmmValidateGenCntrl
(
KwMngmt *cntrl
)
...
static Void kwLmmCleanGblRsrcs
(
KwCb *gCb
)
...

{
   ...
   if (gCb->init.cfgDone)
   {
      ...
      (Void) SDeregCfgTmrMt(gCb->init.ent,gCb->init.inst,(S16)gCb->genCfg.timeRes,100,kwActvTmr)
                                                            ;
      ...
      if (gCb->genCfg.rlcMode == 1)
      {
         ...
         if (gCb->u.dlCb)
         {
            gCb->u.dlCb->shutdownReceived = 1;
            kwUtlFreeDlMemory(gCb);
            if (gCb->u.dlCb->kwuDlSap != 0L)
            {
               { if (gCb->u.dlCb->kwuDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->kwuDlSap, (Size) kwSapSize); gCb->u.dlCb->kwuDlSap = 0L; } };
            }

            if(gCb->u.dlCb->udxDlSap != 0L)
            {
               { if (gCb->u.dlCb->udxDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->udxDlSap, (Size) kwUdxSapSize); gCb->u.dlCb->udxDlSap = 0L; } };
            }

            if(gCb->u.dlCb->rguDlSap != 0L)
            {
               { if (gCb->u.dlCb->rguDlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb->rguDlSap, (Size) gCb->genCfg.maxRguSaps); gCb->u.dlCb->rguDlSap = 0L; } };
               gCb->genCfg.maxRguSaps = 0;
            }
             if (gCb->u.dlCb->shutdownReceived)
            {
               if (gCb->u.dlCb->selfPstMBuf != 
                                              ((void *)0)
                                                  )
               {
      ...
      else
      {
         ...
         if (gCb->u.ulCb)
         {
            if (gCb->u.ulCb->kwuUlSap != 0L)
            {
               { if (gCb->u.ulCb->kwuUlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.ulCb->kwuUlSap, (Size) kwSapSize); gCb->u.ulCb->kwuUlSap = 0L; } };
            }

            if(gCb->u.ulCb->udxUlSap != 0L)
            {
               { if (gCb->u.ulCb->udxUlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.ulCb->udxUlSap, (Size) kwUdxSapSize); gCb->u.ulCb->udxUlSap = 0L; } };
            }

            if(gCb->u.ulCb->rguUlSap != 0L)
            {
               { if (gCb->u.ulCb->rguUlSap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.ulCb->rguUlSap, (Size) gCb->genCfg.maxRguSaps); gCb->u.ulCb->rguUlSap = 0L; } };
               gCb->genCfg.maxRguSaps = 0;
            }
...

{
   ...
   if (gCb->genCfg.rlcMode == 1)
   {
      for (idx = 0; idx < gCb->genCfg.maxRguSaps; idx++)
      {
         ...
         if ((rguSap->state == 2) || (rguSap->state == 3))
         {
   ...
   cmMemset((U8 *)&(gCb->genSts), (U8)0, sizeof (KwGenSts));;

   return(0);
}
static S16 kwLmmGenCntrl
(
KwCb *gCb,
KwMngmt *cntrl
)
      ...
      case 1:
      {
         switch(cntrl->t.cntrl.subAction)
         {
            ...
            case 5:
            {
               ...
               (gCb->init.dbgMask) |= dbgCntrl->dbgMask;
...

{
   ...
   switch(cntrl->t.cntrl.action)
   {
      case 30:
      {
         if(gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId].state != 2)
         {

            kwStartTmr(gCb,(U32)(&gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId]), 5);
            gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId].state = 3;
            KwUlUdxBndReq(&(gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId].pst), gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId].suId, gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId].spId);
         }
         else
         {
      ...
      case 31:
      {
         ...
         gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId].state = 1;
         KwUlUdxUbndReq(&(gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId].pst), gCb->u.ulCb->udxUlSap[cntrl->t.cntrl.s.sapCntrl.suId].spId, 0);
      }
      break;
      default:
         return(9);
   ...
   switch(elmnt)
   {
      case 185:
      {
         ...
         *kwuSap = kwuSapCb->sts;
         ...
         if (action == 0)
         {
            cmMemset((U8 *)&kwuSapCb->sts, (U8)0, sizeof (KwKwuSapSts));;
         }
         break;
      }
      ...
      case 184:
      {
         ...
         if (action == 0)
         {
            cmMemset((U8 *)&(gCb->u.ulCb->ckwSap.sts), (U8)0, sizeof (KwCkwCntSts));;
         }
         break;
      }
      default:
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xc50009, L_DEBUG, event, gCb->trcLen, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c"   , 2487   , "kwLmmSendTrc(): Trace for event=%d, gCb->trcLen=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if(mBuf != 0L)
   {
     ...
     if(gCb->trcLen == -1)
     {
            ...
            != 0)
        {
           ...
           if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc5000a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",2507, "SCpyMsgMsg Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
           return(1);
        }
     ...
     else if(gCb->trcLen > 0)
     {
        ...
        if (SFndLenMsg(mBuf, &bufLen) != 0)
        {
           if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc5000b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",2519, "SFndLenMsg Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
           return(1);
        }
        ...
        if(bufLen < gCb->trcLen)
        {
           ...
           if (SCpyMsgMsg(mBuf, pst.region, pst.pool, &dstMbuf)
              != 0)
           {
              if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc5000c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",2530, "SCpyMsgMsg Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
           }
        ...
        else
        {
           ...
           { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&tempBuf, (Size) gCb->trcLen) == 0) { cmMemset((U8 *)(tempBuf), 0, gCb->trcLen); } else { (tempBuf) = 0L; } };
           if (SCpyMsgFix(mBuf,0,gCb->trcLen,tempBuf,&tempCnt) != 0)
           {
              if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc5000d, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",2556, "SCpyMsgFix Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
           }

           if (SGetMsg(pst.region, pst.pool, &dstMbuf) != 0)
           {
              if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc5000e, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",2562, "Memory Allocation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
           }

           if (SCpyFixMsg(tempBuf,dstMbuf,0,gCb->trcLen,&tempCnt) != 0)
           {
              if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc5000f, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lmm.c",2568, "SCpyMsgFix Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
           }


           { if (tempBuf != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) tempBuf, (Size) gCb->trcLen); tempBuf = 0L; } };
