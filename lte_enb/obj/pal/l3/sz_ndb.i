...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000100)) { snprintf((&szCb.init)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->procId, (&szCb.init)->ent, (&szCb.init)->inst,
                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_ndb.c"
   ,
                                             140
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szNdbAllocConCb\n"); SPrint((&szCb.init)->prntBuf); } }
                                              ;


   *conCb = (SzConCb *)0L;

   { SGetSBuf(szCb.init.region, szCb.init.pool, (Data**)&locConCb, sizeof(SzConCb)); if (locConCb != 0L) { cmMemset((U8*)locConCb, 0, sizeof(SzConCb)); szCb.genSta.memAlloc += (sizeof(SzConCb)); } else { SzUstaDgn _dgn; locConCb = 0L; _dgn.type = 2; _dgn.u.mem.region = szCb.init.region; _dgn.u.mem.pool = szCb.init.pool; szSendLmAlarm (4, 12, 15, &_dgn); szCb.genSts.nmbFailConn++; } };
   if (locConCb == 0L)
   {
      szCb.genSts.nmbFailConn++;
      { SzUstaDgn _dgn; SLogError(szCb.init.ent, szCb.init.inst, szCb.init.procId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_ndb.c", 149, 0x2, (0 + 107), (ErrVal)0, "szNdbAllocConCb"": Unable to allocate resources"); _dgn.type = 2; _dgn.u.mem.region = peer->sztSapCb->pst.region; _dgn.u.mem.pool = peer->sztSapCb->pst.pool; szSendLmAlarm (4, 13, 15, &_dgn); return(1); };
   }
   ...
   szUtilsAllocConId(&locConCb->lclConRefNo);
      ...
      ret = cmHashListInsert (&szCb.lclConCp, (U32)locConCb,
            (U8 *)&locConCb->lclConRefNo, sizeof (SzConRefNo));
      if (ret != 0)
      {
         { if (locConCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locConCb, sizeof(SzConCb)); szCb.genSta.memAlloc -= (sizeof(SzConCb)); locConCb = 0L; } };
         szCb.genSts.nmbFailConn++;
         { SzUstaDgn _dgn; SLogError(szCb.init.ent, szCb.init.inst, szCb.init.procId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_ndb.c", 172, 0x2, (0 + 108), (ErrVal)0, "szNdbAllocConCb"": Unable to allocate resources"); _dgn.type = 2; _dgn.u.mem.region = peer->sztSapCb->pst.region; _dgn.u.mem.pool = peer->sztSapCb->pst.pool; szSendLmAlarm (4, 13, 15, &_dgn); return(1); };
      }


      ret = cmHashListInsert (&peer->conRefLst, (U32)locConCb,
            (U8 *)&locConCb->lclConRefNo, sizeof (SzConRefNo));
      if (ret != 0)
      {
         cmHashListDelete (&szCb.lclConCp, (U32)locConCb);
         { if (locConCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locConCb, sizeof(SzConCb)); szCb.genSta.memAlloc -= (sizeof(SzConCb)); locConCb = 0L; } };
         szCb.genSts.nmbFailConn++;
         { SzUstaDgn _dgn; SLogError(szCb.init.ent, szCb.init.inst, szCb.init.procId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_ndb.c", 183, 0x2, (0 + 109), (ErrVal)0, "szNdbAllocConCb"": Unable to allocate resources"); _dgn.type = 2; _dgn.u.mem.region = peer->sztSapCb->pst.region; _dgn.u.mem.pool = peer->sztSapCb->pst.pool; szSendLmAlarm (4, 13, 15, &_dgn); return(1); };
      }
...

{
   ...
   ,
                                            242
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szNdbGetConCb(conId = %ld)\n", conId); SPrint((&szCb.init)->prntBuf); } }
                                             ;



   found = cmHashListFind(&szCb.lclConCp, (U8 *)&conId,
                    sizeof (SzConRefNo), 0, (U32 *)connectionCb);

   return(found);
}
 S16 szNdbDeallocConCb
(
SzConRefNo conRef,
SzPeerCb *peerCb,
U8 conRefType
...

{
   ...
   ,
                                                                  293
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szNdbDeallocConCb(conRef=%ld)\n", conRef); SPrint((&szCb.init)->prntBuf); } }
                                                                   ;
   ...
   if( found == 0)
   {
      cmHashListDelete (&szCb.lclConCp, (U32)connectionCb);
      cmHashListDelete (&peerCb->conRefLst, (U32)connectionCb);




      cmHashListDelete (&uSapCb->suConnLst, (U32)connectionCb);


      cmHashListDelete (&peerCb->conRefLstRem, (U32)connectionCb);
      { if (connectionCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)connectionCb, sizeof(SzConCb)); szCb.genSta.memAlloc -= (sizeof(SzConCb)); connectionCb = 0L; } };
      szCb.genSts.nmbConn--;
      szCb.genSta.nmbActvPeerConn--;
      peerCb->nmbConn--;
   }
...

{
   ...
   ,
                                       ...
                                       423
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szCmGetStream(peerId=%ld)\n", peerCb->peerId); SPrint((&szCb.init)->prntBuf); } }
 ...
 *strmId = (SctStrmId)((*strmId + 1) % peerCb->assocCb->assocCfg->locOutStrms);
   ...
   ,
                                                             439
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szCmGetStream(*strmId = %d)\n", *strmId); SPrint((&szCb.init)->prntBuf); } }
                                                              ;
...

{
   ...
   ret = cmHashListInit(&szCb.peerLst,
            (U16)szCb.genCfg.nmbPeer,
            0,
            0,
            4,
            szCb.init.region,
   ...
   ret = cmHashListInit(&szCb.peerAddrPortLst,
            (U16)(szCb.genCfg.nmbPeer * 5),
            0,
            0,
            7,
            szCb.init.region,
...

{
   ...
   *peer = 0L;
   ...
   { SGetSBuf(szCb.init.region, szCb.init.pool, (Data**)&locCb, sizeof(SzPeerCb)); if (locCb != 0L) { cmMemset((U8*)locCb, 0, sizeof(SzPeerCb)); szCb.genSta.memAlloc += (sizeof(SzPeerCb)); } else { SzUstaDgn _dgn; locCb = 0L; _dgn.type = 2; _dgn.u.mem.region = szCb.init.region; _dgn.u.mem.pool = szCb.init.pool; szSendLmAlarm (4, 12, 15, &_dgn); szCb.genSts.nmbFailConn++; } };
   if(locCb == 0L)
   {
   ...
   { SGetSBuf(szCb.init.region, szCb.init.pool, (Data**)&locCb->assocCb, sizeof(SzAssocCb)); if (locCb->assocCb != 0L) { cmMemset((U8*)locCb->assocCb, 0, sizeof(SzAssocCb)); szCb.genSta.memAlloc += (sizeof(SzAssocCb)); } else { SzUstaDgn _dgn; locCb->assocCb = 0L; _dgn.type = 2; _dgn.u.mem.region = szCb.init.region; _dgn.u.mem.pool = szCb.init.pool; szSendLmAlarm (4, 12, 15, &_dgn); szCb.genSts.nmbFailConn++; } };
   if(locCb->assocCb == 0L)
   {
      ...
      { if (locCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locCb, sizeof(SzPeerCb)); szCb.genSta.memAlloc -= (sizeof(SzPeerCb)); locCb = 0L; } };
      return(1);
   }


   { SGetSBuf(szCb.init.region, szCb.init.pool, (Data**)&locCb->assocCb->assocCfg, sizeof(SzAssocCfg)); if (locCb->assocCb->assocCfg != 0L) { cmMemset((U8*)locCb->assocCb->assocCfg, 0, sizeof(SzAssocCfg)); szCb.genSta.memAlloc += (sizeof(SzAssocCfg)); } else { SzUstaDgn _dgn; locCb->assocCb->assocCfg = 0L; _dgn.type = 2; _dgn.u.mem.region = szCb.init.region; _dgn.u.mem.pool = szCb.init.pool; szSendLmAlarm (4, 12, 15, &_dgn); szCb.genSts.nmbFailConn++; } };
   if(locCb->assocCb->assocCfg == 0L)
   {




      { if (locCb->assocCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locCb->assocCb, sizeof(SzAssocCb)); szCb.genSta.memAlloc -= (sizeof(SzAssocCb)); locCb->assocCb = 0L; } };
      { if (locCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locCb, sizeof(SzPeerCb)); szCb.genSta.memAlloc -= (sizeof(SzPeerCb)); locCb = 0L; } };
      return(1);
   }
   ...
   offset = (U16)((U32)&conCb.peerConHlEnt - (U32)&conCb);
   ...
   if (ret != 0)
   {
      { if (locCb->assocCb->assocCfg != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locCb->assocCb->assocCfg, sizeof(SzAssocCfg)); szCb.genSta.memAlloc -= (sizeof(SzAssocCfg)); locCb->assocCb->assocCfg = 0L; } };
      { if (locCb->assocCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locCb->assocCb, sizeof(SzAssocCb)); szCb.genSta.memAlloc -= (sizeof(SzAssocCb)); locCb->assocCb = 0L; } };
      { if (locCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locCb, sizeof(SzPeerCb)); szCb.genSta.memAlloc -= (sizeof(SzPeerCb)); locCb = 0L; } };
      return(1);
   }

   offset = (U16)((U32)&conCb.peerConHlEntRem - (U32)&conCb);
   ...
   ret = cmHashListInsert (&szCb.peerLst, (U32)locCb,
...

{
   ...
   pCb = 0L;
   nCb = 0L;
   ret = cmHashListGetNext(&peer->conRefLst, (U32)pCb, (U32 *)&nCb);
   for (;;)
   {
      if (ret != 0)
      {
      ...
      else
      {
         pCb = nCb;
         ret = cmHashListGetNext(&peer->conRefLst, (U32)pCb, (U32 *)&nCb);
         cmHashListDelete (&szCb.lclConCp, (U32)pCb);
         cmHashListDelete (&peer->conRefLst, (U32)pCb);
         cmHashListDelete (&(peer->sztSapCb->suConnLst), (U32)pCb);


         cmHashListDelete (&peer->conRefLstRem, (U32)pCb);
         ...
         { if (pCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)pCb, sizeof(SzConCb)); szCb.genSta.memAlloc -= (sizeof(SzConCb)); pCb = 0L; } };
         szCb.genSts.nmbConn--;
         szCb.genSta.nmbActvPeerConn--;
         peer->nmbConn--;
      }
...

{
   ...
   cmHashListDelete (&szCb.peerLst,(U32)peer);
   ret = szNdbRemPeerAddrPortCb(peer);
   { if (peer->resetPdu != 0L) { cmFreeMem ((Ptr)(peer->resetPdu)); peer->resetPdu = 0L; } };
   { if (peer->setupReq != 0L) { cmFreeMem ((Ptr)(peer->setupReq)); peer->setupReq = 0L; } };
   { if (peer->assocCb->assocCfg != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)peer->assocCb->assocCfg, sizeof(SzAssocCfg)); szCb.genSta.memAlloc -= (sizeof(SzAssocCfg)); peer->assocCb->assocCfg = 0L; } };
   { if (peer->assocCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)peer->assocCb, sizeof(SzAssocCb)); szCb.genSta.memAlloc -= (sizeof(SzAssocCb)); peer->assocCb = 0L; } };
   { if (peer != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)peer, sizeof(SzPeerCb)); szCb.genSta.memAlloc -= (sizeof(SzPeerCb)); peer = 0L; } };
...

{
   ...
   for (idx = 0; idx < assocCfg->dstAddrLst.nmb;idx++)
   {
      if(addrLst.nmb < 5)
      {
         if (assocCfg->dstAddrLst.nAddr[idx].type == 4)
         {
...

{
   ...
   {
      { SGetSBuf(szCb.init.region, szCb.init.pool, (Data**)&peerAssocCb, sizeof(SzPeerAddrPortCb)); if (peerAssocCb != 0L) { cmMemset((U8*)peerAssocCb, 0, sizeof(SzPeerAddrPortCb)); szCb.genSta.memAlloc += (sizeof(SzPeerAddrPortCb)); } else { SzUstaDgn _dgn; peerAssocCb = 0L; _dgn.type = 2; _dgn.u.mem.region = szCb.init.region; _dgn.u.mem.pool = szCb.init.pool; szSendLmAlarm (4, 12, 15, &_dgn); szCb.genSts.nmbFailConn++; } };
      if (0L == peerAssocCb)
      {
      ...
      if (peerAssocCb->peerAddrPort.peerAddr.type == 4)
      {
      ...
      ret = cmHashListInsert(&(szCb.peerAddrPortLst), (U32)(peerAssocCb),
...

{
   ...
   for (idx = 0; idx < dstAddrLst->nmb; idx++)
   {
      { cmMemset((U8*)&peerAssocEntry, 0, sizeof(SzPeerAddrPortEntry)); };
      ...
      ret = cmHashListFind(&(szCb.peerAddrPortLst), (U8 *) &(peerAssocEntry),
            sizeof(SzPeerAddrPortEntry), 0, (U32 *) &peerAssocCb);
      if (ret == 0)
      {
         break;
      }
   ...
   if ( peerAssocCb == (SzPeerAddrPortCb*)0L )
   {
      return(1);
   }
   else
...

{
   ...
   for (idx = 0; idx < dstAddrLst->nmb; idx++)
   {
      ...
      cmHashListDelete(&(szCb.peerAddrPortLst), (U32)(peerAssocCb));
      { if (peerAssocCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)peerAssocCb, sizeof(SzPeerAddrPortCb)); szCb.genSta.memAlloc -= (sizeof(SzPeerAddrPortCb)); peerAssocCb = 0L; } };
   }
