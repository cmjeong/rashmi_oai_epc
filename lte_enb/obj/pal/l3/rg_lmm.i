...
extern Void rgGetSId (SystemId *s);
...
static U16 rgLMMGenCfg ( Inst inst, RgCfg *cfg )


  ;

static U16 rgLMMSapCfg ( Inst inst, RgCfg *cfg, Elmnt sapType )
...
static Void rgLMMFillCfmPst ( Pst *reqPst, Pst *cfmPst, RgMngmt *cfm )



  ;

static Void rgLMMGenCntrl ( RgMngmt *cntrl, RgMngmt *cfm, Pst *cfmPst )



  ;

static Void rgLMMSapCntrl ( RgMngmt *cntrl, RgMngmt *cfm, Pst *cfmPst )
...

{
   ...
   rgCb[macInst].rgInit.cfgDone = 0;
   rgCb[macInst].rgInit.acnt = 0;
   rgCb[macInst].rgInit.usta = 0;
   rgCb[macInst].rgInit.trc = 0;
   rgCb[macInst].trcLen = 0;
   rgCb[macInst].rgInit.procId = SFndProcId();
   rgCb[macInst].tfuSap.numBndRetries = 0;


   rgCb[macInst].tfuSap.sapSta.sapState = 0;
   rgCb[macInst].crgSap.sapSta.sapState = 0;
   rgCb[macInst].rguSap = 0L;
   rgCb[macInst].crgSap.sapSta.sapState = 0;

   rgCb[macInst].inactiveCell = 0L;
   rgCb[macInst].cell = 0L;
...

{
   ...
   switch(cfg->hdr.elmId.elmnt)
   {
      ...
      default:
         ret = 1;
         reason = 5;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc0001, L_ERROR, cfg->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c"         , 270         , "Invalid Elmnt=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
         break;
   }
...

{
   ...
   if(rgCb[inst].rgInit.cfgDone != 1)
   {
      cfm.cfm.status = 1;
      cfm.cfm.reason = 8;
      RgMiLrgStsCfm(&cfmPst,&cfm);
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",348, "Gen Cfg not done", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(0);
   }
   ...
   switch(sts->hdr.elmId.elmnt)
   {
      ...
      default:
         cfm.cfm.status = 1;
         cfm.cfm.reason = 5;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc0003, L_ERROR,sts->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",456, "Invalid Elmnt = %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
   }
   RgMiLrgStsCfm(&cfmPst,&cfm);
   return(0);
...

{
   ...
   if (sta->t.ssta.s.sysId.ptNmb != 0L)
   {
      SPutSBuf(pst->region, pst->pool, (Data *)sta->t.ssta.s.sysId.ptNmb, 8);
   }
   ...
   if(rgCb[inst].rgInit.cfgDone != 1)
   {
      ...
      if (SGetSBuf(cfmPst.region, cfmPst.pool,
          (Data **)&(cfm.t.ssta.s.sysId.ptNmb), 8)
         != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",527, "Memory Unavailable for Confirmation", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(0);
      }
      cmMemset((U8 *)(cfm.t.ssta.s.sysId.ptNmb), 0, 8);
      rgGetSId(&cfm.t.ssta.s.sysId);
      cfm.cfm.status = 1;
      cfm.cfm.reason = 8;
      cfm.hdr.elmId.elmnt = sta->hdr.elmId.elmnt;
      RgMiLrgStaCfm(&cfmPst, &cfm);
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0005, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",536, "Gen Cfg not done", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(0);
   }
   ...
   switch(sta->hdr.elmId.elmnt)
   {
      case 1:
         ...
         if (SGetSBuf(cfmPst.region, cfmPst.pool,
            ...
            != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0006, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",548, "Memory Unavailable for Confirmation", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return(0);
         }
         cmMemset((U8 *)(cfm.t.ssta.s.sysId.ptNmb), 0, 8);
         rgGetSId(&cfm.t.ssta.s.sysId);
    ...
    (U8 *)&rgCb[inst].rguSap[sta->t.ssta.sapInst].sapSta,
      ...
      default:
         ...
         cfm.cfm.reason = 5;
         RgMiLrgStaCfm(&cfmPst, &cfm);
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc0007, L_ERROR,sta->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",586, "Invalid elmnt=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
   }
   return(0);
}
...

{
   ...
   if(rgCb[inst].rgInit.cfgDone != 1)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0008, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",654, "Gen Cfg not done", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(0);
   }
   ...
   switch(cntrl->hdr.elmId.elmnt)
   {
      ...
      default:
         ...
         cfm.cfm.reason = 13;
         RgMiLrgCntrlCfm(&cfmPst, &cfm);
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc0009, L_ERROR,cntrl->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",673, "invalid elmnt=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
   }
   return(ret);
}
...
{
   U16 ret = 0;
   RgLowSapCfgInfo *lowSapCfg = 0L;
   RgUpSapCfgInfo *upSapCfg = 0L;
   RgUpSapCb *upSapCb = 0L;
   ...
   {
      case 186:
         if ((cfg->s.rguSap.spId > 2) &&
             (cfg->s.rguSap.selector != 1) &&
             (cfg->s.rguSap.selector != 0))
         {
            ret = 13;
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc000a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",732, "unsupported Selector value for RGU", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            break;
         }
         upSapCb = &(rgCb[inst].rguSap[cfg->s.rguSap.spId]);
         if(upSapCb->sapSta.sapState == 0)
         {
            upSapCb->sapSta.sapState = 1;
         }
         ...
         break;
      case 1 + 1:
         if ((cfg->s.crgSap.selector != 1) &&
             (cfg->s.crgSap.selector != 0))
         {
            ret = 13;
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc000b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",763, "unsupported Selector value for CRG", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            break;
         }
         if(rgCb[inst].crgSap.sapSta.sapState == 0)
         {
      ...
      case 1 + 4:
         ...
         if ((cfg->s.tfuSap.selector != 1) &&
             (cfg->s.tfuSap.selector != 0))
         {
            ret = 13;
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc000c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",793, "unsupported Selector value for TFU", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            break;
         }

         if (rgCb[inst].tfuSap.sapSta.sapState == 0)
         {
            rgCb[inst].tfuSap.sapSta.sapState = 1;
         }
...

{
   ...
   if ((cfg->s.genCfg.lmPst.selector != 1) &&
       (cfg->s.genCfg.lmPst.selector != 0))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc000d, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",871, "unsupported Selector value for RGU", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(13);
   }
   ...
   rgCb[inst].rgInit.lmPst.event = 0x00;
   ...
   rgCb[inst].crgSap.sapSta.sapState = 0;

   if(cfg->s.genCfg.numRguSaps == 0)
   {
      { if ((&rgCb[inst].rgInit)->dbgMask & ((0x00000100 << 1))) { snprintf((&rgCb[inst].rgInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "MAC", (&rgCb[inst].rgInit)->procId, (&rgCb[inst].rgInit)->ent, (&rgCb[inst].rgInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c", 891); SPrint((&rgCb[inst].rgInit)->prntBuf); sprintf (rgCb[inst].rgInit.prntBuf, "\nrgGenCfg(): Invalid numRguSap.\n"); SPrint((&rgCb[inst].rgInit)->prntBuf); } };
      return(1);
   }
   ...
   if (SGetSBuf(rgCb[inst].rgInit.region,
                ...
                (sizeof(RgUpSapCb) * cfg->s.genCfg.numRguSaps)) != 0)
   {
      { if ((&rgCb[inst].rgInit)->dbgMask & ((0x00000100 << 1))) { snprintf((&rgCb[inst].rgInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "MAC", (&rgCb[inst].rgInit)->procId, (&rgCb[inst].rgInit)->ent, (&rgCb[inst].rgInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c", 901); SPrint((&rgCb[inst].rgInit)->prntBuf); sprintf (rgCb[inst].rgInit.prntBuf, "\nrgGenCfg(): Failed to allocate mem for RGU SAP's.\n"); SPrint((&rgCb[inst].rgInit)->prntBuf); } };
      return(1);
   }
   ...
   {
      rgCb[inst].rguSap[idx].sapSta.sapState = 0;
      cmMemset((U8 *)&rgCb[inst].rguSap[idx], 0, sizeof(RgUpSapCb));
   }
   rgCb[inst].tfuSap.sapSta.sapState = 0;

   cmInitTimers(rgCb[inst].tmrBlk, 1);

   cmMemset((U8 *)&rgCb[inst].tmrTq, 0, sizeof(CmTqType)*10);

   cmMemset((U8 *)&rgCb[inst].tmrTqCp, 0, sizeof(CmTqCp));
   rgCb[inst].tmrTqCp.tmrLen = 10;

   if (SRegCfgTmrMt(rgCb[inst].rgInit.ent,rgCb[inst].rgInit.inst,(S16)rgCb[inst].genCfg.tmrRes,100,rgActvTmr)
                                                      != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc000e, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",924, "Failed to register timer", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if(rgCb[inst].tfuSap.sapSta.sapState == 3)
   {
      rgLIMTfuUbndReq(inst,rgCb[inst].tfuSap.sapCfg.spId, 1);
      if (rgCb[inst].tfuSap.sapCfg.bndTmr.enb == 1)
      {
         rgLMMStopTmr(inst,1, (U32)&rgCb[inst].tfuSap);
      }
      rgCb[inst].tfuSap.sapSta.sapState = 1;
   }
   if(rgCb[inst].tfuSap.sapSta.sapState == 2)
   {
      rgLIMTfuUbndReq(inst,rgCb[inst].tfuSap.sapCfg.spId, 1);
      rgCb[inst].tfuSap.sapSta.sapState = 1;
   }
   ...
   (Void) SDeregCfgTmrMt(rgCb[inst].rgInit.ent,rgCb[inst].rgInit.inst,(S16)rgCb[inst].genCfg.tmrRes,100,rgActvTmr)
                                                              ;
...

{
   ...
   switch(cntrl->t.cntrl.action)
   {
      case 1:
         ...
         switch(cntrl->t.cntrl.subAction)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc000f, L_ERROR,cntrl->t.cntrl.subAction, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1096, "invalid subaction=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               break;
         }
         break;
      case 2:
         ...
         switch(cntrl->t.cntrl.subAction)
         {
            case 4:
               ...
               rgCb[inst].rgInit.trc = 0;
               break;
            case 3:

               rgCb[inst].rgInit.usta = 0;
               break;
            case 5:
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc0010, L_ERROR,cntrl->t.cntrl.subAction, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1127, "invalid subaction=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               break;
         }
         break;
      case 36:
      ...
      default:
         cfm->cfm.status = 1;
         cfm->cfm.reason = 13;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc0011, L_ERROR,cntrl->t.cntrl.action, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1138, "invalid action=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
   }
   RgMiLrgCntrlCfm(cfmPst, cfm);
   return;
      ...
      case 1 + 4:
         switch(cntrl->t.cntrl.action)
         {
            case 30:
               ...
               if ((rgCb[inst].tfuSap.sapSta.sapState == 0) ||
                   (rgCb[inst].tfuSap.sapSta.sapState == 2))
               {
                  cfm->cfm.status = 1;
                  cfm->cfm.reason = 12;
               }
               else
               {
                  if (rgCb[inst].tfuSap.sapCfg.bndTmr.enb == 1)
                  {
                     rgLMMStartTmr(inst,1, rgCb[inst].tfuSap.sapCfg.bndTmr.val,
                     (U32)&rgCb[inst].tfuSap);
                  }

                  rgCb[inst].tfuSap.sapSta.sapState = 3;
            ...
            default:
               ...
               { if ((&rgCb[inst].rgInit)->dbgMask & ((0x00000100 << 1))) { snprintf((&rgCb[inst].rgInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "MAC", (&rgCb[inst].rgInit)->procId, (&rgCb[inst].rgInit)->ent, (&rgCb[inst].rgInit)->inst,
                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c"
               ,
                                     1261
               ); SPrint((&rgCb[inst].rgInit)->prntBuf); sprintf (rgCb[inst].rgInit.prntBuf, "\nrgLMMSapCntrl(): invalid action=%d", cntrl->t.cntrl.action); SPrint((&rgCb[inst].rgInit)->prntBuf); } }
                                      ;
               break;
         }
         break;
      case 186:
         switch(cntrl->t.cntrl.action)
         {
            case 7:
               ...
               rgCb[inst].rguSap[cntrl->t.cntrl.instId].sapSta.sapState = 0;
               cfm->cfm.status = 0;
               cfm->cfm.reason = 0;
               break;
            default:
      ...
      case 1 + 1:
         switch(cntrl->t.cntrl.action)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc0012, L_ERROR,cntrl->t.cntrl.action, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1294, "invalid action=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   Inst inst = tfuSap->sapCfg.sapPst.srcInst - 0;
   ...
   switch(tmrEvnt)
   {
      case 1:
         ...
         if(tfuSap->numBndRetries > 2)
         {
            rgLMMStaInd(inst,2, 8,
                        10, 0L);
         }
         else
         {

            if (tfuSap->sapCfg.bndTmr.enb == 1)
            {
               ret = rgLMMStartTmr(inst,1, tfuSap->sapCfg.bndTmr.val,
               cb);
            }
         ...
         break;
      default:
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdc0013, L_ERROR,tmrEvnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1546, "Invalid tmrEvnt=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
   }
   return(ret);
...

{
   ...
   if ((rgCb[inst].trcLen == 0) || (srcMbuf == 0L))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0014, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1663, "Trace Disabled.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return;
   }
   ...
   if(rgCb[inst].trcLen == -1)
   {
      if (SCpyMsgMsg(srcMbuf, pst.region, pst.pool, &dstMbuf)
         != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0015, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1686, "SCpyMsgMsg Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return;
      }
      trc.cfm.status = 0;
      trc.cfm.reason = 0;
   ...
   else if(rgCb[inst].trcLen > 0)
   {
      ...
      if (SFndLenMsg(srcMbuf, &bufLen) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0016, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1702, "SFndLenMsg Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return;
      }
      ...
      if(bufLen < rgCb[inst].trcLen)
      {
         ...
         if (SCpyMsgMsg(srcMbuf, pst.region, pst.pool, &dstMbuf)
            != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0017, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1713, "SCpyMsgMsg Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return;
         }
      ...
      if(bufLen >= rgCb[inst].trcLen)
      {
         ...
         if (rgAllocSBuf(inst,&tempBuf, rgCb[inst].trcLen) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0018, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1730, "rgAllocSBuf Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return;
         }


         if (SCpyMsgFix(srcMbuf,0,rgCb[inst].trcLen,tempBuf,&tempCnt) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc0019, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1737, "SCpyMsgFix Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return;
         }

         if (SGetMsg(pst.region, pst.pool, &dstMbuf) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc001a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1743, "dstMbuf Allocation Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return;
         }

         if (SCpyFixMsg(tempBuf,dstMbuf,0,rgCb[inst].trcLen,&tempCnt) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc001b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1749, "SCpyFixMsg Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return;
         }
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdc001c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_lmm.c",1816, "Invalid SuId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   switch(status)
   {
      case 1:
         ...
         if (rgCb[inst].tfuSap.sapCfg.bndTmr.enb == 1)
         {
            ret = rgLMMStopTmr(inst,1, (U32)&rgCb[inst].tfuSap);
         }

         cntrlCfm.cfm.status = 0;
         cntrlCfm.cfm.reason = 0;
         break;
      ...
      default:
         ...
         cntrlCfm.cfm.reason = 16;
         break;
   }
   rgCb[inst].tfuSap.numBndRetries = 0;
   cntrlCfm.hdr.elmId.elmnt = 1 + 4;
