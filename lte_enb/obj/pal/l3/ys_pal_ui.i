...

{
   ...
   ret = ysPalUtlSetTfuMsg(cellCb, (Void *)cntrlReq, 19,
                          &cntrlReq->dlTiming);
...

{
   ...
   ret = ysPalUtlSetTfuMsg(cellCb, (Void *)datReq, 16,
                           &datReq->timingInfo);
...

{
   ...
   ret = ysPalUtlSetTfuMsg(cellCb, (Void *)recpReq, 8,
                           &recpReq->timingInfo);
