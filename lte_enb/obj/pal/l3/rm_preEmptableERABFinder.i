                                             ...
                                             CUEContext* pUE)
{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c0001,L_INFO,DBG_CRNTI, ptObjRbInfo->getRabCrnti(), ptObjRbInfo->getERABId(), ptObjRbInfo->getQci(), ptObjRbInfo->getArp(), 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"   ,                                                                             70   , "Inserting ERAB[%d] to list. QCI [%d] ARP [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ...
                                           CUEContext* pUE)
{
   ...
   for(it = itPair.first;it != itPair.second; ++it)
   {
      ...
      {
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c0002,L_INFO,DBG_CRNTI, usCrnti,uiErabId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp",100, "Removing ERAB[%d] from list", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         removeFromList(it);
         break;
      }
   }
   ...
   if(isGbrBearer(uiQciVal))
   {
      ...
      for(it = itPair.first;it != itPair.second; ++it)
      {
         ...
         if((crnti == usCrnti) && (erabId == uiErabId))
         {
            if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c0003,L_INFO,DBG_CRNTI, usCrnti,uiErabId, uiQciVal, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp",119, "Removing ERAB[%d] from QCI[%d] list", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                                                 ...
                                                 bool bIsCSGMember)
{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x9c0004, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp",138, "Deleting ERAB during modification", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c0005,L_INFO,DBG_CRNTI, pObjERabInfo->getRabCrnti(), pObjERabInfo->getERABId(), pObjERabInfo->getQci(), pObjERabInfo->getArp(), 0,                                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"   ,                                                                                153   , "Inserting ERAB[%d] to list during modification. QCI [%d] ARP [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                 ...
                                                 CUEContext* pUE)
{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x9c0006, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp",167, "Deleting ERAB during modification", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if(m_bArpForEmergencyBearer != uiModifiedErabArpVal)
   {
      ...
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c0007,L_INFO,DBG_CRNTI, pObjOldERabInfo->getRabCrnti(), pObjOldERabInfo->getERABId(), pObjOldERabInfo->getQci(), pObjOldERabInfo->getArp(), 0,                                                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"      ,                                                                                            189      , "Inserting ERAB[%d] to list during modification. QCI [%d] ARP [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                   ...
                                                   CERABInfoLst &preEmptedERABs)
{
   ...
   for(rbListIt = m_rabList.begin(); rbListIt != upperIt; rbListIt++)
   {
      ...
      if(isPremptableErabBasedOnIncmoingErab(usCRNTI, pstRejectedErab, rbInfo))
      {
         ...
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x9c0008, L_DEBUG, uiReqDlPrb, (*uiDlPrbSum), "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"         , 232         , "Required DL PRB %ld DL PRB Sum %ld", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                        ;

         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x9c0009, L_DEBUG, uiReqUlPrb, (*uiUlPrbSum), "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"         , 235         , "Required UL PRB %ld UL PRB Sum %ld \n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                        ;

         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c000a,L_INFO,DBG_CRNTI, rbInfo->getRabCrnti(), rbInfo->getERABId(), 0, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"         ,                                    239         , "Adding ERAB[%d] to pre-emption list for PRB requirement", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   else
   {
            ...
            localErabsListIt++)
      {
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c000b,L_INFO,DBG_CRNTI, rbInfo->getRabCrnti(),rbInfo->getERABId(), 0, 0, 0,                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"         ,                                 274         , "Reverting Pre-emption. Removing ERAB[%d] from pre-emption list", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                ...
                                                ErabsMap *rabList)
{
   ...
   else if(isCsgMember == true)
   {
      ...
      uiKey = generateKey(1, 0, (uiArpVal+1));
   ...
   else
   {
      ...
      uiKey = generateKey(0, 0, (uiArpVal+1));
      upperIt = rabList->upper_bound(uiKey);
   }
                                                 ...
                                                 bool isCsgMember)
{
   ...
   for(it = rejectLstMap.begin(); it != rejectLstMap.end(); it++)
   {
      ...
      {
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9c000c, L_DEBUG, ((*it).second)->bERabId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"         , 359         , "ERAB [%d] incapable of preempting other bearers", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
         continue;
      }
      ...
      if(isPrbReqSatisfied)
      {
         ...
         numRejERABs--;
         numAccERABs++;
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c000d,L_INFO,DBG_CRNTI, erabsAccRejLst.usCRNTI,((*it).second)->bERabId, 0, 0, 0,                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"         ,                                       393         , "[PRB]Accepting ERAB [%d] after pre-empting candidate ERABs", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                               ...
                                               bool isCSGMember)
{
   ...
   for(it = rejectLstMap.begin(); it != rejectLstMap.end(); it++)
   {
      ...
      if(false == ((*it).second)->bErabPreemptCap)
      {
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x9c000e, L_DEBUG, ((*it).second)->bERabId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"         , 455         , "ERAB [%d] incapable of preempting other bearers", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
         continue;
      }
            ...
            rbListIt++)
      {
         ...
         {
            if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x9c000f,L_INFO,DBG_CRNTI, ((*rbListIt).second)->getRabCrnti(), ((*rbListIt).second)->getERABId(), 0, 0, 0,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_preEmptableERABFinder.cpp"            ,                                                     474            , "Adding ERAB[%d] to pre-emption list for QCI requirement", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
void CPreEmptableERABFinder::reorderRejectedERABsList(RrmRbcRspInfo & erabsAccRejLst)
{
   ...
   RrmErabRejected newERABRejLst[8];
   ...
   memset(eRabRejectedLst,0,8 * sizeof(RrmErabRejected));


   memcpy(eRabRejectedLst, newERABRejLst,8 * sizeof(RrmErabRejected));
                                              ...
                                              U32 numERABsRej)
{
   for(U32 idx = 0; idx < numERABsRej; idx++)
   {
      ...
      U32 key = generateKey(isCsgMember,
                             ...
                             (15 - eRabRejectedLst[idx].bArpVal));
