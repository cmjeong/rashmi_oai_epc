...
{
   EG_TUN_EVENT_INCSESSREQ,
   EG_TUN_EVENT_OUTSESSREQ,
   EG_TUN_EVENT_INCSESSRSP,
   EG_TUN_EVENT_OUTSESSRSP,
   EG_TUN_EVENT_ERR_IND,

   EG_TUN_EVENT_INC_MSG,
   EG_TUN_EVENT_OUT_MSG,
   EG_TUN_EVENT_MAX
}EgTunnEvent;
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",141); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
}
 Void egUpdateRxStatistics
(
EgtMsgType msgType,
EgSapSts *sts
)
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",167); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",175); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return; };
}
 S16 egCpyCmTptAddr
(
CmTptAddr *dst,
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",208); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",229); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egUTunnTeidMod
(
EgtUEvnt *egtUEvnt,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",269); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   { keyAddr.type = egtUEvnt->u.tnlMgmt.frmDstIpAddr.type; if(egtUEvnt->u.tnlMgmt.frmDstIpAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.tnlMgmt.frmDstIpAddr.u.ipv4TptAddr.address; } };

   cmHashListFind(&(ipCb->destAddrCbLst),
         (U8 *) &(keyAddr),
         sizeof(CmTptAddr), 0, (U32 *)&frmDstCb);
   ...
   if (frmDstCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",291); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Destination IP not configured"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",292); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(96); };
   }
   ...
   if (teidCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",307); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n TEID not configured"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",308); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(98); };
   }
   cmHashListDelete(&(frmDstCb->teIdLst), (U32)teidCb);
   if(frmDstCb->teIdLst.nmbEnt == 0)
   {
      ...
      egSendLmAlarm(2, 1,
            (256 + 7), &sta.dgn);
      { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)frmDstCb); cmHashListDeinit(&(frmDstCb->teIdLst)); { if (frmDstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",331); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)frmDstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) frmDstCb, (Size) sizeof(EgDestAddrCb)); (frmDstCb) = 0L; }}; };
   }
   ...
   cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
   { keyAddr.type = egtUEvnt->u.tnlMgmt.dstIpAddr.type; if(egtUEvnt->u.tnlMgmt.dstIpAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.tnlMgmt.dstIpAddr.u.ipv4TptAddr.address; } };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &dstCb, (Size) sizeof(EgDestAddrCb)) == 0) { cmMemset((U8 *)(*&dstCb), 0, sizeof(EgDestAddrCb)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",349); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; } else { (*&dstCb) = 0L; {}; } };
      ...
      if(dstCb == 0L)
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",357); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(97); };
      }



      ret = cmHashListInit(&dstCb->teIdLst,
            1024,
            0,
            0,
            4,
      ...
      if(ret != 0)
      {
         ...
         { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",376); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }};
         { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",377); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};




         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",382); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(97); };
      }
      ...
      { dstCb->destIpAddr.type = egtUEvnt->u.tnlMgmt.dstIpAddr.type; if(egtUEvnt->u.tnlMgmt.dstIpAddr.type == 4) { dstCb->destIpAddr.u.ipv4TptAddr.address = egtUEvnt->u.tnlMgmt.dstIpAddr.u.ipv4TptAddr.address; } };
      { U8 _temp; if(dstCb->destIpAddr.type == 4) { _temp = (dstCb->destIpAddr.u.ipv4TptAddr.address >> 24); if(_temp == 0xe0) { dstCb->multicastAddr = 1; } } else if(dstCb->destIpAddr.type == 6) { _temp = (dstCb->destIpAddr.u.ipv6TptAddr.ipv6NetAddr[0]); if(_temp == 0xff) { dstCb->multicastAddr = 1; } } };
      dstCb->intfType = egtUEvnt->u.tnlMgmt.intfType;
      dstCb->maxTPduSize = egtUEvnt->u.tnlMgmt.maxTPduSize;
      dstCb->destReachable = 1;
      ...
      if(ret !=0)
      {
         { cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",406); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
         { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",407); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};




         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",412); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(103); };
      }
   }
   ...
   if(ret !=0)
   {
      ...
      {
         { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",427); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
      }
      { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",429); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",434); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(103); };
   }


   teidCb->dstAddrCb = dstCb;
   { U16 nwWord = 0; nwWord = (U16)((((U32)(egtUEvnt->u.tnlMgmt.remTeId) >> 16) & 0xffffL)); teidCb->preEncHdr.hdr[--cnt] = (U8)((((U16)(nwWord) >> 8) & 0xff)); teidCb->preEncHdr.hdr[--cnt] = (U8)(((U16)(nwWord) & 0xff)); nwWord = (U16)(((U32)(egtUEvnt->u.tnlMgmt.remTeId) & 0xffffL)); teidCb->preEncHdr.hdr[--cnt] = (U8)((((U16)(nwWord) >> 8) & 0xff)); teidCb->preEncHdr.hdr[--cnt] = (U8)(((U16)(nwWord) & 0xff)); };
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",452); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
...
{
   EgDestAddrCb *dstCb = 0L;
   EgTeIdCb *teidCb = 0L;
   EgUsta sta;
   S16 ret = 0;
   CmTptAddr keyAddr;

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",487); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",507); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n  Destination does not exist"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                            ;
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",508); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(96); };
   }
   ...
   if (teidCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",525); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n TEID already deleted (%ld)", egtUEvnt->u.tnlMgmt.teId); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                    ;


     { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",528); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(98); };
   }
   ...
   cmHashListDelete(&(dstCb->teIdLst), (U32)teidCb);
   cmHashListDelete(&(egCb.egTeidHashListCp), (U32)teidCb);
   { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",563); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};
   ...
   if(dstCb->teIdLst.nmbEnt == 0)
   {
      ...
      egSendLmAlarm(2, 1, (256 + 7), &sta.dgn);



      { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",583); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
   }

   egCb.genSts.numActvTnls--;

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",588); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };

}
 S16 egUTunnTeidReordDis
(
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb,
EgUSapCb *usap
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",623); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",646); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Invalid Destination IP"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",647); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(96); };
   }
   ret = cmHashListFind(&(dstCb->teIdLst),
         (U8 *)&(egtUEvnt->u.tnlMgmt.teId),
         sizeof(U32), 0, (U32 *)&teidCb);
   ...
   if (teidCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",658); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Invalid Teid"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",659); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(98); };
   }
   ...
   if(!teidCb->reOrdering)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",667); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(99); };
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",685); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egUTunnTeidReordEna
(
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",716); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",737); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Invalid Destination"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",738); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(96); };
   }
   ret = cmHashListFind(&(dstCb->teIdLst),
         (U8 *)&(egtUEvnt->u.tnlMgmt.teId),
         sizeof(U32), 0, (U32 *)&teidCb);
   ...
   if (teidCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",749); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Invalid TEID"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",750); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(98); };
   }
   ...
   if(teidCb->reOrdering)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",759); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
   }
   ...
   if(teidCb->seqInfo == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",779); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Cannot allocate memory for SeqInfo\n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",784); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if(teidCb->seqInfo->pduArray == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",790); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Cannot allocate memory for reordering bufer\n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",795); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",798); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egUTunnTeidAdd
(
EgtUEvnt *egtUEvnt,
...

{
 ...
 U16 portNum = 0;
   ...
   EgUsta sta;
   static EgUMsgHdr preDefHeader;
   cmMemset((U8*)&preDefHeader,0,sizeof(EgUMsgHdr));

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",837); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   { if(egtUEvnt->u.tnlMgmt.srcAddr.type == 4) { portNum = egtUEvnt->u.tnlMgmt.srcAddr.u.ipv4TptAddr.port; } };
   ...
   cmHashListFind(&(ipCb->tptServCbLst),
         (U8 *) &(portNum),
         sizeof(U16), 0, (U32 *)&(tptSrvrCb));

   if(tptSrvrCb == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",858); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Server not configured"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      egSendLmAlarm(2, 1,
           3, &sta.dgn);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",885); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
   { keyAddr.type = egtUEvnt->u.tnlMgmt.dstIpAddr.type; if(egtUEvnt->u.tnlMgmt.dstIpAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.tnlMgmt.dstIpAddr.u.ipv4TptAddr.address; } };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &dstCb, (Size) sizeof(EgDestAddrCb)) == 0) { cmMemset((U8 *)(*&dstCb), 0, sizeof(EgDestAddrCb)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",914); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; } else { (*&dstCb) = 0L; {}; } };

      if(dstCb == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",919); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n  Memory Allocation for destination failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                  ;



         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",923); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(97); };
      }
      ...
      if(ret != 0)
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",943); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n  TEID Hash List initialisation failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                              ;
         { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",944); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }};



         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",948); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(97); };
      }
      ...
      if(0 != egUPlatTunnTeidAdd(dstCb))
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",964); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUPlatTunnTeidAdd returned Failure\n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",965); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }
      ...
      if(ret !=0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",979); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n  Hash List insertion of destination                   CB into Source IP failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }

                                             ;
         { cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",980); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };



         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",984); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(103); };
      }
      ...
      if(!egCb.egUCb.echoTmrStarted && egCb.genCfg.echoTmr.enb)
      {
         ...
         if (ret != 0)
         {
            egCb.egUCb.echoTmrStarted = 0;
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",996); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n  Starting of Echo Timer Failed"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
         }
    else
    {
       egCb.egUCb.echoTmrStarted = 1;
    }
      }
   }
   ...
   { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &teidCb, (Size) sizeof(EgTeIdCb)) == 0) { cmMemset((U8 *)(*&teidCb), 0, sizeof(EgTeIdCb)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1008); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&teidCb, (U32)sizeof(EgTeIdCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; } else { (*&teidCb) = 0L; {}; } };
   ...
   if(teidCb == 0L)
   {
      if(dstCb->teIdLst.nmbEnt == 0)
      {
         ...
         { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1017); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
      }



      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1022); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(97); };
   }
   ...
   if(ret !=0)
   {
      if(dstCb->teIdLst.nmbEnt == 0)
      {
         ...
         { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1061); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
      }
      { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1063); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1068); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(103); };
   }
   ...
   if(teidCb->reOrdering == 1)
   {
      ...
      if(teidCb->seqInfo == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1084); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Cannot allocate memory for reordering bufer\n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
         cmHashListDelete(&(dstCb->teIdLst), (U32)teidCb);
         { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1086); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};
         ...
         if(dstCb->teIdLst.nmbEnt == 0)
         {
            ...
            { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1094); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
         }



         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1099); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }
      ...
      if(teidCb->seqInfo->pduArray == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1106); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Cannot allocate memory for reordering bufer\n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
         cmHashListDelete(&(dstCb->teIdLst), (U32)teidCb);
         { if (teidCb->seqInfo != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1108); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb->seqInfo, (U32)sizeof(SeqInfo) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb->seqInfo, (Size) sizeof(SeqInfo)); (teidCb->seqInfo) = 0L; }};
         { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1109); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};
         ...
         if(dstCb->teIdLst.nmbEnt == 0)
         {
            ...
            { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1117); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
         }




         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1123); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }
   }
   ...
   if(egtUEvnt->u.tnlMgmt.tunnelType == 1)
   {
      dstCb->normaldataTunnCnt++;
      teidCb->tunnelType = 1;
      egCb.genSts.numNrmlDataTunn++;
   }
   else if(egtUEvnt->u.tnlMgmt.tunnelType == 2)
   {
      dstCb->forwardingTunnCnt++;
      teidCb->tunnelType = 2;
      egCb.genSts.numFwdDataTunn++;
   ...
   if(ret !=0)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1161); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(103); };
   }



   if(egtUEvnt->u.tnlMgmt.tunnelType == 2)
   {
      preDefHeader.seqNumber.pres = 1;
   }

   preDefHeader.msgType = EGT_GTPU_MSG_GPDU;
   preDefHeader.teId = teidCb->remTeid;
   preDefHeader.extHdr.pdcpNmb.pres = 0;
   preDefHeader.extHdr.udpPort.pres = 0;
   preDefHeader.nPduNmb.pres = 0;
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1182); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };

}
 S16 egTunProcEguTnlMgmtReq
(
EgtUEvnt *egtUEvnt,
EgUSapCb *usap
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1215); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   egtUEvnt->u.tnlMgmt.cfmStatus.status = 0;
   egtUEvnt->u.tnlMgmt.cfmStatus.reason = 0;
   ...
   cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
   { keyAddr.type = egtUEvnt->u.tnlMgmt.srcAddr.type; if(egtUEvnt->u.tnlMgmt.srcAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.tnlMgmt.srcAddr.u.ipv4TptAddr.address; } };
   ...
   if(ipCb == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1242); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Source IP not configured"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      egCpyCmTptAddr(&(sta.dgn.dgnVal[0].t.ipAddr), &(egtUEvnt->u.tnlMgmt.srcAddr));
      egSendLmAlarm(2, 1, 3, &sta.dgn);




      egtUEvnt->u.tnlMgmt.cfmStatus.status = 1;
      egtUEvnt->u.tnlMgmt.cfmStatus.reason = 94;
      EgUiEgtEguLclTnlMgmtCfm(&(usap->pst), usap->suId, egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1259); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   switch (egtUEvnt->u.tnlMgmt.action)
   {
      ...
      default:
         egtUEvnt->u.tnlMgmt.cfmStatus.status = 1;
         egtUEvnt->u.tnlMgmt.cfmStatus.reason = 100;
   }
   if((egtUEvnt->u.tnlMgmt.action == 7) ||
         (egtUEvnt->u.tnlMgmt.action == 2))
   {
      if(ret == 99)
      {
         EgUiEgtEguLclTnlMgmtCfm(&(usap->pst), usap->suId, egtUEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1319); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
      }
   }
   ...
   EgUiEgtEguLclTnlMgmtCfm(&(usap->pst), usap->suId, egtUEvnt);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1329); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egTunProcEguStaReq
(
EgtUEvnt *egtUEvnt,
EgUSapCb *usap
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1365); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   egtUEvnt->u.status.cfmStatus.status = 0;
   egtUEvnt->u.status.cfmStatus.reason = 0;
   ...
   cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
   { keyAddr.type = egtUEvnt->u.status.srcAddr.type; if(egtUEvnt->u.status.srcAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.status.srcAddr.u.ipv4TptAddr.address; } };

   if(egtUEvnt->u.status.srcAddr.type == 4)
   {
   ...
   if(ipCb == 0L)
   {
      egtUEvnt->u.status.cfmStatus.status = 1;
      egtUEvnt->u.status.cfmStatus.reason = 94;
      EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1417); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if(portInfo == 1)
   {
      ...
      {
         egtUEvnt->u.status.cfmStatus.status = 1;
         egtUEvnt->u.status.cfmStatus.reason = 95;
         EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1436); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }
      ...
      {
         egtUEvnt->u.status.cfmStatus.status = 0;
         egtUEvnt->u.status.cfmStatus.reason = 1;
      }
      EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
   }
   else
   {
      ...
      { dstkeyAddr.type = egtUEvnt->u.status.dstAddr.type; if(egtUEvnt->u.status.dstAddr.type == 4) { dstkeyAddr.u.ipv4TptAddr.address = egtUEvnt->u.status.dstAddr.u.ipv4TptAddr.address; } };
      ...
      {
         egtUEvnt->u.status.cfmStatus.status = 1;
         egtUEvnt->u.status.cfmStatus.reason = 96;
         EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1470); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }

      if(dstCb->multicastAddr == 1)
      {
         egtUEvnt->u.status.cfmStatus.status = 1;
         egtUEvnt->u.status.cfmStatus.reason = 101;
         EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1478); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }
      ...
      {
         egtUEvnt->u.status.cfmStatus.status = 0;
         egtUEvnt->u.status.cfmStatus.reason = 2;
      }
      else
      {
         egtUEvnt->u.status.cfmStatus.status = 0;
         egtUEvnt->u.status.cfmStatus.reason = 3;
      }
      EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1496); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1523); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1530); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",1531); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egTunProcEguDatReq
(
EgtUEvnt *egtUEvnt,
EgUSapCb *usap,
Pst *pst
...

{
   ...
   static CmTptAddr keyAddr;

   EgUEvnt evntMsg;

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2012); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   { keyAddr.type = egtUEvnt->u.egMsg->srcAddr.type; if(egtUEvnt->u.egMsg->srcAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.egMsg->srcAddr.u.ipv4TptAddr.address; } };

   { if(egtUEvnt->u.egMsg->srcAddr.type == 4) { portNum = egtUEvnt->u.egMsg->srcAddr.u.ipv4TptAddr.port; } };
   ...
   if(ipCb == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2041); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Source IP not configured"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2055); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); printf("%s\n", egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2059); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                 ;
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2060); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }



      { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_INV_SRC_IP; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2067); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if(srvCb == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2081); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Server not configured"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2095); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); printf("%s\n", egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2099); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                 ;

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2101); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
      }
      { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_INV_SRC_PORT; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2105); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(1); };
   }
   ...
   { if(egtUEvnt->u.egMsg->remAddr.type == 4) { egtUEvnt->u.egMsg->remAddr.u.ipv4TptAddr.port = 2152; } };
   ...
   { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2150); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2169); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egFTunProcEguDatReq
(
EgtUEvnt *egtUEvnt,
EgUSapCb *usap,
Pst *pst
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2203); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   if(teIdCb == 0L)
   {
      ...
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 7))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2216); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"FATAL\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "[egFTunProcEguDatReq] Failed to get the TeidCb"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      return(1);
   }
   ...
   egtUEvnt->u.egMsg = 0L;
   { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2246); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_tunn.c",2247); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
