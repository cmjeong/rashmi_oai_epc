...

{
    ...
    if((ret1 = SGetMsg(pst->region, pst->pool, &mBuf)) != 0)
    {
       return(ret1);
    }
    SPkS16(spId, mBuf);;
    SPkS16(suId, mBuf);;
    pst->event = (Event) 0x01;
...
)
{
    ...
    switch(pst->selector)
    {
       ...
       case 1:
          {
             cmPkPtr((U32)newUeInfo, mBuf);;
             cmPkPtr((U32)ueInfo, mBuf);;
             break;
          }
       default:
       {
...

{
    ...
    cmPkCmStatus(&status, mBuf);;
    SPkU32(transId, mBuf);;
    SPkS16(suId, mBuf);;
    pst->event = (Event) 0x07;
...

{
    ...
    switch (pst->selector)
    {
       ...
       case 1:
       {
         cmPkPtr((U32) pStaPdu, mBuf);;
         cmPkPtr((U32) rlcId, mBuf);;
         break;
       }
    }
    SPkS16(suId, mBuf);;
    pst->event = (Event) 0x09;
...

{
    ...
    switch(pst->selector)
    {
       ...
       case 0:
       {
          ret1 = cmUnpkUdxStruct(mBuf,0,(U8 *)&tmpNewUeInfo, sizeof(CkwUeInfo));
          ret1 = cmUnpkUdxStruct(mBuf,sizeof(CkwUeInfo),(U8 *)&tmpUeInfo, sizeof(CkwUeInfo));
       ...
       case 1:
       {
          cmUnpkPtr((U32 *) &ueInfo, mBuf);;
          cmUnpkPtr((U32 *) &newUeInfo, mBuf);;
          break;
       }
       default:
       {
...

{
    ...
    cmMemset((U8 *)&status, (U8)0, (U32)sizeof(CmStatus));

    SUnpkS16(&suId, mBuf);;
    SUnpkU32(&transId, mBuf);;

    cmUnpkCmStatus(&status, mBuf);;
...

{
   ...
   break;
       ...
       case 1:
       {
          cmUnpkPtr((U32 *)&rlcId, mBuf);;
          cmUnpkPtr((U32 *)&pBufLst, mBuf);;
          break;
       }
    }
