...
extern Void rgLaaInitTbInfoLst ( RgLaaTbReq **tbInfoLst )
  ...
  ;
static S16 rgUtlHndlCrntiChng ( Inst inst, RgCellCb *cell, CmLteRnti rnti, CmLteRnti newRnti )
...

{
   ...
   *pData = 0L;
   ...
   if (SGetStaticBuffer(rgCb[inst].rgInit.region, rgCb[inst].rgInit.pool, pData, size, 0) != 0)
   {
     dgn.type = 1;
     dgn.u.mem.region = rgCb[inst].rgInit.region;
     dgn.u.mem.pool = rgCb[inst].rgInit.pool;

     rgLMMStaInd(inst,4, 12,
                                       15, &dgn);
      SLogError(rgCb[inst].rgInit.ent, rgCb[inst].rgInit.inst, rgCb[inst].rgInit.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c", (S32) 158, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 28)), (ErrVal) (0), (Txt *) "Unable to Allocate Buffer");
      return(1);
   }
...

{
   ...
   *pData = 0L;
   ...
   if (SGetSBuf(rgCb[inst].rgInit.region, rgCb[inst].rgInit.pool, pData, size) != 0)
   {
     dgn.type = 1;
     dgn.u.mem.region = rgCb[inst].rgInit.region;
     dgn.u.mem.pool = rgCb[inst].rgInit.pool;
     ...
     rgLMMStaInd(inst,4, 12,
                                       15, &dgn);
      SLogError(rgCb[inst].rgInit.ent, rgCb[inst].rgInit.inst, rgCb[inst].rgInit.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c", (S32) 233, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 28)), (ErrVal) (0), (Txt *) "Unable to Allocate Buffer");
      return(1);
   }
...

{
   ...
   if (ret != 0)
   {
      SLogError(rgCb[inst].rgInit.ent, rgCb[inst].rgInit.inst, rgCb[inst].rgInit.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c", (S32) 349, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 29)), (ErrVal) ((ErrVal) 0), (Txt *) "rgFreeSBuf failed.\n");
      return;
   }
...

{
   ...
   ret = SGetMsg((rgCb[inst].rgInit.region), (rgCb[inst].rgInit.pool), mBuf);
   ...
   if (0 != ret)
   {
      ...
      rgLMMStaInd(inst,4, 13,
                                       15, &dgn);
      SLogError(rgCb[inst].rgInit.ent, rgCb[inst].rgInit.inst, rgCb[inst].rgInit.procId, (Txt *) "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c", (S32) 407, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 30)), (ErrVal) (0), (Txt *) "Unable to Allocate Buffer");
      return(1);
   }
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb30001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c",740, "cmAllocEvnt Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }


   SStopTask(startTime, 30226);
...

{
      ...
      (cell->cellId != lcgRegReq->cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb30002,L_ERROR,DBG_CELLID, lcgRegReq->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c",888, "Cell does not exist ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ((ue = rgDBMGetUeCb(cell, lcgRegReq->crnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb30003,L_ERROR,DBG_CELLID, cell->cellId, lcgRegReq->crnti, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"      ,                           895      , "CRNTI:%d does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
      return(1);
   }
...

{
      ...
      (cell->cellId != ulSpsResetInfo->cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb30004,L_ERROR,DBG_CELLID, ulSpsResetInfo->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c",947, "Cell does not exist ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ((ue = rgDBMGetUeCb(cell, ulSpsResetInfo->crnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb30005,L_ERROR,DBG_CELLID, cell->cellId, ulSpsResetInfo->crnti, 0, 0, 0,                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"      ,                             954      , "CRNTI:%d does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                              ;
      return(1);
   }
...

{
      ...
      (cell->cellId != lcInfo->cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb30006,L_ERROR,DBG_CELLID, lcInfo->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c",1018, "Cell does not exist ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ((ue = rgDBMGetUeCb(cell, lcInfo->crnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb30007,L_ERROR,DBG_CELLID, cell->cellId, lcInfo->crnti, 0, 0, 0,                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"      ,                     1025      , "CRNTI:%d does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                      ;
      return(1);
   }
   ...
   for (idx=0; idx < lcInfo->spsLcCnt; idx++)
   {
      ...
      ue->ul.spsLcId[(lcInfo->spsLcId[idx])-1] = 1;
   }
   ue->ul.implRelCnt = lcInfo->implRelCnt;
   ue->ul.explRelCnt = ue->ul.implRelCnt + 1;


   if (rgDBMInsSpsUeCb(cell, ue) == 1)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb30008,L_ERROR,DBG_CELLID, cell->cellId, ue->spsRnti, 0, 0, 0,                                                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"      ,                                                                          1043      , "Ue insertion into SPS list failed SPS CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                           ;
      return(1);
   }
...

{
      ...
      (cell->cellId != cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb30009,L_ERROR,DBG_CELLID, cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c",1102, "Cell does not exist ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ((ue = rgDBMGetUeCb(cell, crnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb3000a,L_ERROR,DBG_CELLID, cellId, crnti, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c",1108, "CRNTI:%d Ue does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if ((ue == 0L) || (newUe == 0L))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb3000b,L_ERROR,DBG_CELLID, cell->cellId, rnti, ((U32)ue), ((U32)newUe), newRnti,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"      ,                                                     1169      , "RNTI:%d Failed to get UECB[%lu:%lu] or NEW RNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if ((ue = rgDBMGetUeCb(cell, rlsRnti->rnti)) == 0L)
   {

      if((ue=rgDBMGetUeCbFromRachLst (cell, rlsRnti->rnti)) != 0L)
      {
      ...
      {
         if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb3000c,L_WARNING,DBG_CELLID, cell->cellId,rlsRnti->rnti, 0, 0, 0,                                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"         ,                                                                   1431         , "RNTI:%d No ueCb found in RachLst", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                    ;
      }
   }
   else
   {
...

      {
         if((ue=rgDBMGetUeCbFromRachLst (cell, rlsRnti->rnti)) != 0L)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb3000d,L_ERROR,DBG_CELLID, cell->cellId, rlsRnti->rnti, 0, 0, 0,                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"            ,                                                                 1460            , "RNTI:%d STALE UE is still present", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                  ;
         }
      }
   }
...

{
      ...
      (cell->cellId != rlsRnti->cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb3000e,L_ERROR,DBG_CELLID, rlsRnti->cellId, rlsRnti->rnti, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"      ,                        1521      , "No cellCb found with cellId for RNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (rlsRnti->ueIdChng)
   {
      ...
      if (rgUtlHndlCrntiChng(macInst,cell, rlsRnti->rnti, rlsRnti->newRnti) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb3000f,L_ERROR,DBG_CELLID, rlsRnti->cellId, rlsRnti->rnti, rlsRnti->newRnti, 0, 0,                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_utl.c"         ,                                                 1535         , "CRNTI change failed for RNTI:%d new RNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
