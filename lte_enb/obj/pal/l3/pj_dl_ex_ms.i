...

{
   ...
   switch(pst->srcEnt)
   {
      case 0x0E:
         {
            switch(pst->event)
            {
               ...
               default:
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd90001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_ex_ms.c",245, "Received Invalid Event from SM", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     ret = 1;
                     break;
                  }
      ...
      case 0xd9:
         {
            switch(pst->event)
            {
               ...
               default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd90002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_ex_ms.c",411, " Received Invalid Event From RRC", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
      ...
      case 0xe2:
         {
            switch(pst->event)
            {
               ...
               default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd90003, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_ex_ms.c",454, " Received Invalid Event from Relay", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
            }
            break;
      ...
      case 0xe1:
         {
            switch(pst->event)
            {
               default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd90004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_ex_ms.c",478, "Received Invalid Event from Offboard Ciphering", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
            }
            break;
      ...
      case 0xe0:
         {
            switch(pst->event)
            {
               default:
                  SPutMsg(mBuf);
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd90005, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_ex_ms.c",515, "Received Invalid Event from Offboard Security", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                  ret = 1;
                  break;
            }
            break;
      ...
      case 0xd7:
         {
            switch(pst->event)
            {
               ...
               default:
                  {
                     SPutMsg(mBuf);
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd90006, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_ex_ms.c",569, "Received Invalid Event from RLC", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     ret = 1;
                     break;
                   }
      ...
      default:
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd90007, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_ex_ms.c",643, "Recieved Invalid Source Entity ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            SPutMsg(mBuf);
            ret = 1;
            break;
         }
