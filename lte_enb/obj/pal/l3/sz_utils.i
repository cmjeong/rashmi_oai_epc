...
extern S16 szDelSctSap (SuId lSapId, U8 opn);
 ...
 S16 szFillTknU32 (TknU32 *encParam,U32 val);
 S16 szFillTknU8 (TknU8 *encParam,U8 val);
 S16 szFillTknU16 (TknU16 *encParam,U16 val);
U16 szElmSize[][48] =
{
   {
...

{
   ...
   {
      case 0:
         if(pdu->pdu.val.initiatingMsg.pres.pres == 1)
         {
         ...
         break;
      case 1:
         if(pdu->pdu.val.successfulOutcome.pres.pres == 1)
         {
         ...
         break;
      case 2:
        if(pdu->pdu.val.unsuccessfulOutcome.pres.pres == 1)
        {
   ...
   *ie = 0L;
   ...
   while (recIdx < numComp)
   {
      ...
      if (((TknPres *)currStr)->pres == 1)
      {
         ...
         if (recId == id)
         {
            startStr = (TknU8 *) ((U32)currStr + sizeof(SztProtIE_ID) + sizeof(SztCriticality));
...

{
   ...
   ret = cmAllocEvnt(sizeof(S1apPdu), 2048, &mem, (Ptr *)rstAckPdu);
   if (ret != 0)
   {
   ...
   szFillTknU8(&((*rstAckPdu)->pdu.choice), 1);
   szFillTknU8(&((*rstAckPdu)->pdu.val.successfulOutcome.pres),1);
   szFillTknU32(&((*rstAckPdu)->pdu.val.successfulOutcome.procedureCode),14);
   szFillTknU32(&((*rstAckPdu)->pdu.val.successfulOutcome.criticality),SztCriticalityrejectEnum);
   szFillTknU8(&((*rstAckPdu)->pdu.val.successfulOutcome.value.u.sztResetAckg.pres),1);

   szGetIE(&(pdu->pdu),92,&rstIe);

   if(rstIe == 0L)
   {
      *cause = 18;
      { if (*rstAckPdu != 0L) { cmFreeMem ((Ptr)(*rstAckPdu)); *rstAckPdu = 0L; } };
      return(1);
   }


   if(((SztResetTyp *)rstIe)->choice.val == 1)
   {
      ...
      if ((cmGetMem(&((*rstAckPdu)->memCp), sizeof(SztProtIE_Field_ResetAckgIEs),
          (Ptr *)&((*rstAckPdu)->pdu.val.successfulOutcome.value.
                       u.sztResetAckg.protocolIEs.member))) !=0)
      {
      ...
      szFillTknU8(&(ie->pres),1);
      szFillTknU32(&(ie->id),93);
      ...
      if ((cmGetMem(&((*rstAckPdu)->memCp), numCon * sizeof(SztProtIE_SingleCont_UE_assocLogS1_ConItemResAck),
          (Ptr *)&ie->value.u.sztUE_assocLogS1_ConLstResAck.member)) !=0)
      {
      ...
      for(idx = 0; idx < numCon; idx++)
      {
         ...
         szFillTknU8(&(ie1->pres),1);
         szFillTknU32(&(ie1->id),91);
         szFillTknU32(&(ie1->criticality),SztCriticalityignoreEnum);
         szFillTknU8(&(ie1->value.u.sztUE_assocLogS1_ConItem.pres),1);
         ...
         ie1->value.u.sztUE_assocLogS1_ConItem.iE_Extns.noComp.pres = 0;
      }
   }
   else
   {
...
{
   SztProtIE_Field_ErrIndIEs *ie = 0L;
   TknU8 *mmeS1apId = 0L;
   TknU8 *enbS1apId = 0L;
   ...
   SztCriticalityDiag_IE_Item *ie1 = 0L;
   U8 idx;
   U32 procCode;
   U32 criticality;
   ...
   ret = cmAllocEvnt(sizeof(S1apPdu), 2048, &mem, (Ptr *)errIndPdu);
   if (ret != 0)
   {
      return(1);
   }

   szFillTknU8(&((*errIndPdu)->pdu.choice), 0);
   szFillTknU8(&((*errIndPdu)->pdu.val.initiatingMsg.pres), 1);
   szFillTknU32(&((*errIndPdu)->pdu.val.initiatingMsg.procedureCode), 15);
   szFillTknU32(&((*errIndPdu)->pdu.val.initiatingMsg.criticality), SztCriticalityignoreEnum);


   szFillTknU8(&((*errIndPdu)->pdu.val.initiatingMsg.value.u.sztErrInd.pres), 1);

   numComp = 1;

   if(pdu != 0L)
   {
      szGetIE(&pdu->pdu,0, &mmeS1apId);
      szGetIE(&pdu->pdu,8, &enbS1apId);
   }
   ...
   if ((cmGetMem((*errIndPdu), (numComp * sizeof(SztProtIE_Field_ErrIndIEs)),
               (Ptr *)&((*errIndPdu)->pdu.val.initiatingMsg.value.u.sztErrInd.protocolIEs.member))) !=0)
   {
      { if (*errIndPdu != 0L) { cmFreeMem ((Ptr)(*errIndPdu)); *errIndPdu = 0L; } };
      return(1);
   }
   ...
   if(asnErr->ieCount > 15)
   {
      asnErr->ieCount = 15;
   }

   if(asnErr->ieCount && (0L != pdu))
   {
      ...
      szFillTknU8(&(ie->pres), 1);
      szFillTknU32(&(ie->id), 58);
      szFillTknU32(&(ie->criticality), SztCriticalityignoreEnum);
      szFillTknU8(&(ie->value.u.sztCriticalityDiag.pres), 1);
      ...
      if ((cmGetMem((*errIndPdu), (numComp * sizeof(SztCriticalityDiag_IE_Item)),
                  (Ptr *)&(ie->value.u.sztCriticalityDiag.iEsCriticalityDiag.member))) != 0)
      {
         { if (*errIndPdu != 0L) { cmFreeMem ((Ptr)(*errIndPdu)); *errIndPdu = 0L; } };
         return(1);
      }
...
)
{
   ...
   ret = cmAllocEvnt(sizeof(S1apPdu), 2048, &mem, (Ptr *)initCxtSetupFail);
   if (ret != 0)
   {
      return(1);
   }

   szFillTknU8(&((*initCxtSetupFail)->pdu.choice), 2);
   szFillTknU8(&((*initCxtSetupFail)->pdu.val.unsuccessfulOutcome.pres),1);
   szFillTknU32(&((*initCxtSetupFail)->pdu.val.unsuccessfulOutcome.procedureCode),9);
   szFillTknU32(&((*initCxtSetupFail)->pdu.val.unsuccessfulOutcome.criticality),SztCriticalityrejectEnum);


   szFillTknU8(&((*initCxtSetupFail)->pdu.val.unsuccessfulOutcome.value.u.sztInitCntxtSetupFail.pres),1);
   ...
   if ((cmGetMem((*initCxtSetupFail), numComp*sizeof(SztProtIE_Field_InitCntxtSetupFailIEs),
       (Ptr *)&((*initCxtSetupFail)->pdu.val.unsuccessfulOutcome.value.u.sztInitCntxtSetupFail.protocolIEs.member))) !=0)
   {
      { if (*initCxtSetupFail != 0L) { cmFreeMem ((Ptr)(*initCxtSetupFail)); *initCxtSetupFail = 0L; } };
      return(1);
   }
...
)
{
   ...
   ret = cmAllocEvnt(sizeof(S1apPdu), 2048, &mem, (Ptr *)ueCxtModFailPdu);
   if (ret != 0)
   {
      return(1);
   }

   szFillTknU8(&((*ueCxtModFailPdu)->pdu.choice), 2);
   szFillTknU8(&((*ueCxtModFailPdu)->pdu.val.unsuccessfulOutcome.pres),1);
   szFillTknU32(&((*ueCxtModFailPdu)->pdu.val.unsuccessfulOutcome.procedureCode),21);
   szFillTknU32(&((*ueCxtModFailPdu)->pdu.val.unsuccessfulOutcome.criticality),SztCriticalityrejectEnum);


   szFillTknU8(&((*ueCxtModFailPdu)->pdu.val.unsuccessfulOutcome.value.u.sztUECntxtModificationFail.pres),1);
   ...
   if ((cmGetMem((*ueCxtModFailPdu), numComp*sizeof(SztProtIE_Field_UECntxtModificationFailIEs),
       (Ptr *)&((*ueCxtModFailPdu)->pdu.val.unsuccessfulOutcome.value.u.sztUECntxtModificationFail.protocolIEs.member))) !=0)
   {
      { if (*ueCxtModFailPdu != 0L) { cmFreeMem ((Ptr)(*ueCxtModFailPdu)); *ueCxtModFailPdu = 0L; } };
      return(1);
   }
...

{
   ...
   if (szCb.nodeCb.nodeType == 2)
   {
      id = ((++szCb.lclConCntr) % 0xffffff);
   }



   if(szCb.nodeCb.nodeType == 3)
   {
      id = ((++szCb.lclConCntr) % 0xffffffff);
   }
...

{
   ...
   ret = cmAllocEvnt(sizeof(S1apPdu), 2048, &mem, (Ptr *)&szRstPdu);
   if (ret != 0)
   {
      { if (szRstPdu != 0L) { cmFreeMem ((Ptr)(szRstPdu)); szRstPdu = 0L; } };
      return(1);
   }

   szFillTknU8(&(szRstPdu->pdu.choice), 0);
   szFillTknU8(&(szRstPdu->pdu.val.initiatingMsg.pres), 1);
   ...
   if ((cmGetMem(szRstPdu, (numComp * sizeof(SztProtIE_Field_ResetIEs)),
               (Ptr *)&szRstPdu->pdu.val.initiatingMsg.value.u.sztReset.protocolIEs.member)) !=0)
   {
      { if (szRstPdu != 0L) { cmFreeMem ((Ptr)(szRstPdu)); szRstPdu = 0L; } };
      return(1);
   }
   ...
   if(ie->value.u.sztResetTyp.choice.val == 0)
   {
   ...
   else
   {
      ...
      if (cmGetMem(szRstPdu, (numComp * sizeof(SztProtIE_SingleCont_UE_assocLogS1_ConItemRes)),
               (Ptr *)&(ie->value.u.sztResetTyp.val.partOfS1_Intf.member)) != 0)
      {
         { if (szRstPdu != 0L) { cmFreeMem ((Ptr)(szRstPdu)); szRstPdu = 0L; } };
         return(1);
      }
...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000008)) { snprintf((&szCb.init)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->procId, (&szCb.init)->ent, (&szCb.init)->inst,
                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_utils.c"
   ,
                                                        1788
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szUtilsGetConCb : Received dedicated procedure\n"); SPrint((&szCb.init)->prntBuf); } }
                                                         ;
...
)
{
   ...
   SztHovrPrepFail *failMsg = 0L;
   SztProtIE_Field_HovrPrepFailIEs *ie = 0L;
   ...
   szFillTknU8(&((*errIndPdu)->pdu.choice), 2);
   szFillTknU8(&((*errIndPdu)->pdu.val.unsuccessfulOutcome.pres), 1);
   ...
   if ((cmGetMem((*errIndPdu), (numComp * sizeof(SztProtIE_Field_HovrPrepFailIEs)),
               (Ptr *)&(failMsg->protocolIEs.member))) != 0)
   {
      { if (*errIndPdu != 0L) { cmFreeMem ((Ptr)(*errIndPdu)); *errIndPdu = 0L; } };
      return(1);
   }
...
)
{
   ...
   SztHovrFail *failMsg = 0L;
   SztProtIE_Field_HovrFailIEs *ie = 0L;
...
)
{
   ...
   SztPathSwRqstFail *failMsg = 0L;
   SztProtIE_Field_PathSwRqstFailIEs *ie = 0L;
...
)
{
   ...
   SztS1SetupFail *failMsg = 0L;
   SztProtIE_Field_S1SetupFailIEs *ie = 0L;
...
)
{
   ...
   SztENBConfigUpdFail *failMsg = 0L;
   SztProtIE_Field_ENBConfigUpdFailIEs *ie = 0L;
...
)
{
   ...
   SztMMEConfigUpdFail *failMsg = 0L;
   SztProtIE_Field_MMEConfigUpdFailIEs *ie = 0L;
...
)
{
   ...
   ,
                                                                  2940
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szUtilsBldUnsucOutComeMsg : Received dedicated procedure\n"); SPrint((&szCb.init)->prntBuf); } }
                                                                   ;
