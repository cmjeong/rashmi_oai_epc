...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xc40001, L_DEBUG, suId, status, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lim.c",150, "KwLiRguBndCfm(suId(%d), status(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   rguSap = (tKwCb->genCfg.rlcMode == 1) ?
            &(tKwCb->u.dlCb->rguDlSap[suId]) : &(tKwCb->u.ulCb->rguUlSap[suId]);

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xc40002, L_DEBUG, rguSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lim.c",175, "KwLiRguBndCfm: For RGU SAP state=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if (!rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc40003,L_ERROR,DBG_CELLID, datInd->cellId, datInd->lcId, 0, 0, 0,                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lim.c"      ,                     285      , "LcId [%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                      ;
...

{
   ...
   if(!rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc40004,L_ERROR,DBG_CELLID, staInd->cellId, staInd->lcId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_lim.c"      ,                        453      , "LcId [%d] not found CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
