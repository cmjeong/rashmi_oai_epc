...
extern Void kwLmmSendAlarm (KwCb *gCb, U16 category, U16 event, U16 cause, SuId suId, U32 ueId)
                                            ...
                                            ;
static S16 PtUiKwuBndCfm ( Pst *pst, SuId suId, U8 status )
 ...
 S16 PtUiKwuDatCfm ( Pst *pst, SuId suId, KwuDatCfmInfo *datCfm )



  ;

 S16 PtUiKwuStaInd ( Pst *pst, SuId suId, KwuStaIndInfo *staInd )



  ;

 S16 PtUiKwuReEstCmpInd ( Pst *pst, SuId suId, CmLteRlcId rlcId )



  ;

 S16 PtUiKwuDiscSduCfm ( Pst *pst, SuId suId, KwuDiscSduInfo *discCfm )



  ;
 S16 PtUiKwuFlowCntrlInd ( Pst *pst, SuId suId, KwuFlowCntrlIndInfo *flowCntrlIndInfo )



  ;
 S16 PtUiKwuDatInd ( Pst *pst, SuId suId, KwuDatIndInfo *datInd, Buffer *mBuf )




  ;
static S16 PtUiCkwBndCfm ( Pst *pst, SuId suId, U8 status )



  ;

 S16 PtUiCkwCfgCfm ( Pst *pst, SuId suId, CkwCfgCfmInfo *cfmInfo )



  ;

 S16 PtUiCkwUeIdChgCfm ( Pst *pst, SuId suId, U32 transId, CkwUeInfo *ueInfo, CmStatus status )
...
{
   ;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xc70001, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_ptui.c",657, "In KwUiKwuReEstCmpInd", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   (pst=pst);
   (suId=suId);
   (flowCntrlIndInfo=flowCntrlIndInfo);
   return(0);
