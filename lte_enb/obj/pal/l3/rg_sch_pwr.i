...
typedef S8 RgSchCmnUlPwrCqiToPwrTbl[16];

static RgSchCmnUlPwrCqiToPwrTbl rgSchPwrCqiToPwrTbl;



const U8 rgSchPwrRbToPwrTbl[111] = { 0,
...
static S8 rgSCHPwrGetCqiPwr ( U8 cqi )

           ;
static S8 rgSCHPwrGetCqiPwrForUe ( RgSchCellCb *cell, RgSchUeCb *ue, U8 cqi )



           ;
static S8 rgSCHPwrCalcEfficncyPwr ( U32 eff )

           ;
static S8 rgSCHPwrGetDelta2FrmCqi ( U8 crntCqi, U8 trgCqi, RgSchUeCb *ue, RgSchCellCb *cell )




           ;
static Void rgSCHPwrGetPuschTpc ( U8 isAcc, S8 delta, S8 availPwr, U8 *tpc, S8 *tpcDelta )
           ...
           ;
static U8 rgSCHPwrGetMaxRb ( RgSchCellCb *cell, S8 pwr )


           ;
static U8 rgSCHPwrRbToPwr ( RgSchCellCb *cell, U8 numRb )
...
static Void rgSCHPwrSchedPuschRnti ( RgSchCellCb *cell, RgSchCmnTpcRntiCb *cb, RgSchPdcch *pdcch, RgSchUlSf *ulSf, Bool *sched )
           ...
           ;
static Void rgSCHPwrGetPucchFmt3TpcForUe ( RgSchUeCb *ue, U8 *tpc, S8 *delta )



           ;
static Void rgSCHPwrGetPucchFmt3aTpcForUe ( RgSchUeCb *ue, U8 *tpc, S8 *delta )



           ;
static Void rgSCHPwrGetPuschFmt3TpcForUe ( RgSchUeCb *ue, U8 *tpc, S8 *delta )



           ;
static Void rgSCHPwrGetPuschFmt3aTpcForUe ( RgSchUeCb *ue, U8 *tpc, S8 *delta )



           ;
static Void rgSCHPwrGetAcc1bitTpc ( S8 remPwr, U8 *tpc, S8 *delta )



           ;
static Void rgSCHPwrGetAcc2bitTpc ( S8 remPwr, U8 *tpc, S8 *delta )



           ;
static Void rgSCHPwrGetAbsTpc ( S8 remPwr, U8 *tpc, S8 *delta )
...
static Void rgSCHPwrRmvSchdPuschTpcRntiCb ( RgSchCellCb *cell, RgSchCmnTpcRntiCb *cb )
           ...
           ;
static S16 rgSCHPwrChkPucchTpcRntiIdx ( RgSchCmnTpcRntiCb *cb, U8 idx )


           ;
static S16 rgSCHPwrChkPuschTpcRntiIdx ( RgSchCmnTpcRntiCb *cb, U8 idx )


           ;
static S16 rgSCHPwrChkUniqPucchTpcRntiIdx ( RgSchCmnTpcRntiCb *cb, U8 idx )


           ;
static S16 rgSCHPwrChkUniqPuschTpcRntiIdx ( RgSchCmnTpcRntiCb *cb, U8 idx )


           ;
static S16 rgSCHPwrChkTpcRntiIdx ( RgSchCmnTpcRntiCb *cb, U8 idx )


           ;
static S8 rgSCHPwrGetPhValFromPhr ( U8 phr )

           ;
static S8 rgSCHPwrGetPCMaxValFromPCMax ( U8 pCMax )
...
{
   RgSchCmnUeUlPwrCb *uePwr = &(((RgSchCmnUe *)((ue->cellInfo[ue->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]])->sch))->ul.ulPwrCb);
   ;;
...

{
   ...
   if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbc0001,L_UNUSED,DBG_CELLID, cell->cellId, ue->ueId, maxRb, uePwr->phVal, availPwr,                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_pwr.c"   ,                                                686   , "UEID:%d Output Max Rb (%d), phVal (%d) AvailPwr (%d) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                 ;
   if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbc0002,L_UNUSED,DBG_CELLID, cell->cellId, ue->ueId, uePwr->pwrPerRb, uePwr->remPuschPwr, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_pwr.c"   ,                           691   , "UEID:%d pwrPerRb %d remPuschPwr %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   return(((uePwr->maxPwrDeltaByPhr) <= ((trgCqi - crntCqi) * 2) ? (uePwr->maxPwrDeltaByPhr) : ((trgCqi - crntCqi) * 2)))
                                                         ;
}
...
)
{
   ...
   delta = ((delta) <= (availPwr) ? (delta) : (availPwr));
...

{
   ...
   cellUl = &(((RgSchCmnCell *)((cell)->sc.sch))->ul);
   if (pwr <= 0)
   {
   ...
   return(((cellUl->maxUlBwPerUe) <= (rgSchPwrToRbTbl[(U8)pwr]) ? (cellUl->maxUlBwPerUe) : (rgSchPwrToRbTbl[(U8)pwr])));
}
...
{
   RgSchCmnUlPwrCb *cellPwr = &((RgSchCmnCell *)((cell)->sc.sch))->ul.ulPwrCb;
   CmLListCp *lst;
   CmLList *lnk;
   RgSchPdcch *pdcch;
   ;;
   ...
   lnk = lst->first;
   while (lnk && ((pdcch = rgSCHCmnCmnPdcchAlloc(cell, dlSf)) != 0L))
   {
...
)
{
   ...
   if (cb->isFmt3a)
   {
      ...
      pdcch->dci.u.format3AInfo.isPucch = 1;

      tpcCmds = pdcch->dci.u.format3AInfo.tpcCmd;


      for (atleastOne = 0, lnk = lst->first; lnk; lnk = lnk->next)
      {
   ...
   else
   {
      ...
      pdcch->dci.u.format3Info.isPucch = 1;
...
)
{
   ...
   if (cb->isFmt3a)
   {
      ...
      pdcch->dci.dciFormat = TFU_DCI_FORMAT_3A;
      pdcch->dciNumOfBits = cell->dciSize.size[TFU_DCI_FORMAT_3A];
      pdcch->dci.u.format3AInfo.isPucch = 0;
      tpcCmds = pdcch->dci.u.format3AInfo.tpcCmd;
   ...
   else
   {
      ...
      pdcch->dci.dciFormat = TFU_DCI_FORMAT_3;
      pdcch->dciNumOfBits = cell->dciSize.size[TFU_DCI_FORMAT_3];
      pdcch->dci.u.format3Info.isPucch = 0;
      tpcCmds = pdcch->dci.u.format3Info.tpcCmd;
...
{
   RgSchCmnUeUlPwrCb *uePwr = &(((RgSchCmnUe *)((ue->cellInfo[ue->cellIdToCellIdxMap [(U8)((ue->cell->cellId >= rgSchCb[ue->cell->instIdx].genCfg.startCellId) ? (ue->cell->cellId - rgSchCb[ue->cell->instIdx].genCfg.startCellId)&(8 -1): 0)]])->sch))->ul.ulPwrCb);
   ;;
...
{
   RgSchCmnUeUlPwrCb *uePwr = &(((RgSchCmnUe *)((ue->cellInfo[ue->cellIdToCellIdxMap [(U8)((ue->cell->cellId >= rgSchCb[ue->cell->instIdx].genCfg.startCellId) ? (ue->cell->cellId - rgSchCb[ue->cell->instIdx].genCfg.startCellId)&(8 -1): 0)]])->sch))->ul.ulPwrCb);
   S8 adj = ((uePwr->remPuschPwr) <= (uePwr->phVal) ? (uePwr->remPuschPwr) : (uePwr->phVal));
   ;;
...

{
   ...
   if (uePwr->isPhrAvail)
   {
      ...
      uePwr->phVal = ((-23) >= (uePwr->phVal) ? (-23) : (uePwr->phVal));
   }
...

{
   ...
   if (uePwr->schdPucchGrpLnk.node == 0L)
   {
      return;
   }
...

{
   ...
   if (uePwr->schdPuschGrpLnk.node == 0L)
   {
      return;
   }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbc0003,L_DEBUG,DBG_UEID, ue->ueId, uePwr->phVal, allocInfo->cqi, allocInfo->numRb, uePwr->pwrPerRb,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_pwr.c"   ,                           2303   , "Output: Reported PHR[%d] cqi[%u] allocRb[%u] uePwr->pwrPerRb[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if (uePwr->isPhrAvail)
   {
      ...
      uePwr->phVal = ((40) <= (uePwr->phVal) ? (40) : (uePwr->phVal));
   }
   uePwr->numRb = numRb;
   return;
}
...

{
   ...
   cellPwr->pMax = ((cfg->pMax) <= (23) ? (cfg->pMax) : (23));
...

{
   ...
   RgSchCmnUlUe *ueUl = (&(((RgSchCmnUe *)((ue->cellInfo[ue->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]])->sch))->ul));
   RgSchCmnUeUlPwrCb *uePwr = &(((RgSchCmnUe *)((ue->cellInfo[ue->cellIdToCellIdxMap [(U8)((cell->cellId >= rgSchCb[cell->instIdx].genCfg.startCellId) ? (cell->cellId - rgSchCb[cell->instIdx].genCfg.startCellId)&(8 -1): 0)]])->sch))->ul.ulPwrCb);
   RgSchCmnTpcRntiCb *pucchRntiCb = 0L;
   RgSchCmnTpcRntiCb *puschRntiCb = 0L;
   U8 pucchIdx = 0;
   U8 puschIdx = 0;
   ;;
   ...
   if (pucchRntiCb)
   {
      if (uePwr->tpcPucchRntiCb != pucchRntiCb)
      {
      ...
      if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbc0004,L_UNUSED,DBG_CELLID, cell->cellId, pucchRntiCb->cfgdUes.count, ((U32)pucchRntiCb->cfgdUes.first), ((U32)pucchRntiCb->cfgdUes.last), ue->ueId,                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_pwr.c"      ,                                                        2893      , "<GRP_PWR>PucchRntiCb cfgdUes(%ld %lu %lu) UEID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                                                         ;
      if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbc0005,L_UNUSED,DBG_CELLID, cell->cellId, ue->ueId, pucchRntiCb->isFmt3a, pucchRntiCb->schdLnk.node, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_pwr.c"      ,                                        2897      , "UEID:%d isFmt3a(%u) ueNode(%ld)", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                                         ;
      if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xbc0006,L_UNUSED,DBG_CELLID, cell->cellId, pucchRntiCb->toBeSchdUes.count, ((U32)pucchRntiCb->toBeSchdUes.first), ((U32)pucchRntiCb->toBeSchdUes.last), pucchRntiCb->tpcRnti,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_sch_pwr.c"      ,                                   2903      , "toBeSchdUes(%ld %lu %lu) tpcRnti(%u)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (puschRntiCb)
   {
      if (uePwr->tpcPuschRntiCb != puschRntiCb)
      {
...

{
   ...
   {
      rgSCHPwrDelUeFrmPucchTpcRntiCb(cell, uePwr->tpcPucchRntiCb, ue);
      uePwr->tpcPucchRntiCb = 0L;
   }
   if (uePwr->tpcPuschRntiCb)
   {
      rgSCHPwrDelUeFrmPuschTpcRntiCb(cell, uePwr->tpcPuschRntiCb, ue);
      uePwr->tpcPuschRntiCb = 0L;
   }
   return;
}
...

{
   ...
   uePwr->schdPucchGrpLnk.node = (U32)ue;
...

{
   ...
   uePwr->schdPuschGrpLnk.node = (U32)ue;
   if (cb->toBeSchdUes.count == 1)
   {
...

{
   ...
   if (rgSCHPwrChkTpcRntiIdx(cb, idx) != 0)
   {
      return(1);
   }
   if (rgSCHPwrChkUniqPucchTpcRntiIdx(cb, idx) != 0)
   {
      return(1);
   }
   return(0);
...

{
   ...
   if (rgSCHPwrChkUniqPuschTpcRntiIdx(cb, idx) != 0)
   {
      return(1);
   }
   return(0);
