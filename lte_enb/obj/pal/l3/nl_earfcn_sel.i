...
extern S16 nlSendSonMeasRptIntervalInd ( U32 ueMeasInterval, NlCellCb *cellCb )
  ...
  ;
static S16 nlCellSelectEarfcnByDSon ( NlCellCb *cellCb, LnlCellCfg *cellCfg )


  ;
 S16 nlValidateCellEarfcnCfg
(
LnlCellCfg *cellCfg
)
...

{
   ...
   do
   {
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf60001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_earfcn_sel.c",104, "Empty DL-Earfcn list received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
      if(cellCfg->numUlEarfcn == 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf60002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_earfcn_sel.c",110, "Empty UL-Earfcn list received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
      if(cellCfg->numDlEarfcn != cellCfg->numUlEarfcn)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf60003, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_earfcn_sel.c",116, "number of DL-Earfcn and UL-Earfcn mismatched", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
   }while(0);
...
static S16 nlCellSelectEarfcnByDSon
(
NlCellCb *cellCb,
LnlCellCfg *cellCfg
)
...

{
   ...
   U32 earfcnCount;
   U32 remEarfcnCount;
   NlRemScanEarfcnSel remScanEarfcnSel[64];
   NlRemScanEarfcnSel *dlEarfcnSel = 0L;
   U8 earfcnSelCount = 0;
   U8 count;
...

{
   ...
   switch(nlCb.genCfg.earfcnSelType)
   {
      case NL_PCI_SEL_DISABLE :
      {
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xf60004, L_INFO, cellCb->cellInfo.dlEarfcn, cellCb->cellInfo.ulEarfcn, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_earfcn_sel.c"         , 248         , "SON selected DL-Earfcn : %d UL-earfcn : %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                ;
      ...
      case NL_PCI_SEL_DSON :
      {
         ...
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xf60005, L_INFO, cellCb->cellInfo.dlEarfcn, cellCb->cellInfo.ulEarfcn, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteson/src/nl_earfcn_sel.c"         , 257         , "SON selected DL-Earfcn : %d UL-earfcn : %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                ;
