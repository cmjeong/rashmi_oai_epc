   ...
   switch(pst->srcEnt)
   {
      ...
      case 0xd9:
         switch (pst->event)
         {
            ...
            case 1:
               ret = cmUnpkCtfBndReq (TfUiCtfBndReq, pst, mBuf);
               break;
            case 3:
               ret = cmUnpkCtfUbndReq (TfUiCtfUbndReq, pst, mBuf);
               break;
            case 4:
               ret = cmUnpkCtfCfgReq (TfUiCtfCfgReq, pst, mBuf);
               break;
            ...
            default:
               { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst,
                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ex_ms.c"
               ,
                                      188
               ...
               ,
                                      188
               ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysActvTsk(): Invalid event (%d)! \n", pst->event); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                       ;
               SPutMsg(mBuf);
               break;
      ...
      case 0xd5:
         ...
         switch(pst->event)
         {
            ...
            case 7:
               cmUnpkTfuRaReqInd(TfUiTfuRaReqInd, pst, mBuf);
               break;
            case 10:
               cmUnpkTfuHqInd(TfUiTfuHqInd, pst, mBuf);
               break;
            case 12:
               cmUnpkTfuSrInd(TfUiTfuSrInd, pst, mBuf);
               break;
            case 13:
               cmUnpkTfuDatInd(TfUiTfuDatInd, pst, mBuf);
               break;
            case 17:
               ysPrcTmrExpiry(0L, 10);
               SPutMsg(mBuf);
               break;
            case 15:
               cmUnpkTfuTimingAdvInd(TfUiTfuTimingAdvInd, pst, mBuf);
               break;
            case 11:
               cmUnpkTfuDlCqiInd(TfUiTfuDlCqiInd, pst, mBuf);
               break;
            default:
               { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ex_ms.c", 241); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ex_ms.c", 241); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysActvTsk(): Invalid event (%d)! \n",pst->event); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
               SPutMsg(mBuf);
               break;
         }
         break;
      ...
      default:
         ...
         ,
                                                            250
         ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysActvTsk(): Message from an invalid                               entity (%d)! \n", pst->srcEnt); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                                             ;
         SPutMsg(mBuf);
         ret = 1;
