...
static S16 pjCfgFillPjUlRbCb ( PjCb *gCb, PjUlRbCb *rbCb, PjUlUeCb *ueCb, U8 isHo, CpjCfgEnt *cfgEnt, CpjCfmEnt *cfmEnt )
...
static S16 pjCfgUpdUlCompInfo ( PjCb *gCb, PjUlRbCb *rbCb, PjUlUeCb *ueCb, CpjHdrCompCfg *rohcCfg )
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd50001, L_DEBUG, cellId, ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 164   , "pjCfgAddRb- Received with -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                  ;

   if( 0L == *ueCb)
   {

      if ( pjDbmCreateUlUeCb(gCb, ueId, cellId, ueCb) != 0)
      {

         { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 2; }
                                          ;

         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50002,L_ERROR,DBG_UEID, ueId, cellId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"         ,                           176         , "Creating UE Cb Failed -- cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
         return(ret);
      }
   }
   ...
   if ( 0 != ret)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50003,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                         190      , "Invalid RB ID-- cellId(%d),RB Id(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;
      return(ret);
   }
   ...
   if (0L != rbCb)
   {
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50004,L_WARNING,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                               201      , "CellId [%u]:RbId[%d] already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;
   ...
   else if (0L == rbCb)
   {
      ...
      rbCb = pjDbmCreateUlRbCb(gCb, entCfg->rbId, entCfg->rbType, *ueCb, 2);
      if(0L == rbCb)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50005,L_ERROR,DBG_UEID, ueId, cellId, entCfg->rbId, 0, 0,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"         ,                                   214         , "CellId [%u]:Creation of rbCb with id [%d] failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                    ;
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50006,L_DEBUG,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, cfgEnt->rbId, cfgEnt->cfgType, 0,                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   ,                                                                287   , "Received Fill RB Req For " "cellId(%d), rbId(%d), cfgType(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   switch (cfgEnt->cfgType)
   {
      ...
      case 0x01:
         {
            ...
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50007,L_DEBUG,DBG_UEID, ueCb->key.ueId, pjRbCb->dir, pjRbCb->mode, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"            ,                                                  330            , "RB Add Req Received with - Dir(%d),mode(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      case 0x02:
         {
            ...
            if(0x01 & cfgEnt->m.modCfg.bitFlag)
            ...
            if(1 & cfgEnt->m.modCfg.hoInfo.isHoPres)
            {
               ...
               if(1 & cfgEnt->m.modCfg.hoInfo.isHoPres)
               {
                  if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50008,L_DEBUG,DBG_UEID, ueCb->key.ueId, pjRbCb->dir, pjRbCb->mode, 0, 0,                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"                  ,                                                        386                  , "Received PDCP Update from Application for dir(%d), mode(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                  ...
                  { (pjRbCb->ulCb.nxtRxSn) = (U16)(cfgEnt->m.modCfg.hoInfo.ulCount % (1 << pjRbCb->snLen)); (pjRbCb->ulCb.rxHfn) = (cfgEnt->m.modCfg.hoInfo.ulCount >> pjRbCb->snLen); }
                                                                     ;
                  ...
                  if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50009,L_DEBUG,DBG_UEID, ueCb->key.ueId, 0, 0, 0, 0,                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"                  ,                                                             411                  , "Sending PDCP Status Report to UE ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                              ;
                  ...
                  if(bMapLen != 0)
                  {
                     { if (bitMap != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) bitMap, (Size) (bMapLen / 8) * sizeof(U8)); bitMap = 0L; } };
                  }
               }
            }
      ...
      default:
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd5000a, L_ERROR, cfgEnt->cfgType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c",432, "Invalid cfgType [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         }
   }
   return(ret);
}
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd5000b, L_DEBUG, ueCb->key.cellId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 486   , "Re-Cfg UL RB Req Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                     ;
   ...
   if( 0L == rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd5000c,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                          495      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
   ...
   ret = pjCfgFillPjUlRbCb(gCb, rbCb, ueCb,0, entCfg , entCfm);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd5000d, L_DEBUG, ueCb->key.cellId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 556   , "Del UL RB Req Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
   ...
   if (0L == rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd5000e,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                          565      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
   ...
   if(0 != ret)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd5000f,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                          582      , "CellId[%u]:RbId[%d] not deleted", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
      return(ret);
   }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd50010, L_DEBUG, ueCb->key.cellId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 637   , "Config ReEst Req Received for UL RB -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
   ...
   if( 0L == rbCb )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50011,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                          646      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;

      { cmMemcpy((U8*)entCfm, (U8 *)entDlCfgCfm, sizeof(CpjCfmEnt)); };
   ...
   if (ueCb->libInfo.state != 2 )
   {
      ...
      { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status = 2; entCfm->reason = 23; }
                                       ;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50012,L_ERROR,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, entCfg->rbId, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                          660      , "CellId[%u]:W/o REEST ,RbId[%d] not reestblshd", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
      return(1);
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd50013, L_DEBUG, ueCb->key.cellId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 735   , "pjCfgDelUe- Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;



   ret=pjDbmDelUlUeCb(gCb, ueCb, 0);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd50014, L_DEBUG, secCfg->cellId, secCfg->ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 788   , "pjCfgPrcSecCfg- Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                  ;
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50015,L_ERROR,DBG_CELLID, secCfg->cellId, secCfg->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                        797      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
   ...
   ueCb->secInfo.secCxt.dir = 0;

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50016,L_DEBUG,DBG_UEID, secCfg->ueId, secCfg->cellId, ueCb->secInfo.intInfo.algoType, ueCb->secInfo.cipherInfo.algoType, 0,                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   ,                                            839   , "Security Paramters stored in UE CB are -- cellId(%d)," " Integrity Algo(%ld), cipherAlgoType(%ld) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd50017, L_DEBUG, ueInfo->cellId, ueInfo->ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 933   , "pjCfgUeIdChng- Recived for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                  ;
        ...
        (ueInfo->cellId == newUeInfo->cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50018,L_ERROR,DBG_UEID, ueInfo->ueId, ueInfo->cellId, newUeInfo->cellId, newUeInfo->ueId, 0,                                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                                                  944      , "Changing UE Id -- Failed :" "old and New UeId are Same - cellId(%d),newCellId(%d), newUeId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (ret == 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50019,L_ERROR,DBG_UEID, ueInfo->ueId, newUeInfo->cellId, 0, 0, 0,                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                       956      , "Changing Ue ID Failed :New UeId already Exists -- cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd5001a,L_ERROR,DBG_CELLID, ueInfo->cellId,ueInfo->ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c",966, "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      status->reason = 7;
      status->status = 2;
      return(1);
   }
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd5001b,L_ERROR,DBG_UEID, ueInfo->ueId, ueInfo->cellId, 0, 0, 0,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                   978      , "cmHashListDelete Failed -- cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                    ;
   ...
   ueCb->key.cellId = newUeInfo->cellId;
    ...
    ret = cmHashListInsert(&(gCb->u.ulCb->ueLstCp), (U32)ueCb,
          (U8 *)&(ueCb->key), (U16) sizeof(PjUeKey));

  if (ret != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd5001c,L_ERROR,DBG_UEID, ueInfo->ueId, newUeInfo->cellId, newUeInfo->ueId, 0, 0,                                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                                       997      , "cmHashListInsert Failed -- cellId(%d),New ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd5001d, L_DEBUG, countReq->cellId, countReq->ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 1055   , "pjCfgPrcCount - Count Request Received for - cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd5001e,L_ERROR,DBG_CELLID, countReq->cellId,countReq->ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c",1066, "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd5001f, L_DEBUG, staReq->cellId, staReq->ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 1166   , "pjCfgPrcSduSta - Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                  ;
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50020,L_ERROR,DBG_CELLID, staReq->cellId,staReq->ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c",1175, "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd50021, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c",1182, "Memory allocation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      ...
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50022,L_DEBUG,DBG_UEID, staReq->ueId, staReq->cellId, 0, 0, 0,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                   1194      , "UE Cb is not found -- cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                    ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd50023, L_DEBUG, rbCb->rbId, ueCb->key.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 1277   , "pjCfgUpdCompInfo - Received for -- cellId(%d),RbId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                ;
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd50024, L_DEBUG, rbCb->rohc.profId, rbCb->rohc.maxCid, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 1312   , "pjCfgUpdCompInfo - Selected   -- profId(%d),maxCid(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                          ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd50025, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c",1363, "pjCfgDelPjRBCb- Recieved -- rbId() CfgState() ", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   if(0L != rbCb)
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd50026, L_DEBUG, rbCb->rbId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      , 1369      , "pjCfgDelPjRBCb- Received for -- rbId (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                          ;
      rbCb->ueCb = 0L;
      ...
      pjDbmDelUlRbCb(gCb,rbCb->rbId, rbCb->rbType, &rbCb, 2, ueCb);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd50027, L_DEBUG, rlcId.cellId, rlcId.ueId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"   , 1460   , "pjCfgReEstReq- Received for -- cellId(%d),ueId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;
   ...
   if( 0 != ret || 0L == rbCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd50028,L_ERROR,DBG_UEID, rlcId.ueId, rlcId.cellId, rlcId.rbId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_cfg_ul.c"      ,                                    1469      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;

      { reEstCfm->ueId = rlcId.ueId; reEstCfm->cellId = rlcId.cellId; reEstCfm->transId = reEstReq->transId; reEstCfm->status = 1; }
                                            ;
      return(ret);
   }
   ...
   cmMemcpy(&ueCb->secInfo.intInfo.intKey[0], &reEstReq->intKey[0], 16);
   cmMemcpy(&ueCb->secInfo.cipherInfo.cpKey[0], &reEstReq->ctrlplnKey[0], 16);
   cmMemcpy(&ueCb->secInfo.cipherInfo.upKey[0], &reEstReq->usrplnKey[0], 16);
