...
static S16 szUiGetAndChkSztSap (SpId spId, SzSztSapCb **uSapCb);
static S16 szUiDoAudit (SztAudEvnt *audit, SzSztSapCb *sztSapCb, U16 *cause);
 S16 SzUiSztBndReq
(
Pst *pst,
SuId suId,
...

{
   ...
   ;;
   { if ((&szCb.init)->dbgMask & (0x00000004)) { snprintf((&szCb.init)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->procId, (&szCb.init)->ent, (&szCb.init)->inst,
                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/s1ap/sz_ui.c"
   ,
                                                                 174
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztBndReq(pst, suId(%d), spId(%d))\n", suId, spId); SPrint((&szCb.init)->prntBuf); } }
                                                                  ;
   ...
   (Void) SzUiSztBndCfm(&uSapCb->pst, suId, 1);
   return(0);
}
 S16 SzUiSztUbndReq
(
...

{
   ...
   ,
                                                                     374
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztUbndReq(pst, spId(%d), reason(%d))\n", spId, reason); SPrint((&szCb.init)->prntBuf); } }
                                                                      ;

   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                                380
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztUbndReq: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                 ;
   ...
   ret = szUbndSztSap (uSapCb->spId, 2);
...

{
   ...
   ,
                                                 458
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztUDatReq(pst, spId(%d))\n", spId); SPrint((&szCb.init)->prntBuf); } }
                                                  ;
   ...
   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                                465
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztUDatReq: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                 ;

      { if (uDatEvnt->pdu != 0L) { cmFreeMem ((Ptr)(uDatEvnt->pdu)); uDatEvnt->pdu = 0L; } };
      return(1);
   }
   ...
   if(ret != 0)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 12; _errInd.causeValue = (U8)uDatEvnt->peerId.val; _errInd.transId.pres = 1; _errInd.transId.val = uDatEvnt->transId.val; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                             ;
      { if (uDatEvnt->pdu != 0L) { cmFreeMem ((Ptr)(uDatEvnt->pdu)); uDatEvnt->pdu = 0L; } };
      return(ret);
   }
      ...
      switch (cause)
      {
         case 11:
         {
            ...
            ,
                                                  ...
                                                  518
            ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztUDatReq : Node is not in valid state                   to receive message from user\n"); SPrint((&szCb.init)->prntBuf); } }

                                                   ;

            { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 11; _errInd.causeValue = (U8)spId; _errInd.transId.pres = 1; _errInd.transId.val = uDatEvnt->transId.val; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                  ;
            { if (uDatEvnt->pdu != 0L) { cmFreeMem ((Ptr)(uDatEvnt->pdu)); uDatEvnt->pdu = 0L; } };
            break;
         }
         case 9:
         {
            ...
            ,
                                              ...
                                              530
            ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztUDatReq :Failed to encode and                      send data to the peer\n"); SPrint((&szCb.init)->prntBuf); } }

                                               ;

            { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 9; _errInd.causeValue = (U8)uDatEvnt->peerId.val; _errInd.transId.pres = 1; _errInd.transId.val = uDatEvnt->transId.val; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
         ...
         case 7:
         {
            ...
            ,
                                                                                 542
            ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztUDatReq :Failed to encode : transfer syntax error\n"); SPrint((&szCb.init)->prntBuf); } }
                                                                                  ;

            { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 7; _errInd.causeValue = (U8)uDatEvnt->peerId.val; _errInd.transId.pres = 1; _errInd.transId.val = uDatEvnt->transId.val; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
         ...
         case 8:
         {
            ...
            ,
                                                                                 554
            ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztUDatReq :Failed to encode : abstract syntax error\n"); SPrint((&szCb.init)->prntBuf); } }
                                                                                  ;

            { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 8; _errInd.causeValue = (U8)uDatEvnt->peerId.val; _errInd.transId.pres = 1; _errInd.transId.val = uDatEvnt->transId.val; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
         ...
         case 1:
         {
            ...
            { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 1; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = uDatEvnt->transId.val; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                               ;
            { if (uDatEvnt->pdu != 0L) { cmFreeMem ((Ptr)(uDatEvnt->pdu)); uDatEvnt->pdu = 0L; } };
            return(1);
            break;
         ...
         case 18:
         {
            ...
            { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 18; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = uDatEvnt->transId.val; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                         ;
            { if (uDatEvnt->pdu != 0L) { cmFreeMem ((Ptr)(uDatEvnt->pdu)); uDatEvnt->pdu = 0L; } };
            return(1);
         }
         ...
         case 3:
         {
            ...
            { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 3; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = uDatEvnt->transId.val; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                      ;
            { if (uDatEvnt->pdu != 0L) { cmFreeMem ((Ptr)(uDatEvnt->pdu)); uDatEvnt->pdu = 0L; } };
            return(1);
         }
...

{
   ...
   ,
                                                674
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztConReq(pst, spId(%d))\n", spId); SPrint((&szCb.init)->prntBuf); } }
                                                 ;
   ...
   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                               681
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztConReq: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                ;

      if (conReq != 0L)
      {
         { if (conReq->pdu != 0L) { cmFreeMem ((Ptr)(conReq->pdu)); conReq->pdu = 0L; } };
      }
      return(1);
   }
   ...
   if(conReq == 0L)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 1; _errInd.causeValue = (U8)0; _errInd.transId.pres = 0; _errInd.transId.val = 0; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); };
      return(1);
   }
   ...
   if(ret != 0)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 12; _errInd.causeValue = (U8)conReq->peerId.val; _errInd.transId.pres = 1; _errInd.transId.val = conReq->u.suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                   ;
      { if (conReq->pdu != 0L) { cmFreeMem ((Ptr)(conReq->pdu)); conReq->pdu = 0L; } };
   ...
   if(peer->state == 1)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 2; _errInd.causeValue = (U8)peer->state; _errInd.transId.pres = 1; _errInd.transId.val = conReq->u.suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                            ;
      { if (conReq->pdu != 0L) { cmFreeMem ((Ptr)(conReq->pdu)); conReq->pdu = 0L; } };
   ...
   if(peer->skipUeSm)
   {
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 1; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = conReq->u.suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                 ;
      { if (conReq->pdu != 0L) { cmFreeMem ((Ptr)(conReq->pdu)); conReq->pdu = 0L; } };
   ...
   ret = szValidateSdus(conReq->pdu, 1, &evnt);
   if (ret != 0)
   {
   ...
   if ((U32)szCb.genSts.nmbConn >= szCb.genCfg.nmbConn)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 3; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = conReq->u.suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                              ;
      { if (conReq->pdu != 0L) { cmFreeMem ((Ptr)(conReq->pdu)); conReq->pdu = 0L; } };
      ...
      ,
                                                                                                        758
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztConReq:             nmbConn (%ld) exceeds the configured maximum, discarding the ConReq ", szCb.genSts.nmbConn); SPrint((&szCb.init)->prntBuf); } }
                                                                                                         ;
   ...
   ret = cmHashListFind(&uSapCb->suConnLst, (U8 *)&conReq->u.suConnId,
                        sizeof (UConnId), 0, (U32 *)&conCb);

   if(ret == 0)
   {

      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 4; _errInd.causeValue = (U8)conReq->u.suConnId; _errInd.transId.pres = 1; _errInd.transId.val = conReq->u.suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                          ;
   ...
   if (peer->nodeType == 1)
   {
      szGetIE(&(conReq->pdu->pdu), 8, &eNbId);
      if(eNbId == 0L)
      {

         { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 18; _errInd.causeValue = (U8)6; _errInd.transId.pres = 1; _errInd.transId.val = conReq->u.suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                      ;
         { if (conReq->pdu != 0L) { cmFreeMem ((Ptr)(conReq->pdu)); conReq->pdu = 0L; } };
         return(1);
      }
   ...
   if ((ret = szNdbAllocConCb(&conCb, peer)) != 0)
   {
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 3; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = conReq->u.suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                              ;
      { if (conReq->pdu != 0L) { cmFreeMem ((Ptr)(conReq->pdu)); conReq->pdu = 0L; } };
   ...
   ret = cmHashListInsert (&uSapCb->suConnLst, (U32)conCb,
                           (U8 *)&conCb->cd.suConnId, sizeof (UConnId));
   if (ret != 0)
   {
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 15; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = conReq->u.suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                             ;
      { if (conReq->pdu != 0L) { cmFreeMem ((Ptr)(conReq->pdu)); conReq->pdu = 0L; } };
      return(ret);
   }
   ...
   szSmExcMt(conCb, peer, conReq->pdu, evnt, 1);
...

{
   ...
   ,
                                                907
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztConRsp(pst, spId(%d))\n", spId); SPrint((&szCb.init)->prntBuf); } }
                                                 ;
   ...
   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                               914
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztConRsp: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                ;

      if (conRsp != 0L)
      {
         { if (conRsp->pdu != 0L) { cmFreeMem ((Ptr)(conRsp->pdu)); conRsp->pdu = 0L; } };
      }
      return(1);
   }
   ...
   ret = szValidateSdus(conRsp->pdu, 2, &evnt);
   ...
   if (ret != 0)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 1; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = conRsp->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                         ;
      { if (conRsp->pdu != 0L) { cmFreeMem ((Ptr)(conRsp->pdu)); conRsp->pdu = 0L; } };
      return(1);
   }
   ...
   if(ret == 0)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 4; _errInd.causeValue = (U8)conRsp->suConnId; _errInd.transId.pres = 1; _errInd.transId.val = conRsp->suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                        ;
      { if (conRsp->pdu != 0L) { cmFreeMem ((Ptr)(conRsp->pdu)); conRsp->pdu = 0L; } };
   ...
   if ((ret = szNdbGetConCb(conRsp->spConnId, &conCb)) != 0)
   {

      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 4; _errInd.causeValue = (U8)conRsp->spConnId; _errInd.transId.pres = 1; _errInd.transId.val = conRsp->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                        ;
      { if (conRsp->pdu != 0L) { cmFreeMem ((Ptr)(conRsp->pdu)); conRsp->pdu = 0L; } };
      return(ret);
   }
   ...
   szGetIE(&(conRsp->pdu->pdu), 8, &eNbId);
   szGetIE(&(conRsp->pdu->pdu), 0, &mmeS1apId);
   if((eNbId == 0L) || (mmeS1apId == 0L))
   {

      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 18; _errInd.causeValue = (U8)6; _errInd.transId.pres = 1; _errInd.transId.val = conCb->cd.spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                   ;
      { if (conRsp->pdu != 0L) { cmFreeMem ((Ptr)(conRsp->pdu)); conRsp->pdu = 0L; } };
      return(1);
   }
   ...
   if(peer->state == 1)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 2; _errInd.causeValue = (U8)peer->state; _errInd.transId.pres = 1; _errInd.transId.val = conRsp->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                            ;
      { if (conRsp->pdu != 0L) { cmFreeMem ((Ptr)(conRsp->pdu)); conRsp->pdu = 0L; } };
   ...
   conCb->cd.suConnId = conRsp->suConnId;
   ...
   if (ret != 0)
   {
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 15; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = conRsp->suConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                             ;
      { if (conRsp->pdu != 0L) { cmFreeMem ((Ptr)(conRsp->pdu)); conRsp->pdu = 0L; } };
      return(ret);
   }

   szSmExcMt(conCb, peer, conRsp->pdu, evnt, 1);
...

{
   ...
   ,
                                                1084
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztRelReq(pst, spId(%d))\n", spId); SPrint((&szCb.init)->prntBuf); } }
                                                 ;
   ...
   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                               1091
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztRelReq: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                ;

      if (relReq != 0L)
      {
         { if (relReq->pdu != 0L) { cmFreeMem ((Ptr)(relReq->pdu)); relReq->pdu = 0L; } };
      }
      return(1);
   }
   ...
   if (ret != 0)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 4; _errInd.causeValue = (U8)relReq->connId; _errInd.transId.pres = 1; _errInd.transId.val = relReq->connId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                   ;
      { if (relReq->pdu != 0L) { cmFreeMem ((Ptr)(relReq->pdu)); relReq->pdu = 0L; } };
   ...
   if(peer->state == 1)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 2; _errInd.causeValue = (U8)peer->state; _errInd.transId.pres = 1; _errInd.transId.val = relReq->connId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                    ;
      { if (relReq->pdu != 0L) { cmFreeMem ((Ptr)(relReq->pdu)); relReq->pdu = 0L; } };
      return(1);
   }
   ...
   { cmMemset((U8*)&relCfm, 0, sizeof(SztRelCfm)); };
   ...
   else
   {
      ...
      ret = szValidateSdus(relReq->pdu, 3, &evnt);
      if (ret != 0)
      {

           { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 1; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = relReq->connId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                           ;
      { if (relReq->pdu != 0L) { cmFreeMem ((Ptr)(relReq->pdu)); relReq->pdu = 0L; } };
           return(1);
      }

      szSmExcMt(conCb, peer, relReq->pdu, evnt, 1);
   }
...

{
   ...
   ,
                                                1267
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztRelRsp(pst, spId(%d))\n", spId); SPrint((&szCb.init)->prntBuf); } }
                                                 ;
   ...
   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                               1273
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztRelRsp: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                ;

      if (relRsp != 0L)
      {
         { if (relRsp->pdu != 0L) { cmFreeMem ((Ptr)(relRsp->pdu)); relRsp->pdu = 0L; } };
      }
      return(1);
   }
   ...
   ret = szValidateSdus(relRsp->pdu, 4, &evnt);
   if (ret != 0)
   {

      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 1; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = relRsp->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                 ;
      { if (relRsp->pdu != 0L) { cmFreeMem ((Ptr)(relRsp->pdu)); relRsp->pdu = 0L; } };
      return(1);
   }
   ...
   if ((ret = szNdbGetConCb(relRsp->spConnId, &conCb)) != 0)
   {

      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 4; _errInd.causeValue = (U8)relRsp->spConnId; _errInd.transId.pres = 1; _errInd.transId.val = relRsp->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                        ;
      { if (relRsp->pdu != 0L) { cmFreeMem ((Ptr)(relRsp->pdu)); relRsp->pdu = 0L; } };
      return(ret);
   }
   ...
   if(peer->state == 1)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 2; _errInd.causeValue = (U8)peer->state; _errInd.transId.pres = 1; _errInd.transId.val = relRsp->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                            ;
      { if (relRsp->pdu != 0L) { cmFreeMem ((Ptr)(relRsp->pdu)); relRsp->pdu = 0L; } };
   ...
   szSmExcMt(conCb, peer, relRsp->pdu, evnt, 1);
...

{
   ...
   ,
                                                1407
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztDatReq(pst, spId(%d))\n", spId); SPrint((&szCb.init)->prntBuf); } }
                                                 ;
   ...
   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                               1413
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztDatReq: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                ;

      if (datEvnt != 0L)
      {
        { if (datEvnt->pdu != 0L) { cmFreeMem ((Ptr)(datEvnt->pdu)); datEvnt->pdu = 0L; } };
      }
      return(1);
   }

   if ((datEvnt == 0L) || (datEvnt->pdu == 0L))
   {
   ...
   ret = szValidateSdus(datEvnt->pdu, 5, &evnt);

   if (ret != 0)
   {

      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 1; _errInd.causeValue = (U8)0; _errInd.transId.pres = 1; _errInd.transId.val = datEvnt->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                         ;
      { if (datEvnt->pdu != 0L) { cmFreeMem ((Ptr)(datEvnt->pdu)); datEvnt->pdu = 0L; } };
      return(1);
   }
   ...
   if ((ret = szNdbGetConCb(datEvnt->spConnId, &conCb)) != 0)
   {

      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 4; _errInd.causeValue = (U8)datEvnt->spConnId; _errInd.transId.pres = 1; _errInd.transId.val = datEvnt->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                 ;
      { if (datEvnt->pdu != 0L) { cmFreeMem ((Ptr)(datEvnt->pdu)); datEvnt->pdu = 0L; } };
      return(ret);
   }
   ...
   szGetIE(&(datEvnt->pdu->pdu), 8, &eNbId);
   szGetIE(&(datEvnt->pdu->pdu), 0, &mmeS1apId);
   if((eNbId == 0L) || (mmeS1apId == 0L))
   {
   ...
   if(peer->nodeType == 1)
   {
      if((((SztENB_UE_S1AP_ID *)eNbId)->val) != conCb->lclConRefNo)
      {
         ...
         { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 4; _errInd.causeValue = (U8)((SztENB_UE_S1AP_ID *)eNbId)->val; _errInd.transId.pres = 1; _errInd.transId.val = datEvnt->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                                         ;
         { if (datEvnt->pdu != 0L) { cmFreeMem ((Ptr)(datEvnt->pdu)); datEvnt->pdu = 0L; } };
   ...
   if(peer->state == 1)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 2; _errInd.causeValue = (U8)peer->state; _errInd.transId.pres = 1; _errInd.transId.val = datEvnt->spConnId; SzUiSztErrInd (&uSapCb->pst, uSapCb->suId, &_errInd); }
                                                                    ;
      { if (datEvnt->pdu != 0L) { cmFreeMem ((Ptr)(datEvnt->pdu)); datEvnt->pdu = 0L; } };
   ...
   szSmExcMt(conCb, peer, datEvnt->pdu, evnt, 1);

   return(0);

}
 S16 SzUiSztEncDecReq
(
Pst *pst,
SpId spId,
...

{
   ...
   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                                  1587
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztEncDecReq: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                   ;

      if (sztEncDecEvnt != 0L)
      {
         if (sztEncDecEvnt->type.val == 2 || sztEncDecEvnt->type.val == 1)
         {
            { if (sztEncDecEvnt->u.pdu != 0L) { cmFreeMem ((Ptr)(sztEncDecEvnt->u.pdu)); sztEncDecEvnt->u.pdu = 0L; } };
         }


         else
         {
            { if (sztEncDecEvnt->u.iePdu != 0L) { cmFreeMem ((Ptr)(sztEncDecEvnt->u.iePdu)); sztEncDecEvnt->u.iePdu = 0L; } };
         }
   ...
   if ((sztEncDecEvnt == 0L) || (sztEncDecEvnt->type.pres != 1))
   {
      status.status = 1;
      status.cause = 1;
   ...
   if (sztEncDecEvnt->type.val == 2 || sztEncDecEvnt->type.val == 4)
   {
      if (sztEncDecEvnt->u.mBuf != 0L)
      {
         SFndLenMsg (sztEncDecEvnt->u.mBuf, &msgLen);
      }

      if(sztEncDecEvnt->u.mBuf == 0L || msgLen == 0)
      {
         status.status = 1;
         status.cause = 1;
      ...
      if (sztEncDecEvnt->type.val == 2)
      {
         ret = szDecode(&mem, &asnErr, &(tempEncDecEvnt.u.pdu), &(sztEncDecEvnt->u.mBuf));
         { if (sztEncDecEvnt->u.mBuf != 0L) { SPutMsg (sztEncDecEvnt->u.mBuf); sztEncDecEvnt->u.mBuf = 0L; } };
      }
   ...
   else if (sztEncDecEvnt->type.val == 1 || sztEncDecEvnt->type.val == 3)
   {
      if (sztEncDecEvnt->type.val == 1)
      {
...

{
   ...
   ,
                                                1809
   ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztAudReq(pst, spId(%d))\n", spId); SPrint((&szCb.init)->prntBuf); } }
                                                 ;
   ...
   if(szUiGetAndChkSztSap(spId, &uSapCb) != 0)
   {
      ...
      ,
                                               1816
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztAudReq: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                ;
   ...
   if(audEvnt == 0L)
   {
      ...
      ,
                                                       1825
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztAudReq: No Audit Event Present \n"); SPrint((&szCb.init)->prntBuf); } }
                                                        ;
   ...
   switch(audEvnt->type)
   {
      ...
      case 2:
      {
         if (szUiDoAudit(&audCfm, uSapCb, &cause) != 0)
         {
      ...
      case 3:
      {
         ...
         if(szNdbChkPeer(peerId,&peer) != 0)
         {
            audCfm.status.status = 1;
            audCfm.status.cause = 12;
         ...
         if(peer->assocCb == 0L ||
            peer->assocCb->assocState != 1)
         {
            audCfm.status.status = 1;
            audCfm.status.cause = 14;
...

{
   ...
   if(szUiGetAndChkSztSap(spId, &sapCb) != 0)
   {
      ...
      ,
                                                   1991
      ); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzUiSztAbortS1Req: Invalid SZT sap\n"); SPrint((&szCb.init)->prntBuf); } }
                                                    ;
   ...
   if(abortS1 == 0L)
   {
      ...
      { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) 1; _errInd.causeValue = (U8)0; _errInd.transId.pres = 0; _errInd.transId.val = 0; SzUiSztErrInd (&sapCb->pst, sapCb->suId, &_errInd); };
      return(1);
   }

   abortS1->abortS1Cfm.status = 0;
   abortS1->abortS1Cfm.reason = 6;
   ...
   if (ret != 0)
   {
      ...
      abortS1->abortS1Cfm.status = 1;
      abortS1->abortS1Cfm.reason = 12;

      SzUiSztAbortS1Cfm(&sapCb->pst, sapCb->suId, abortS1);
      return(ret);
   }

   if ((peerCb->state == 4) && (peerCb->assocCb->assocState == 0))
   {
      SzUiSztAbortS1Cfm(&sapCb->pst, sapCb->suId, abortS1);
      return(ret);
   }
   ...
   { if (peerCb->setupReq != 0L) { cmFreeMem ((Ptr)(peerCb->setupReq)); peerCb->setupReq = 0L; } };
...

{
   ...
   { if (conCb != 0L) { peer->peerSts.cfm.szDedProcSts.rx++; peer->sctSapCb->sts.cfm.szDedProcSts.rx++; } else { peer->peerSts.cfm.szComProcSts.rx++; peer->sctSapCb->sts.cfm.szComProcSts.rx++; } };
...

{
   ...
   if (sapCb->state != 2)
   {
      ...
      { if (conCfm->pdu != 0L) { cmFreeMem ((Ptr)(conCfm->pdu)); conCfm->pdu = 0L; } };
      return(1);
   }
...

{
   ...
   if (sapCb->state != 2)
   {
      ...
      { if (uDatEvn->pdu != 0L) { cmFreeMem ((Ptr)(uDatEvn->pdu)); uDatEvn->pdu = 0L; } };
      return(1);
   }



   { if (0L != 0L) { peerCb->peerSts.cfm.szDedProcSts.rx++; peerCb->sctSapCb->sts.cfm.szDedProcSts.rx++; } else { peerCb->peerSts.cfm.szComProcSts.rx++; peerCb->sctSapCb->sts.cfm.szComProcSts.rx++; } };
...

{
   ...
   if (sapCb->state != 2)
   {
      ...
      { if (relInd->pdu != 0L) { cmFreeMem ((Ptr)(relInd->pdu)); relInd->pdu = 0L; } };
      return(1);
   }
...

{
   ...
   if (sapCb->state != 2)
   {
      ...
      { if (relCfm->pdu != 0L) { cmFreeMem ((Ptr)(relCfm->pdu)); relCfm->pdu = 0L; } };
      return(1);
   }
...
static S16 szUiGetAndChkSztSap
(
SpId spId,
SzSztSapCb **uSapCb
)
   ...
   *cause = 6;
   ...
   switch(audit->type)
   {
      case 1:
      {
         ...
         {
            audit->u.audConn.connSt[loopCnt].state = 0xF;

            if (audit->u.audConn.connIdType == 1)
            {
            ...
            if(audit->u.audConn.connSt[loopCnt].state != 0xF)
            {
