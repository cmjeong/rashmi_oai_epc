...
static S16 rgTOMProcCrntiCEInDatInd ( RgMacPdu *pdu, RgUeCb *prevUeCb, RgCellCb *cellCb, TfuDatInfo *datInfo, RgInfCeInfo *ceInfo, U8 subframe )
...
static S16 rgTOMProcCCCHSduInDatInd ( RgMacPdu *pdu, RgUeCb *prevUeCb, RgCellCb *cellCb, TfuDatInfo *datInfo, RgInfCeInfo *ceInfo, U8 subframe )
...
{
   S16 ret;
   TfuDatReqPduInfo *datReq=0L;

   RgDlHqProcCb *hqCb;
   U8 idx;
   Inst inst = cellCb->macInst - 0;
   ...
   if (dlSf->bcch.tb != 0L)
   {
      if ((ret = rgGetEventMem(inst,(Ptr *)&datReq, sizeof(TfuDatReqPduInfo),
                                &(datInfo->memCp))) != 0)
      {
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0001,L_ERROR,DBG_CELLID, cellCb->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",211, "Memory Exhaustion ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(ret);
      }
   ...
   if (dlSf->pcch.tb != 0L)
   {
      ...
      {
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0002,L_ERROR,DBG_CELLID, cellCb->cellId,datReq->rnti, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",257, "Memory Exhaustion CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(ret);
      }
   ...
   for(idx=0; idx < dlSf->numRaRsp; idx++)
   {
      ...
      {
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0003,L_ERROR,DBG_CELLID, cellCb->cellId, datReq->rnti, 0, 0, 0,                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"         ,                297         , "Memory Exhaustion CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                 ;
         return(ret);
      }
   ...
   if (dlSf->tbs.count != 0)
   {
      ...
      while (dlSf->tbs.first)
      {
         ...
         if ((ret = rgDHMSndDatReq (cellCb, dlSf, datInfo, hqCb, err)) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0004,L_ERROR,DBG_CELLID, cellCb->cellId, 0, 0, 0, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"            ,                                        342            , "DHM unable to fill DATA request", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
            err->errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 6);
            continue;
         }
      }
   }
...

{
   ...
   if ((ret = rgAllocEventMem(inst,(Ptr *)&datInfo,
                            sizeof(TfuDatReqInfo))) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0005,L_ERROR,DBG_CELLID, cellCb->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",409, "Unable to Allocate TfuDatReqInfo", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(ret);
   }
   else
   {
      ...
      if ((dlSf->schdTime.subframe + 2) > (10 - 1)) datInfo->timingInfo.sfn = (dlSf->schdTime.sfn + 1) % 1024; else datInfo->timingInfo.sfn = dlSf->schdTime.sfn; datInfo->timingInfo.subframe = (dlSf->schdTime.subframe + 2) % 10;;
      ...
      if (dlSf->bch.tb != 0L)
      {
         datInfo->bchDat.pres = 1;
         datInfo->bchDat.val = dlSf->bch.tb;
         dlSf->bch.tb = 0L;
      }

      if ((ret = rgTOMUtlFillDatReqPdus(datInfo, dlSf, cellCb, err)) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0006,L_ERROR,DBG_CELLID, cellCb->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",435, "Unable to send data for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { if (0L != (datInfo)) { cmFreeMem((datInfo)); datInfo = 0L; } };
         return(ret);
      }
      if((datInfo->pdus.count) || (datInfo->bchDat.pres == 1))
      {

         if (rgLIMTfuDatReq(inst,datInfo) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0007,L_ERROR,DBG_CELLID, cellCb->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",444, "Unable to send data info for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         }
      }
      else
      {
...

{
      ...
      ||(cellCb->cellId != ttiInd->cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0008,L_ERROR,DBG_CELLID, ttiInd->cellId, 0, 0, 0, 0,                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"      ,                                     534      , "Unable to get the cellCb for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                      ;
      err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 6);
      err.errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1;
      return(1);
   }
   cellCb->crntTime.sfn = ttiInd->timingInfo.sfn; cellCb->crntTime.subframe = ttiInd->timingInfo.subframe;;
   rgMacGT = ttiInd->timingInfo.sfn * 10 + ttiInd->timingInfo.subframe;
   { if (ttiInd->timingInfo.sfn == 0) { if ((ttiInd->timingInfo.subframe - (1)) < 0) { prevTmInfo.sfn = 1024 - 1; } else { prevTmInfo.sfn = ttiInd->timingInfo.sfn; } } else { if ((ttiInd->timingInfo.subframe - (1)) < 0) { prevTmInfo.sfn = ttiInd->timingInfo.sfn - 1; } else prevTmInfo.sfn = ttiInd->timingInfo.sfn; } prevTmInfo.subframe = (10 + ttiInd->timingInfo.subframe - (1)) % (10); };
   prevDlSf = &cellCb->subFrms[prevTmInfo.subframe];
   if(0 == prevDlSf->txDone)
   {
      if (0 != rgTOMUtlProcDlSf (prevDlSf, cellCb, &err))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0009,L_ERROR,DBG_CELLID, cellCb->cellId, 0, 0, 0, 0,                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"         ,                                       564         , "Unable to process " "previous downlink subframe for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                        ;
         err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 6);
      }
   ...
   if((dlSf->txDone == 1) ||
      (!((ttiInd->timingInfo.sfn == dlSf->schdTime.sfn) && (ttiInd->timingInfo.subframe == dlSf->schdTime.subframe))))
   {
   ...
   if (0 != rgTOMUtlProcDlSf (dlSf, cellCb, &err))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed000a,L_ERROR,DBG_CELLID, ttiInd->cellId, 0, 0, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"      ,                                                      650      , "Unable to process downlink subframe for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
      err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 6);
   }
...

{
   ...
   SStartTask(&startTime, 30224);





   if (cmAllocEvnt (sizeof (RgMacPdu), 1500, &evntMem, (Ptr*)pdu) != 0)
   {
      rgFillDgnParams(inst,&dgn, 1);
      rgLMMStaInd(inst,4, 13,
                                       15, &dgn);
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xed000b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",714, "Allocation of DUX event failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }


   SStopTask(startTime, 30224);
...

{
   ...
   if ((error == 1) && (pdu->sduLst.count > 0))
   {
      node = pdu->sduLst.first;
      while (node)
      {
         sdu = (RgMacSdu*)node->node;
         { if (0L != (sdu->mBuf)) { SPutMsg((sdu->mBuf)); sdu->mBuf = 0L; } };
         node = node->next;
      }
   }
   { if (0L != (pdu)) { cmFreeMem((pdu)); pdu = 0L; } };
   return;
}
...

{
   ...
   SStartTask(&startTime, 30225);




   if (cmAllocEvnt (sizeof (RgInfSfDatInd), 1500, &evntMem, (Ptr*)sfInfo) != 0)
   {
      rgFillDgnParams(inst,&dgn, 1);
      rgLMMStaInd(inst,4, 13,
                                       15, &dgn);
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xed000c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",822, "Allocation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }


   SStopTask(startTime, 30225);
...

{
   ...
   { if (0L != (sfInfo)) { cmFreeMem((sfInfo)); sfInfo = 0L; } };
   return;
}
 RgUeCb *glblueCb4;
 RgUeCb *glblueCb5;
 ...
 )
{
   ...
   glblueCb4 = ueCb;
      if ((sdu->lcId == 0x00))
      {
         ...
         if ((ret = rgAllocShrablSBuf (inst,(Data**)&cDatInd, sizeof(RgRguCmnDatInd))) != 0)
         {
            return(1);
         }
         ...
         if (ccchSz >= 6)
         {
            SCpyMsgFix (sdu->mBuf, (MsgLen)0, 6, ueCb->contResId.resId,
                        &cpySz);
         }
         sdu->mBuf = 0L;
      ...
      if ((ret = rgAllocShrablSBuf (inst,(Data**)&dDatInd, sizeof(RgRguDedDatInd))) != 0)
      {
         return(1);
      }
   ...
   while (node)
   {
      ...
      if(ulLcCb == 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed000d,L_ERROR,DBG_CELLID, cellCb->cellId,sdu->lcId, ueCb->ueId, 0, 0,                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"         ,                         1116         , "Unconfigured LCID:%d CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                          ;
      ...
      if (dDatInd->numLch >= 10)
      {
         if ((ret = rgUIMSndDedDatInd(inst,ueCb->rguUlSap,dDatInd)) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed000e,L_ERROR,DBG_CELLID, cellCb->cellId,ueCb->ueId, 0, 0, 0,                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"            ,                                                           1148            , "Failed to send datIndication to RGU CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                            ;
            return(ret);
         }
      ...
      if (ueCb->ul.spsLcId[sdu->lcId-1] == 1)
      {
         ueCb->ul.spsDatRcvd++;
      }
   ...
   if((dDatInd) && (dDatInd->numLch))
   {
      ...
      if ((ret = rgUIMSndDedDatInd(inst,ueCb->rguUlSap,dDatInd)) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed000f,L_ERROR,DBG_CELLID, cellCb->cellId,ueCb->ueId, 0, 0, 0,                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"         ,                                                           1289         , "Failed to send datIndication to RGU CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                            ;
         return(ret);
      }
   }
...
)
{
   ...
   { ret = cmGetMem((Ptr)&sfInfo->memCp, sizeof(RgInfUeDatInd), (Ptr *)&ueInfo); };
   ...
   ueInfo->ueLstEnt.node = (U32)ueInfo;
   for (lcgId = 1, idx = 0; lcgId < 4; lcgId++)
   {
      if (lcgBytes[lcgId] != 0)
      {
...

{
      ...
      (cellCb->cellId != datInd->cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0010,L_ERROR,DBG_CELLID, datInd->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",1489, "Unable to get the cellCb for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }


   if (rgTOMInfAllocPduEvnt (inst,&sfInfo) != 0)
   {
      err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0011,L_ERROR,DBG_CELLID, datInd->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",1497, "Unable to Allocate PDU for DUX cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for (;node; node=node->next)
   {
      ...
      if (rgTOMUtlAllocPduEvnt (inst,&pdu) != 0)
      {
         err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0012,L_ERROR,DBG_CELLID, datInd->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",1526, "Unable to Allocate PDU for DUX cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                           ...
                           &datInfo->mBuf, &err)) != 0)
      {
         ...
         rgTOMUtlFreePduEvnt (pdu, 1);
         err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0013,L_ERROR,DBG_CELLID, datInd->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",1537, "DUX processing failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      else
      {
         ...
         if (ueCb == 0L)
         {
...

            {
               ...
               rgTOMUtlFreePduEvnt (pdu, 1);
               err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0014,L_ERROR,DBG_CELLID, datInd->cellId, datInfo->rnti, 0, 0, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"               ,                               1615               , "RNTI:%d Unable to get the UE CB", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;
               tfuSap->sapSts.numPduDrop++;
               continue;
            }
         ...
         if ((ret = rgTOMUtlProcMsg(cellCb, ueCb, pdu, isSpsRnti,&spsToBeActvtd,&sduSize, subframe, (U32 *)&lcgBytes)) != 0)
...

         {
            rgTOMUtlFreePduEvnt (pdu, 1);
            err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0015,L_ERROR,DBG_CELLID, datInd->cellId,ueCb->ueId, 0, 0, 0,                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"            ,                                                             1633            , "Unable to handle Data Indication CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                              ;
            tfuSap->sapSts.numPduDrop++;
            continue;
         }
      ...
      if(rgTOMUtlInsSchInfo(pdu, sfInfo, &ceInfo, datInfo->rnti,spsToBeActvtd,sduSize, (U32 *)&lcgBytes) != 0)
...

{
   ...
   if(cmnLcInfo->bitMask & (1<<0))
   {
      dlSf->bch.tb = cmnLcInfo->bchInfo.pdu;

   }

   if(cmnLcInfo->bitMask & (1<<2))
   {
      ...
      if (rgAllocShrablSBuf (inst,(Data**)&staInd, sizeof(RguCStaIndInfo)) != 0)
      {
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1;
         return(1);
      }
      ...
      if (rgUIMSndCmnStaInd (inst,cell->rguDlSap,staInd) != 0)
      {
         return(1);
      }
   }

   if(cmnLcInfo->bitMask & (1<<1))
   {
...

{
   ...
   if(dlSf->txDone == 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xed0016, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",2045, "SUBFRAME Not pushed to the PHY", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      if (dlSf->bch.tb != 0L)
      {
         { if (0L != (dlSf->bch.tb)) { SPutMsg((dlSf->bch.tb)); dlSf->bch.tb = 0L; } };
      }
      if (dlSf->bcch.tb != 0L)
      {
         { if (0L != (dlSf->bcch.tb)) { SPutMsg((dlSf->bcch.tb)); dlSf->bcch.tb = 0L; } };
      }
      if (dlSf->pcch.tb != 0L)
      {
         { if (0L != (dlSf->pcch.tb)) { SPutMsg((dlSf->pcch.tb)); dlSf->pcch.tb = 0L; } };
      }

      for(idx=0; idx < dlSf->numRaRsp; idx++)
      {
         { if (0L != (dlSf->raRsp[idx].rar)) { SPutMsg((dlSf->raRsp[idx].rar)); dlSf->raRsp[idx].rar = 0L; } };
      }
   }
  ...
  if (dlSf->tbs.count)
  {
      ...
      RgDlHqProcCb *hqP;
       { if ((&rgCb[inst].rgInit)->dbgMask & ((0x00000100 << 1))) { snprintf((&rgCb[inst].rgInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "MAC", (&rgCb[inst].rgInit)->procId, (&rgCb[inst].rgInit)->ent, (&rgCb[inst].rgInit)->inst,
                                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"
       ,
                                                          2078
       ); SPrint((&rgCb[inst].rgInit)->prntBuf); sprintf (rgCb[inst].rgInit.prntBuf, "Error Stale TBs in Subframes TBS list\n"); SPrint((&rgCb[inst].rgInit)->prntBuf); } }
                                                           ;
      node = dlSf->tbs.first;
    while(node)
    {
...

{
   ...
   RgUiRguFlowCntrlInd(pst, cell->rguDlSap->sapCfg.spId,flowCntrlInd);
   return(0);
}
...

{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0017,L_ERROR,DBG_CELLID, sfInfo->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",2225, "No cellCb found with cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if(!(dlSf->txDone) &&
        ...
        (((cell->crntTime.sfn == dlSf->schdTime.sfn) && (cell->crntTime.subframe == dlSf->schdTime.subframe))))
   {



      if (0 != rgTOMUtlProcDlSf (dlSf, cell, &err))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0018,L_ERROR,DBG_CELLID, cell->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c",2284, "Unable to process downlink subframe for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         err.errType = ((((0 + 11) + 1) + 1) + 1);
      }
...
)
{
   ...
   if (ueCb == 0L)
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0019,L_ERROR,DBG_CELLID, cellCb->cellId, ceInfo->ces.cRnti, 0, 0, 0,                                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"       ,                                                                           2368       , "RNTI:%d Received MSG3 with CRNTI,unable to find ueCb", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                            ;
       return(1);
   }
   ...
   if (prevUeCb == 0L)
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed001a,L_ERROR,DBG_CELLID, cellCb->cellId, ceInfo->ces.cRnti, 0, 0, 0,                                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"       ,                                                                            2376       , "RNTI:%d Received MSG3 with CRNTI,unable to find ueCb", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                             ;
       return(1);
   }
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed001b,L_DEBUG,DBG_CELLID, cellCb->cellId, ceInfo->ces.cRnti, datInfo->rnti, 0, 0,                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"   ,                                            2381   , "CRNTI CE(%d) received through tmpCrnti(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if ((rgTOMUtlProcMsg(cellCb, ueCb, pdu, 0,&spsToBeActvtd,&sduSize, subframe, 0L)) != 0)



   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed001c,L_ERROR,DBG_CELLID, cellCb->cellId,datInfo->rnti, 0, 0, 0,                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"       ,                                                           2392       , "RNTI:%d Processing for MSG3 failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                            ;
       return(1);
   }
   return(0);
...
)
{
   ...
   if (ceInfo->bitMask & (1<<1))
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed001d,L_ERROR,DBG_CELLID, cellCb->cellId,ceInfo->ces.cRnti, 0, 0, 0,                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"       ,                                                             2468       , "CRNTI:%d Received MSG3 with CCCH", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                              ;
       return(1);
   }
   ...
   if (ueCb == 0L)
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed001e,L_ERROR,DBG_CELLID, cellCb->cellId, datInfo->rnti, 0, 0, 0,                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"       ,                                                            2477       , "RNTI:%d Processing for MSG3 failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                             ;
       return(1);
   }
   ...
   if (ueCb->dl.hqEnt.numHqProcs)
   {
       ...
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed001f,L_ERROR,DBG_CELLID, cellCb->cellId, datInfo->rnti, 0, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"       ,                                                  2485       , "RNTI:%d Processing for MSG3 failed. Duplicate " "MSG3 received. Dropping", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                   ;
       return(1);
   }

   if(rgDHMHqEntInit(inst,&ueCb->dl.hqEnt,
                     cellCb->maxDlHqProcPerUe) != 0)
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0020,L_ERROR,DBG_CELLID, cellCb->cellId, datInfo->rnti, 0, 0, 0,                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"       ,                       2493       , "RNTI:%d Harq Initialization failed ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                        ;
       return(1);
   }
    if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0021,L_DEBUG,DBG_CELLID, cellCb->cellId,datInfo->rnti, 0, 0, 0,                                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"    ,                                                                   2497    , "CCCH SDU received through tmpCrnti(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                    ;
   ...
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xed0022,L_ERROR,DBG_CELLID, cellCb->cellId, datInfo->rnti, 0, 0, 0,                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_tom.c"       ,                       2505       , "RNTI:%d Processing for MSG3 failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                        ;
       return(1);
   }
   return(0);
