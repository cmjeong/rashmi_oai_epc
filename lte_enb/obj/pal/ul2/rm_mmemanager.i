...
LrmCause CMMEManger::addMME(LrmMmeCfg & stMmeCfg)
{
   ...
   {
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xa10001, L_WARNING,stMmeCfg.usMmeId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp",57, "MME [%d] : Already exist in RRM", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xa10002, L_ALWAYS, stMmeCb.usMmeId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp",66, "New MME added: MME ID: %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...
RmuMmeOvldStatus CMMEManger::upMME(U16 usMmeId)
{
   ...
   {
      if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0xa10003, L_ALWAYS, stMmeCb.usMmeId, stMmeCb.enMmeOvldStatus, m_bActiveMmesCnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp"      , 89      , "MME ID: %d is already UP status:%ld MME count=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                       ;
      return m_enMMEOverloadStatus;
   }
   ...
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xa10004, L_ALWAYS, stMmeCb.usMmeId, m_bActiveMmesCnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp"   , 99   , "MME UP: MME ID: %d Active MME count: %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
...
RmuMmeOvldStatus CMMEManger::downMME(U16 usMmeId)
{
   ...
   {
      if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0xa10005, L_ALWAYS, stMmeCb.usMmeId, stMmeCb.enMmeOvldStatus, m_bActiveMmesCnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp"      , 119      , "MME ID: %d is already down status:%ld MME count=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                       ;
      return m_enMMEOverloadStatus;
   }
   ...
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xa10006, L_ALWAYS, stMmeCb.usMmeId, m_bActiveMmesCnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp"   , 134   , "MME DOWN: MME ID: %d Active MME count=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
   return updateMMEOverloadStatus();
}
...
LrmCause CMMEManger::deleteMME(LrmMmeCfg & stMmeCfg)
{
   ...
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xa10007, L_ALWAYS, stMmeCfg.usMmeId, m_bActiveMmesCnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp"   , 158   , "MME deleted: MME ID: %d Active MME count: %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                            ;
   return LRM_CAUSE_NOT_APP;
}
...
RmuMmeOvldStatus CMMEManger::handleMMEOvldStart(RmuMmeOvldStartInd & stMmeOvldStrtInd)
{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0xa10008, L_INFO, stMmeCb.usMmeId, stMmeCb.enMmeOvldStatus, m_bOverloadedMmesCnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp"   , 189   , "Overload Start: MME ID: %d OverloadAction: %d " "Overload MME count: %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
RmuMmeOvldStatus CMMEManger::handleMmeOverloadStop(RmuMmeOvldStopInd & stMmeOvldStopInd)
{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xa10009, L_INFO, stMmeCb.usMmeId, m_bOverloadedMmesCnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_mmemanager.cpp"   , 212   , "Overload Stop: MME ID: %d Overload MME count: %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                               ;
