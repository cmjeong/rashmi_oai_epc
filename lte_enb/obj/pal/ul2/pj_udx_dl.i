...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe10001, L_DEBUG, spId, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",144, "PjDlUdxBndReq(pst, spId(%d), suId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   switch(udxSap->state)
   {
      ...
      case 4:
      {
         ...
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe10002, L_DEBUG, udxSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",164, "PjDlUdxBndReq: state (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
      }
      ...
      case 2:
      {
               ...
               || udxSap->suId != suId)
         {
            ...
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe10003, L_DEBUG, udxSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"            , 185            , "PjDlUdxBndReq: SAP already bound -- state(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
            ret = 1;
         }
         break;
     ...
     default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",193, "Invalid UDX DL SAP State in Bind Req", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
   }
   ...
   if (ret == 0)
   {
      PjDlUdxBndCfm(&(udxSap->pst), udxSap->suId, 1);
   }
   else
   {
      PjDlUdxBndCfm(&(udxSap->pst), udxSap->suId, 2);
   }
...

{
   ...
   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe10005, L_DEBUG, spId, reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",255, "PjDlUdxUbndReq(pst, spId(%d), reason(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe10006, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",314, "PjDlUdxUlStaRep(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(udxSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10007, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",323, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (staRep->sta != 0L) { SPutMsg(staRep->sta); } staRep->sta = 0L; };
      { if (staRep != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staRep, (Size) sizeof(UdxUlStaRepInfo), 0); staRep = 0L; } };
      return(1);
   }
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10008,L_ERROR,DBG_CELLID, staRep->pdcpId.cellId, staRep->pdcpId.ueId, 0, 0, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                               339      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;
      { if (staRep->sta != 0L) { SPutMsg(staRep->sta); } staRep->sta = 0L; };
      { if (staRep != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staRep, (Size) sizeof(UdxUlStaRepInfo), 0); staRep = 0L; } };
      return(ret);
   ...
   { tRbCb = (staRep->pdcpId.rbType==0)?ueCb->srbCb[staRep->pdcpId.rbId]:ueCb->drbCb[staRep->pdcpId.rbId];};


   if( 0L == tRbCb )
   {
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10009,L_WARNING,DBG_UEID, staRep->pdcpId.ueId, staRep->pdcpId.cellId, staRep->pdcpId.rbId, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                                      352      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
      { if (staRep->sta != 0L) { SPutMsg(staRep->sta); } staRep->sta = 0L; };
      { if (staRep != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staRep, (Size) sizeof(UdxUlStaRepInfo), 0); staRep = 0L; } };
      return(1);
   ...
   if (tRbCb->state != 1)
   {
      if (tRbCb->dlCb.staRep != 
                               ((void *)0)
                                   )
      {
        { if (tRbCb->dlCb.staRep != 0L) { SPutMsg(tRbCb->dlCb.staRep); } tRbCb->dlCb.staRep = 0L; };
      }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe1000a, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",424, "PjDlUdxDlStaRep(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(udxSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe1000b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",433, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (staRep->staPdu != 0L) { SPutMsg(staRep->staPdu); } staRep->staPdu = 0L; };
      { if (staRep != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staRep, (Size) sizeof(UdxDlStaRepInfo), 0); staRep = 0L; } };
      return(1);
   }
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe1000c,L_ERROR,DBG_CELLID, staRep->pdcpId.cellId, staRep->pdcpId.ueId, 0, 0, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                               449      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;
      { if (staRep->staPdu != 0L) { SPutMsg(staRep->staPdu); } staRep->staPdu = 0L; };
      { if (staRep != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staRep, (Size) sizeof(UdxDlStaRepInfo), 0); staRep = 0L; } };
      return(ret);
   ...
   if( 0L == tRbCb )
   {
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe1000d,L_WARNING,DBG_UEID, staRep->pdcpId.ueId, staRep->pdcpId.cellId, staRep->pdcpId.rbId, 0, 0,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                                      462      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                       ;
      { if (staRep->staPdu != 0L) { SPutMsg(staRep->staPdu); } staRep->staPdu = 0L; };
      { if (staRep != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staRep, (Size) sizeof(UdxDlStaRepInfo), 0); staRep = 0L; } };
      return(1);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe1000e, L_DEBUG, spId, cfg->transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"   , 541   , "PjDlUdxCfgReq(pst, spId(%d), TransId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
   ...
   { if(udxSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe1000f, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",551, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (cfg != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) cfg, (Size) sizeof(UdxCfgReqInfo), 0); cfg = 0L; } };
      return(1);
   }

   ret = 0;
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&cfgCfm, (Size) sizeof (UdxCfgCfmInfo), 0) != 0) { ret = 1; } }
                                  ;

    if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10010, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",565, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for (idx = 0; idx < cfg->numEnt && idx < 10; idx++)
   {
      UdxCfmEnt *entCfgCfm;
      UdxCfgEnt *entCfg;
              ...
              != ueCb)
      {
         ...
         { entCfgCfm->rbId = entCfg->rbId; entCfgCfm->rbType = entCfg->rbType; entCfgCfm->status = 1; entCfgCfm->reason = 0; }
                                 ;
      }
      else
      {
         if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10011,L_WARNING,DBG_CELLID, cfg->cellId, cfg->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"         ,                        592         , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
         { entCfgCfm->rbId = entCfg->rbId; entCfgCfm->rbType = entCfg->rbType; entCfgCfm->status = 2; entCfgCfm->reason = 7; }
                                  ;

         if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10012,L_WARNING,DBG_UEID, cfg->ueId,cfg->cellId, 0, 0, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"         ,                                                                             597         , "Dl RB Config Req- UE CB is not found for cellid (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                              ;
         if (entCfg->cfgType != 0x01)
         {
      ...
      switch (entCfg->cfgType)
      {
         case 0x01:
            {
               if (entCfg->m.addCfg.rlcInfo.dir & 2)
               {
                  U8 isHo;
                  ...
                  if (pjCfgAddDlRb(tPjCb,cfg->ueId, cfg->cellId, isHo,
                                     entCfg, &ueCb,entCfgCfm) != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10013,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"                     ,                                                                            620                     , "Dl Cfg RB Add Req" " for cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x02:
            {
               ...
               if ((entCfg->m.modCfg.bitFlag & 0x02) ||
                  ...
                  (entCfg->m.modCfg.hoInfo.isHoPres & 2))
               {
                  if (pjCfgReCfgDlRb(tPjCb,ueCb, entCfg, entCfgCfm) != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10014,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"                     ,                                                                            648                     , "Dl RB Modify Req" "for cellId(%d),rbId(%d) not done as RbCb not found: reason(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x03:
            {
               ...
               if (pjCfgDelDlRb(tPjCb, ueCb, entCfg, entCfgCfm) != 0)
               {
                  if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10015,L_WARNING,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"                  ,                                                                         671                  , "Dl RB Delete Req for" "for cellId(%d), rbId(%d) not done as RbCb not found: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x04:
            {
               if (pjCfgReEstDlRb(tPjCb, ueCb, entCfg, entCfgCfm) != 0)
               {
                   if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10016,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"                   ,                                                                           682                   , "Dl RB Re-establih Req" "for cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x05:
            {
               ...
               if (pjCfgDelDlUe(tPjCb, ueCb,entCfg, entCfgCfm) != 0)
               {

                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10017,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"                  ,                                                                           701                  , "Dl UE Delete Req for" "cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         default:
            {
               { entCfgCfm->rbId = entCfg->rbId; entCfgCfm->rbType = entCfg->rbType; entCfgCfm->status = 2; entCfgCfm->reason = 14; }
                                              ;

               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10018,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->cfgEnt[idx].rbId, 0,                                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"               ,                                                                        721               , "Dl Cfg Req with Invalid" "config type,cellId(%d),cfgType(%d),rbId(%d) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (cfmType != 0)
   {
      if (ueCb != 0L)
      {
         ...
         {
            pjUtlDlSaveCfmInfo(tPjCb, ueCb, cfmType, startTmr, 0xd8, (U32)cfgCfm, (U32)cfg);
            { if (cfgCfm != 0L) { (Void) SPutSBuf(udxSap->pst.region, udxSap->pst.pool, (Data *) cfgCfm, (Size) sizeof(UdxCfgCfmInfo)); cfgCfm = 0L; } };
         }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe10019, L_DEBUG, spId, transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",813, "PjDlUdxUeIdChgReq(pst, spId(%d), transId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(udxSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe1001a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",825, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (ueInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) ueInfo, (Size) sizeof(UdxUeInfo), 0); ueInfo = 0L; } };
      { if (newUeInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) newUeInfo, (Size) sizeof(UdxUeInfo), 0); newUeInfo = 0L; } };
      return(1);
   }
   ...
   if (pjCfgDlUeIdChng(tPjCb, ueInfo,
                   newUeInfo, &status) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe1001b,L_ERROR,DBG_UEID, ueInfo->ueId, ueInfo->ueId, newUeInfo->ueId, newUeInfo->cellId, status.reason,                                                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                                                            839      , "Dl UeId Change Req old-ueId(%d)," "new-ueId(%d), cellId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&tUeInfo, (Size) sizeof (UdxUeInfo), 0) != 0) { ret = 1; } }
                                ;
   if( ret != 0)
   {
      ...
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe1001c, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",853, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe1001d, L_DEBUG, spId, secCfg->transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"   , 915   , "PjDlUdxSecCfgReq(pst, spId(%d), TransId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                               ;
   ...
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&cfgCfm, (Size) sizeof (UdxSecCfgCfmInfo), 0) != 0) { ret = 1; } }
                                     ;
    if(ret != 0)
   {


      { if (secCfg != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) secCfg, (Size) sizeof(UdxSecCfgReqInfo), 0); secCfg = 0L; } };

      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe1001e, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",938, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if ( pjCfgPrcSecDlCfg(tPjCb,secCfg,
                            cfgCfm) != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe1001f,L_ERROR,DBG_UEID, secCfg->ueId, secCfg->cellId, cfgCfm->reason, 0, 0,                                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                                                  946      , " Dl Sec Cfg Req for cellId(%d)" " Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                   ;
   }
...

{
   ...
   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe10020, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1009, "PjDlUdxReEstReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   ret = 0;
   udxSap = &(tPjCb->u.dlCb->udxDlSap[0]);


   { if(udxSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10021, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1015, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (reEstReq != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) reEstReq, (Size) sizeof(UdxReEstReqInfo), 0); reEstReq = 0L; } };
      return(1);
   }
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&reEstCfm, (Size) sizeof (UdxReEstCfmInfo), 0) != 0) { ret = 1; } }
                                    ;
   if(ret != 0)
   {
      ...
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10022, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1030, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ( pjCfgDlReEstReq(tPjCb,(UdxReEstReqInfo *)reEstReq,
                              (UdxReEstCfmInfo *)reEstCfm) != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10023,L_ERROR,DBG_UEID, reEstReq->pdcpId.ueId, reEstReq->pdcpId.cellId, reEstCfm->status, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                                  1039      , "Dl Re-Est Req Cfg for" " cellId(%d)  Failed: reason (%u)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe10024, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1093, "PjDlUdxCountReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   ret = 0;
   countCfm = 0L;
   udxSap = &(tPjCb->u.dlCb->udxDlSap[0]);
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&countCfm, (Size) sizeof (UdxCountCfmInfo), 0) != 0) { ret = 1; } }
                                    ;
   if( ret != 0)
   {


      { if (countReq != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) countReq, (Size) sizeof(UdxCountReqInfo), 0); countReq = 0L; } };

      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10025, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1106, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   if ( pjCfgPrcDlCount(tPjCb, countReq,
                             countCfm) != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10026,L_ERROR,DBG_UEID, countReq->ueId, countReq->cellId, countCfm->reason, 0, 0,                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                            1114      , "Dl Count Req for cellId(%d)" " Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   udxSap = &(tPjCb->u.dlCb->udxDlSap[0]);
    ...
    if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe10027, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1169, "PjDlUdxSduStaReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };



   { if(udxSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10028, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1173, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (staReq != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staReq, (Size) sizeof(UdxSduStaReqInfo), 0); staReq = 0L; } };
      return(1);
   }

   if (pjCfgPrcDlSduSta(tPjCb,(UdxSduStaReqInfo *) staReq) != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10029,L_ERROR,DBG_UEID, staReq->ueId,staReq->cellId, 0, 0, 0,                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                                                 1184      , "Dl Sdu Sta Req for cellId(%d) Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                  ;
      ret = 1;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe1002a, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1240, "PjDlUdxUlFdbkPktInfo(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(udxSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe1002b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1249, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (fdbkPktInfo->fbPkt != 0L) { SPutMsg(fdbkPktInfo->fbPkt); } fdbkPktInfo->fbPkt = 0L; };
      { if (fdbkPktInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) fdbkPktInfo, (Size) sizeof(UdxDlFdbkPktInfo), 0); fdbkPktInfo = 0L; } };
      return(1);
   }
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe1002c,L_ERROR,DBG_CELLID, fdbkPktInfo->pdcpId.cellId, fdbkPktInfo->pdcpId.ueId, 0, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                    1265      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
      { if (fdbkPktInfo->fbPkt != 0L) { SPutMsg(fdbkPktInfo->fbPkt); } fdbkPktInfo->fbPkt = 0L; };
      { if (fdbkPktInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) fdbkPktInfo, (Size) sizeof(UdxDlFdbkPktInfo), 0); fdbkPktInfo = 0L; } };
      return(ret);
   ...
   { tRbCb = (fdbkPktInfo->pdcpId.rbType==0)?ueCb->srbCb[fdbkPktInfo->pdcpId.rbId]:ueCb->drbCb[fdbkPktInfo->pdcpId.rbId];};


   if( 0L == tRbCb )
   {
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe1002d,L_WARNING,DBG_UEID, fdbkPktInfo->pdcpId.ueId, fdbkPktInfo->pdcpId.cellId, fdbkPktInfo->pdcpId.rbId, 0, 0,                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                                                1278      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                 ;
      { if (fdbkPktInfo->fbPkt != 0L) { SPutMsg(fdbkPktInfo->fbPkt); } fdbkPktInfo->fbPkt = 0L; };
      { if (fdbkPktInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) fdbkPktInfo, (Size) sizeof(UdxDlFdbkPktInfo), 0); fdbkPktInfo = 0L; } };
      return(1);
   ...
   if ( ret != 0 )
   {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe1002e, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1290, "SAddPreMsg failed for ROHC Feedbck pdu", RLOG_FILE_ID, RLOG_MODULE_NAME); };
       { if (rohcFdbPdu != 0L) { SPutMsg(rohcFdbPdu); } rohcFdbPdu = 0L; };
       return(1);
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe1002f, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1357, "PjDlUdxDlFdbkPktInfo(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(udxSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10030, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1366, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10031,L_ERROR,DBG_CELLID, fdbkPktInfo->pdcpId.cellId, fdbkPktInfo->pdcpId.ueId, 0, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                    1382      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
      { if (fdbkPktInfo->fbPkt != 0L) { SPutMsg(fdbkPktInfo->fbPkt); } fdbkPktInfo->fbPkt = 0L; };
      { if (fdbkPktInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) fdbkPktInfo, (Size) sizeof(UdxDlFdbkPktInfo), 0); fdbkPktInfo = 0L; } };
      return(ret);
   ...
   if( 0L == tRbCb )
   {
      if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10032,L_WARNING,DBG_UEID, fdbkPktInfo->pdcpId.ueId, fdbkPktInfo->pdcpId.cellId, fdbkPktInfo->pdcpId.rbId, 0, 0,                                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                                                                1395      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                 ;
      { if (fdbkPktInfo->fbPkt != 0L) { SPutMsg(fdbkPktInfo->fbPkt); } fdbkPktInfo->fbPkt = 0L; };
      { if (fdbkPktInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) fdbkPktInfo, (Size) sizeof(UdxDlFdbkPktInfo), 0); fdbkPktInfo = 0L; } };
      return(1);
...

{
   ...
   udxSap = &(tPjCb->u.dlCb->udxDlSap[0]);
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&cfmInfo, (Size) sizeof (UdxDatResumeCfmInfo), 0) != 0) { ret = 1; } }
                                          ;
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe10033, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c",1599, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (datResumeInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) datResumeInfo, (Size) sizeof(UdxDatResumeInfo), 0); datResumeInfo = 0L; } };
      return(1);
   }
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10034,L_ERROR,DBG_CELLID, datResumeInfo->cellId, datResumeInfo->ueId, 0, 0, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                               1617      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;
      cfmInfo->status = 2;
      cfmInfo->reason = 7;
      { if (datResumeInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) datResumeInfo, (Size) sizeof(UdxDatResumeInfo), 0); datResumeInfo = 0L; } };
...

{
   ...
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&cfmInfo, (Size) sizeof (UdxDatFwdCfmInfo), 0) != 0) { ret = 1; } }
                                     ;
   if( ret != 0)
   {
      cfmInfo = 0L;
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe10035,L_ERROR,DBG_CELLID, datFwdInfo->cellId, datFwdInfo->ueId, 0, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_dl.c"      ,                            1707      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
      cfmInfo->status = 2;
      cfmInfo->reason = 7;
      ...
      PjDlUdxDatFwdCfm(&tPjCb->u.dlCb->udxDlSap[0].pst,
                       tPjCb->u.dlCb->udxDlSap[0].suId, cfmInfo);
      { if (datFwdInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) datFwdInfo, (Size) sizeof(UdxDatForwardInfo), 0); datFwdInfo = 0L; } };
      return(ret);
   }
