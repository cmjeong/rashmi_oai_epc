...

{
   ...
   tPjCb = pjCb[pst->dstInst];;

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe30001, L_DEBUG, spId, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",159, "PjUiCpjBndReq(pst, spId(%d), suId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   switch(cpjSap->state)
   {
      ...
      case 4:
      {
         ...
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe30002, L_DEBUG, cpjSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",181, "PjUiCpjBndReq: state (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
      }
      ...
      case 2:
      {
               ...
               || cpjSap->suId != suId)
         {
            ...
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe30003, L_DEBUG, cpjSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",199, "PjUiCpjBndReq: SAP already bound -- state(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            ret = 1;
         }
         break;
      }
     ...
     default:
      {
         ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",208, "Invalid CPJ SAP State in Bind Req", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ret = 1;
         break;
      }
   }
   ...
   if (ret == 0)
   {
      PjUiCpjBndCfm(&(cpjSap->pst), cpjSap->suId, 1);
   }
   else
   {
      PjUiCpjBndCfm(&(cpjSap->pst), cpjSap->suId, 2);
   }
...

{
   ...
   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe30005, L_DEBUG, spId, reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",275, "PjUiCpjUbndReq(pst, spId(%d), reason(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe30006, L_DEBUG, spId, cfg->transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",359, "PjUiPjuCfgReq(pst, spId(%d), TransId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(cpjSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30007, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",368, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (cfg != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) cfg, (Size) sizeof(CpjCfgReqInfo)); cfg = 0L; } };
      return(1);
   }

   udxSap = (&(tPjCb->u.ulCb->udxUlSap[0]));
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxCfgReqInfo, (Size) sizeof (UdxCfgReqInfo), 0) != 0) { ret = 1; } };
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30008, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",380, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (cfg != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) cfg, (Size) sizeof(CpjCfgReqInfo)); cfg = 0L; } };
      return(1);
   }


   { cmMemcpy((U8*)udxCfgReqInfo, (U8 *)cfg, sizeof(UdxCfgReqInfo)); };
   { if (SGetSBuf(tPjCb->init.region, tPjCb->init.pool, (Data **)&cfgInfo, (Size) sizeof (PjCfgInfo)) == 0) { cmMemset((U8 *)(cfgInfo), 0, sizeof (PjCfgInfo)); } else { (cfgInfo) = 0L; } };

   if (cfgInfo == 0L)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30009, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",391, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (cfg != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) cfg, (Size) sizeof(CpjCfgReqInfo)); cfg = 0L; } };
      { if (udxCfgReqInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) udxCfgReqInfo, (Size) sizeof(UdxCfgReqInfo), 0); udxCfgReqInfo = 0L; } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3000a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",405, "Addition to UL transId List Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (cfg != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) cfg, (Size) sizeof(CpjCfgReqInfo)); cfg = 0L; } };
      { if (udxCfgReqInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) udxCfgReqInfo, (Size) sizeof(UdxCfgReqInfo), 0); udxCfgReqInfo = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe3000b, L_DEBUG, spId, transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",465, "PjUiCpjUeIdChgReq(pst, spId(%d), transId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(cpjSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3000c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",476, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {

      { if (ueInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) ueInfo, (Size) sizeof(CpjUeInfo)); ueInfo = 0L; } };
      { if (newUeInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) newUeInfo, (Size) sizeof(CpjUeInfo)); newUeInfo = 0L; } };
      return(1);
   }


   udxSap = (&(tPjCb->u.ulCb->udxUlSap[0]));
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxUeInfo, (Size) sizeof (UdxUeInfo), 0) != 0) { ret = 1; } }
                                             ;
    if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3000d, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",491, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxNewUeInfo, (Size) sizeof (UdxUeInfo), 0) != 0) { ret = 1; } }
                              ;
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3000e, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",502, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };


      { if (udxUeInfo != 0L) { (Void) SPutStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data *) udxUeInfo, (Size) sizeof(UdxUeInfo), 0); udxUeInfo = 0L; } };
      { if (newUeInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) newUeInfo, (Size) sizeof(CpjUeInfo)); newUeInfo = 0L; } };
      { if (ueInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) ueInfo, (Size) sizeof(CpjUeInfo)); ueInfo = 0L; } };
      return(1);
   }

   { cmMemcpy((U8*)udxUeInfo, (U8 *)ueInfo, sizeof(UdxUeInfo)); };
   { cmMemcpy((U8*)udxNewUeInfo, (U8 *)newUeInfo, sizeof (UdxUeInfo)); };

   { if (SGetSBuf(tPjCb->init.region, tPjCb->init.pool, (Data **)&cfgInfo, (Size) sizeof (PjCfgInfo)) == 0) { cmMemset((U8 *)(cfgInfo), 0, sizeof (PjCfgInfo)); } else { (cfgInfo) = 0L; } };
   if (cfgInfo == 0L)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3000f, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",517, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (udxUeInfo != 0L) { (Void) SPutStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data *) udxUeInfo, (Size) sizeof(UdxUeInfo), 0); udxUeInfo = 0L; } };
      { if (udxNewUeInfo != 0L) { (Void) SPutStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data *) udxNewUeInfo, (Size) sizeof(UdxUeInfo), 0); udxNewUeInfo = 0L; } };
      { if (newUeInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) newUeInfo, (Size) sizeof(CpjUeInfo)); newUeInfo = 0L; } };
      { if (ueInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) ueInfo, (Size) sizeof(CpjUeInfo)); ueInfo = 0L; } };
      return(1);
   }
   ...
   if((ret = pjDbmAddUlTransIdLst(tPjCb, cfgInfo)) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30010, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",532, "Addition to UL transId List Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (udxUeInfo != 0L) { (Void) SPutStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data *) udxUeInfo, (Size) sizeof(UdxUeInfo), 0); udxUeInfo = 0L; } };
      { if (udxNewUeInfo != 0L) { (Void) SPutStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data *) udxNewUeInfo, (Size) sizeof(UdxUeInfo), 0); udxNewUeInfo = 0L; } };
      { if (newUeInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) newUeInfo, (Size) sizeof(CpjUeInfo)); newUeInfo = 0L; } };
      { if (ueInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) ueInfo, (Size) sizeof(CpjUeInfo)); ueInfo = 0L; } };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe30011, L_DEBUG, spId, secCfg->transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"   , 596   , "PjUiCpjSecCfgReq(pst, spId(%d), TransId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                               ;
   ...
   udxSap = (&(tPjCb->u.ulCb->udxUlSap[0]));
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxSecCfgReqInfo, (Size) sizeof (UdxSecCfgReqInfo), 0) != 0) { ret = 1; } };
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30012, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",609, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   { cmMemcpy((U8*)udxSecCfgReqInfo, (U8 *)secCfg, sizeof(UdxSecCfgReqInfo)); };
   { if (SGetSBuf(tPjCb->init.region, tPjCb->init.pool, (Data **)&cfgInfo, (Size) sizeof (PjCfgInfo)) == 0) { cmMemset((U8 *)(cfgInfo), 0, sizeof (PjCfgInfo)); } else { (cfgInfo) = 0L; } };

   if (cfgInfo == 0L)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30013, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",618, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30014, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",630, "Addition to UL transId List Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if (pst->dstInst >= 2)
   {
      { if (reEstReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) reEstReq, (Size) sizeof(CpjReEstReqInfo)); reEstReq = 0L; } };
      return(1);
   }
   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe30015, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",681, "PjUiCpjReEstReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   ret = 0;
   cpjSap = &(tPjCb->u.ulCb->cpjSap);


   { if(cpjSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30016, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",687, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {
   ...
   udxSap = (&(tPjCb->u.ulCb->udxUlSap[0]));
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxReEstReqInfo, (Size) sizeof (UdxReEstReqInfo), 0) != 0) { ret = 1; } }
                                    ;
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30017, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",700, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (reEstReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) reEstReq, (Size) sizeof(CpjReEstReqInfo)); reEstReq = 0L; } };
      return(1);
   }

   { cmMemcpy((U8*)udxReEstReqInfo, (U8 *)reEstReq, sizeof(UdxReEstReqInfo)); };

   { if (SGetSBuf(tPjCb->init.region, tPjCb->init.pool, (Data **)&cfgInfo, (Size) sizeof (PjCfgInfo)) == 0) { cmMemset((U8 *)(cfgInfo), 0, sizeof (PjCfgInfo)); } else { (cfgInfo) = 0L; } };
   if (cfgInfo == 0L)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30018, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",710, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (reEstReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) reEstReq, (Size) sizeof(CpjReEstReqInfo)); reEstReq = 0L; } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30019, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",723, "Addition to UL transId List Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (reEstReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) reEstReq, (Size) sizeof(CpjReEstReqInfo)); reEstReq = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      return(1);
   }
...

{
   ...
   if (pst->dstInst >= 2)
   {
      { if (countReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) countReq, (Size) sizeof(CpjCountReqInfo)); countReq = 0L; } };
      return(1);
   }


   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe3001a, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",780, "PjUiCpjCountReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   udxSap = (&(tPjCb->u.ulCb->udxUlSap[0]));
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxCountReqInfo, (Size) sizeof (UdxCountReqInfo), 0) != 0) { ret = 1; } };
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3001b, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",791, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   { cmMemcpy((U8*)udxCountReqInfo, (U8 *)countReq, sizeof(UdxCountReqInfo)); };
   { if (SGetSBuf(tPjCb->init.region, tPjCb->init.pool, (Data **)&cfgInfo, (Size) sizeof (PjCfgInfo)) == 0) { cmMemset((U8 *)(cfgInfo), 0, sizeof (PjCfgInfo)); } else { (cfgInfo) = 0L; } };

   if (cfgInfo == 0L)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3001c, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",800, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (countReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) countReq, (Size) sizeof(CpjCountReqInfo)); countReq = 0L; } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3001d, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",813, "Addition to UL transId List Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (udxCountReqInfo != 0L) { (Void) SPutSBuf(udxSap->pst.region, udxSap->pst.pool, (Data *) udxCountReqInfo, (Size) sizeof(UdxCountReqInfo)); udxCountReqInfo = 0L; } };
      { if (countReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) countReq, (Size) sizeof(CpjCountReqInfo)); countReq = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      return(1);
   }
...

{
   ...
   if (pst->dstInst >= 2)
   {
      { if (staReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) staReq, (Size) sizeof(CpjSduStaReqInfo)); staReq = 0L; } };
      return(1);
   }

   tPjCb = pjCb[pst->dstInst];;

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe3001e, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",874, "PjUiCpjSduStaReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(cpjSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3001f, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",882, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe30020,L_ERROR,DBG_CELLID, staReq->cellId, staReq->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"      ,                        895      , "UL UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
      ...
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30021, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",902, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { if (staReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) staReq, (Size) sizeof(CpjSduStaReqInfo)); staReq = 0L; } };
         return(1);
      }
      ...
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe30022,L_DEBUG,DBG_UEID, staReq->ueId, staReq->cellId, 0, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"      ,                                                  914      , "Prc Sdu Sta Req - UE Cb is not" " found in cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                   ;
   ...
   ueCb->libInfo.state = 3;

   udxSap = (&(tPjCb->u.ulCb->udxUlSap[0]));
   ret = 0;
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxSduStaReq, (Size) sizeof (UdxSduStaReqInfo), 0) != 0) { ret = 1; } }
                                     ;
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30023, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",935, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (staReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) staReq, (Size) sizeof(CpjSduStaReqInfo)); staReq = 0L; } };
      return(1);
   }

   { cmMemcpy((U8*)udxSduStaReq, (U8 *)staReq, sizeof(UdxSduStaReqInfo)); };

   { if (SGetSBuf(tPjCb->init.region, tPjCb->init.pool, (Data **)&cfgInfo, (Size) sizeof (PjCfgInfo)) == 0) { cmMemset((U8 *)(cfgInfo), 0, sizeof (PjCfgInfo)); } else { (cfgInfo) = 0L; } };
   if (cfgInfo == 0L)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30024, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",945, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (staReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) staReq, (Size) sizeof(CpjSduStaReqInfo)); staReq = 0L; } };
      { if (udxSduStaReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) udxSduStaReq, (Size) sizeof(UdxSduStaReqInfo)); udxSduStaReq = 0L; } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30025, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",959, "Addition to UL transId List Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (staReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) staReq, (Size) sizeof(CpjSduStaReqInfo)); staReq = 0L; } };
      { if (udxSduStaReq != 0L) { (Void) SPutSBuf(udxSap->pst.region, udxSap->pst.pool, (Data *) udxSduStaReq, (Size) sizeof(UdxSduStaReqInfo)); udxSduStaReq = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof(PjCfgInfo)); cfgInfo = 0L; } };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe30026, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1013, "PjUiCpjDatResumeReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(cpjSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30027, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1021, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe30028,L_ERROR,DBG_CELLID, datResReq->cellId, datResReq->ueId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"      ,                           1031      , "UL UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
      { if (datResReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datResReq, (Size) sizeof(CpjDatResumeReqInfo)); datResReq = 0L; } };
      return(1);
   }
   ...
   udxSap = (&(tPjCb->u.ulCb->udxUlSap[0]));
   ret = 0;
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxDatResumeInfo, (Size) sizeof (UdxDatResumeInfo), 0) != 0) { ret = 1; } }
                                     ;
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30029, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1043, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (datResReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datResReq, (Size) sizeof(CpjDatResumeReqInfo)); datResReq = 0L; } };
      return(1);
   }
   ...
   if (cfgInfo == 0L)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3002a, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1051, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (datResReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datResReq, (Size) sizeof(CpjDatResumeReqInfo)); datResReq = 0L; } };
      { if (udxDatResumeInfo != 0L) { (Void) SPutSBuf(udxSap->pst.region, udxSap->pst.pool, (Data *) udxDatResumeInfo, (Size) sizeof(UdxDatResumeInfo)); udxDatResumeInfo = 0L; } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3002b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1067, "Addition to UL transId List Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (datResReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datResReq, (Size) sizeof(CpjDatResumeReqInfo)); datResReq = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof(PjCfgInfo)); cfgInfo = 0L; } };
      { if (udxDatResumeInfo != 0L) { (Void) SPutSBuf(udxSap->pst.region, udxSap->pst.pool, (Data *) udxDatResumeInfo, (Size) sizeof(UdxDatResumeInfo)); udxDatResumeInfo = 0L; } };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe3002c, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1121, "PjUiCpjDatForwardReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if(cpjSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3002d, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1131, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {
      { if (dataFwdReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) dataFwdReq, (Size) sizeof(CpjDataFwdReqInfo)); dataFwdReq = 0L; } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe3002e,L_ERROR,DBG_CELLID, cellId,ueId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1141, "UL UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (dataFwdReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) dataFwdReq, (Size) sizeof(CpjDataFwdReqInfo)); dataFwdReq = 0L; } };
      return(1);
   }
   ...
   udxSap = (&(tPjCb->u.ulCb->udxUlSap[0]));
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&udxDatForwardInfo, (Size) sizeof (UdxDatForwardInfo), 0) != 0) { ret = 1; } }
                                      ;
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3002f, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1155, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (dataFwdReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) dataFwdReq, (Size) sizeof(CpjDataFwdReqInfo)); dataFwdReq = 0L; } };
      return(1);
   }
   ...
   { if (dataFwdReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) dataFwdReq, (Size) sizeof(CpjDataFwdReqInfo)); dataFwdReq = 0L; } };
   if(ueCb->isUlDatFwdReqd == 1)
   {


      udxDatForwardInfo->ulFwding = 1;
   }
...

{
   ...
   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe30030, L_DEBUG, spId, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1232, "PjUiPjuBndReq(pst, spId(%d), suId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   ret = 0;
   pjuSap = 0L;
   if (tPjCb->pjGenCfg.mode == 0x1)
   {
   ...
   switch(pjuSap->state)
   {
      ...
      case 4:
      {
         ...
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe30031, L_DEBUG, pjuSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1277, "PjUiPjuBndReq: state (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         break;
      }
      ...
      case 2:
      {
         ...
         if (pjuSap->pst.dstProcId != pst->srcProcId
               ...
               || pjuSap->suId != suId)
         {
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0xe30032, L_DEBUG, suId, pjuSap->suId, pst->srcProcId, pjuSap->pst.dstProcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"            , 1295            , "Ui Pju Bnd Req suId(%d)<>suId(%d)," "pst->srcProcId(%d)<>pjuSap->pst.dstProcId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                                            ;

            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0xe30033, L_DEBUG, pst->srcEnt, pjuSap->pst.dstEnt, pst->srcInst, pjuSap->pst.dstInst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"            , 1299            , "Ui Pju Bnd Req pst->srcEnt(%d)<>pjuSap->pst.dstEnt" "(%d),pst->srcInst(%d)<>pjuSap->pst.dstInst(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
     ...
     default:
      {
         ...
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30034, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1310, "Invalid PJU SAP State in Bind Req", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         ;
         ret = 1;
         break;
      }
   ...
   if (ret == 0)
   {
      PjUiPjuBndCfm(&(pjuSap->pst), pjuSap->suId, 1);
   }
   else
   {
      PjUiPjuBndCfm(&(pjuSap->pst), pjuSap->suId, 2);
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe30035, L_DEBUG, spId, reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1383, "PjUiPjuUbndReq(pst, spId(%d), reason(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...
)
{
   ...
   ;
   if ((pst->dstInst >= 2) || (mBuf == 0L))
   {
      { if (pdcpId != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) pdcpId, (Size) sizeof(CmLtePdcpId)); pdcpId = 0L; } };
      { if (mBuf != 0L) { SPutMsg(mBuf); } mBuf = 0L; };
      return(1);
   }
   ...
   ret = 0;
   if (pjDbmFetchDlUeCb(tPjCb, pdcpId->ueId, pdcpId->cellId, &ueCb) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe30036,L_ERROR,DBG_CELLID, pdcpId->cellId, pdcpId->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"      ,                        1503      , "DL UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
      { if (mBuf != 0L) { SPutMsg(mBuf); } mBuf = 0L; };
      return(1);
   }
   ...
   { pjRbCb = (pdcpId->rbType==0)?ueCb->srbCb[pdcpId->rbId]:ueCb->drbCb[pdcpId->rbId];};
   if (pjRbCb == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe30037,L_ERROR,DBG_UEID, pdcpId->ueId, pdcpId->cellId, pdcpId->rbId, 0, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"      ,                                        1513      , "CellId[%u]: DL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
      { if (mBuf != 0L) { SPutMsg(mBuf); } mBuf = 0L; };
      return(1);
   }
   ...
   if (pjLibPktAdmCtrl(pjRbCb, mBuf) != 0)
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe30038,L_DEBUG,DBG_UEID, pdcpId->ueId, pdcpId->cellId, pdcpId->rbId, 0, 0,                                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"      ,                                                               1526      , "Pju Dat Req: PDCP pkt dropped for" " cellId(%d),rbId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                ;
      { if (mBuf != 0L) { SPutMsg(mBuf); } mBuf = 0L; };
   ...
   if((pjRbCb->state != 1) && (pjRbCb->rbType != 0))
   {
      if(pjRbCb->dlCb.dlPktQ.count < 500)
      {

         pjDlmEnqueueDlPkt(tPjCb, pjRbCb, 2, 
                                                          ((void *)0)
                                                              , sduId, mBuf);
         return(0);
      }
   ...
   { PjDlCb *_dlCb; _dlCb = &pjRbCb->dlCb; sn = _dlCb->nxtTxSn; txHfn = _dlCb->txHfn; if ( (++_dlCb->nxtTxSn) == pjRbCb->maxTxSn) { _dlCb->txHfn++; _dlCb->nxtTxSn = 0; } };
   pjDlmProcessSdus(tPjCb, pjRbCb, mBuf, sduId, sn,txHfn);


   return(0);
}
 S16 PjUiPjuDatFwdReq
(
Pst *pst,
SpId spId,
CmLtePdcpId *pdcpId,
...

{
   ...
   if (pst->dstInst >= 2)
   {
      { if (datFwdReq->datFwdInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datFwdReq->datFwdInfo, (Size) (datFwdReq->numSdus * sizeof(PjuDatFwdInfo))); datFwdReq->datFwdInfo = 0L; } }
                                                              ;
      { if (datFwdReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datFwdReq, (Size) sizeof(PjuDatFwdReqInfo)); datFwdReq = 0L; } };
      return(1);
   }
   tPjCb = pjCb[pst->dstInst];;
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe30039, L_DEBUG, spId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1834, "PjUiPjuDatFwdReq(pst, spId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   if (( datFwdReq->dir == 2 ) &&
       (tPjCb->pjGenCfg.mode == 0x2))

   {
      ...
      { if(pjuSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3003a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1844, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
      if (ret != 0)
      {
      ...
      if (pjDbmFetchDlUeCb(tPjCb, pdcpId->ueId, pdcpId->cellId, &dlUeCb) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe3003b,L_ERROR,DBG_CELLID, pdcpId->cellId, pdcpId->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"         ,                        1857         , "DL UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
      ...
      { dlRbCb = (pdcpId->rbType==0)?dlUeCb->srbCb[pdcpId->rbId]:dlUeCb->drbCb[pdcpId->rbId];};
      if (dlRbCb == 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe3003c,L_ERROR,DBG_UEID, pdcpId->ueId, pdcpId->cellId, pdcpId->rbId, 0, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"         ,                                        1869         , "CellId[%u]: DL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
      ...
      if (dlRbCb->state == 4)
      {
          pjDlmEnqueueDlPkt(tPjCb,dlRbCb, 1, datFwdReq, 0, 0L);
      }
      else
      {
   ...
   else if (( datFwdReq->dir == 1 ) &&
             (tPjCb->pjGenCfg.mode == 0x1))
   {
      PjUlRbCb *ulRbCb;
      PjUlUeCb *ulUeCb;
      pjuSap = (PjPjuSapCb*)(tPjCb->u.ulCb->pjuSap + spId);
      ...
      pjuSap->state = 2;
      { if(pjuSap->state != 2) { if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe3003d, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",1900, "Sap State Invalid.", RLOG_FILE_ID, RLOG_MODULE_NAME); }; pjLmmSendAlarm(tPjCb, 2, 1, 9, 0, 0); ret = 1; } };
      if (ret != 0)
      {
      ...
      if (pjDbmFetchUlUeCb(tPjCb, pdcpId->ueId, pdcpId->cellId, &ulUeCb) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe3003e,L_ERROR,DBG_CELLID, pdcpId->cellId, pdcpId->ueId, 0, 0, 0,                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"         ,                        1913         , "UL UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                         ;
      ...
      { ulRbCb = (pdcpId->rbType==0)?ulUeCb->srbCb[pdcpId->rbId]:ulUeCb->drbCb[pdcpId->rbId];};
      if (ulRbCb == 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe3003f,L_ERROR,DBG_UEID, pdcpId->ueId, pdcpId->cellId, pdcpId->rbId, 0, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"         ,                                        1925         , "CellId[%u]: UL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
...

{
   ...
   if(SGetSBuf(cpjSap->pst.region,cpjSap->pst.pool,(Data **)&kdfCfmInf,
      sizeof (CpjKdfCfmInfo)) != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe30040, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c",2008, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe30041, L_DEBUG, kdfReqInfo->keyDerType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_uim.c"   , 2025   , "Key derivation request for Key type %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;

   switch(kdfReqInfo->keyDerType)
   {
      case 0:
         kdfCfmInf->keyDerType = 0;
         ret = pjLibObdPrcKenbCfg(tPjCb, &(kdfReqInfo->u.kEnbInf),
               &(kdfCfmInf->u.kEnbInf));
         break;

      case 1:
         kdfCfmInf->keyDerType = 1;
