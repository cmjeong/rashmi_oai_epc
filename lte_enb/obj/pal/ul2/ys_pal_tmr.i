...
static Void * ysPalTtiTmrTsk (Void *);
 Void ysPrcTmrExpiry
(
Ptr cb,
S16 tmrEvnt
...

{
   ...
   switch (tmrEvnt)
   {
      ...
      case 10:
      {
         static CmLteTimingInfo timingInfo;


         if (ysCb.ttiReady == 1)

         {
            { if ((timingInfo.subframe + 1) > (10 - 1)) timingInfo.sfn = ((timingInfo.sfn + 1) % 1024); timingInfo.subframe = ((timingInfo.subframe + 1) % 10); };
      ...
      default:
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_tmr.c", 133); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_tmr.c", 133); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysPrcTmrExpiry(): invalid tmrEvnt = %d", tmrEvnt); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   }
   return;
}
...

{
   ...
   if ((SCreatePThread(&tId, &attr, ysPalTtiTmrTsk, (Ptr)
                                                        ((void *)0)
                                                            )) != 0)

   {
      ...
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_tmr.c", 172); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_tmr.c", 172); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to create TTI generator thread\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
...
{
   static struct timespec interval, remInterval;
   static struct timespec startTm, wakeup;
   ...
   while(1)
   {
       ...
       interval.tv_sec = 0;
       startTm.tv_nsec += YS_TTI_TMR_VAL_CFG;
      ...
      while(ttiEvnt)
      {
         ...
         if (ret != 0)
         {
            { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_tmr.c", 311); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_tmr.c", 311); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SGetMsg failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
            continue;
         }
         SPstTsk(&pst, tempBuf);
         ttiEvnt--;
