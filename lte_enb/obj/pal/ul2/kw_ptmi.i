...
extern Void kwLmmSendAlarm (KwCb *gCb, U16 category, U16 event, U16 cause, SuId suId, U32 ueId)
                                            ...
                                            ;
static S16 PtMiLkwCfgCfm (Pst *pst, KwMngmt *cfm);
static S16 PtMiLkwCntrlCfm (Pst *pst, KwMngmt *cfm);
static S16 PtMiLkwStaInd (Pst *pst, KwMngmt *usta);

static S16 PtMiLkwStaCfm (Pst *pst, KwMngmt *cfm);
static S16 PtMiLkwStsCfm (Pst *pst, Action action, KwMngmt *cfm)
                                              ;
static S16 PtMiLkwTrcInd (Pst *pst, KwMngmt *trc, Buffer *mBuf)
                                              ;
static LkwCfgCfm kwMiLkwCfgCfmMt[2] =
{
...
static LkwCntrlCfm kwMiLkwCntrlCfmMt[2] =
{
...
static LkwStaInd kwMiLkwStaIndMt[2] =
{
...
static LkwStaCfm kwMiLkwStaCfmMt[2] =
{
...
static LkwStsCfm kwMiLkwStsCfmMt[2] =
{
...
static LkwTrcInd kwMiLkwTrcIndMt[2] =
{
