...
static S16 rgCOMHndlCfgReq (Inst inst,CrgCfg *cfg, RgErrInfo *errInfo,Bool *isCfmRqrd,CrgCfgTransId transId);
static S16 rgCOMHndlRecfgReq (Inst inst,CrgRecfg *recfg, RgErrInfo *errInfo, CrgCfgTransId transId,Bool *isCfmRqrd)
                                                ;
static S16 rgCOMHndlDelReq (Inst inst,CrgDel *del, RgErrInfo *errInfo, Bool *isCfmRqrd, CrgCfgTransId transId);
static S16 rgCOMHndlResetReq (Inst inst,CrgRst *reset,RgErrInfo *errInfo);
 S16 rgCOMCfgReq
(
Inst inst,
...

{
   ...
   switch (crgCfgReq->action)
   {
      ...
      default:
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb50001, L_ERROR, crgCfgReq->action, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c"            , 157            , "Invalid configuration action %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
...
)
{
   ...
   errInfo->errType = ((((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 6) + 1);
   ...
   switch (cfg->cfgType)
   {
      case 1:
      {
         ...
         if (ret != 0)
         {
              if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb50002,L_ERROR,DBG_CELLID, cfg->u.cellCfg.cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c",242, "Cell configuration validation FAILED\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
         }
      ...
      {
         {
            ...
            if (ret != 0)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb50003,L_ERROR,DBG_CRNTI, cfg->u.ueCfg.crnti, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c",254, "Ue configuration validation FAILED\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               return(1);
            }
      ...
      case 3:
      {
         ...
         if (ret != 0)
         {
            ...
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb50004,L_ERROR,DBG_CELLID, cfg->u.cellCfg.cellId, cfg->u.lchCfg.lcId, 0, 0, 0,                                                                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c"            ,                                                                                          269            , "LC configuration validation FAILED: LC %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                                           ;
            return(1);
         }
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb50005, L_ERROR,cfg->cfgType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c",277, "Should never come here: cfgType %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
   }
...
)
{
   ...
   errInfo->errType = (((((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 6) + 1) + 1);
   ...
   switch (recfg->recfgType)
   {
      case 1:
      {
         ret = rgCFGVldtCrgCellRecfg(inst,&recfg->u.cellRecfg, &cell, errInfo);
            if (ret != 0)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb50006,L_ERROR,DBG_CELLID, recfg->u.cellRecfg.cellId, 0, 0, 0, 0,                                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c"               ,                                                       347               , "Cell Recfg Validation FAILED", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                        ;
               return(1);
            }
      ...
      case 2:
      {
         ...
         else
         {
            ...
            if ( ret != 0)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb50007,L_ERROR,DBG_CELLID, recfg->u.ueRecfg.cellId, recfg->u.ueRecfg.oldCrnti, 0, 0, 0,                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c"               ,                                               385               , "Ue Re-configuration validation FAILED OLD CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      case 3:
      {
         ...
         if (ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb50008,L_ERROR,DBG_CELLID, recfg->u.lchRecfg.cellId, recfg->u.lchRecfg.lcId, recfg->u.lchRecfg.crnti, 0, 0,                                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c"            ,                                                                    403            , "LC Re-configuration validation FAILED LCID:%d CRNTI:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb50009, L_ERROR, recfg->recfgType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c"         , 420         , "Should never come here: recfgType %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;
         return(1);
      }
   }
...
)
{
   ...
   errInfo->errType = (((((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 6) + 1) + 2);
   ...
   switch (del->delType)
   {
      ...
      case 2:
      {
         ...
         SStartTask(&startTime,30214);


         ret = rgCFGCrgUeDel(inst,del, errInfo);
         { if ((&rgCb[inst].rgInit)->dbgMask & ((0x00000100 << 0))) { snprintf((&rgCb[inst].rgInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "MAC", (&rgCb[inst].rgInit)->procId, (&rgCb[inst].rgInit)->ent, (&rgCb[inst].rgInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c", 537); SPrint((&rgCb[inst].rgInit)->prntBuf); sprintf (rgCb[inst].rgInit.prntBuf,"[%d] Delete UE Done \n", del->u.ueDel.crnti); SPrint((&rgCb[inst].rgInit)->prntBuf); } };


         SStopTask(startTime,30214);
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb5000a, L_ERROR, del->delType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_com.c"         , 552         , "Should never come here: delType %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                               ;
         return(1);
      }
   }
