...
extern Void pjDeInitDeCipherQ(Void);
 S16 pjDeciphStateChek (PjCb *gCb, PjRxEnt *delEnt);
static S16 pjDbmInsInSeqRxEnt
(
PjBuf *buf,
PjRxEnt *rxEnt
)
...

{
   ...
   tmpEnt = (PjRxEnt *) ((((&buf->datPktQ)->crnt = (&buf->datPktQ)->first))->node);
   if((rxEnt->count) < (tmpEnt->count))
   {
      rxEnt->datPktEnt.node = (U32) rxEnt;
      cmLListInsCrnt(&buf->datPktQ, &rxEnt->datPktEnt);
   }
   else
   {
      tmpEnt = (PjRxEnt *) ((((&buf->datPktQ)->crnt = (&buf->datPktQ)->last))->node);
      while((rxEnt->count) < (tmpEnt->count))
      {
         ((&buf->datPktQ)->crnt = ((&buf->datPktQ)->crnt ? (&buf->datPktQ)->crnt->prev : (&buf->datPktQ)->first));
         tmpEnt = (PjRxEnt *) ((((&buf->datPktQ)->crnt))->node);
      }
      rxEnt->datPktEnt.node = (U32) rxEnt;
...

{
   ...
   hashKey = (U8)(rxEnt->count % 255);

   rxEnt->lstEnt.node = (U32) rxEnt;
...

{
   ...
   hashKey = (U8)(count % 255);

   datQ = &buf->datQ[hashKey];


   ((datQ)->crnt = (datQ)->first);
   while(((datQ)->crnt))
   {
      tmpEnt = (PjRxEnt *)((((datQ)->crnt))->node);
      if((tmpEnt->count) == count)
      {
         return(tmpEnt);
      }
      ((datQ)->crnt = ((datQ)->crnt ? (datQ)->crnt->next : (datQ)->first));
   }
   return(0L);
}
...
{
  ;;
  { if (delEnt->mBuf != 0L) { SPutMsg(delEnt->mBuf); } delEnt->mBuf = 0L; };
  { if (delEnt != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) delEnt, (Size) sizeof(PjRxEnt)); delEnt = 0L; } };
  return(0);
}
 S16 pjDbmDelRxEnt
(
...

{
   ...
   if(delEnt->datPktEnt.node != 0L)
   {
      cmLListDelFrm(&buf->datPktQ, &delEnt->datPktEnt);
      delEnt->datPktEnt.node = 0L;
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80001, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",393, "pjDbmRxDelAll(buf)", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   for(listInd = 0; listInd< buf->numBins; listInd++)
   {
      datQ = &buf->datQ[listInd];
      while(((datQ)->crnt = (datQ)->first))
      {
         lstEnt = cmLListDelFrm(datQ, ((datQ)->crnt));
         if(lstEnt != 0L)
         {
            delEnt = (PjRxEnt *)((lstEnt)->node);
            if(delEnt->datPktEnt.node != 0L)
            {
               cmLListDelFrm(&buf->datPktQ, &delEnt->datPktEnt);
               delEnt->datPktEnt.node = 0L;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80002, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",448, "pjDbmRxDeInit(buf)", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   pjDbmRxDelAll(gCb,buf);


   { if (buf->datQ != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) buf->datQ, (Size) (sizeof(CmLListCp) * buf->numBins)); buf->datQ = 0L; } };
   buf->numBins = 0L;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80003, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",490, "pjDbmInit()", RLOG_FILE_ID, RLOG_MODULE_NAME); };



   ret = cmHashListInit(&(gCb->u.ulCb->ueLstCp), (U16) 128,
         (U16) 0, (Bool) 0, (U16) 0,
         gCb->init.region, gCb->init.pool);
   if (ret != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",500, "cmHashListInit Failed for gCb.ueLstCp.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80005, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",513, "cmHashListInit Failed for pjCb.transIdLstCp.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80006, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",551, "pjDbmDeInit()", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80007, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",559, "cmHashListDeinit Failed for gCb.ueLstCp.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80008, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",569, "cmHashListDeinit Failed for gCb.transIdLstCp.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80009, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",578, "cmHashListDeinit Failed for gCb->u.ulCb->transIdLstCp", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      return(ret);
   }
   return(0);
}
 S16 pjDbmFetchUlRbCb
(
PjCb *gCb,
CmLteRlcId rlcId,
PjUlRbCb **rbCb
...

{
   ...
   { ret = 0; if (rlcId.ueId == 0) { if (rlcId.rbId >= 10) { ret = 1; } } else { if ((rlcId.rbType != 0) && (rlcId.rbType != 1)) { ret = 1; } else if (rlcId.rbType == 0 &&rlcId.rbId >= 3) { ret = 1; } else if (rlcId.rbType == 1 &&rlcId.rbId >= 32) { ret = 1; } } };
   if (ret != 0)
   {


      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd8000a,L_ERROR,DBG_UEID, rlcId.ueId, rlcId.rbId, rlcId.cellId, 0, 0,                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c"      ,                                               636      , "PJ_VALIDATE_RBID Failed rbId(%d), cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                ;

      return(ret);
   }
   if (pjDbmFetchUlUeCb(gCb, rlcId.ueId, rlcId.cellId, &ueCb) != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd8000b,L_ERROR,DBG_UEID, rlcId.ueId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",643, "Failed to Fetch UE Cb", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      return(1);
   }
   else
   {
      { tRbCb = (rlcId.rbType==0)?ueCb->srbCb[rlcId.rbId]:ueCb->drbCb[rlcId.rbId];};
   }

   if (tRbCb == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd8000c,L_ERROR,DBG_UEID, rlcId.ueId, rlcId.cellId, rlcId.rbId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c"      ,                                    655      , "CellId[%u]:RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
      return(1);
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd8000d, L_DEBUG, numRbCb, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",703, "pjDbmDelAllRb(rbCbLst, numRbCb(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for (idx = 0; idx < numRbCb; idx++)
   {
      ...
      if (rbCb != 0L)
      {
         { { if (rbCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCb, (Size) sizeof(PjUlRbCb)); rbCb = 0L; } }; { gCb->pjGenSts.numOfRb--; }; };
         rbCbLst[idx] = 0L;
      }
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd8000e, L_DEBUG, ueId, cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",760, "pjDbmCreateUeCb(ueId(%d), cellId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&*ueCb, (Size) sizeof(PjUlUeCb)) == 0) { cmMemset((U8 *)(*ueCb), 0, sizeof(PjUlUeCb)); } else { (*ueCb) = 0L; } };
   tUeCb = *ueCb;
   tUeCb->key.ueId = ueId;
   tUeCb->key.cellId = cellId;

   ret = cmHashListInsert(&(gCb->u.ulCb->ueLstCp), (U32)tUeCb, (U8 *)&(tUeCb->key),
         (U16) sizeof(PjUeKey));
   if (ret != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd8000f,L_ERROR,DBG_UEID, ueId, cellId, 0, 0, 0,                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c"      ,                                  784      , "Ul UeCb Hash Insert Failed : cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;
...

{
   ...
   if (ret != 0)
   {
      ...
      if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd80010,L_INFO,DBG_UEID, ueId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",847, "Hash Find Failed for fetching ueCb", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xd80011, L_DEBUG, ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c"   , 895   , "pjDbmDelUeCb(ueId(%d), cellId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                             ;
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd80012,L_ERROR,DBG_UEID, ueCb->key.ueId, 0, 0, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c"      ,                                                   940      , "Hash Delete Failed for deleting ueCb.", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80013, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",983, "pjDbmDelAllUe()", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   while (cmHashListGetNext(&(gCb->u.ulCb->ueLstCp), (U32) ueCb, (U32 *)&ueCb) == 0)
   {

      ret = pjDbmDelUlUeCb(gCb,ueCb, 1);
      if (ret != 0)
      {

         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd80014,L_ERROR,DBG_UEID, ueCb->key.ueId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",997, "UE deletion Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...
)
{
   ...
   rbCb = 0L;
   rbCbLst = 0L;
   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&rbCb, (Size) sizeof(PjUlRbCb)) == 0) { cmMemset((U8 *)(rbCb), 0, sizeof(PjUlRbCb)); } else { (rbCb) = 0L; } };
   if ( rbCb == 0L )
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80015, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1098, "Memory Allocation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(rbCb);
   }
   rbCb->rbId = rbId;
   rbCb->rbType = rbType;

   rbCbLst = ((rbType == 0)? ueCb->srbCb:ueCb->drbCb);
   rbCbLst[rbId] = rbCb;

   { gCb->pjGenSts.numOfRb++; };

   return(rbCb);

}
 S16 pjDbmFetchPjUlRbCb
(
PjUlUeCb *ueCb,
U8 rbId,
U8 rbType,
...

{
   ...
   *pjRbCb = 0L;
   ...
   { rbCb = (rbType==0)?ueCb->srbCb[rbId]:ueCb->drbCb[rbId];};
   if ( rbCb != 0L )
   {
      *pjRbCb = rbCb;
   }
...

{
   ...
   if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd80016, L_UNUSED, cfg->transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1257, "pjDbmAddUlTransIdLst(transId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); };





   ret = cmHashListInsert(&(gCb->u.ulCb->transIdLstCp), (U32)cfg,
         (U8 *)&(cfg->transId), (U16) sizeof(cfg->transId));
   if (ret != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd80017, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1268, "Hash Insert Failed for Inserting UL transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd80018, L_DEBUG, transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1310, "pjDbmFindUlTransIdLst(transId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   ret = cmHashListFind(&(gCb->u.ulCb->transIdLstCp),(U8 *) &transId,
                  sizeof (transId), 0,(U32 *) cfg);
   if (ret != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd80019, L_ERROR, transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1321, "Hash Find Failed Fetch for transId [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if (ret != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd8001a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1328, "Deleting Trans ID Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd8001b, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1367, "pjDbmFindUlTransIdLst(transId()", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   ret = cmHashListDelete(&(gCb->u.ulCb->transIdLstCp),(U32) (*cfg));
   if (ret != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xd8001c, L_ERROR,(*cfg)->transId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1374, " Hash Delete Failed for transId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   }

   return(ret);
}
 S16 pjDbmDelAllUlTransIdLst
(
PjCb *gCb
)
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd8001d, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1411, "pjDbmFindUlTransIdLst", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

   {
      ...
      if (ret != 0)
      {
         ...
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xd8001e, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dbm_ul.c",1425, " pjDbmDelTransIdLst Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
