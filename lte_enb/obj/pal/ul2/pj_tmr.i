...
static Void pjBndTmrExpiry (S16 tmrEvnt, U32 cb);
 S16 pjStartTmr
(
PjCb *gCb,
U32 cb,
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdf0001, L_DEBUG, tmrEvnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_tmr.c",143, "pjStartTmr(cb, tmrEvnt (%d)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   switch (tmrEvnt)
   {
      case 0x18:
      {
         ...
         wait = (U16)((kwuSap->bndTmrInt * 100)/(gCb->pjGenCfg.timeRes * 1000));
      ...
      case 0x19:
      {
         ...
         wait = (U16)((udxSap->bndTmrInt * 100)/(gCb->pjGenCfg.timeRes * 1000));
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdf0002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_tmr.c",260, "Invalid Start tmr Evnt", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdf0003, L_DEBUG, tmrEvnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_tmr.c",332, "pjStopTmr(cb, tmrEvnt(%d)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   switch (tmrEvnt)
   {
      ...
      default:
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdf0004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_tmr.c",414, "Invalid Stop tmr Evnt", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
   }
...

{
   ...
   if( L_UNUSED < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdf0005, L_UNUSED, tmrEvnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_tmr.c",616, "pjChkTmr(cb, tmrEvnt(%d)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   switch (tmrEvnt)
   {
      default:
      {
          ...
          if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xdf0006, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_tmr.c",683, "Invalid Chk tmr Evnt", RLOG_FILE_ID, RLOG_MODULE_NAME); };
          return(1);
      }
   }
...

{
   ...
   if (tmrEvnt == 0x18)
   {
      ...
      tPjCb = pjCb[kwuSapCb->pst.srcInst];;
      if (kwuSapCb->state == 3)
      {
         if (kwuSapCb->retryCnt < 3)
         {

            kwuSapCb->retryCnt++;


            pjStartTmr(tPjCb, (U32)kwuSapCb, 0x18);
   ...
   else
   {
      ...
      tPjCb = pjCb[udxSap->pst.srcInst];;

      if (udxSap->state == 3)
      {
         if (udxSap->retryCnt < 3)
         {

            udxSap->retryCnt++;


            pjStartTmr(tPjCb, (U32)udxSap, 0x19);
