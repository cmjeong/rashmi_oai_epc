...
extern S16 hiProcHdrParm (HiConCb *conCb, CmTptAddr *srcAddr, CmTptAddr *remAddr, CmIpHdrParm *hdrParm, Buffer *mBuf, MsgLen mLen)
                                                                 ...
                                                                 ;
static S16 PtUiHitConInd (Pst *pst, SuId suId, UConnId servconId, UConnId spConId, CmTptAddr *peerAddr)
                                                                       ;
static S16 PtUiHitConCfm (Pst *pst, SuId suId, UConnId suConId, UConnId spConId, CmTptAddr *localAddr)
                                                                        ;
static S16 PtUiHitBndCfm (Pst *pst, SuId suId, U8 status);
...
static S16 PtUiHitUDatInd (Pst *pst, SuId suId, UConnId suConId, CmTptAddr *srcAddr, CmTptAddr *remAddr, CmIpHdrParm *ipHdrParm, Buffer *mBuf)


                                               ;


static S16 PtUiHitDatInd (Pst *pst, SuId suId, UConnId suConId, Buffer *mBuf)
                                               ;
static S16 PtUiHitDiscInd (Pst *pst, SuId suId, U8 choice, UConnId conId, Reason reason)
                                                               ;
static S16 PtUiHitDiscCfm (Pst *pst, SuId suId, U8 choice, UConnId conId, Action action)
                                                               ;
static S16 PtUiHitFlcInd (Pst *pst, SuId suId, UConnId suConId, Reason reason)
                                                                 ;
static HitConInd HiUiHitConIndMt[16] =
{
...
static HitConCfm HiUiHitConCfmMt[16] =
{
...
static HitBndCfm HiUiHitBndCfmMt[16] =
{
...
static HitDatInd HiUiHitDatIndMt[16] =
{
...
static HitUDatInd HiUiHitUDatIndMt[16] =
{
...
static HitDiscInd HiUiHitDiscIndMt[16] =
{
...
static HitDiscCfm HiUiHitDiscCfmMt[16] =
{
...
static HitFlcInd HiUiHitFlcIndMt[16] =
{
...
)
{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { snprintf((&(hiCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->procId, (&(hiCb.init))->ent, (&(hiCb.init))->inst,
                                                                    ...
                                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/tucl/hi_ptui.c"
   ,

                                                                    3397
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitConInd(pst, suId(%d), servConId(%ld)), spConId(%ld),            peerAddr(%p)\n", suId, servConId, spConId, (Ptr)peerAddr); SPrint((&(hiCb.init))->prntBuf); } }
...
)
{
   ...
   ,
                                                              ...
                                                              3472
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitConCfm(pst, suId(%d), suConId(%ld)), spConId(%ld),      localAddr(%p)\n", suId, suConId, spConId, (Ptr)localAddr); SPrint((&(hiCb.init))->prntBuf); } }
...

{
   ...
   ,
                                                                    3595
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitBndCfm(pst, suId(%d), status(%d)\n", suId, status); SPrint((&(hiCb.init))->prntBuf); } }
                                                                     ;
...

{
   ...
   ,
                                   ...
                                   3653
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDatInd(pst, suId(%d), suConId(%ld), mBuf(%p))\n", suId, suConId, (Ptr)mBuf); SPrint((&(hiCb.init))->prntBuf); } }
...
)
{
   ...
   ,
                                                               ...
                                                               3751
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitUDatInd(pst, suId(%d), suConId(%ld), srcAddr(%p),           mBuf(%p))\n", suId, suConId, (Ptr)srcAddr, (Ptr)mBuf); SPrint((&(hiCb.init))->prntBuf); } }
...
)
{
   ...
   ,
                                                       ...
                                                       3839
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDiscInd(pst, suId(%d), choice(%d), conId(%ld),           reason(%d))\n", suId, choice, conId, reason); SPrint((&(hiCb.init))->prntBuf); } }
...
)
{
   ...
   ,
                                                      ...
                                                      3910
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDiscCfm(pst, suId(%d), choice(%d), conId(%ld),           action(%d))\n", suId, choice, conId, action); SPrint((&(hiCb.init))->prntBuf); } }
...

{
   ...
   ,
                       ...
                       3974
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitFlcInd(pst, suId(%d), reason(%d))\n", suId, reason); SPrint((&(hiCb.init))->prntBuf); } }
