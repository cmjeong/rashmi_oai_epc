...
static S16 pjLimDiscSduCfm (PjCb *gCb, PjDlRbCb *pjRbCb, KwuDiscSduInfo *discSduCfm)
...

{
   ...
   datReq.lcType = (U8)((pjRbCb->rbType == 0) ?
                     5 : 4);


   datReq.sduId = sduId;

   return(PjLiKwuDatReq(&(pjSapCb->pst),pjSapCb->spId, &datReq, mBuf));
}
 S16 pjDlmSendDiscSdu
(
PjCb *gCb,
PjDlRbCb *pjRbCb,
U32 sduId
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xdb0001, L_DEBUG,suId, status, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c",250, "PjLiKwuBndCfm(SuId (%d), status (%d) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   (pst=pst);
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdb0002, L_DEBUG, kwuSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"   , 284   , "PjLiKwuBndCfm: For KWU SAP state=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;
   ...
   switch (kwuSap->state)
   {
      case 3:
      {
         pjStopTmr (tPjCb, (U32)kwuSap, 0x18);
...

{
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xdb0003,L_ERROR,DBG_UEID, datInd->rlcId.ueId, datInd->rlcId.cellId, datInd->rlcId.rbId, 0, 0,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"      ,                                                    378      , "CellId[%u]:UL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                     ;
...

{
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xdb0004,L_ERROR,DBG_UEID, datCfm->rlcId.ueId, datCfm->rlcId.cellId, datCfm->rlcId.rbId, 0, 0,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"      ,                                                    444      , "CellId[%u]:DL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                     ;
      { if (datCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) datCfm, (Size) sizeof(KwuDatCfmInfo), 0); datCfm = 0L; } };
      return(1);
   }
   ...
   pjCfm.numSdu = (U16)(datCfm->numSduIds);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xdb0005, L_DEBUG, flowCntrlInfo->rlcId.rbId, flowCntrlInfo->rlcId.rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"   , 507   , "PjLiKwuFlowCntrlInd(rbId(%d),rbType (%d), mBuf)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                           ;

   ret = pjDbmFetchDlRbCb (tPjCb,flowCntrlInfo->rlcId,&pjRbCb);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xdb0006,L_ERROR,DBG_UEID, flowCntrlInfo->rlcId.ueId, flowCntrlInfo->rlcId.cellId, flowCntrlInfo->rlcId.rbId, 0, 0,                                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"      ,                                                                  513      , "CellId[%u]:DL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                   ;
      { if (flowCntrlInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) flowCntrlInfo, (Size) sizeof(KwuFlowCntrlIndInfo), 0); flowCntrlInfo = 0L; } };
      return(1);
   }
...

{
   ...
   tPjCb = pjCb[pst->dstInst];;
   if ((pst->dstInst >= 2) || (tPjCb->init.cfgDone == 0))
   {
       { if (staInd != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staInd, (Size) sizeof(KwuStaIndInfo), 0); staInd = 0L; } };
       return(1);
   }


   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xdb0007, L_DEBUG, staInd->rlcId.rbId, staInd->rlcId.rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"   , 593   , "PjLiKwuStaInd(rbId(%d),rbType (%d), mBuf)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                 ;

   ret = pjDbmFetchDlRbCb (tPjCb,staInd->rlcId,&pjRbCb);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xdb0008,L_ERROR,DBG_UEID, staInd->rlcId.ueId, staInd->rlcId.cellId, staInd->rlcId.rbId, 0, 0,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"      ,                                                    599      , "CellId[%u]:DL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                     ;

      { if (staInd != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staInd, (Size) sizeof(KwuStaIndInfo), 0); staInd = 0L; } };
      return(1);
  }
  minSduCnt = (100 < 1024)?100:1024;
  if(staInd->numSdu > minSduCnt)
  {
      staInd->numSdu = (U16)minSduCnt;
    if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xdb0009,L_ERROR,DBG_RBID, pjRbCb->rbId, staInd->numSdu, minSduCnt, 0, 0,                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"    ,                                        609    , "numSdu [%u] in StaInd is more than acceptable limit [%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;
  }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xdb000a, L_DEBUG, rlcId.rbId, rlcId.rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"   , 667   , "PjLiKwuReEstCmpInd(rbId(%d),rbType (%d), mBuf)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                 ;

   ret = pjDbmFetchUlRbCb (tPjCb,rlcId,&ulRbCb);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xdb000b,L_ERROR,DBG_UEID, rlcId.ueId, rlcId.cellId, rlcId.rbId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"      ,                                    673      , "CellId[%u]:UL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
      return(1);
   }
 ...
 S16 PjLiKwuDiscSduCfm
(
Pst *pst,
SuId suId,
KwuDiscSduInfo *discInfo
)
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xdb000c, L_DEBUG, discInfo->rlcId.rbId, discInfo->rlcId.rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"   , 787   , "PjLiKwuDiscSduCfm (rbId(%d),rbType (%d), mBuf)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                  ;

   ret = pjDbmFetchDlRbCb (tPjCb,discInfo->rlcId,&pjRbCb);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xdb000d,L_ERROR,DBG_UEID, discInfo->rlcId.ueId, discInfo->rlcId.cellId, discInfo->rlcId.rbId, 0, 0,                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c"      ,                                                        793      , "CellId[%u]:DL RbId[%d] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                         ;
      { if (discInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) discInfo, (Size) sizeof(KwuDiscSduInfo), 0); discInfo = 0L; } };
      return(1);
  }
...

{
   ...
   if(pjRbCb->rbType == 0)
   {
      if((pjRbCb->rbId == 1) || (pjRbCb->ueCb->libInfo.state == 1))
      {
...

{
   ...
   ret = pjDlmProcessCfm(gCb, pjRbCb, datCfm, 0);
...

{
   ...
   if (gCb->init.cfgDone == 0)
   {
      return;
   }
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdb000e, L_DEBUG, pjRbCb->rbId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c",969, "pjLimStaInd(pjRbCb(%d), staInd)", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   ret = pjDlmProcessCfm(gCb, pjRbCb, staInd, 1);
...

{
   ...
   PjTxEnt *txEnt;
   U32 count = 0;
   U16 cfmsToUpperLayer = 0;

   ;;

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xdb000f, L_DEBUG, pjRbCb->rbId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lim.c",1102, "pjLimDiscSduCfm(pjRbCb(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   if((gCb->init.cfgDone == 0) || (discSduCfm->numSduIds == 0))
   {
      return(0);
   }
   ...
   while(count < discSduCfm->numSduIds)
   {
      ...
      if(txEnt != 0L)
      {
         if( pjRbCb->dlCb.cfmReqd)
         {
            ...
            datCfm.cfmSta[cfmsToUpperLayer++].status = 2;
         }
