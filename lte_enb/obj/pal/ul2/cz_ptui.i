...
extern S16 PtUiCztBndCfm (Pst * pst, SuId suId, U8 status);

extern S16 PtUiCztGpInd (Pst * pst, SuId suId, CztEvnt * gpInd);

extern S16 PtUiCztGpCfm (Pst * pst, SuId suId, CztEvnt * gpCfm);

extern S16 PtUiCztBmpInd (Pst * pst, SuId suId, CztEvnt * bmpEvnt);

extern S16 PtUiCztBmpCfm (Pst * pst, SuId suId, CztEvnt * bmpCfm);

extern S16 PtUiCztGpErrInd (Pst * pst, SuId suId, CztEvnt * gpErrInd);

extern S16 PtUiCztLclErrorInd (Pst * pst, SuId suId, CztLclErrInd * cztLclErrInd);

extern S16 PtUiCztRelCfm (Pst * pst, SuId suId, CztRlsCfm *rlsCfm);

extern S16 PtUiCztStatusInd (Pst * pst, SuId suId, CztStaInd * cztSta);

extern S16 PtUiCztDynamPeerAssocInd (Pst * pst, SuId suId, CztPeerAssocInd * peerAssocInd);

extern S16 PtUiCztAudCfm (Pst *pst, SuId suId, CztAudEvnt *audEvnt);




static const CztBndCfm CzUiCztBndCfmMt[3] =
{
...
static const CztGpInd CzUiCztGpIndMt[3] =
{
...
static const CztGpCfm CzUiCztGpCfmMt[3] =
{
...
static const CztBmpInd CzUiCztBmpIndMt[3] =
{
...
static const CztBmpCfm CzUiCztBmpCfmMt[3] =
{
...
static const CztGpErrInd CzUiCztGpErrIndMt[3] =
{
...
static const CztLclErrorInd CzUiCztLclErrorIndMt[3] =
{
...
static const CztRelCfm CzUiCztRelCfmMt[3] =
{
...
static const CztStatusInd CzUiCztStaIndMt[3] =
{
...
static const CztDynamPeerAssocInd CzUiCztDynamPeerAssocIndMt[3] =
{
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztBndCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",366, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztBndCfmMt[pst->selector])(pst, suId, status);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",370, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztGpInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",390, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztGpIndMt[pst->selector])(pst, suId, gpInd);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",394, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztGpCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",414, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztGpCfmMt[pst->selector])(pst, suId, gpCfm);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",418, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztBmpInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",438, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztBmpIndMt[pst->selector])(pst, suId, bmpEvnt);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",442, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztBmpCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",462, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztBmpCfmMt[pst->selector])(pst, suId, bmpCfm);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",466, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztGpErrInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",486, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztGpErrIndMt[pst->selector])(pst, suId, gpErrInd);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",490, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);

}



 S16 CzUiCztLclErrorInd
(
Pst * pst,
SuId suId,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztLclErrorInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",510, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztLclErrorIndMt[pst->selector])(pst, suId, cztLclErrInd);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",514, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztRelCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",534, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztRelCfmMt[pst->selector])(pst, suId, rlsCfm);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",538, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztStaInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",558, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztStaIndMt[pst->selector])(pst, suId, cztSta);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",562, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);

}



 S16 CzUiCztDynamPeerAssocInd
(
Pst * pst,
SuId suId,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztDynamPeerAssocInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",582, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*CzUiCztDynamPeerAssocIndMt[pst->selector])(pst, suId, peerAssocInd);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",586, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...
{
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"CzUiCztAudCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",617, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (*czUiCztAudCfmMt[pst->selector]) (pst, suId, audEvnt);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",621, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
}
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztBndCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",642, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (status=status);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",648, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztGpInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",668, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (gpInd=gpInd);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",674, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztGpCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",694, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (gpCfm=gpCfm);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",700, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztBmpInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",720, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (bmpEvnt=bmpEvnt);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",726, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztBmpCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",746, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (bmpCfm=bmpCfm);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",752, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztGpErrInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",772, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (gpErrInd=gpErrInd);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",778, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);

}



 S16 PtUiCztLclErrorInd
(
Pst * pst,
SuId suId,
CztLclErrInd * cztLclErrInd
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztLclErrorInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",798, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (cztLclErrInd=cztLclErrInd);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",804, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztRelCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",824, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (rlsCfm=rlsCfm);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",830, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);

}



 S16 PtUiCztStatusInd
(
Pst * pst,
SuId suId,
CztStaInd * cztSta
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztStatusInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",850, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (cztSta=cztSta);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",856, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);

}



 S16 PtUiCztDynamPeerAssocInd
(
Pst * pst,
SuId suId,
CztPeerAssocInd * peerAssocInd
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztDynamPeerAssocInd"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",876, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (peerAssocInd=peerAssocInd);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",882, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
...
{
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"PtUiCztAudCfm"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",913, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } }

   (pst=pst);
   (suId=suId);
   (audEvnt=audEvnt);

   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","/home/mrehwald/Desktop/Radisys/lte_enb/src/x2ap/cz_ptui.c",919, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
