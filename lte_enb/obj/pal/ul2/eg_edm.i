...
static S16 egUEncodeGmHdr (EgUEvnt *evntMsg, Buffer *mBuf);




static S16 egUDecodeGmHdr (EgUEvnt *evntMsg, Buffer *mBuf);





static S16 egUValidateGmHdr (EgUEvnt *evntMsg);





static U32 egEdmDecoder (EgUEvnt *egUEvnt,Buffer *mBuf,U32 msgType);

static S16 egEdmEncoder (EgUEvnt *evntMsg,Buffer *mBuf);

static U32 egEdmDecPvtExtIe (EgUEvnt *egUEvnt, U8 *pktBuffer, MsgLen *msgLen);

static U32 egEdmEncPvtExtIe (EgUIe *tmpIe, U8 *pktBuffer,MsgLen *pktOffset);
static S16 egUEncodeGmHdr
(
   EgUEvnt *evntMsg,
   Buffer *mBuf
 )
...

{
   ...
   if((tmpByte & 0x01) || (tmpByte & 0x02)||(tmpByte & 0x04))
   {
      extPres = 1;
   }
   ...
   { U16 nwWord = 0; nwWord = (U16)((((U32)(header->teId) >> 16) & 0xffffL)); hdr[--cnt] = (U8)((((U16)(nwWord) >> 8) & 0xff)); hdr[--cnt] = (U8)(((U16)(nwWord) & 0xff)); nwWord = (U16)(((U32)(header->teId) & 0xffffL)); hdr[--cnt] = (U8)((((U16)(nwWord) >> 8) & 0xff)); hdr[--cnt] = (U8)(((U16)(nwWord) & 0xff)); };
   ...
   if(header->seqNumber.pres)
   {
      hdr[--cnt] = (((U16)(header->seqNumber.val) >> 8) & 0xff);
      hdr[--cnt] = ((U16)(header->seqNumber.val) & 0xff);
   }
   else if(extPres)
   {
      hdr[--cnt] = 0;
   ...
   if(header->extHdr.udpPort.pres)
   {
      hdr[--cnt] = 64;
      hdr[--cnt] = 1;
      hdr[--cnt] = (((U16)(header->extHdr.udpPort.val) >> 8) & 0xff);
      hdr[--cnt] = ((U16)(header->extHdr.udpPort.val) & 0xff);
   }
   ...
   if(header->extHdr.pdcpNmb.pres)
   {
      hdr[--cnt] = 192;
      hdr[--cnt] = 1;
      hdr[--cnt] = (((U16)(header->extHdr.pdcpNmb.val) >> 8) & 0xff);
      hdr[--cnt] = ((U16)(header->extHdr.pdcpNmb.val) & 0xff);
   }
   ...
   if(header->msgType == EGT_GTPU_MSG_GPDU)
   {
      ...
      msgLen = (evntMsg->tPduSize) + (40 - cnt) - 0x08;




      hdr[40 - 3] = (U8)(((U16)(msgLen) >> 8) & 0xff);
      hdr[40 - 4] = (U8)((U16)(msgLen) & 0xff);
   }
   SAddPreMsgMult(&hdr[cnt], (40 - cnt), mBuf);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",427); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",466); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; }
   tmpByte |= 0x20;
   ...
   { U16 nwWord = 0; nwWord = (U16)((((U32)(statHdr->teId) >> 16) & 0xffffL)); preEncHdr[--cnt] = (U8)((((U16)(nwWord) >> 8) & 0xff)); preEncHdr[--cnt] = (U8)(((U16)(nwWord) & 0xff)); nwWord = (U16)(((U32)(statHdr->teId) & 0xffffL)); preEncHdr[--cnt] = (U8)((((U16)(nwWord) >> 8) & 0xff)); preEncHdr[--cnt] = (U8)(((U16)(nwWord) & 0xff)); };
   ...
   if(statHdr->seqNumber.pres)
   {
      preEncHdr[--cnt] = (((U16)(statHdr->seqNumber.val) >> 8) & 0xff);
      preEncHdr[--cnt] = ((U16)(statHdr->seqNumber.val) & 0xff);
   }
   else if(extPres)
   {
      preEncHdr[--cnt] = 0;
   ...
   if(statHdr->extHdr.udpPort.pres)
   {
      preEncHdr[--cnt] = 64;
      preEncHdr[--cnt] = 1;
      preEncHdr[--cnt] = (((U16)(statHdr->extHdr.udpPort.val) >> 8) & 0xff);
      preEncHdr[--cnt] = ((U16)(statHdr->extHdr.udpPort.val) & 0xff);
   }
   ...
   if(statHdr->extHdr.pdcpNmb.pres)
   {
      preEncHdr[--cnt] = 192;
      preEncHdr[--cnt] = 1;
      preEncHdr[--cnt] = (((U16)(statHdr->extHdr.pdcpNmb.val) >> 8) & 0xff);
      preEncHdr[--cnt] = ((U16)(statHdr->extHdr.pdcpNmb.val) & 0xff);
   }
   ...
   *hdrIndex = cnt;
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",627); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0); };
}
 S16 egUEncMsgReq
(
   EgUEvnt *evntMsg
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",674); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   if(retVal != 0)
   {
      ...
      { dgn.dgnVal[0].type = 2; dgn.dgnVal[0].t.mem.region = mem.region; dgn.dgnVal[0].t.mem.pool = mem.pool; egSendLmAlarm (4, 13, 15,(EgUstaDgn *)&dgn); };

      retVal = EGT_ERR_MEM_ALLOC_FAILED;
      { evntMsg->resultType = retVal; evntMsg->failedIeType = 0; evntMsg->failedMsgType = msgType; };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",803); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   tempLen = 0x02;
   { U8 nwByte[0x02]; nwByte[0] = (U8)((((U16)(encLen) >> 8) & 0xff)); nwByte[1] = (U8)(((U16)(encLen) & 0xff)); SRepMsg(nwByte[0], mBuf, tempLen++); SRepMsg(nwByte[1], mBuf, tempLen++); };
   ...
   evntMsg->resultType = 100;

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",858); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
}
 S16 egUDecMsgReq
(
   EgUEvnt *evntMsg
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",901); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };
   ...
   if(cmAllocEvnt(sizeof(EgUMsg), 256,
            &mem, (Ptr*)&evntMsg->egMsg) != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",927); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecMsgReq: Memory allocation failed for egMsg \n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                      ;
      ...
      cmMemset((U8*)&dgn, 0, sizeof(EgUstaDgn));
      { dgn.dgnVal[0].type = 2; dgn.dgnVal[0].t.mem.region = mem.region; dgn.dgnVal[0].t.mem.pool = mem.pool; egSendLmAlarm (4, 13, 15,(EgUstaDgn *)&dgn); };
      { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",935); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",937); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(EGT_ERR_MSG_UNABLE_TO_COMPLY); };
   }
   ...
   if(retVal != 0 && retVal != 0x48)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",947); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecMsgReq: Message header decoding is failed \n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                     ;



      { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",951); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };

      evntMsg->resultType = retVal;
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",954); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   if(retVal != 0x48)
   {
      ...
      if(retVal != 0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",967); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egEdmDecoder: IE decoding is failed \n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                            ;



         { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",971); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
         evntMsg->resultType = retVal;
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",973); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
      }
   }
   else
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",981); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Received Malformed Packet from Network: Message Type(%d) Teid=(%lu) \n", evntMsg->msgType,evntMsg->teid); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                               ;
   ...
   {
      { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",989); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); printf("%s\n", egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
   }
   ...
   evntMsg->resultType = 100;
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1006); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
}
static S16 egUDecodeGmHdr
(
   EgUEvnt *evntMsg,
   Buffer *mBuf
 )
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1058); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; };




   SGetReadPtr(mBuf, &pktBuffer, &msgLen);

   if (pktBuffer == 0L)
   {

      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1068); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egUDecodeGmHdr: pktBuffer is NULLP \n"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      return(1);
   }
   ...
   extPres = pktBuffer[pktOffset] & 0x07;
   pktOffset++;
   ...
   pktOffset++;
   { msgLen = pktBuffer[pktOffset] << 8 | pktBuffer[pktOffset+1]; pktOffset = pktOffset + 1; };
   pktOffset++;
   { evntMsg->egMsg->msgHdr.teId = pktBuffer[pktOffset] << 24 | pktBuffer[pktOffset+1] << 16 | pktBuffer[pktOffset+2] << 8 | pktBuffer[pktOffset+3]; pktOffset = pktOffset + 3; };
   ...
   if ( extPres & 0x02 )
   {
      evntMsg->egMsg->msgHdr.seqNumber.pres = 1;
      pktOffset++;
      { evntMsg->egMsg->msgHdr.seqNumber.val = pktBuffer[pktOffset] << 8 | pktBuffer[pktOffset+1]; pktOffset = pktOffset + 1; };
   }
   else if(extPres)
   {
   ...
   if ( extPres & 0x01 )
   {
      evntMsg->egMsg->msgHdr.nPduNmb.pres = 1;
      pktOffset++;
      ...
      while(0 != extHdrType)
      {
         ...
         switch (extHdrType)
         {
            ...
            case 64:
               ...
               if(extHdrLen == 0x01)
               {
                  evntMsg->egMsg->msgHdr.extHdr.udpPort.pres = 1;

                  pktOffset++;
                  { evntMsg->egMsg->msgHdr.extHdr.udpPort.val = pktBuffer[pktOffset] << 8 | pktBuffer[pktOffset+1]; pktOffset = pktOffset + 1; };
               ...
               else
               {
                  ...
                  retVal = (extHdrType >> 6 == 3) ? 31 : 32;
                  if(32 == retVal)
                  {
                     pktOffset += (0x04 * pktBuffer[pktOffset]) - 0x02;
                  }


                  { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1320); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Received Ext. Hdr :%d with wrong                      length : %d -- Actual length :%d\n", extHdrType, extHdrLen, 0x01); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
            ...
            case 192:
               ...
               if(extHdrLen == 0x01)
               {
                  evntMsg->egMsg->msgHdr.extHdr.pdcpNmb.pres = 1;

                  pktOffset++;
                  { evntMsg->egMsg->msgHdr.extHdr.pdcpNmb.val = pktBuffer[pktOffset] << 8 | pktBuffer[pktOffset+1]; pktOffset = pktOffset + 1; };
               ...
               else
               {
                  ...
                  { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1363); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Received Ext. Hdr :%d with wrong                      length : %d -- Actual length :%d\n", extHdrType, extHdrLen, 0x01); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
         ...
         if((retVal == 0 || retVal == 32) && (unKnownExtHdr == 0))
         {
         ...
         else if(retVal == 31 )
         {
            if(unKnownExtHdr == 1)
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1411); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Received UnSupported Ext. Hdr :%d with                   Comprehension Required\n", extHdrType); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
       ...
       break;
            ...
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1436); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Received Supported Ext. Hdr :%d with                   Comprehension Required with Wrong length field\n", extHdrType); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }


                                    ;
               retVal = EGT_ERR_WRONG_EXT_HDR;
      break;
            }
         }
         else if ((retVal == 32) && (unKnownExtHdr == 1))
         {
   ...
   if((retVal == 0) && (evntMsg->egMsg->msgHdr.msgType != EGT_GTPU_MSG_GPDU))
   {
   ...
   if((bufLen - 0x08 == msgLen) && (pktOffset+decBufLen+0x01 == bufLen))
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1496); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
   }
   else
   {
      ...
      if(evntMsg->egMsg->msgHdr.msgType == EGT_GTPU_MSG_GPDU)
      {
         ...
         { evntMsg->resultType = retVal; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; }
                                              ;
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1519); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retVal); };
      }
      else
      {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1523); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(0x48); };
   }
   }
}
static S16 egUValidateGmHdr
(
   EgUEvnt *evntMsg
 )
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1560); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); printf("%s\n", egCb.init.prntBuf); }; } ;; }

      hdr = &evntMsg->egMsg->msgHdr;

   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1566); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr Message Type (%d) \n", hdr->msgType); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
            ...
            (hdr->msgType == EGT_GTPU_MSG_ERROR_IND)) && (hdr->teId))
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1585); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr Invalid teid(%ld) for this message\n", hdr->teId); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                                   ;


      { evntMsg->resultType = retValue; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; }
                                           ;
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1590); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retValue); };
   ...
   else
   {
      ...
      if((hdr->msgType == EGT_GTPU_MSG_ECHO_REQ) || (hdr->msgType == EGT_GTPU_MSG_ECHO_RSP))
      {
         if(!hdr->seqNumber.pres)
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1697); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr(Sequence number not present for message %d\n", hdr->msgType); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                                                                    ;
            { evntMsg->resultType = retValue; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; }
                                                 ;
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1700); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retValue); };
         }

      }
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",1729); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); printf("%s\n", egCb.init.prntBuf); }; } return(retValue); };
}
static U32 egEdmDecoder
(
EgUEvnt *egUEvnt,
Buffer *mBuf,
U32 msgType
...

{
   ...
   switch(msgType)
   {
      ...
      case EGT_GTPU_MSG_END_MARKER:
         ...
         if(0 != egEdmDecPvtExtIe(egUEvnt,&pktBuffer[offset],&msgLen))
            return(1);
         break;
      case EGT_GTPU_MSG_ECHO_RSP:
         offset = 0;
         if((pktBuffer[offset] != 14) && (msgLen > 0))
         {
            printf("\nMandatory IE=[%s] Missing. ","Recovery");

            return(EGT_ERR_MSG_MISS_MAND_IE);
      ...
      case EGT_GTPU_MSG_ERROR_IND:
           offset = 0;
           if((pktBuffer[offset] != 16) && (msgLen > 0))
           {
           ...
           else
           {
              ...
              { tmpIe.t.valUnSgnd32 = pktBuffer[offset] << 24 | pktBuffer[offset+1] << 16 | pktBuffer[offset+2] << 8 | pktBuffer[offset+3]; offset = offset + 3; };
              offset++;
           ...
           if((pktBuffer[offset] != 133) && (msgLen > 0))
           {
           ...
           else
           {
               ...
               offset++;
               {
                  { tmpIe.t.ipAddr.addrType = pktBuffer[offset] << 8 | pktBuffer[offset + 1]; offset = offset + 2; if(tmpIe.t.ipAddr.addrType == 0x04) { { tmpIe.t.ipAddr.u.ipv4 = pktBuffer[offset] << 24 | pktBuffer[offset+1] << 16 | pktBuffer[offset+2] << 8 | pktBuffer[offset+3]; offset = offset + 3; } }}
                                                             ;
               }
               offset++;
               EgUUtilGmAppendIe(egUEvnt->egMsg,(EgUIe *)&tmpIe);
      ...
      case EGT_GTPU_MSG_SUPP_EXT_HDR_NTF:
            ...
            offset = 0;
            if((pktBuffer[offset] != 141) && (msgLen > 0))
            {
            ...
            else
            {
               ...
               for(i = 0; ((i < tmpIe.t.extHdrTypeLst.noOfExtHdrs) && (i < 2)) ; i++)
               {
      ...
      case EGT_GTPU_MSG_GPDU:
         ...
         break;
      default:
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",2003); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egEdmDecoder Unknown MsgType received" " (IE(%lu)) \n",msgType); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                    ;

         return(EGT_ERR_MSG_INV_TYPE);
         break;
   }
   return(0);
}
...

{
   ...
   while(*msgLen > 0)
   {
      if(pktBuffer[offset] != 255)
      {

         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",2037); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egEdmDecPvtExtIe Unknown IE received" " (IE(%d)) \n",pktBuffer[offset]); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                             ;
         return(1);
      }
      else
      {
         ...
         tmpIe.t.pvtExt.propVal.length = (tmpIe.t.pvtExt.propVal.length << 8 | pktBuffer[offset + 1]) - 0x02;
         offset = offset + 2;
         ...
         cmMemcpy((U8 *)&tmpIe.t.pvtExt.propVal.val,(const U8 *) &pktBuffer[offset],tmpIe.t.pvtExt.propVal.length);
...

{
   ...
   switch (msgType)
   {
     ...
     case EGT_GTPU_MSG_END_MARKER:
         ...
         ((((tmpNode) = ((&evntMsg->egMsg->u.egIeList)->crnt = (&evntMsg->egMsg->u.egIeList)->first)) != 0L) ? (tmpNode)->node : 0L);
         while(tmpNode != 0L)
         {
               ...
               if(tmpIe->ieType != 255)
               {
                  ...
                  { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",2110); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egEdmEncoder Unknown IE received" " (MsgType(%d) IE(%d), resultType(%d)) \n", msgType, tmpIe->ieType, EGT_ERR_INV_IE_VAL); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }

                                                               ;

                  { evntMsg->resultType = 1; evntMsg->failedIeType = tmpIe->ieType; evntMsg->failedMsgType = msgType; };
                  return(1);
               }
               else
               {
                  ...
                  if(0 != retVal)
                  {
                     { evntMsg->resultType = retVal; evntMsg->failedIeType = tmpIe->ieType; evntMsg->failedMsgType = msgType; };
                     printf("\n Failed to Encode EGU_IE_PVT_EXTN IE ");
                  }
               }


               ((((tmpNode) = ((&evntMsg->egMsg->u.egIeList)->crnt = ((&evntMsg->egMsg->u.egIeList)->crnt ? (&evntMsg->egMsg->u.egIeList)->crnt->next : (&evntMsg->egMsg->u.egIeList)->first)))!= 0L) ? (tmpNode)->node : 0L);
         }
         break;
      case EGT_GTPU_MSG_ECHO_RSP:
            ...
            while(tmpNode != 0L)
            {
                  ...
                  switch(tmpIe->ieType)
                  {
                     ...
                     default:
                        { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",2162); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egEdmEncoder Unknown IE received" " (MsgType(%d) IE(%d), resultType(%d)) \n", msgType, tmpIe->ieType, EGT_ERR_INV_IE_VAL); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }

                                                                     ;


                        { evntMsg->resultType = EGT_ERR_INV_IE_TYPE; evntMsg->failedIeType = tmpIe->ieType; evntMsg->failedMsgType = msgType; };
                        return(1);
                  }
             ...
             while(tmpNode != 0L)
             {
                ...
                switch(tmpIe->ieType)
                {
                  case 16:
                     ...
                     { pktBuffer[offset] = (tmpIe->t.valUnSgnd32 & 0xFF000000) >> 24; offset++; pktBuffer[offset] = (tmpIe->t.valUnSgnd32 & 0x00FF0000) >> 16; offset++; pktBuffer[offset] = (tmpIe->t.valUnSgnd32 & 0x0000FF00) >> 8; offset++; pktBuffer[offset] = (tmpIe->t.valUnSgnd32 & 0x000000FF); };
                     offset++;
                  ...
                  case 133:
                     ...
                     {
                     { pktBuffer[offset] = 0x00; offset++; pktBuffer[offset] = 0x04; offset++; { pktBuffer[offset] = (tmpIe->t.ipAddr.u.ipv4 & 0xFF000000) >> 24; offset++; pktBuffer[offset] = (tmpIe->t.ipAddr.u.ipv4 & 0x00FF0000) >> 16; offset++; pktBuffer[offset] = (tmpIe->t.ipAddr.u.ipv4 & 0x0000FF00) >> 8; offset++; pktBuffer[offset] = (tmpIe->t.ipAddr.u.ipv4 & 0x000000FF); } };
                     }
                     offset++;
                     break;
                  case 255:
                     ...
                     if(0 != retVal)
                     {
                        { evntMsg->resultType = retVal; evntMsg->failedIeType = tmpIe->ieType; evntMsg->failedMsgType = evntMsg->msgType; };
                        printf("\n Failed to Encode EGU_IE_PVT_EXTN IE ");
                     }
                     break;
                  default:
                     { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",2220); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egEdmEncoder Unknown IE received" " (MsgType(%d) IE(%d), resultType(%d)) \n", msgType, tmpIe->ieType, EGT_ERR_INV_IE_VAL); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
             ...
             while(tmpNode != 0L)
             {
                ...
                switch(tmpIe->ieType)
                {
                  case 141:
                     ...
                     break;
                   default:
                      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",2257); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egEdmEncoder Unknown IE received" " (MsgType(%d) IE(%d), resultType(%d)) \n", msgType, tmpIe->ieType, EGT_ERR_INV_IE_VAL); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }

                                                                   ;
                      { evntMsg->resultType = EGT_ERR_INV_IE_VAL; evntMsg->failedIeType = tmpIe->ieType; evntMsg->failedMsgType = msgType; };
                      return(1);
                }
      ...
      case EGT_GTPU_MSG_GPDU:
         ...
         break;
      default:
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",2273); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egEdmEncoder Unknown MsgType Received" " (MsgType(%d)) \n", msgType); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } }
                                                  ;

         { evntMsg->resultType = EGT_ERR_MSG_INV_TYPE; evntMsg->failedIeType = EGT_ERR_INV_IE_TYPE; evntMsg->failedMsgType = msgType; };
         return(1);
   }
   ...
   if(retVal != 0)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); printf("%s\n", egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","/home/mrehwald/Desktop/Radisys/lte_enb/src/egtpu/eg_edm.c",2283); printf("%s\n", egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); printf("%s\n", egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egEdmEncoder:Failed to Added Encoded Buffer to Message"); printf("%s\n", egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); printf("%s\n", egCb.init.prntBuf); }; } };
      if(tmpIe)
      {
         { evntMsg->resultType = retVal; evntMsg->failedIeType = tmpIe->ieType; evntMsg->failedMsgType = msgType; };
      }
      ...
      {
         { evntMsg->resultType = retVal; evntMsg->failedIeType = EGT_ERR_INV_IE_TYPE; evntMsg->failedMsgType = msgType; };
      }
...

{
   ...
   tmpLen = tmpIe->t.pvtExt.propVal.length + 0x02;
