...
static S16 kwUmmExtractHdr (KwCb *gCb, KwUlRbCb *rbCb, Buffer *pdu, KwUmHdr *umHdr)


                                                   ;

static Void kwUmmReAssembleSdus (KwCb *gCb, KwUlRbCb *rbCb, KwUmRecBuf *umRecBuf)

                                                              ;
static Void kwUmmFindNextVRUR (KwUmUl* umUl, KwSn nextSn)
{
   KwSn ur = (((umUl->vrUr) - ((*umUl).vrUh - (*umUl).umWinSz)) & ((*umUl).modBitMask));

   KwSn nextSnToCompare = (((nextSn) - ((*umUl).vrUh - (*umUl).umWinSz)) & ((*umUl).modBitMask));

   while (ur < nextSnToCompare)
   {
      if (!(umUl->recBuf[nextSn]))
      {
         umUl->vrUr = nextSn;
         break;
      }
      nextSn = (nextSn + 1) & umUl->modBitMask;
      nextSnToCompare = (((nextSn) - ((*umUl).vrUh - (*umUl).umWinSz)) & ((*umUl).modBitMask));
   }
}
static S16 kwUmmCheckSnInReordWindow (KwSn sn,
                                       const KwUmUl* const umUl)
{
   return ((((sn) - ((*umUl).vrUh - (*umUl).umWinSz)) & ((*umUl).modBitMask)) < (((umUl->vrUh) - ((*umUl).vrUh - (*umUl).umWinSz)) & ((*umUl).modBitMask)));
}
 Void kwUmmProcessPdus
(
KwCb *gCb,
KwUlRbCb *rbCb,
KwPduInfo *pduInfo
...

{
   ...
   pduCount = (pduInfo->numPdu < 4)? pduInfo->numPdu : 4;
   ...
   while (count < pduCount)
   {
      ...
      gCb->genSts.pdusRecv++;
      SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&tmpRecBuf, (Size) sizeof(KwUmRecBuf));
      if (kwUmmExtractHdr(gCb, rbCb, pdu, &(tmpRecBuf->umHdr)))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf00001,L_ERROR,DBG_RBID, rbCb->rlcId.rbId, rbCb->rlcId.ueId, rbCb->rlcId.cellId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_umm_ul.c"         ,                                    276         , "Header Extraction Failed UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) tmpRecBuf, (Size) sizeof(KwUmRecBuf)); tmpRecBuf = 0L; };
         SPutMsg(pdu);
         count++;
      ...
      ur = (((rbCb->m.umUl.vrUr) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));
      uh = (((rbCb->m.umUl.vrUh) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));
      seqNum = (((curSn) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));

      if (((ur < seqNum) && (seqNum < uh) && (rbCb->m.umUl.recBuf[curSn])) ||
          (seqNum < ur))
      {

         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf00002,L_DEBUG,DBG_RBID, rbCb->rlcId.rbId, curSn, rbCb->rlcId.ueId, rbCb->rlcId.cellId, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_umm_ul.c"         ,                                    303         , "Received a duplicate pdu with sn %d UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if (!kwUmmCheckSnInReordWindow(curSn,&rbCb->m.umUl))
      {
         *vrUh = (curSn + 1) & rbCb->m.umUl.modBitMask;



         if (!kwUmmCheckSnInReordWindow(*vrUr,&rbCb->m.umUl))
         {
            ...
            *vrUr = (*vrUh - rbCb->m.umUl.umWinSz) & rbCb->m.umUl.modBitMask;
            lowerEdge = (((*vrUr) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));

            while ((((sn) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask)) < lowerEdge)
            {
               if (recBuf[sn])
               {
                  kwUmmReAssembleSdus(gCb,rbCb,recBuf[sn]);
                  { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) recBuf[sn], (Size) sizeof(KwUmRecBuf)); recBuf[sn] = 0L; };
                  recBuf[sn] = 0L;
               }
               sn = (sn + 1) & rbCb->m.umUl.modBitMask;
            }
         }
      }
      if (recBuf[*vrUr])
      {
         KwSn sn = *vrUr;
         KwSn tSn = (((sn) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));
         KwSn tVrUr;


         KwSn nextVrUr = (*vrUr + 1) & rbCb->m.umUl.modBitMask;
         kwUmmFindNextVRUR(&rbCb->m.umUl, nextVrUr);


         tVrUr = (((*vrUr) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));
         while (recBuf[sn] && tSn < tVrUr)
         {
            ...
            recBuf[sn] = 0L;
            sn = (sn + 1) & rbCb->m.umUl.modBitMask;
            tSn = (((sn) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));
         }
      }

      tmrRunning = kwChkTmr(gCb,(U32)rbCb, 1);

      if (tmrRunning)
      {
         KwSn tVrUx = (((*vrUx) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));
         KwSn tVrUr = (((*vrUr) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));

         KwSn tVrUh = (((*vrUh) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));

         S16 ret = kwUmmCheckSnInReordWindow(*vrUx, &rbCb->m.umUl);

         if ( (tVrUx <= tVrUr) || ((!ret) && (tVrUx != tVrUh)))
         {
            kwStopTmr(gCb,(U32)rbCb,1);
            tmrRunning = 0;
         }
      }
      ...
      if (!tmrRunning)
      {
         if ((((*vrUh) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask)) > (((*vrUr) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask)))
         {
            kwStartTmr(gCb,(U32)rbCb,1);
            *vrUx = *vrUh;
         }
      }
      count++;
...
static Void kwUmmReAssembleSdus
(
KwCb *gCb,
KwUlRbCb *rbCb,
KwUmRecBuf *umRecBuf
      ...
      if (0 == count )
      {
         if (fi & 2)
         {
            ...
            else
            {
               ...
               if (*partialSdu)
               {
                  { if (*partialSdu != 0L) { SPutMsg(*partialSdu); } *partialSdu = 0L; };
                  *partialSdu = 0L;
               }
...

{
   ...
   vrUh = (((rbCb->m.umUl.vrUh) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask));
   recBuf = rbCb->m.umUl.recBuf;

   if(1 == kwChkTmr(gCb,(U32)rbCb,1))
   {
       kwStopTmr(gCb,(U32)rbCb,1);
   }

   while ((((curSn) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask)) < vrUh)
   {
      if ( recBuf[curSn] != 0L )
      {
         kwUmmReAssembleSdus(gCb,rbCb,recBuf[curSn]);
         { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) recBuf[curSn], (Size) sizeof(KwUmRecBuf)); recBuf[curSn] = 0L; };
         recBuf[curSn] = 0L;
      }
...

{
   ...
   while(e && umHdr->numLi < (2 * 100) )
   {
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf00003,L_ERROR,DBG_RBID, rbCb->rlcId.rbId, rbCb->rlcId.ueId, rbCb->rlcId.cellId, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_umm_ul.c"         ,                                    756         , "Received LI as 0 UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if ( pduSz <= totalSz )
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf00004,L_ERROR,DBG_RBID, rbCb->rlcId.rbId, umHdr->sn, rbCb->rlcId.ueId, rbCb->rlcId.cellId, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_umm_ul.c"         ,                                    766         , "SN [%d]: UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }



                                     ;
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf00005,L_ERROR,DBG_RBID, rbCb->rlcId.rbId, totalSz, pduSz, rbCb->rlcId.ueId, rbCb->rlcId.cellId,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_umm_ul.c"         ,                                    772         , "Corrupted PDU as TotSz[%lu] PduSz[%lu] UEID:%d CELLID:%d ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      if ( e && umHdr->numLi < (2 * 100))
      {
         U8 tmp = ((dst[1]) & 0x08) >> 3;
         umHdr->li[umHdr->numLi] = ( dst[1] & 0x07) << 8;

         ret = SRemPreMsg(dst,pdu);
         umHdr->li[umHdr->numLi] |= ( dst[0] );


         if ( 0 == umHdr->li[umHdr->numLi] )
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf00006,L_ERROR,DBG_RBID, rbCb->rlcId.rbId, rbCb->rlcId.ueId, rbCb->rlcId.cellId, 0, 0,                                       "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_umm_ul.c"            ,                                       807            , "Received LI as 0 UEID:%d CELLID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   prevVrUr = rbCb->m.umUl.vrUr;


   kwUmmFindNextVRUR(&rbCb->m.umUl, rbCb->m.umUl.vrUx);

   while ((((prevVrUr) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask)) <
          (((rbCb->m.umUl.vrUr) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask)))
   {
      if (rbCb->m.umUl.recBuf[prevVrUr])
      {
         kwUmmReAssembleSdus(gCb, rbCb, rbCb->m.umUl.recBuf[prevVrUr]);
         if(rbCb->m.umUl.recBuf[prevVrUr]->pdu != 0L)
         {
            { if (rbCb->m.umUl.recBuf[prevVrUr]->pdu != 0L) { SPutMsg(rbCb->m.umUl.recBuf[prevVrUr]->pdu); } rbCb->m.umUl.recBuf[prevVrUr]->pdu = 0L; };
         }
         { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCb->m.umUl.recBuf[prevVrUr], (Size) sizeof(KwUmRecBuf)); rbCb->m.umUl.recBuf[prevVrUr] = 0L; };
         rbCb->m.umUl.recBuf[prevVrUr] = 0L;
      }

      prevVrUr = (prevVrUr + 1) & rbCb->m.umUl.modBitMask;
   }

   if ((((rbCb->m.umUl.vrUh) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask)) >
       (((rbCb->m.umUl.vrUr) - ((rbCb->m.umUl).vrUh - (rbCb->m.umUl).umWinSz)) & ((rbCb->m.umUl).modBitMask)))
   {
      kwStartTmr(gCb,(U32)rbCb,1);
      rbCb->m.umUl.vrUx = rbCb->m.umUl.vrUh;
   }
}
 Void kwUmmFreeUlRbCb
(
KwCb *gCb,
KwUlRbCb *rbCb
)
...

{
   ...
   while (curSn < windSz)
   {
      if (umRecBuf[curSn] != 0L)
      {
         SPutMsg((umRecBuf[curSn]->pdu));;
         umRecBuf[curSn]->pdu = 0L;

         { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) umRecBuf[curSn], (Size) sizeof(KwUmRecBuf)); umRecBuf[curSn] = 0L; };
         umRecBuf[curSn] = 0L;
      }
      curSn++;
   }
   { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCb->m.umUl.recBuf, (Size) (windSz ) * sizeof(KwUmRecBuf*)); rbCb->m.umUl.recBuf = 0L; };
   rbCb->m.umUl.recBuf = 0L;
   return;
}
