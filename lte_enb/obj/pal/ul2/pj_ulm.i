...
extern U8 isSecBatchMode;
 ...
 S16 pjUtlChekTxEnqReq(PjCb *gCb, PjDlRbCb *pjRbCb, PjTxEnt *txEnt);
 S16 pjUtlChekRxEnqReq(PjCb *gCb, PjUlRbCb *pjRbCb, PjRxEnt *rxEnt);
static S16 pjUlmDrbFetchSn
(
PjCb *gCb,
PjUlRbCb *pjRbCb,
Buffer *pdu,
...
static Void pjUlmEnqueueUlPkt ( PjCb *gCb, PjUlRbCb *pjRbCb,PjSn sn, Buffer *pdu);



 S16 pjUlmHndlDlFdbk ( PjCb *gCb, PjUlRbCb *pjRbCb, Buffer *mBuf )
...

{
   ...
   if(res != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf50001,L_ERROR,DBG_UEID, pjRbCb->ueCb->key.ueId, 0, 0, 0, 0,                                                "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"      ,                                                194      , "Reserved Values Non-zero ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                 ;
      { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L; };
      { gCb->pjGenSts.errorPdusRecv++; };
      return(1);
   }
...

{
   ...
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&fbPkt, (Size) sizeof (UdxDlFdbkPktInfo), 0) != 0) { ret = 1; } }
                                     ;
   if(ret != 0)
   {
      fbPkt = 0L;
...
)
{
   ...
   else if (pjRbCb->snLen == 12)
   {
      ...
      if (res != 8)
      {
         do { if (!((gCb->init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2)))) { { sprintf (gCb->init.prntBuf," Reserved Values Non-zero \n"); SPrint(gCb->init.prntBuf); }; } }while(0)
                                                                  ;
         return(1);
      }
...

{
   ...
   else
   {
      ...
      if(pduType == 0x00)
      {
         ...
         if (ret != 0)
         {
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf50002,L_DEBUG,DBG_UEID, pjRbCb->ueCb->key.ueId, 0, 0, 0, 0,                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"            ,                                                                 580            , " pjUlmHndlDlStaRep() returned Failed ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                  ;
            { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L; };
            return(1);
         }
      }
      else if(pduType == 0x01)
      {
         ...
         if(res != 0)
         {
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf50003,L_DEBUG,DBG_UEID, pjRbCb->ueCb->key.ueId, 0, 0, 0, 0,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"            ,                                                    593            , " Reserved values non-null ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                     ;
            { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L; };
            { gCb->pjGenSts.errorPdusRecv++; };
            return(1);
         ...
         if (ret != 0)
         {
            if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf50004,L_DEBUG,DBG_UEID, pjRbCb->ueCb->key.ueId, 0, 0, 0, 0,                                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"            ,                                                         603            , " pjUlmHndlDlStaRep() returned Failed ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                          ;
            { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L; };
            return(1);
         }
      ...
      else
      {
         ...
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf50005,L_DEBUG,DBG_UEID, pjRbCb->ueCb->key.ueId, 0, 0, 0, 0,                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"         ,                                             612         , " Invalid PDU Type ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;
         { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L; };
         { gCb->pjGenSts.errorPdusRecv++; };
         return(1);
...

{
   ...
   { count = (((ulCb->rxHfn) << 5) | sn); };


   { if(sn < pjRbCb->ulCb.nxtRxSn) { pjRbCb->ulCb.rxHfn++; } pjRbCb->ulCb.nxtRxSn = (U16)((sn + 1) % (1 << pjRbCb->snLen)); if(pjRbCb->ulCb.nxtRxSn == 0) { pjRbCb->ulCb.rxHfn ++; } };
   ...
   ret = pjDbmInsRxEnt(gCb, &ulCb->recBuf, rxEnt, 0);
...

{
   ...
   sn = sn;
   ulCb = &pjRbCb->ulCb;
   { oldRxCnt = (((ulCb->rxHfn) << (pjRbCb->snLen)) | (ulCb->nxtRxSn)); };


   { if(sn < pjRbCb->ulCb.nxtRxSn) { pjRbCb->ulCb.rxHfn++; } pjRbCb->ulCb.nxtRxSn = (U16)((sn + 1) % (1 << pjRbCb->snLen)); if(pjRbCb->ulCb.nxtRxSn == 0) { pjRbCb->ulCb.rxHfn ++; } };
   { count = (((ulCb->rxHfn) << (pjRbCb->snLen)) | sn); };
   ;
   ;
...
)
{
   ...
   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&rxEnt, (Size) sizeof(PjRxEnt)) != 0) { (rxEnt) = 0L; } };
   ...
   rxEnt->lstEnt.next = 0L;
   rxEnt->lstEnt.prev = 0L;
   rxEnt->lstEnt.node = 0L;
   rxEnt->discFlag = rxEnt->dupEntry = 0;
   rxEnt->isOutSeq = isOutOfSeq;



   if(( (((sn - (ulCb->lastSubCnt % (1 << pjRbCb->snLen ))) % (1 << pjRbCb->snLen)) > (1 << (pjRbCb->snLen - 1))) || ((((ulCb->lastSubCnt % (1 << pjRbCb->snLen)) - sn) >= 0) && (((ulCb->lastSubCnt % (1 << pjRbCb->snLen)) - sn) < (1 << (pjRbCb->snLen - 1)))) ))
   {
      rxEnt->discFlag = 1;
      if(sn > ulCb->nxtRxSn)
      {
   ...
   else if((ulCb->nxtRxSn - sn) > (1 << (pjRbCb->snLen - 1)))
   {
      ulCb->rxHfn ++;
      ctxHfn ++;
      ulCb->nxtRxSn = (U16)(sn + 1);
      ;

   }

   else if((sn - ulCb->nxtRxSn) > (1 << (pjRbCb->snLen - 1)))
   {
         ctxHfn --;
   }
   ...
   if(isOutOfSeq == 0)
   {
      { pjRbCb->ulCb.fmsCount = ((pjRbCb->ulCb.rxHfn << pjRbCb->snLen) | pjRbCb->ulCb.nxtRxSn); };
   }
   ...
   ;
   ret = pjDbmInsRxEnt(gCb, &ulCb->recBuf, rxEnt, 1);
   if(ret == 12)
   {
   ...
   if(dupEntry == 1)
   {
      ...
      { if (rxEnt->mBuf != 0L) { SPutMsg(rxEnt->mBuf); } rxEnt->mBuf = 0L; };
      { if (rxEnt != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rxEnt, (Size) sizeof(PjRxEnt)); rxEnt = 0L; } };
      return(0);
   }
   else if(discFlag == 1)
   {
...

{
   ...
   if(secInfo->secAct == 1 && secInfo->cipherInfo.algoType != 0)
   {
      ...
      else
      {
         ...
         if( pjUtlDecipherReq(gCb, pjRbCb, rxEnt->count, rxEnt->mBuf, &mBuf) != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf50006, L_ERROR, rxEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1036, "Deciphering Req failed Rx Count [%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            { CmLtePdcpId _pdcpId; Buffer *_mBuf = 0L; PjuStaIndInfo _staInd; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.ulCb->pjuSap[0]); else _pjuSap = &(gCb->u.ulCb->pjuSap[1]); _pdcpId.ueId = pjRbCb->ueCb->key.ueId; _pdcpId.cellId = pjRbCb->ueCb->key.cellId; _pdcpId.rbId = pjRbCb->rbId; _pdcpId.rbType = pjRbCb->rbType; switch (rxEnt->state) { case 1: case 2: { _staInd.cause = 2; break; } case 3: case 4: { _staInd.cause = 1; _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; break; } case 5: case 6: { _staInd.cause = 3; if(pjRbCb->ulCb.discReqd == 0) { _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; } break; } default: break; } PjUiPjuStaInd(&(_pjuSap->pst), _pjuSap->suId, &_pdcpId, &_staInd, _mBuf); };
            pjDbmDelRxEnt(gCb, &ulCb->recBuf, rxEnt->count);
            { gCb->pjGenSts.numDeciphFails++; };
            return(1);
         }
     ...
     else
     {
      if(mBuf == 0L)
      {
       if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf50007, L_ERROR, rxEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1063, "Deciphering Req failed Rx Count [%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
       { CmLtePdcpId _pdcpId; Buffer *_mBuf = 0L; PjuStaIndInfo _staInd; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.ulCb->pjuSap[0]); else _pjuSap = &(gCb->u.ulCb->pjuSap[1]); _pdcpId.ueId = pjRbCb->ueCb->key.ueId; _pdcpId.cellId = pjRbCb->ueCb->key.cellId; _pdcpId.rbId = pjRbCb->rbId; _pdcpId.rbType = pjRbCb->rbType; switch (rxEnt->state) { case 1: case 2: { _staInd.cause = 2; break; } case 3: case 4: { _staInd.cause = 1; _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; break; } case 5: case 6: { _staInd.cause = 3; if(pjRbCb->ulCb.discReqd == 0) { _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; } break; } default: break; } PjUiPjuStaInd(&(_pjuSap->pst), _pjuSap->suId, &_pdcpId, &_staInd, _mBuf); };
       pjDbmDelRxEnt(gCb, &ulCb->recBuf, rxEnt->count);
       { gCb->pjGenSts.numDeciphFails++; };
       return(1);
     ...
     return(0);
         ...
         if(mBuf == 0L)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf50008, L_ERROR, rxEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1088, "Deciphering Req failed Rx Count [%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            { CmLtePdcpId _pdcpId; Buffer *_mBuf = 0L; PjuStaIndInfo _staInd; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.ulCb->pjuSap[0]); else _pjuSap = &(gCb->u.ulCb->pjuSap[1]); _pdcpId.ueId = pjRbCb->ueCb->key.ueId; _pdcpId.cellId = pjRbCb->ueCb->key.cellId; _pdcpId.rbId = pjRbCb->rbId; _pdcpId.rbType = pjRbCb->rbType; switch (rxEnt->state) { case 1: case 2: { _staInd.cause = 2; break; } case 3: case 4: { _staInd.cause = 1; _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; break; } case 5: case 6: { _staInd.cause = 3; if(pjRbCb->ulCb.discReqd == 0) { _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; } break; } default: break; } PjUiPjuStaInd(&(_pjuSap->pst), _pjuSap->suId, &_pdcpId, &_staInd, _mBuf); };
            pjDbmDelRxEnt(gCb, &ulCb->recBuf, rxEnt->count);
            { gCb->pjGenSts.numDeciphFails++; };
            return(1);
...

{
   ...
   { U16 _tmp16 = 0; Data _unPkArray[4] = {0}; SRemPstMsgMult(_unPkArray, (MsgLen)4, rxEnt->mBuf); _tmp16 = (U16) (U16) (((U16)((U8) _unPkArray[3]) << 8) | ((U16)(_tmp16) & 0x00ff)); _tmp16 = (U16) (U16) (((U16)((U8) _unPkArray[2]) & 0xff) | ((U16)(_tmp16) & 0xff00)); macI = (U32) (U32) (((U32)((U16) _tmp16) << 16) | ((U32)(macI) & (U32)0x0000ffff)); _tmp16 = (U16) (U16) (((U16)((U8) _unPkArray[1]) << 8) | ((U16)(_tmp16) & 0x00ff)); _tmp16 = (U16) (U16) (((U16)((U8) _unPkArray[0]) & 0xff) | ((U16)(_tmp16) & 0xff00)); macI = (U32) (U32) (((U32)((U16) _tmp16) & 0xffff) | ((U32)(macI) & (U32)0xffff0000)); };


   if(pjRbCb->ueCb->secInfo.secAct == 1 && pjRbCb->ueCb->secInfo.intInfo.algoType != 0)
   {
      ...
      sn = (U16)(rxEnt->count % (1 << 5));
      ret = SAddPreMsg((Data)sn, rxEnt->mBuf);
      if( pjUtlIntVerReq(gCb, pjRbCb, inParam, rxEnt->mBuf, macI, &status) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf50009, L_ERROR, rxEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1201, "Integrity Verification Req failed Rx Count[%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      if(status != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf5000a, L_ERROR, rxEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1233, "Integrity Verification Req failed Rx Count[%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { CmLtePdcpId _pdcpId; Buffer *_mBuf = 0L; PjuStaIndInfo _staInd; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.ulCb->pjuSap[0]); else _pjuSap = &(gCb->u.ulCb->pjuSap[1]); _pdcpId.ueId = pjRbCb->ueCb->key.ueId; _pdcpId.cellId = pjRbCb->ueCb->key.cellId; _pdcpId.rbId = pjRbCb->rbId; _pdcpId.rbType = pjRbCb->rbType; switch (rxEnt->state) { case 1: case 2: { _staInd.cause = 2; break; } case 3: case 4: { _staInd.cause = 1; _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; break; } case 5: case 6: { _staInd.cause = 3; if(pjRbCb->ulCb.discReqd == 0) { _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; } break; } default: break; } PjUiPjuStaInd(&(_pjuSap->pst), _pjuSap->suId, &_pdcpId, &_staInd, _mBuf); };
         pjDbmDelRxEnt(gCb, &ulCb->recBuf, rxEnt->count);
         { gCb->pjGenSts.numIntgVrfFails++; };
         return(1);
...

{
   ...
   if(pjRbCb->rohc.hdrCmpUsed == 1)
   {

      if(pjUtlDeCmpReq(gCb, pjRbCb,rxEnt->count, rxEnt->mBuf, &mBuf) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf5000b, L_ERROR, rxEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1300, "DeCompression Req failed Rx Count[%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { CmLtePdcpId _pdcpId; Buffer *_mBuf = 0L; PjuStaIndInfo _staInd; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.ulCb->pjuSap[0]); else _pjuSap = &(gCb->u.ulCb->pjuSap[1]); _pdcpId.ueId = pjRbCb->ueCb->key.ueId; _pdcpId.cellId = pjRbCb->ueCb->key.cellId; _pdcpId.rbId = pjRbCb->rbId; _pdcpId.rbType = pjRbCb->rbType; switch (rxEnt->state) { case 1: case 2: { _staInd.cause = 2; break; } case 3: case 4: { _staInd.cause = 1; _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; break; } case 5: case 6: { _staInd.cause = 3; if(pjRbCb->ulCb.discReqd == 0) { _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; } break; } default: break; } PjUiPjuStaInd(&(_pjuSap->pst), _pjuSap->suId, &_pdcpId, &_staInd, _mBuf); };
         pjDbmDelRxEnt(gCb, &ulCb->recBuf, rxEnt->count);
         { gCb->pjGenSts.numDecmpFails++; };
         return(1);
      }
      if(mBuf == 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf5000c, L_ERROR, rxEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1316, "DeCompression Req failed Rx Count[%lu]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { CmLtePdcpId _pdcpId; Buffer *_mBuf = 0L; PjuStaIndInfo _staInd; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(gCb->u.ulCb->pjuSap[0]); else _pjuSap = &(gCb->u.ulCb->pjuSap[1]); _pdcpId.ueId = pjRbCb->ueCb->key.ueId; _pdcpId.cellId = pjRbCb->ueCb->key.cellId; _pdcpId.rbId = pjRbCb->rbId; _pdcpId.rbType = pjRbCb->rbType; switch (rxEnt->state) { case 1: case 2: { _staInd.cause = 2; break; } case 3: case 4: { _staInd.cause = 1; _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; break; } case 5: case 6: { _staInd.cause = 3; if(pjRbCb->ulCb.discReqd == 0) { _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; } break; } default: break; } PjUiPjuStaInd(&(_pjuSap->pst), _pjuSap->suId, &_pdcpId, &_staInd, _mBuf); };
         pjDbmDelRxEnt(gCb, &ulCb->recBuf, rxEnt->count);
         { gCb->pjGenSts.numDecmpFails++; };
         return(1);
   ...
   if((rxEnt->discFlag == 1) ||
      (rxEnt->dupEntry == 1))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xf5000d, L_ERROR, rxEnt->discFlag, rxEnt->dupEntry, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1333, "Dropping packets...discflag is [%d], dupEntry is [%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(0);
   }
   ...
   rxEnt->state = 7;
   ;
   { if(pjRbCb->mode == 3) { pjUlmDeliverDrbAm(gCb,pjRbCb, rxEnt); } else { pjUlmDeliverDrbUm(gCb,pjRbCb, rxEnt); } };
...

{
   ...
   { CmLtePdcpId _pdcpId; Buffer *_mBuf; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) { _pjuSap = &(gCb->u.ulCb->pjuSap[0]); } else { _pjuSap = &(gCb->u.ulCb->pjuSap[1]); } _pdcpId.ueId = pjRbCb->ueCb->key.ueId; _pdcpId.cellId = pjRbCb->ueCb->key.cellId; _pdcpId.rbType = pjRbCb->rbType; _pdcpId.rbId = pjRbCb->rbId; _mBuf = rxEnt->mBuf; rxEnt->mBuf = 0L; if(gCb->init.trc == 1) { pjLmmSendTrc(gCb,0x44, _mBuf); } PjUiPjuDatInd(&(_pjuSap->pst), _pjuSap->suId, &_pdcpId, _mBuf); { if (pjRbCb->rbType == 0) gCb->u.ulCb->pjuSap[0].sts.txSdus++; else gCb->u.ulCb->pjuSap[1].sts.txSdus++; } };


   pjDbmDelRxEnt(gCb, &ulCb->recBuf, rxEnt->count);
   return(0);
}
 S16 pjUlmDeliverDrbUm
(
PjCb *gCb,
PjUlRbCb *pjRbCb,
PjRxEnt *rxEnt
...

{
   ...
   nxtSubCnt = ulCb->lastSubCnt + 1;
      ...
      if(rxEnt->isOutSeq == 0)
      {
         ...
         if(((&pjRbCb->ulCb.recBuf.datPktQ)->crnt))
         {

            tmpEnt = (PjRxEnt *) ((((&pjRbCb->ulCb.recBuf.datPktQ)->crnt))->node);
            if((rxEnt->count) > (tmpEnt->count))
            {
               ...
               {
                  { CmLtePdcpId _pdcpId; Buffer *_mBuf; PjPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) { _pjuSap = &(gCb->u.ulCb->pjuSap[0]); } else { _pjuSap = &(gCb->u.ulCb->pjuSap[1]); } _pdcpId.ueId = pjRbCb->ueCb->key.ueId; _pdcpId.cellId = pjRbCb->ueCb->key.cellId; _pdcpId.rbType = pjRbCb->rbType; _pdcpId.rbId = pjRbCb->rbId; _mBuf = tmpEnt->mBuf; tmpEnt->mBuf = 0L; if(gCb->init.trc == 1) { pjLmmSendTrc(gCb,0x44, _mBuf); } PjUiPjuDatInd(&(_pjuSap->pst), _pjuSap->suId, &_pdcpId, _mBuf); { if (pjRbCb->rbType == 0) gCb->u.ulCb->pjuSap[0].sts.txSdus++; else gCb->u.ulCb->pjuSap[1].sts.txSdus++; } };
...

{
   ...
   U8 numBits = 0;
   Bool nxtSnNotFnd;
   PjUlHoCfmInfo *hoInfo = 0L;
   U8 packByte[512] = {0};

   ;;

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xf5000e, L_DEBUG,pjRbCb->rbId, pjRbCb->rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1802, "pjUlmReEstDrbAm(pjRbCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };


   ulCb = &pjRbCb->ulCb;
   { cmMemset((U8 *)&(packByte), (U8)0, (sizeof(packByte))); };

   if(pjRbCb->state == 2)
   {

      if(ulCb->staRepReqd == 0)
      {
         return(0);
      }
   }
   ...
   fms = (U16)(pjRbCb->ulCb.fmsCount & (0x0fff));

   bitIdx = 8;

   idx = 1;
   ((&pjRbCb->ulCb.recBuf.datPktQ)->crnt = (&pjRbCb->ulCb.recBuf.datPktQ)->first);
   while(((&pjRbCb->ulCb.recBuf.datPktQ)->crnt))
   {
      nxtSnNotFnd = 1;
      tmpEnt = (PjRxEnt *) ((((&pjRbCb->ulCb.recBuf.datPktQ)->crnt))->node);

      sn = (U16)((tmpEnt->count) & (0x0fff));
      if(tmpEnt->isOutSeq == 0)
      {
      ...
      while((nxtSnNotFnd == 1) && (byteIdx < 512))
      {
   ...
   if(pjRbCb->state == 3)
   {
      ...
      if (numBits > 0)
      {
         if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf5000f,L_DEBUG,DBG_UEID, pjRbCb->ueCb->key.ueId, pjRbCb->rbId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"         ,                           1893         , "pjUlmReEstDrbAm : OutOfSeq UL Pkts are present for rbId = %d ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      { cmMemcpy((U8*)hoInfo->ulBitMap, (U8 *)packByte, (numBits / 8)); };
      }
   ...
   else
   {
      ...
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xf50010,L_DEBUG,DBG_UEID, pjRbCb->ueCb->key.ueId, 0, 0, 0, 0,                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"      ,                                                           1912      , "pjUlmReEstDrbAm : Sending PDCP Status Report ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                            ;
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xf50011, L_DEBUG,pjRbCb->rbId, pjRbCb->rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",1964, "pjUlmBldStaRep(pjRbCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   { if (SGetMsg(gCb->init.region, gCb->init.pool, (Buffer **)&staRep) != 0) { (staRep) = 0L; } };
   if (pjRbCb->snLen == 12)
   {
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xf50012, L_DEBUG, pjRbCb->rbId, pjRbCb->rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"   , 2056   , "pjUlmHdlDatFwdReq(pjRbCb(%d,%d), datFwdReq) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                      ;
   ...
   for( sduIndex = 0; sduIndex < datFwdReq->numSdus; sduIndex++)
   {
      ...
      { gCb->pjGenSts.numPktsRcvd++; };


      { if((pjRbCb->ulCb.nxtRxSn == 0) && (pjRbCb->ulCb.rxHfn == 0)) { { datFwdCnt = ((0 << pjRbCb->snLen) | (info->sn)); }; } else if((info->sn) >= pjRbCb->ulCb.nxtRxSn) { { datFwdCnt = (((pjRbCb->ulCb.rxHfn) << pjRbCb->snLen) | (info->sn)); }; } else { { datFwdCnt = (((pjRbCb->ulCb.rxHfn + 1) << pjRbCb->snLen) | (info->sn)); }; } };
      ...
      pjDbmInsRxEnt(gCb, &ulCb->recBuf, rxEnt, 0);
   }

   return(0);
}
 S16 pjUlmSubmitForDecmp
(
PjCb *gCb,
PjUlRbCb *pjRbCb,
PjRxEnt *rxEnt
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0xf50013, L_DEBUG, pjRbCb->rbId, pjRbCb->rbType, rxEnt->count, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"   , 2147   , "pjUlmSubmitForDecmp(pjRbCb(%d,%d),rxEnt(%ld)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
   ...
   if(pjUlmHdlDeCmp(gCb, pjRbCb, rxEnt) != 0)
   {
      return(1);
   }
   return(0);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xf50014, L_DEBUG, pjRbCb->rbId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",2628, "pjUlmStartDataFrwdPerRb (%d )) ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...
while(numSduCnt >0)
{
   ...
   else
   {
      ...
      if(SGetSBuf(pjuSap->pst.region,pjuSap->pst.pool,
         (Data **)&datFwdInd->datFwdInfo, (sizeof (PjuDatFwdInfo)* numSduTx)) != 0)
      {
          datFwdInd->datFwdInfo = 0L;
      }
   while (numSduTx>0)
   {

      tmpRxEnt = (PjRxEnt *) ((((&pjRbCb->ulCb.recBuf.datPktQ)->crnt))->node);
      sn = (U16)((tmpRxEnt->count) & (0x0fff));
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xf50015, L_DEBUG, pjRbCb->rbId, datFwdReq->numSdus, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c"   , 2800   , "pjDlmHndlDatFwdReq(pjRbCb (%d),datFwdReq(%d)) ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
   ...
   for ( numSdus = 0; numSdus < datFwdReq->numSdus; numSdus++ )
   {
      ...
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&rxEnt, (Size) sizeof(PjRxEnt)) == 0) { cmMemset((U8 *)(rxEnt), 0, sizeof(PjRxEnt)); } else { (rxEnt) = 0L; } };
      if(( (((sn - ((&pjRbCb->ulCb)->lastSubCnt % (1 << pjRbCb->snLen ))) % (1 << pjRbCb->snLen)) > (1 << (pjRbCb->snLen - 1))) || (((((&pjRbCb->ulCb)->lastSubCnt % (1 << pjRbCb->snLen)) - sn) >= 0) && ((((&pjRbCb->ulCb)->lastSubCnt % (1 << pjRbCb->snLen)) - sn) < (1 << (pjRbCb->snLen - 1)))) ))
      {
         rxEnt->discFlag = 1;
      ...
      else if((pjRbCb->ulCb.nxtRxSn - sn) > (1 << (pjRbCb->snLen - 1)))
      {
         pjRbCb->ulCb.rxHfn ++;
         ctxHfn ++;
         pjRbCb->ulCb.nxtRxSn = (U16)(sn + 1);
         ;

      }

      else if((sn - pjRbCb->ulCb.nxtRxSn) > (1 << (pjRbCb->snLen - 1)))
      {
         ctxHfn --;
      }
      ...
      ;
      ret = pjDbmInsRxEnt(gCb, &pjRbCb->ulCb.recBuf, rxEnt, 1);
      if(ret == 12)
      {
...

{
   ...
   ((((node) = ((&(pjRbCb->ulCb.ulPktLst))->crnt = (&(pjRbCb->ulCb.ulPktLst))->first)) != 0L) ? (node)->node : 0L);
   while (node != 0L)
   {
      ...
      pjUlmProcessDrbAm(gCb,pjRbCb, pkt->sn, pkt->pdu, 1);
      { if (pkt != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) pkt, (Size) sizeof (PjUlPkt)); pkt = 0L; } };
...

{
   ...
   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&pkt, (Size) sizeof(PjUlPkt)) == 0) { cmMemset((U8 *)(pkt), 0, sizeof(PjUlPkt)); } else { (pkt) = 0L; } };
   if (pkt != 0L)
   {
      pkt->sn = sn;
      pkt->pdu = pdu;
   ...
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xf50016, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_ulm.c",2989, "Memory allocation failure", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L; };
   }
