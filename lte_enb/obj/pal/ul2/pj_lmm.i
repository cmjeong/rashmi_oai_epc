...
extern S16 pjGetSId (SystemId *s);
...
U8 isSecBatchMode;
 ...
 PjCb *pjCb[2];
extern S16 pjActvTmr (Ent ent, Inst inst);

static S16 pjLmmSendCfm (Pst *pst,PjMngmt *cfm,U8 type,Header *hdr);
static S16 pjLmmGenCfg (PjCb *gCb,PjGenCfg *cfg);
static S16 pjLmmPjuSapCfg (PjCb *gCb,PjSapCfg *cfg);
static S16 pjLmmKwuSapCfg (PjCb *gCb,PjSapCfg *cfg);
static S16 pjLmmUdxSapCfg (PjCb *gCb,PjSapCfg *cfg);
static S16 pjLmmCpjSapCfg (PjCb *gCb,PjSapCfg *cfg);
static S16 pjLmmGenCntrl (PjCb *gCb,PjMngmt *cntrl);
static S16 pjLmmUdxSapCntrl (PjCb *gCb,PjMngmt *cntrl);
static S16 pjLmmLSapCntrl (PjCb *gCb,PjMngmt *cntrl);
static S16 pjLmmFormLmCfm (Pst *pst, Header *hdr, Reason reason);
static S16 pjLmmGetPjuSapSta (PjCb *gCb,PjPjuSapSta *sta);
static S16 pjLmmGetKwuSapSta (PjCb *gCb,PjKwuSapSta *sta);
static S16 pjLmmGetUdxSapSta (PjCb *gCb,PjUdxSapSta *sta);
static S16 pjLmmGetCpjSapSta (PjCb *gCb,PjCpjSapSta *sta);
static S16 pjLmmGetGenSts (PjCb *gCb,PjGenSts *sts,Action action);
static S16 pjLmmGetSapSts (PjCb *gCb,PjMngmt *sts,Elmnt elmnt,Action action);
static Void pjLmmCleanGblRsrcs (PjCb *gCb);
static S16 pjLmmGenCfg
(
PjCb *gCb,
PjGenCfg *cfg
)
...

{
   ...
   { cmMemcpy((U8*)&(gCb->pjGenCfg), (U8 *)cfg, sizeof(PjGenCfg)); };
   ...
   pjMemSize += (Size)(128 * sizeof(CmListEnt));


   pjMemSize += (Size)(10 * sizeof(CmListEnt));


   if(SGetSMem((gCb->init.region), pjMemSize,
              (&gCb->init.pool)) != 0)
   {
      return(4);
   }
   cmMemset((U8 *)&gCb->pjTq, 0, sizeof(CmTqType)*10);
   cmMemset((U8 *)&gCb->pjTqCp, 0, sizeof(CmTqCp));
   gCb->pjTqCp.tmrLen = 10;

   if(SRegCfgTmrMt(gCb->init.ent,gCb->init.inst,(U16)cfg->timeRes,100,pjActvTmr)
                         != 0)
   {
   ...
   {
      gCb->pjTq[cnt].first = 0L;
      gCb->pjTq[cnt].tail = 0L;
   }


   if (cfg->mode == 0x1)
   {
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.ulCb, (Size) sizeof(PjUlgCb)) == 0) { cmMemset((U8 *)(gCb->u.ulCb), 0, sizeof(PjUlgCb)); } else { (gCb->u.ulCb) = 0L; } };
      if (gCb->u.ulCb == 0L)
      {
        if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x870001, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",267, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      { cmMemset((U8 *)&(gCb->u.ulCb->pjuSap[0]), (U8)0, sizeof(PjPjuSapCb)); };
      { cmMemset((U8 *)&(gCb->u.ulCb->pjuSap[1]), (U8)0, sizeof(PjPjuSapCb)); };


      { cmMemset((U8 *)&(gCb->u.ulCb->kwuSap), (U8)0, (2 * sizeof(PjPjuSapCb))); };
      { cmMemset((U8 *)&(gCb->u.ulCb->udxUlSap), (U8)0, (1 * sizeof(PjUdxUlSapCb))); };


      { cmMemset((U8 *)&(gCb->u.ulCb->cpjSap), (U8)0, sizeof(PjCpjSapCb)); };
   ...
   {
      { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&gCb->u.dlCb, (Size) sizeof(PjDlgCb)) == 0) { cmMemset((U8 *)(gCb->u.dlCb), 0, sizeof(PjDlgCb)); } else { (gCb->u.dlCb) = 0L; } };
      if (gCb->u.dlCb == 0L)
      {
        if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x870002, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",299, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      ...
      { cmMemset((U8 *)&(gCb->u.dlCb->pjuSap[0]), (U8)0, sizeof(PjPjuSapCb)); };
      { cmMemset((U8 *)&(gCb->u.dlCb->pjuSap[1]), (U8)0, sizeof(PjPjuSapCb)); };


      { cmMemset((U8 *)&(gCb->u.dlCb->kwuSap), (U8)0, (2 * sizeof(PjPjuSapCb))); };
      { cmMemset((U8 *)&(gCb->u.dlCb->udxDlSap), (U8)0, (1 * sizeof(PjUdxDlSapCb))); };
...

{
   ...
   { cmMemset((U8 *)&cfm->hdr, (U8)'\0', sizeof(cfm->hdr)); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x870003, L_DEBUG, cfg->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",513, "PjMiLpjCfgReq(post, elmId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };

   ret = 0;


   if ((!(tPjCb->init.cfgDone & 2)) &&
         (cfg->hdr.elmId.elmnt != 1))
   {
      ...
      rCfm.cfm.status = 1;
      rCfm.cfm.reason = 8;
      pjLmmSendCfm(pst, &rCfm, 1, &cfg->hdr);
      return(1);
   }
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x870004, L_DEBUG, rCfm.cfm.status, rCfm.cfm.reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c"   , 584   , "Cfg  Req processed : status(%d) reason(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                             ;

   ret = pjLmmSendCfm(pst, &rCfm, 1, &cfg->hdr);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x870005, L_DEBUG, cntrl->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c"   , 669   , "Cntrl Req Received (post, elmId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;
   ...
   if (!(tPjCb->init.cfgDone & 2))
   {
      ...
      pjLmmSendCfm(pst, &rCfm, 2, &cntrl->hdr);
      return(1);
   }
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x870006, L_DEBUG, reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",721, "Cntrl Req  Processed sending cfm: reason(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0x870007, L_DEBUG, sta->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c"   , 761   , "Status  Req Received (post, elmId(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;

   { cmMemset((U8 *)&rSta, (U8)0, sizeof(PjMngmt)); };
   ...
   switch (elmnt)
   {
      ...
      case 185:
      {
         { cmMemcpy((U8*)&rSta.t.ssta.s.kwuSap, (U8 *)&sta->t.ssta.s.kwuSap, sizeof (PjKwuSapSta)); }
                                    ;
      ...
      case 189:
      {
         { cmMemcpy((U8*)&rSta.t.ssta.s.udxSap, (U8 *)&sta->t.ssta.s.udxSap, sizeof (PjUdxSapSta)); }
                                    ;
      ...
      case 188:
      {
         { cmMemcpy((U8*)&rSta.t.ssta.s.pjuSap, (U8 *)&sta->t.ssta.s.pjuSap, sizeof (PjPjuSapSta)); }
                                    ;
      ...
      case 187:
      {
         { cmMemcpy((U8*)&rSta.t.ssta.s.cpjSap, (U8 *)&sta->t.ssta.s.cpjSap, sizeof (PjCpjSapSta)); }
                                    ;
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x870008, L_DEBUG, rSta.cfm.status, rSta.cfm.reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c"   , 832   , "Sta Req processed - sending cfm: status(%d) reason(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                              ;

   ret = pjLmmSendCfm(pst, &rSta, 4, &sta->hdr);
...

{
   ...
   tPjCb = pjCb[pst->dstInst];;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x870009, L_DEBUG, action, sts->hdr.elmId.elmnt, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c"   , 890   , "Sts Req (post, elmId(%d),action(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                         ;

   { cmMemset((U8 *)&rSts, (U8)0, sizeof(PjMngmt)); };
   ...
   switch (elmnt)
   {
      ...
      case 188:
      {
         ...
         { cmMemcpy((U8*)&rSts.t.sts.s.pjuSap, (U8 *)&sts->t.sts.s.pjuSap, sizeof(PjPjuSts)); }
                                     ;
         break;
      }
      case 187:
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0x87000a, L_DEBUG, rSts.cfm.status, rSts.cfm.reason, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c"   , 933   , "Sts Req Processed - sending cfm: status(%d) reason(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                             ;

   ret = pjLmmSendCfm(pst, &rSts, 3, &sts->hdr);

   return(ret);
}
static S16 pjLmmPjuSapCfg
(
PjCb *gCb,
PjSapCfg *cfg
)
...

{
   ...
   kwuSap->pst.event = 0x00;
   kwuSap->suId = cfg->sapId;


   kwuSap->bndTmrInt = cfg->bndTmrIntvl;
   cmInitTimers(&kwuSap->bndTmr,1);
   kwuSap->state = 1;

   return(0);
}
static S16 pjLmmUdxSapCfg
(
PjCb *gCb,
PjSapCfg *cfg
)
...
static S16 pjLmmValidateGenCntrl
(
PjMngmt *cntrl
)
...

{
   ...
   || (cntrl->t.cntrl.s.sapCntrl.suId >= 2))
   {
      reason = 12;
      return(reason);
   }
   ...
   switch(action)
   {
      case 30:
      {
         if(udxSap->state != 2)
         {
            ...
            ret = pjStartTmr(gCb, (U32)udxSap, 0x19);
            if(ret == 1)
            {
               reason = 7;
            }
   ...
   switch(action)
   {
      case 30:
      {
         if(kwuSap->state != 2)
         {
            ...
            ret = pjStartTmr(gCb, (U32)kwuSap, 0x18);
            if(ret == 1)
            {
               reason = 7;
            }
...

{
   ...
   pjLmmSendCfm(pst, &rCfm, 2, hdr);

   return(ret);
}
static S16 pjLmmGetPjuSapSta
(
PjCb *gCb,
PjPjuSapSta *sta
)
...

{
   ...
   { cmMemcpy((U8*)sts, (U8 *)&(gCb->pjGenSts), sizeof (PjGenSts)); };

   if(action == 0)
   {
      genSts = &(gCb->pjGenSts);
      { cmMemset((U8 *)genSts, (U8)0, sizeof (PjGenSts)); };
   }

   return(0);
}
static S16 pjLmmGetSapSts
(
PjCb *gCb,
PjMngmt *sts,
Elmnt elmnt,
...

{
   ...
   pjuSapCb = (gCb->pjGenCfg.mode == 0x2)?
   ...
   if (action == 0)
   {
      { cmMemset((U8 *)&pjuSapCb->sts, (U8)0, sizeof (PjPjuSts)); };
   }
...
)
{
   ...
   { cmMemset((U8 *)&usta, (U8)0, sizeof(PjMngmt)); };
...

{
   ...
   { cmMemset((U8 *)&trc, (U8)0, sizeof(PjMngmt)); };
   ...
   if(mBuf != 0L)
   {
     ...
     if(gCb->trcLen == -1)
     {
            ...
            != 0)
        {
           ...
           if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x87000b, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",2773, "SCpyMsgMsg Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
           return(1);
        }
     ...
     else if(gCb->trcLen > 0)
     {
        ...
        {
           if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x87000c, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",2785, "SFndLenMsg Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
           return(1);
        }
        ...
        if(bufLen < gCb->trcLen)
        {
           ...
           if (SCpyMsgMsg(mBuf, pst.region, pst.pool, &dstMbuf)
              != 0)
           {
              if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x87000d, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",2796, "pjLmmSendTrc(): SCpyMsgMsg Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
           }
        ...
        if(bufLen >= gCb->trcLen)
        {
           ...
           {
              if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x87000e, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",2821, "SCpyMsgFix Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
           }

           if (SGetMsg(pst.region, pst.pool, &dstMbuf) != 0)
           {
              if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x87000f, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",2827, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
           }

           if (SCpyFixMsg(tempBuf,dstMbuf,0,gCb->trcLen,&tempCnt) != 0)
           {
              if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x870010, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_lmm.c",2833, "SCpyFixMsg Failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
              return(1);
           }
...
static Void pjLmmCleanGblRsrcs
(
PjCb *gCb
)
...

{
    ...
    ;
        ...
        if (gCb->init.cfgDone)
        {
            ...
            (Void) SDeregCfgTmrMt(gCb->init.ent,gCb->init.inst,(S16)gCb->pjGenCfg.timeRes,100,pjActvTmr)
                                                          ;



            kwSapSize = (Size)((Size)gCb->pjGenCfg.maxKwuSaps * (Size)sizeof(PjKwuSapCb));
            if (gCb->pjGenCfg.mode == 0x2)
            {
                if (gCb->u.dlCb)
                {
                    if (gCb->u.dlCb->kwuSap != (PjKwuSapCb *)0L)
                    {

                    }

                    { if (gCb->u.dlCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.dlCb, (Size) sizeof (PjDlgCb)); gCb->u.dlCb = 0L; } };
                }
            ...
            else
            {
                if (gCb->u.ulCb)
                {
                    if (gCb->u.ulCb->kwuSap != (PjKwuSapCb *)0L)
                    {

                    }

                    { if (gCb->u.ulCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) gCb->u.ulCb, (Size) sizeof (PjUlgCb)); gCb->u.ulCb = 0L; } };
                }
            }
