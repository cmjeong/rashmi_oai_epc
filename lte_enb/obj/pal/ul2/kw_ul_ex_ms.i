      ...
      case 0x0E:
         {
            switch(pst->event)
            {
               ...
               default:
                  ...
                  if (pst->dstInst < 2)
                  {
                     if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xce0001, L_FATAL, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_ul_ex_ms.c"                     , 290                     , "Received Invalid Event[%d] from SM", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
                  }
                  ret = 1;
                  break;
      ...
      case 0xd7:
         {
            switch(pst->event)
            {
               ...
               default:
                  ...
                  if (pst->dstInst < 2)
                  {
                      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xce0002, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_ul_ex_ms.c"                      , 335                      , "Received Invalid Event[%d] from RLC UL", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
                  }
                  ret = 1;
                  break;
      ...
      case 0xd9:
         {
            switch(pst->event)
            {
               ...
               default:
                  ...
                  if (pst->dstInst < 2)
                  {
                      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xce0003, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_ul_ex_ms.c"                      , 400                      , "Received Invalid Event[%d] from RRC", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
                  }
                  ret = 1;
                  break;
      ...
      case 0xd8:
         {
            switch(pst->event)
            {
               ...
               default:
                  ...
                  if (pst->dstInst < 2)
                  {
                      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xce0004, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_ul_ex_ms.c"                      , 431                      , "Received Invalid Event[%d] from PDCP", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
                  }
                  ret = 1;
                  break;
      ...
      case 0xd6:
         {
            switch(pst->event)
            {
               ...
               default:
                  ...
                  if (pst->dstInst < 2)
                  {
                      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xce0005, L_ERROR, pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_ul_ex_ms.c"                      , 470                      , "Received Invalid Event[%d] from MAC", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
                  }
                  ret = 1;
                  break;
      ...
      default:
         {
          if (pst->dstInst < 2)
           {
              if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xce0006, L_ERROR,pst->event, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_ul_ex_ms.c",524, "Received Invalid Source Entity[%d]", RLOG_FILE_ID, RLOG_MODULE_NAME); };
           }
            SPutMsg(mBuf);
            ret = 1;
            break;
