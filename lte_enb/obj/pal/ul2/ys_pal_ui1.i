...
extern Void postToApp (Buffer *mBuf, U8 radioType, U8 direction, U8 rntiType, U16 rnti,U16 ueid, U16 subframe, U8 isPredefinedData, U8 retx, U8 crcStatus)
                                                                         ...
                                                                         ;
static S16 ysCtfDelCellCfg ( CtfCellReleaseInfo *cellRel )

  ;

static S16 ysUiChkAndGetTfuSap ( SpId spId, YsTfuSapType type, YsTfuSapCb **tfuSapCb )
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 104); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 104); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiCtfBndReq(): suId = %d; spId = %d;\n", suId, spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ret = 0;
   ...
   if(spId == ysCb.ctfSap.spId)
   {
      ...
      {
         case 0:
            { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 121); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 121); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not Configured\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
            ret = TfUiCtfBndCfm(&retPst, suId, 2);
            break;

         case 1:
            { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 126); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 126); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not yet bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
            ysCb.ctfSap.sapState = 2;
            ...
            ret = TfUiCtfBndCfm(&ysCb.ctfSap.sapPst, suId, 1);
            break;

         case 2:
            { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 137); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 137); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP already bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
            ret = TfUiCtfBndCfm(&ysCb.ctfSap.sapPst, suId, 1);
            break;
         default:
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 195); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 195); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiCtfUbndReq: spId = %d; reason = %d \n", spId, reason); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if(spId == ysCb.ctfSap.spId)
   {
      switch (ysCb.ctfSap.sapState)
      {
         case 2:
            ...
            { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 204); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 204); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Is Bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
            ysCb.ctfSap.sapState = 1;
            break;
         default:
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst,
                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c"
   ,
                                         280
   ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst,
                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c"
   ,
                                         280
   ); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiCtfCfgReq(): spId = %d; transId = %s;\n", spId, transId.trans); SPrint((&ysCb.ysInit)->prntBuf); } }; } }
                                          ;


   ret = 0;

   if(ysUiChkAndGetCtfSap(spId, &ctfSapCb) != 0)
   {
      TfUiCtfCfgCfm(&ysCb.ctfSap.sapPst, ysCb.ctfSap.suId,
                     transId, 2);

      if( cfgReqInfo->vendorParams.paramBuffer != 0L )
      {
   ...
   switch(cfgReqInfo->cfgType)
   {
      ...
      case 1:
         {
            cellCb = ysUtlGetCellCfg(cfgReqInfo->u.cfg.u.cellCfg.cellId);
            if(0L == cellCb)
            {
               return(1);
            }
...

{
   ...
   ;
      ...
      { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 412); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 412); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysCtfDelCellCfg(): cellId = %d \n", cellRel->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ysCb.ttiReady = 0;


   cellCb = ysUtlGetCellCfg(cellRel->cellId);
   if(0L == cellCb)
   {
      return(1);
   }
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 541); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 541); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuBndReq(): suId = %d; spId = %d;\n", suId, spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   ret = ysUiChkAndGetTfuSap(spId, LYS_TFU_USR_SAP, &tfuSap);

   if ((0 != ret) || (0L == tfuSap) || (spId != tfuSap->spId))
   {




      TfUiTfuBndCfm(&retPst, suId, 2);
      return(1);
   }
   ...
   {
      case 0:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 572); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 572); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not Configured\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ret = TfUiTfuBndCfm(&retPst, suId, 2);
         break;

      case 1:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 577); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 577); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not yet bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         tfuSap->suId = suId;
         ...
         ret = TfUiTfuBndCfm(&tfuSap->sapPst, suId, 1);
         break;

      case 2:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 590); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 590); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP already bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ret = TfUiTfuBndCfm(&tfuSap->sapPst, suId, 1);
         break;
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 643); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 643); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuUbndReq: spId = %d; reason = %d \n", spId, reason); SPrint((&ysCb.ysInit)->prntBuf); } }; } };

   if(ysUiChkAndGetTfuSap(spId, LYS_TFU_USR_SAP, &tfuSapCb) != 0)
   {
      return(1);
   }
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 694); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 694); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuSchBndReq(): suId = %d; spId = %d;\n", suId, spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   ret = ysUiChkAndGetTfuSap(spId, LYS_TFU_SCH_SAP, &schTfuSap);

   if ((0 != ret) || (0L == schTfuSap) || (spId != schTfuSap->spId))
   {




      TfUiTfuSchBndCfm(&retPst, suId, 2);
      return(1);
   }
   ...
   {
      case 0:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 725); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 725); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not Configured\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ret = TfUiTfuSchBndCfm(&retPst, suId, 2);
         break;

      case 1:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 730); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 730); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not yet bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         schTfuSap->suId = suId;
         schTfuSap->sapPst.dstProcId = pst->srcProcId;
         schTfuSap->sapPst.dstEnt = pst->srcEnt;
         schTfuSap->sapPst.dstInst = pst->srcInst;

         schTfuSap->sapState = 2;

         ret = TfUiTfuSchBndCfm(&schTfuSap->sapPst, suId, 1);
         break;

      case 2:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 742); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 742); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP already bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ret = TfUiTfuSchBndCfm(&schTfuSap->sapPst, suId, 1);
         break;
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 795); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 795); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuSchUbndReq: spId = %d; reason = %d \n", spId, reason); SPrint((&ysCb.ysInit)->prntBuf); } }; } };

   if(ysUiChkAndGetTfuSap(spId, LYS_TFU_SCH_SAP, &tfuSapCb) != 0)
   {
      return(1);
   }
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 851); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 851); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuCntrlReq(): spId = %d;\n", spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   if((cellCb = ysUtlGetCellCfg(cntrlReq->cellId)) == 0L)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 865); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 865); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysUtlGetCellCfg Failed \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (cntrlReq != 0L) { cmFreeMem ((Ptr)(cntrlReq)); cntrlReq = 0L; }};
      return(1);
   }
   ...
   if(ret != 0)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 889); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 889); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "CntrlReq processing Failed \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (cntrlReq != 0L) { cmFreeMem ((Ptr)(cntrlReq)); cntrlReq = 0L; }};
      return(1);
   }
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 942); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 942); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuDatReq(): spId = %d;\n", spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if((cellCb = ysUtlGetCellCfg(datReq->cellId)) == 0L)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 952); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 952); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysUtlGetCellCfg Failed \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      ysUtlFreeDatReq(datReq);
      return(1);
   }

   if(cellCb->phyState != 2)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 959); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 959); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "PHY is not in running state \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      ysUtlFreeDatReq(datReq);
      return(1);
   }
   ...
   if(ret != 0)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1008); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1008); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to process Data Request\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      ysUtlFreeDatReq(datReq);
      return(1);
   }
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1067); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1067); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuRecpReq(): spId = %d;\n", spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };

   if(ysUiChkAndGetTfuSap(spId, LYS_TFU_SCH_SAP, &tfuSapCb) != 0)
   {
      { if (recpReq != 0L) { cmFreeMem ((Ptr)(recpReq)); recpReq = 0L; }};
      return(1);
   }

   if((cellCb = ysUtlGetCellCfg(recpReq->cellId)) == 0L)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1077); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1077); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysUtlGetCellCfg Failed \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (recpReq != 0L) { cmFreeMem ((Ptr)(recpReq)); recpReq = 0L; }};
      return(1);
   }
   ...
   if(cellCb->phyState != 2)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1084); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1084); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "PHY is not in running state \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (recpReq != 0L) { cmFreeMem ((Ptr)(recpReq)); recpReq = 0L; }};
      return(1);
   }
   ...
   if(ret != 0)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1098); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { snprintf((&ysCb.ysInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->procId, (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lteclpal/ys_pal_ui1.c", 1098); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to process Reception Request\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (recpReq != 0L) { cmFreeMem ((Ptr)(recpReq)); recpReq = 0L; }};
      return(1);
   }
...
static S16 ysUiChkAndGetTfuSap
(
SpId spId,
YsTfuSapType type,
YsTfuSapCb **tfuSapCb
...

{
   ...
   if (type == LYS_TFU_USR_SAP)
   {
      ...
      {
         sap = ysCb.tfuSapLst[indx];
         if((0L != sap) && (sap->spId == spId))
         {
            break;
         }
         sap = 0L;
