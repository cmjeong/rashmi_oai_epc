...
static S16 pjHdlCpjUlCfgReq (PjCb *gCb,PjCfgInfo *cfgInfo, UdxCfgCfmInfo *cfmInfo, CpjCfgCfmInfo *cfgCfm, Bool *sndCfgCfm)
                                                                              ;
 S16 PjUlUdxBndCfm
(
Pst * pst,
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe20001, L_DEBUG, suId, status, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",137, "PjUlUdxBndCfm(post, suId(%d), status(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;


   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20002, L_DEBUG, udxSap->state, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"   , 166   , "PjLiRguBndCfm: For RGU SAP state=%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                     ;
   ...
   switch (udxSap->state)
   {
      case 3:
      {
         pjStopTmr (tPjCb,(U32)udxSap, 0x19);
   ...
   pjLmmSendAlarm(tPjCb,2, event, cause, suId, 0);
...
)
{
   U8 idx;
   PjUlUeCb *ueCb = 0L;
   CpjCfgReqInfo *cfg = cfgInfo->cfgInfo;

   pjDbmFetchUlUeCb(tPjCb, cfg->ueId, cfg->cellId, &ueCb);
   if(!ueCb)
      return(0);
   ...
   {
      PjUlRbCb *ulRbCb = 0L;
      CpjCfgEnt *entCfg = &(cfg->cfgEnt[idx]);

      switch (entCfg->cfgType)
      {
         case 0x04:
         {
            { ulRbCb = (entCfg->rbType==0)?ueCb->srbCb[entCfg->rbId]:ueCb->drbCb[entCfg->rbId];};
            if(!ulRbCb)
            {
               printf("\ncould not find RB CB for %d type %d\n",
                     entCfg->rbId, entCfg->rbType);
               if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20003,L_DEBUG,DBG_UEID, cfg->ueId, entCfg->rbId, entCfg->rbType, 0, 0,                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"               ,                                                 241               , "Could not find RB CB for %d type %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
            ...
            if(ulRbCb->rbType != 0)
            {
               if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20004,L_DEBUG,DBG_UEID, cfg->ueId, entCfg->rbId, 0, 0, 0,                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"               ,                                 249               , "Processing local reestablishment confirm for %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20005, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",293, "PjUlUdxBndCfm(post, suId(%d), )", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb,cfmInfo->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20006, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",313, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (cfmInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) cfmInfo, (Size) sizeof (UdxCfgCfmInfo), 0); cfmInfo = 0L; } };
      return(1);
   }
   ...
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20007, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",322, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      { if (cfmInfo != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) cfmInfo, (Size) sizeof (UdxCfgCfmInfo), 0); cfmInfo = 0L; } };
      { if (cfgInfo->cfgInfo != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) cfgInfo->cfgInfo, (Size) sizeof(CpjCfgReqInfo)); cfgInfo->cfgInfo = 0L; } };
   ...
   pjTipChkSndReestCmpInd(tPjCb, cfgInfo);
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20008, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",391, "PjUlUdxReEstCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb, reEstCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20009, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",409, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (reEstCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) reEstCfm, (Size) sizeof (UdxReEstCfmInfo), 0); reEstCfm = 0L; } };
      return(1);
   }
   ...
   if(SGetSBuf(cpjSap->pst.region,cpjSap->pst.pool,(Data **)&cpjReEstCfm,
      sizeof (CpjReEstCfmInfo)) != 0)
   {


      { if (reEstCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) reEstCfm, (Size) sizeof (UdxReEstCfmInfo), 0); reEstCfm = 0L; } };
      { if (cfgInfo->reEstReq != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) cfgInfo->reEstReq, (Size) sizeof(CpjReEstReqInfo)); cfgInfo->reEstReq = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2000a, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",425, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe2000b, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",489, "PjUlUdxUeIdChgCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   cpjSap = &(tPjCb->u.ulCb->cpjSap);

   ret = pjDbmFindUlTransIdLst(tPjCb,secCfgCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2000c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",506, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (secCfgCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) secCfgCfm, (Size) sizeof (UdxSecCfgCfmInfo), 0); secCfgCfm = 0L; } };
      return(1);
   }
   ...
   if(SGetSBuf(cpjSap->pst.region,cpjSap->pst.pool,(Data **)&cfgCfm,
      sizeof (CpjSecCfgCfmInfo)) != 0)
   {


      { if (secCfg != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) secCfg, (Size) sizeof(CpjSecCfgReqInfo)); secCfg = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2000d, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",521, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ( pjCfgPrcSecUlCfg(tPjCb,secCfg,cfgCfm) != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2000e,L_ERROR,DBG_UEID, secCfg->ueId, secCfg->cellId, cfgCfm->reason, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                                          529      , "PjUiCpjSecCfgReq  cellId(%d) pjCfgSecCfg Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   {
        if (secCfgCfm->status != 1)
        {
            { cmMemcpy((U8*)cfgCfm, (U8 *)secCfgCfm, sizeof (CpjSecCfgCfmInfo)); };
        }
   }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe2000f, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",602, "PjUlUdxUeIdChgCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb, transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20010, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",619, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if ( (ret = pjCfgUlUeIdChng(tPjCb,cfgInfo->ueInfo,
                      cfgInfo->newUeInfo, &tStatus)) != 0)
   {

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20011,L_ERROR,DBG_UEID, cfgInfo->ueInfo->ueId, cfgInfo->ueInfo->ueId, cfgInfo->newUeInfo->ueId, cfgInfo->newUeInfo->cellId, status.reason,                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                                                      635      , "Cpj UeId Chg Req" " old-ueId(%d), new-ueId(%d), cellId(%d))Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   { if (cfgInfo->ueInfo != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) cfgInfo->ueInfo, (Size) sizeof(CpjUeInfo)); cfgInfo->ueInfo = 0L; } };
   { if (cfgInfo->newUeInfo != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) cfgInfo->newUeInfo, (Size) sizeof(CpjUeInfo)); cfgInfo->newUeInfo = 0L; } };
   { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20012, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",693, "PjUlUdxUeIdChgCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb, cntCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20013, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",710, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (cntCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) cntCfm, (Size) sizeof (UdxCountCfmInfo), 0); cntCfm = 0L; } };
      return(1);
   }
   cpjSap = &tPjCb->u.ulCb->cpjSap;
   countReq = cfgInfo->cntReq;
   if(SGetSBuf(cpjSap->pst.region,cpjSap->pst.pool,(Data **)&countCfm,
      sizeof (CpjCountCfmInfo)) != 0)
   {
      ...
      { if (cntCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) cntCfm, (Size) sizeof (UdxCountCfmInfo), 0); cntCfm = 0L; } };
      { if (countReq != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) countReq, (Size) sizeof(CpjCountReqInfo)); countReq = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20014, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",726, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };

      return(1);
   }
   { cmMemcpy((U8*)countCfm, (U8 *)cntCfm, sizeof(CpjCountCfmInfo)); };
   if ( pjCfgPrcUlCount(tPjCb, countReq, countCfm, cntCfm) != 0 )
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20015,L_ERROR,DBG_UEID, countReq->ueId, countReq->cellId, countCfm->reason, 0, 0,                                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                                                  735      , "PjUiCpjCountReq cellId(%d)  pjCfgSecCfg Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe20016, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",786, "PjUlUdxSduStaCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;
   cpjSap = &(tPjCb->u.ulCb->cpjSap);
   ret = pjDbmFindUlTransIdLst(tPjCb, staCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20017, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",803, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (staCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staCfm, (Size) sizeof (UdxSduStaCfmInfo), 0); staCfm = 0L; } };
      return(1);
   }
   ...
   if (0 == staCfm->status)
   {
      if (pjCfgPrcUlSduSta(tPjCb, staReq, staCfm) != 0 )
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20018,L_ERROR,DBG_UEID, staReq->ueId,staReq->cellId, 0, 0, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"         ,                                                                             815         , "PjUlUdxSduStaReq ,cellId(%d) pjCfgSecCfg Failed", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                              ;
   ...
   else
   {
      ...
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe20019, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",827, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         { if (staCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) staCfm, (Size) sizeof (UdxSduStaCfmInfo), 0); staCfm = 0L; } };
         { if (cfgInfo->staReq != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) cfgInfo->staReq, (Size) sizeof(CpjSduStaReqInfo)); cfgInfo->staReq = 0L; } };
         { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
         return(1);
      }
      ...
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2001a,L_DEBUG,DBG_UEID, staCfm->ueId,staCfm->cellId, 0, 0, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                                                                             841      , "PjUlUdxSduStaCfm- UdxSduStaCfm fail - cellId(%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                              ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe2001b, L_DEBUG, suId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",886, "PjUlUdxDatResumeCfm(post, suId(%d), ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   udxSap = tPjCb->u.ulCb->udxUlSap + suId;

   ret = pjDbmFindUlTransIdLst(tPjCb, udxDatResumeCfm->transId, &cfgInfo);
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2001c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",903, "Invalid transId", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (udxDatResumeCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) udxDatResumeCfm, (Size) sizeof (UdxDatResumeCfmInfo), 0); udxDatResumeCfm = 0L; } };
      return(1);
   }
   ...
   if(SGetSBuf(cpjSap->pst.region,cpjSap->pst.pool,(Data **)&datResumeCfmInfo,
      sizeof (CpjDatResumeCfmInfo)) != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xe2001d, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c",918, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      { if (udxDatResumeCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) udxDatResumeCfm, (Size) sizeof (UdxDatResumeCfmInfo), 0); udxDatResumeCfm = 0L; } };
      { if (cfgInfo->datResReq != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) cfgInfo->datResReq, (Size) sizeof(CpjDatResumeReqInfo)); cfgInfo->datResReq = 0L; } };
      { if (cfgInfo != 0L) { (Void) SPutSBuf(tPjCb->init.region, tPjCb->init.pool, (Data *) cfgInfo, (Size) sizeof (PjCfgInfo)); cfgInfo = 0L; } };
      return(1);
   }
...

{
   ...
   if( 0 != ret || 0L == ueCb)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2001e,L_ERROR,DBG_CELLID, datFwdCfm->cellId, datFwdCfm->ueId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"      ,                           979      , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
      { if (datFwdCfm != 0L) { (Void) SPutStaticBuffer(pst->region, pst->pool, (Data *) datFwdCfm, (Size) sizeof(UdxDatFwdCfmInfo), 0); datFwdCfm = 0L; } };
      return(ret);
   }
   ...
   if(ueCb->isUlDatFwdReqd == 1)
   {
      ...
      for(rbCnt = 0; rbCnt < 32; rbCnt++)
      {
         ...
         if((pjRbCb->mode == 3) && (ueCb->libInfo.state == 3))
         {
...
)
{
   ...
   for (idx = 0; idx < cfg->numEnt && idx < 10; idx++)
   {
      ...
      {
         if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe2001f,L_INFO,DBG_CELLID, cfg->cellId, cfg->ueId, 0, 0, 0,                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"         ,                     1089         , "UeId[%u] not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                      ;
      ...
      switch (entCfg->cfgType)
      {
         case 0x01:
            {
               if (entCfg->m.addCfg.rlcInfo.dir & 1)
               {
                  U8 isHo;
                  isHo = cfg->isHo;
                              ...
                              entCfg, &ueCb, entCfgCfm) != 0)
                  {
                      ...
                      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20020,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                      ,                                                                                 1114                      , "UL RB Addition for" "cellId(%d),rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                  ...
                  if (entCfg->m.addCfg.rlcInfo.dir & 2)
                  {
                      ...
                      {
                        { cmMemcpy((U8*)entCfgCfm, (U8 *)entDlCfgCfm, sizeof(CpjCfmEnt)); }
                                                           ;
                      }
                  }
               }
               else if (entCfg->m.addCfg.rlcInfo.dir & 2)
               {
                 { cmMemcpy((U8*)entCfgCfm, (U8 *)entDlCfgCfm, sizeof(CpjCfmEnt)); };
               }
               break;
         ...
         case 0x02:
            {
               if ((entCfg->m.modCfg.bitFlag & 0x01) ||
                   (entCfg->m.modCfg.hoInfo.isHoPres & 1))
               {

                  if (pjCfgReCfgUlRb(gCb,ueCb, entCfg, entCfgCfm) != 0)
                  {

                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20021,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                     ,                                                                             1157                     , "RB Config Modify HO" "for cellId(%d), rbId(%d) Failed :reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
               ...
               else if (entCfg->m.modCfg.hdrCompCfg.hdrCompUsed)
               {
                  ...
                  if (pjCfgReCfgUlRb(gCb,ueCb, entCfg, entCfgCfm) != 0)
                  {
                     ...
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20022,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                     ,                                                                             1189                     , "UL RB Modify Normal" " for cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                                              ;

                     if (entCfgCfm->reason == 6)
                     {
                       { cmMemcpy((U8*)entCfgCfm, (U8 *)entDlCfgCfm, sizeof(CpjCfmEnt)); };
                     }
                  }
                  if ((entDlCfgCfm->reason != 6) &&
                     (entDlCfgCfm->status != 1))
                  {
         ...
         case 0x03:
            {
               ...
               if (pjCfgDelUlRb(gCb,ueCb,entCfg, entCfgCfm) != 0)
               {

                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20023,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                  ,                                                                           1230                  , "Ul RB Delete for" "cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                                            ;

               }
               if ((entDlCfgCfm->status != 1) || (entCfgCfm->status != 1))
               {
                   { cmMemcpy((U8*)entCfgCfm, (U8 *)entDlCfgCfm, sizeof(CpjCfmEnt)); }
                                                      ;
               }
         ...
         case 0x04:
            {
               ...
               if (pjCfgReEstUlRb(gCb,ueCb,entCfg, entCfgCfm, entDlCfgCfm) != 0)
               {
                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20024,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                  ,                                                                              1248                  , "UL RB Re-establish " "for cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         case 0x05:
            {
               ...
               if (pjCfgDelUlUe(gCb,ueCb,entCfg, entCfgCfm) != 0)
               {

                  if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20025,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, cfg->cfgEnt[idx].rbId, entCfgCfm->reason, 0,                                                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"                  ,                                                                           1267                  , "UL UE Delete for " "cellId(%d), rbId(%d) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
         ...
         default:
            {
               ...
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xe20026,L_ERROR,DBG_UEID, cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->cfgEnt[idx].rbId, 14,                                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_udx_ul.c"               ,                                                                    1294               , "Cfg Req with Invalid Cfg" "Type cellId(%d), cfgType(%d), rbId(%d)) Failed: reason (%d)", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if (cfmType & 0x04)
   {
      ...
      {
         pjUtlUlSaveCfmInfo(gCb, ueCb, cfmType, startTmr, 0xd8, (U32)cfgCfm, (U32)cfg);
         cpjSap = &(gCb->u.ulCb->cpjSap);
         { if (cfgCfm != 0L) { (Void) SPutSBuf(cpjSap->pst.region, cpjSap->pst.pool, (Data *) cfgCfm, (Size) sizeof(CpjCfgCfmInfo)); cfgCfm = 0L; } };
         *sndCfgCfm = 0;
      }
   }
   else
