...
static S16 rgCFGVldtCrgDedLcCfg (Inst inst,CrgLchCfg *lcCfg, RgCellCb **cell, RgUeCb **ue, RgErrInfo *errInfo)
                                          ;
static S16 rgCFGVldtCrgCmnLcCfg (Inst inst,CrgLchCfg *lcCfg, RgCellCb **cell, RgErrInfo *errInfo)
                             ;
static S16 rgCFGCrgDedLcCfg (RgCellCb *cell, RgUeCb *ue, CrgLchCfg *lcCfg, RgErrInfo *errInfo)
                                               ;
static S16 rgCFGCrgCmnLcCfg (Inst inst,RgCellCb *cell, CrgLchCfg *lcCfg, RgErrInfo *errInfo)
                             ;
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1;
   if ((rgCb[inst].cell != 0L)
         || rgCb[inst].inactiveCell != 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40001,L_ERROR,DBG_CELLID, cellCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",143, "Cell already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40002,L_ERROR,DBG_CELLID, cellCfg->cellId, cellCfg->bwCfg.ulTotalBw, cellCfg->bwCfg.dlTotalBw, 0, 0,                                                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                                              153      , "Invalid Bandwidth configuration: ul %d dl %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }

                                                               ;
      return(1);
   }
   if (cellCfg->rachCfg.maxMsg3Tx < 1)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40003,L_ERROR,DBG_CELLID, cellCfg->cellId,cellCfg->rachCfg.maxMsg3Tx, 0, 0, 0,                                                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                                                                     159      , "Invalid RACH configuration: maxMsg3Tx %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                                      ;
      return(1);
   }
   ...
   {
      { if ((&rgCb[inst].rgInit)->dbgMask & ((0x00000100 << 1))) { snprintf((&rgCb[inst].rgInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "MAC", (&rgCb[inst].rgInit)->procId, (&rgCb[inst].rgInit)->ent, (&rgCb[inst].rgInit)->inst,


                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"
      ,


                               169
      ); SPrint((&rgCb[inst].rgInit)->prntBuf); sprintf (rgCb[inst].rgInit.prntBuf, "Invald Sap Id: DL %d UL %d for CellId %d failed\n", cellCfg->rguDlSapId, cellCfg->rguUlSapId, cellCfg->cellId); SPrint((&rgCb[inst].rgInit)->prntBuf); } }
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 1;
   if ((ueCfg->txMode.pres == 1) &&
       (ueCfg->txMode.tm == CRG_UE_TM_5))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40004,L_ERROR,DBG_CRNTI, ueCfg->crnti, ueCfg->txMode.tm, 0, 0, 0,                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                            225      , "Transmission Mode=%d not supported", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                             ;
      return(1);
   }


   if(((*cell = rgCb[inst].cell) == 0L) ||
       ((*cell)->cellId != ueCfg->cellId))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40005,L_ERROR,DBG_CRNTI, ueCfg->crnti, ueCfg->cellId, 0, 0, 0,                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                         234      , "Active Cell does not exist for cellId%d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                          ;
      return(1);
   }

   if (rgDBMGetUeCb(*cell, ueCfg->crnti) != 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40006,L_ERROR,DBG_CRNTI, ueCfg->crnti, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",240, "Ue already exists", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if (ueCfg->ueUlHqCfg.maxUlHqTx < 1)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40007,L_ERROR,DBG_CRNTI, ueCfg->crnti, ueCfg->ueUlHqCfg.maxUlHqTx, 0, 0, 0,                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                      247      , "Invalid Uplink HARQ config %d ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
      return(1);
   }
      ...
      (ueCfg->rguUlSapId > rgCb[inst].numRguSaps))
   {
      ...
      ,
                            ...
                            257
      ); SPrint((&rgCb[inst].rgInit)->prntBuf); sprintf (rgCb[inst].rgInit.prntBuf, "Invald Sap Id: DL %d UL %d for ueId %d failed\n", ueCfg->rguDlSapId, ueCfg->rguUlSapId, ueCfg->crnti); SPrint((&rgCb[inst].rgInit)->prntBuf); } }
...
)
{
   ...
   if (lcCfg->lcType == 4 || lcCfg->lcType == 5)
   {
      ...
      if ((rgCFGVldtCrgDedLcCfg(inst,lcCfg, cell, ue, errInfo)) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40008,L_ERROR,DBG_CRNTI, lcCfg->crnti, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",318, "Validation for dedicated LC failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
   }
   else if (lcCfg->lcType == 1
         || lcCfg->lcType == 2
         || lcCfg->lcType == 3)
   {
      if ((rgCFGVldtCrgCmnLcCfg(inst,lcCfg, cell, errInfo)) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40009,L_ERROR,DBG_CRNTI, lcCfg->crnti, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",328, "Validation for common logical channels failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
   }
   else
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4000a,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->lcType, 0, 0, 0,                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                             335      , "Invalid logical channel type %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                              ;
      return(1);
   }
   errInfo->errCause = 0;
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 4;

   if (((*cell = rgCb[inst].cell) == 0L)
         && ((*cell = rgCb[inst].inactiveCell) == 0L))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4000b,L_ERROR,DBG_CELLID, cellRecfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",403, "Cell does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if((*cell)->cellId != cellRecfg->cellId)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4000c,L_ERROR,DBG_CELLID, cellRecfg->cellId,cellRecfg->cellId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",409, "Cell does not exist %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   if (cellRecfg->rachRecfg.maxMsg3Tx < 1)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4000d,L_ERROR,DBG_CELLID, cellRecfg->cellId,cellRecfg->rachRecfg.maxMsg3Tx, 0, 0, 0,                                                                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                                                                         415      , "Invalid RACH configuration: maxMsg3Tx %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                                          ;
      return(1);
   }
   errInfo->errCause = 0;
...
)
{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 5;

   if ((ueRecfg->txMode.pres == 1) &&
       (ueRecfg->txMode.tm == CRG_UE_TM_5))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4000e,L_ERROR,DBG_CELLID, ueRecfg->cellId, ueRecfg->txMode.tm, 0, 0, 0,                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                  476      , "Transmission Mode=%d not supported", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;
      return(1);
   }
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4000f,L_ERROR,DBG_CELLID, ueRecfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",484, "Active Cell does not exist\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }



   if ((*ue = rgDBMGetUeCb(*cell, ueRecfg->oldCrnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40010,L_ERROR,DBG_CELLID, ueRecfg->cellId, ueRecfg->oldCrnti, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",492, "[%d]Old Ue does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   if (ueRecfg->ueUlHqRecfg.maxUlHqTx < 1)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40011,L_ERROR,DBG_CELLID, ueRecfg->cellId, ueRecfg->ueUlHqRecfg.maxUlHqTx, 0, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                          498      , "Invalid Uplink HARQ config for UE %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
      return(1);
   }
   errInfo->errCause = 0;
...
)
{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 6;


   if ((((*cell = rgCb[inst].cell)) == 0L)
      || ((*cell)->cellId != lcRecfg->cellId))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40012,L_ERROR,DBG_CRNTI, lcRecfg->crnti, lcRecfg->cellId, lcRecfg->crnti, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",564, "Active Cell %u does not exist for UE %u", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ((*ue = rgDBMGetUeCb(*cell, lcRecfg->crnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40013,L_ERROR,DBG_CRNTI, lcRecfg->crnti, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",570, "Ue does not exist for dedicated logical channel", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if ((*ulLc = rgDBMGetUlDedLcCb((*ue), lcRecfg->lcId)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40014,L_ERROR,DBG_CRNTI, lcRecfg->crnti,lcRecfg->lcId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",576, "Dedicated UL LC does not exist %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }

   if (lcRecfg->ulRecfg.lcgId > (4 - 1))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40015,L_ERROR,DBG_CRNTI, lcRecfg->crnti, lcRecfg->ulRecfg.lcgId, lcRecfg->lcId, 0, 0,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                                     583      , "Invalid lcgId for uplink logical channel lcg %d lc %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                      ;
      return(1);
   }
...
)
{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 21;


   if (((*cell = rgCb[inst].cell) == 0L)
      || ((*cell)->cellId != reset->cellId))
   {
      { if ((&rgCb[inst].rgInit)->dbgMask & ((0x00000100 << 1))) { snprintf((&rgCb[inst].rgInit)->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "MAC", (&rgCb[inst].rgInit)->procId, (&rgCb[inst].rgInit)->ent, (&rgCb[inst].rgInit)->inst, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c", 642); SPrint((&rgCb[inst].rgInit)->prntBuf); sprintf (rgCb[inst].rgInit.prntBuf, "[%d]Active Cell does not exist %d\n",reset->crnti, reset->cellId); SPrint((&rgCb[inst].rgInit)->prntBuf); } };
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40016,L_ERROR,DBG_CRNTI, reset->crnti,reset->cellId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",643, "Active Cell does not exist %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }


   if ((*ue = rgDBMGetUeCb(*cell, reset->crnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40017,L_ERROR,DBG_CRNTI, reset->crnti, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",650, "UE does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 9;


   if((ret = rgAllocSBuf(inst,(Data**)&cell, sizeof(RgCellCb))) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40018,L_ERROR,DBG_CELLID, cellCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",712, "Memory allocation FAILED for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   if (cell == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40019,L_ERROR,DBG_CELLID, cellCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",717, "Memory allocation FAILED for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if (ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4001a,L_ERROR,DBG_CELLID, cellCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",735, "DBM initialization for cell failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 10;


   if ((ue = rgDBMGetUeCbFromRachLst(cell, ueCfg->crnti)) == 0L)
   {

      if((ue=rgRAMCreateUeCb(cell, ueCfg->crnti, 0, errInfo)) == 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4001b,L_ERROR,DBG_CRNTI, ueCfg->crnti, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1067, "UeCb creation failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      if(rgDHMHqEntInit(inst,&ue->dl.hqEnt, cell->maxDlHqProcPerUe) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4001c,L_ERROR,DBG_CRNTI, ueCfg->crnti, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1072, "UeCb Harq Entity Initialization failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      handover = 1;
   }
...
)
{
   ...
   if (lcCfg->lcType == 4 || lcCfg->lcType == 5)
   {
      ...
      if ((rgCFGCrgDedLcCfg(cell, ue, lcCfg, errInfo)) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4001d,L_ERROR,DBG_CRNTI, lcCfg->crnti,lcCfg->lcId, 0, 0, 0,                                                                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"         ,                                                                              1176         , "Dedicated logical channel configuration failed %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                               ;
         return(1);
      }
   ...
   {
      if ((rgCFGCrgCmnLcCfg(inst,cell, lcCfg, errInfo)) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4001e,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->lcId, 0, 0, 0,                                            "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"         ,                                            1191         , "Common logical channel configuration" "failed %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                             ;
         return(1);
      }
   }
   ...
   errInfo->errCause = 0;
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4001f,L_INFO,DBG_CRNTI, lcCfg->crnti, lcCfg->lcId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1197, "CRG LC config done for UE: lcId %d\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return(0);
}
...
)
{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 14;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40020,L_DEBUG,DBG_CRNTI, ue->ueId, cell->cellId, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1407, "UE: of cell %d Reset\n", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 18;
   if (((cell = rgCb[inst].cell) == 0L)
       ||(cell->cellId != cellDelInfo->u.cellDel.cellId))
   {
      if(((cell = rgCb[inst].inactiveCell) == 0L)
          ||(cell->cellId != cellDelInfo->u.cellDel.cellId))
      {


         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40021,L_ERROR,DBG_CELLID, cellDelInfo->u.cellDel.cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1464, "Cell does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 19;

   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40022,L_DEBUG,DBG_CRNTI, ueDelInfo->u.ueDel.crnti, ueDelInfo->u.ueDel.crnti, 0, 0, 0,                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"   ,                                    1535   , "UE %d Deletion Req at MAC\n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                     ;
   if ((rgCb[inst].cell == 0L)
       || (rgCb[inst].cell->cellId != ueDelInfo->u.ueDel.cellId))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40023,L_ERROR,DBG_CRNTI, ueDelInfo->u.ueDel.crnti, ueDelInfo->u.ueDel.cellId, 0, 0, 0,                                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                         1540      , "Cell does not exist %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;
      return(1);
   }
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 20;


   if (((cell = rgCb[inst].cell) == 0L) ||
       (rgCb[inst].cell->cellId != lcDelInfo->u.lchDel.cellId))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40024,L_ERROR,DBG_CRNTI, lcDelInfo->u.lchDel.crnti, lcDelInfo->u.lchDel.cellId, 0, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                          1602      , "Cell does not exist %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
      return(1);
   }


   if ((ue = rgDBMGetUeCb(cell, lcDelInfo->u.lchDel.crnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40025,L_ERROR,DBG_CRNTI, lcDelInfo->u.lchDel.crnti, 0, 0, 0, 0,                                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                                                 1610      , "UE does not exist for dedicated logical channel", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                  ;
      return(1);
   }


   if (lcDelInfo->u.lchDel.dir & (1<<0))
   {
      if ((dlLc = rgDBMGetDlDedLcCb(ue, lcDelInfo->u.lchDel.lcId))
            == 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40026,L_ERROR,DBG_CRNTI, lcDelInfo->u.lchDel.crnti, lcDelInfo->u.lchDel.lcId, 0, 0, 0,                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"         ,                                           1621         , "DL LC %d does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                            ;
         return(1);
      }
   ...
   if (lcDelInfo->u.lchDel.dir & (1<<1))
   {
      if ((ulLc = rgDBMGetUlDedLcCb(ue, lcDelInfo->u.lchDel.lcId))
            == 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40027,L_ERROR,DBG_CRNTI, lcDelInfo->u.lchDel.crnti, lcDelInfo->u.lchDel.lcId, 0, 0, 0,                                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"         ,                                           1635         , "UL LC %d does not exist", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                            ;
         return(1);
      }
   ...
   if (!dirVld)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40028,L_ERROR,DBG_CRNTI, lcDelInfo->u.lchDel.crnti, lcDelInfo->u.lchDel.dir, 0, 0, 0,                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                   1645      , "Invalid direction %d for LC Delete", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                    ;
      return(1);
   }
...
)
{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 2;


   if (((*cell = rgCb[inst].cell) == 0L)
      || ((*cell)->cellId != lcCfg->cellId))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40029,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->cellId, 0, 0, 0,                             "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                             1702      , "Active Cell does not exist: Cell %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                              ;
      return(1);
   }


   if ((*ue = rgDBMGetUeCb(*cell, lcCfg->crnti)) == 0L)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4002a,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->lcId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                           1710      , "UE  does not exist for dedicated logical channel %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
      return(1);
   }
   ...
   if ((lcCfg->lcId < 0x01)
            ||(lcCfg->lcId > 0x0A))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4002b,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->lcId, 0, 0, 0,                           "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                           1719      , "Invalid logical channel Id %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                            ;
      return(1);
   }
   ...
   if (lcCfg->dir & (1<<0))
   {
      if (rgDBMGetDlDedLcCb((*ue), lcCfg->lcId) != 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4002c,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->lcId, 0, 0, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"         ,                               1729         , "UE: Dedicated DL LC %d already configured", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;
         return(1);
      }
      dirVld = 1;
   ...
   if (lcCfg->dir & (1<<1))
   {
      if (lcCfg->ulInfo.lcgId > (4 - 1))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4002d,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->ulInfo.lcgId, 0, 0, 0,                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"         ,                                      1741         , "UE: Invalid lcgId for uplink logical channel %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                       ;
         return(1);
      }
      if (rgDBMGetUlDedLcCb((*ue), lcCfg->lcId) != 0L)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4002e,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->lcId, 0, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"         ,                              1747         , "UE: Dedicated UL LC %d already configured", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                               ;
         return(1);
      }
      dirVld = 1;
   ...
   if (!dirVld)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4002f,L_ERROR,DBG_CRNTI, lcCfg->crnti, lcCfg->dir, 0, 0, 0,                         "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                         1756      , "Invalid Direction %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                          ;
      return(1);
   }
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 3;


   if (((*cell = rgCb[inst].cell) != 0L)
      && ((*cell)->cellId != lcCfg->cellId))
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40030,L_ERROR,DBG_CELLID, lcCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1806, "Active Cell exists for common channels", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
        ...
        || ((*cell)->cellId != lcCfg->cellId))
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40031,L_ERROR,DBG_CELLID, lcCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1815, "Inactive Cell does not exist for common channels", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if (lcCfg->dir & (1<<0))
   {
      if (lcCfg->lcType == 1)
      {
         if (lcCfg->dlInfo.dlTrchType == 3)
         {
            if (rgDBMGetBcchOnDlsch(*cell,lcCfg->lcId) != 0L)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40032,L_ERROR,DBG_CELLID, lcCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1827, "BCCH on DLSCH already configured for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               return(1);
            }
         }
         else if (lcCfg->dlInfo.dlTrchType == 1)
         {
            if (rgDBMGetBcchOnBch(*cell) != 0L)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40033,L_ERROR,DBG_CELLID, lcCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1835, "BCCH on BCH already configured for cell %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               return(1);
            }
         }
         else
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40034,L_ERROR,DBG_CELLID, lcCfg->cellId, lcCfg->dlInfo.dlTrchType, 0, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"            ,                                          1842            , "Invalid transport channel %d for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
            return(1);
         }
      }
      ...
      {
         if (rgDBMGetPcch(*cell) != 0L)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40035,L_ERROR,DBG_CELLID, lcCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1850, "PCCH already configured for cell", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return(1);
         }
      }
      else if (((*cell)->dlCcchId != 255))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40036,L_ERROR,DBG_CELLID, lcCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1856, "DL CCCH already configured for cell %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      dirVld = 1;
   }
   ...
   if (lcCfg->dir & (1<<1))
   {
      ...
      if (lcCfg->lcType != 3)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40037,L_ERROR,DBG_CELLID, lcCfg->cellId, lcCfg->lcType, 0, 0, 0,                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"         ,                               1869         , "Invalid UL common lcType %d for cell ", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                ;
         return(1);
      }
      if (((*cell)->ulCcchId != 255))
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40038,L_ERROR,DBG_CELLID, lcCfg->cellId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1874, "UL CCCH already configured for cell ", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      dirVld = 1;
   }
   ...
   if (!dirVld)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb40039,L_ERROR,DBG_CELLID, lcCfg->cellId, lcCfg->dir, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c",1883, "Invalid Direction %d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 11;
...

{
   ...
   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 12;
   ...
   if (lcCfg->lcType == 3)
   {
      ...
      if (lcCfg->dir & (1<<0))
      {
         ...
         cell->cellActvState |= (1<<5);
      }

      if (lcCfg->dir & (1<<1))
      {
         cell->ulCcchId = lcCfg->lcId;
         cell->cellActvState |= (1<<4);
      }
   }
   else
   {
      if (lcCfg->lcType == 1)
      {
         ...
         if (lcCfg->dlInfo.dlTrchType == 3)
         {
            ...
            if(cell->cellActvState & (1<<1))
            {
               cell->cellActvState |= (1<<2);
            }
            else
            {
               cell->cellActvState |= (1<<1);
            }
         }
         else
         {
            rgDBMInsBcchOnBch(cell, lcCfg->lcId);
            cell->cellActvState |= (1<<0);
         }
      }
      else
      {
         rgDBMInsPcch(cell, lcCfg->lcId);
         cell->cellActvState |= (1<<3);
      }
   }


   if (cell->cellActvState == ((1<<0) | (1<<1) | (1<<2) | (1<<3) | (1<<4) | (1<<5)))
   {
      rgCb[inst].cell = cell;
      rgCb[inst].inactiveCell = 0L;
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xb4003a,L_DEBUG,DBG_CELLID, cell->cellId, lcCfg->lcId, 0, 0, 0,                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_cfg.c"      ,                                     2042      , "Cell %d added to active list after common LC %d               config\n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                      ;
   }
...

{
   ...
   while ((ue = rgDBMGetNextUeCb(cell, 0L)) != 0L)
   {
...

{
   ...
   while ((ue = rgDBMGetNextSpsUeCb(cell, 0L)))
   {
...

{
   ...
   if((cell == 0L) || (cell->cellId != regReq->cellId))
   {
      return(1);
   }
   if(regReq->maxDlHqProcPerUe > 8)
   {
      return(1);
   }
