...
extern S16 hiProcHdrParm (HiConCb *conCb, CmTptAddr *srcAddr, CmTptAddr *remAddr, CmIpHdrParm *hdrParm, Buffer *mBuf, MsgLen mLen)
                                                                 ...
                                                                 ;
static LhiCfgCfm HiMiLhiCfgCfmMt[2] =
{
...
static LhiCntrlCfm HiMiLhiCntrlCfmMt[2] =
{
...
static LhiStsCfm HiMiLhiStsCfmMt[2] =
{
...
static LhiStaInd HiMiLhiStaIndMt[2] =
{
...
static LhiStaCfm HiMiLhiStaCfmMt[2] =
{
...
static LhiTrcInd HiMiLhiTrcIndMt[2] =
{
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { snprintf((&(hiCb.init))->prntBuf, 255, "[%s %d:0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->procId, (&(hiCb.init))->ent, (&(hiCb.init))->inst,
                                                      "/home/mrehwald/Desktop/Radisys/lte_enb/src/tucl/hi_ptmi.c"
   ,
                                                      380
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCfgCfm(pst, cfg (0x%p))\n", (Ptr)cfg); SPrint((&(hiCb.init))->prntBuf); } }
                                                       ;


   return((*HiMiLhiCfgCfmMt[pst->selector])(pst, cfg));
}
 S16 HiMiLhiCntrlCfm
(
Pst *pst,
...

{
   ...
   ,
                                                            416
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCntrlCfm(pst, cntrl (0x%p))\n", (Ptr)cntrl); SPrint((&(hiCb.init))->prntBuf); } }
                                                             ;


   return((*HiMiLhiCntrlCfmMt[pst->selector])(pst, cntrl));
}
 S16 HiMiLhiStaInd
(
Pst *pst,
...

{
   ...
   ,
                                                         452
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStaInd(pst, usta (0x%p))\n", (Ptr)usta); SPrint((&(hiCb.init))->prntBuf); } }
                                                          ;


   return((*HiMiLhiStaIndMt[pst->selector])(pst, usta));
}
 S16 HiMiLhiStaCfm
(
Pst *pst,
...

{
   ...
   ,
                                                       488
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStaCfm(pst, sta (0x%p))\n", (Ptr)sta); SPrint((&(hiCb.init))->prntBuf); } }
                                                        ;


   return((*HiMiLhiStaCfmMt[pst->selector])(pst, sta));
}
 S16 HiMiLhiStsCfm
(
Pst *pst,
...

{
   ...
   ,
                                                      524
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStsCfm(pst, sts (0x%p))\n", (Ptr)sts); SPrint((&(hiCb.init))->prntBuf); } }
                                                       ;


   return((*HiMiLhiStsCfmMt[pst->selector])(pst, sts));
}
 S16 HiMiLhiTrcInd
(
Pst *pst,
...

{
   ...
   ,
                                                      562
   ); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiTrcInd(pst, trc (0x%p))\n", (Ptr)trc); SPrint((&(hiCb.init))->prntBuf); } }
                                                       ;


   return((*HiMiLhiTrcIndMt[pst->selector])(pst, trc, mBuf));
}
