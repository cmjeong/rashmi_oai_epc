...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xc90001,L_DEBUG,DBG_RBID, rbCb->rlcId.rbId, 0, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_tmm_ul.c",215, "do nothing for TMM for ReEstablish", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   return;
}
