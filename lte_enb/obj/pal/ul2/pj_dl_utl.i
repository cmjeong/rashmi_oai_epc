...
static S16 pjUtlDlHdlSecInitCfm (PjCb *gCb,PjDlUeCb *ueCb, U16 txIdx,PjAsyncCfm *asyncCfm, UdxSecCfgCfmInfo *secCfgCfm,UdxReEstCfmInfo *reEstCfm)
                                                                                                     ;
static S16 pjUtlDlHdlCmpInitCfm (PjCb *gCb,PjDlUeCb *ueCb, U16 txIdx,PjAsyncCfm *asyncCfm, UdxCfgCfmInfo *cfgCfm)
                                                                     ;
 S16 pjUtlDlUpdUpSecKeys
(
PjCb *gCb,
PjDlUeCb *ueCb
)
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0001, L_DEBUG, ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c"   , 145   , "pjUtlReEstReconfig(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0002, L_DEBUG, ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c"   , 204   , "pjUtlReEstReconfig(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0003, L_DEBUG,pjRbCb->rbId, pjRbCb->rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",268, "pjUtlDlCmpInit(pjRbCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0004, L_DEBUG,ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",330, "pjUtlDlIntInit(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0005, L_DEBUG,ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",408, "pjUtlCpInit(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0006, L_DEBUG,ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",487, "pjUtlUpInit(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0007, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",833, "pjUtlDlCipherClose", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0008, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",880, "pjUtlDlIntClose", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0009, L_DEBUG,pjRbCb->rbId, pjRbCb->rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",926, "pjUtlCmpReset(pjRbCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda000a, L_DEBUG,pjRbCb->rbId, pjRbCb->rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",973, "pjUtlReEstSrb1(pjRbCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda000b, L_DEBUG,ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1038, "pjUtlReEstHO(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&ueCb->hoInfo, (Size) sizeof(PjDlHoInfo)) == 0) { cmMemset((U8 *)(ueCb->hoInfo), 0, sizeof(PjDlHoInfo)); } else { (ueCb->hoInfo) = 0L; } };
   { if (SGetSBuf(gCb->init.region, gCb->init.pool, (Data **)&ueCb->hoInfo->hoCfmInfo, (Size) sizeof(PjDlHoCfmInfo) * 32) == 0) { cmMemset((U8 *)(ueCb->hoInfo->hoCfmInfo), 0, sizeof(PjDlHoCfmInfo) * 32); } else { (ueCb->hoInfo->hoCfmInfo) = 0L; } };
   rbCbLst = ueCb->drbCb;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda000c, L_DEBUG,ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1128, "pjUtlReEstDl(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda000d, L_DEBUG,ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1192, "pjUtlSndReEstCfgCfm(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   for(rbCnt = 0; rbCnt < 3; rbCnt ++)
   {
      if( ((tRbCb = ueCb->srbCb[rbCnt]) == 0L) ||
          (tRbCb->state == 1))
      {
         continue;
      }
   ...
   { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&cfgCfmInfo, (Size) sizeof (CpjCfgCfmInfo), 0) != 0) { ret = 1; } }
                                  ;
   if(ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda000e, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1231, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xda000f,L_DEBUG,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, cfmType, startTmr, entity,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c"   ,                                                    1300   , "pjUtlSaveCfmInfo cellId(%d),cfmType(%d),startTmr(%d),entity(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
   ...
   if(ueCb->libInfo.asyncCfm[txId]== 0L)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0010, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1326, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
...
)
{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xda0011,L_DEBUG,DBG_UEID, ueCb->key.ueId, ueCb->key.cellId, txIdx, cfmType, maskVal,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c"   ,                                                   1492   , "pjUtlHdlDlObdInitCfm cellId(%d), txIdx(%d), cfmType(%d), maskVal(%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0012, L_DEBUG, ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c"   , 1587   , "pjUtlDlHdlInitObdTmrExp(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                          ;
   ...
   {
      { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&secCfgCfm, (Size) sizeof (UdxSecCfgCfmInfo), 0) != 0) { ret = 1; } }
                                         ;
      if(ret != 0)
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0013, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1613, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
   ...
   else if (asyncCfm->cfmType & 0x10)
   {
      ...
      if(ret != 0)
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0014, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1645, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
   ...
   else if(asyncCfm->cfmType & 0x08)
   {
      ...
      if (ret != 0)
      {
         ...
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xda0015,L_ERROR,DBG_UEID, ueCb->key.ueId, 0, 0, 0, 0,                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c"         ,                                                    1694         , "Hash List Delete Failed for DL ueCb", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                     ;
      ...
      if ( asyncCfm->entity == 0xd8 )
      {
         ...
         if(ret != 0)
         {
            if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0016, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1704, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return(1);
         }
         ...
         { if (ueCb != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) ueCb, (Size) sizeof(PjDlUeCb)); ueCb = 0L; } };
         PjDlUdxCfgCfm(&(udxSap->pst), udxSap->suId, cfgCfm);
      }
      else if ( asyncCfm->entity == 0xd8 )
      {

         { if(SGetStaticBuffer(udxSap->pst.region, udxSap->pst.pool, (Data **)&pjCfgCfm, (Size) sizeof (UdxCfgCfmInfo), 0) != 0) { ret = 1; } }
                                         ;
         if(ret != 0)
         {
            if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0017, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1740, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return(1);
         }
         for ( idx = 0; idx < asyncCfm->numEnt; idx++)
         {
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xda0018, L_DEBUG,ueCb->key.ueId, ueCb->key.cellId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1812, "pjUtlSndSduStaCfm(ueCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   if( ret != 0)
   {
      if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0019, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1821, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   { U8 _rbCnt; U8 _numRb = 0; PjDlHoCfmInfo *_hoCfmInfo; UdxSduStaInfo *_staInfo; cfmInfo->ueId = ueCb->key.ueId; cfmInfo->cellId = ueCb->key.cellId; cfmInfo->transId = ueCb->hoInfo->transId; for(_rbCnt = 0; _rbCnt < 32 && _numRb < 12; _rbCnt++) { _hoCfmInfo = &ueCb->hoInfo->hoCfmInfo[_rbCnt]; _staInfo = &cfmInfo->sduStaInfo[_numRb]; if(_hoCfmInfo->pres != 1) { continue; } _staInfo->rbId = _hoCfmInfo->rbId; _staInfo->dir = _hoCfmInfo->dir; _staInfo->dlSduStaInfo.count = _hoCfmInfo->count; _staInfo->dlSduStaInfo.hoPres = 1; _numRb++; } cfmInfo->numRb = _numRb; cfmInfo->status = 0; cfmInfo->reason = 0; { if (ueCb->hoInfo->hoCfmInfo != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) ueCb->hoInfo->hoCfmInfo, (Size) (32 * sizeof(PjDlHoCfmInfo))); ueCb->hoInfo->hoCfmInfo = 0L; } } { if (ueCb->hoInfo != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) ueCb->hoInfo, (Size) sizeof(PjDlHoInfo)); ueCb->hoInfo = 0L; } }; };
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda001a, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1872, "pjUtlShutdown()", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   ...
   while (cmHashListGetNext(&(gCb->u.dlCb->ueLstCp), (U32) prevUeCb, (U32 *)&ueCb) == 0)
   {
      if ( ueCb != 0L )
      {
...
{
   ;
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda001b, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",1989, "pjUtlFreeRb()", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   pjUtlCmpClose(gCb,pjRbCb->cmpCxtId);

   return;
}
 S16 pjUtlDlSndDatFwdInd
(
PjCb *gCb,
PjDlRbCb *pjRbCb,
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda001c, L_DEBUG, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",2042, "pjUtlSndDatFwdInd()", RLOG_FILE_ID, RLOG_MODULE_NAME); };
...
void dumpPDCPDlRbInformation(PjDlRbCb* dlRbCb, U16 ueId)
{
   ...
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xda001d,L_INFO,DBG_UEID, ueId, dlCb->txBuf.numEntries, 0, 0, 0,                                          "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c"   ,                                          2265   , "PDCP DL RB numEntries = %lu", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                           ;
   printf("UE [%u] PDCP DL RB numEntries = %lu",
...
void DumpPDCPDlDebugInformation(void)
{
   ...
   PjDlUeCb *ueCb = 0L;
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda001e, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",2284, "PDCP DL Information", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   if( L_INFO < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda001f, L_INFO, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",2285, "===================", RLOG_FILE_ID, RLOG_MODULE_NAME); };
   printf("PDCP DL Information\n");
   printf("===================\n");

   while (0 == cmHashListGetNext(&dlgCb->ueLstCp,
                                   (U32) ueCb,
                                   (U32 *)&ueCb))
   {
      U32 i;
 ...
 Void pjUtlEmptyDlPktList(PjCb *gCb, PjDlRbCb *pjRbCb)
{
   PjDlPkt *ulPkt;
   ...
   while(ulPktLst->first)
   {
      ...
      { if (ulPkt != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) ulPkt, (Size) sizeof(PjDlPkt)); ulPkt = 0L; } };
   }
   return;
}
...
static S16 pjUtlDlHdlSecInitCfm
(
PjCb *gCb,
PjDlUeCb *ueCb,
U16 txIdx,
...
)
{
   ...
   if(asyncCfm->libInitBitMask == 0)
   {
      ...
      if(ueCb->libInfo.state == 1)
      {
         ...
         if(ret != 0)
         {
            if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0020, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",2414, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return(1);
         }
         { secCfgCfm->ueId = asyncCfm->ueId; secCfgCfm->cellId = asyncCfm->cellId; secCfgCfm->transId = asyncCfm->transId; secCfgCfm->status = 1; secCfgCfm->reason = 0; };
      ...
      else if(ueCb->libInfo.state == 2)
      {
         ...
         if(ret != 0)
         {
            if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0021, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",2434, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            return(1);
         }
...
static S16 pjUtlDlHdlCmpInitCfm
(
PjCb *gCb,
PjDlUeCb *ueCb,
U16 txIdx,
...
)
{
         ...
         !(asyncCfm->cfmType & 0x04))
   {
      ...
      if(ret != 0)
      {
         if( L_FATAL < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xda0022, L_FATAL, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_dl_utl.c",2490, "Memory Allocation failed.", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      cfgCfm->transId = asyncCfm->transId;
      cfgCfm->ueId = asyncCfm->ueId;
