...
Void PrintRLCStats(Void)
{
   ...
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0xd10001, L_ALWAYS, dlInst->genSts.pdusSent, dlInst->genSts.pdusRetx, dlInst->genSts.protTimeOut, dlInst->genSts.numSduDisc, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"   , 124   , "RLC Stats: PDUs Sent = (%ld), PdusRext = (%ld), TimeOut = (%ld), SduDiscarded = (%ld)", RLOG_FILE_ID, RLOG_MODULE_NAME); }



                                               ;
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0xd10002, L_ALWAYS, ulInst->genSts.pdusRecv, ulInst->genSts.unexpPdusRecv, ulInst->genSts.errorPdusRecv, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"   , 128   , "RLC Stats: PDUs Rcvd = (%ld), unexpPdus = (%ld), errorPdus = (%ld)", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                                                  ;
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0xd10003, L_ALWAYS, gRlcStats.amRlcStats.numDLStaPduSent, gRlcStats.amRlcStats.numDLNacksInStaPdu, gRlcStats.amRlcStats.numDLBytesUnused, gRlcStats.amRlcStats.numDLPollTimerExpiresSrb, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"   , 132   , "RLC Stats: AMDL: " "StaPduSent:%lu NacksInStaPdu:%lu BytesUnused:%lu PollTimerExpires SRB:%lu ", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                                                                                                          ;
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev3(0xd10004, L_ALWAYS, gRlcStats.amRlcStats.numDLPollTimerExpiresDrb, gRlcStats.amRlcStats.numDLMaxRetx, gRlcStats.amRlcStats.numDLRetransPdus, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"   , 136   , "RLC Stats: AMDL: " "DRB:%lu MaxRetx:%lu RetransPdus:%lu", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                                                           ;
   if( L_ALWAYS < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev4(0xd10005, L_ALWAYS, gRlcStats.amRlcStats.numULPdusDiscarded, gRlcStats.amRlcStats.numULReOrdTimerExpires, gRlcStats.amRlcStats.numULStaPduRcvd, gRlcStats.amRlcStats.numULNackInStaPduRcvd, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"   , 140   , "RLC Stats: AMUL: " " PdusDiscarded:%lu ReOrdTimerExpires:%lu StaPduRcvd:%lu NackInStaPduRcvd:%lu ", RLOG_FILE_ID, RLOG_MODULE_NAME); }


                                                                                                      ;

   printf("RLC Stats: PDUs Sent = (%ld), PdusRext = (%ld), TimeOut = (%ld), SduDiscarded = (%ld)\n",
                     dlInst->genSts.pdusSent,
                     dlInst->genSts.pdusRetx,
                     dlInst->genSts.protTimeOut,
                     dlInst->genSts.numSduDisc);
   printf("RLC Stats: PDUs Rcvd = (%ld), unexpPdus = (%ld), errorPdus = (%ld)\n",
...

{
   ...
   KwRguSapCb *rguSap;
   U32 totNumPdu;
   RguStaIndTb *staIndTb = 0L;
   RguDatReqTb *datReqTb = 0L;
   RguDStaIndPerUe *staInd = 0L;
   U32 idx;
   ...
   datReqInfo = 0L;
   { if (SGetStaticBuffer(gCb->u.dlCb->rguDlSap->pst.region, gCb->u.dlCb->rguDlSap->pst.pool, (Data **)&datReqInfo, (Size) sizeof(RguDDatReqInfo), 0) == 0) { cmMemset((U8 *)(datReqInfo), 0, sizeof(RguDDatReqInfo)); } else { (datReqInfo) = 0L; } }
   ...
   for(idx = 0; idx < staIndInfo->nmbOfUeGrantPerTti; idx++)
   {
      ...
      if(0 != kwDbmFetchDlUeCb(gCb,staInd->rnti,staIndInfo->cellId,&ueCb))
      {

         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd10006,L_ERROR,DBG_CELLID, staIndInfo->cellId, staInd->rnti, 0, 0, 0,                              "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"         ,                              239         , "UeId[%u]:ueCb not found", RLOG_FILE_ID, RLOG_MODULE_NAME); }
      ...
      for (numTb = 0; numTb < staInd->nmbOfTbs; numTb++)
      {
         ...
         for (count = 0;count < staIndTb->nmbLch; count++)
         {
            ...
            if (rbCb && (!kwDlUtlIsReestInProgress(rbCb)))
            {
               ...
               datReqTb->lchData[count].setMaxUlPrio = 0;
               if ((rbCb->m.amDl.pollSn == ((rbCb->m.amDl.vtS - 1) & 0x3ff)) &&
                   (rbCb->m.amDl.sduQ.count > 1))
               {

                  datReqTb->lchData[count].setMaxUlPrio = 1;
               }
...
)
{
   ...
   if ((rbCb->lastRprtdBoToMac > (U32)8000) && (rbCb->boUnRprtdCnt < (U32)5)
       && (!staPduPrsnt) && ((3 == rbCb->mode ) && (rbCb->m.amDl.nxtRetx == 0L)))
   {
      rbCb->boUnRprtdCnt++;
      return(0);
   }
   ...
   if ( 2 == rbCb->mode && (rbCb->m.umDl.sduQ.count > 0))
   {
   ...
   else if ( 3 == rbCb->mode )
   {
      ...
      {
         staRspInfo.boReport.oldestSduArrTime = rbCb->m.amDl.nxtTx->arrTime;
      }
      else
      {
...

{
 ...
 Void kwDlUtlSetReestInProgressForRB
(
KwCb *gCb,
KwDlRbCb *rbCb
)
...

{
 ...
 Void kwDlUtlResetReestInProgress
(
KwDlRbCb *rbCb
)
...

{
   ...
   rbCb->reestInProgress = 0;
}
 Void kwDlUtlSetReestInProgressForAllRBs
(
KwCb *gCb,
KwDlUeCb *ueCb
)
...

{
   ...
   for(rbIdx = 0;rbIdx < 3;rbIdx++)
   {
      if(ueCb->srbCb[rbIdx] != 0L)
      {
         ...
         else
         {
            ...
            if(kwChkTmr(gCb, (U32)ueCb->srbCb[rbIdx], 4))
            {
               kwStopTmr(gCb, (U32)ueCb->srbCb[rbIdx], 4);
            }
         }
      }
   }

   for(rbIdx = 0;rbIdx < 32;rbIdx++)
   {
      if(ueCb->drbCb[rbIdx] != 0L)
      {
 ...
 Void kwUtlIncrementKwuStsSduTx
(
KwKwuSapCb *kwuSap
)
...

{
 ...
 Void kwUtlIncrementGenStsBytesAndPdusSent
(
KwGenSts *genSts,
Buffer *pdu
)
...

{
   ...
   cmMemset((U8 *)selfPst, (U8)0, sizeof(Pst));;
   selfPst->srcProcId = SFndProcId();
   selfPst->dstProcId = SFndProcId();
   selfPst->dstEnt = gCb->init.ent;
   selfPst->dstInst = gCb->init.inst;
   selfPst->srcEnt = gCb->init.ent;
   selfPst->srcInst = gCb->init.inst;
   selfPst->prior = 0x03;
   selfPst->event = 0x10;
}
 Void kwUtlRaiseDlCleanupEvent
(
KwCb *gCb
)
...

{
   ...
   if(!gCb->u.dlCb->eventInQueue)
   {
      ...
      gCb->u.dlCb->eventInQueue = 1;
   }

   return;
}
 Void kwUtlAddSduToBeFreedQueue
(
KwCb *gCb,
KwSdu *sdu
)
...

{
 ...
 Void kwUtlAddReTxPduToBeFreedQueue
(
KwCb *gCb,
KwRetx *retx
)
...

{
 ...
 Void kwUtlAddTxPduToBeFreedQueue
(
KwCb *gCb,
KwTx *pdu
)
...
{
   pdu->rlsLnk.node = (U32)pdu;
   cmLListAdd2Tail(&(gCb->u.dlCb->toBeFreed.txLst), &(pdu->rlsLnk));
   return;
}
static Bool kwUtlFreeDlAmRbMemory
(
KwCb *gCb,
KwDlRbCb *rbCb,
U32 *toBeFreed
...

{
   ...
   {
      if (rbCb->m.amDl.txBuf[rbCb->m.amDl.vtA] && rbCb->m.amDl.txBuf[rbCb->m.amDl.vtA]->pdu)
      {
         { if (rbCb->m.amDl.txBuf[rbCb->m.amDl.vtA]->pdu != 0L) { SPutMsg(rbCb->m.amDl.txBuf[rbCb->m.amDl.vtA]->pdu); } rbCb->m.amDl.txBuf[rbCb->m.amDl.vtA]->pdu = 0L; };
         { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCb->m.amDl.txBuf[rbCb->m.amDl.vtA], (Size) sizeof(KwTx)); rbCb->m.amDl.txBuf[rbCb->m.amDl.vtA] = 0L; };
         if(gCb->u.dlCb->shutdownReceived == 0)
         {
         (*toBeFreed)--;
      }
      }
      rbCb->m.amDl.vtA = (rbCb->m.amDl.vtA + 1) % windSz;
      { mVtS = (rbCb->m.amDl.vtS - rbCb->m.amDl.vtA) & 0x3ff; };
   }
   if(*toBeFreed == 0)
   {
   ...
   { if (rbCb->m.amDl.txBuf != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCb->m.amDl.txBuf, (Size) (windSz)* sizeof(KwTx*)); rbCb->m.amDl.txBuf = 0L; } };


   { CmLList *tmpNode; if((tmpNode=((&rbCb->m.amDl.retxLst)->crnt = (&rbCb->m.amDl.retxLst)->first))) retx = (KwRetx *)tmpNode->node; else retx = 0L; };
   while (retx && (*toBeFreed))
   {

      { if (retx->seg != 0L) { SPutMsg(retx->seg); } retx->seg = 0L; };

      cmLListDelFrm(&rbCb->m.amDl.retxLst, &retx->lstEnt);
      { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) retx, (Size) sizeof(KwRetx)); retx = 0L; };
   ...
   if(rbCb->m.amDl.pStaPdu)
   {
      Pst *udxPst;
      udxPst = &gCb->u.dlCb->udxDlSap->pst;
      { (Void) SPutStaticBuffer(udxPst->region, udxPst->pool, (Data *) rbCb->m.amDl.pStaPdu, (Size) sizeof(KwUdxDlStaPdu), 0); rbCb->m.amDl.pStaPdu = 0L; }
...

{
   ...
   {
      if ((pToBeFreed->txLst.count + pToBeFreed->reTxLst.count + pToBeFreed->sduLst.count) > (3 * 10))
      {
...

   {
      ...
      SPutMsg((seg->seg));;
      { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) seg, (Size) sizeof(KwRetx)); seg = 0L; };
      toBeFreed--;
   }
...

   {
      ...
      cmLListDelFrm(lst, lst->first);
      SPutMsg((pdu->pdu));;
      { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) pdu, (Size) sizeof(KwTx)); pdu = 0L; };
      toBeFreed--;
   }
...

   {
      ...
      { if(sdu->mBuf) { SPutMsg(sdu->mBuf); } cmLListDelFrm(lst,&sdu->lstEnt); { if (sdu != 0L) { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) sdu, (Size) sizeof(KwSdu)); sdu = 0L; } }; };
      toBeFreed--;
   }
...

   {
      ...
      {
         cmLListDelFrm(lst, lst->first);
         { (Void) SPutSBuf(gCb->init.region, gCb->init.pool, (Data *) rbCb, (Size) sizeof(KwDlRbCb)); rbCb = 0L; };
      }
   }
...
static Void dumpRLCDlRbInformation(KwDlRbCb* dlRbCb)
{
   if(dlRbCb->mode == 2)
   {
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd10007,L_DEBUG,DBG_RBID, dlRbCb->rlcId.rbId, dlRbCb->rlcId.ueId, dlRbCb->rlcId.cellId, (int)dlRbCb->m.umDl.sduQ.count, 0,                                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"      ,                                                     2021      , "UM Downlink UEID:%d CELLID:%d Q size = %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }



                                                      ;
   }
   else if(dlRbCb->mode == 3)
   {
      U32 j, numTxPdus=0;
      for(j = 0; j < (512 << 1); j++)
      {
         if(dlRbCb->m.amDl.txBuf[j] != 0L)
         {
            numTxPdus++;
         }
      }
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd10008,L_DEBUG,DBG_RBID, dlRbCb->rlcId.rbId, dlRbCb->rlcId.ueId, dlRbCb->rlcId.cellId, (int)dlRbCb->m.amDl.sduQ.count, (int)numTxPdus,                                     "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"      ,                                     2038      , "AM Downlink UEID:%d CELLID:%d Sizes SDU Q = %d TX Q = %d ", RLOG_FILE_ID, RLOG_MODULE_NAME); }




                                      ;
      if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0xd10009,L_DEBUG,DBG_RBID, dlRbCb->rlcId.rbId, dlRbCb->rlcId.ueId, dlRbCb->rlcId.cellId, (int)dlRbCb->m.amDl.retxLst.count, 0,                                                        "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterlc/kw_utl_dl.c"      ,                                                        2043      , "AM Downlink UEID:%d CELLID:%d RETX Q= %d", RLOG_FILE_ID, RLOG_MODULE_NAME); }
...
Void DumpRLCDlDebugInformation(Void)
{
   ...
   KwDlUeCb *ueCb = 0L;
   printf("RLC Information\n");
   printf("===============\n");

   while (0 == cmHashListGetNext(&dlCb->ueLstCp,
                                   (U32) ueCb,
                                   (U32 *)&ueCb))
   {
      U32 i;
   ...
   printf("toBeFreed RETX list size = %d\n",(int)pToBeFreed->reTxLst.count);
   printf("toBeFreed TX list size   = %d\n",(int)pToBeFreed->txLst.count);
   printf("toBeFreed SDU list size  = %d\n",(int)pToBeFreed->sduLst.count);
   printf("toBeFreed RB list size   = %d\n",(int)pToBeFreed->rbLst.count);
}
void kwUtlFreeDlMem
(
 Void
...

{
   ...
   { SGetStaticBuffer(kwuSap->pst.region, kwuSap->pst.pool, (Data **)&flowCntrlInfo, (Size) sizeof(KwuFlowCntrlIndInfo), 0); }
