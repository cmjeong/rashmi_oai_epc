...
void CRmRcmDrxMgr::rmRcmDrxPopulateOnduration()
{
   switch(m_enUlDlConfig)
   {
      ...
      break;
      default:
         if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0x910001, L_WARNING,                                                 "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_rcmdrx.cpp"         ,                                                 124         , "Invalid UL-DL config, settign Onduration" "for UL-DL config 1", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                  ;
         m_usTddOnDuration = 9;
   }
...
S32 CRmRcmDrxMgr::rmRcmCfgDrx(CUEContext *pobjUe, U32 bResCfgMask)
{
   ...
   if(bResAllocated & 2)
   {
      ...
      {
         if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x910002,L_WARNING,DBG_CRNTI, (pobjUe->getCRNTI()),usLongDrxCycle, 0, 0, 0, "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_rcmdrx.cpp",184, "Long Cycle (%u) could not be configured", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         if(bResAllocated & 8)
         {
            pobjUe->relDrxCfg();
            return 2;
   ...
   {
       if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x910003,L_WARNING,DBG_CRNTI, (pobjUe->getCRNTI()), 0, 0, 0, 0,                                                   "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_rcmdrx.cpp"       ,                                                   212       , "On Duration Timer could not be configured\n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                    ;
      if(bResAllocated & 8)
      {
         pobjUe->relDrxCfg();
   ...
   if(bResCfgMask & 0x40)
   {
      ...
      {
         if( L_WARNING < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x910004,L_WARNING,DBG_CRNTI, (pobjUe->getCRNTI()), 0, 0, 0, 0,                                               "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_rcmdrx.cpp"         ,                                               233         , "Short Cycle could not be configured\n", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                ;
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x910005,L_DEBUG,DBG_CRNTI, (pobjUe->getCRNTI()), 0, 0, 0, 0,                                  "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_rcmdrx.cpp"   ,                                  243   , "setting the DRX Profile", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                   ;
...
U16 CRmRcmDrxMgr::rmRcmDrxGetOnDuration(U16 usDrxLongCycle, CmRrmDrxCfg& stRmDrxCfg, CUEContext *pobjUe, U16& usOnDurationTmr)
{
   ...
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLevE(0x910006,L_ERROR,DBG_CRNTI, (pobjUe->getCRNTI()), 0, 0, 0, 0,                                                                    "/home/mrehwald/Desktop/Radisys/lte_enb/src/lterrm/src/rm_rcmdrx.cpp"      ,                                                                    370      , "Onduration can not be more than DRX Long Cycle", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                                     ;
      return 1;
   }
   else
