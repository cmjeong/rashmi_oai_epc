...

{
   ...
   if(SUnpkU8(&byte, mBuf) != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb00001, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",191, "SUnpkU8 failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
      return(1);
   }
   fmt = byte & 0x80;
   *sduLen = byte & 0x7F;
   if(fmt)
   {
      if(SUnpkU8(&byte,mBuf) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb00002, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",201, "SUnpkU8 failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
         return(1);
      }
...
)
{
   ...
   { ret = cmGetMem((Ptr)&pdu->memCp, sizeof(RgMacSdu), (Ptr *)&sdu); };
   if(ret != 0)
   {
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00003, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",257, "Allocation of RgSubHdr failed for LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 1;
      return(1);
   }
   { (sdu)->lcId = (lcId); (sdu)->len = (sduLen); (sdu)->mBuf = 0L; (sdu)->sduLstEnt.next = 0L; (sdu)->sduLstEnt.prev = 0L; (sdu)->sduLstEnt.node = (U32)(sdu); };
   cmLListAdd2Tail(&pdu->sduLst, &sdu->sduLstEnt);
   return(0);
}
static S16 rgDUXExtPadSubHdrs
(
Inst inst,
RgMacPdu *pdu,
Buffer *mBuf,
...
)
{
   ...
   *subHdrChkCmp = 1;
   do
   {
      if(SUnpkU8(&byte,mBuf) != 0)
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb00004, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",327, "SUnpkU8 failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
         return(1);
      }
      ...
      if(lcId == 0x1F)
      {
         ...
         {
            ++(*numPadSubHdrs);
            if(*numPadSubHdrs > 0x02)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00005, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",343, "padSubHdrs received more than 2 for LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6;
               return(1);
            }
            continue;
         }
         else
         {
            if(*numPadSubHdrs)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00006, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",353, "invalid padSubHdrs received for LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6;
               return(1);
            }
            break;
   ...
   *subHdrChkCmp = 1;
   ...
   do
   {
      ...
      if(lcId == 0x1F)
      {
         if(*extnBit)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00007, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",441, "invalid padSubHdrs received LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6;
            return(1);
         }
         else
         {
            if(*numPadSubHdrs)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00008, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",449, "invalid padSubHdrs received  LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6;
               return(1);
            }
            break;
      ...
      if ((lcId >= 0x19) && (lcId <= 0X1E))
      {
         { ret = cmGetMem((Ptr)&pdu->memCp, sizeof(RgMacCeSubHdr), (Ptr *)&ceSubHdr); };
         if(ret != 0)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00009, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",462, "Allocation of RgMacCeSubHdr failed  LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 1;
            return(1);
         }
         { (ceSubHdr)->lcId = (lcId); (ceSubHdr)->subHdrLstEnt.next = 0L; (ceSubHdr)->subHdrLstEnt.prev = 0L; (ceSubHdr)->subHdrLstEnt.node = (U32)(ceSubHdr); };
         ...
         if(*extnBit)
         {
            if(SUnpkU8(&byte,mBuf) != 0)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb0000a, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",473, "SUnpkU8 failed  LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
               return(1);
            }
         }
...
)
{
   ...
   do
   {
      ...
      if(lcId == 0x1F)
      {
         if(extnBit)
         {
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb0000b, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",555, "invalid padSubHdrs received LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6;
            return(1);
         }
         else
         {
            if(numPadSubHdrs)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb0000c, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",563, "invalid padSubHdrs received LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6;
               return(1);
            }
            break;
      ...
      if(lcId <= 0x0A)
      {
         ...
         if(extnBit)
         {
            if(rgDUXExtSduLen(inst,mBuf, &sduLen, err) != 0)
            {
               return(1);
            }

            if(rgDUXInsSdu(inst,pdu, lcId, sduLen, err) != 0)
            {
               return(1);
            }
            if(SUnpkU8(&byte,mBuf) != 0)
            {
               if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb0000d, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",592, "SUnpkU8 failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
               err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
               return(1);
            }
            continue;
      ...
      {
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb0000e, L_ERROR,lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",610, "Invalid LCID:%u received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1;
         return(1);
      }
   }
   while(extnBit);
...
)
{
   ...
   ((((tmpNode) = ((&pdu->ceLst)->crnt = (&pdu->ceLst)->first)) != 0L) ? (tmpNode)->node : 0L);
   ...
   while(tmpNode)
   {
      ...
      switch(ceSubHdr->lcId)
      {
         case 0x19:
               {
                  ...
                  if(ret != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb0000f, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",681, "Unpacking of EXT PHR failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
                     return(1);
                  }
                  ...
                  Ci |= 0x1;
                  for (sCellIdx = 0; (Ci && sCellIdx < 8); sCellIdx++)
                  {
                     if (Ci & 0x1)
                     {
                        extPhr->servCellPhr[extPhr->numServCells].sCellIdx = sCellIdx;
                        { ret = SUnpkU8((&extPhrOctet), (mBuf)); };
                        if(ret != 0)
                        {
                           if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00010, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",702, "Unpacking of EXT PHR failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                           err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
                           return(1);
                        }
                        ...
                        if (extPhrOctet & 0x40)
                        {
                           extPhr->servCellPhr[extPhr->numServCells].pCmax = 0xFF;
                        }
                        else
                        {
                           { ret = SUnpkU8((&extPhrPCmax), (mBuf)); };
                           if(ret != 0)
                           {
                              if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00011, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",726, "Unpacking of EXT PHR failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                              err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
                              return(1);
                           }
         ...
         case 0x1A:
               {
                  { ret = SUnpkU8((&ceInfo->ces.phr), (mBuf)); };
                  if(ret != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00012, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",746, "Unpacking of PHR failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
                     return(1);
                  }
                  ceInfo->bitMask |= (1<<2);
         ...
         case 0X1C:
               {
                  { ret = SUnpkU8((&ceInfo->ces.bsr.truncBsr), (mBuf)); };
                  if(ret != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00013, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",758, "Unpacking of Trunc BSR failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
                     return(1);
                  }
                  ceInfo->bitMask |= (1<<3);
         ...
         case 0X1D:
               {
                  { ret = SUnpkU8((&ceInfo->ces.bsr.shortBsr), (mBuf)); };
                  if(ret != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00014, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",770, "Unpacking of Short BSR failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
                     return(1);
                  }
                  ceInfo->bitMask |= (1<<4);
         ...
         case 0X1E:
               {
                  U8 longBsr[3] = {0};
                  { ret = SRemPreMsgMult((longBsr), 3, (mBuf)); };
                  if(ret != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00015, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",783, "Unpacking of Long BSR failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
                     return(1);
                  }
                  { ceInfo->ces.bsr.longBsr.bs1 = longBsr[0] >> 2; ceInfo->ces.bsr.longBsr.bs2 = (((longBsr[0] & 0x3) << 4) | (longBsr[1] >> 4)); ceInfo->ces.bsr.longBsr.bs3 = (((longBsr[1] & 0x0F) << 2) | (longBsr[2] >> 6)); ceInfo->ces.bsr.longBsr.bs4 = longBsr[2] & 0x3F; }
         ...
         case 0X1B:
               {
                  { Data _unpkArray[2]; *&ceInfo->ces.cRnti = 0; ret = SRemPreMsgMult(_unpkArray, (MsgLen) 2, mBuf); if (ret == 0) { *&ceInfo->ces.cRnti = (U16) (U16) (((U16)((U8) _unpkArray[0]) << 8) | ((U16)(*&ceInfo->ces.cRnti) & 0x00ff)); *&ceInfo->ces.cRnti = (U16) (U16) (((U16)((U8) _unpkArray[1]) & 0xff) | ((U16)(*&ceInfo->ces.cRnti) & 0xff00)); }};
                  if(ret != 0)
                  {
                     if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00016, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",800, "Unpacking of C-RNTI failed LCID:%d", RLOG_FILE_ID, RLOG_MODULE_NAME); };
                     err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
                     return(1);
                  }
                  ceInfo->bitMask |= (1<<1);
               ...
               break;
         default:
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xb00017, L_ERROR,ceSubHdr->lcId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",808, "Invalid LCID:%u received", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1;
            return(1);
      }
      ((((tmpNode) = ((&pdu->ceLst)->crnt = ((&pdu->ceLst)->crnt ? (&pdu->ceLst)->crnt->next : (&pdu->ceLst)->first)))!= 0L) ? (tmpNode)->node : 0L);
   }
   return(0);
}
static S16 rgDUXExtSdus
(
Inst inst,
RgMacPdu *pdu,
Buffer *mBuf,
...

{
   ...
   tmpBuf1 = mBuf;
   ((((tmpNode) = ((&pdu->sduLst)->crnt = (&pdu->sduLst)->first)) != 0L) ? (tmpNode)->node : 0L);
   ...
   while(tmpNode)
   {
      ...
      {
         MsgLen len = 0;
         if(SFndLenMsg(tmpBuf1,&len) != 0)
         {
            { if (0L != (tmpBuf1)) { SPutMsg((tmpBuf1)); tmpBuf1 = 0L; } };
            if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb00018, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",875, "mBuf length check failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
            err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 2;
            return(1);
         }
         sdu->len = len;
      ...
      if((ret != 0) && (!((ret == 2) && (tmpNode->next == 0L))))
      {
         { if (0L != (tmpBuf1)) { SPutMsg((tmpBuf1)); tmpBuf1 = 0L; } };
         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb00019, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",887, "SSegMsg failed", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 3;
         return(1);
      }
      ...
      ((((tmpNode) = ((&pdu->sduLst)->crnt = ((&pdu->sduLst)->crnt ? (&pdu->sduLst)->crnt->next : (&pdu->sduLst)->first)))!= 0L) ? (tmpNode)->node : 0L);
   }
   { if (0L != (tmpBuf1)) { SPutMsg((tmpBuf1)); tmpBuf1 = 0L; } };
   return(0);
}
...
)
{
   ...
   if(rgDUXExtPadSubHdrs(inst,pdu, *mBuf, &numPadSubHdrs,
         &unPkByte, &extnBit, &subHdrChkCmp, err) != 0)
   {
      { if (0L != (*mBuf)) { SPutMsg((*mBuf)); *mBuf = 0L; } };

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb0001a, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",962, "Failed to extract pad sub headers", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
         ...
         &unPkByte, &extnBit, &subHdrChkCmp, err) != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb0001b, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",978, "failed to Extract the ce sub headers", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if((!extnBit) && (subHdrChkCmp))
   {
      ...
      if(rgDUXExtCes(inst,pdu, ceInfo, *mBuf, err) != 0)
      {
         { if (0L != (*mBuf)) { SPutMsg((*mBuf)); *mBuf = 0L; } };

         if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb0001c, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",989, "failed to Extract the ces", RLOG_FILE_ID, RLOG_MODULE_NAME); };
         return(1);
      }
      { if (0L != (*mBuf)) { SPutMsg((*mBuf)); *mBuf = 0L; } };
      return(0);
   ...
   if(rgDUXExtSduSubHdrs(inst,pdu, ceInfo, *mBuf,
         numPadSubHdrs, unPkByte, err) != 0)
   {
      { if (0L != (*mBuf)) { SPutMsg((*mBuf)); *mBuf = 0L; } };

      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb0001d, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",1002, "failed to Extract the sdu sub headers", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   ...
   if(rgDUXExtCes(inst,pdu, ceInfo, *mBuf, err) != 0)
   {
      ...
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb0001e, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",1011, " failed to Extract the ces", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }


   if(rgDUXExtSdus(inst,pdu, *mBuf, err) != 0)
   {


      *mBuf = 0L;
      if( L_ERROR < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev0(0xb0001f, L_ERROR, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltemac/rg_dux.c",1021, "failed to Extract the sdus", RLOG_FILE_ID, RLOG_MODULE_NAME); };
      return(1);
   }
   *mBuf = 0L;
   return(0);
