...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev2(0xe70001, L_DEBUG, pjRbCb->rbId, pjRbCb->rbType, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_utl.c"   , 1546   , "pjUtlCmpReq(pjRbCb(%d,%d))", RLOG_FILE_ID, RLOG_MODULE_NAME); }
                                                 ;
...

{
   ...
   if( L_DEBUG < g_logLevel || g_modMask & RLOG_MODULE_ID){ logLev1(0xe70002, L_DEBUG, cmpCxtId, "/home/mrehwald/Desktop/Radisys/lte_enb/src/ltepdcp/pj_utl.c",1599, "pjUtlCmpClose(cmpCxtId(%ld))", RLOG_FILE_ID, RLOG_MODULE_NAME); };
