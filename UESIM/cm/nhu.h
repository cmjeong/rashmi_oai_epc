...
#ifdef SCALABLE_ARCH
#define EVTNHUUESWITCHPREPREQ  0x1D /* UE Switch Prep Req */
#define EVTNHUUESWITCHPREPCFM  0x1E /* UE Switch Prep Cfm */
#define EVTNHUUESWITCHREQ      0x1F /* UE Switch Req */
#define EVTNHUUESWITCHCFM      0x20 /* UE Switch Cfm */
#define EVTNHUUESWTCHSTSUPD    0x21 /* UE Switch Status Update */
#endif
