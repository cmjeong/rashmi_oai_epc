...
#endif
#ifdef SCALABLE_ARCH
   Inst pjDlInst; /*!< PDCP DL Inst Id */
   Inst kwDlInst; /*!< RLC UL Inst Id */
   Inst pjUlInst; /*!< PDCP UL Inst Id */
   Inst kwUlInst; /*!< RLC DL Inst Id */
   /* PJU interface SAP IDs; At present we are not using
    */
   Inst          pjuInst[NHU_MAX_PJUSAPS];
#endif
#ifdef TENB_MULT_CELL_SUPPRT
...
#ifdef SCALABLE_ARCH
/**
  * @struct nhuUeSwitchPrepReqPerEnt
    @brief UE Switch Prepare request per entity  
    @details This structure contains the input for UE switch prepare request for an entity
*/
typedef struct nhuUeSwitchPrepReqPerEnt
{
   CmEntityType entType;
   Inst newInstId;
}NhuUeSwitchPrepReqPerEnt;


/**
  * @struct nhuUeSwitchPrepReqSdu
    @brief UE Switch Prepare request
    @details This structure contains the input for UE switch prepare request
*/
typedef struct nhuUeSwitchPrepReqSdu
{
   CmMemListCp    memCp;
   NhuHdr   hdr;                                            /*!< Config Hdr */
   U8 numEnt;                                               /*!< Number of entities to be switched */
   NhuUeSwitchPrepReqPerEnt *ueSwitchPrepReqPerEnt;         /*!< UE swtich prep for Entity */
}NhuUeSwitchPrepReqSdu;

/**
  * @struct NhuUeSwitchPrepCfmSdu
    @brief UE Switch Prepare Confirm
    @details This structure contains the confirm for Switch Prep Req
*/
typedef struct nhuUeSwitchPrepCfmSdu
{
   NhuHdr   hdr;    /*!< Config Hdr */
   Bool     status; /*!< status of the switch Prep Req */
}NhuUeSwitchPrepCfmSdu;

/**
  * @struct NhuUeSwitchReqPerEnt
    @brief UE Switch Prepare request per entity  
    @details This structure contains the input for UE switch prepare request for an entity
*/
typedef struct nhuUeSwitchReqPerEnt
{
   CmEntityType entType;
   Inst newInstId;
}NhuUeSwitchReqPerEnt;

/**
  * @struct NhuUeSwitchReqSdu
    @brief UE Switch request
    @details This structure contains the input for UE switch request
*/
typedef struct nhuUeSwitchReqSdu
{
   CmMemListCp    memCp;
   NhuHdr   hdr;                            /*!< Config Hdr */
   U8 numEnt;                               /*!< Number of entities to be switched */
   NhuUeSwitchReqPerEnt *ueSwitchReqPerEnt; /*!< UE swtich prep for Entity */
}NhuUeSwitchReqSdu;

/**
  * @struct NhuUeSwitchCfmSdu
    @brief UE Switch Confirm
    @details This structure contains the confirm for Switch Req
*/
typedef struct nhuUeSwitchCfmSdu
{
   NhuHdr   hdr;    /*!< Config Hdr */
   Bool     status; /*!< status of the Switch Req */
}NhuUeSwitchCfmSdu;

/**
  * @struct NhuUeSwtchStsUpdSdu
    @brief UE Switch Status Update
    @details This structure contains the Status update information for the switch request
*/
typedef struct nhuUeSwtchStsUpdSdu
{
   NhuHdr   hdr;          /*!< Config Hdr */
   Bool     status;       /*!< status of the Switch procedure */
   CmEntityType entType;  /*!< Entity type */
   Inst instId;           /*!< Inst Id of the entity */
}NhuUeSwtchStsUpdSdu;
#endif
...
#ifdef SCALABLE_ARCH
typedef S16 (*NhuUeSwitchPrepReq)    ARGS((
               Pst            *pst,               /* Post structure */
               SpId           spId,               /* RRC service provider SAP ID */
               NhuUeSwitchPrepReqSdu *ueSwithPrepReq /* UE Switch Prep Config */
               ));
typedef S16 (*NhuUeSwitchPrepCfm)    ARGS((
               Pst            *pst,               /* Post structure */
               SuId           suId,               /* RRC service user SAP ID */
               NhuUeSwitchPrepCfmSdu *ueSwithPrepCfm /* UE Switch Prep Cfm */
               ));

typedef S16 (*NhuUeSwitchReq)    ARGS((
               Pst            *pst,       /* Post structure */
               SpId           spId,       /* RRC service provider SAP ID */
               NhuUeSwitchReqSdu *ueSwithReq /* UE Switch Prep Config */
               ));
typedef S16 (*NhuUeSwitchCfm)    ARGS((
               Pst            *pst,       /* Post structure */
               SuId           suId,       /* RRC service user SAP ID */
               NhuUeSwitchCfmSdu *ueSwithCfm /* UE Switch Cfm */
               ));
typedef S16 (*NhuUeSwtchStsUpd)    ARGS((
               Pst            *pst,       /* Post structure */
               SuId           suId,       /* RRC service user SAP ID */
               NhuUeSwtchStsUpdSdu *ueSwitchStsUpd /* UE Switch Status update */
               ));
#endif
...
#ifdef SCALABLE_ARCH
   EXTERN S16 NxLiNhuUeSwitchPrepCfm ARGS((Pst *pst, SuId suId, NhuUeSwitchPrepCfmSdu *nhuUeSwitchPrepCfmSdu));
   EXTERN S16 NxLiNhuUeSwitchCfm ARGS((Pst *pst, SuId suId, NhuUeSwitchCfmSdu *nhuUeSwitchCfmSdu));
   EXTERN S16 NxLiNhuUeSwtchStsUpd ARGS((Pst *pst, SuId suId, NhuUeSwtchStsUpdSdu *nhuUeSwtchStsUpdSdu));
#endif /* SCALABLE_ARCH */
...
#ifdef SCALABLE_ARCH
/** 
@brief Entity Switch Prep Request from RRC User.
@details 
* This primitive is used to configure the lower layers to prepare for a UE entity switch
* @param[in] pst Pointer to the service user task configuration structure.
* @param[in] spId The service provider SAP ID.
* @param[in] ueSwithPrepReq Pointer to the Switch Prepare Request parameters
*
* @return S16
*  -# ROK
*  -# RFAILED
*/   
EXTERN S16 NhUiNhuUeSwitchPrepReq ARGS((Pst *pst, SpId spId, NhuUeSwitchPrepReqSdu *ueSwithPrepReq));

/** 

@brief Entity Switch Prep Confirm
@details 
* This primitive is used to confirm the status of the switch prepare request 
* @param[in] pst Pointer to the service user task configuration structure.
* @param[in] spId The service provider SAP ID.
* @param[in] ueSwithPrepCfm Pointer to the Switch Prepare confirm parameters
*
* @return S16
*  -# ROK
*  -# RFAILED
*/   
EXTERN S16 NhUiNhuUeSwitchPrepCfm ARGS((Pst *pst, SpId spId, NhuUeSwitchPrepCfmSdu *ueSwithPrepCfm));

/** 
@brief Entity Switch Request from RRC User.
@details 
* This primitive is used to configure the lower layers for a UE entity switch
* @param[in] pst Pointer to the service user task configuration structure.
* @param[in] spId The service provider SAP ID.
* @param[in] ueSwithReq Pointer to the Switch Request parameters
*
* @return S16
*  -# ROK
*  -# RFAILED
*/   
EXTERN S16 NhUiNhuUeSwitchReq ARGS((Pst *pst, SpId spId, NhuUeSwitchReqSdu *ueSwithReq));

/** 

@brief Entity Switch Confirm
@details 
* This primitive is used to confirm the status of the switch request 
* @param[in] pst Pointer to the service user task configuration structure.
* @param[in] spId The service provider SAP ID.
* @param[in] ueSwithCfm Pointer to the Switch confirm parameters
*
* @return S16
*  -# ROK
*  -# RFAILED
*/   
EXTERN S16 NhUiNhuUeSwitchCfm ARGS((Pst *pst, SpId spId, NhuUeSwitchCfmSdu *ueSwithCfm));

/** 
@brief Entity Switch Status Update
@details 
* This primitive is used to Send status update of the switch operation 
* @param[in] pst Pointer to the service user task configuration structure.
* @param[in] spId The service provider SAP ID.
* @param[in] ueSwithStsUpd Pointer to the Switch Status Update Parameter
*
* @return S16
*  -# ROK
*  -# RFAILED
*/   
EXTERN S16 NhUiNhuUeSwtchStsUpd ARGS((Pst *pst, SpId spId, NhuUeSwtchStsUpdSdu *ueSwithStsUpd));
#endif
#endif /* NH */
...
EXTERN S16 cmPkNhuUeSwitchPrepReq
ARGS ((
Pst *pst,
SpId spId,
NhuUeSwitchPrepReqSdu *param
));

EXTERN S16 cmPkNhuUeSwitchPrepCfm
ARGS ((
Pst *pst,
SuId suId,
NhuUeSwitchPrepCfmSdu *param
));
EXTERN S16 cmPkNhuUeSwitchReq
ARGS ((
Pst *pst,
SpId spId,
NhuUeSwitchReqSdu *param
));

EXTERN S16 cmPkNhuUeSwitchCfm
ARGS ((
Pst *pst,
SuId suId,
NhuUeSwitchCfmSdu *param
));

EXTERN S16 cmPkNhuUeSwtchStsUpd
ARGS ((
Pst *pst,
SuId suId,
NhuUeSwtchStsUpdSdu *param
));

EXTERN S16 cmPkNhuUeSwitchPrepReqSdu
ARGS ((
NhuUeSwitchPrepReqSdu *param,
Buffer *mBuf
));
EXTERN S16 cmPkNhuUeSwitchReqSdu
ARGS ((
NhuUeSwitchReqSdu *param,
Buffer *mBuf
));
EXTERN S16 cmPkNhuUeSwitchPrepCfmSdu
ARGS ((
NhuUeSwitchPrepCfmSdu *param,
Buffer *mBuf
));

EXTERN S16 cmPkNhuUeSwitchCfmSdu
ARGS ((
NhuUeSwitchCfmSdu *param,
Buffer *mBuf
));

EXTERN S16 cmPkNhuUeSwtchStsUpdSdu
ARGS ((
NhuUeSwtchStsUpdSdu *param,
Buffer *mBuf
));
...
EXTERN S16 cmUnpkNhuUeSwitchPrepReq
ARGS ((
NhuUeSwitchPrepReq func,
Pst *pst,
Buffer *mBuf,
Mem *sMem,
Size maxBlkSize
...
EXTERN S16 cmUnpkNhuUeSwitchPrepCfm
ARGS ((
NhuUeSwitchPrepCfm func,
Pst *pst,
Buffer *mBuf
));

EXTERN S16 cmUnpkNhuUeSwitchReq
ARGS ((
NhuUeSwitchReq func,
Pst *pst,
Buffer *mBuf,
...
EXTERN S16 cmUnpkNhuUeSwitchCfm
ARGS ((
NhuUeSwitchCfm func,
Pst *pst,
Buffer *mBuf
...
EXTERN S16 cmUnpkNhuUeSwtchStsUpd
ARGS ((
NhuUeSwtchStsUpd func,
Pst *pst,
Buffer *mBuf
));

EXTERN S16 cmUnpkNhuUeSwitchPrepReqSdu
ARGS ((
NhuUeSwitchPrepReqSdu *param,
Buffer *mBuf
));
EXTERN S16 cmUnpkNhuUeSwitchReqSdu
ARGS ((
NhuUeSwitchReqSdu *param,
Buffer *mBuf
));

EXTERN S16 cmUnpkNhuUeSwitchPrepCfmSdu
ARGS ((
NhuUeSwitchPrepCfmSdu *param,
Buffer *mBuf
));
EXTERN S16 cmUnpkNhuUeSwitchCfmSdu
ARGS ((
NhuUeSwitchCfmSdu *param,
Buffer *mBuf
));
EXTERN S16 cmUnpkNhuUeSwtchStsUpdSdu
ARGS ((
NhuUeSwtchStsUpdSdu *param,
Buffer *mBuf
));
