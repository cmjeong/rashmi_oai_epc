...
/********************************************************************20**
     ...
     Sid:      sm_msg.c@@/main/1 - Mon Apr  5 18:01:11 2010
...
/* ss037.103 Removed the semaphore operation for performance enhancement */
   ...
   {
      SSLOGERROR(ERRCLS_INT_PAR, ESS140, ERRZERO,
...
/* ss016.13: Addition */
   ...
   if (regp->poolTbl[pool].type != SS_POOL_DYNAMIC)
   {
      SSLOGERROR(ERRCLS_DEBUG, ESS145, ERRZERO, "SPutDBuf:Invalid pool type");
      RETVALUE(RFAILED);
   }
#endif
   ...
   if (ret != ROK)
   {
      SSLOGERROR(ERRCLS_DEBUG, ESS146, ERRZERO,
...
/* ss016.13: Addition */
  ...
  {
#if (ERRCLASS & ERRCLS_DEBUG)
      SSLOGERROR(ERRCLS_DEBUG, ESS147, ERRZERO,
...
/********************************************************************30**
         ...
         End of file:     sm_msg.c@@/main/1 - Mon Apr  5 18:01:11 2010
